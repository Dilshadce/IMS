...
<cfinvoke component="cfc.sum_pay_tm" method="sum_pay" empno="#selectList.empno#" 
...
<cfloop query="selectList">	
   ...
   <cfset sdl_cfc="success">
	<cfelse>
		<cfinvoke component="cfc.sdl" method="cal_HRD_SDL" returnvariable="sdl_cfc" empno="#selectList.empno#" db="#dts#"/>
    </cfif>	
	<cfelse>
    <cfquery name="update_sdl" datasource="#dts#">
       		UPDATE comm SET levy_sd = 0  
...
<cfquery name="getpaytra1" datasource="#dts#">
    SELECT * FROM paytran WHERE empno = <cfqueryparam cfsqltype="cf_sql_varchar" value="#url.empno#">
</cfquery>
