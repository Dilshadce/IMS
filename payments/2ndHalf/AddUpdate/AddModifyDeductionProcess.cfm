...
Update paytran SET #ded_attrib#=#evaluate("form.ded1_#i#_#j#")# WHERE empno = "#select_paytran_data.empno#"
</cfquery>
</cfloop>
<cfset j=j+1>
</cfloop>
...
<cfset ded_attrib = "ded" & #i# >
<cfquery name="update_all" datasource="#dts#">
Update paytran SET #ded_attrib#=#evaluate("form.ded2_#i#_#j#")# WHERE empno = #select_paytran_data.empno#
</cfquery>
</cfloop>
<cfset j=j+1>
</cfloop>
...
<cfset ded_attrib = "ded" & #i# >
<cfquery name="update_all" datasource="#dts#">
Update paytran SET #ded_attrib#=#evaluate("form.ded3_#i#_#j#")# WHERE empno = #select_paytran_data.empno#
</cfquery>
</cfloop>
<cfset j=j+1>
</cfloop>
...
<cfoutput><form name="pc" action="/payments/2ndHalf/addUpdate/AddModifyDeductionMain.cfm" method="post"></cfoutput>
