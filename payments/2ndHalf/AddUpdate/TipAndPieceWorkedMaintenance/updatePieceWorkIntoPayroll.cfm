...
UPDATE paytran SET Piecepay = #grand_total# WHERE empno = "#select_emp_list.empno#"
</cfquery>
</cfloop>
...
<cfoutput><form name="pc"  action="/payments/2ndHalf/AddUpdate/TipAndPieceWorkedMaintenance/prwMain.cfm" method="post"></cfoutput>
