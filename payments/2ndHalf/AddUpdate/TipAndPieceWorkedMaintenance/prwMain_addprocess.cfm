...
<cflocation url="/payments/2ndHalf/AddUpdate/TipAndPieceWorkedMaintenance/prwMain_add.cfm?empno=#url.empno#">
...
VALUES ("#url.empno#","#evaluate('form.ncode__r#i#')#",#cfc_pcdate#,"#numberformat(evaluate('form.nwork__r#i#'))#","#numberformat(evaluate('form.nywork__r#i#'))#")
</cfquery>
</cfif>
</cfloop>
