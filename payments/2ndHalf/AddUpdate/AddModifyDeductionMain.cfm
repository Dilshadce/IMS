...
<td width="90"><input type="text" name="ded1_#i#_#j#" value="#NumberFormat(evaluate('select_paytran_data.#ded_attrib#'),'.__')#" size="5" /></td>
</cfloop>
<cfset j=j+1>
</tr>
...
<cfset ded_attrib = "ded" & #i# >
<td width="90"><input type="text" name="ded2_#i#_#j#" value="#NumberFormat(evaluate('select_paytran_data.#ded_attrib#'),'.__')#" size="5" /></td>
</cfloop>
<cfset j=j+1>
</tr>
<input type="hidden" name="empno" id="empno" value="#select_paytran_data.empno#">
...
<cfset ded_attrib = "ded" & #i# >
<td width="90"><input type="text" name="ded3_#i#_#j#" value="#NumberFormat(evaluate('select_paytran_data.#ded_attrib#'),'.__')#" size="5" /></td>
</cfloop>
<cfset j=j+1>
</tr>
<input type="hidden" name="empno" id="empno" value="#select_paytran_data.empno#">
