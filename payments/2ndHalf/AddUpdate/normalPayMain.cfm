...
<!--- <cfset currentFile="http://localhost/payments/2ndHalf/AddUpdate/normalPayMain.cfm"> --->  
...
<cfquery name="getData" datasource="#dts#">
	...
	(
		SELECT * FROM pmast
		WHERE confid >= #hpin# and paystatus = "A" <cfif sFor neq "">and (#variables.sType# like '%#URLDecode(variables.sFor)#' 
...
<body>
				...
				<cfif getData.recordcount>
					...
					<tr onMouseOver="javascript:this.style.backgroundColor='99FF00';" onMouseOut="javascript:this.style.backgroundColor='';">
						...
						<td>
	           			...
	           			<td width="">
		           			<a href="/payments/2ndHalf/AddUpdate/normalPayEditForm.cfm?empno=#URLEncodedFormat(getData.empno)#"><img height="18px" width="18px" src="/images/edit.ICO" alt="Update" border="0">PAY</a>
		...
		<div><br /><a href="/payments/2ndHalf/addUpdate/addUpdateList.cfm"><strong>< Back</strong></a></div>
