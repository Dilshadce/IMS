...
<head>
	...
	function saveonly()
	{
	document.eForm.action = "/payments/2ndHalf/AddUpdate/normalPay_process.cfm?type=normal";
	}
	
	function savenext()
	{
	document.eForm.action = "/payments/2ndHalf/AddUpdate/normalPay_process.cfm?type=normal&page=next";
	}
	
	function all_add()
	{
	document.eForm.action = "/payments/2ndHalf/AddUpdate/normalPay_process.cfm?type=all_add";
	}
...
<!--- Prompt Table Start --->
	...
	<cfform name="eForm" id="eForm" action="/payments/2ndHalf/AddUpdate/normalPay_processnew.cfm?type=normal" method="post">
	<table class="form">
	<tr>
		<td>Employee No.</td>
		...
		<td ><input type="text" name="name" value="#pmast_qry.NAME#" size="40" readonly></td>
         <td><input type="button" name="goprocess" value="Process Pay" onClick="window.location.href='/payments/2ndHalf/processpaymain.cfm'" /></td>
	</tr>
	<tr>
		<td>Line No.</td>
...
#val(sum_prj_rcd.totot6_p)# > 
	...
	<center>
		...
		<input type="submit" name="save" value="Save" onClick="javascript:saveonly();">
        
		
		
		<input type="button" name="exit" value="Exit" onClick="window.location='window.close();'">
	</center>
	</cfform>
	</cfoutput>
