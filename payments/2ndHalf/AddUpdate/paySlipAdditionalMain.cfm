 ...
 <!--- <cfset currentFile="http://localhost/payments/2ndHalf/AddUpdate/paySlipAdditionalMain.cfm"> --->   
				...
				<cfif getData.recordcount>
					...
					<tr>
						...
						<td>
	           			...
	           			<td width="">
		           			<a href="/payments/2ndHalf/AddUpdate/paySlipAdditionalForm.cfm?empno=#getData.empno#"><img height="18px" width="18px" src="/images/edit.ICO" alt="Edit" border="0">Edit</a>
						</td>
					</tr>
					</cfoutput>
				<cfelse>
