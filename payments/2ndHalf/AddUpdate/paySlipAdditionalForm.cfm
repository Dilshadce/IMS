...
<cfoutput>
<form name="pForm" action="/payments/2ndhalf/addUpdate/paySlipAdditionalMain_process.cfm" method="post">
<div class="mainTitle">2nd Half Payroll 
...
<center>
	...
	<input type="button" name="exit" value="Exit" onClick="window.location='/payments/2ndHalf/addUpdate/paySlipAdditionalMain.cfm'">
</center>
</form>
</cfoutput>
</body>
