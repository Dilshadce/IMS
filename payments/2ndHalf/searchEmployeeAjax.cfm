...
select * from ( SELECT * FROM pmast as a left join (select empno as empno1,payyes from paytran) as b on a.empno = b.empno1 WHERE a.paystatus = "A"  and a.confid >= #hpin# and b.payyes = "Y")as pm 
