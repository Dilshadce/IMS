...
<div class="tabber">
	...
	<table>
		...
		<tr>
			...
			<td>
				<a href="##" onclick="window.open('/payments/1stHalf/AddUpdate/TipAndPieceWorkedMaintenance/prwMain_add.cfm?empno=#getEmp_qry.empno#', 'windowname1', 'width=800, height=500, left=100, top=30');" />
	...
	<center>
		...
		<input type="button" name="cancel" value="Cancel" onclick="window.location.href='/payments/1stHalf/AddUpdate/TipAndPieceWorkedMaintenance/tnpList.cfm';">
	</center>
