...
<body>
	...
	<form name="eForm" action="/payments/1stHalf/AddUpdate/HolidayAndLeaveMaintenance/holidayLeaveMaintenanceHoliday_process.cfm" method="post">
		...
		<tr><input type="hidden" name="entryno" value="#holiday_qry.entryno#" />
			<td>
				<input type="text" name="hol_date__r#entryno#" value="#lsdateformat(holiday_qry.hol_date,"dd/mm/yyyy")#" size="18" maxlength="10" />
			</td>
			<td>
				<img src="/images/cal.gif" width=17 height=15 border=0 onClick="showCalendarControl(hol_date__r#entryno#);">
			</td>
			<td>
				<input type="text" name="hol_desp__r#entryno#" value="#holiday_qry.hol_desp#" size="70" />
			</td>
			<!--- <td>
				<a href="##" onclick="window.open('/payments/1stHalf/AddUpdate/HolidayAndLeaveMaintenance/holidayLeaveMaintenanceHoliday_update.cfm?entryno=#holiday_qry.entryno#', 'windowname1', 'width=700, height=400, left=100, top=30');">
