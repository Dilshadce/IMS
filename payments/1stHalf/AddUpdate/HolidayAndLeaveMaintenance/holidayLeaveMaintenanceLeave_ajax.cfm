...
WHERE 0=0 
	...
	<table>
		...
		<tr><input type="hidden" name="empno" value="#getEmp_qry.empno#" />
			...
			<td>
				<a href="##" onclick="window.open('/payments/1stHalf/AddUpdate/HolidayAndLeaveMaintenance/holidayLeaveMaintenanceLeave_add.cfm?empno=#getEmp_qry.empno#', 'windowname1', 'width=700, height=600, left=100, top=30');" />
