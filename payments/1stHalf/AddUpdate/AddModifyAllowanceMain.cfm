...
SELECT * FROM paytra1 as pt LEFT JOIN pmast as pm ON pt.empno=pm.empno 
WHERE pm.paystatus = "A" and confid >= #hpin# 
<cfif isdefined("form.stype")>and #form.stype# like '%#form.sFor#%'</cfif>
...
<td width="90"><input type="text" name="aw1_#i#_#j#" value="#NumberFormat(evaluate('select_paytra1_data.#aw_attrib#'),'.__')#" size="5" /></td>
</cfloop>
<cfset j=j+1>
</tr>
...
<cfset aw_attrib = "aw" & #i# >
<td width="90"><input type="text" name="aw2_#i#_#j#" value="#NumberFormat(evaluate('select_paytra1_data.#aw_attrib#'),'.__')#" size="5" /></td>
</cfloop>
<cfset j=j+1>
</tr>
<input type="hidden" name="empno" id="empno" value="#select_paytra1_data.empno#">
...
<cfset aw_attrib = "aw" & #i# >
<td width="90"><input type="text" name="aw3_#i#_#j#" value="#NumberFormat(evaluate('select_paytra1_data.#aw_attrib#'),'.__')#" size="5" /></td>
</cfloop>
<cfset j=j+1>
</tr>
<input type="hidden" name="empno" id="empno" value="#select_paytra1_data.empno#">
...
<cfset aw_attrib = "aw" & #i# >
<td width="90"><input type="text" name="aw4_#i#_#j#" value="#NumberFormat(evaluate('select_paytra1_data.#aw_attrib#'),'.__')#" size="5" /></td>
</cfloop>
<cfset j=j+1>
</tr >
<input type="hidden" name="empno" id="empno" value="#select_paytra1_data.empno#">
