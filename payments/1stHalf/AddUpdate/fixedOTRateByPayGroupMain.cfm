<html>
<head>
	<title>1st Half Payroll - Fixed Overtime Rate By Pay Group</title>
...
SELECT *
FROM pmast WHERE paystatus = "A" and confid >= #hpin#
ORDER BY empno
</cfquery>
...
<cfoutput>
<form name="fForm" action="/payments/1stHalf/addUpdate/fixedOTRateByPayGroupMain_process.cfm" method="post">
<div class="mainTitle">1st Half Payroll - Fixed Overtime Rate By Pay Group</div>
<table class="form">
<tr>
