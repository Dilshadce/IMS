 ...
 <!--- <cfset currentFile="http://localhost/payments/1stHalf/AddUpdate/paySlipAdditionalMain.cfm"> --->   
...
<body>
		<div class="mainTitle">Pay Slip - Additional Remark / Note</div>
		<div class="ttype3">
			<cfoutput>
				...
				<cfif getData.recordcount>
					...
					<tr>
						...
						<td>
	           			...
	           			<td width="">
		           			<a href="/payments/1stHalf/AddUpdate/paySlipAdditionalForm.cfm?empno=#getData.empno#"><img height="18px" width="18px" src="/images/edit.ICO" alt="Edit" border="0">Edit</a>
						</td>
					</tr>
					</cfoutput>
				<cfelse>
