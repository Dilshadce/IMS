...
UPDATE paytra1, pwork SET paytra1.#num_rdhlworked.WORK_TYPE# = #num_rdhlworked.WORK_DAY# WHERE paytra1.empno = pwork.empno
</cfquery>
</cfloop>
...
<cfoutput><form name="pc"  action="/payments/1stHalf/AddUpdate/RestdayAndHolidayWorked/maintainMain.cfm" method="post"></cfoutput>
