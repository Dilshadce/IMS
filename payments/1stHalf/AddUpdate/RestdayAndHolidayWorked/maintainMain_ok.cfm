...
<div class="tabber">
	...
	<form name="eForm" action="/payments/1stHalf/AddUpdate/RestdayAndHolidayWorked/maintainMain_process.cfm" method="post">
	...
	<table id="tit" class="form" border="0">
		...
		<tr>
			...
			<td>
				<a href="/payments/1stHalf/AddUpdate/RestdayAndHolidayWorked/maintainMain_process.cfm?type=delete&empno=#pwork_qry.empno#">
