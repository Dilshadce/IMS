...
SELECT p.empno FROM paytra1 p, pmast pm
...
<cfoutput><form name="pc"  action="/payments/1stHalf/AddUpdate/RestdayAndHolidayWorked/convertMain.cfm" method="post"></cfoutput>
