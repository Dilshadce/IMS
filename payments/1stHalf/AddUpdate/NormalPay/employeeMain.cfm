...
<!--- <cfset currentFile="http://localhost/personnel/employee/employeeMain.cfm"> --->
...
<body>
		<!--- <font class="ttype">Customer Profile</font><br> --->
		<div class="mainTitle">Add / Edit Category</div>
		<div class="ttype3">
			<cfoutput>
			<form name="eForm" action="#currentFile#?list=#variables.records_per_page#" method="post">
				...
				<cfif getData.recordcount>
					...
					<tr>
						...
						<td>
	           			...
	           			<td width="">
		           			<a href="/personnel/employee/employeeEditForm.cfm?empno=#getData.empno#"><img height="18px" width="18px" src="/images/edit.ICO" alt="Edit" border="0">Edit</a> || 
