<html>
<head>
	<title>1st Half Payroll - Pay Allowance For</title>
...
<tr>
	<td colspan="3" align="right"><input type="button" name="cancel" value="Cancel" onclick="window.location='/payments/1stHalf/addUpdate/addUpdateList.cfm'"></td>
</tr>
</table>
</form>
</cfoutput>
