...
<!--- <cfset currentFile="http://localhost/payments/1stHalf/AddUpdate/editOTRateCPFMain.cfm"> --->
...
<head>
	...
	<title>Edit Overtime Rate/ EPF / SOCSO / PCB</title>
	<cfelse>
...
<body>
<cfif country_code eq 'MY'>
	<div class="mainTitle">Edit Overtime Rate/ EPF / SOCSO / PCB</div>
<cfelse>
	<div class="mainTitle">Edit Overtime Rate / CPF</div>
</cfif>
		<br  />
		<div class="ttype3">
			<cfoutput>
				...
				<cfif getData.recordcount>
					...
					<tr>
						...
						<td>
	           			...
	           			<td width="">
		           			<a href="/payments/1stHalf/AddUpdate/editOTRateCPFForm.cfm?empno=#getData.empno#"><img height="18px" width="18px" src="/images/edit.ICO" alt="Edit" border="0">Edit</a>
						</td>
					</tr>
					</cfoutput>
				<cfelse>
