<cfset dts1 = replace(dts,'_i','_p','All')>
    ...
    <td><a style="cursor:pointer" onClick="selectlist('#getitemno.xplacementno#','#url.nametype#');<cfif url.nametype eq "placementfrom">selectlist('#getitemno.xplacementno#','placementto');</cfif>ColdFusion.Window.hide('findplacementnonew');" >SELECT</a></td>
    </tr>
    </cfloop>
