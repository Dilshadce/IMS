...
<cfset filename = hcomid&"_"&payrollmonth&"Pay_Bill_Audit_"&getauthuser()&".xls">
...
<Cell ss:StyleID="s65"><Data ss:Type="Number"><cfif getassignment.paymenttype eq "hr">#numberformat(getassignment.custsalaryhrs,'.____')#<cfelseif getassignment.paymenttype eq "day">#numberformat(getassignment.custsalaryday,'.____')#<cfelse><cfif val(getassignment.workd) neq 0><cfset monthprorate = ROUND((val(getassignment.custsalaryday)/val(getassignment.workd))*100000)/100000><cfelse><cfset monthprorate = 1></cfif>#numberformat(monthprorate,'.____')#</cfif></Data></Cell>
...
<cfif val(evaluate('getassignment.fixawee#a#')) neq 0 or val(evaluate('getassignment.fixawer#a#'))>
 <Row ss:AutoFitHeight="0">
<cfinclude template="startrowexcel.cfm">
                 <Cell ss:StyleID="s28"><Data ss:Type="String">#evaluate('fixawdesp#a#')#</Data></Cell>
...
<Row ss:AutoFitHeight="0">
<cfinclude template="startrowexcel.cfm">
                 <Cell ss:StyleID="s28"><Data ss:Type="String">#evaluate('allowancedesp#a#')#</Data></Cell>
...
<!---<cfif val(getassignment.lvltotalee1) neq 0 or val(getassignment.lvltotaler1) neq 0>
<Row ss:AutoFitHeight="0">
<cfinclude template="startrowexcel.cfm">
                 <Cell ss:StyleID="s28"><Data ss:Type="String">NPL</Data></Cell>
<Cell ss:StyleID="s65"><Data ss:Type="Number"><cfif val(getassignment.lvleedayhr1) neq 0>#val(getassignment.lvleedayhr1)#<cfelse>0.00</cfif></Data></Cell>
<Cell ss:StyleID="s65"><Data ss:Type="Number">#numberformat(val(getassignment.lvleerate1),',.__')#</Data></Cell>
<Cell ss:StyleID="s65"><Data ss:Type="Number">#numberformat(val(getassignment.lvltotalee1),',.__')#</Data></Cell>
<Cell ss:StyleID="s65"><Data ss:Type="Number"><cfif val(getassignment.lvlerdayhr1) neq 0>#val(getassignment.lvlerdayhr1)#<cfelse>0.00</cfif></Data></Cell>
<Cell ss:StyleID="s65"><Data ss:Type="Number">#numberformat(val(getassignment.lvlerrate1),',.__')#</Data></Cell>
<Cell ss:StyleID="s65"><Data ss:Type="Number">#numberformat(val(getassignment.lvltotaler1),',.__')#</Data></Cell>
<Cell ss:StyleID="s28"><Data ss:Type="String"><cfif numberformat(val(getassignment.lvltotalee1),'.__') gt numberformat(val(getassignment.lvltotaler1),'.__')>**<cfelse>.</cfif></Data></Cell>
</Row>
</cfif>--->
...
<Cell ss:StyleID="s65"><Data ss:Type="Number">-#numberformat(val(getassignment.selfcpf),',.__')#</Data></Cell>
<Cell ss:StyleID="s65"><Data ss:Type="Number">-#numberformat(val(getassignment.selfcpf),',.__')#</Data></Cell>
...
<Cell ss:StyleID="s65"><Data ss:Type="Number">-#numberformat(val(getassignment.selfsdf),',.__')#</Data></Cell>
<Cell ss:StyleID="s65"><Data ss:Type="Number">-#numberformat(val(getassignment.selfsdf),',.__')#</Data></Cell>
...
<Row ss:AutoFitHeight="0">
<cfinclude template="startrowexcel.cfm">
                 <Cell ss:StyleID="s28"><Data ss:Type="String">#evaluate('getassignment.billitemdesp#a#')# Fee</Data></Cell>
<Cell ss:StyleID="s65"><Data ss:Type="Number">0.00</Data></Cell>
<Cell ss:StyleID="s65"><Data ss:Type="Number">0.00</Data></Cell>
<Cell ss:StyleID="s65"><Data ss:Type="Number">0.00</Data></Cell>
...
<Row ss:AutoFitHeight="0">
<cfinclude template="startrowexcel.cfm">
                 <Cell ss:StyleID="s28"><Data ss:Type="String">#evaluate('getassignment.addchargedesp#a#')# Fee</Data></Cell>
<Cell ss:StyleID="s65"><Data ss:Type="Number">1.00</Data></Cell>
