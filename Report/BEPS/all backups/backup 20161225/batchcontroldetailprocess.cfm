...
<td  nowrap="nowrap" align="right">#numberformat(val(invlesspay),',.__')#,<br> #getassignment.custtotalgross# Invoice gross - (#getassignment.selftotal# Salary + #checkma.totalamt# Add Charges - #getpayroll.ded101# DED + #getassignment.selfcpf# EPF)  
