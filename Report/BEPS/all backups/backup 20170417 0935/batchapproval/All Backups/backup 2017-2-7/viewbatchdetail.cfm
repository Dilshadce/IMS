		...
		<table border="1">
			...
			<cfloop query="getassignment">
				<tr  onMouseOut="javascript:this.style.backgroundColor='';" onMouseOver="javascript:this.style.backgroundColor='99FF00';">
					...
					<cfset countid = countid + 1>
					nowrap="nowrap" align="right">#numberformat(val(getassignment.isdf),',.__')#</td> <td #replace(displayphrase,'$$countid$$',countid)#
					<cfset countid = countid + 1>
...
SELECT * FROM argiro WHERE id = "#url.id#"
			...
			<tr>
				...
				<cfset countid = countid + 1>
				align="right">#numberformat(gettotal.isdf,',.__')#</th> <th #replace(displayphrase,'$$countid$$',countid)#
				<cfset countid = countid + 1>
