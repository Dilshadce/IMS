...
WHERE UPPER(EMPNO) = <cfqueryparam cfsqltype="cf_sql_varchar" value="#UCASE(getassignment.empno)#">
						...
						<td  nowrap="nowrap" align="right">
                            ...
                            <cfelse>                            
                                ...
                                <cfquery name="updateNetpay" datasource="#replace(dts,'_i','_p')#">
                                    UPDATE paytra1
                                    SET netpay=grosspay-ifnull(epfww,0.00)-ifnull(socsoww,0.00)-ifnull(ded115,0.00)-ifnull(ded114,0.00)-ifnull(ded109,0.00)-ifnull(ded113,0.00)+ifnull(tdedu,0.00),
                                    payyes="Y"
                                    WHERE empno = '#trim(getassignment.empno)#'
                                </cfquery>
						...
						<td  nowrap="nowrap" align="right">
							...
							<br>
							#getassignment.custtotalgross# Invoice gross - (#getassignment.selftotal# Salary + #checkma.totalamt# Add Charges - #getpayroll.ded101# DED + #getpayroll.EPFWW# EPF)
