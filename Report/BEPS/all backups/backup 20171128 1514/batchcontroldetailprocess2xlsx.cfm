    ...
    <cfif val(getassignment.selfsalary) neq 0 or val(getassignment.custsalary) neq 0>     <!---For normal amount--->
        ...
        <cfelse>
            <cfif val(getassignment.workd) neq 0>
                <cfset monthprorate = ROUND((val(DateDiff("d", getassignment.startdate, getassignment.completedate) + 1)/val(getassignment.workd))*100000)/100000>
