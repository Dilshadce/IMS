...
<cfoutput>
<form name="tgForm" action="/Report/BEPS/batchapproval/paytra1/generateThruBankViaDiskette.cfm" method="post" target="BLANK"  onSubmit="return validateform();">
<table class="form">
<tr>
...
<!--- temp query replacing this for feb payout 
...
<tr>
	...
	<td>
	<!--- temp query replacing this for feb 7 payout 
...
<tr>
	...
	<td><input type="text" name="cdate" value="#DateFormat(getbatch.giropaydate,"yyyy/mm/dd")#" size="10" readonly></td>
</tr>
<!---<tr>
	<td>Report Date</td>
	<cfset rdate = Createdate(gs_qry.myear, gs_qry.mmonth, DaysInMonth(CreateDate(gs_qry.myear, gs_qry.mmonth, 1)))>
...
<tr>
	<td>Prepared By</td>
	<td><input type="text" id="Prepared_By" name="Prepared_By" value="#getauthuser()#" readonly></td>
</tr>
<tr>
	<!---<td>Batch No.</td>
    ...
    <td>PIR Reference No</td>
	<td><input type="text" id="pir_refno" name="pir_refno" value="" size="30" >
	</td>
