							...
							<tr onMouseOut="javascript:this.style.backgroundColor='';" onMouseOver="javascript:this.style.backgroundColor='99FF00';">
								...
								<td style="padding:0px 0px 0px 20px;">
									<div id="approvediv#getlist.id#">
										<cfif getauthuser() eq "ultranieo" or getauthuser() eq "kelly.lim@manpower.com.my" or getauthuser() eq "renusidhu.as@manpower.com.my" or getauthuser() eq "adminbepstest" or getauthuser() eq "Chrisbeps">
