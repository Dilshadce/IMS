...
<hr />
    ...
    <td colspan="100%" align="center"><input type="Submit" name="Submit" value="View Report" onClick="document.form123.action = 'batchcontroldetailprocess.cfm';"><!--- &nbsp;&nbsp;&nbsp;<input type="Submit" name="Submit" value="Pay Bill Audit Report" onClick="document.form123.action = 'batchcontroldetailprocess2.cfm';"> --->&nbsp;&nbsp;&nbsp;<input type="Submit" name="Submit" value="Pay Bill Audit Report Excel" onClick="document.form123.action = 'batchcontroldetailprocess2excel.cfm';"></td>
    </tr>
</table>
</cfoutput>
</cfform>
