...
<cfset tran = url.type >
    ...
    &nbsp;&nbsp;<font style="text-transform:uppercase">Assignmentslip NO.</font>&nbsp;<input type="text" name="refno1" size="8" id="refno1" onblur="document.getElementById('loading').style.visibility='visible';ajaxFunction1(document.getElementById('ajaxField'),'findAssignAjax.cfm?type=#url.type#&fromto=#url.fromto#&refno='+document.getElementById('refno1').value+'&empname='+document.getElementById('empname1').value+'&empno='+document.getElementById('empno1').value+'&placementno='+document.getElementById('placementno1').value);" <cfif isdefined('url.custno')>value="#url.custno#"</cfif>  />&nbsp;Employee No:&nbsp;<input type="text" name="empno1" id="empno1" onblur="document.getElementById('loading').style.visibility='visible';ajaxFunction1(document.getElementById('ajaxField'),'findAssignAjax.cfm?type=#url.type#&fromto=#url.fromto#&refno='+document.getElementById('refno1').value+'&empname='+document.getElementById('empname1').value+'&empno='+document.getElementById('empno1').value+'&placementno='+document.getElementById('placementno1').value);" size="12" />
    <br>&nbsp;Employee NAME:&nbsp;<input type="text" name="empname1" id="empname1" onblur="document.getElementById('loading').style.visibility='visible';ajaxFunction1(document.getElementById('ajaxField'),'findAssignAjax.cfm?type=#url.type#&fromto=#url.fromto#&refno='+document.getElementById('refno1').value+'&empname='+document.getElementById('empname1').value+'&empno='+document.getElementById('empno1').value+'&placementno='+document.getElementById('placementno1').value);" size="12" />
    &nbsp;Placement No:&nbsp;<input type="text" name="placementno1" id="placementno1" onblur="document.getElementById('loading').style.visibility='visible';ajaxFunction1(document.getElementById('ajaxField'),'findAssignAjax.cfm?type=#url.type#&fromto=#url.fromto#&refno='+document.getElementById('refno1').value+'&empname='+document.getElementById('empname1').value+'&empno='+document.getElementById('empno1').value+'&placementno='+document.getElementById('placementno1').value);" size="12" />
