...
WHERE UPPER(EMPNO) = <cfqueryparam cfsqltype="cf_sql_varchar" value="#UCASE(getassignment.empno)#">
						...
						<cfset peegross = numberformat(val(peegross + getassignment.selfsalary + getassignment.selfphnlsalary + getassignment.selfottotal + getassignment.selfallowance + val(getpayroll.aw116)+val(getpayroll.aw117) +getassignment.selfpayback + getpayroll.ded101 ),'.__')>
						<cfset subpeegross = numberformat(val(subpeegross + getassignment.selfsalary + getassignment.selfphnlsalary + getassignment.selfottotal + getassignment.selfallowance + val(getpayroll.aw116)+val(getpayroll.aw117) + getassignment.selfpayback + getpayroll.ded101) ,'.__')>
						<td  nowrap="nowrap" align="right">
							#numberformat(val( getassignment.selfsalary + getassignment.selfphnlsalary + getassignment.selfottotal + getassignment.selfallowance + val(getpayroll.aw116)+val(getpayroll.aw117) + getassignment.selfpayback + getpayroll.ded101) ,'.__')#
						</td>
