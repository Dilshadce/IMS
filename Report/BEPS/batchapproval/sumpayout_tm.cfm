...
<!--- Constant --->
<cfset max_socsoww = 29.75>
<cfset max_socsocc = 104.15>
<cfset max_eisww = 11.90>
<cfset max_eiscc = 11.90>
...
<cfloop list="paytra1,paytran" index="a">
    ...
    <cfquery name="updatedwfinal" datasource="#db#">
        ...
        EPFCC=#val(tEPFER)#, 
        SOCSOWW = IF(#val(tSOCSOEE)# >= #max_socsoww#, #max_socsoww#, #val(tSOCSOEE)# ),
        SOCSOCC = IF(#val(tSOCSOER)# >= #max_socsocc# or #val(tSOCSOEE)# >= #max_socsoww# , #max_socsocc#, #val(tSOCSOER)# ),
        EISWW = IF(#val(tEISEE)# >= #max_eisww#, #max_eisww#, #val(tEISEE)# ),
        EISCC = IF(#val(tEISER)# >= #max_eiscc#, #max_eiscc#, #val(tEISER)# ),
...
<cfquery name="updatedwfinal" datasource="#db#">
    ...
    EPFCC=#val(ftEPFER)#, 
    SOCSOWW = IF(#val(ftSOCSOEE)# >= #max_socsoww#, #max_socsoww#, #val(ftSOCSOEE)# ),
    SOCSOCC = IF(#val(ftSOCSOER)# >= #max_socsocc# or #val(ftSOCSOEE)# >= #max_socsoww# , #max_socsocc#, #val(ftSOCSOER)# ),
    EISWW = IF(#val(ftEISEE)# >= #max_eisww#, #max_eisww#, #val(ftEISEE)# ),
    EISCC = IF(#val(ftEISER)# >= #max_eiscc#, #max_eiscc#, #val(ftEISER)# ),
