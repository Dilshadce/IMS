        ...
        <form name="tgForm" action="/Report/BEPS/batchapproval/generateGiroBankfile/generateThruBankViaDiskette.cfm" method="post" target="BLANK"  onSubmit="return validateform();">
            <table class="form">
                    ...
                    <tr>
                        ...
                        <td>
                            ...
                            <cfloop query="getbatch">
                                <input type="checkbox" name="batch" id="batch" value="#getbatch.batches#" onclick="setpirrefno(this.value,'#lcase(getbatch.branch)#','#url.paytype#');">
                                &nbsp;&nbsp;#getbatch.batches#
                                <br>
                            </cfloop>
                        </td>
                ...
                <tr>
                    ...
                    <td>
                        <input type="text" id="pir_refno#url.paytype#" name="pir_refno" value="" size="30" >
                    </td>
                </tr>
                <tr>
                    <td>
