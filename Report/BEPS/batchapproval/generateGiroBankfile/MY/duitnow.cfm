...
<cfloop query="getpay_qry">
    ...
    <cfset record = "">
    <cfset rcd1 = "01">
    <cfset rcd2 = "CN"> <!--- DN = Duit Now --->
    <cfset rcd3 = "Domestic Payments (MY)">
    <cfset rcd4 = "">
    <cfset rcd5 = dateformat(getpay_qry.giropaydate,'DDMMYYYY')>
    <cfset rcd6 = "">
    <cfset rcd7 = "">
    <cfset rcd8 = getpay_qry.empno>
    <cfset rcd9 = pir_ref>
    <cfif len(rcd9) gt 55>
    ...
    <cfelse>
        <cfset error = error & 'Line ' & #count# & ' - Record no. 15  debit bank account no. empty. @ #getpay_qry.empno#<br />'>
    </cfif>
    <cfset rcd16 = trim(getpay_qry.bankaccno)>
    <cfif len(rcd16) lte 6 or len(rcd16) gt 35>
        <cfset error = error & 'Line ' & #count# & ' - Record no. 16  employee bank account no. exceeds 35 characters or wrong format. @ #getpay_qry.empno#<br />'>
    </cfif>
    <cfset rcd17 = "">
    <cfset rcd18 = "">
    <cfset rcd19 = "N">
    ...
    <cfelse>
        <cfset rcd37 = "MBBEMYKL"> <!---swift code--->
    </cfif>
    <cfset rcd38 = "">
    <cfset rcd39 = "">
    <cfset rcd40 = "">
...
<!---    <cfset rcd102 = "">
    ...
    <cfset rcd186 = ""><!--- DuitName ID Type --->
    <cfset rcd187 = ""><!--- DuitName ID --->
    <cfset rcd188 = "FT"><!--- Transaction Type --->

    <cfloop from="1" to="500" index="i">
        <cfif (i gte 71 and i lte 109) or (i gte 112 and i lte 185) or (i gte 189 and i lte 500)>
            <cfset record = record & "|">
            <cfset result = result & "|">
        <cfelse>
