...
<html>
	...
	<body>
		...
		<cfoutput>
        <form name="tgForm" action="/Report/BEPS/batchapproval/generateGiroBankfile/generateThruBankViaDiskette.cfm" method="post" target="BLANK"  onSubmit="return validateform();">
            <table class="form">
                <tr>
                    <th colspan="2">
                        Generate ASCII File
                    ...
                    <tr>
                        ...
                        <td>
                            ...
                            <cfloop query="getbatch">
                                <input type="checkbox" name="batch" id="batch" value="#getbatch.batches#" onclick="setpirrefno(this.value,'#lcase(getbatch.branch)#','#url.paytype#','pir_refno_bank_file_');">
                                &nbsp;&nbsp;#getbatch.batches#
                                <br>
                            </cfloop>
                        </td>
                ...
                <tr>
                    ...
                    <td>
                        <input type="text" id="pir_refno_bank_file_#url.paytype#" name="pir_refno" value="" size="30" >
                    </td>
                </tr>
                <tr>
                    <td>
