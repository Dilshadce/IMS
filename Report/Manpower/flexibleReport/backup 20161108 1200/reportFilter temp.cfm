...
<table border="0" align="center" width="80%" class="data" style="dis">
	<cfloop list="#filterlist#" delimiters="," index="i">
        ...
        <cfelseif i eq "Contract Start Date" or i eq "Contract End Date" or i eq "Consultant" or i eq 'Project' or i eq "Job Code">
       	...
       	<cfquery name="getdata" datasource="#dts#">       	 
            ...
            from    <cfif i eq "Customer">
                    ...
                    <cfelseif i eq "Job Code">   
                        driver          
                    <cfelse>
                    	main.users where userbranch = "beps_i" and usergrpid <> "super"
                    </cfif>
...
function openSearch(type, input, toinput){
	type = type;
	input = input;
