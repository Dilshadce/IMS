...
<body>
<cfform action="batchcontrolsummaryprocess.cfm" method="post" name="form123" target="_blank">

<!--- <h2>Print <cfoutput>#trantype#</cfoutput> Listing Report</h2> --->
<cfoutput>
<h3>
	<a><font size="2">Batch Total Summary Report</font></a>
</h3>
...
<option value="#userlist.userid#">#userlist.userid#</option>
    ...
    Group By Batches
    order by giropaydate,batches
    </cfquery>
    <cfloop query="getbatch">
    <input type="checkbox" name="batches" id="batches" value="#getbatch.batches#">&nbsp;&nbsp;#getbatch.batches#-#dateformat(getbatch.giropaydate,'dd/mm/yyyy')#<br>
    ...
    <td colspan="100%" align="center"><input type="Submit" name="Submit" value="Submit"></td>
    </tr>
</table>
</cfoutput>
</cfform>
