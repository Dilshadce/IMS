...
select a.batchno,a.giropaydate,a.netpay,b.name,b.bankcode,b.bankaccno,b.nric,b.nricn,b.passport from icgiro as a 
...
<cfset filenewdir = "C:\Inetpub\wwwroot\payroll\download\#dts#\">
           ...
           <!--- #header#
            ...
            <cfset totalamt = val(totalamt) + val(netpayamt)>
            ...
            <!---data set 8--->
            <cfset datatemp = right("#ReReplaceNoCase(dateformat(form.cdate, 'yyyymmdd'),'[^0-9]','','ALL')#",8)>
            ...
            <cfset datatemp = right("#getpaytra1_qry.passport#",40)>
            <cfset format = 20 - len('#datatemp#')>
            <cfloop index="i" from="1" to="#format#">
            	<cfset datatemp = datatemp & " ">
            </cfloop>
