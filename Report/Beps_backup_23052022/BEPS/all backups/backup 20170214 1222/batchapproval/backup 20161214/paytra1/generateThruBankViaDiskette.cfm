...
<cfif isdefined('form.batch_no') eq false>
<cfoutput>
...
<cfif left(dts,8) eq "manpower">
<cfif form.batch_no neq ''>
<cfquery name="getempnolist" datasource="#replace(dts,'_p','_i')#">
SELECT empno FROM assignmentslip WHERE batches in (<cfqueryparam cfsqltype="cf_sql_varchar" value="#form.batch_no#" list="yes" separator=",">)
</cfquery>
</cfif>
