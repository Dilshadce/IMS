...
<hr />
    ...
    <td></td>
    <td>
    <input type="checkbox" name="permonly" id="permonly" value="" >
    </td>
    </tr>
    <tr>
    <th>CN DN</th>
    ...
    <td></td>
    <td>
    <input type="checkbox" name="assignonly" id="assignonly" value="">
    </td>
    </tr>
	<tr>
    </tr>
	...
	&nbsp;&nbsp;&nbsp;
	<input type="Submit" name="Submit" value="Pay Bill Report (Without Format)" onClick="document.form123.action = 'batchcontroldetailprocess2xlsx.cfm';">
	&nbsp;&nbsp;&nbsp;
