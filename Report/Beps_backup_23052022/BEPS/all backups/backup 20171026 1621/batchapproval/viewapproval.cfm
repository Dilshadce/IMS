							...
							<tr onMouseOut="javascript:this.style.backgroundColor='';" onMouseOver="javascript:this.style.backgroundColor='99FF00';">
								...
								<td style="padding:0px 0px 0px 20px;">
									<div id="approvediv#getlist.id#">
										<cfif getauthuser() eq "mptest10" or getauthuser() eq "kelly.lim@manpower.com.my" or getauthuser() eq "renusidhu.as@manpower.com.my" or getauthuser() eq "adminbepstest" or getauthuser() eq "Chrisbeps" or getauthuser() eq "ultralung"  or getauthuser() eq "ultranieo">
...
and batchno in (<cfqueryparam cfsqltype="cf_sql_varchar" value="#valuelist(getbatch.batches)#" list="yes" separator=",">) ORDER by girorefno,approved_on,batchno
										...
										<div id="approvediv#getlist.id#">
											<div id="giro#getlist.id#">
												<cfif getlist.girorefno eq "">
													...
													<cfif getauthuser() eq "ultranieo" or getauthuser() eq "adminbepstest" or getauthuser() eq "Chrisbeps" or getauthuser() eq "kelly.lim@manpower.com.my" or getauthuser() eq "renusidhu.as@manpower.com.my">
														&nbsp;&nbsp;
														<input type="button" name="approve_btn" id="approve_btn" value="Reject" onClick="document.getElementById('hidid').value='#getlist.id#';ColdFusion.Window.show('rejectbatch');">
													</cfif>
												<cfelse>
                            ...
                            <tr>
								<td colspan="100%">
                                    <div align="center">
										<input type="button" name="paytra1giro_btn" id="paytra1giro_btn" value="Generate Normal Pay Out Giro (New Format)" onClick="ColdFusion.Window.show('generategironew1');">
										&nbsp;&nbsp;&nbsp;
										<input type="button" name="paytrangiro_btn" id="paytrangiro_btn" value="Generate Exception Pay Out Giro (New Format)" onClick="ColdFusion.Window.show('generategironew2');">
										&nbsp;&nbsp;&nbsp;
										<input type="button" name="single_giro" id="single_giro_btn" value="Generate Single Giro (New Format)" onClick="ColdFusion.Window.show('singlegironew');">
...
and batchno in (<cfqueryparam cfsqltype="cf_sql_varchar" value="#valuelist(getbatch.batches)#" list="yes" separator=",">) ORDER by date(approved_on),batchno
        ...
        <cfwindow center="true" width="600" height="500"
			...
			initshow="false" draggable="true" resizable="true"
			source="/report/beps/batchapproval/generateGiroBankfile/thruBankViaDisketteMain_generate.cfm?type=1&mmonth=#payrollmonth#&paydate=paytra1" refreshonshow="true" modal="true"  />
		<cfwindow center="true" width="600" height="500"
			name="generategironew2" title="Generate APS"
			initshow="false" draggable="true" resizable="true"
			source="/report/beps/batchapproval/generateGiroBankfile/thruBankViaDisketteMain_generate.cfm?tbl=paytran&type=1&mmonth=#payrollmonth#&paydate=paytran" refreshonshow="true" modal="true"  />

        <cfwindow center="true" width="600" height="500"
			name="singlegironew" title="Generate single giro"
			initshow="false" draggable="true" resizable="true"
			source="/report/beps/batchapproval/generateGiroBankfile/singlegiro.cfm?type=1" refreshonshow="true" modal="true"  />
        <!---Added by Nieo 20170829 1348, new pipeline Maybank upload file--->         
	</body>
</html>
