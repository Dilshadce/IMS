...
SELECT * FROM (
SELECT * FROM (
SELECT refno, wos_date as assignmentslipdate, net,tax,grand,name as custname from artran WHERE 1=1 and type = "INV"
<cfif form.billfrom neq "" and form.billto neq "">
and refno between <cfqueryparam cfsqltype="cf_sql_varchar" value="#form.billfrom#"> and <cfqueryparam cfsqltype="cf_sql_varchar" value="#form.billto#">
</cfif> 
<cfif form.datefrom neq "" and form.dateto neq "">
...
UNION ALL
SELECT * FROM (
SELECT refno, wos_date as assignmentslipdate, net  * -1 as net,tax * -1 as tax,grand * -1 as grand,name as custname from artran WHERE 1=1 and type = "CN"
<cfif form.billfrom neq "" and form.billto neq "">
and refno between <cfqueryparam cfsqltype="cf_sql_varchar" value="#form.billfrom#"> and <cfqueryparam cfsqltype="cf_sql_varchar" value="#form.billto#">
</cfif> 
<cfif form.datefrom neq "" and form.dateto neq "">
...
SELECT GROSSPAY as NETPAY,EPFCC,EMPNO,TMONTH,EPFWW,DED111,DED113,DED114,DED101 FROM #replace(dts,'_i','_p')#.pay_12m WHERE empno in (<cfqueryparam cfsqltype="cf_sql_varchar" value="#valuelist(getassignment.empno)#" list="yes" separator=",">) 
</cfquery>
<cfquery name="getoldmonthsdl" datasource="#dts#">
SELECT LEVY_SD,EMPNO,TMONTH,levy_fw_w FROM #replace(dts,'_i','_p')#.comm_12m WHERE empno in (<cfqueryparam cfsqltype="cf_sql_varchar" value="#valuelist(getassignment.empno)#" list="yes" separator=",">) 
</cfquery>
...
<cfif url.type eq "Costing">
<cfif mid(getassignment.consultant,3,1) eq "/">
...
<td align="right">#numberformat(val(getassignment.net),'.__')#</td>
