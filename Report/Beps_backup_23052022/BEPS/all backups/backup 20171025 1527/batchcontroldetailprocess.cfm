...
<cfqueryparam cfsqltype="cf_sql_double" value="#numberformat(val(getassignment.selfsalary)-val(getpayroll.ded101),'.__')#">,
...
<cfqueryparam cfsqltype="cf_sql_double" value="#numberformat(val(getpayroll.ded115),'.__')+numberformat(val(getpayroll.ded114),'.__')#">,
