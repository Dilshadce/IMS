<cfoutput>
	...
	<cfif payrollmonth eq form.month>
		<cfquery name="paytra1" datasource="#replace(dts,'_i','_p')#" cachedwithin="#createtimespan(0,0,0,30)#">
        SELECT * FROM PAYTRA1
        </cfquery>
		<cfquery name="paytran" datasource="#replace(dts,'_i','_p')#" cachedwithin="#createtimespan(0,0,0,30)#">
        SELECT * FROM PAYTRAN
        </cfquery>
		<cfquery name="getlevy" datasource="#replace(dts,'_i','_p')#" cachedwithin="#createtimespan(0,0,0,30)#">
	...
	<cfquery name="getplacement" datasource="#dts#" cachedwithin="#createtimespan(0,0,0,30)#">
	...
	<cfquery name="getassignment" datasource="#dts#" cachedwithin="#createtimespan(0,0,0,30)#">
    SELECT * FROM (
...
Select banktype from assignmentslip WHERE batches in (<cfqueryparam cfsqltype="cf_sql_varchar" value="#form.batches#" list="yes" separator=",">
					...
					<tr>
						<th colspan="100%" align="left">
							Bank Info : #valuelist(getbanktype.banktype)#
						</th>
					</tr>
				</cfif>
				<tr>
...
SELECT LEVY_SD,LEVY_FW_W FROM getlevy WHERE UPPER(EMPNO) = <cfqueryparam cfsqltype="cf_sql_varchar" value="#UCASE(getassignment.empno)#">
						...
						<cfquery name="checkma" datasource="#dts#" cachedwithin="#createtimespan(0,0,0,30)#">
...
WHERE UPPER(EMPNO) = <cfqueryparam cfsqltype="cf_sql_varchar" value="#UCASE(getassignment.empno)#">
						...
						<cfelse>							
							<cfset pfund = pfund + numberformat(val(getpayroll.ded115),'.__')+numberformat(val(getpayroll.ded114),'.__')>
							<cfset subpfund = subpfund + numberformat(val(getpayroll.ded115),'.__')+numberformat(val(getpayroll.ded114),'.__')>
							<td  nowrap="nowrap" align="right">
							#numberformat(numberformat(val(getpayroll.ded115),'.__')+numberformat(val(getpayroll.ded114),'.__'),'.__')#
						</cfif>
						</td>
						<cfif checkapproval.recordcount	neq 0>
						...
						<cfelse>
							<cfset totalnet = numberformat(val(getassignment.selftotal),'.__')-numberformat(val(checkma.totalded),'.__')-numberformat(val(getpayroll.ded115),'.__')-numberformat(val(getpayroll.ded114),'.__')- numberformat(val(getdbded.dbded113),'.__')- numberformat(val(getdbded.dbded114),'.__')- numberformat(val(getdbded.dbded109),'.__')>
						</cfif>
						<td  nowrap="nowrap" align="right">
