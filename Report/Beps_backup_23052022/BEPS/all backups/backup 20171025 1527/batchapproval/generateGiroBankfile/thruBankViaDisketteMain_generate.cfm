...
SELECT * FROM dept order by deptcode
						...
						<td>
							<select name="deptfrom" id="deptfrom">
								...
								<cfloop query="getdept">
									<option value="#getdept.deptcode#">
										#getdept.deptcode# - #getdept.deptdesp#
									</option>
								</cfloop>
							</select>
						</td>
					...
					<cfif left(dts,8) eq "manpower">
							...
							Select batches,a.giropaydate from assignmentslip a
									...
									and month(submited_on) = "#url.mmonth#"
...
SELECT batchno FROM argiro WHERE batchno in 
						...
						<tr>
							...
							<td>
								...
								<cfloop query="getbatch">
									<input type="checkbox" name="batch" id="batch" value="#getbatch.batches#">
									&nbsp;&nbsp;#getbatch.batches#
									<br>
								</cfloop>
							</td>
