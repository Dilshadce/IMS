...
,"#dateformat(approvedbydateold,'yyyy-mm-dd')#"
					...
					<cfquery name="getpayroll" datasource="#dts#">
SELECT * FROM manpower_p.#getassignment.paydate#
...
WHERE UPPER(EMPNO) = <cfqueryparam cfsqltype="cf_sql_varchar" value="#UCASE(getassignment.empno)#">
						...
						<td  nowrap="nowrap" align="right">
							#numberformat(val(checkma.totalded),',.__')#
						</td>
						...
						<cfset peecpf = peecpf + numberformat(val(getpayroll.EPFWW),'.__')>
						<cfset subpeecpf = subpeecpf + numberformat(val(getpayroll.EPFWW),'.__')>
						<td  nowrap="nowrap" align="right">
							#numberformat(val(getpayroll.EPFWW),',.__')#
						</td>
						<cfset peesdf = peesdf + numberformat(val(getpayroll.SOCSOWW),'.__')>
						<cfset subpeesdf = subpeesdf + numberformat(val(getpayroll.SOCSOWW),'.__')>
						<td  nowrap="nowrap" align="right">
							#numberformat(val(getpayroll.SOCSOWW),'.__')#
						</td>
						...
						<td  nowrap="nowrap" align="right">
							#numberformat(val(getpayroll.ded115),'.__')+numberformat(val(getpayroll.ded114),'.__')#
						</td>
						<cfset totalnet = numberformat(val(getassignment.selftotal),'.__')-numberformat(val(checkma.totalded),'.__')-numberformat(val(getpayroll.ded115),'.__')-numberformat(val(getpayroll.ded114),'.__')>
						<td  nowrap="nowrap" align="right">
						...
						<cfset percpf = persdf + numberformat(val(getpayroll.EPFCC),'.__')>
						<cfset subpercpf = subpercpf + numberformat(val(getpayroll.EPFCC),'.__')>
						<td  nowrap="nowrap" align="right">
							#numberformat(val(getpayroll.EPFCC),',.__')#
						</td>
						<cfset persdf = persdf + numberformat(val(getpayroll.SOCSOCC),'.__')>
						<cfset subpersdf = subpersdf + numberformat(val(getpayroll.SOCSOCC),'.__')>
						<td  nowrap="nowrap" align="right">
							#numberformat(val(getpayroll.SOCSOCC),',.__')#
						</td>
						<cfset pnetpay = pnetpay + numberformat(val(totalnet),'.__')>
						<cfset subpnetpay = subpnetpay + numberformat(val(totalnet),'.__')>
						<cfset invlesspay = numberformat(val(getassignment.custtotalgross),'.__') - (numberformat(val(getassignment.selftotal)-val(getpayroll.ded101),'.__')+ numberformat(val(checkma.totalamt),'.__')+numberformat(val(getpayroll.EPFWW),'.__')+numberformat(val(levysd.levy_sd),'.__')+numberformat(val(levysd.levy_fw_w),'.__'))>
						<td  nowrap="nowrap" align="right">
...
<cfqueryparam cfsqltype="cf_sql_double" value="#numberformat(val(getpayroll.EPFCC),'.__')#">,
<cfqueryparam cfsqltype="cf_sql_double" value="#numberformat(val(getpayroll.SOCSOCC),'.__')#">,
