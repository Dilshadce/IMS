...
WHERE year(completedate) >= #getpayroll.myear#-1) as b on a.placementno = b.pno
LEFT JOIN
(
...
<cfset filename = hcomid&"_"&payrollmonth&"Pay_Bill_Audit_"&huserid&"_"&timenow&".xls">
<cfset totalpay =0.00>
   ...
   <NumberFormat ss:Format="Fixed"/>
		 ...
		 <Cell ss:StyleID="s23"><Data ss:Type="String">Invoice</Data></Cell>
                    ...
                    <cfif isdefined('form.StaffCode')>
                        <Cell ss:StyleID="s23"><Data ss:Type="String">StaffCode</Data></Cell>
                    </cfif>
...
<Cell ss:StyleID="s65"><Data ss:Type="Number"><cfif val(evaluate('getassignment.fixawee#a#')) neq 0 and val(evaluate('getassignment.fixaweeqty#a#')) neq 0>#numberformat(val(evaluate('getassignment.fixaweeqty#a#')),',.__')#<cfelseif val(evaluate('getassignment.fixawee#a#')) neq 0>1.00<cfelse>0.00</cfif></Data></Cell>
    <Cell ss:StyleID="s65"><Data ss:Type="Number"><cfif val(evaluate('getassignment.fixaweerate#a#')) neq 0>#numberformat(val(evaluate('getassignment.fixaweerate#a#')),',.__')#<cfelse>#numberformat(val(evaluate('getassignment.fixawee#a#')),',.__')#</cfif></Data></Cell>
<Cell ss:StyleID="s65"><Data ss:Type="Number">#numberformat(val(evaluate('getassignment.fixawee#a#')),',.__')#</Data></Cell>
<Cell ss:StyleID="s65"><Data ss:Type="Number"><cfif val(evaluate('getassignment.fixawer#a#')) neq 0 and val(evaluate('getassignment.fixawerqty#a#')) neq 0>#numberformat(val(evaluate('getassignment.fixawerqty#a#')),',.__')#<cfelseif val(evaluate('getassignment.fixawer#a#')) neq 0>1.00<cfelse>0.00</cfif></Data></Cell>
<Cell ss:StyleID="s65"><Data ss:Type="Number"><cfif val(evaluate('getassignment.fixawerrate#a#')) neq 0>#numberformat(val(evaluate('getassignment.fixawerrate#a#')),',.__')#<cfelse>#numberformat(val(evaluate('getassignment.fixawer#a#')),',.__')#</cfif></Data></Cell>
...
<Cell ss:StyleID="s65"><Data ss:Type="Number"><cfif val(evaluate('getassignment.awee#a#')) neq 0 and val(evaluate('getassignment.aweeqty#a#')) neq 0>#numberformat(val(evaluate('getassignment.aweeqty#a#')),',.__')#<cfelseif val(evaluate('getassignment.awee#a#')) neq 0>1.00<cfelse>0.00</cfif></Data></Cell>
<Cell ss:StyleID="s65"><Data ss:Type="Number"><cfif val(evaluate('getassignment.aweerate#a#')) neq 0>#numberformat(val(evaluate('getassignment.aweerate#a#')),',.__')#<cfelse>#numberformat(val(evaluate('getassignment.awee#a#')),',.__')#</cfif></Data></Cell>
<Cell ss:StyleID="s65"><Data ss:Type="Number">#numberformat(val(evaluate('getassignment.awee#a#')),',.__')#</Data></Cell>
<Cell ss:StyleID="s65"><Data ss:Type="Number"><cfif val(evaluate('getassignment.awer#a#')) neq 0 and val(evaluate('getassignment.awerqty#a#')) neq 0>#numberformat(val(evaluate('getassignment.awerqty#a#')),',.__')#<cfelseif val(evaluate('getassignment.awer#a#')) neq 0>1.00<cfelse>0.00</cfif></Data></Cell>
<Cell ss:StyleID="s65"><Data ss:Type="Number"><cfif val(evaluate('getassignment.awerrate#a#')) neq 0>#numberformat(val(evaluate('getassignment.awerrate#a#')),',.__')#<cfelse>#numberformat(val(evaluate('getassignment.awer#a#')),',.__')#</cfif></Data></Cell>
...
<cfif val(getassignment.selfeis) neq 0 or val(getassignment.custeis) neq 0>
<Row ss:AutoFitHeight="0">
<cfinclude template="startrowexcel.cfm">
                 <Cell ss:StyleID="s28"><Data ss:Type="String">EIS</Data></Cell>
<Cell ss:StyleID="s65"><Data ss:Type="Number"><cfif val(getassignment.selfeis) neq 0>1.00<cfelse>0.00</cfif></Data></Cell>
<Cell ss:StyleID="s65"><Data ss:Type="Number"><cfif findnocase('-',getassignment.selfeis)>#numberformat(val(replace(getassignment.selfeis,'-','')),',.__')#<cfelse>-#numberformat(val(getassignment.selfeis),',.__')#</cfif></Data></Cell>
<Cell ss:StyleID="s65"><Data ss:Type="Number"><cfif findnocase('-',getassignment.selfeis)>#numberformat(val(replace(getassignment.selfeis,'-','')),',.__')#<cfelse>-#numberformat(val(getassignment.selfeis),',.__')#</cfif></Data></Cell>
<Cell ss:StyleID="s65"><Data ss:Type="Number"><cfif val(getassignment.custeis) neq 0>1.00<cfelse>0.00</cfif></Data></Cell>
<Cell ss:StyleID="s65"><Data ss:Type="Number">#numberformat(val(getassignment.custeis),',.__')#</Data></Cell>
<Cell ss:StyleID="s65"><Data ss:Type="Number">#numberformat(val(getassignment.custeis),',.__')#</Data></Cell>
<Cell ss:StyleID="s28"><Data ss:Type="String"><cfif numberformat(val(selfeis),'.__') gt numberformat(val(custeis),'.__')>**<cfelse>.</cfif></Data></Cell>
</Row>
</cfif>
...
<cfif val(getassignment.custdeduction) neq 0 or val(getassignment.selfdeduction) neq 0>
<cfloop from="1" to="6" index="a">
...
<cfinclude template="startrowexcel.cfm">
    <cfwddx action = "cfml2wddx" input = "#evaluate('getassignment.billitemdesp#a#')#" output = "wddxText3000">
                 <Cell ss:StyleID="s28"><Data ss:Type="String">#wddxText3000#</Data></Cell>
<Cell ss:StyleID="s65"><Data ss:Type="Number">0.00</Data></Cell>
<Cell ss:StyleID="s65"><Data ss:Type="Number">0.00</Data></Cell>
<Cell ss:StyleID="s65"><Data ss:Type="Number">0.00</Data></Cell>
...
<cfwddx action = "cfml2wddx" input = "#getassignment.payrollperiod#" output = "wddxText14">
    <cfwddx action = "cfml2wddx" input = "#getassignment.consultant#" output = "wddxText15">
...
<Cell ss:StyleID="s28"><Data ss:Type="String">#wddxText11#</Data></Cell>
                    ...
                    <cfif isdefined('form.StaffCode')>
                        <Cell ss:StyleID="s28"><Data ss:Type="String">#wddxText15#</Data></Cell>
                    </cfif>
