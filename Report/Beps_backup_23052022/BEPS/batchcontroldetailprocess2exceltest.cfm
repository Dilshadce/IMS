...
where 
    <!---Added by Nieo 20171117 1038 for new filter requirement--->
    a.fperiod between #numberformat(form.month,'00')# and #numberformat(form.monthto,'00')#
    <!---Added by Nieo 20171117 1038 for new filter requirement--->
...
<cfset filename = hcomid&"_"&payrollmonth&"Pay_Bill_Audit_"&getauthuser()&"_"&timenow&"_new.xls">
...
<Cell ss:StyleID="s28"><Data ss:Type="String">#wddxText1100#</Data></Cell>
                    ...
                    <cfif isdefined('form.StaffCode')>
                        <Cell ss:StyleID="s28"><Data ss:Type="String">#wddxText1500#</Data></Cell>
                    </cfif>
