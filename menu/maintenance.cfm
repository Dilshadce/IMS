...
<cfoutput>
    ...
    <cfif left(lcase(HcomID),4) eq "beps">
    	<li>
			<a href="/#HDir#/maintenance/Placementnew/s_Placementtable.cfm" target="mainFrame">
				Placement Profile
			</a>
		</li>
   
   		 <li>
			<a href="/#HDir#/maintenance/placementleavetable/s_placementleave.cfm" target="mainFrame">
				Placement Leave
			</a>
		</li>
    </cfif>
     ...
     <cfif getpin2.h1300 eq "T">
    	...
    	<li>
			<a href="/#HDir#/maintenance/branch/branchtable.cfm" target="mainFrame">
				Branch Profile
			</a>
		</li>
        <li>
			<a href="/#HDir#/maintenance/branchitemno/branchitemno.cfm" target="mainFrame">
				Branch Item No Profile
			</a>
		</li>
        <li>
			<a href="/#HDir#/maintenance/monthlytransfer/monthlytransfertable.cfm" target="mainFrame">
				Transfer Limit Profile
			</a>
		</li>
    ...
    <li>
			<a href="/#HDir#/maintenance/package/packagetable.cfm" target="mainFrame">
				Package Profile
			</a>
	</li>
    <li>
			<a href="/#HDir#/maintenance/shellvehicles/S_vehicles.cfm" target="mainFrame">
				Vehicle Profile
			</a>
	</li>
    <li>
			<a href="/#HDir#/maintenance/make/maketable.cfm" target="mainFrame">
				Make Profile
			</a>
	</li>
    <li>
			<a href="/#HDir#/maintenance/model/modeltable.cfm" target="mainFrame">
				Model Profile
			</a>
	</li>
    <cfif getpin2.h1Q10 eq "T">
    <li>
			<a href="/#HDir#/maintenance/capacity/capacitytable.cfm" target="mainFrame">
				Capacity Profile
			</a>
	</li>
    </cfif>
    ...
    <li>
			<a href="/#HDir#/maintenance/Colour/colourtable.cfm" target="mainFrame">
				Colour Profile
			</a>
	</li>
    </cfif>
    <li>
			<a href="https://crm.netiquette.com.sg/" target="mainFrame">
				Link to CRM
			</a>
	</li>
    </cfif>
	...
	<cfif getpin2.h1D00 eq "T">
      ...
      <a href="/#HDir#/maintenance/locationtable.cfm" target="mainFrame">#getgeneral.lLOCATION#</a>
	</cfif>
	</cfif>
    ...
    <cfif getpin2.h1ZB0 eq "T">
		<li>
			<a href="/#HDir#/maintenance/identifier/Identifiertable.cfm" target="mainFrame">
				Identifier Profile
			</a>
		</li>
	</cfif>
