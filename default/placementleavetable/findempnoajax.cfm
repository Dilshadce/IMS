<cfset dts1 = replace(dts,'_i','_p','All')>
    ...
    <td><a style="cursor:pointer" onClick="selectlist('#getitemno.empno#','#url.nametype#');<cfif url.nametype eq "empfrom">selectlist('#getitemno.empno#','empto');</cfif>ColdFusion.Window.hide('findempno');" >SELECT</a></td>
    </tr>
    </cfloop>
