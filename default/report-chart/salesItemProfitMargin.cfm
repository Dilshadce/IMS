...
<html>
<head>
<title>Sales Item Profit Margin Chart</title>
...
<cfoutput>
<h3>
	<a href="chartmenu.cfm">Chart Report Menu</a> >> 
	<a><font size="2">Sales Item Profit Margin </font></a>
</h3>
...
<form name="salesItemProfitMargin" action="salesItemProfitMarginChart.cfm?type=Item" method="post" target="_blank">

	<input type="hidden" name="tran" id="tran" value="Item" />
...
<tr>
      	...
      	<td colspan="2">
			<select name="itemfrom">
          		...
          		<cfloop query="getitem"><option value="#itemno#">#itemno# - #desp#</option></cfloop>
			</select>
...
<cfwindow center="true" width="550" height="400" name="finditem" refreshOnShow="true"
        ...
        source="finditem.cfm?type={tran}&fromto={fromto}" />