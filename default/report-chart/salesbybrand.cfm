...
<body>
<cfoutput>
<!--- <h2>Print Sales by Brand</h2> --->
<h3>
	<a href="chartmenu.cfm">Chart Report Menu</a> >> 
	<a><font size="2">Print Sales by Brand</font></a>
</h3>
...
<form name="salesbybrand" action="salesbybrandGraph.cfm?trantype=Brand&alown=#alown#" method="post" target="_blank">
