...
<h3>
	...
	<a><font size="2">Sales Agent Profit Margin Chart</font></a>
</h3>
...
<form name="salesAgentProfitMargin" action="salesAgentProfitMarginChart.cfm?trantype=Agent&alown=#alown#" method="post" target="_blank">
