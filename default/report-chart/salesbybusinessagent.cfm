...
<body>
<cfoutput>
<!--- <h2>Purchase by Brand</h2> --->
<h3>
	<a href="chartmenu.cfm">Chart Report Menu</a> >> 
	<a><font size="2">Print Business Sales by Agent</font></a>
</h3>
...
<form name="salesbybusiness" action="salesbybusinessagentGraph.cfm?trantype=Business&alown=#alown#" method="post" target="_blank">
<table width="60%" border="0" cellspacing="0" cellpadding="3" class="data" align="center">
    ...
    <tr>
		<th>Business From</th>
        <td><select name="businessfrom">
				<option value="">Choose an Business</option>
