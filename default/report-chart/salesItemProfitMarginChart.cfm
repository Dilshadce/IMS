...
<cfoutput>
  <form name="chartform" id="chartform" action="salesItemProfitMarginChart.cfm? method="post">
  	<input type="hidden" id="itemfrom" name="itemfrom" value="#form.itemfrom#">
	<input type="hidden" id="itemto" name="itemto" value="#form.itemto#">
