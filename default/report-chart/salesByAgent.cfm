...
<body>
<cfoutput>
<!--- <h2>Print Sales by Agent</h2> --->
<h3>
	<a href="chartmenu.cfm">Chart Report Menu</a> >> 
	<a><font size="2">Print By Agent Chart</font></a>
</h3>
...
<form name="salesByAgent" action="salesByAgentGraph.cfm?trantype=Agent&alown=#alown#" method="post" target="_blank">
