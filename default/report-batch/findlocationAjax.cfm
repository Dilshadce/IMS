 <cfquery name="getlocation" datasource="#dts#">
    ...
    <td><a onMouseOver="JavaScript:this.style.cursor='hand';" onClick="selectlist('#getlocation.xlocation#','location#url.fromto#');ColdFusion.Window.hide('findlocation');" >SELECT</a></td>
    </tr>
    </cfloop>
