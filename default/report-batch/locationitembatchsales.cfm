...
<cfswitch expression="#form.result#">
	...
	<Row ss:AutoFitHeight="0" ss:Height="23.0625">
		<Cell ss:MergeAcross="7" ss:StyleID="s22"><Data ss:Type="String">Print Location Item <cfif checkcustom.customcompany eq "Y">- Lot Number<cfelse>Batch</cfif> Sales Report</Data></Cell>
	</Row>
...
--->
	...
	<table width="100%" border="0" cellspacing="1" cellpadding="2">
		<tr>
			<td colspan="100%"><div align="center"><font size="3" face="Times New Roman, Times, serif"><strong>Print Location Item <cfif checkcustom.customcompany eq "Y">- Lot Number<cfelse>Batch</cfif> Sales Report</strong></font></div></td>
		</tr>
		<cfif form.batchcodefrom neq "" and form.batchcodeto neq "">
			<tr>
