...
<cfswitch expression="#form.result#">
	...
	<Row ss:AutoFitHeight="0" ss:Height="23.0625">
		<Cell ss:MergeAcross="6" ss:StyleID="s22"><Data ss:Type="String">Print <cfif checkcustom.customcompany eq "Y">Lot Number -<cfelse>Batch</cfif> Item Listing Report</Data></Cell>
	</Row>
...
--->
	...
	<html>
	<head>
	<title>Batch Item Listing Opening Report</title>
	...
	<table width="100%" border="0" cellspacing="0" cellpadding="2">
		<tr>
			<td colspan="100%"><div align="center"><font size="3" face="Times New Roman, Times, serif"><strong>Print <cfif checkcustom.customcompany eq "Y">Lot Number -<cfelse>Batch</cfif> Item Listing Report</strong></font></div></td>
		</tr>
		<cfif form.batchcodefrom neq "" and form.batchcodeto neq "">
			<tr>
