...
<head>
	...
	function closenref()
	{
	ColdFusion.Window.hide('createhistoryprice');
	...
	<title>History Price Maintenance</title>
</head>

<body>
<h1>History Price Maintenance for Item No <cfoutput>#url.itemno#</cfoutput></h1><cfoutput>
<h4>
<a onClick="ColdFusion.Window.show('createhistoryprice');" onMouseOver="this.style.cursor='hand'">Create New History Price</a>|<a href="p_historyprice.cfm?itemno=#url.itemno#">History Price Listing</a></h4>	</cfoutput>
 <cfoutput>
		<cfform>
			<table border="1" width="90%" align="center">
				<tr>
					<td>
						<cfinput type="hidden" id="filtercolumn" name="filtercolumn" value="itemno">
						<cfinput type="hidden" id="filter" name="filter" value="#url.itemno#">
						<cfinput type="hidden" name="filterbutton" value="Go" id="filterbutton"
					...
					<td id="gridtd" style="padding-top:10px;">
						<div style="min-heigh:200px;">
							<cfgrid name="usersgrid" pagesize="10" format="html" width="100%" height="280"
								bind="cfc:historypricerecord.getBatchs({cfgridpage},{cfgridpagesize},{cfgridsortcolumn},{cfgridsortdirection},{filtercolumn},{filter},'#dts#')"
                                onchange="cfc:historypricerecord.editBatch({cfgridaction},
                                            {cfgridrow},
                                            {cfgridchanged},'#dts#','#HUserID#')" selectmode="edit" textcolor="##000000" delete="yes" deletebutton="Delete">
                                <cfgridcolumn name="itemno" header="Item No" width="150" select="no" >
								<cfgridcolumn name="price" header="Price" width="300">
								<cfgridcolumn name="enddate" header="End Date" mask="DD/MM/YYYY" type="date"  width="300">
							</cfgrid>
						</div>			
					</td>
				</tr>
...
<cfoutput>
<cfwindow name="createhistoryprice" center="true" source="createhistoryprice.cfm?itemno=#url.itemno#" modal="true" closable="true" width="630" height="500" refreshonshow="true" title="Create New Voucher" />
</cfoutput>
</html>