...
<cfloop index="LoopCount" from="1" to="#iDecl_UPrice#">
	...
	<cfif form.periodfrom neq "" and form.periodto neq "">
            ...
            <Row ss:AutoFitHeight="0" ss:Height="20.0625">
						<Cell ss:StyleID="s51"><Data ss:Type="String">Category : #getcate.cate#</Data></Cell>
					</Row>
<cfquery name="showcomm" datasource="#dts#">
select ifnull(c.totalpay,0) as totalpay,ifnull(b.disp1,0) as disp1,a.itemno,a.desp,a.refno,a.type,ifnull(a.price,0) as price,ifnull(a.dispec1,0) as dispec1,ifnull(a.disamt,0) as disamt,ifnull(a.amt,0) as amt,a.wos_date,b.agenno,a.qty,ifnull(b.disp1,0) as disp1,a.unit from ictran as a
...
left join(
select billno_postid,date,billdate,sum(invamt) as totalpay,billno from #dts1#.arpay where billno_postid in (<cfqueryparam cfsqltype="cf_sql_varchar" list="yes" separator="," value="#arpostvaluelist#">) and datediff(date,billdate) <= 30 group by billno
)as c on a.refno=c.billno

where  b.net-c.totalpay<=0
...
where a.commid=b.commrateid
and a.cate='#getcate.cate#'
