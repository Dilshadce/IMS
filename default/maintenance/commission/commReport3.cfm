...
<cfset url.type = "agentproducttype">
...
<cfswitch expression="#type#">
	<cfcase value="customerproducttype">
		...
		<form name="itemsales" action="itemtype1.cfm?trantype=#trantype#" method="post" target="_blank">
	</cfcase>
	
	<cfcase value="productcustomertype">
		<cfset trantype = "PRODUCT - CUSTOMER SALES">
		<form name="itemsales" action="itemtype2.cfm?trantype=#trantype#" method="post" target="_blank">
	</cfcase>
	
	<cfcase value="agentproducttype">
		<cfset trantype = "AGENT - PRODUCT SALES">
		<form name="itemsales" action="commReportPro3.cfm?trantype=#trantype#" method="post" target="_blank">
	</cfcase>
</cfswitch>
