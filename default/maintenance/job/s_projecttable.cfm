...
<h1><cfoutput>Project Selection Page</cfoutput></h1>
		
<cfoutput>
  <h4><cfif getpin2.h1H10 eq 'T'><a href="Projecttable2.cfm?type=Create">Creating a #getgeneral.layer#</a> </cfif><cfif getpin2.h1H20 eq 'T'>|| <a href="Projecttable.cfm?">List 
    all #getgeneral.layer#</a> </cfif><cfif getpin2.h1H30 eq 'T'>|| <a href="s_Projecttable.cfm?type=project">Search For #getgeneral.layer#</a>|| <a href="p_project.cfm">#getgeneral.layer# Listing Report</a></cfif></h4>
</cfoutput>
		...
		<form action="s_Projecttable.cfm" method="post"></cfoutput>
			...
			<select name="searchType">
				...
				<option value="porj">P or J</option>
			</select>
	...
	<cfif isdefined("form.skeypage")>
		...
		<cfquery datasource='#dts#' name="type">
			Select * FROM #target_project# where porj = "J" order by source, project, porj
		</cfquery>
		
		<cfif isdefined("form.searchStr")>
			<cfquery datasource='#dts#' name="exactResult">
				Select * FROM #target_project# where #form.searchType# = '#form.searchStr#' and porj = "J" order by #form.searchType#
			</cfquery>
			
			<cfquery datasource='#dts#' name="similarResult">
				Select * FROM #target_project# where #form.searchType# LIKE '#form.searchStr#' and porj = "J" order by #form.searchType#
			</cfquery>
