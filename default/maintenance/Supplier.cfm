...
<cfquery name="getcodepatern" datasource="#dts#">
	...
	creditorto,
    countryddl,
    suppno ,dfsuppcode,df_purchasetaxzero,defaultNONGSTcustomer
	from gsetup;
</cfquery>
...
<cfif url.type eq "Edit">
  ...
  <cfset autopay="O">
  <!--- ADD ON 26-11-2009 --->
  <cfset groupto=getcodepatern.creditorfr&"/000">
  <!--- ADD ON 26-11-2009 --->
  <cfset arrem1="">
  <cfset arrem2="">
  <cfset arrem3="">
...
<cfoutput>
  ...
  <h4>
    ...
    <a href="vPersonnel.cfm?type=Supplier">List all Supplier</a> || <a href="linkPage.cfm?type=Supplier">Search Supplier</a> || <a href="p_suppcust.cfm?type=Supplier">Supplier Listing</a> </h4>
</cfoutput> <cfoutput>
  <form name="SupplierForm" action="/default/maintenance/SupplierProcess.cfm" method="post" 
    ...
    <table align="center" class="data" width="80%">
      <tr>
        ...
        <td colspan="3"><cfif mode eq "Delete" or mode eq "Edit">
            ...
            <cfelse>
            <input type="text" size="40" name="custno" value="<cfif getrefno.refnoused eq 1>#nextcustno#<cfelse>#custno#</cfif>" maxlength="8">
            <input type="hidden" name="nexcustno" id="nexcustno" value="#getcodepatern.suppno#" >
          ...
          Open Item Supplier </td>
      </tr>
      <tr>
        <th> Name </th>
        <td colspan="3"><input type="text" size="40" name="Name" value="#Name#" maxlength="40">
          <cfif mode eq "Create">
            &nbsp;&nbsp;&nbsp;&nbsp;
            <input type="checkbox" name="check" value="Y" onClick="checkSimilar();ajaxFunction(document.getElementById('ajaxField1'),'/default/maintenance/ajaxAction.cfm?dfunction=checkSimilarSupplier&name='+document.getElementById('Name').value);">
            Bad Status
      ...
      <tr <cfif getdisplaysetup2.supp_profile_nongstsuppomer neq 'Y'>style="display:none"</cfif>>
        <th width="20%">Non GST Supplier </th>
        <td width="30%"><input type="checkbox" name="ngst_cust" value="#ngst_cust#" <cfif ngst_cust eq "T">checked</cfif> onClick="ajaxFunction(document.getElementById('taxcodeajax'),'taxcodeajax2.cfm?ngst_cust='+document.getElementById('ngst_cust').checked+'&custno='+document.getElementById('custno').value);">
          <div id="taxcodeajax">
            <cfif ngst_cust eq 'T'>
        ...
        <th width="20%" <cfif getdisplaysetup2.supp_profile_Terms neq 'Y'>style="display:none"</cfif>>Terms</th>
        <td width="30%" style="vertical-align:middle" <cfif getdisplaysetup2.supp_profile_Terms neq 'Y'>style="display:none"</cfif>><select name="term" id="term">
      ...
      <tr <cfif getdisplaysetup2.supp_profile_taxincluded neq 'Y'>style="display:none"</cfif>>
        ...
        <th <cfif getdisplaysetup2.supp_profile_agent neq 'Y'>style="display:none"</cfif>>Agent</th>
        <td <cfif getdisplaysetup2.supp_profile_agent neq 'Y'>style="display:none"</cfif>><input type="text" name="agent" id="agent" value="#xagent#" maxlength="50" size="40"></td>
      </tr>
      <tr >
        <th <cfif getdisplaysetup2.supp_profile_groupto neq 'Y'>style="visibility:hidden"</cfif>>Group To </th>
        <td <cfif getdisplaysetup2.supp_profile_groupto neq 'Y'>style="visibility:hidden"</cfif>><input name="groupto" type="text" maxlength="12" value="#groupto#" size="15"></td>
        <th <cfif getdisplaysetup2.supp_profile_CurrencyCode neq 'Y'>style="display:none"</cfif>>Currency Code #currcode1#</th>
        <td <cfif getdisplaysetup2.supp_profile_CurrencyCode neq 'Y'>style="display:none"</cfif>><select name="currcode" id="currcode" onChange="javascript:displayrate()">
            ...
            <cfloop query="showall">
              <option value="#showall.CurrCode#" 
							<cfif showall.currcode eq '#currcode1#'>selected</cfif>> #showall.currcode# - #showall.Currency# </option>
            </cfloop>
          </select></td>
      </tr>
    </table>
    ...
    <table align="center" id="transaction_menu_page1" class="data" width="80%">
      <tr <cfif getdisplaysetup2.supp_profile_address neq 'Y'>style="display:none"</cfif>>
        ...
        <td width="30%"><input type="text" size="40" name="Add1" value="#Add1#" maxlength="35" ></td>
        <cfif getdisplaysetup2.supp_profile_deliveryaddress neq 'Y'>
          style="display:none"
        </cfif>
        <th width="20%">Delivery Address
          <input type="button" name="btn_copy" id="btn_copy" value="Copy Address" onClick=
                ...
                " /></th>
        <td width="30%"><input type="text" size="40" name="DAddr1" value="#DAddr1#" maxlength="35"></td>
      </tr>
      <tr <cfif getdisplaysetup2.supp_profile_address neq 'Y'>style="display:none"</cfif>>
        <td></td>
      ...
      <cfif getcodepatern.countryddl eq 'Y'>
        <tr>
          <th <cfif getdisplaysetup2.supp_profile_country neq 'Y'>style="display:none"</cfif>>Country :</th>
          <td <cfif getdisplaysetup2.supp_profile_country neq 'Y'>style="display:none"</cfif>><cfquery name="getcountrylist" datasource="#dts#">
		SELECT * FROM droplistcountry
          ...
          <th <cfif getdisplaysetup2.supp_profile_deliverycountry neq 'Y'>style="display:none"</cfif>>Delivery Country :</th>
          <td <cfif getdisplaysetup2.supp_profile_deliverycountry neq 'Y'>style="display:none"</cfif>><cfset singapore = "Singapore">
        ...
        <tr >
          <th <cfif getdisplaysetup2.supp_profile_country neq 'Y'>style="display:none"</cfif>>Country :</th>
          <td <cfif getdisplaysetup2.supp_profile_country neq 'Y'>style="display:none"</cfif>><input type="text" size="40" name="country" value="#country#" maxlength="50" ></td>
          <th <cfif getdisplaysetup2.supp_profile_deliverycountry neq 'Y'>style="display:none"</cfif>>Delivery Country :</th>
          <td <cfif getdisplaysetup2.supp_profile_deliverycountry neq 'Y'>style="display:none"</cfif>><input type="text" size="40" name="d_country" value="#d_country#" maxlength="50"></td>
        </tr>
      </cfif>
      <tr>
        <th <cfif getdisplaysetup2.supp_profile_postalcode neq 'Y'>style="display:none"</cfif>>Postal Code </th>
        <td <cfif getdisplaysetup2.supp_profile_postalcode neq 'Y'>style="display:none"</cfif>><input type="text" size="40" name="postalcode" value="#postalcode#" maxlength="50" ></td>
        <th <cfif getdisplaysetup2.supp_profile_deliverypostalcode neq 'Y'>style="display:none"</cfif>>Delivery Postal Code </th>
        <td <cfif getdisplaysetup2.supp_profile_deliverypostalcode neq 'Y'>style="display:none"</cfif>><input type="text" size="40" name="d_postalcode" value="#d_postalcode#" maxlength="50"></td>
      </tr>
      <tr>
        <th <cfif getdisplaysetup2.supp_profile_attention neq 'Y'>style="display:none"</cfif>>Attention </th>
        <td <cfif getdisplaysetup2.supp_profile_attention neq 'Y'>style="display:none"</cfif>><input type="text" size="40" name="Attn"  value="#attn#" maxlength="35" ></td>
        <th <cfif getdisplaysetup2.supp_profile_deliveryattention neq 'Y'>style="display:none"</cfif>>Delivery Attention </th>
        <td <cfif getdisplaysetup2.supp_profile_deliveryattention neq 'Y'>style="display:none"</cfif>><input type="text" size="40" name="DAttn"  value="#dattn#" maxlength="35"></td>
      </tr>
      <tr>
        <th <cfif getdisplaysetup2.supp_profile_phone neq 'Y'>style="display:none"</cfif>>Phone</th>
        <td <cfif getdisplaysetup2.supp_profile_phone neq 'Y'>style="display:none"</cfif>><input type="text" size="40" name="phone" value="#phone#" maxlength="25" ></td>
        <th <cfif getdisplaysetup2.supp_profile_deliveryphone neq 'Y'>style="display:none"</cfif>>Delivery Phone</th>
        <td <cfif getdisplaysetup2.supp_profile_deliveryphone neq 'Y'>style="display:none"</cfif>><input type="text" size="40" name="dphone" value="#dphone#" maxlength="25"></td>
      </tr>
      <tr>
        <th <cfif getdisplaysetup2.supp_profile_phone2 neq 'Y'>style="display:none"</cfif>><cfif lcase(HcomID) eq "mastercare_i" or lcase(HcomID) eq "gorgeous_i">
            HP
            <cfelse>
            Phone 2
          </cfif>
        </th>
        <td <cfif getdisplaysetup2.supp_profile_phone2 neq 'Y'>style="display:none"</cfif>><input type="text" size="40" name="phonea" value="#phonea#" maxlength="25"></td>
        <th <cfif getdisplaysetup2.supp_profile_deliveryfax neq 'Y'>style="display:none"</cfif>>Delivery Fax</th>
        <td <cfif getdisplaysetup2.supp_profile_deliveryfax neq 'Y'>style="display:none"</cfif>><input type="text" size="40" name="dfax" value="#dfax#" maxlength="25"></td>
      <tr >
        <th <cfif getdisplaysetup2.supp_profile_fax neq 'Y'>style="display:none"</cfif>>Fax</th>
        <td <cfif getdisplaysetup2.supp_profile_fax neq 'Y'>style="display:none"</cfif>><input type="text" size="40" name="Fax" value="#Fax#" maxlength="25" ></td>
        <th <cfif getdisplaysetup2.supp_profile_contact neq 'Y'>style="display:none"</cfif>><cfif lcase(HcomID) eq "varz_i">
            REP
            <cfelse>
            Contact
          </cfif></th>
        <td <cfif getdisplaysetup2.supp_profile_contact neq 'Y'>style="display:none"</cfif>><input type="text" size="40" name="contact"  value="#contact#" maxlength="15"></td>
      </tr>
      <tr >
        <th width="20%" <cfif getdisplaysetup2.supp_profile_website neq 'Y'>style="display:none"</cfif>>Web Site </th>
        <td width="30%" <cfif getdisplaysetup2.supp_profile_website neq 'Y'>style="display:none"</cfif>><input type="text" size="40" name="web_site" value="#website#" maxlength="50"></td>
        <th width="20%" <cfif getdisplaysetup2.supp_profile_email neq 'Y'>style="display:none"</cfif>>Email </th>
        <td width="30%" <cfif getdisplaysetup2.supp_profile_email neq 'Y'>style="display:none"</cfif>><input type="text" size="40" name="e_mail" value="#email#" maxlength="90"></td>
      </tr>
    </table>
    ...
    select * from driver order by driverno
      ...
      <tr>
        <th <cfif getdisplaysetup2.supp_profile_EndUser neq 'Y'>style="display:none"</cfif>>End User </th>
        <td <cfif getdisplaysetup2.supp_profile_EndUser neq 'Y'>style="display:none"</cfif>><select name="enduser" id="enduser">
      ...
      <tr >
        <th <cfif getdisplaysetup2.supp_profile_InvoiceLimit neq 'Y'>style="display:none"</cfif>>Invoice Limit </th>
        <td <cfif getdisplaysetup2.supp_profile_InvoiceLimit neq 'Y'>style="display:none"</cfif>><input type="text" size="40" name="invLimit" value="#invLimit#" maxlength="19"></td>
        <th <cfif getdisplaysetup2.supp_profile_DiscountPercentageCategory neq 'Y'>style="display:none"</cfif>>Discount Percentage Category </th>
        <td <cfif getdisplaysetup2.supp_profile_DiscountPercentageCategory neq 'Y'>style="display:none"</cfif>><input type="text" size="40" name="dispec_cat" value="#dispec_cat#" maxlength="1"></td>
      </tr>
      <tr >
        <th <cfif getdisplaysetup2.supp_profile_Area neq 'Y'>style="display:none"</cfif>>Area </th>
        <td <cfif getdisplaysetup2.supp_profile_Area neq 'Y'>style="display:none"</cfif>><select name="area" id="area">
        ...
        <th <cfif getdisplaysetup2.supp_profile_DiscountPercentageLevel1 neq 'Y'>style="display:none"</cfif>>Discount Percentage Level 1 </th>
        <td <cfif getdisplaysetup2.supp_profile_DiscountPercentageLevel1 neq 'Y'>style="display:none"</cfif>><input type="text" size="40" name="dispec1" value="#dispec1#" maxlength="5"></td>
      </tr>
      <tr>
        <th <cfif getdisplaysetup2.supp_profile_Business neq 'Y'>style="display:none"</cfif>>Business </th>
        <td <cfif getdisplaysetup2.supp_profile_Business neq 'Y'>style="display:none"</cfif>><select name="business" id="business">
        ...
        <th <cfif getdisplaysetup2.supp_profile_DiscountPercentageLevel2 neq 'Y'>style="display:none"</cfif>>Discount Percentage Level 2 </th>
        <td <cfif getdisplaysetup2.supp_profile_DiscountPercentageLevel2 neq 'Y'>style="display:none"</cfif>><input type="text" size="40" name="dispec2" value="#dispec2#" maxlength="5"></td>
      </tr>
      <tr >
        <th></th>
        <td></td>
        <th <cfif getdisplaysetup2.supp_profile_DiscountPercentageLevel3 neq 'Y'>style="display:none"</cfif>>Discount Percentage Level 3 </th>
        <td <cfif getdisplaysetup2.supp_profile_DiscountPercentageLevel3 neq 'Y'>style="display:none"</cfif>><input type="text" size="40" name="dispec3" value="#dispec3#" maxlength="5"></td>
      </tr>
      <cfif Hlinkams eq "Y">
        <tr >
          <th <cfif getdisplaysetup2.supp_profile_PurchaseCode neq 'Y'>style="display:none"</cfif>>Purchase Code:</th>
          <td <cfif getdisplaysetup2.supp_profile_PurchaseCode neq 'Y'>style="display:none"</cfif>><select name="SALEC">
          ...
          <th <cfif getdisplaysetup2.supp_profile_PurchaseReturnCode neq 'Y'>style="display:none"</cfif>>Purchase Return Code:</th>
          <td <cfif getdisplaysetup2.supp_profile_PurchaseReturnCode neq 'Y'>style="display:none"</cfif>><select name="SALECNC">
        ...
        <tr>
          <th <cfif getdisplaysetup2.supp_profile_PurchaseCode neq 'Y'>style="display:none"</cfif>>Purchase Code:</th>
          <td <cfif getdisplaysetup2.supp_profile_PurchaseCode neq 'Y'>style="display:none"</cfif>><input type="text" size="40" name="SALEC" id="SALEC" value="#SALEC#" mask="1111/111" maxlength="7"></td>
          <th <cfif getdisplaysetup2.supp_profile_PurchaseReturnCode neq 'Y'>style="display:none"</cfif>>Purchase Return Code:</th>
          <td <cfif getdisplaysetup2.supp_profile_PurchaseReturnCode neq 'Y'>style="display:none"</cfif>><input type="text" size="40" name="SALECNC" id="SALECNC" value="#SALECNC#" mask="1111/111" maxlength="7"></td>
        </tr>
        
      </cfif>
      <tr >
        <th <cfif getdisplaysetup2.supp_profile_CreditLimit neq 'Y'>style="display:none"</cfif>>Credit Limit </th>
        <td <cfif getdisplaysetup2.supp_profile_CreditLimit neq 'Y'>style="display:none"</cfif>><input type="text" size="40" name="crlimit" value="#crlimit#" maxlength="19"></td>
        <th <cfif getdisplaysetup2.supp_profile_Remark1 neq 'Y'>style="display:none"</cfif>><cfif lcase(HcomID) eq "varz_i">
            Ship Date
            <cfelse>
            #getcustremark.cust_rem1#
          </cfif>
        </th>
        <td <cfif getdisplaysetup2.supp_profile_Remark1 neq 'Y'>style="display:none"</cfif>><input type="text" size="40" name="arrem1" id="arrem1" value="#arrem1#" maxlength="35"></td>
      </tr>
      <tr >
        <th <cfif getdisplaysetup2.supp_profile_Currency neq 'Y'>style="display:none"</cfif>>Currency</th>
        <td <cfif getdisplaysetup2.supp_profile_Currency neq 'Y'>style="display:none"</cfif>><input type="text" size="40" name="currency" value="#currency#" maxlength="10"></td>
        <th <cfif getdisplaysetup2.supp_profile_Remark2 neq 'Y'>style="display:none"</cfif>><cfif lcase(HcomID) eq "varz_i">
            Ship Via
            <cfelse>
            #getcustremark.cust_rem2#
          </cfif>
        </th>
        <td  <cfif getdisplaysetup2.supp_profile_Remark2 neq 'Y'>style="display:none"</cfif>><input type="text" size="40" name="arrem2" id="arrem2" value="#arrem2#" maxlength="35"></td>
      </tr>
      <tr >
        <th <cfif getdisplaysetup2.supp_profile_CurrencyDollar neq 'Y'>style="display:none"</cfif>>Currency Dollar </th>
        <td <cfif getdisplaysetup2.supp_profile_CurrencyDollar neq 'Y'>style="display:none"</cfif>><input type="text" size="40" name="currency1" value="#currency1#" maxlength="17"></td>
        <th <cfif getdisplaysetup2.supp_profile_Remark3 neq 'Y'>style="display:none"</cfif>><cfif lcase(HcomID) eq "varz_i">
            Ship Terms
            <cfelse>
            #getcustremark.cust_rem3#
          </cfif>
        </th>
        <td <cfif getdisplaysetup2.supp_profile_Remark3 neq 'Y'>style="display:none"</cfif>><input type="text" size="40" name="arrem3" id="arrem3" value="#arrem3#" maxlength="35"></td>
      </tr>
      <tr >
        <th <cfif getdisplaysetup2.supp_profile_CurrencyDollar2 neq 'Y'>style="display:none"</cfif>>Currency Dollar 2 </th>
        <td <cfif getdisplaysetup2.supp_profile_CurrencyDollar2 neq 'Y'>style="display:none"</cfif>><input type="text" size="40" name="currency2" value="#currency2#" maxlength="17"></td>
        <th <cfif getdisplaysetup2.supp_profile_Remark4 neq 'Y'>style="display:none"</cfif>><cfif lcase(HcomID) eq "varz_i">
            Expected
            <cfelse>
            #getcustremark.cust_rem4#
          </cfif>
        </th>
        <td <cfif getdisplaysetup2.supp_profile_Remark4 neq 'Y'>style="display:none"</cfif>><input type="text" size="40" name="arrem4" id="arrem4" value="#arrem4#" maxlength="35"></td>
      </tr>
      <tr >
        <th <cfif getdisplaysetup2.supp_profile_Status neq 'Y'>style="display:none"</cfif>>Status :</th>
        <td <cfif getdisplaysetup2.supp_profile_Status neq 'Y'>style="display:none"</cfif>><input type="checkbox" name="status" value="B" <cfif status eq "B">checked</cfif>></td>
        <th <cfif getdisplaysetup2.supp_profile_Date neq 'Y'>style="display:none"</cfif>>Date </th>
        <td <cfif getdisplaysetup2.supp_profile_Date neq 'Y'>style="display:none"</cfif>><input type="text" size="40" name="date" value="#date#" readonly></td>
      </tr>
    </table>
    <table class="data" width="80%" align="center">
      <tr>
        <td></td>
        <td align="center"><cfif getpin2.h1112 neq 'T'>
