...
select itemformat from dealer_menu
    ...
    <td>#getattn.name#</td>
    <td><a onMouseOver="JavaScript:this.style.cursor='hand';" onClick="document.getElementById('#nametype#').value='#getattn.attentionno#';ColdFusion.Window.hide('findattn2');" >SELECT</a></td>
    </tr>
    </cfloop>
