<html>
<head>
	<title>Maintenance Model</title></title>
...
<cfif getPersonnel.recordcount neq 0>
	...
	<cfform action="Modeltable.cfm" method="post">
		...
		<cfif start neq 1>
			<cfoutput>|| <a href="modeltable.cfm?start=#prevFive#">Previous</a> ||</cfoutput>
		</cfif>

		<cfif page neq noOfPage>
			<cfoutput> <a href="modeltable.cfm?start=#evaluate(nextFive)#">Next</a> ||</cfoutput>
		</cfif>
		...
		<cfoutput query="getPersonnel" startrow="#start#" maxrows="5">
			<cfset strNo = 'getPersonnel.Model'>
			...
			<table align="center" class="data" width="50%">
				...
				<tr>
					...
					<a href="Modeltable2.cfm?type=Delete&Model=#evaluate(strNo)#"><img height="18px" width="18px" src="/images/delete.ICO" alt="Delete" border="0">Delete</a>
			  		<a href="Modeltable2.cfm?type=Edit&Model=#evaluate(strNo)#"><img height="18px" width="18px" src="/images/edit.ICO" alt="Edit" border="0">Edit</a></div></td>
        		</tr>
				</cfif>
     	 	</table>
			<br>
