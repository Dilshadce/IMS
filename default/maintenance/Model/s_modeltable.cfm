...
<body>
<h1>Model Selection Page</h1>

<cfoutput>
	<h4>
	<cfif getpin2.h1F10 eq 'T'><a href="Modeltable2.cfm?type=Create">Creating A New Model</a> </cfif>
    ...
    <cfif getpin2.h1630 eq 'T'>|| <a href="p_Model.cfm">Model Listing</a></cfif>
	</h4>

    <form action="s_Modeltable.cfm" method="post">
		<h1>Search By :
	...
	<cfif isdefined("url.process")>
  	...
  	<cfif isdefined("form.searchStr")>
  		<cfquery datasource="#dts#" name="exactResult">
    		select * from vehiModel where #form.searchType# = '#form.searchStr#' order by #form.searchType#
		</cfquery>
			
  		<cfquery datasource="#dts#" name="similarResult">
    		select * from vehiModel where #form.searchType# LIKE <cfqueryparam cfsqltype="cf_sql_varchar" value="%#form.searchStr#%"> order by #form.searchType#
		</cfquery>
		...
		<table align="center" class="data" width="50%">
        	...
        	<tr> 
          		<td>#exactResult.Model#</td>
          		<td>#exactResult.desp#</td>
          		<cfif getpin2.h1F11 eq 'T'>
				<td nowrap> 
            		<div align="center">
					<a href="Modeltable2.cfm?type=Delete&Model=#exactResult.Model#">
					<img height="18px" width="18px" src="/images/delete.ICO" alt="Delete" border="0">Delete</a>&nbsp; 
					<a href="Modeltable2.cfm?type=Edit&Model=#exactResult.Model#">
    ...
    <cfif similarResult.recordCount neq 0>
      	<table align="center" class="data" width="50%">					
	    	<tr>
	      	...
	      	<tr> 
          		<td>#similarResult.Model#</td>
          		<td>#similarResult.desp#</td>
          		<cfif getpin2.h1F11 eq 'T'>
				<td nowrap> 
            		<div align="center">
					<a href="Modeltable2.cfm?type=Delete&Model=#similarResult.Model#">
					<img height="18px" width="18px" src="/images/delete.ICO" alt="Delete" border="0">Delete</a>&nbsp; 
					<a href="Modeltable2.cfm?type=Edit&Model=#similarResult.Model#">
					<img height="18px" width="18px" src="/images/edit.ICO" alt="Edit" border="0">Edit</a> 
            		</div>
				</td>
				</cfif>
      	...
      	<tr> 
			...
			<cfif getpin2.h1F11 eq 'T'>
				<td nowrap><div align="center">
					<a href="Modeltable2.cfm?type=Delete&Model=#type.Model#">
					<img height="18px" width="18px" src="/images/delete.ICO" alt="Delete" border="0">Delete</a>&nbsp; 
					<a href="Modeltable2.cfm?type=Edit&Model=#type.Model#">
