<html>
    <head>
        ...
        <link href="/latest/css/selectivity-3.1.0/selectivity.min.css" rel="stylesheet" type="text/css">
        <link rel="stylesheet" href="//maxcdn.bootstrapcdn.com/font-awesome/4.2.0/css/font-awesome.min.css">
        
        <script src="/scripts/CalendarControl.js" language="javascript"></script>
        <script src="/latest/js/jquery/jquery-3.1.1.min.js" language="javascript"></script>
        <script src="/latest/js/selectivity-3.1.0/selectivity-jquery.js" language="javascript"></script>
        <script src="/latest/js/selectivity-3.1.0/selectivity.js" language="javascript"></script>
    ...
    <cfquery datasource='#dts#' name="getOTtable">
    ...
    <body>
        ...
        <cfoutput>
            <cfif #url.type# eq "Edit">
                ...
                <cfloop list="#typelist#" index="i">
                    ...
                    <cfset "#i#MINOT" = evaluate('getitem.#i#MINOT')>
                    <cfset "#i#MAXOT" = evaluate('getitem.#i#MAXOT')>
                    <cfset "#i#ROUNDUP" = evaluate('getitem.#i#ROUNDUP')>
                </cfloop>
            ...
            <h4>
                <cfif getpin2.h1610 eq 'T'>   <a href="sizeidtable2.cfm?type=Create">   Creating a #getgeneral.layer#   </a></cfif>
                <cfif getpin2.h1620 eq 'T'>|| <a href="sizeidtable.cfm?">               List all #getgeneral.layer#     </a></cfif>
                <cfif getpin2.h1630 eq 'T'>|| <a href="s_sizeidtable.cfm?type=icsizeid">Search For #getgeneral.layer#   </a></cfif>
        ...
        <cfform name="CustomerForm" action="sizeidprocess.cfm" method="post" onsubmit="return validate()">
            <cfoutput>
                ...
                <h1 align="center">#getgeneral.layer# Maintenance</h1>
            </cfoutput>
            ...
            <table align="center" class="data" width="450">
                <cfoutput> 
                    ...
                    <tr align="center"> 
                        <td>Joint OT :</td>
                        <td>
                            <select id="joint_ot" class="selectivity-input" data-placeholder="Type to search OT table" name="joint_ot" multiple>
                            ...
                            <optgroup label="Belgium">
                                ...
                                <cfloop query="getOTtable">
                                    <option value="#getOTtable.sizeid#" 
                                            <cfif #IsDefined("getitem.joint_ot")# AND #ListFind("#getitem.joint_ot#", "#getOTtable.sizeid#", ",")# NEQ 0>selected</cfif>>
                                        #getOTtable.sizeid#
                                    </option>
                                </cfloop>
                            </select>
                            ...
                            <table>
                                ...
                                <cfloop list="#typelist#" index="i">
                                    <tr>
                                        ...
                                        <td><input type="text" name="#i#MINOT" id="#i#MINOT" value="#evaluate('#i#MINOT')#" size="5"></td>
                                        <td><input type="text" name="#i#MAXOT" id="#i#MAXOT" value="#evaluate('#i#MAXOT')#" size="5"></td>
                                        <td><input type="text" name="#i#ROUNDUP" id="#i#ROUNDUP" value="#evaluate('#i#ROUNDUP')#" size="5"></td>
                                    </tr>
                                </cfloop>
                            </table>
                        </td>
