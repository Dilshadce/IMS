...
<cfquery name="getGroup" datasource="#dts#">
  ...
  <cfif form.groupfrom neq "" and form.groupto neq "">
	where colorid >= '#form.groupfrom#' and colorid <= '#form.groupto#'
  </cfif>
  order by colorid
</cfquery>
	...
	<table width="95%" border="0" class="" align="center">
	  ...
	  <cfloop query="getGroup">
	    ...
	    <tr>
	      ...
	      <td><cfif getpin2.h1511 eq 'T'><a href="coloridtable2.cfm?type=Edit&colorid=#colorid#">#colorid#</a><cfelse>#colorid#</cfif></td>
	      <td>#desp#</td>
