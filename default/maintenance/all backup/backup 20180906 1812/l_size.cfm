...
<cfquery name="getGroup" datasource="#dts#">
  ...
  <cfif form.groupfrom neq "" and form.groupto neq "">
	where sizeid >= '#form.groupfrom#' and sizeid <= '#form.groupto#'
  </cfif>
  order by sizeid
</cfquery>
	...
	<table width="95%" border="0" class="" align="center">
	  ...
	  <cfloop query="getGroup">
	    ...
	    <tr>
	      ...
	      <td><cfif getpin2.h1511 eq 'T'><a href="sizeidtable.cfm?type=Edit&sizeid=#sizeid#">#sizeid#</a><cfelse>#sizeid#</cfif></td>
	      <td>#desp#</td>
