...
<cfoutput>
  <h4><cfif getpin2.h1810 eq 'T'><a href="coloridtable2.cfm?type=Create">Creating a #getgeneral.layer#</a> </cfif><cfif getpin2.h1820 eq 'T'>|| <a href="coloridtable.cfm?">List 
	...
	<cfform action="s_coloridtable.cfm" method="post">
		...
		<cfoutput>
			<cfif start neq 1>
				|| <a href="s_coloridtable.cfm?start=#prevtwenty#">Previous</a> ||
			</cfif>
		
			<cfif page neq noOfPage>
				 <a href="s_coloridtable.cfm?start=#evaluate(nexttwenty)#">Next</a> ||
			</cfif>
		...
		<cfif isdefined("form.searchStr")>
			...
			<table align="center" class="data" width="600px">					
					...
					<tr>
						...
						<cfif getpin2.h1811 eq 'T'><td nowrap width="20%"><div align="center"><a href="coloridtable2.cfm?type=Delete&colorid=#urlencodedformat(exactResult.colorid)#"><img height="18px" width="18px" src="../../images/delete.ICO" alt="Delete" border="0">Delete</a>&nbsp;<a href="coloridtable2.cfm?type=Edit&colorid=#urlencodedformat(exactResult.colorid)#"><img height="18px" width="18px" src="../../images/edit.ICO" alt="Edit" border="0">Edit</a></div></td></cfif>
					</tr>
					</cfoutput>
			</table>
			<cfelse>
			...
			<table align="center" class="data" width="600px">					
					...
					<tr>
						...
						<cfif getpin2.h1811 eq 'T'><td nowrap width="20%"><div align="center"><a href="coloridtable2.cfm?type=Delete&colorid=#urlencodedformat(similarResult.colorid)#"><img height="18px" width="18px" src="../../images/delete.ICO" alt="Delete" border="0">Delete</a>&nbsp;<a href="coloridtable2.cfm?type=Edit&colorid=#urlencodedformat(similarResult.colorid)#"><img height="18px" width="18px" src="../../images/edit.ICO" alt="Edit" border="0">Edit</a></div></td></cfif>
					</tr>
					</cfoutput>
			</table>
			<cfelse>
		...
		<table align="center" class="data" width="600px">					
				...
				<tr>
						...
						<td>#type.desp#<br></td>
						<cfif getpin2.h1811 eq 'T'><td nowrap width="20%"><div align="center"><a href="coloridtable2.cfm?type=Delete&colorid=#urlencodedformat(type.colorid)#"><img height="18px" width="18px" src="../../images/delete.ICO" alt="Delete" border="0">Delete</a>&nbsp;<a href="coloridtable2.cfm?type=Edit&colorid=#urlencodedformat(type.colorid)#"><img height="18px" width="18px" src="../../images/edit.ICO" alt="Edit" border="0">Edit</a></div></td></cfif>
				</tr>
