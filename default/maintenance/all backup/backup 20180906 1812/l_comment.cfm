...
<div align="center"><font color="#000000" size="3" face="Arial, Helvetica, sans-serif"><strong><cfoutput>Comment</cfoutput> Listing</strong></font></div>
	...
	<table width="95%" border="0" class="" align="center">
	  ...
	  <cfloop query="getGroup">
	    ...
	    <tr>
	      ...
	      <td><cfif getpin2.h1511 eq 'T'><a href="commenttable2.cfm?type=Edit&code=#code#">#Code#</a><cfelse>#Code#</cfif></td>
	      <td>#desp#</td>
