...
<cfquery name="getGroup" datasource="#dts#">
  ...
  <cfif form.groupfrom neq "" and form.groupto neq "">
	where brand >= '#form.groupfrom#' and brand <= '#form.groupto#'
  </cfif>
  order by brand
</cfquery>
...
<div align="center"><font color="#000000" size="3" face="Arial, Helvetica, sans-serif"><strong><cfoutput>#getgsetup.lbrand# </cfoutput> Listing</strong></font></div>
  ...
  <cfif getGroup.recordCount gt 0>
	...
	<table width="95%" border="0" class="" align="center">
	  ...
	  <tr>
        ...
        <td><strong><font size="2" face="Arial, Helvetica, sans-serif"><cfoutput>#getgsetup.lbrand#</cfoutput></font></strong></td>
	  ...
	  <cfloop query="getGroup">
	    ...
	    <tr>
	      ...
	      <td><cfif getpin2.h1511 eq 'T'><a href="brandtable2.cfm?type=Edit&brand=#brand#">#brand#</a><cfelse>#brand#</cfif></td>
	      <td>#desp#</td>
