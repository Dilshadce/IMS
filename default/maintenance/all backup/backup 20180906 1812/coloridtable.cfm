  ...
  <cfform action="coloridtable.cfm" method="post">
    ...
    <cfoutput query="getPersonnel" startrow="#start#" maxrows="5"> 
      ...
      <table align="center" class="data" width="450px">
        ...
        <tr> 
          <td colspan="2"><div align="right"><a href="coloridtable2.cfm?type=Delete&colorid=#urlencodedformat(evaluate(strNo))#"><img height="18px" width="18px" src="../../images/delete.ICO" alt="Delete" border="0"> 
              Delete</a> <a href="coloridtable2.cfm?type=Edit&colorid=#urlencodedformat(evaluate(strNo))#"><img height="18px" width="18px" src="../../images/edit.ICO" alt="Edit" border="0">Edit</a></div></td>
        </tr>
		</cfif>
      </table>
      <br>
