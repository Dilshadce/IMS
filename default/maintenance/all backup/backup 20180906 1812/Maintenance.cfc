		...
		<cfset currentdatetime = '#lsdateformat(now(), "YYYY-MM-DD")# #timeformat(now(), "HH:MM:SS")#'>
	        ...
	        <cfswitch expression="#ARGUMENTS.gridaction#">
	           ...
	           <cfcase value="D">
        	        <!--- Perform actual delete --->
                    <cfquery name="getlocation" datasource="#dts#">
                    select * from ictran where location=<cfqueryparam cfsqltype="cf_sql_varchar" value="#ARGUMENTS.gridrow.location#"> limit 1
                    </cfquery>
                    <cfquery name="getlocation2" datasource="#dts#">
                    select * from locqdbf where location=<cfqueryparam cfsqltype="cf_sql_varchar" value="#ARGUMENTS.gridrow.location#"> limit 1
                    </cfquery>
                    
                    <cfif getlocation.recordcount eq 0 and getlocation2.recordcount eq 0>
                	<cfquery datasource="#dts#">
