...
<cfquery name="getGroup" datasource="#dts#">
  ...
  <cfif form.groupfrom neq "" and form.groupto neq "">
	where unit >= '#form.groupfrom#' and unit <= '#form.groupto#'
  </cfif>
  order by unit
</cfquery>
...
<div align="center"><font color="#000000" size="3" face="Arial, Helvetica, sans-serif"><strong><cfoutput>Unit</cfoutput> Listing</strong></font></div>
  ...
  <cfif getGroup.recordCount gt 0>
	...
	<table width="95%" border="0" class="" align="center">
	  ...
	  <tr>
        ...
        <td><strong><font size="2" face="Arial, Helvetica, sans-serif"><cfoutput>Unit</cfoutput></font></strong></td>
	  ...
	  <cfloop query="getGroup">
	    ...
	    <tr>
	      ...
	      <td><cfif getpin2.h1511 eq 'T'><a href="unittable2.cfm?type=Edit&unit=#unit#">#Unit#</a><cfelse>#Unit#</cfif></td>
	      <td>#desp#</td>
