...
<cfoutput>
  <cfif url.type eq 'Edit'>
    ...
    <cfset FPRICE_MIN = getitem.FPRICE_MIN>
    <cfset FPRICE2_MIN = getitem.FPRICE2_MIN>
    <cfset FPRICE3_MIN = getitem.FPRICE3_MIN>
    <cfset FPRICE4_MIN = getitem.FPRICE4_MIN>
    <cfset FPRICE5_MIN = getitem.FPRICE5_MIN>
    <cfset FPRICE6_MIN = getitem.FPRICE6_MIN>
    <cfset FPRICE7_MIN = getitem.FPRICE7_MIN>
    <cfset FPRICE8_MIN = getitem.FPRICE8_MIN>
    <cfset FPRICE9_MIN = getitem.FPRICE9_MIN>
    <cfset FPRICE10_MIN = getitem.FPRICE10_MIN>
...
<cfform name='CustomerForm' action='icitemprocess.cfm' method='post' onsubmit='return validate(event);'>
  <cfoutput>
    <input type='hidden' name='mode' id="mode" value='#mode#'>
    <input type='hidden' name='edi_id' id="edi_id" value='#edi_id#'>
    <input type='hidden' name='com_id' id="com_id" value='#lcase(HcomID)#'>
    <cfif isdefined('url.express')>
      <input type='hidden' name='express' id="express" value='#url.express#'>
    </cfif>
    <cfif isdefined('url.ovasexpress')>
      <input type='hidden' name='ovasexpress' id="ovasexpress" value='1'>
    </cfif>
  </cfoutput>
  ...
  <table align='center' class='data' width='779' cellspacing="0">
    <cfoutput>
      <tr>
        ...
        <td colspan='6'><cfif mode eq 'Delete' or mode eq 'Edit'>
            <input type='text' size='60' name='itemno' id="itemno" value='#convertquote(url.itemno)#' readonly>
            <cfelse>
            <cfif lcase(hcomid) eq "ovas_i" or lcase(hcomid) eq "demo_i">
              <input type='text' size='60' name='itemno' id="itemno" value='#itemno#'>
              <cfelse>
              <input type='text' size='60' name='itemno' id="itemno" value='#itemno#' maxlength='54'>
            </cfif>
          </cfif>
          ...
          &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Created On : #dateformat(created_on,'DD/MM/YYYY')# <br>
          &nbsp;
          <div id="hint" class="autocomplete"></div><br><br>
          <script type="text/javascript">
      ...
      <tr>
        <td <cfif getdisplaysetup2.item_descp neq "Y">style="visibility:hidden"</cfif>><cfif lcase(HcomID) eq "asaiki_i">
            Supplier Part Number :
            <cfelse>
            <cfoutput>#getremarkInfo.ldescription#</cfoutput> : <cfif getdisplaysetup2.compulsory_item_desp eq "Y">*</cfif>
          </cfif></td>
        <td colspan='6' <cfif getdisplaysetup2.item_descp neq "Y">style="visibility:hidden"</cfif>><textarea id="desp" name="desp" cols="100" rows="1" style="overflow:auto" onKeyPress="return imposeMaxLength(this, <cfif lcase(HcomID) eq "hl_i">
        35
		<cfelse>
        #getgsetup.desplimit#
          ...
          <cfif getmodule.auto neq '1'>
            <!---<input type="button" name="MCE1" id="MCE1" value="MCE" onClick="texteditor('MCE1');">
            &nbsp;&nbsp;--->
            <input type="button" name="SYMBOLbtn1" id="SYMBOLbtn1" value="SYMBOL" onClick="javascript:ColdFusion.Window.show('findSymbol1');">
          </cfif>
        
          <!--- <input type='text' size='100' name='desp' value='#convertquote(desp)#' maxlength='60' onClick="onselect()"> ---></td>
        <cfif isdefined('url.express')>
          <td><input name='cancel' type='button' value='Cancel' onClick="window.close()"></td>
        </cfif>
      </tr>
      <tr>
        <td>&nbsp;</td>
        ...
        70
          ...
          &nbsp;&nbsp;
          <cfif getmodule.auto neq '1'>
            <!---<input type="button" name="MCE2" id="MCE2" value="MCE" onClick="texteditor('MCE2');">
            &nbsp;&nbsp;--->
            <input type="button" name="SYMBOLbtn2" id="SYMBOLbtn2" value="SYMBOL" onClick="javascript:ColdFusion.Window.show('findSymbol2');">
          </cfif>
          
          <!--- <input type='text' size='100' name='despa' value='#convertquote(despa)#' maxlength='70'> ---></td>
      </tr>
      <tr>
        <td <cfif getdisplaysetup2.item_comment neq "Y">style="visibility:hidden"</cfif>>Comment : <cfif getdisplaysetup2.compulsory_item_comment eq "Y">*</cfif></td>
        <td <cfif getdisplaysetup2.item_comment neq "Y">style="visibility:hidden"</cfif>>
        <cfif lcase(hcomid) eq "d72ipl_i">
        <textarea name='comment' id="comment" tabindex="3" cols='100' rows='5'>#convertquote(comment)#</textarea>
        <cfelse>
        <textarea name='comment' id="comment" tabindex="3" cols='60' rows='5'>#convertquote(comment)#</textarea>
        </cfif>
        </td>
      </tr>
      <tr>
      ...
      <tr>
        <td height='22' <cfif getdisplaysetup2.item_brand neq "Y">style="visibility:hidden"</cfif>><cfif lcase(HcomID) eq "vsolutionspteltd_i">
            Others :
            <cfelseif lcase(HcomID) eq "ultrexauto_i">
            Make & model:
            <cfelse>
            #getgsetup.lbrand# : <cfif getdisplaysetup2.compulsory_item_brand eq "Y">*</cfif>
          </cfif></td>
    ...
    <cfoutput>
      ...
      <td <cfif getdisplaysetup2.item_size neq "Y">style="visibility:hidden"</cfif>>#getgsetup.lsize# : <cfif getdisplaysetup2.compulsory_item_size eq "Y">*</cfif></td>
    </cfoutput>
    <td width='148' <cfif getdisplaysetup2.item_size neq "Y">style="visibility:hidden"</cfif>><cfif left(dts,4) eq "tcds">
        <cfoutput>
    ...
    <tr><cfoutput>
      ...
      <td width='148' <cfif getdisplaysetup2.item_rating neq "Y">style="visibility:hidden"</cfif>><select name='COSTCODE' id="COSTCODE">
          <option value=''>-</option>
          <cfoutput query='getcostcode'>
            <option value='#costcode#'<cfif costcode eq xcostcode>selected</cfif>>#costcode# - #desp#</option>
          </cfoutput>
        </select>
        <a onClick="ColdFusion.Window.show('createRatingAjax');" onMouseOver="this.style.cursor='hand';">Create New <cfoutput>#getgsetup.lrating#</cfoutput></a></td>
      ...
      <tr>
        <cfif getpin2.h1360 neq 'T'>
          ...
          <td nowrap><input name='UCOST' type='hidden' value='#NumberFormat(UCOST, stDecl_UPrice)#' size='17' maxlength='17'>
            &nbsp;&nbsp;</td>
          <cfelse>
          <td nowrap <cfif getdisplaysetup2.item_ucp neq "Y">style="visibility:hidden"</cfif>>Unit Cost Price :</td>
      ...
      <cfif getpin2.h1360 neq 'T'>
        <cfif getpin2.h1361 neq 'T'>
          <cfif getpin2.h1361 neq 'T'>
            ...
            <cfelse>
            <td height='22' <cfif getdisplaysetup2.item_usp2 neq "Y">style="visibility:hidden"</cfif>>Unit Selling Price 2 :</td>
    ...
    <cfoutput>
      ...
      <tr>
        <cfif getpin2.h1360 neq 'T'>
          ...
          <cfelse>
          <td <cfif getdisplaysetup2.item_msp neq "Y">style="visibility:hidden"</cfif>>
              Min. Selling Price :</td>
          <td <cfif getdisplaysetup2.item_msp neq "Y">style="visibility:hidden"</cfif>>
      ...
      <tr>
        <td colspan="7"><table style="display:none" id="r4" align="center" width="100%">
            ...
            <cfif getpin2.h1360 neq 'T'>
            <input type="hidden" name="FPRICE_MIN" id="FPRICE_MIN" value="#val(FPRICE_MIN)#">
            <input type="hidden" name="FPRICE2_MIN" id="FPRICE2_MIN" value="#val(FPRICE2_MIN)#">
            <cfelse>
            <tr <cfif getdisplaysetup2.item_msp neq "Y">style="visibility:hidden"</cfif>>
          	<td>Min. Selling Price :</td>
          	<td>
              <cfinput name='FPRICE_MIN' id="FPRICE_MIN" type='text' value='#NumberFormat(FPRICE_MIN, stDecl_UPrice)#' size='17' maxlength='17'>
             </td>
            <td>Min. Selling Price :</td>
            <td>
              <cfinput name='FPRICE2_MIN' id="FPRICE2_MIN" type='text' value='#NumberFormat(FPRICE2_MIN, stDecl_UPrice)#' size='17' maxlength='17'>
              </td>
        	</tr>
            </cfif>
            ...
            <cfif getpin2.h1360 neq 'T'>
            <input type="hidden" name="FPRICE3_MIN" id="FPRICE3_MIN" value="#val(FPRICE3_MIN)#">
            <input type="hidden" name="FPRICE4_MIN" id="FPRICE4_MIN" value="#val(FPRICE4_MIN)#">
            <cfelse>
            <tr <cfif getdisplaysetup2.item_msp neq "Y">style="visibility:hidden"</cfif>>
          	<td>Min. Selling Price :</td>
          	<td>
              <cfinput name='FPRICE3_MIN' id="FPRICE3_MIN" type='text' value='#NumberFormat(FPRICE3_MIN, stDecl_UPrice)#' size='17' maxlength='17'>
              </td>
            <td>Min. Selling Price :</td>
            <td>
              <cfinput name='FPRICE4_MIN' id="FPRICE4_MIN" type='text' value='#NumberFormat(FPRICE4_MIN, stDecl_UPrice)#' size='17' maxlength='17'>
              </td>
        	</tr>
            </cfif>
            ...
            <cfif getpin2.h1360 neq 'T'>
            <input type="hidden" name="FPRICE5_MIN" id="FPRICE5_MIN" value="#val(FPRICE5_MIN)#">
            <input type="hidden" name="FPRICE6_MIN" id="FPRICE6_MIN" value="#val(FPRICE6_MIN)#">
            <cfelse>
            <tr <cfif getdisplaysetup2.item_msp neq "Y">style="visibility:hidden"</cfif>>
          	<td>Min. Selling Price :</td>
          	<td>
              <cfinput name='FPRICE5_MIN' id="FPRICE5_MIN" type='text' value='#NumberFormat(FPRICE5_MIN, stDecl_UPrice)#' size='17' maxlength='17'>
              </td>
            <td>Min. Selling Price :</td>
            <td>
              <cfinput name='FPRICE6_MIN' id="FPRICE6_MIN" type='text' value='#NumberFormat(FPRICE6_MIN, stDecl_UPrice)#' size='17' maxlength='17'>
              </td>
        	</tr>
            </cfif>
            ...
            <cfif getpin2.h1360 neq 'T'>
            <input type="hidden" name="FPRICE7_MIN" id="FPRICE7_MIN" value="#val(FPRICE7_MIN)#">
            <input type="hidden" name="FPRICE8_MIN" id="FPRICE8_MIN" value="#val(FPRICE8_MIN)#">
            <cfelse>
            <tr <cfif getdisplaysetup2.item_msp neq "Y">style="visibility:hidden"</cfif>>
          	<td>Min. Selling Price :</td>
          	<td>
              <cfinput name='FPRICE7_MIN' id="FPRICE7_MIN" type='text' value='#NumberFormat(FPRICE7_MIN, stDecl_UPrice)#' size='17' maxlength='17'>
              </td>
            <td>Min. Selling Price :</td>
            <td>
              <cfinput name='FPRICE8_MIN' id="FPRICE8_MIN" type='text' value='#NumberFormat(FPRICE8_MIN, stDecl_UPrice)#' size='17' maxlength='17'>
              </td>
        	</tr>
            </cfif>
            ...
            <cfif getpin2.h1360 neq 'T'>
            <input type="hidden" name="FPRICE9_MIN" id="FPRICE9_MIN" value="#val(FPRICE9_MIN)#">
            <input type="hidden" name="FPRICE10_MIN" id="FPRICE10_MIN" value="#val(FPRICE10_MIN)#">
            <cfelse>
            <tr <cfif getdisplaysetup2.item_msp neq "Y">style="visibility:hidden"</cfif>>
          	<td>Min. Selling Price :</td>
          	<td>
              <cfinput name='FPRICE9_MIN' id="FPRICE9_MIN" type='text' value='#NumberFormat(FPRICE9_MIN, stDecl_UPrice)#' size='17' maxlength='17'>
              </td>
            <td>Min. Selling Price :</td>
            <td>
              <cfinput name='FPRICE10_MIN' id="FPRICE10_MIN" type='text' value='#NumberFormat(FPRICE10_MIN, stDecl_UPrice)#' size='17' maxlength='17'>
              </td>
        	</tr>
            </cfif>
