...
<html>
<head>
<title>BOM Item Forecast Report by SO</title>
...
<cfquery name="getbill" datasource="#dts#">
	select refno from artran where type='so' and (toinv='' or toinv is null) and (void='' or void is null)
</cfquery>
...
<cfquery name="getgeneral" datasource="#dts#">
	select filterall,lCATEGORY,lGROUP,lSIZE,lMATERIAL,lMODEL,lRATING,lAGENT,lDRIVER,lLOCATION,lPROJECT,lJOB,filteritemreport,ddlitem,lso from gsetup
</cfquery>

<body>
<h1><center>BOM Item Forecast Report by SO</center></h1>
...
<cfoutput>
	...
	<form action="bominforecastreport.cfm" method="post" name="form" target="_blank">


<table width="80%" border="0" cellspacing="0" cellpadding="3" class="data" align="center">
<tr>
		<td nowrap><input type="checkbox" name="groupbyitem" id="1" value="yes"> <label for="groupbyitem">Group by item</label></td>
    </tr>
    <tr>
		<td nowrap><input type="checkbox" name="negative" id="1" value="yes"> <label for="negative">Negative Value</label></td>
    </tr>
	<tr>
		<th width="30%" nowrap>#getgeneral.lso# From</th>
        <td><select name="billfrom">
				<option value="">Choose a #getgeneral.lso#</option>
