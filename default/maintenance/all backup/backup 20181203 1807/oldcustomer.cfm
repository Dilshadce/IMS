...
<cfoutput>
	...
	<table align="center" class="data" width="730px">
  		<tr>
    		<th>Customer No :</th>
    		<td>
  		...
  		<tr>
    		...
    		<td><input type="text" size="40" name="Name" id="Name" value="#Name#" maxlength="40">
				<cfif mode eq "Create">
					&nbsp;&nbsp;&nbsp;&nbsp;<input type="checkbox" name="check" id="check" value="Y" onClick="checkSimilar();ajaxFunction(document.getElementById('ajaxField1'),'/default/maintenance/ajaxAction.cfm?dfunction=checkSimilarCustomer&name='+document.getElementById('Name').value);">Check Similar Name
		...
		<tr <cfif getdisplaysetup2.cust_profile_nongstcustomer neq 'Y'>style="display:none"</cfif>>
            ...
            <cfelse>--->
            <td><input type="checkbox" name="ngst_cust" id="ngst_cust" value="#ngst_cust#" <cfif ngst_cust eq "T">checked</cfif> onClick="ajaxFunction(document.getElementById('taxcodeajax'),'taxcodeajax.cfm?ngst_cust='+document.getElementById('ngst_cust').checked+'&custno='+document.getElementById('custno').value);">
            <div id="taxcodeajax">
            <cfif ngst_cust eq 'T'>
        ...
        <tr <cfif getdisplaysetup2.cust_profile_taxincluded neq 'Y'>style="display:none"</cfif>>
		   	<th>Tax Included :</th>
		    <td><input type="checkbox" name="taxincl_cust" id="taxincl_cust" value="#taxincl_cust#" <cfif taxincl_cust eq "T">checked</cfif>></td>
		</tr>
		<tr <cfif getdisplaysetup2.cust_profile_groupto neq 'Y'>style="display:none"</cfif>>
		   	<th>Group To :</th>
		    <td><input name="groupto" type="text" maxlength="12" value="#groupto#" size="15"></td>
		</tr>
		<tr><td colspan="100%"><hr></td></tr>
  		<tr <cfif getdisplaysetup2.cust_profile_address neq 'Y'>style="display:none"</cfif>>
    		<th>Address :</th>
		...
		<tr <cfif getdisplaysetup2.cust_profile_postalcode neq 'Y'>style="display:none"</cfif>>
		    <th>Postal Code :</th>
		...
		<cfif lcase(HcomID) eq "tmt_i" or lcase(HcomID) eq "taff_i" or lcase(HcomID) eq "taftc_i">
	  		<tr>
	    		...
	    		<td><cfif lcase(HcomID) eq "beps_i"><input type="text" size="40" name="Attn" id="Attn"  value="#attn#" maxlength="20"><cfelse><input type="text" size="40" name="Attn" id="Attn"  value="#attn#" maxlength="35"></cfif></td>
	  		</tr>
	  		<tr>
		    	<th>Forum Id :</th>
		...
		<cfelse>
            ...
            <input type="button" size="10" value="Ajax Search" onClick="document.getElementById('attn1').value='Attn';ColdFusion.Window.show('findattn');" />
            <cfelse>
				<cfif lcase(HcomID) eq "beps_i"><input type="text" size="40" name="Attn" id="Attn"  value="#attn#" maxlength="20" ><cfelse><input type="text" size="40" name="Attn" id="Attn"  value="#attn#" maxlength="35" ></cfif>
            <input type="button" size="10" value="Ajax Search" onClick="document.getElementById('attn1').value='Attn';ColdFusion.Window.show('findattn2');" />    
                </cfif>
                  </td>
	  		</tr>
		  	<tr <cfif getdisplaysetup2.cust_profile_phone neq 'Y'>style="display:none"</cfif>>
		    	<th>Phone :</th>
		    	<td><input type="text" size="40" name="phone" id="phone" value="#phone#" maxlength="25" ></td>
		  	</tr>
		  	<tr <cfif getdisplaysetup2.cust_profile_phone2 neq 'Y'>style="display:none"</cfif>>
		    	<th><cfif lcase(HcomID) eq "mastercare_i" or lcase(HcomID) eq "gorgeous_i">HP<cfelse>HP</cfif> :</th>
		    	<td><input type="text" size="40" name="phonea" id="phonea" value="#phonea#" maxlength="25"></td>
		  	</tr>
		  	<tr <cfif getdisplaysetup2.cust_profile_fax neq 'Y'>style="display:none"</cfif>>
		    	<th>Fax :</th>
		    	<td><input type="text" size="40" name="Fax" id="Fax" value="#Fax#" maxlength="25"></td>
		  	</tr>
	  		<tr <cfif getdisplaysetup2.cust_profile_deliveryaddress neq 'Y'>style="display:none"</cfif>>
                ...
                " /></th>
		    	<td><input type="text" size="40" name="DAddr1" id="DAddr1" value="#DAddr1#" maxlength="35"></td>
		  	</tr>
		  	<tr <cfif getdisplaysetup2.cust_profile_deliveryaddress neq 'Y'>style="display:none"</cfif>>
			  	<td></td>
            ...
            <cfif getcodepatern.countryddl eq 'Y'>
         		<tr <cfif getdisplaysetup2.cust_profile_deliverycountry neq 'Y'>style="display:none"</cfif>>
        ...
        <cfelse>
			...
			<tr <cfif getdisplaysetup2.cust_profile_deliverypostalcode neq 'Y'>style="display:none"</cfif>>
		  	...
		  	<tr <cfif getdisplaysetup2.cust_profile_deliveryattention neq 'Y'>style="display:none"</cfif>>
            ...
            <input type="button" size="10" value="Ajax Search" onClick="document.getElementById('attn1').value='DAttn';ColdFusion.Window.show('findattn');" />
            <cfelse>    
                
                
                <input type="text" size="40" name="DAttn" id="DAttn"  value="#dattn#" maxlength="35"><input type="button" size="10" value="Ajax Search" onClick="document.getElementById('attn1').value='DAttn';ColdFusion.Window.show('findattn2');" /></td>
                
                </cfif>
		  	</tr>
		  	<tr <cfif getdisplaysetup2.cust_profile_deliveryphone neq 'Y'>style="display:none"</cfif>>
		    	<th>Delivery Phone :</th>
		    	<td><input type="text" size="40" name="dphone" id="dphone" value="#dphone#" maxlength="25"></td>
		  	</tr>
		  	
		  	<tr <cfif getdisplaysetup2.cust_profile_contact neq 'Y'>style="display:none"</cfif>>
		    	<th><cfif lcase(HcomID) eq "varz_i">REP<cfelse>Delivery HP</cfif> :</th>
		    	<td><input type="text" size="40" name="contact" id="contact"  value="#contact#"  maxlength="35"></td>
		  	</tr>
            <tr <cfif getdisplaysetup2.cust_profile_deliveryfax neq 'Y'>style="display:none"</cfif>>
		    	<th>Delivery Fax :</th>
		    	<td><input type="text" size="40" name="dfax" id="dfax" value="#dfax#" maxlength="25"></td>
		  	</tr>
		  	<tr <cfif getdisplaysetup2.cust_profile_email neq 'Y'>style="display:none"</cfif>>
		    	<th>Email :</th>
		    	<td><input type="text" size="60" name="e_mail" id="e_mail" value="#email#" maxlength="90"></td>
		  	</tr>
		  	<tr <cfif getdisplaysetup2.cust_profile_website neq 'Y'>style="display:none"</cfif>>
		    	<th>Web Site :</th>
		    	<td><input type="text" size="40" name="web_site" id="web_site" value="#website#" maxlength="50"></td>
		  	</tr>
		</cfif>
    ...
    <tr <cfif getdisplaysetup2.cust_profile_EndUser neq 'Y'>style="display:none"</cfif>>
    <th><cfif lcase(HcomID) eq "asaiki_i">End Customer :<cfelse><cfoutput>#getcodepatern.ldriver# :</cfoutput></cfif></th>
    <td>
	...
	<tr <cfif getdisplaysetup2.cust_profile_Sales neq 'Y'>style="display:none"</cfif>>
	...
	<tr <cfif getdisplaysetup2.cust_profile_Terms neq 'Y'>style="display:none"</cfif>>
		<th>Terms :</th>
	...
	<tr <cfif getdisplaysetup2.cust_profile_Area neq 'Y'>style="display:none"</cfif>>
		<th><cfif lcase(HcomID) eq "asaiki_i">Country :<cfelse>Area :</cfif></th>
	...
	<tr <cfif getdisplaysetup2.cust_profile_Business neq 'Y'>style="display:none"</cfif>>
		<th><cfif lcase(hcomid) eq "asaiki_i">Department :<cfelse>Business :</cfif></th>
	...
	* 
    ...
    <tr <cfif getdisplaysetup2.cust_profile_Headquaters neq 'Y'>style="display:none"</cfif>>
		<th>Headquaters</th>
		<td><select name="headquaters" id="headquaters">
				<option value="">Choose a Headquaters</option>
				<cfoutput query="gethq">
					<option value="#gethq.custno#"<cfif xheadquaters eq gethq.custno>Selected</cfif>>#gethq.custno# - #gethq.name#</option>
				</cfoutput>
			</select>
            <input type="button" size="10" value="Ajax Search" onClick="ColdFusion.Window.show('findheadquaters');" />
    ...
    <tr >
		<th>Identifier :</th>
		<td><input type="text" size="40" name="identifier" id="identifier" value="#xidentifier#" readonly> <input type="button" name="chooseidentifierbtn" id="chooseidentifierbtn"  value="Choose Identifier" onClick="ColdFusion.Window.show('chooseidentifier');"></td>
	</tr>
    
	<tr <cfif getdisplaysetup2.cust_profile_CreditLimit neq 'Y'>style="display:none"</cfif>>
		<th>Credit Limit :</th>
	...
	<tr <cfif getdisplaysetup2.cust_profile_CurrencyCode neq 'Y'>style="display:none"</cfif>>
	...
	<cfoutput>
		<tr <cfif getdisplaysetup2.cust_profile_Currency neq 'Y'>style="display:none"</cfif>>
			<th>Currency:</th>
			<td><input type="text" size="40" name="currency" id="currency" value="#currency#" maxlength="10"></td>
		</tr>
		<tr <cfif getdisplaysetup2.cust_profile_CurrencyDollar neq 'Y'>style="display:none"</cfif>>
			<th>Currency Dollar :</th>
			<td><input type="text" size="40" name="currency1" id="currency1" value="#currency1#" maxlength="17"></td>
		</tr>
		<tr <cfif getdisplaysetup2.cust_profile_CurrencyDollar2 neq 'Y'>style="display:none"</cfif>>
			<th>Currency Dollar 2 :</th>
			<td><input type="text" size="40" name="currency2" id="currency2" value="#currency2#" maxlength="17"></td>
		</tr>
		<tr <cfif getdisplaysetup2.cust_profile_BadStatus neq 'Y'>style="display:none"</cfif>>
			<th>Bad Status :</th>
			<td><input type="checkbox" name="status" id="status" value="B" <cfif status eq "B">checked</cfif>></td>
		</tr>
		<tr <cfif getdisplaysetup2.cust_profile_Date neq 'Y'>style="display:none"</cfif>>
		...
		<tr <cfif getdisplaysetup2.cust_profile_InvoiceLimit neq 'Y'>style="display:none"</cfif>>
			<th>Invoice Limit :</th>
			<td><input type="text" size="40" name="invLimit" id="invLimit" value="#invLimit#" maxlength="19"></td>
		</tr>
		<tr <cfif getdisplaysetup2.cust_profile_DiscountPercentageCategory neq 'Y'>style="display:none"</cfif>>
		...
		<tr <cfif getdisplaysetup2.cust_profile_DiscountPercentageLevel1 neq 'Y'>style="display:none"</cfif>>
		...
		<tr <cfif getdisplaysetup2.cust_profile_DiscountPercentageLevel2 neq 'Y'>style="display:none"</cfif>>
			<th>Discount Percentage Level 2 :</th>
			<td><input type="text" size="40" name="dispec2" id="dispec2" value="#dispec2#" maxlength="5"></td>
		</tr>
		<tr <cfif getdisplaysetup2.cust_profile_DiscountPercentageLevel3 neq 'Y'>style="display:none"</cfif>>
        ...
        <tr <cfif getdisplaysetup2.cust_profile_CreditSalesCode neq 'Y'>style="display:none"</cfif>> 
                 ...
                 <tr <cfif getdisplaysetup2.cust_profile_SalesReturnCode neq 'Y'>style="display:none"</cfif>> 
        ...
        <tr <cfif getdisplaysetup2.cust_profile_NormalRate neq 'Y'>style="display:none"</cfif>>
			<th>Normal Rate:</th>
			<td><input type="text" size="40" name="normal_rate" id="normal_rate" value="#normal_rate#" maxlength="2"></td>
		</tr>
        
        <tr <cfif getdisplaysetup2.cust_profile_OfferRate neq 'Y'>style="display:none"</cfif>>
			<th>Offer Rate:</th>
			<td><input type="text" size="40" name="offer_rate" id="offer_rate" value="#offer_rate#" maxlength="2"></td>
		</tr>
        
        <tr <cfif getdisplaysetup2.cust_profile_OtherRate neq 'Y'>style="display:none"</cfif>>
			<th>Others Rate:</th>
			<td><input type="text" size="40" name="others_rate" id="others_rate" value="#others_rate#" maxlength="2"></td>
		</tr>
		<tr <cfif getdisplaysetup2.cust_profile_Remark1 neq 'Y'>style="display:none"</cfif>>
			<th><cfif lcase(HcomID) eq "solidlogic_i">Rebate Percent (%)<cfelseif lcase(HcomID) eq "taftc_i">Contact Person :<cfelseif lcase(HcomID) eq "accord_i" or lcase(HcomID) eq "demoinsurance_i">Member ID :<cfelseif lcase(HcomID) eq "shell_i">Member ID<cfelseif lcase(HcomID) eq "varz_i">Ship Date<cfelseif lcase(HcomID) eq "asaiki_i">Supplier<cfelse>Remark 1</cfif> :</th>
       ...
       select * from #target_apvend#
		...
		<tr <cfif getdisplaysetup2.cust_profile_Remark2 neq 'Y'>style="display:none"</cfif>>
			<th><cfif lcase(HcomID) eq "taftc_i">Tel :<cfelseif lcase(HcomID) eq "accord_i" or lcase(HcomID) eq "demoinsurance_i" or lcase(HcomID) eq "shell_i">Gender :<cfelseif lcase(HcomID) eq "bestform_i" or lcase(HcomID) eq "ulp_i" or lcase(HcomID) eq "gbi_i">Last Quotation Ref No :<cfelseif lcase(HcomID) eq "varz_i">Ship Via<cfelseif lcase(HcomID) eq "asaiki_i">Account Type :<cfelse>Remark 2 :</cfif></th>
			<td><cfif lcase(HcomID) eq "accord_i" or lcase(HcomID) eq "demoinsurance_i">
...
<cfelseif lcase(HcomID) eq "asaiki_i">
		...
		<tr <cfif getdisplaysetup2.cust_profile_Remark3 neq 'Y'>style="display:none"</cfif>>
			<th><cfif lcase(HcomID) eq "taftc_i">Company :<cfelseif lcase(HcomID) eq "accord_i" or lcase(HcomID) eq "demoinsurance_i">Martial Status :<cfelseif lcase(HcomID) eq "bestform_i" or lcase(HcomID) eq "ulp_i">Last Sales Order Ref No :<cfelseif lcase(HcomID) eq "varz_i">Ship Terms<cfelseif lcase(HcomID) eq "asaiki_i">Ship Via<cfelse><cfif getcodepatern.custnamelength neq "Y">Remark 3 :</cfif></cfif></th>
			<td><cfif lcase(HcomID) eq "accord_i" or lcase(HcomID) eq "demoinsurance_i"><cfif #arrem3# eq "single">
...
<option value="single">Single</option>
		...
		<tr <cfif getdisplaysetup2.cust_profile_Remark4 neq 'Y'>style="display:none"</cfif>>
			<th><cfif lcase(HcomID) eq "taftc_i">Company Address :<cfelseif lcase(HcomID) eq "accord_i" or lcase(HcomID) eq "demoinsurance_i">License Date :<cfelseif lcase(HcomID) eq "bestform_i" or lcase(HcomID) eq "ulp_i">Last Invoice Ref No :<cfelseif lcase(HcomID) eq "varz_i">Expected<cfelse><cfif getcodepatern.custnamelength neq "Y">Remark 4 :</cfif></cfif></th>
			<td>
...
SELECT salary FROM droplist where salary != "" group by salary order by salary 
		...
		<tr>
			<td></td>
			<td align="right"><cfif getpin2.h1212 neq 'T'><input type="submit" value="  #button#  "></cfif></td>
		</tr>				
	</cfoutput>
