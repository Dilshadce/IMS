		...
		<table align="center" class="data" width="80%">
			...
			<tr>								
				...
				<td>
					...
					<cfif mode eq "Create">
						&nbsp;&nbsp;&nbsp;&nbsp;<input type="checkbox" name="check" value="Y" onClick="checkSimilar();ajaxFunction(document.getElementById('ajaxField1'),'/default/maintenance/ajaxAction.cfm?dfunction=checkSimilarSupplier&name='+document.getElementById('Name').value);">Bad Status
            ...
            <tr <cfif getdisplaysetup2.supp_profile_taxincluded neq 'Y'>style="display:none"</cfif>>
		   	<th>Tax Included </th>
		    <td><input type="heckbox" name="taxincl_cust" id="taxincl_cust" value="#taxincl_cust#" <cfif taxincl_cust eq "T">checked</cfif>></td>
		</tr>
...
<table align="center" class="data" width="80%">
		<tr>
			<th onClick="javascript:shoh('transaction_menu_page1');shoh('transaction_menu_page2');">Details<img src="/images/d.gif" name="imgtransaction_menu_page1" align="center"></th>
			<th onClick="javascript:shoh('transaction_menu_page2');shoh('transaction_menu_page1');">More Info<img src="/images/u.gif" name="imgtransaction_menu_page2" align="center"></th>
		</tr>
	</table>
...
<table align="center" id="transaction_menu_page1" class="data" width="80%">
			...
			<tr <cfif getdisplaysetup2.supp_profile_address neq 'Y'>style="display:none"</cfif>>
                ...
                <cfif getdisplaysetup2.supp_profile_deliveryaddress neq 'Y'>style="display:none"</cfif>
        ...
        <td <cfif getdisplaysetup2.supp_profile_country neq 'Y'>style="display:none"</cfif>>
        ...
        <td <cfif getdisplaysetup2.supp_profile_deliverycountry neq 'Y'>style="display:none"</cfif>>
			<cfset singapore = "Singapore">
        ...
        <cfelse>
            ...
            <th <cfif getdisplaysetup2.supp_profile_deliverycountry neq 'Y'>style="display:none"</cfif>>Delivery Country :</th>
		  	...
		  	<tr <cfif getdisplaysetup2.supp_profile_postalcode neq 'Y'>style="display:none"</cfif>>
                ...
                <cfif getdisplaysetup2.supp_profile_deliverypostalcode neq 'Y'>style="display:none"</cfif>
			...
			<tr <cfif getdisplaysetup2.supp_profile_attention neq 'Y'>style="display:none"</cfif>>
                ...
                <cfif getdisplaysetup2.supp_profile_deliveryattention neq 'Y'>style="display:none"</cfif>
			...
			<tr <cfif getdisplaysetup2.supp_profile_phone neq 'Y'>style="display:none"</cfif>>
                ...
                <cfif getdisplaysetup2.supp_profile_deliveryphone neq 'Y'>style="display:none"</cfif>
			...
			<tr <cfif getdisplaysetup2.supp_profile_phone2 neq 'Y'>style="display:none"</cfif>>
                ...
                <cfif getdisplaysetup2.supp_profile_deliveryfax neq 'Y'>style="display:none"</cfif>
		    	<th>Delivery Fax</th>
			...
			<tr <cfif getdisplaysetup2.supp_profile_fax neq 'Y'>style="display:none"</cfif>>
               ...
               <cfif getdisplaysetup2.supp_profile_contact neq 'Y'>style="display:none"</cfif>
			...
			<cfif getdisplaysetup2.supp_profile_email neq 'Y'>style="display:none"</cfif>
				<th>Email </th>
	...
	<td <cfif getdisplaysetup2.supp_profile_agent neq 'Y'>style="display:none"</cfif>><input type="text" size="40" name="agent" value="#agent#" maxlength="12"></td>
			<tr >
			...
			<tr >
				<th <cfif getdisplaysetup2.supp_profile_Terms neq 'Y'>style="display:none"</cfif>>Terms</th>
				<td <cfif getdisplaysetup2.supp_profile_Terms neq 'Y'>style="display:none"</cfif>><select name="term" id="term">
        ...
        <tr > 
		  			...
		  			<td <cfif getdisplaysetup2.supp_profile_PurchaseCode neq 'Y'>style="display:none"</cfif>>
						<select name="SALEC">
		  			...
		  			<td <cfif getdisplaysetup2.supp_profile_PurchaseReturnCode neq 'Y'>style="display:none"</cfif>>
						<select name="SALECNC">
		...
		<tr>
			...
			<tr >
				...
				<th <cfif getdisplaysetup2.supp_profile_Remark1 neq 'Y'>style="display:none"</cfif>><cfif lcase(HcomID) eq "varz_i">Ship Date<cfelse>Remark 1</cfif> </th>
			...
			<tr >
				...
				<th <cfif getdisplaysetup2.supp_profile_Remark2 neq 'Y'>style="display:none"</cfif>><cfif lcase(HcomID) eq "varz_i">Ship Via<cfelse>Remark 2</cfif> </th>
			...
			<tr >
				...
				<th <cfif getdisplaysetup2.supp_profile_Remark3 neq 'Y'>style="display:none"</cfif>><cfif lcase(HcomID) eq "varz_i">Ship Terms<cfelse>Remark 3</cfif> </th>
			...
			<tr >
				...
				<th <cfif getdisplaysetup2.supp_profile_Remark4 neq 'Y'>style="display:none"</cfif>><cfif lcase(HcomID) eq "varz_i">Expected<cfelse>Remark 4</cfif> </th>
        ...
        <tr>
				<td></td>
				<td align="center"><input type="submit" value="  #button#  "></td>
			</tr>				
        </table>
	</form>
