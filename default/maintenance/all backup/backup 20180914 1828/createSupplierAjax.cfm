...
<cfelse>
<cfoutput>
<cfinput type="text" size="15" name="custno" value="#nextcustno#" required="yes" maxlength="8" onBlur="if((this.value.length*1) < 8){alert('Please Key in at least 8 character');this.focus();}else{
		var allNum = '';
		var chkVal = allNum;
...
}" message="-Please enter at least 8 characters in the Supplier No"><input type="hidden" name="nexcustno" id="nexcustno" value="#getgsetup.custSuppNo#" >
</cfoutput>
</cfif>
...
<td width="400px"><cfinput type="text" name="name" id="name" required="yes" size="50" tabindex="3" message="-Supplier name is required" maxlength="40"></td>
<th align="right">GST No.</th>
<td ><cfinput type="text" name="GSTNO" id="GSTNO" disabled="disabled"  />&nbsp;&nbsp;<cfinput type="checkbox" name="ngst_cust" id="ngst_cust" value="T" checked="yes" onChange="chgtx()" > Non GST Supplier</td>
</tr>
<tr>
<th></th>
...
<td width="330px">Open Item Supplier
