...
<cfquery name="getGroup" datasource="#dts#">
  ...
  <cfif form.groupfrom neq "" and form.groupto neq "">
	where area >= '#form.groupfrom#' and area <= '#form.groupto#'
  </cfif>
  order by area
</cfquery>
...
<div align="center"><font color="#000000" size="3" face="Arial, Helvetica, sans-serif"><strong><cfoutput>Area</cfoutput> Listing</strong></font></div>
  ...
  <cfif getGroup.recordCount gt 0>
	...
	<table width="95%" border="0" class="" align="center">
	  ...
	  <tr>
        ...
        <td><strong><font size="2" face="Arial, Helvetica, sans-serif"><cfoutput>Area</cfoutput></font></strong></td>
	  ...
	  <cfloop query="getGroup">
	    ...
	    <tr>
	      ...
	      <td><cfif getpin2.h1511 eq 'T'><a href="areatable2.cfm?type=Edit&area=#area#">#area#</a><cfelse>#area#</cfif></td>
	      <td>#desp#</td>
