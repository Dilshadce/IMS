...
<cfif form.colorid CONTAINS '"' or form.colorid CONTAINS "'" or form.colorid CONTAINS "?" or form.colorid CONTAINS "@" or form.colorid CONTAINS "&" or form.colorid CONTAINS "," or form.colorid CONTAINS "\" or form.colorid CONTAINS ";" or form.colorid CONTAINS "##">
...
<cfif #form.mode# eq "Create">
    ...
    <cfinsert datasource='#dts#' tablename="iccolorid" formfields="colorid,desp,term">
    <cfelseif left(dts,6) eq "linsad">
       <cfinsert datasource='#dts#' tablename="iccolorid" formfields="colorid,desp,mainpaper">         
	<cfelse>
...
<cfelse>
		...
		<cfif checkitemExist.recordcount GT 0 >
                ...
                <cfif left(dts,8) eq "manpower">
                <cfupdate datasource='#dts#' tablename="iccolorid" formfields="colorid,desp,term">
                
                 <cfelseif left(dts,6) eq "linsad">
        <cfupdate datasource='#dts#' tablename="iccolorid" formfields="colorid,desp,mainpaper">
                <cfelse>
