...
<cfset nametype = url.type>
    ...
    <font style="text-transform:uppercase">PLACEMENT NO.</font>&nbsp;<input type="text" name="placementno1" size="8" id="placementno1" onblur="document.getElementById('loading').style.visibility='visible';ajaxFunction1(document.getElementById('ajaxField'),'findempnoajax.cfm?nametype=#nametype#&placementno='+document.getElementById('placementno1').value+'&custname='+document.getElementById('custname1').value+'&empname='+document.getElementById('empname1').value);"  />
    &nbsp;&nbsp;&nbsp;EMPLOYEE NAME/NO
    <input type="text" name="empname1" size="8" id="empname1" onblur="document.getElementById('loading').style.visibility='visible';ajaxFunction1(document.getElementById('ajaxField'),'findempnoajax.cfm?nametype=#nametype#&placementno='+document.getElementById('placementno1').value+'&custname='+document.getElementById('custname1').value+'&empname='+document.getElementById('empname1').value);" />
    
    &nbsp;&nbsp;&nbsp;CUSTOMER NAME
    <input type="text" name="custname1" size="8" id="custname1" onblur="document.getElementById('loading').style.visibility='visible';ajaxFunction1(document.getElementById('ajaxField'),'findempnoajax.cfm?nametype=#nametype#&placementno='+document.getElementById('placementno1').value+'&custname='+document.getElementById('custname1').value+'&empname='+document.getElementById('empname1').value);" />
    ...
    <td><a style="cursor:pointer" onClick="selectlist('#getitemno.empno#','#nametype#');<cfif url.type eq "empfrom">selectlist('#getitemno.empno#','empto');</cfif>ColdFusion.Window.hide('findempno');"><u>SELECT</u></a></td>
    </tr>
    </cfloop>    
    </table>
    </div>
