...
<cfform action="l_placementleave.cfm" name="form" method="post" target="_blank">
<cfoutput>
...
<input type="hidden" name="tran" id="tran" value="#target_arcust#">
  ...
  <table border="0" align="center" width="90%" class="data">
    ...
    <tr> 
        ...
        <td><select name="custfrom" id="custfrom" onChange="getfield();">
...
<input type="button" size="10" value="Ajax Search" onClick="document.getElementById('fromto').value='custto';ColdFusion.Window.show('findCustomer');" />
    ...
    <tr> 
      ...
      <td width="70%"><div id="deptfromfield"><select name="departmentfrom" id="departmentfrom"  onChange="getfield();">
...
<cfquery name="getsupervisor" datasource="#dts#">
    ...
    <tr> 
            ...
            <td><div align="center">From</div></td>
            <td colspan="2">
            	<div id="suppfromfield"><select name="supervisorfrom" id="supervisorfrom" onChange="getfield();">
