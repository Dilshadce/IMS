<cfset dts1 = replace(dts,'_i','_p','All')>
    ...
    <table width="600px">
    <tr>
    <th width="100px"><font style="text-transform:uppercase">#UCASE(url.nametype)#</font></th>
    ...
    <td><a style="cursor:pointer" onClick="document.getElementById('placementno').value='#getitemno.xplacementno#';document.getElementById('empno').innerHTML='#getitemno.empno#';document.getElementById('empname').innerHTML='#getitemno.xempname#';document.getElementById('custno').innerHTML='#getitemno.custno#';document.getElementById('custname').innerHTML=unescape('#URLENCODEDFORMAT(getitemno.xcustname)#');document.getElementById('contractstartdate').innerHTML='#dateformat(getitemno.startdate,'dd/mm/yyyy')#';document.getElementById('contractenddate').innerHTML='#dateformat(getitemno.completedate,'dd/mm/yyyy')#';document.getElementById('ratetype').innerHTML='#getitemno.clienttype#';getleave('#getitemno.xplacementno#');ColdFusion.Window.hide('findplacementno');" >SELECT</a></td>
    </tr>
    </cfloop>
