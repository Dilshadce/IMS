<html>
<head>
	<title>Maintenance Branch Item No</title></title>
...
<h1>View Branch Item No Informations</h1>
...
<cfif getPersonnel.recordcount neq 0>
	...
	<cfform action="branchitemno.cfm" method="post">
		...
		<cfif start neq 1>
			<cfoutput>|| <a href="branchitemno.cfm?start=#prevFive#">Previous</a> ||</cfoutput>
		</cfif>

		<cfif page neq noOfPage>
			<cfoutput> <a href="branchitemno.cfm?start=#evaluate(nextFive)#">Next</a> ||</cfoutput>
		</cfif>
		...
		<cfoutput query="getPersonnel" startrow="#start#" maxrows="5">
			<cfset strNo = 'getPersonnel.branchitemno'>

			<table align="center" class="data" width="50%">
				<tr>
          			<th width="20%">Branch Item No</th>
          			<td>#getPersonnel.branchitemno#</td>
        		</tr>
        		<tr>
          			<th>Description</th>
				...
				<tr>
					...
					<a href="branchitemno2.cfm?type=Delete&branchitemno=#evaluate(strNo)#"><img height="18px" width="18px" src="/images/delete.ICO" alt="Delete" border="0">Delete</a>
			  		<a href="branchitemno2.cfm?type=Edit&branchitemno=#evaluate(strNo)#"><img height="18px" width="18px" src="/images/edit.ICO" alt="Edit" border="0">Edit</a></div></td>
        		</tr>
				</cfif>
     	 	</table>
			<br>
