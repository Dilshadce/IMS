...
<html>
<head>
<title><cfoutput>Identifier</cfoutput> Listing</title>
...
<cfquery name="getgroup" datasource="#dts#">
  ...
  <h1 align="center"><cfoutput>Identifier Listing Report</cfoutput></h1>
<cfoutput>
    <h4 align = "center">
		...
		<cfif getpin2.h1H30 eq 'T'>|| <a href="s_identifiertable.cfm?type=desp">Search For Identifier</a></cfif>|| <a href="p_identifier.cfm">Identifier Listing report</a>
  </h4>
  </cfoutput>

<cfform action="l_identifier.cfm" name="form" method="post" target="_blank">
  ...
  <table border="0" align="center" width="90%" class="data">
    <tr> 
      <th width="15%"><cfoutput>Identifier</cfoutput></th>
      <td width="7%"> <div align="center">From</div></td>
      <td width="67%"><select name="groupfrom">
          <option value=""><cfoutput>Choose a Identifier</cfoutput></option>
          <cfoutput query="getgroup">
            <option value="#identifierno#">#identifierno# - #desp# </option>
          </cfoutput> </select></td>
    </tr>
    <tr>
      <th height="24" width="15%"><cfoutput>Identifier</cfoutput></th>
