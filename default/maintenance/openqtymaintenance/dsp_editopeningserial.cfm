...
function submitaction(){
 	if(document.itemform.serialno.value == ''){
 		...
 		document.all.feedcontact1.dataurl="databind/act_updateserialno.cfm?itemno=" + escape(itemno) + "&serialno=" + serialno + "&location=" + location + "&wos_date=" + wos_date + "&oriserialno=" + oriserialno + "&orilocation=" + orilocation;
