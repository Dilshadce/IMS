...
<cfif form.mode1 eq "Add">
	<cfquery datasource="#dts#" name="inserticl3p">			
		insert into icl3p (itemno,custno,price,dispec,dispec2,dispec3,netprice,ci_note,desp,altitemno)
		values (<cfqueryparam cfsqltype="cf_sql_varchar" value="#itemno#">, '#custno#', '#form.price#',
		'#form.dis1#', '#form.dis2#', '#form.dis3#', '#xthird#','#form.note#',<cfqueryparam cfsqltype="cf_sql_varchar" value="#form.desp#">,<cfqueryparam cfsqltype="cf_sql_varchar" value="#form.altitemno#">)			
	</cfquery>
...
<cfif form.mode1 eq "Edit">
	<cfquery datasource="#dts#" name="updateicl3p">
		...
		dispec2 = '#form.dis2#', dispec3 = '#form.dis3#', netprice = '#xthird#' , desp=<cfqueryparam cfsqltype="cf_sql_varchar" value="#form.desp#">, altitemno=<cfqueryparam cfsqltype="cf_sql_varchar" value="#form.altitemno#"> where itemno = <cfqueryparam cfsqltype="cf_sql_varchar" value="#itemno#"> and custno = '#custno#'
	</cfquery>
