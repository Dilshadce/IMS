...
<cfquery name="getGroup" datasource="#dts#">
  select * from vehicolour
  <cfif form.groupfrom neq "" and form.groupto neq "">
	where Colour >= '#form.groupfrom#' and Colour <= '#form.groupto#'
  </cfif>
  order by Colour
</cfquery>
...
<div align="center"><font color="#000000" size="3" face="Arial, Helvetica, sans-serif"><strong><cfoutput>Colour</cfoutput> Listing</strong></font></div>
  ...
  <cfif getGroup.recordCount gt 0>
	...
	<table width="95%" border="0" class="" align="center">
	  ...
	  <tr>
        ...
        <td><strong><font size="2" face="Arial, Helvetica, sans-serif"><cfoutput>Colour</cfoutput></font></strong></td>
	  ...
	  <cfloop query="getGroup">
	    ...
	    <tr>
	      ...
	      <td><cfif getpin2.h1511 eq 'T'><a href="Colourtable2.cfm?type=Edit&Colour=#Colour#">#Colour#</a><cfelse>#Colour#</cfif></td>
	      <td>#desp#</td>
