...
<cfif #form.mode# eq "Create">
    ...
    ADD COLUMN `#form.costcode#entitle` CHAR(1) DEFAULT 'N',
    ...
    ADD COLUMN `#form.costcode#days` FLOAT DEFAULT 0,
    ADD COLUMN `#form.costcode#totaldays` FLOAT DEFAULT 0,
    ADD COLUMN `#form.costcode#earndays` CHAR(1) DEFAULT 'N',
    ADD COLUMN `#form.costcode#earntype` CHAR(4) DEFAULT 'UP',
		...
		<cfif checkitemExist.recordcount GT 0 >
				...
				<cfif #form.mode# eq "Delete">
                     ...
                     <cftry>
                        ...
                        DROP COLUMN `#form.costcode#earntype`,
