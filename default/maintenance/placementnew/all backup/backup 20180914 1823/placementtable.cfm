...
<html>
<head>
<title>View <cfoutput>Placement</cfoutput></title>
...
<cfoutput>
<h1>View Placement Informations</h1>
</cfoutput>
<cfoutput>
	<h4>
		...
		<cfif getpin2.h1H30 eq 'T'>|| <a href="s_Placementtable.cfm?type=Placement">Search For Placement</a>
	  </cfif>||<a href="p_Placement.cfm">Placement Listing report</a>
	</h4>
</cfoutput>
...
<cfif getPersonnel.recordcount neq 0>
	...
	<cfform action="Placementtable.cfm" method="post">
	...
	<cfif start neq 1>
		<cfoutput>|| <a href="Placementtable.cfm?start=#prevFive#">Previous</a> ||</cfoutput>
	</cfif>
	
	<cfif page neq noOfPage>
		<cfoutput> <a href="Placementtable.cfm?start=#evaluate(nextFive)#">Next</a> ||</cfoutput>
	</cfif>
...
<cfif isdefined("url.process")>
	...
	<cfset strNo = "getPersonnel.placementno">
	<!--- QCH <cfset strNo = "start">  --->
      ...
      <table align="center" class="data" width="550px">
        ...
        <tr> 
          <th>Date</th>
          <td>#dateformat(getPersonnel.Placementdate,'DD/MM/YYYY')#</td>
        </tr>
        <tr> 
          <th>Type</th>
          <td>#getPersonnel.Placementtype#</td>
        </tr>
        <tr> 
          <th>Location</th>
        ...
        <tr> 
          <td colspan="2"><div align="right"><a href="Placementtable2.cfm?type=Delete&placementno=#evaluate(strNo)#"><img height="18px" width="18px" src="/images/delete.ICO" alt="Delete" border="0"> 
              Delete</a> <a href="Placementtable2.cfm?type=Edit&placementno=#evaluate(strNo)#"><img height="18px" width="18px" src="/images/edit.ICO" alt="Edit" border="0">Edit</a></div></td>
        </tr><!---</cfif>---->
      </table>
