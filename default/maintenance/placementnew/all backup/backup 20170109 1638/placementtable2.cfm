...
<tr>
    ...
    <td>
      <input type="hidden" id="hrMgr" name="hrMgr" class="hrMgrFilter" data-placeholder="Hiring Manager" onchange="myFunction(this.value)"/>
    </td>
    <th>Hiring Manager Email</th>
    <td>
      <cfinput type="text" <!---disabled="disabled"--->id="hrMgrEmail" name="hrMgrEmail" value="#hrMgrEmail#" validate="email" message="Hiring Manager Email in incorrect format" style="width:80%">
    </td>
</tr>
