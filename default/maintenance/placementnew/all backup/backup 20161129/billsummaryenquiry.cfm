...
<table width="100%" border="0" cellspacing="0" cellpadding="2" class="data">
    ...
    <tr>
        ...
        <cfif lcase(hcomid) eq "leadbuilders_i">
	...
	<td><div align="left"><font size="2" face="Times New Roman,Times,serif"><strong>Location</strong></font></div></td>
		...
		<td colspan="3"><div align="right"><font size="2" face="Times New Roman,Times,serif"><strong><cfif lcase(hcomid) eq "leadbuilders_i">UNIT PRICE<cfelse>FOREIGN PRICE</cfif></strong></font></div></td>
		<cfif lcase(hcomid) eq "leadbuilders_i">
		...
		<td colspan="3"><div align="right"><font size="2" face="Times New Roman,Times,serif"><strong><cfif lcase(hcomid) eq "leadbuilders_i">AMOUNT<cfelse>PRICE</cfif></strong></font></div></td>
	...
	<td><div align="left"><font size="1" face="Times New Roman,Times,serif">
        <cfloop query="getitem">
			...
			<cfloop query="getitem">
                ...
                <cfelse>
                #numberformat(getitem.price_bil,stDecl_UPrice)#<br><cfif lcase(hcomid) eq "bestform_i"><br></cfif>
                </cfif>
