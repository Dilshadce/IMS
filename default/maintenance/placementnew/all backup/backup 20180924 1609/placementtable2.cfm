...
<tr>
    ...
    <td><input type="hidden" id="hrMgr" name="hrMgr" class="hrMgrFilter" data-placeholder="Hiring Manager" onchange="getHRmgrEmail(this.value);" >
         </td>
...
<font size="-2">(Pro-rate to contract duration)</font></th>
                ...
                <td>
                    <select name="#i#earntype" id="#i#earntype">
