...
<cfform name="PlacementForm" id="PlacementForm" action="placementtableprocess.cfm" method="post" onsubmit="return validate()">
  ...
  <th>* Type</th>
    ...
    <th><cfset newkey = newkey + 1><label id="requiredcheck#newkey#"  style="display:inline">* </label>Employee NRIC</th>
      ...
      <th>* Position</th>
      <td><cfinput type="text" name="position" id="position" value="#Position#" required="yes" message="Position is Required"></td>
      </tr>
<tr><td></td></tr>
<tr>
	<td colspan="100%"><hr /></td>
...
<tr>
    ...
    <td>
      <input type="hidden" id="hrMgr" name="hrMgr" class="hrMgrFilter" data-placeholder="Hiring Manager" />
    </td>
    <th>Hiring Manager Email</th>
    <td>
      <cfinput type="text" id="hrMgrEmail" name="hrMgrEmail" value="#hrMgrEmail#" validate="email" message="Hiring Manager Email in incorrect format" style="width:80%">
    </td>
</tr>
<tr>
 ...
 <th>Do Not Bill CPF Seperately</th>
    ...
    <th><!--- CPF Amount ---></th>
     ...
     <th><!--- SDF Amount ---></th>
      ...
      <tr>
      <td><cfinput type="text" size="12" name="eff_d_#i#" id="eff_d_#i#" value="#evaluate('eff_d_#i#')#" validate="eurodate" message="Effective Date is Invalid"><img src="/images/cal.gif" width=17 height=15 border=0 onClick="showCalendarControl(document.getElementById('eff_d_#i#'));"></td>
      <td>
      <cfinput type="text" size="12" name="employee_rate_#i#" id="employee_rate_#i#" value="#evaluate('employee_rate_#i#')#" validate="float" message="Employee Rate is Invalid" onKeyUp="totalallup();">
      </td>
       <td>
      <cfinput type="text" size="12" name="employer_rate_#i#" id="employer_rate_#i#" value="#evaluate('employer_rate_#i#')#" validate="float" message="Employer Rate is Invalid" onKeyUp="totalallup();">
      </td>
      <td><cfinput type="text" size="12" name="cpfamt#i#" id="cpfamt#i#" value="#evaluate('cpfamt#i#')#" validate="float" message="CPF Amount is Invalid" onKeyUp="totalallup();"></td>
      <td><cfinput type="text" size="12" name="sdfamt#i#" id="sdfamt#i#" value="#evaluate('sdfamt#i#')#" validate="float" message="SDF Amount is Invalid" onKeyUp="totalallup();"></td>
      <td><cfinput type="text" size="12" name="subtotalamt#i#" id="subtotalamt#i#" value="#evaluate('subtotalamt#i#')#" validate="float" message="Sub Total Amount is Invalid" onKeyUp="totalallup();" readonly="yes"></td>
      <td>
       <cfinput type="text" size="12" name="adminfee#i#" id="adminfee#i#" value="#evaluate('adminfee#i#')#" readonly="yes">
      </td>
      <td><cfinput type="text" size="12" name="rebateamt#i#" id="rebateamt#i#" value="#evaluate('rebateamt#i#')#" validate="float" message="Rebate Amount is Invalid" onKeyUp="totalallup();" readonly="yes"></td>
      <td>
