...
<cfif form.mode eq "Create">
	...
	<cfif checkitemExist.recordcount GT 0 >
		...
		<cfquery datasource="#dts#" name="insertartran">
            ...
            <cfqueryparam cfsqltype="cf_sql_varchar" value="#evaluate('form.#leavelist.costcode#earntype')#">,
           ...
           <cfif isdefined('form.prorated1')><cfqueryparam cfsqltype="cf_sql_varchar" value="Y"><cfelse><cfqueryparam cfsqltype="cf_sql_varchar" value="N"></cfif>,
            ...
            <cfqueryparam cfsqltype="cf_sql_varchar" value="#form.verifier#">,
            <cfqueryparam cfsqltype="cf_sql_varchar" value="#form.verifieremail#">,
            ...
            <!---Added by Nieo 20171219 1155--->
            <cfqueryparam cfsqltype="cf_sql_varchar" value="#form.workorderid#">,
            <cfqueryparam cfsqltype="cf_sql_varchar" value="#form.costcenter#">,
            <cfqueryparam cfsqltype="cf_sql_varchar" value="#form.cLocation#">,
            <cfqueryparam cfsqltype="cf_sql_varchar" value="#form.businessunit#">,
            <cfqueryparam cfsqltype="cf_sql_varchar" value="#form.jobid#">,
            <cfqueryparam cfsqltype="cf_sql_varchar" value="#form.jobposting#">,
            <cfqueryparam cfsqltype="cf_sql_varchar" value="#form.securityID#">,
            <cfqueryparam cfsqltype="cf_sql_varchar" value="#form.site#">
            <!---Added by Nieo 20171219 1155--->
            )
           ...
           subtotalamt4 = <cfqueryparam cfsqltype="cf_sql_varchar" value="#form.subtotalamt4#">,
            ...
            adminfeepamt = <cfqueryparam cfsqltype="cf_sql_varchar" value="#form.adminfeepamt#">,
                   ...
                   #leavelist.costcode#earndays =  <cfif isdefined('form.#leavelist.costcode#earndays')>
                    ...
                    #leavelist.costcode#earntype = <cfqueryparam cfsqltype="cf_sql_varchar" value="#evaluate('form.#leavelist.costcode#earntype')#">,
            ...
            newtype = '#form.clienttype#',
                ...
                verifier = <cfqueryparam cfsqltype="cf_sql_varchar" value="#form.verifier#">,
                verifieremail = <cfqueryparam cfsqltype="cf_sql_varchar" value="#form.verifieremail#">,
            ...
            <!---Added by Nieo 20171219 1155--->
            workorderid= <cfqueryparam cfsqltype="cf_sql_varchar" value="#form.workorderid#">,
            costcenter= <cfqueryparam cfsqltype="cf_sql_varchar" value="#form.costcenter#">,
            cLocation=<cfqueryparam cfsqltype="cf_sql_varchar" value="#form.cLocation#">,
            businessunit=<cfqueryparam cfsqltype="cf_sql_varchar" value="#form.businessunit#">,
            jobid=<cfqueryparam cfsqltype="cf_sql_varchar" value="#form.jobid#">,
            jobposting=<cfqueryparam cfsqltype="cf_sql_varchar" value="#form.jobposting#">,
            securityID=<cfqueryparam cfsqltype="cf_sql_varchar" value="#form.securityID#">,
