...
<cfif #IsDefined("form.joint_ot")#>
    <cfset jointot = "#form.joint_ot#">
<cfelse>
    <cfset jointot = "">
</cfif>
<cfif #form.mode# eq "Create">
    ...
    <cfquery name="insert" datasource="#dts#">
        ...
        ,<cfqueryparam cfsqltype="cf_sql_varchar" value="#jointot#">
        <cfloop from="1" to="7" index="i">
        ...
        <cfloop list="#typelist#" index="i">
            ...
            ,<cfqueryparam cfsqltype="cf_sql_varchar" value="#evaluate('form.#i#MINOT')#">
            ,<cfqueryparam cfsqltype="cf_sql_varchar" value="#evaluate('form.#i#MAXOT')#">
            ,<cfqueryparam cfsqltype="cf_sql_varchar" value="#evaluate('form.#i#ROUNDUP')#">
        </cfloop>
        <cfloop from="1" to="30" index="i">
    ...
    <cfif checkitemExist.recordcount GT 0 >
        ...
        <cfif #form.mode# eq "Edit">
            ...
            <cfquery name="update" datasource="#dts#">
                ...
                ,joint_ot = <cfqueryparam cfsqltype="cf_sql_varchar" value="#jointot#">
                <cfloop from="1" to="7" index="i">
                ...
                <cfloop list="#typelist#" index="i">
                    ...
                    ,#i#MINOT = <cfqueryparam cfsqltype="cf_sql_varchar" value="#evaluate('form.#i#MINOT')#">
                    ,#i#MAXOT = <cfqueryparam cfsqltype="cf_sql_varchar" value="#evaluate('form.#i#MAXOT')#">
                    ,#i#ROUNDUP = <cfqueryparam cfsqltype="cf_sql_varchar" value="#evaluate('form.#i#ROUNDUP')#">
                </cfloop>
                <cfloop from="1" to="30" index="i">
                    <cfif evaluate('form.phdate#i#') neq "">
                        <cfset phdate = dateformatnew(evaluate('form.phdate#i#'),'YYYY-MM-DD')>
