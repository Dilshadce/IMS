...
<cfif form.mode eq "Create">
	...
	<cfquery name="insertitem" datasource="#dts#">
		...
		'#wos_group#','#jsstringformat(shelf)#',"#form.taxcode#",<cfqueryparam cfsqltype="cf_sql_varchar" value="#trim(form.supp)#">,'#packing#','#unit#','#wqformula#','#wpformula#','#val(ucost)#','#val(price)#','#val(price2)#',
	...
	<cfif checkitemExist.recordcount GT 0 >
		...
		<cfif form.mode eq "Edit">
			...
			<cfquery name="updateicitem" datasource="#dts#">
                ...
                FPRICE_MIN="#val(form.FPRICE_MIN)#",
                FPRICE2_MIN="#val(form.FPRICE2_MIN)#",
                FPRICE3_MIN="#val(form.FPRICE3_MIN)#",
                FPRICE4_MIN="#val(form.FPRICE4_MIN)#",
                FPRICE5_MIN="#val(form.FPRICE5_MIN)#",
                FPRICE6_MIN="#val(form.FPRICE6_MIN)#",
                FPRICE7_MIN="#val(form.FPRICE7_MIN)#",
                FPRICE8_MIN="#val(form.FPRICE8_MIN)#",
                FPRICE9_MIN="#val(form.FPRICE9_MIN)#",
                FPRICE10_MIN="#val(form.FPRICE10_MIN)#",
