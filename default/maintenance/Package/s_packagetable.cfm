...
<cfoutput>
    ...
    <form action="s_Packagetable.cfm" method="post">
		<h1>Search By :
	...
	<cfif isdefined("url.process")>
  	...
  	<cfif isdefined("form.searchStr")>
  		<cfquery datasource="#dts#" name="exactResult">
    		select * from package where #form.searchType# = '#form.searchStr#' order by #form.searchType#
		</cfquery>
			
  		<cfquery datasource="#dts#" name="similarResult">
    		select * from package where #form.searchType# LIKE <cfqueryparam cfsqltype="cf_sql_varchar" value="%#form.searchStr#%"> order by #form.searchType#
		</cfquery>
		...
		<table align="center" class="data" width="50%">
        	...
        	<tr> 
          		<td>#exactResult.packcode#</td>
          		<td>#exactResult.packdesp#</td>
          		<cfif getpin2.h1F11 eq 'T'>
				<td nowrap> 
            		<div align="center">
					<a href="Packagetable2.cfm?type=Delete&packcode=#exactResult.packcode#">
					<img height="18px" width="18px" src="/images/delete.ICO" alt="Delete" border="0">Delete</a>&nbsp; 
					<a href="Packagetable2.cfm?type=Edit&packcode=#exactResult.packcode#">
    ...
    <cfif similarResult.recordCount neq 0>
      	<table align="center" class="data" width="50%">					
	    	<tr>
	      	...
	      	<tr> 
          		<td>#similarResult.packcode#</td>
          		<td>#similarResult.packdesp#</td>
          		<cfif getpin2.h1F11 eq 'T'>
				<td nowrap> 
            		<div align="center">
					<a href="Packagetable2.cfm?type=Delete&packcode=#similarResult.packcode#">
					<img height="18px" width="18px" src="/images/delete.ICO" alt="Delete" border="0">Delete</a>&nbsp; 
					<a href="Packagetable2.cfm?type=Edit&packcode=#similarResult.packcode#">
					<img height="18px" width="18px" src="/images/edit.ICO" alt="Edit" border="0">Edit</a> 
            		</div>
				</td>
				</cfif>
  	...
  	<table align="center" class="data" width="50%">
    	...
    	<cfoutput query="type" maxrows="20"> 
      	<tr> 
        	...
        	<td>#type.packcode#</td>
        	<td nowrap>#type.packdesp#</td>
			<cfif getpin2.h1F11 eq 'T'>
				<td nowrap><div align="center">
					<a href="Packagetable2.cfm?type=Delete&packcode=#type.packcode#">
					<img height="18px" width="18px" src="/images/delete.ICO" alt="Delete" border="0">Delete</a>&nbsp; 
					<a href="Packagetable2.cfm?type=Edit&packcode=#type.packcode#">
