<cfcomponent output="false">
	...
	<cffunction name="getPromoItem" access="remote" returntype="any">
        ...
        <cfargument name="promoid" required="no" default="">
	    
	    <cfquery name="selUsers" datasource="#dts#">
			SELECT
				promoitemid,itemno,desp,itemprice,created_by,created_on
			FROM
				promoitem
	...
	<cffunction name="getPromoItemColumns" access="remote" returntype="any">
		...
		<cfquery name="selUsers" datasource="#dts#" result="selResult">
			SELECT
				promoitemid,itemno,desp,created_by,created_on
			FROM
				promoitem		
		</cfquery>
    ...
    <cffunction name="editPromoItem" access="remote">
        ...
        <cfswitch expression="#ARGUMENTS.gridaction#">
            ...
            <cfcase value="U">
                ...
                WHERE promoitemid = <cfqueryparam cfsqltype="cf_sql_varchar" value="#ARGUMENTS.gridrow.promoitemid#">
                </cfquery>
            </cfcase>
            <!--- Process deletes --->
            <cfcase value="D">
