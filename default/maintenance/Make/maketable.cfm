<html>
<head>
	<title>Maintenance Make</title></title>
...
<cfif getPersonnel.recordcount neq 0>
	...
	<cfform action="Maketable.cfm" method="post">
		...
		<cfif start neq 1>
			<cfoutput>|| <a href="maketable.cfm?start=#prevFive#">Previous</a> ||</cfoutput>
		</cfif>

		<cfif page neq noOfPage>
			<cfoutput> <a href="maketable.cfm?start=#evaluate(nextFive)#">Next</a> ||</cfoutput>
		</cfif>
		...
		<cfoutput query="getPersonnel" startrow="#start#" maxrows="5">
			...
			<table align="center" class="data" width="50%">
				...
				<tr>
					...
					<a href="Maketable2.cfm?type=Delete&Make=#evaluate(strNo)#"><img height="18px" width="18px" src="/images/delete.ICO" alt="Delete" border="0">Delete</a>
			  		<a href="Maketable2.cfm?type=Edit&Make=#evaluate(strNo)#"><img height="18px" width="18px" src="/images/edit.ICO" alt="Edit" border="0">Edit</a></div></td>
        		</tr>
				</cfif>
     	 	</table>
			<br>
