...
<cfoutput>
    ...
    <form action="s_Maketable.cfm" method="post">
		<h1>Search By :
	...
	<cfif isdefined("url.process")>
  	...
  	<cfif isdefined("form.searchStr")>
  		<cfquery datasource="#dts#" name="exactResult">
    		select * from vehiMake where #form.searchType# = '#form.searchStr#' order by #form.searchType#
		</cfquery>
			
  		<cfquery datasource="#dts#" name="similarResult">
    		select * from vehiMake where #form.searchType# LIKE <cfqueryparam cfsqltype="cf_sql_varchar" value="%#form.searchStr#%"> order by #form.searchType#
		</cfquery>
		...
		<table align="center" class="data" width="50%">
        	...
        	<tr> 
          		<td>#exactResult.Make#</td>
          		<td>#exactResult.desp#</td>
          		<cfif getpin2.h1F11 eq 'T'>
				<td nowrap> 
            		<div align="center">
					<a href="Maketable2.cfm?type=Delete&Make=#exactResult.Make#">
					<img height="18px" width="18px" src="/images/delete.ICO" alt="Delete" border="0">Delete</a>&nbsp; 
					<a href="Maketable2.cfm?type=Edit&Make=#exactResult.Make#">
    ...
    <cfif similarResult.recordCount neq 0>
      	<table align="center" class="data" width="50%">					
	    	<tr>
	      	...
	      	<tr> 
          		<td>#similarResult.Make#</td>
          		<td>#similarResult.desp#</td>
          		<cfif getpin2.h1F11 eq 'T'>
				<td nowrap> 
            		<div align="center">
					<a href="Maketable2.cfm?type=Delete&Make=#similarResult.Make#">
					<img height="18px" width="18px" src="/images/delete.ICO" alt="Delete" border="0">Delete</a>&nbsp; 
					<a href="Maketable2.cfm?type=Edit&Make=#similarResult.Make#">
					<img height="18px" width="18px" src="/images/edit.ICO" alt="Edit" border="0">Edit</a> 
            		</div>
				</td>
				</cfif>
      	...
      	<tr> 
			...
			<cfif getpin2.h1F11 eq 'T'>
				<td nowrap><div align="center">
					<a href="Maketable2.cfm?type=Delete&Make=#type.Make#">
					<img height="18px" width="18px" src="/images/delete.ICO" alt="Delete" border="0">Delete</a>&nbsp; 
					<a href="Maketable2.cfm?type=Edit&Make=#type.Make#">
