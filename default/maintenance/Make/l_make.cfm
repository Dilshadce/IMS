...
<cfquery name="getGroup" datasource="#dts#">
  select * from vehiMake
  <cfif form.groupfrom neq "" and form.groupto neq "">
	where Make >= '#form.groupfrom#' and Make <= '#form.groupto#'
  </cfif>
  order by Make
</cfquery>
...
<div align="center"><font color="#000000" size="3" face="Arial, Helvetica, sans-serif"><strong><cfoutput>Make</cfoutput> Listing</strong></font></div>
  ...
  <cfif getGroup.recordCount gt 0>
	...
	<table width="95%" border="0" class="" align="center">
	  ...
	  <tr>
        ...
        <td><strong><font size="2" face="Arial, Helvetica, sans-serif"><cfoutput>Make</cfoutput></font></strong></td>
	  ...
	  <cfloop query="getGroup">
	    ...
	    <tr>
	      ...
	      <td><cfif getpin2.h1511 eq 'T'><a href="Maketable2.cfm?type=Edit&Make=#Make#">#Make#</a><cfelse>#Make#</cfif></td>
	      <td>#desp#</td>
