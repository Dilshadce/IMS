...
<cfif getPersonnel.recordcount neq 0>
	...
	<cfform action="voucherprefix.cfm" method="post">
	...
	<cfif start neq 1>
		<cfoutput>|| <a href="voucherprefix.cfm?start=#prevFive#">Previous</a> ||</cfoutput>
	</cfif>
	
	<cfif page neq noOfPage>
		<cfoutput> <a href="voucherprefix.cfm?start=#evaluate(nextFive)#">Next</a> ||</cfoutput>
	</cfif>
...
<cfif isdefined("url.process")>
	...
	<cfset strNo = "getPersonnel.voucherprefixno">
	<!--- QCH <cfset strNo = "start">  --->
      ...
      <table align="center" class="data" width="550px">
        ...
        <tr> 
          ...
          <td>#getPersonnel.voucherprefixno#</td>
        </tr>
       

        <tr> 
          <td colspan="2"><div align="right"><a href="voucherprefix2.cfm?type=Delete&voucherprefixno=#evaluate(strNo)#"><img height="18px" width="18px" src="../../images/delete.ICO" alt="Delete" border="0"> 
              Delete</a> </div></td>
        </tr>
      </table>
