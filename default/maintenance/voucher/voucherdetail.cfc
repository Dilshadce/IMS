<cfcomponent output="false">
	...
	<cffunction name="getBatchs" access="remote" returntype="any">
	    ...
	    <cfargument name="rowbatch" required="no" default="">
	    ...
	    <cfquery name="selUsers" datasource="#dts#">
			...
			FROM
				voucher
			<cfif Arguments.rowbatch NEQ "">
				WHERE batch = <cfqueryparam cfsqltype="cf_sql_varchar" value="#Arguments.rowbatch#">
			</cfif>
    ...
    <cffunction name="editBatch" access="remote">
        ...
        <cfswitch expression="#ARGUMENTS.gridaction#">
            ...
            <cfcase value="U">
                ...
                WHERE voucherid = <cfqueryparam cfsqltype="cf_sql_varchar" value="#ARGUMENTS.gridrow.voucherid#">
                </cfquery>
            </cfcase>
            <!--- Process deletes --->
            <cfcase value="D">
