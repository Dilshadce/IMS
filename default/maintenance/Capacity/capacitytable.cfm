<html>
<head>
	<title>Maintenance Capacity</title></title>
...
<h1>View Capacity Informations</h1>
...
<cfif getPersonnel.recordcount neq 0>
	...
	<cfform action="Capacitytable.cfm" method="post">
		...
		<cfoutput query="getPersonnel" startrow="#start#" maxrows="5">
			...
			<table align="center" class="data" width="50%">
				...
				<tr>
					...
					<a href="Capacitytable2.cfm?type=Delete&Capacity=#evaluate(strNo)#"><img height="18px" width="18px" src="/images/delete.ICO" alt="Delete" border="0">Delete</a>
			  		<a href="Capacitytable2.cfm?type=Edit&Capacity=#evaluate(strNo)#"><img height="18px" width="18px" src="/images/edit.ICO" alt="Edit" border="0">Edit</a></div></td>
        		</tr>
				</cfif>
     	 	</table>
			<br>
	...
	<cfif start neq 1>
		<cfoutput>|| <a href="Capacitytable.cfm?start=#prevFive#">Previous</a> ||</cfoutput>
	</cfif>

	<cfif page neq noOfPage>
		<cfoutput> <a href="Capacitytable.cfm?start=#evaluate(nextFive)#">Next</a> ||</cfoutput>
	</cfif>
