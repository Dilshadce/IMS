...
<cfquery name="getGroup" datasource="#dts#">
  select * from vehicapacity
  <cfif form.groupfrom neq "" and form.groupto neq "">
	where Capacity >= '#form.groupfrom#' and Capacity <= '#form.groupto#'
  </cfif>
  order by Capacity
</cfquery>
...
<div align="center"><font color="#000000" size="3" face="Arial, Helvetica, sans-serif"><strong><cfoutput>Capacity</cfoutput> Listing</strong></font></div>
  ...
  <cfif getGroup.recordCount gt 0>
	...
	<table width="95%" border="0" class="" align="center">
	  ...
	  <tr>
        ...
        <td><strong><font size="2" face="Arial, Helvetica, sans-serif"><cfoutput>Capacity</cfoutput></font></strong></td>
	  ...
	  <cfloop query="getGroup">
	    ...
	    <tr>
	      ...
	      <td><cfif getpin2.h1511 eq 'T'><a href="Capacitytable2.cfm?type=Edit&Capacity=#Capacity#">#Capacity#</a><cfelse>#Capacity#</cfif></td>
	      <td>#desp#</td>
