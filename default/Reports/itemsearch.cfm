...
<body>	
 ...
 <!---  <h4><a href="..\maintenance\Icitem2.cfm?type=Create">Creating a New Item</a></h4> --->
	  ...
	  <table align="center" class="data" width="550px">					
		...
		<cfoutput query="exactResult">
		  <tr>
		    ...
		    <td><a href="C_stockcard.cfm?itemno1=#exactResult.itemno#&get=#get#<cfif isdefined("productfrom")>&productfrom=#productfrom#</cfif><cfif isdefined("productto")>&productto=#productto#</cfif>">Select</a>
			</td>
		  </tr>
	    </cfoutput>
	  </table>
	  ...
	  <table align="center" class="data" width="600px">					
		...
		<cfoutput query="similarResult">
		  <tr>
		    ...
		    <td><a href="C_stockcard.cfm?itemno1=#similarResult.itemno#&get=#get#<cfif isdefined("productfrom")>&productfrom=#productfrom#</cfif><cfif isdefined("productto")>&productto=#productto#</cfif>">Select</a>
			 </td>
		  </tr>
	    </cfoutput>
	  </table>
	  ...
	  <table align="center" class="data" width="600px">					
		...
		<cfoutput query="type1" maxrows="20">
		  <tr>
		    ...
		    <td>#type1.price#</td>
		    <td><a href="C_stockcard.cfm?itemno1=#type1.itemno#&get=#get#<cfif isdefined("productfrom")>&productfrom=#productfrom#</cfif><cfif isdefined("productto")>&productto=#productto#</cfif>">Select</a></td>
		  </tr>
