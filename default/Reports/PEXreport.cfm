...
<cfquery name='getP_EX1detail' datasource='#dts#'>
	select type,refno, fperiod, wos_date,desp,net,tax from artran where type = 'RC' and note = 'EX'
...
<cfif getP_EX2.recordcount gt 0>
  	<cfif getP_EX2.sumtax neq ''>
		<cfset P_EX2 = getP_EX2.sumtax>
  	</cfif>

	<cfif getP_EX2.sumnet neq ''>
		<cfset P_EXnet2 = getP_EX2.sumnet>
  	</cfif>
</cfif>

<cfquery name='getP_EX2detail' datasource='#dts#'>
  	select refno, fperiod, wos_date,desp,net,tax from artran where type = 'PR' and note = 'EX'
  	<cfif pfrom neq '' and pto neq ''>
	and fperiod >= '#pfrom#' and fperiod <= '#pto#'
  	</cfif>
  	order by wos_date,refno
...
<body>
<div align="center"><font size="3" face="Arial, Helvetica, sans-serif" color="#000000"><strong>EXEMPT PURCHASES</strong></font></div>
<table width="100%" border="0" cellspacing="0" cellpadding="2" align="center">
	<tr>
  	...
  	<tr>
    	...
    	<td><div align="right"><strong><font size="2" face="Arial, Helvetica, sans-serif">TAXABLE
        </font></strong></div></td>
  	</tr>
  	<tr>
    	<td colspan="7"><HR></td>
    ...
    <tr>
      	...
      	<td><font size="2" face="Arial, Helvetica, sans-serif">TOTAL EXMPT PURCHASES</font></td>
