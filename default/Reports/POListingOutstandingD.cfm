...
<html>
<head>
<title>Outstanding Vendor Purchases Listing Details by <cfoutput>#url.rgSort#</cfoutput></title>
...
<table width="100%" border="0" cellspacing="1" cellpadding="0">
	<tr>
		<td colspan="16"><div align="center"><font size="4" face="Arial black"><strong>MSD ENGINEERING PTE LTD</strong></font><br>
	...
	<tr>
      	<td colspan="13"><font size="1" face="Times New Roman, Times, serif"><strong>Outstanding Vendor Purchases Listing Details By <cfoutput>#url.rgsort#</cfoutput></strong></font></td>
...
<table width="100%" border="0" cellspacing="1" cellpadding="0">
    ...
    <tr>
      	...
      	<td width="5%"><div align="right"><font size="1" face="Times New Roman, Times, serif"><strong>YTD Rec'd</strong></font></div></td>
      	<td width="5%"><div align="right"><font size="1" face="Times New Roman, Times, serif"><strong>Current Qty Rec'd</strong></font></div></td>
      	<td width="5%"><div align="right"><font size="1" face="Times New Roman, Times, serif"><strong>Balance</strong></font></div></td>
      	<td width="5%"><div align="center"><font size="1" face="Times New Roman, Times, serif"><strong>Currcy</strong></font></div></td>
      	<td width="7%"><div align="left"><font size="1" face="Times New Roman, Times, serif"><strong>Total PO Value</strong></font></div></td>
      	<td width="7%"><div align="right"><font size="1" face="Times New Roman, Times, serif"><strong>Total Rec'd Value</strong></font></div></td>
      	<td width="7%"><div align="right"><font size="1" face="Times New Roman, Times, serif"><strong>Outstnd Value</strong></font></div></td>
      	<td width="5%"><div align="right"><font size="1" face="Times New Roman, Times, serif"></font></div></td>
      	<td width="7%"><div align="right"><font size="1" face="Times New Roman, Times, serif"><strong>Total PO Value</strong></font></div></td>
      	<td width="7%"><div align="right"><font size="1" face="Times New Roman, Times, serif"><strong>Total Rec'd</strong></font></div></td>
      	<td width="7%"><div align="right"><font size="1" face="Times New Roman, Times, serif"><strong>Outstnd Value</strong></font></div></td>
      	<td width="7%"><div align="right"><font size="1" face="Times New Roman, Times, serif"><strong>GRN No.</strong></font></div></td>
    </tr>
    <tr>
      	<td colspan="15"><hr></td>
    </tr>
...
<cfif rgSort eq "Purchase Order No">
	...
	<cfloop query = "getartran">
		<cfquery name = "getrcqty" datasource = "#dts#">
        	select qty_bil from ictran where type = 'RC' and dono = '#getartran.refno#' and qty <> '0'
        </cfquery>
        ...
        <cfif Balance neq 0>
			<!--- Print the sub-total --->
          	...
          	<tr>
            	<td valign="top" nowrap>&nbsp;</td>
            	<td><div align="left"><font face="Times New Roman, Times, serif"><font size="1"><strong>Supplier Code</strong></font></font></div></td>
            	<td colspan="5"><div align="left"><font face="Times New Roman, Times, serif"><font size="1"><strong>Supplier Name</strong></font></font></div></td>
            	<td><div align="left"><font face="Times New Roman, Times, serif"><font size="1"><strong>PO Date</strong></font></font></div></td>
            	<td colspan="3"><div align="center"><font face="Times New Roman, Times, serif"><font face="Times New Roman, Times, serif"><font size="1"><strong>Our PO No</strong></font></font><font size="1"></font></font></div></td>
            	...
            	<td colspan="4"><font size="1" face="Times New Roman, Times, serif"><strong>Contract No</strong></font></td>
          	</tr>
		  	<cfoutput>
          	<tr>
            	<td valign="top" nowrap>&nbsp;</td>
            	...
            	<td colspan="3"><div align="center"><font face="Times New Roman, Times, serif"><font size="1">#getSOCode.SOcode##getartran.dono#</font></font></td> --->
            	<td colspan="4"><font size="1" face="Times New Roman, Times, serif">#getartran.rem7#</font></td>
          	</tr>
		  	</cfoutput>
          	<tr>
            	<td valign="top" nowrap>&nbsp;</td>
		  	...
		  	<cfloop query = "getictran">
            	...
            	<tr>
			  	...
			  	<cfquery name="getCurr_Receive" datasource="#dts#">
              		select qty as qty_bil from iclink where type = 'RC' and frtype = 'PO' and itemno = '#getictran.itemno#' and frrefno = '#getictran.refno#'
              		and frtrancode = '#getictran.trancode#' order by wos_date
              		<!---select qty_bil from ictran where type = 'RC' and dono = '#stLastNo#'
              		and itemno = '#getictran.itemno#' and qty <> '0' order by trdatetime --->
              	</cfquery>
                ...
                <cfelse>
			  	...
			  	<td><div align="center"><font face="Times New Roman, Times, serif"><font size="1">#getCurrCode2.currcode#</font></font></div></td>
			  	...
			  	<cfquery name="getReceive" datasource="#dts#">
              		select refno from iclink where type ='RC' and frrefno = '#getictran.refno#' and frtype = 'PO'
              		and itemno = '#getictran.itemno#' and frtrancode = '#getictran.trancode#'
              	</cfquery>

			  	<td><div align="right"><font face="Times New Roman, Times, serif"><font size="1">&nbsp;<cfloop query="getreceive">#getRCCode.RCCode##getReceive.refno#</cfloop></font></font></div></td>
            </tr>
            <tr>
              	<td valign="top" nowrap>&nbsp;</td>
              	<td colspan="13"><div align="left"><font face="Times New Roman, Times, serif"><font size="1">#getictran.desp# #getictran.despa#</font></font></div></td>
              	<td>&nbsp;</td>
            </tr>
			</cfoutput>
          	...
          	<cfloop query = "getictran">
            	...
            	<tr>
			  		...
			  		<cfquery name="getYTD" datasource="#dts#">
						...
						and a.type = 'RC' and a.itemno = b.itemno and b.itemno = '#getictran.itemno#' and a.frtrancode = '#getictran.trancode#'
              			<!---select sum(qty_bil) as QTY_YTD, sum(amt_bil) as FC_amt1, sum(amt)
              			as SGD_amt1 from ictran where type = 'RC' and dono = '#getictran.refno#'
              			and itemno = '#getictran.itemno#' and qty <> '0' --->
              		</cfquery>
				...
				<cfquery name="getRCCode" datasource="#dts#">
              	...
              	<cfquery name="getReceive" datasource="#dts#">
              		select refno from iclink where type ='RC' and frrefno = '#getictran.refno#' and frtype = 'PO' and itemno = '#getictran.itemno#' and frtrancode = '#getictran.trancode#'
              	</cfquery>
              	<td><div align="right"><font face="Times New Roman, Times, serif"><font size="1">&nbsp;<cfloop query="getreceive">#getRCCode.RCCode##getReceive.refno# </cfloop></font></font></div></td>
            </tr>
            <tr>
