...
<cfquery name='getS_EX1detail' datasource='#dts#'>
    select type,refno, fperiod, wos_date,desp,net,tax from artran where (type = 'INV' or type = 'DN' or type = 'CS') and note = 'EX'
...
<cfif getS_EX2.recordcount gt 0>
  <cfif #getS_EX2.sumtax# neq ''>
	<cfset S_EX2 = #getS_EX2.sumtax#>
  </cfif>
  <cfif #getS_EX2.sumnet# neq ''>
	<cfset S_EXnet2 = #getS_EX2.sumnet#>
  </cfif>
</cfif>

<cfquery name='getS_EX2detail' datasource='#dts#'>
  select refno, fperiod, wos_date,desp,net,tax from artran where type = 'CN' and note = 'EX' and (void = '' or void is null)
  <cfif pfrom neq '' and pto neq ''>
	and fperiod >= '#pfrom#' and fperiod <= '#pto#'
  </cfif>
  order by wos_date,refno
...
<body>
<div align="center"><font size="3" face="Arial, Helvetica, sans-serif" color="#000000"><strong>EXEMPT
...
<table width="100%" border="0" cellspacing="0" cellpadding="2" align="center">
  ...
  <cfloop query="getS_EX1detail">
    ...
    <tr>
      ...
      <td><font size="2" face="Arial, Helvetica, sans-serif">TOTAL EXMPT SALES</font></td>
