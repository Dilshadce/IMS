...
<cfquery name='getS_ZR1detail' datasource='#dts#'>
	select type,refno,desp,fperiod,wos_date,net from artran where (type = 'INV' or type = 'DN' or type = 'CS') and note = 'ZR'
	<cfif pfrom neq '' and pto neq ''>
	and fperiod >= '#pfrom#' and fperiod <= '#pto#'
  	</cfif>
</cfquery>
...
<cfquery name='getS_ZR2detail' datasource='#dts#'>
  select refno,desp,fperiod,wos_date,net from artran where type = 'CN' and note = 'ZR'
  <cfif pfrom neq '' and pto neq ''>
  and fperiod >= '#pfrom#' and fperiod <= '#pto#'
  </cfif>
</cfquery>

<cfloop query="getS_ZR2detail">
	<cfset xnet2 = net>
	<!--- <cfset xtax2 = #tax#> --->
...
<body>
<div align="center"><font size="3" face="Arial, Helvetica, sans-serif" color="#000000"><strong>ZERO-RATED SALES</strong></font></div>
<table width="100%" border="0" cellspacing="0" cellpadding="2" align="center">
    ...
    <tr>
      	...
      	<td><font size="2" face="Arial, Helvetica, sans-serif">TOTAL ZERO-RATED SALES</font></td>
