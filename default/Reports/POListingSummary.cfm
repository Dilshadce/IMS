...
<html>
<head>
<title>Vendor Purchase Summary By <cfoutput>#url.rgSort#</cfoutput></title>
...
<table width="100%" border="0" cellspacing="1" cellpadding="0">
	...
	<tr>
	  	<td width="72%"><font size="1" face="Times New Roman, Times, serif"><strong>Vendor Purchases Listing Summary By <cfoutput>#url.rgsort#</cfoutput></strong></font></td>
...
<table width="100%" border="0" cellspacing="1" cellpadding="0">
	<tr>
	  	...
	  	<td><div align="right"><font size="1" face="Times New Roman, Times, serif"><strong>SGD Equialent</strong></font></div></td>
	</tr>
	<tr>
	  	<td width="5%" nowrap><div align="left"><font size="1" face="Times New Roman, Times, serif"><strong>Supplier Code</strong></font></div></td>
		<td width="23%"><div align="left"><font size="1" face="Times New Roman, Times, serif"><strong>Supplier Name</strong></font></div></td>
	  	<td width="8%"><div align="left"><font size="1" face="Times New Roman, Times, serif"><strong>SO Date</strong></font></div></td>
	  	<td width="10%"><div align="left"><font size="1" face="Times New Roman, Times, serif"><strong>Contract No.</strong></font></div></td>
	  	<td width="8%"><div align="left"><font size="1" face="Times New Roman, Times, serif"><strong>PO Date </strong></font></div></td>
	  	<td width="8%"><div align="left"><font size="1" face="Times New Roman, Times, serif"><strong>Our PO No.</strong></font></div></td>
	  	...
	  	<td width="6%"><div align="right"><font size="1" face="Times New Roman, Times, serif"></font></div></td>
...
<cfif rgSort eq "Purchase Order No">
	<cfloop query = "getartran">
		...
		<tr>
		    ...
		    <cfquery name="getsodate" datasource="#dts#">
		  		select wos_date from artran where refno = '#getartran.rem7#' and type = 'SO'
		 	</cfquery>
		  	...
		  	<!--- <cfquery name="getSO" datasource="#dts#">
				select sono, dodate from ictran where refno ='#getartran.refno#' and type = 'PO' and qty <> '0'
		  	</cfquery> --->
		  	<td><font face="Times New Roman, Times, serif"><font size="1"><cfif getsodate.recordcount gt 0>#dateformat(getsodate.wos_date,"dd/mm/yyyy")#</cfif></font></font></td>
		  	<td><div align="left"><font size="1" face="Times New Roman, Times, serif">#getSOCode.socode##getartran.rem7#</font></div></td>
		  	<td><font face="Times New Roman, Times, serif"><font size="1">#dateformat(wos_date,"dd/mm/yyyy")#</font></font></td>
		  	...
		  	<cfquery name="getCurrCode2" datasource="#dts#">
				select currcode from supplier where customerno ='#getartran.custno#'
		  	</cfquery>
			...
			Select currrate from ictran where type = 'SO' and refno = '#getartran.refno#'
		  	</cfquery> --->
		  	<td><div align="right"><font size="1" face="Times New Roman, Times, serif">#numberformat(getartran.currrate,'____.____')#</font></div></td>
			<!---<cfset temp = #getCurrRate.currrate# * #getartran.grand_bil#>--->
		  	<td><div align="right"><font size="1" face="Times New Roman, Times, serif">#numberformat(getartran.grand,',_.__')#</font></div></td>

		  	<cfset maxArray = right(CurrArray2[1][1],1)>

			<cfloop index = "i" from = "1" to = "#maxArray#">
				<cfif CurrArray2[i+1][1] eq getcurrcode2.currcode>
			  		<cfif getartran.grand_bil gt 0>
			    		<cfset CurrArray2[i+1][2] = CurrArray2[i+1][2] + getartran.grand_bil>
			    		<cfset CurrArray2[i+1][3] = CurrArray2[i+1][3] + 1>
			    		<cfset CurrArray2[i+1][4] = CurrArray2[i+1][4] + getartran.currrate>
			    		<cfset CurrArray2[i+1][5] = CurrArray2[i+1][5] + getartran.grand>
			  		</cfif>
				</cfif>
				<cfset i = i + 1>
		  	</cfloop>
...
<cfif rgSort eq "Supplier Name">
	<cfloop query = "getartran">
		<cfoutput>
		<tr>
		<cfif getartran.name neq stLastNo and stLastNo neq "">
		<tr>
			<td colspan="10"><hr></td>
		</tr>
		...
		<cfloop index = "i" from = "1" to = "#maxArray#">
			<cfif CurrArray[i+1][1] eq stLastCurr>
				<tr>
				  	<td colspan="4" valign="top" nowrap>&nbsp;</td>
				  	<cfif stDisplay eq 0>
	...
	<cfif getartran.name neq stLastNo>
		<td valign="top" nowrap><font face="Times New Roman, Times, serif"><font size="1">#getartran.custno#</font></font></td>
		<td nowrap><font face="Times New Roman, Times, serif"><font size="1">#getartran.name#</font></font></td>
	<cfelse>
	...
	<cfloop index = "i" from = "1" to = "#maxArray#">
		...
		<cfif CurrArray[i+1][1] eq getcurrcode2.currcode>
			<cfif getartran.grand_bil gt 0>
			    ...
			    <cfset CurrArray[i+1][4] = CurrArray[i+1][4] + getartran.currrate>
			    <cfset CurrArray[i+1][5] = CurrArray[i+1][5] + getartran.grand>
			</cfif>
		</cfif>
		<cfset i = i + 1>
	</cfloop>
...
<cfif rgSort eq "Supplier Code">
	<cfloop query = "getartran">
		<cfoutput>
		<tr>
  	      <cfif getartran.custno neq stLastNo and stLastNo neq "">
		    <tr>
			  <td colspan="10"><hr></td>
			</tr>
			<cfset maxArray = right(CurrArray[1][1],1)>
		...
		<cfif getartran.custno neq stLastNo>
			<td valign="top" nowrap><font face="Times New Roman, Times, serif"><font size="1">#getartran.custno#</font></font></td>
		    <td nowrap><font face="Times New Roman, Times, serif"><font size="1">#getartran.name#</font></font></td>
		<cfelse>
  		    <td colspan="2" valign="top" nowrap>&nbsp;</td>
...
<cfif rgSort eq "Month">
	<cfloop query = "getartran">
		<cfoutput>
		<tr>
			<cfif year(getartran.wos_date) & month(getartran.wos_date) neq stLastNo and stLastNo neq "">
		    	<tr>
			  		<td colspan="10"><hr></td>
				</tr>
				<cfset maxArray = right(CurrArray[1][1],1)>
			...
			<!---<cfif year(#getartran.wos_date#) & month(#getartran.wos_date#) neq #stLastNo#> --->
		    <td valign="top" nowrap><font face="Times New Roman, Times, serif"><font size="1">#getartran.custno#</font></font></td>
          	<td nowrap><font face="Times New Roman, Times, serif"><font size="1">#getartran.name#</font></font></td>
			<!---<cfelse>
  		    <td colspan="2" valign="top" nowrap>&nbsp;</td>
...
<!---
GRN No	GRN No	GRN No	GRN No	GRN No	GRN No	GRN No	GRN No	GRN No	GRN No	GRN No	GRN No
GRN No	GRN No	GRN No	GRN No	GRN No	GRN No	GRN No	GRN No	GRN No	GRN No	GRN No	GRN No
GRN No	GRN No	GRN No	GRN No	GRN No	GRN No	GRN No	GRN No	GRN No	GRN No	GRN No	GRN No
GRN No	GRN No	GRN No	GRN No	GRN No	GRN No	GRN No	GRN No	GRN No	GRN No	GRN No	GRN No
GRN No	GRN No	GRN No	GRN No	GRN No	GRN No	GRN No	GRN No	GRN No	GRN No	GRN No	GRN No
