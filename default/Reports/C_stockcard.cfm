...
<cfoutput>
<cfif pfrom neq "">
	<form action= "itemsearch.cfm?get=from<cfif form.productto neq "">&productto=#productto#</cfif>" method="post" name="form123">
	</form>
	<script>
		form123.submit();
	</script>
	<cfabort>
<cfelseif pto neq "">
	<form action= "itemsearch.cfm?get=to<cfif form.productfrom neq "">&productfrom=#productfrom#</cfif>" method="post" name="form123">
	</form>
	<script>
		form123.submit();
	</script>
...
<cfelseif Submit eq "Submit">
	<form name="form123" action= "C_stockcard2.cfm" method="post"  target="_blank">
...
<body>
<h1 align="center">View Stock Card Report</h1>

<form action="C_stockcard.cfm" name="form" method="post">
  <table border="0" align="center" width="80%" class="data">
    ...
    <tr>
      ...
      <td colspan="2" nowrap>
	    ...
	    <cfif isdefined("url.productto")>
		  ...
		  <input type="submit" name="pto" value="Search"> </td>
    </tr>
    <tr>
      <td colspan="5"><hr></td>
    </tr>
    ...
    <tr>
      <th width="16%">Date</th>
      <td width="5%"> <div align="center">To</div></td>
      <td width="69%"><input type="text" name="dateto" maxlength="10" validate="eurodate" size="10">
        (DD/MM/YYYY)&nbsp; </td>
