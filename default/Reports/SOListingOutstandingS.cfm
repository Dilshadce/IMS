...
<html>
<head>
<title>Outstanding SO Listing Summary By <cfoutput>#url.rgSort#</cfoutput></title>
...
<table width="100%" border="0" cellspacing="1" cellpadding="0">
	<tr>
		<td colspan="11"><div align="center"><font size="4" face="Arial black"><strong>MSD ENGINEERING PTE LTD</strong></font><br>
	...
	<tr>
      	<td colspan="9"><font size="1" face="Times New Roman, Times, serif"><strong>Outstanding SO Listing Summary By <cfoutput>#url.rgsort#</cfoutput></strong></font></td>
...
<table width="100%" border="0" cellspacing="1" cellpadding="0">
	<tr>
		<td colspan="3" nowrap><font size="1" face="Times New Roman, Times, serif">&nbsp;</font></td>
      	<td colspan="3" nowrap><div align="center"><font size="1" face="Times New Roman, Times, serif"><strong>Foreign Currency</strong></font></div></td>
      	<td nowrap><div align="center"><font size="1" face="Times New Roman, Times, serif"><strong>Exchg Rate</strong></font></div></td>
      	<td colspan="3" nowrap><div align="center"><font size="1" face="Times New Roman, Times, serif"><strong>SGD Equialent</strong></font></div></td>
      	<td nowrap></td>
    </tr>
    <tr>
      	<td nowrap></td>
      	<td nowrap></td>
      	<!---<td width="5%"><div align="right"><font size="1" face="Times New Roman, Times, serif"><strong>Qty Ordered</strong></font></div></td>
      	<td width="5%"><div align="right"><font size="1" face="Times New Roman, Times, serif"><strong>YTD Delivrd</strong></font></div></td>
      	<td width="5%"><div align="right"><font size="1" face="Times New Roman, Times, serif"><strong>Current<br>Qty Delivrd</strong></font></div></td>
      	<td width="5%"><div align="right"><font size="1" face="Times New Roman, Times, serif"><strong>Balance</strong></font></div></td>--->
      	<td nowrap><div align="center"><font size="1" face="Times New Roman, Times, serif"><strong>Currcy</strong></font></div></td>
      	<td nowrap><div align="right"><font size="1" face="Times New Roman, Times, serif"><strong>Total SO Value</strong></font></div></td>
      	<td nowrap><div align="right"><font size="1" face="Times New Roman, Times, serif"><strong>Total Delivrd Value</strong></font></div></td>
      	<td nowrap><div align="right"><font size="1" face="Times New Roman, Times, serif"><strong>Outstnd Value</strong></font></div></td>
      	<td nowrap></td>
      	<td nowrap><div align="right"><font size="1" face="Times New Roman, Times, serif"><strong>Total SO Value</strong></font></div></td>
      	<td nowrap><div align="right"><font size="1" face="Times New Roman, Times, serif"><strong>Total Delivrd</strong></font></div></td>
      	<td nowrap><div align="right"><font size="1" face="Times New Roman, Times, serif"><strong>Outstnd Value</strong></font></div></td>
      	<td nowrap><div align="center"><font size="1" face="Times New Roman, Times, serif"><strong>Invoice No.</strong></font></div></td>
    </tr>
    <tr>
      	<td colspan="11"><hr></td>
    </tr>
        	...
        	<cfif Balance neq 0>
          	<!--- Print the sub-total --->
          		<cfif stLastNo neq getartran.refno and stLastNo neq "">
            		...
            		<tr>
              			<td colspan="11" valign="top" nowrap>&nbsp;</td>
            		</tr>
          		</cfif>
          		<!---<cfif stLastNo eq ""> --->
          		<tr>
            		<td nowrap valign="top"></td>
            		<td nowrap><div align="left"><font face="Times New Roman, Times, serif"><font size="1"><strong>Client Code</strong></font></font></div></td>
            		<td nowrap><div align="left"><font face="Times New Roman, Times, serif"><font size="1"><strong>Company Name</strong></font></font></div></td>
            		<td nowrap></td>
					<td nowrap><div align="left"><font face="Times New Roman, Times, serif"><font size="1"><strong>SO Date</strong></font></font></div></td>
            		<td nowrap><div align="center"><font face="Times New Roman, Times, serif"><font size="1"><strong>Client PO</strong></font></font></div></td>
            		<td nowrap></td>
            		<td nowrap colspan="3"><div align="center"><font face="Times New Roman, Times, serif"><font size="1"><strong>Contract No.</strong></font></font></div></td>
            		<td nowrap></td>
          		</tr>

		  		<cfquery name="getdo" datasource="#dts#">
		  			select distinct(refno)as refno, toinv from ictran where sono = '#getartran.refno#' and type = 'DO'
		  		</cfquery>
          		...
          		<tr>
            		...
            		<td nowrap><div align="center"><font face="Times New Roman, Times, serif"><font size="1">#getartran.rem9#</font></div></td>
            		<td nowrap><div align="center"><font face="Times New Roman, Times, serif"><font size="1">#numberformat(currrate,",.____")#</font></font></div></td>
            		<td nowrap colspan="3"><div align="center"><font face="Times New Roman, Times, serif"><font size="1">#getgeneral.prefix##getartran.refno#</font></div></td>
            		<td nowrap><cfloop query="getdo">
								<font size="1" face="Times New Roman, Times, serif">#getdo.toinv#</font>
              					</cfloop>
					</td>
          		</tr>
		  		</cfoutput>
            	...
            	<td>&nbsp;</td>
		  		...
		  		<cfloop query = "getictran">
            		<cfquery name="getYTD" datasource="#dts#">
            			...
            			= b.type and b.refno = '#getictran.refno#' and b.type = 'SO' and a.type
            			= 'DO' and a.itemno = b.itemno and b.itemno = '#getictran.itemno#'
            			and a.frtrancode = '#getictran.trancode#'
            			<!--- select sum(qty_bil) as QTY_YTD, sum(amt_bil) as FC_amt1, sum(amt)
            			as SGD_amt1 from ictran where type ='DO' and sono = '#stLastNo#' and
            			itemno = '#getictran.itemno#' and qty <> '0'  --->
            		</cfquery>
					...
					<cfquery name="getCurr_Delivery" datasource="#dts#">
            			select qty as qty_bil from iclink where type = 'DO' and frtype = 'SO'
            			and itemno = '#getictran.itemno#' and frrefno = '#getictran.refno#'
            			and frtrancode = '#getictran.trancode#' order by wos_date
						<!--- select qty_bil from ictran where type ='DO' and sono = '#stLastNo#'
            			and itemno = '#getictran.itemno#' and qty <> '0' order by wos_date  --->
            		</cfquery>
        	...
        	<cfif Balance neq 0>
          		<cfif stLastNo neq getartran.name>
			  			...
			  			<cfloop index = "i" from = "1" to = "#maxArray#">
                			<cfif CurrArray1[i+1][6] neq 0 or CurrArray1[i+1][1] eq "SGD">
				  				...
				  				<tr>
									...
									<td nowrap><div align="center"><font size="1" face="Times New Roman, Times, serif">#CurrArray1[i+1][1]#</font></div></td>
									<td nowrap><div align="right"><font size="1" face="Times New Roman, Times, serif">#numberformat(CurrArray1[i+1][6],',_.__')#</font></div></td>
									<td nowrap><div align="right"><font size="1" face="Times New Roman, Times, serif">#numberformat(CurrArray1[i+1][7],',_.__')#</font></div></td>
									<td nowrap><div align="right"><font size="1" face="Times New Roman, Times, serif">#numberformat(CurrArray1[i+1][8],',_.__')#</font></div></td>
									<td nowrap></td>
									<td nowrap><div align="right"><font size="1" face="Times New Roman, Times, serif">#numberformat(CurrArray1[i+1][9],',_.__')#</font></div></td>
									<td nowrap><div align="right"><font size="1" face="Times New Roman, Times, serif">#numberformat(CurrArray1[i+1][10],',_.__')#</font></div></td>
									<td nowrap><div align="right"><font size="1" face="Times New Roman, Times, serif">#numberformat(CurrArray1[i+1][11],',_.__')#</font></div></td>
									<td nowrap></td>
                  				</tr>
				  				</cfoutput>
                			</cfif>
            		...
            		<tr>
              			...
              			<td nowrap><div align="left"><font face="Times New Roman, Times, serif"><font size="1">#getartran.name#</font></font></div></td>
					  	<td nowrap></td>
						<td nowrap><div align="left"><font size="1" face="Times New Roman, Times, serif"><cfloop query="getartran">#dateformat(getartran.wos_date,"dd/mm/yyyy")#<cfif getartran.recordcount gt 1><br></cfif></cfloop></font></div></td>
					  	<td nowrap><div align="center"><font face="Times New Roman, Times, serif"><font size="1"><cfloop query="getartran">#getartran.rem9#<cfif getartran.recordcount gt 1><br></cfif></cfloop></font></div></td>
					  	<td nowrap><div align="center"><font face="Times New Roman, Times, serif"><font size="1"><cfloop query="getartran">#numberformat(currrate,",.____")#<cfif getartran.recordcount gt 1><br></cfif></cfloop></font></font></div></td>
					  	<td colspan="3"><div align="center"><font face="Times New Roman, Times, serif"><font size="1"><cfloop query="getartran">#getgeneral.prefix##getartran.refno#<cfif getartran.recordcount gt 1><br></cfif></cfloop></font></div></td>
					  	<td nowrap><cfloop query="getdo">
                					<font size="1" face="Times New Roman, Times, serif">#getdo.toinv#</font>
									</cfloop>
						</td>
        	...
        	<cfif Balance neq 0>
          		<cfif stLastNo neq getartran.custno>
            		...
            		<tr>
              			...
              			<td nowrap></td>
						<td nowrap><div align="left"><font size="1" face="Times New Roman, Times, serif"><cfloop query="getartran">#dateformat(getartran.wos_date,"dd/mm/yyyy")#<cfif getartran.recordcount gt 1><br></cfif></cfloop></font></div></td>
              			<td nowrap><div align="center"><font face="Times New Roman, Times, serif"><font size="1"><cfloop query="getartran">#getartran.rem9#<cfif getartran.recordcount gt 1><br></cfif></cfloop></font></font></td>
              			<td nowrap><div align="center"><font face="Times New Roman, Times, serif"><font size="1"><cfloop query="getartran">#numberformat(currrate,",.____")#<cfif getartran.recordcount gt 1><br></cfif></cfloop></font></font></div></td>
              			<td nowrap colspan="3"><div align="center"><font face="Times New Roman, Times, serif"><font size="1"><cfloop query="getartran">#getgeneral.prefix##getartran.refno#<cfif getartran.recordcount gt 1><br></cfif></cfloop></font></font></td>
              			<td nowrap><cfloop query="getdo">
									<font size="1" face="Times New Roman, Times, serif">#getdo.toinv#</font>
              						</cfloop>
						</td>
...
--->
					...
					<cfloop index = "i" from = "1" to = "#maxArray#">
              			<cfif CurrArray[i+1][6] neq 0>
                			...
                			<tr>
							  	...
							  	<td><div align="right"><font size="1" face="Times New Roman, Times, serif">#CurrArray[i+1][4]#</font></div></td>
							  	<td><div align="right"><font size="1" face="Times New Roman, Times, serif">#CurrArray[i+1][5]#</font></div></td>--->
							  	<td nowrap><div align="center"><font size="1" face="Times New Roman, Times, serif">#CurrArray[i+1][1]#</font></div></td>
							 	<td nowrap><div align="right"><font size="1" face="Times New Roman, Times, serif">#numberformat(CurrArray[i+1][6],',_.__')#</font></div></td>
							  	<td nowrap><div align="right"><font size="1" face="Times New Roman, Times, serif">#numberformat(CurrArray[i+1][7],',_.__')#</font></div></td>
							  	<td nowrap><div align="right"><font size="1" face="Times New Roman, Times, serif">#numberformat(CurrArray[i+1][8],',_.__')#</font></div></td>
							  	<td nowrap>&nbsp;</td>
							  	<td nowrap><div align="right"><font size="1" face="Times New Roman, Times, serif">#numberformat(CurrArray[i+1][9],',_.__')#</font></div></td>
							  	<td nowrap><div align="right"><font size="1" face="Times New Roman, Times, serif">#numberformat(CurrArray[i+1][10],',_.__')#</font></div></td>
							  	<td nowrap><div align="right"><font size="1" face="Times New Roman, Times, serif">#numberformat(CurrArray[i+1][11],',_.__')#</font></div></td>
							  	<td nowrap></td>
                			</tr>
                			<tr>
                  				<td colspan="11"><hr></td>
    ...
    <cfif rgSort neq "Client Name" and rgSort neq "Client Code">
      	<cfset maxArray = right(CurrArray[1][1],1)>
		...
		<cfloop index = "i" from = "1" to = "#maxArray#">
        	<cfif CurrArray[i+1][6] neq 0>
          		...
          		<tr>
					...
					<td nowrap><div align="center"><font size="1" face="Times New Roman, Times, serif"><cfoutput>#CurrArray[i+1][1]#</cfoutput></font></div></td>
					<td nowrap><div align="right"><font size="1" face="Times New Roman, Times, serif"><cfoutput>#numberformat(CurrArray[i+1][6],',_.__')#</cfoutput></font></div></td>
					<td nowrap><div align="right"><font size="1" face="Times New Roman, Times, serif"><cfoutput>#numberformat(CurrArray[i+1][7],',_.__')#</cfoutput></font></div></td>
					<td nowrap><div align="right"><font size="1" face="Times New Roman, Times, serif"><cfoutput>#numberformat(CurrArray[i+1][8],',_.__')#</cfoutput></font></div></td>
					<td nowrap></td>
					<td nowrap><div align="right"><font size="1" face="Times New Roman, Times, serif"><cfoutput>#numberformat(CurrArray[i+1][9],',_.__')#</cfoutput></font></div></td>
					<td nowrap><div align="right"><font size="1" face="Times New Roman, Times, serif"><cfoutput>#numberformat(CurrArray[i+1][10],',_.__')#</cfoutput></font></div></td>
					<td nowrap><div align="right"><font size="1" face="Times New Roman, Times, serif"><cfoutput>#numberformat(CurrArray[i+1][11],',_.__')#</cfoutput></font></div></td>
					<td nowrap></td>
          		</tr>
          		<tr>
            		<td colspan="11"><hr></td>
	  	...
	  	<cfloop index = "i" from = "1" to = "#maxArray#">
        	<cfif CurrArray1[i+1][6] neq 0 or CurrArray1[i+1][1] eq "SGD">
          		<tr>
					...
					<td nowrap><div align="center"><font size="1" face="Times New Roman, Times, serif"><cfoutput>#CurrArray1[i+1][1]#</cfoutput></font></div></td>
					<td nowrap><div align="right"><font size="1" face="Times New Roman, Times, serif"><cfoutput>#numberformat(CurrArray1[i+1][6],',_.__')#</cfoutput></font></div></td>
					<td nowrap><div align="right"><font size="1" face="Times New Roman, Times, serif"><cfoutput>#numberformat(CurrArray1[i+1][7],',_.__')#</cfoutput></font></div></td>
					<td nowrap><div align="right"><font size="1" face="Times New Roman, Times, serif"><cfoutput>#numberformat(CurrArray1[i+1][8],',_.__')#</cfoutput></font></div></td>
					<td nowrap></td>
					<td nowrap><div align="right"><font size="1" face="Times New Roman, Times, serif"><cfoutput>#numberformat(CurrArray1[i+1][9],',_.__')#</cfoutput></font></div></td>
					<td nowrap><div align="right"><font size="1" face="Times New Roman, Times, serif"><cfoutput>#numberformat(CurrArray1[i+1][10],',_.__')#</cfoutput></font></div></td>
					<td nowrap><div align="right"><font size="1" face="Times New Roman, Times, serif"><cfoutput>#numberformat(CurrArray1[i+1][11],',_.__')#</cfoutput></font></div></td>
					<td nowrap></td>
          		</tr>
        	</cfif>
      	</cfloop>
    ...
    <cfset T_SGD_Outstanding = #CurrArray2[2][11]#></tr>
    --->
    <cfset maxArray = right(CurrArray2[1][1],1)>
    <cfset DisplayTotal = 0>
      	...
      	<cfif CurrArray2[i+1][2] neq 0 or CurrArray2[i+1][1] eq "SGD">
        	<tr>
            	...
            	<cfelse>
			  	...
			  	<td nowrap><div align="center"><font size="1" face="Times New Roman, Times, serif"><cfoutput>#CurrArray2[i+1][1]#</cfoutput></font></div></td>
			  	<td nowrap><div align="right"><font size="1" face="Times New Roman, Times, serif"><cfoutput>#numberformat(CurrArray2[i+1][6],',_.__')#</cfoutput></font></div></td>
			  	<td nowrap><div align="right"><font size="1" face="Times New Roman, Times, serif"><cfoutput>#numberformat(CurrArray2[i+1][7],',_.__')#</cfoutput></font></div></td>
			  	<td nowrap><div align="right"><font size="1" face="Times New Roman, Times, serif"><cfoutput>#numberformat(CurrArray2[i+1][8],',_.__')#</cfoutput></font></div></td>
			  	<td nowrap></td>
			  	<td nowrap><div align="right"><font size="1" face="Times New Roman, Times, serif"><cfoutput>#numberformat(CurrArray2[i+1][9],',_.__')#</cfoutput></font></div></td>
			  	<td nowrap><div align="right"><font size="1" face="Times New Roman, Times, serif"><cfoutput>#numberformat(CurrArray2[i+1][10],',_.__')#</cfoutput></font></div></td>
			  	<td nowrap><div align="right"><font size="1" face="Times New Roman, Times, serif"><cfoutput>#numberformat(CurrArray2[i+1][11],',_.__')#</cfoutput></font></div></td>
			  	<td nowrap></td>
    ...
    <tr>
      	...
      	<td nowrap><div align="right"><font size="1" face="Times New Roman, Times, serif"><cfoutput>#numberformat(T_FC_SO,',_.__')#</cfoutput></font></div></td>
      	<td nowrap><div align="right"><font size="1" face="Times New Roman, Times, serif"><cfoutput>#numberformat(T_FC_Delivery,',_.__')#</cfoutput></font></div></td>
      	<td nowrap><div align="right"><font size="1" face="Times New Roman, Times, serif"><cfoutput>#numberformat(T_FC_Outstanding,',_.__')#</cfoutput></font></div></td>
      	<td nowrap></td>
      	<td nowrap><div align="right"><font size="1" face="Times New Roman, Times, serif"><cfoutput>#numberformat(T_SGD_SO,',_.__')#</cfoutput></font></div></td>
      	<td nowrap><div align="right"><font size="1" face="Times New Roman, Times, serif"><cfoutput>#numberformat(T_SGD_Delivery,',_.__')#</cfoutput></font></div></td>
      	<td nowrap><div align="right"><font size="1" face="Times New Roman, Times, serif"><cfoutput>#numberformat(T_SGD_Outstanding,',_.__')#</cfoutput></font></div></td>
      	<td nowrap></td>
	</tr>
</table>
<br>
