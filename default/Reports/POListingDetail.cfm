...
<html>
<head>
<title>Vendor Purchase Listing Detail By <cfoutput>#url.rgsort#</cfoutput></title>
...
<table width="100%" border="0" cellspacing="1" cellpadding="0">
	...
	<tr>
      	<td><font size="1" face="Times New Roman, Times, serif"><strong>Vendor Purchases Listing Detail By <cfoutput>#url.rgsort#</cfoutput></strong></font></td>
...
<cfif rgSort eq "Purchase Order No">
	...
	<cfloop query = "getartran">
		...
		<cfoutput>
        <tr>
          	<td colspan="15" valign="top" nowrap><font face="Times New Roman, Times, serif"><font size="1"><strong>#getartran.custno# #getartran.name# </strong>Tel: #getCust.phone# #getCust.phonea# <strong>#getartran.rem7#</strong></font></font></td>
        </tr>
        <tr>
          	<td colspan="15" valign="top" nowrap><div align="left"><font face="Times New Roman, Times, serif"><font size="1">#getcust.add1# #getcust.add2# #getcust.add3# #getcust.add4#</font></font></div></td>
        </tr>
        <tr>
          	<td valign="top" nowrap>&nbsp;</td>
          	<td colspan="2"><font face="Times New Roman, Times, serif"><font size="1">#getgeneral.prefix##getartran.refno#</font></font></td>
          	<td><font face="Times New Roman, Times, serif"><font size="1">#dateformat(getartran.wos_date,"dd/mm/yyyy")#</font></font></td>
          	<td colspan="10"><font face="Times New Roman, Times, serif"><font size="1">&nbsp;</font></font></td>
        </tr>
		</cfoutput>
		...
		<cfloop query = "getictran">
			<cfoutput>
		  	<tr>
            	<td><div align="right"><font face="Times New Roman, Times, serif"><font size="1">#getictran.currentrow#.&nbsp;</font></font></div></td>
				...
				<cfquery name="getReceive" datasource="#dts#">
					...
					and itemno = '#getictran.itemno#' and frtrancode = '#getictran.trancode#' order by refno
            		<!--- select wos_date, qty_bil from ictran where type ='RC' and refno =
            		'#getictran.toinv#' and itemno = '#getictran.itemno#' and qty <> '0' --->
            	</cfquery>

				<td><div align="left"><font face="Times New Roman, Times, serif"><font size="1"><cfloop query="getreceive">#getRCCode.rccode##getreceive.refno#<cfif getreceive.recordcount gt 1><br></cfif></cfloop></font></font></div></td>
            	<td><div align="left"><font face="Times New Roman, Times, serif"><font size="1"><cfloop query="getreceive">#dateformat(getreceive.wos_date,"dd/mm/yyyy")#<cfif getreceive.recordcount gt 1><br></cfif></cfloop></font></font></div></td>
	...
	<cfloop query = "getartran">
		...
		<cfloop query = "getictran">
		  	...
		  	<tr>
				...
				<cfquery name="getReceive" datasource="#dts#">
            		select * from iclink where type = 'RC' and frtype = 'PO'
					and frrefno = '#getictran.refno#' and itemno = '#getictran.itemno#' and frtrancode = '#getictran.trancode#' order by refno
            		<!--- select wos_date, qty_bil from ictran where type ='RC' and refno =
            		'#getictran.toinv#' and itemno = '#getictran.itemno#' and qty <> '0' --->
            	</cfquery>
