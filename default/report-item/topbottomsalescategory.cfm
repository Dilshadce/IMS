...
<cfquery name="getgeneral" datasource="#dts#">
	select lastaccyear,lCATEGORY,lGROUP,lSIZE,lMATERIAL,lMODEL,lRATING,lAGENT,lDRIVER,lLOCATION,filterall,agentlistuserid from gsetup
</cfquery>
...
<cfform name="topbottomlist" action="topbottomcategory.cfm?trantype=#type#&alown=#alown#" method="post" target="_blank">
