	...
	<table width="100%" border="0" cellspacing="0" cellpadding="2">
		...
		<cfloop query="getcustomer">
			...
			<tr>
                ...
                <cfif getcustomer.rem1 eq "Profile">
                 <cfquery name ="getcusadd" datasource="#dts#">
                select * from #target_arcust# where custno='#getcustomer.custno#'
                </cfquery>
                <cfelse>
                <cfquery name ="getcusadd" datasource="#dts#">
                select * from address where code='#getcustomer.rem1#'
                </cfquery>
                </cfif>
                <td><div align="left"><strong><u>
<cfif getcustomer.rem1 eq "">                #getcustomer.comm0##getcustomer.comm1##getcustomer.comm2##getcustomer.comm3#
<cfelse>
#getcusadd.add1##getcusadd.add2##getcusadd.add3##getcusadd.add4#
</cfif>
</u></strong></div></td>
			</tr>
