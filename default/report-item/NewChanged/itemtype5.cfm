...
<cfswitch expression="#form.result#">
	...
	<cfquery name="getcustomer" datasource="#dts#">
        ...
        <cfif form.headquaterfrom neq "" and form.headquaterto neq "">
		and a.custno in (select custno from #target_arcust# where headquater = '#form.headquaterfrom#')
		</cfif>
		group by a.custno 
		order by a.custno;
	</cfquery>
	...
	<table width="100%" border="0" cellspacing="0" cellpadding="2">
        ...
        <cfif trim(form.headquaterfrom) neq "">
			<tr>
				<td colspan="#columncount#"><div align="center"><font size="2" face="Times New Roman, Times, serif">HEADQUATER: #form.headquaterfrom#</font></div></td>
			</tr>
		</cfif>
		<tr>
