...
<cfset nametype = "cust">
    ...
    <br />
    <select name="displaytype" onblur="document.getElementById('loading').style.visibility='visible';ajaxFunction1(document.getElementById('ajaxField'),'findcustomerajax2.cfm?type=#url.type#&nametype=#nametype#&fromto=#url.fromto#&custno='+document.getElementById('custno1').value+'&custname='+document.getElementById('custname1').value+'&leftcustname='+document.getElementById('custname2').value+'&displaytype='+document.getElementById('displaytype').value);">
    ...
    <td><a onMouseOver="JavaScript:this.style.cursor='hand';" onClick="selectlist('#getcustsupp.xcustno#','headquater#url.fromto#');ColdFusion.Window.hide('findCustomer2');"><u>SELECT</u></a></td>
    </tr>
    </cfloop>
...
<cfset nametype = "cust">
    ...
    <font style="text-transform:uppercase">#UCASE(nametype)# NO.</font>&nbsp;<input type="text" name="custno1" size="8" id="custno1" onblur="document.getElementById('loading').style.visibility='visible';ajaxFunction1(document.getElementById('ajaxField'),'findcustomerajax2.cfm?type=#url.type#&nametype=#nametype#&fromto=#url.fromto#&custno='+document.getElementById('custno1').value+'&custname='+document.getElementById('custname1').value+'&leftcustname='+document.getElementById('custname2').value+'&displaytype='+document.getElementById('displaytype').value);" <cfif isdefined('url.custno')>value="#url.custno#"</cfif>  />&nbsp;MID NAME:&nbsp;<input type="text" name="custname1" id="custname1" onblur="document.getElementById('loading').style.visibility='visible';ajaxFunction1(document.getElementById('ajaxField'),'findcustomerajax2.cfm?type=#url.type#&nametype=#nametype#&fromto=#url.fromto#&custno='+document.getElementById('custno1').value+'&custname='+document.getElementById('custname1').value+'&leftcustname='+document.getElementById('custname2').value+'&displaytype='+document.getElementById('displaytype').value);" size="12" />&nbsp;LEFT NAME:&nbsp;<input type="text" name="custname2" id="custname2" onblur="document.getElementById('loading').style.visibility='visible';ajaxFunction1(document.getElementById('ajaxField'),'findcustomerajax2.cfm?type=#url.type#&nametype=#nametype#&fromto=#url.fromto#&custno='+document.getElementById('custno1').value+'&custname='+document.getElementById('custname1').value+'&leftcustname='+document.getElementById('custname2').value+'&displaytype='+document.getElementById('displaytype').value);" size="12" />
    <br />
    <select name="displaytype" onblur="document.getElementById('loading').style.visibility='visible';ajaxFunction1(document.getElementById('ajaxField'),'findcustomerajax2.cfm?type=#url.type#&nametype=#nametype#&fromto=#url.fromto#&custno='+document.getElementById('custno1').value+'&custname='+document.getElementById('custname1').value+'&leftcustname='+document.getElementById('custname2').value+'&displaytype='+document.getElementById('displaytype').value);">
    <option value="name">Debitor No - Name</option>
    <option value="name2">Debitor No - Name - Name 2</option>
