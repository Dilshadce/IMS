...
<cfif form.mode eq "Create">
	...
	<cfif checkitemExist.recordcount GT 0 >
		...
		<cfquery datasource="#dts#" name="insertartran">
            ...
            <cfqueryparam cfsqltype="cf_sql_double" value="#val(form.po_amount)#">,
           ...
           <cfif isdefined('form.prorated1')><cfqueryparam cfsqltype="cf_sql_varchar" value="Y"><cfelse><cfqueryparam cfsqltype="cf_sql_varchar" value="N"></cfif>,
            ...
            <cfqueryparam cfsqltype="cf_sql_varchar" value="#getauthuser()#">
             <cfloop from="1" to="3" index="a">
            ,<cfqueryparam cfsqltype="cf_sql_varchar" value="#evaluate('form.welfare#a#')#">
            <cfif isdefined('form.welfareeg#a#')>
            ,"Y"
            <cfelse>
            ,"N"
			</cfif>
            <cfif evaluate('form.welfareclaimdate#a#') eq "">
            ,'0000-00-00'
			<cfelse>
            ,"#dateformatnew(evaluate('form.welfareclaimdate#a#'),'yyyy-mm-dd')#"
            </cfif>
            <cfif evaluate('form.welfareclaimeddate#a#') eq "">
            ,'0000-00-00'
			<cfelse>
            ,"#dateformatnew(evaluate('form.welfareclaimeddate#a#'),'yyyy-mm-dd')#"
            </cfif>
            ,<cfqueryparam cfsqltype="cf_sql_varchar" value="#evaluate('form.welfareremark#a#')#">
            ,<cfqueryparam cfsqltype="cf_sql_varchar" value="#evaluate('form.welfaredesp#a#')#">
            <cfif isdefined('form.welfaredisq#a#')>
            ,"Y"
            <cfelse>
            ,"N"
			</cfif>
             <cfif evaluate('form.welfaredisdate#a#') eq "">
            ,'0000-00-00'
			<cfelse>
            ,"#dateformatnew(evaluate('form.welfaredisdate#a#'),'yyyy-mm-dd')#"
            </cfif>
            ,<cfqueryparam cfsqltype="cf_sql_varchar" value="#evaluate('form.welfaredisdesp#a#')#">
            </cfloop>
            )
  	...
  	<cfif checkitemExist.recordcount GT 0 >
		...
		<cfif form.mode eq "Edit">
		  		...
		  		<cfquery datasource='#dts#' name="updatePlacement">
                    ...
                    po_amount=<cfqueryparam cfsqltype="cf_sql_double" value="#val(form.po_amount)#">,
           ...
           subtotalamt4 = <cfqueryparam cfsqltype="cf_sql_varchar" value="#form.subtotalamt4#">,
            ...
            <cfloop from="1" to="3" index="a">
            ,welfare#a# = <cfqueryparam cfsqltype="cf_sql_varchar" value="#evaluate('form.welfare#a#')#">
            <cfif isdefined('form.welfareeg#a#')>
            ,welfareeg#a# = "Y"
            <cfelse>
            ,welfareeg#a# = "N"
            ...
            <cfif evaluate('form.welfareclaimdate#a#') eq "">
            ,welfareclaimdate#a# = '0000-00-00'
			<cfelse>
            ,welfareclaimdate#a# = "#dateformatnew(evaluate('form.welfareclaimdate#a#'),'yyyy-mm-dd')#"
            </cfif>
            <cfif evaluate('form.welfareclaimeddate#a#') eq "">
            ,welfareclaimeddate#a# = '0000-00-00'
			<cfelse>
            ,welfareclaimeddate#a# = "#dateformatnew(evaluate('form.welfareclaimeddate#a#'),'yyyy-mm-dd')#"
            </cfif>
            ,welfareremark#a# = <cfqueryparam cfsqltype="cf_sql_varchar" value="#evaluate('form.welfareremark#a#')#">
            ,welfaredesp#a# = <cfqueryparam cfsqltype="cf_sql_varchar" value="#evaluate('form.welfaredesp#a#')#">
            <cfif isdefined('form.welfaredisq#a#')>
            ,welfaredisq#a# = "Y"
            <cfelse>
            ,welfaredisq#a# = "N"
             ...
             <cfif evaluate('form.welfaredisdate#a#') eq "">
            ,welfaredisdate#a# = '0000-00-00'
			<cfelse>
            ,welfaredisdate#a# = "#dateformatnew(evaluate('form.welfaredisdate#a#'),'yyyy-mm-dd')#"
            </cfif>
            ,welfaredisdesp#a# = <cfqueryparam cfsqltype="cf_sql_varchar" value="#evaluate('form.welfaredisdesp#a#')#">
            </cfloop>
				...
				WHERE placement = <cfqueryparam cfsqltype="cf_sql_varchar" value="#form.oriplacementno#">
                </cfquery>
