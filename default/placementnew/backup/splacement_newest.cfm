...
<cfquery name="getrecordcount" datasource="#dts#">
	...
	from placement 
	order by right(placementno,6) desc
</cfquery>
...
<cfif getrecordcount.recordcount neq 0>
	...
	<cfform action="splacement_newest.cfm" method="post" target="_self">
		...
		<cfquery datasource='#dts#' name="getjob">
			Select * from Placement order by right(placementno,6) desc
			limit #start-1#,20;
		</cfquery>
		...
		<table align="center" class="data" width="1000px">
          ...
          <td>#getjob.created_by#</td>
            ...
            <div align="center">
            <cfif hcomid eq "bepsdemo_i">
            <a style="cursor:pointer" onClick="parent.document.getElementById('hidpno').value='#getjob.Placementno#';parent.ColdFusion.Window.show('printstatus');"><img height="18px" width="18px" src="/images/PNG-48/Print.png" alt="Print" border="0">Print & Status Update</a>
            <cfelse>
            <a href="printplacementnew.cfm?Placementno=#getjob.Placementno#" target="_blank"><img height="18px" width="18px" src="/images/PNG-48/Print.png" alt="Print" border="0">Print</a></cfif>&nbsp; 
