...
<cfoutput>
	...
	<iframe allowtransparency="true" align="middle" scrolling="auto" frameborder="0" width="100%" height="650" src="splacement_newest.cfm"></iframe><cfif hcomid eq "bepsdemo_i">
    <link href="/scripts/CalendarControl.css" rel="stylesheet" type="text/css">
<script language="javascript" type="text/javascript" src="/scripts/CalendarControl.js"></script>
<input type="text" name="hidpno" id="hidpno" value="">
<cfwindow name="printstatus" modal="true" source="printstatus.cfm?placementno={hidpno}" center="true" closable="true" width="800" height="250" title="Print Letter and Status Update" refreshonshow="true"></cfwindow>
</cfif>
	<cfabort>
</cfoutput>
