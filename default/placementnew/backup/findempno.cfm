...
<cfset dts1 = replace(dts,'_i','_p','All')>
    ...
    <!--- &nbsp;&nbsp;&nbsp;Name --->
    <input style="display:none" type="text" name="name1" size="15" id="name1" onblur="document.getElementById('loading').style.visibility='visible';ajaxFunction1(document.getElementById('ajaxFieldempno'),'findempnoajax.cfm?nametype=#nametype#&empno='+document.getElementById('empno1').value+'&nric='+document.getElementById('nric1').value+'&name='+document.getElementById('name1').value);"  />
