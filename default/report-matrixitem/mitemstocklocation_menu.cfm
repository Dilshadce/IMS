...
<html>
<head>
<title>Matrix Location Stock Report</title>
...
<h3>
	<a href="matrixitemreportmenu.cfm">Matrix Report Menu</a> >> 
	<a><font size="2">Matrix Location Stock Report</font></a>
</h3>

<cfform action="mitemstocklocation_result.cfm" name="physical_worksheet" method="post" target="_blank">
<table border="0" align="center" width="65%" class="data">
	...
	<th>Date</th>
      	<td colspan="2">
			<cfinput name="target_date" type="text" value="#dateformat(now(),'dd/mm/yyyy')#" size="11" maxlength="10" required="yes" validate="eurodate" message="Please Key In Correct Date Format !" mask="99/99/9999"> (DD/MM/YYYY)
