...
<cfquery name="getgeneral" datasource="#dts#">
	select filterall,lCATEGORY,lGROUP,lSIZE,lMATERIAL,lMODEL,lRATING,lAGENT,lDRIVER,lLOCATION,singlelocation from gsetup
</cfquery>
...
<h3>
	...
	<a><font size="2">View Matrix Item Stock Balance Report</font></a>
</h3>

<cfform action="matrixitemlocationstock_card1.cfm" name="form" method="post" target="_blank">
