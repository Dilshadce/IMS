...
<table width="100%" border="0" cellspacing="0" cellpadding="2" class="data">
	<tr>
		<td colspan="100%"><div align="center"><font size="3" face="Times New Roman,Times,serif"><strong>Print Item No Batch Code Report</strong></font></div></td>
	</tr>
	...
	<cfquery name="gettran" datasource="#dts#">
		...
		(<cfloop index="a" from="1" to="#arraylen(str)#">
		 ...
		 <cfif form.datefrom neq "" and form.dateto neq "">
          ...
          and (batchcode ='' or batchcode is null)
