...
<html>
<head>
<title>View No Job Report</title>
...
<cfquery name="getgeneral" datasource="#dts#">
	select lastaccyear,filterall,LPROJECT,ljob from gsetup
</cfquery>
<!--- Add On 12-01-2010 --->
...
<cfform action="nojobreport1.cfm" method="post" name="form123" target="_blank" onsubmit="return checking()">

<h2>View No Job Report</h2>
<br><br>
