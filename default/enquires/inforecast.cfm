...
<cfif type eq 'inventory'>
	<cfform action="inforecastreport.cfm" method="post" name="form" target="_blank">
...
<table width="80%" border="0" cellspacing="0" cellpadding="3" class="data" align="center">
    ...
    <tr>
    <th>Release Date</th>
    <td> <input type="checkbox" name="itemtba" id="itemtba" value="1"> TBA
    ...
    <td>
        <cfinput type="text" name="releasedatefrom" id="releasedatefrom" value="" size="10" validate="eurodate" message="Please Key in correct format"> <img src="/images/cal.gif" width=17 height=15 border=0 onClick="showCalendarControl(releasedatefrom);"> (DD/MM/YYYY)
    </td>
    </tr>
    <tr>
    <th>Release Date To</th>
    <td>
        <cfinput type="text" name="releasedateto" id="releasedateto" value="" size="10" validate="eurodate" message="Please Key in correct format"> <img src="/images/cal.gif" width=17 height=15 border=0 onClick="showCalendarControl(releasedateto);"> (DD/MM/YYYY)
    </td>
    </tr>
...
<cfelse>
	<cfform action="deforecastreport.cfm" method="post" name="form" target="_blank">
