...
<cfquery name="getitem" datasource="#dts#">
	select itemno, desp,despa from icitem where (itemtype <> "SV" or itemtype is null) and (nonstkitem<>'T' or nonstkitem is null) order by <cfif getdealer_menu.productSortBy neq "">#getdealer_menu.productSortBy#<cfelse>itemno</cfif>
</cfquery>
