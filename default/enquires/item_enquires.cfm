...
<table width="75%" border="0" cellspacing="0" cellpadding="3" class="data" align="center">
		<cfform action="item_enquiresreport.cfm" method="post" target="_blank" name="form" id="form">
...
Negative Stock Only<input type="checkbox" name="negative" id="negative" value="yes" >
		  	...
		  	<th>Choose to view Single item</th>
        	<td valign="center"><br/>
        ...
        <th>Itemno / Desp</th>
        <td>
        <input type="text" name="itemdesp" id="itemdesp" value="">
        <input type="checkbox" name="leftdesp" id="leftdesp" >&nbsp;&nbsp;
        <input type="submit" value="Display" name="choose"> Click here to view many items
        </td>
        </tr>
		</cfoutput>
		</cfform>
