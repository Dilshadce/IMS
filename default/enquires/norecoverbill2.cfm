...
<table width="100%" border="0" cellspacing="0" cellpadding="2" class="data">
	<tr>
		<td colspan="100%"><div align="center"><font size="3" face="Times New Roman,Times,serif"><strong>Bill Item Deleted Before Bill Report</strong></font></div></td>
	</tr>
    <tr> 
	...
	<cfquery name="gettran" datasource="#dts#">
		select * from ictran where toinv!=''
	</cfquery>
	
	<cfloop query="gettran">
    
    <cfquery name="checkvalue" datasource="#dts#">
		select * from iclink where frrefno='#gettran.refno#' and frtype='#gettran.type#' and frtrancode='#gettran.trancode#'
	</cfquery>
