...
<h3> <a href="historypricemenu.cfm">History Price Enquiry Menu</a> >> <a><font size="2"><cfoutput>#trantype#</cfoutput></font></a> </h3>
<cfoutput>
  <cfif history eq "customeritemlastprice">
    ...
    <cfform name="historyprice" action="historyprice1.cfm?type=customeritemlastprice" method="post" target="_blank">
      ...
      <table width="80%" border="0" cellspacing="0" cellpadding="3" class="data" align="center">
        ...
        <tr>
          <th>Customer To</th>
          <td><cfif getgeneral.filteritemreport eq "1">
              <select id="custto" name='custto'>
                <option value=''>Please Filter The Customer</option>
              </select>
              Filter by:
              <input id="letter3" name="letter3" type="text3" size="8" onKeyup="getcust2()">
              in:
        ...
        <tr>
          ...
          <td><cfif getgeneral.filteritemreport eq "1">
              ...
              Filter by:
              <input id="letter" name="letter" type="text" size="8" onKeyup="getItem()">
              in:
              ...
              <cfelse>
              <input type="text" name="itemfrom" id="itemfrom" size="40">
        ...
        <tr>
          ...
          <td><cfif getgeneral.filteritemreport eq "1">
              ...
              Filter by:
              <input id="letter1" name="letter1" type="text" size="8" onKeyup="getItem1()">
              in:
              ...
              <cfelse>
              <input type="text" name="itemto" id="itemto" size="40">
        ...
        <tr>
          <th>Date From</th>
          <td><cfinput type="text" name="datefrom" validate="eurodate" message="Wrong date type! Please try again" size="10">
            <img src="/images/cal.gif" width=17 height=15 border=0 onClick="showCalendarControl(datefrom);">(DD/MM/YYYY)</td>
        </tr>
        <tr>
          <th>Date To</th>
          <td><cfinput type="text" name="dateto" validate="eurodate" message="Wrong date type! Please try again" size="10">
        ...
        <tr>
          <td><input type="radio" name="sort" id="1" value="itemno" checked>
            Sort by Item No</td>
          <td><input type="radio" name="sort" id="1" value="desp">
            Sort by Item Description</td>
        </tr>
        <tr>
          <td><input type="checkbox" name="displaycurr" id="1" value="yes">
            With Currency Code</td>
          <td><input type="checkbox" name="displayqty" id="1" value="yes">
            With Quantity</td>
        </tr>
        <tr>
          <td><input type="checkbox" name="includelastyear" id="1" value="yes">
            Include Last Year</td>
        </tr>
        <tr>
    ...
    <cfform name="historyprice" action="historyprice2.cfm?type=itemcustomertransactedprice" method="post" target="_blank">
      <input type="hidden" name="tran" id="tran" value="#target_arcust#" />
      <input type="hidden" name="fromto" id="fromto" value="" />
      <table width="75%" border="0" cellspacing="0" cellpadding="3" class="data" align="center">
        <tr>
          <td nowrap><input type="radio" name="result" value="HTML" checked>
            HTML<br/>
            <input type="radio" name="result" value="EXCELDEFAULT">
            EXCEL DEFAULT<br/>
            <input type="checkbox" name="service" id="service" value="1">
            Include Service<br/>
            <input type="checkbox" name="includelastyear" id="1" value="yes">
            Include Last Year </td>
        </tr>
        <tr>
          <th>Customer From</th>
        ...
        <tr>
          <th>Item No From</th>
          <td colspan="2"><cfif getgeneral.filteritemreport eq "1">
              <select id="itemfrom" name='itemfrom'>
                <option value=''>Please Filter The Item</option>
              </select>
              Filter by:
        ...
        <tr>
          ...
          <td colspan="2"><select name="brandfrom">
        ...
        <tr>
          ...
          <td colspan="2"><select name="brandto">
              <option value="">Choose a <cfoutput>#getgeneral.lbrand#</cfoutput></option>
              <cfloop query="getbrand">
                <option value="#brand#">#brand# - #desp#</option>
              </cfloop>
    ...
    <cfform name="historyprice" action="historyprice3.cfm?type=customeritemtransactedprice" method="post" target="_blank">
      <input type="hidden" name="tran" id="tran" value="#target_arcust#" />
      <input type="hidden" name="fromto" id="fromto" value="" />
      <table width="80%" border="0" cellspacing="0" cellpadding="3" class="data" align="center">
        <tr>
        ...
        <tr>
          <td><input type="checkbox" name="displaydesp" value="desp">
            With Description</td>
          <td><input type="checkbox" name="displaycurr" value="curr">
            List Foreign Curency Price</td>
        </tr>
        <tr>
          <td><input type="checkbox" name="includelastyear" id="1" value="yes">
            Include Last Year</td>
    ...
    <cfif history eq "itemsupplierlastprice">
      ...
      <form name="historyprice" action="historyprice4.cfm?type=itemsupplierlastprice" method="post" target="_blank">
      <input type="hidden" name="tran" id="tran" value="#target_apvend#" />
      <input type="hidden" name="fromto" id="fromto" value="" />
      <cfelseif history eq "itemsuppliertransactedprice">
      <!--- <h2>Print Item - Supplier Transacted Price Enquiry</h2> --->
      <form name="historyprice" action="historyprice5.cfm?type=itemsuppliertransactedprice" method="post" target="_blank">
      <input type="hidden" name="tran" id="tran" value="#target_apvend#" />
      <input type="hidden" name="fromto" id="fromto" value="" />
    </cfif>
    <table width="75%" border="0" cellspacing="0" cellpadding="3" class="data" align="center">
      <tr>
        ...
        <td><cfif getgeneral.filteritemreport eq "1">
            ...
            Filter by:
            <input id="letter4" name="letter4" type="text4" size="8" onKeyup="getsupp()">
            in:
      ...
      <tr>
        ...
        <td><cfif getgeneral.filteritemreport eq "1">
            ...
            Filter by:
            <input id="letter5" name="letter5" type="text5" size="8" onKeyup="getsupp2()">
            in:
      ...
      <tr>
        <th>Date From</th>
        <td><input type="text" name="datefrom" size="10" onBlur="validatedate(datefrom)">
          <img src="/images/cal.gif" width=17 height=15 border=0 onClick="showCalendarControl(datefrom);">(DD/MM/YYYY)</td>
      </tr>
      <tr>
        <th>Date To</th>
        <td><input type="text" name="dateto" size="10" onBlur="validatedate(dateto)">
          <img src="/images/cal.gif" width=17 height=15 border=0 onClick="showCalendarControl(dateto);">(DD/MM/YYYY)</td>
      </tr>
      <cfif history eq "itemsupplierlastprice">
        <tr>
    ...
    <cfform name="historyprice" action="historyprice6.cfm?type=supplieritemtransactedprice" method="post" target="_blank">
      <input type="hidden" name="tran" id="tran" value="#target_apvend#" />
      <input type="hidden" name="fromto" id="fromto" value="" />
      <table width="80%" border="0" cellspacing="0" cellpadding="3" class="data" align="center">
        <tr>
    ...
    <cfform name="historyprice" action="historyprice7.cfm?type=adjustedtransactioncost" method="post" target="_blank">
      <input type="hidden" name="tran" id="tran" value="#target_apvend#" />
      <input type="hidden" name="fromto" id="fromto" value="" />
      <table width="80%" border="0" cellspacing="0" cellpadding="3" class="data" align="center">
        <tr>
        ...
        <tr>
          ...
          <td><cfif getgeneral.filteritemreport eq "1">
              ...
              <cfelse>
              <input type="text" name="itemfrom" id="itemfrom" size="12">
              <input type="button" size="10" value="Ajax Search" onClick="document.getElementById('fromto').value='from';ColdFusion.Window.show('finditem');" />
            </cfif></td>
        </tr>
        <tr>
          ...
          <td><cfif getgeneral.filteritemreport eq "1">
              ...
              <cfelse>
              <input type="text" name="itemto" id="itemto" size="12">
              <input type="button" size="10" value="Ajax Search" onClick="document.getElementById('fromto').value='to';ColdFusion.Window.show('finditem');" />
            </cfif></td>
        </tr>
        <tr>
