...
<html>
<head>
<title>View Bill Summary Report</title>
...
<cfquery name="getgeneral" datasource="#dts#">
	select lastaccyear,filterall,LPROJECT,Ljob,filteritemreport,DDLITEM from gsetup
</cfquery>
<!--- Add On 12-01-2010 --->
...
<cfform action="billsummaryenquiry.cfm" method="post" name="form123" target="_blank" onsubmit="return checking()">

<h2>View Bill Summary Report</h2>
<br><br>
...
<table border="0" align="center" width="65%" class="data">
    ...
    <cfoutput>
	<tr>
		<td nowrap><input type="checkbox" name="purchasereceive" value="RC"> #getGeneralInfo.lRC#</td>
		<td nowrap><input type="checkbox" name="purchasereturn" value="PR"> #getGeneralInfo.lPR#</td>
		<td nowrap><input type="checkbox" name="invoice" value="INV"> #getGeneralInfo.lINV#</td>
	</tr>
	<tr>
		<td nowrap><input type="checkbox" name="cashsales" value="CS"> #getGeneralInfo.lCS#</td>
		<td nowrap><input type="checkbox" name="debitnote" value="DN"> #getGeneralInfo.lDN#</td>
		<td nowrap><input type="checkbox" name="creditnote" value="CN"> #getGeneralInfo.lCN#</td>
	</tr>
	<tr>
		<td nowrap><input type="checkbox" name="deliveryorder" value="DO"> #getGeneralInfo.lDO#</td>
		<td nowrap><input type="checkbox" name="salesorder" value="SO"> #getGeneralInfo.lSO#</td>
		<td nowrap><input type="checkbox" name="purchaseorder" value="PO"> #getGeneralInfo.lPO#</td>
	</tr>
	<tr>
		<td nowrap><input type="checkbox" name="quotation" value="QUO"> #getGeneralInfo.lQUO#</td>
		<td nowrap><input type="checkbox" name="adjustmentincrease" value="OAI"> #getGeneralInfo.lOAI#</td>
		<td nowrap><input type="checkbox" name="adjustmentreduce" value="OAR"> #getGeneralInfo.lOAR#</td>
	</tr>
    
	<tr>
		<td nowrap><input type="checkbox" name="issue" value="ISS"> #getGeneralInfo.lISS#</td>
	</tr>
    </cfoutput>
	<tr>
      	<td colspan="4"><hr></td>
    ...
    <tr> 
	        ...
	        <td colspan="2"><select name="jobfrom">
	    ...
	    <tr> 
	        ...
	        <td colspan="2"><select name="jobto">
					<option value="">Choose a <cfoutput>#getgeneral.ljob#</cfoutput></option>
					<cfoutput query="getjob">
						<option value="#source#">#source# - #project#</option>
					</cfoutput>
