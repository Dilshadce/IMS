<html>
<head>
<title>Bill That Error During Update Report</title>
...
<table width="100%" border="0" cellspacing="0" cellpadding="2" class="data">
	<tr>
		<td colspan="100%"><div align="center"><font size="3" face="Times New Roman,Times,serif"><strong>Bill That Error During Update Report</strong></font></div></td>
	</tr>
    <tr> 
	...
	<cfquery name="gettran" datasource="#dts#">
		select * from ictran group by type,refno
	</cfquery>
	
	<cfloop query="gettran">
    
    <cfquery name="checkvalue" datasource="#dts#">
		select * from artran where type='#gettran.type#' and refno='#gettran.refno#'
	</cfquery>
