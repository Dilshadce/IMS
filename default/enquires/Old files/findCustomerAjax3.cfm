...
<cfset ptype = url.type >
    ...
    <td><a onMouseOver="JavaScript:this.style.cursor='hand';" onClick="selectlist2('#getcustsupp.xcustno#','cust#url.fromto#');ColdFusion.Window.hide('findCustomer');" >SELECT</a></td>
    </tr>
    </cfloop>
