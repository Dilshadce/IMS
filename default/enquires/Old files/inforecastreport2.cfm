...
<cfquery name="gettran" datasource="#dts#">
	...
	where a.type in ('SO','PO'<cfif lcase(HcomID) eq "kjcpl_i" or lcase(HcomID) eq "mlpl_i" or lcase(HcomID) eq "viva_i">,'QUO'</cfif>) and (a.void = '' or a.void is null) <cfif lcase(HcomID) eq "kjcpl_i" or lcase(HcomID) eq "mlpl_i" or lcase(HcomID) eq "viva_i"><cfelse>and a.wos_date > #getgeneral.lastaccyear#</cfif>
...
<table width="100%" border="0" align="center" cellspacing="0">
	...
	<tr>
  	...
  	<tr>
	    ...
	    <td><div align="right"><font size="2" face="Times New Roman, Times, serif"><cfif lcase(HcomID) eq "kjcpl_i" or lcase(HcomID) eq "mlpl_i" or lcase(HcomID) eq "viva_i">PO+OH-SO-QUO<cfelse>PO+OH-SO</cfif></font></div></td>
	</tr>
  	<tr>
    	<td colspan="100%"><hr></td>
  	</tr>
