		...
		*
		...
		order by a.entryno;
			...
			<cfloop query="getvehicle">
                ...
                <Cell ss:MergeAcross="2" ss:StyleID="s26"><Data ss:Type="String">#XmlFormat(custname)#</Data></Cell>
                ...
                <Cell ss:MergeAcross="2" ss:StyleID="s26"><Data ss:Type="String">#XmlFormat(phone)#</Data></Cell>
                <Cell ss:StyleID="s35"><Data ss:Type="String">Owner : </Data></Cell>
                <Cell ss:MergeAcross="2" ss:StyleID="s26"><Data ss:Type="String">#XmlFormat(contactperson)#</Data></Cell>
                </Row>
...
--->
	...
	<table width="100%" border="0" cellspacing="0" cellpadding="2">
		<tr>
			<td colspan="100%"><div align="left"><font size="3" face="Times New Roman, Times, serif"><strong>Vehicle Service History Report Summary</strong></font></div></td>
		</tr>
        		<tr>
		...
		<tr>
            ...
            <td colspan="2"><div align="left"><font size="2" face="Times New Roman, Times, serif">#getvehicle.phone#</font></div></td>
            <td colspan="2"></td>
