...
<form name="vehicleserhistory" action="vehicleserhistory1.cfm" method="post" target="_blank">

<!--- <h2>Print #trantype# Report By Type</h2> --->
<h3>
	<a href="vehiclereportmenu.cfm">Vehicle Service History Report</a> >> 
	<a><font size="2">Print Vehicle Service History Report By Date </font></a>
</h3>
