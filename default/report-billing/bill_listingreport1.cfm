...
<cfif isdefined('form.cbdetail') and (form.result eq 'HTML' or form.result eq 'EXCELDEFAULT')>
...
SELECT * FROM (
	...
	<cfif trim(form.getfrom) neq "" and trim(form.getto) neq "">
        ...
        and a.rem0 between '#form.getfrom#' and '#form.getto#'
        <cfelse>
...
SELECT * FROM (
	...
	select 
	a.*
	from artran as a<cfif (form.locationfrom neq "" and form.locationto neq "") or url.trancode eq "TR" or (form.groupfrom neq "" and form.groupto neq "") or (form.itemfrom neq "" and form.itemto neq "")>, ictran as b </cfif><cfif url.trancode eq "TR">, ictran as c</cfif>
	where 
	a.type='#url.trancode#' 
	and (a.void='' or a.void is null)
	<cfif (form.locationfrom neq "" and form.locationto neq "") or url.trancode eq "TR" or (form.groupfrom neq "" and form.groupto neq "")  or (form.itemfrom neq "" and form.itemto neq "")>
		<cfif url.trancode neq "TR">
			and a.type=b.type 
		<cfelse>
			and b.type ='TROU'
...
<cfswitch expression="#form.result#">
    ...
    <cfif form.userfrom neq "" and form.userto neq "">
    <cfwddx action = "cfml2wddx" input = "#getgeneral.lDriver# From #form.userfrom# To #form.userto#" output = "wddxText">
    <Row ss:AutoFitHeight="0" ss:Height="20.0625">
							<Cell ss:MergeAcross="#c#" ss:StyleID="s24"><Data ss:Type="String">#wddxText#</Data></Cell>
						</Row>
		</cfif>
        ...
        <Row ss:AutoFitHeight="0" ss:Height="20.0625">
				...
				<Row ss:AutoFitHeight="0" ss:Height="23.0625">
                    ...
                    <Cell ss:StyleID="s27"><Data ss:Type="String">Account No.</Data></Cell>
					<Cell ss:StyleID="s27"><Data ss:Type="String">Account Name.</Data></Cell>
...
<!---- End PDF report --->
    ...
    <cfif form.userfrom neq "" and form.userto neq "">
	 <tr>
					<td colspan="100%"><div align="center"><font size="1.5" face="Arial, Helvetica, sans-serif">#getgeneral.lDriver# From #form.userfrom# To #form.userto#</font></div></td>
				</tr>
		</cfif>
        <cfif form.Daddressfrom neq "" and form.Daddressto neq "">
	 <tr>
...
<cfset gettran.invgross = val(gettran.invgross) + val(gettran.discount)>
     ...
     <cfset detailforeigntotalgrand = detailforeigntotalgrand + val(numberformat(gettran.grand_bil,".__"))>
            ...
            <cfoutput>
            <tr><td><b>Total</b></td><td></td><td></td><td></td><td></td><td></td><td></td><td></td><td></td><td><b>#numberformat(detailtotalgrand,",_.__")#</b></td><td></td><td></td><td></td>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<td><b>#numberformat(detailforeigntotalgrand,",_.__")#</b></td></tr>
			<tr><td></td></tr>
            </cfoutput>
		<tr>
            <td colspan="100%"><hr></td>
    ...
    <cfif form.userfrom neq "" and form.userto neq "">
	 ...
	 <tr>
					<td colspan="100%"><div align="center"><font size="1.5" face="Arial, Helvetica, sans-serif">Customer From #form.getfrom# To #form.getto#</font></div></td>
				</tr>
		</cfif>
