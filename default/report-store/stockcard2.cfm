...
<cfswitch expression="#form.result#">
    ...
    <cfif trim(catefrom) neq "" and trim(cateto) neq "">
 	 <Row ss:AutoFitHeight="0" ss:Height="20.0625">
					...
					<Cell ss:MergeAcross="#c#" ss:StyleID="s24"><Data ss:Type="String">#wddxText# From #catefrom# To #cateto#</Data></Cell>
		</Row>
    </cfif>
    ...
    <cfif trim(suppfrom) neq "" and trim(suppto) neq "">
     <Row ss:AutoFitHeight="0" ss:Height="20.0625">
            		<cfwddx action = "cfml2wddx" input = "#suppfrom# To #suppto#" output = "wddxText3">
