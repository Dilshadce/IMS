...
<cfset type ="customerlist">
		<cfset trantype = "CUSTOMER INVOICE DETAIL LISTING">
...
<h3>
	<a href="storereportmenu.cfm">StoreKeeper Report Menu</a> >> 
...
<cfif type eq "customerlist">
	...
	<form name="saleslist" action="invdetaillisting1.cfm?trantype=#trantype#" method="post" target="_blank">
