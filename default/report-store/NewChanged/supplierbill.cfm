...
<html>
<head>
<title>Supplier Item Transaction Listing</title>
...
<cfset type ="customerlist">
		<cfset trantype = "SUPPLIER BILL DETAIL LISTING">
...
<cfif type eq "customerlist">
	...
	<form name="saleslist" action="supplierbill1.cfm?trantype=#trantype#" method="post" target="_blank">
<cfelseif type eq "productlist">
	...
	<form name="saleslist" action="saleslisting2.cfm?trantype=#trantype#" method="post" target="_blank">
<cfelseif type eq "agentlist">
	...
	<form name="saleslist" action="saleslisting3.cfm?trantype=#trantype#" method="post" target="_blank">
<cfelseif type eq "arealist">
	...
	<form name="saleslist" action="saleslisting4.cfm?trantype=#trantype#" method="post" target="_blank">
</cfif>
	...
	<tr>   
        ...
        <td><select name="suppfrom">
            ...
            <cfif getgeneral.filterall eq "1">
				<input type="button" size="10" value="Ajax Search" onClick="document.getElementById('fromto').value='from';ColdFusion.Window.show('findCustomer');" />&nbsp;<input type="text" name="searchsuppfr" onKeyUp="getCust('suppfrom','Supplier');">
			</cfif>
		</td>
	</tr>
    <tr> 
        ...
        <td><select name="suppto">
            ...
            <cfif getgeneral.filterall eq "1">
				<input type="button" size="10" value="Ajax Search" onClick="document.getElementById('fromto').value='to';ColdFusion.Window.show('findCustomer');" />&nbsp;<input type="text" name="searchsuppto" onKeyUp="getCust('suppto','Supplier');">
			</cfif>
		</td>
    </tr>
	<tr> 
	...
	function disable1()
		{
			if(document.saleslist.show.value == "all")
				{document.saleslist.suppfrom.disabled = false;
				document.saleslist.suppto.disabled = false;
				document.saleslist.suppfrom.value = "";
				document.saleslist.suppto.value = "";}
			else
				{document.saleslist.suppfrom.disabled = true;
				document.saleslist.suppto.disabled = true;
				document.saleslist.suppfrom.value = "";
				document.saleslist.suppto.value = "";}
		}
	function disable2()
