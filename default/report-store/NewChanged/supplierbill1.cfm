...
<cfswitch expression="#form.result#">
	<cfcase value="EXCELDEFAULT">
		...
		<cfxml variable="data">
			...
			<Worksheet ss:Name="SUPPLIER ITEM TRANSACTION LISTING REPORT">
				<Table x:FullColumns="1" x:FullRows="1" ss:DefaultColumnWidth="54" ss:DefaultRowHeight="11.25">
					<Column ss:Width="300.5"/>
					<Column ss:Width="280.25"/>
	 ...
	 <Row ss:AutoFitHeight="0" ss:Height="20.0625">
                <cfwddx action = "cfml2wddx" input = "#dateformat(form.datefrom,"dd/mm/yyyy")# - #dateformat(form.dateto,"dd/mm/yyyy")#" output = "wddxText2">
			<Cell ss:MergeAcross="#c#" ss:StyleID="s22"><Data ss:Type="String">DATE: #wddxText2#</Data></Cell>
		</Row>
			</cfif>
            
			<cfif trim(form.suppfrom) neq "" and trim(form.suppto) neq "">
	 <Row ss:AutoFitHeight="0" ss:Height="20.0625">
                <cfwddx action = "cfml2wddx" input = "#form.suppfrom# - #form.suppto#" output = "wddxText3">
			<Cell ss:MergeAcross="#c#" ss:StyleID="s22"><Data ss:Type="String">SUPP_NO: #wddxText3#</Data></Cell>
		</Row>
			</cfif>
	 ...
	 <Row ss:AutoFitHeight="0" ss:Height="20.0625">
				...
				<cfloop query="getdata">
					...
					<cfset amt = 0>
	 <Row ss:AutoFitHeight="0" ss:Height="20.0625">
                <cfwddx action = "cfml2wddx" input = "#dateformat(getdata.wos_date,"dd-mm-yyyy")#" output = "wddxText9">
                <cfwddx action = "cfml2wddx" input = "#getdata.type#" output = "wddxText10">
                <cfwddx action = "cfml2wddx" input = "#getdata.refno#" output = "wddxText11">
                <cfwddx action = "cfml2wddx" input = "#getdata.itemno#" output = "wddxText12">
                <cfwddx action = "cfml2wddx" input = "#getdata.qty_bil#" output = "wddxText13">
                <cfwddx action = "cfml2wddx" input = "#numberformat(getdata.price_bil,",.__")#" output = "wddxText14">
                <cfwddx action = "cfml2wddx" input = "#numberformat(getdata.amt1_bil,",.__")#" output = "wddxText15">
                <cfwddx action = "cfml2wddx" input = "#getdata.qty_bil#" output = "wddxText16">
                <cfwddx action = "cfml2wddx" input = "#numberformat(getdata.price_bil,",.__")#" output = "wddxText17">
                <cfwddx action = "cfml2wddx" input = "#numberformat(getdata.amt1_bil,",.__")#" output = "wddxText18">
                ...
                <Cell ss:StyleID="s26"><Data ss:Type="String">#getdata.itemno#</Data></Cell>
                      <cfif getdata.type eq "RC">
                <Cell ss:StyleID="s24"><Data ss:Type="String">#getdata.qty_bil#</Data></Cell>
                <Cell ss:StyleID="s24"><Data ss:Type="String">#numberformat(getdata.price_bil,",.__")#</Data></Cell>
                <Cell ss:StyleID="s24"><Data ss:Type="String">#numberformat(getdata.amt1_bil,",.__")#</Data></Cell>
	 ...
	 <Row ss:AutoFitHeight="0" ss:Height="20.0625">
				...
				<Cell ss:StyleID="s51"><Data ss:Type="String"></Data></Cell>
				<Cell ss:StyleID="s51"><Data ss:Type="String">#subtotalqty#</Data></Cell>
				<Cell ss:StyleID="s51"><Data ss:Type="String"></Data></Cell>
				<Cell ss:StyleID="s51"><Data ss:Type="String">#numberformat(subtotal,",.__")#</Data></Cell>
				</Row>
	 ...
	 <Row ss:AutoFitHeight="0" ss:Height="20.0625">
		...
		<html>
		<head>
		<title>SUPPLIER BILL DETAIL LISTING REPORT</title>
		...
		<table width="100%" border="0" cellspacing="0" cellpadding="2">
			...
			<cfif trim(form.suppfrom) neq "" and trim(form.suppto) neq "">
				<tr>
					<td colspan="8"><div align="center"><font size="2" face="Times New Roman, Times, serif">SUPP_NO: #form.suppfrom# - #form.suppto#</font></div></td>
				</tr>
			</cfif>
