...
<cfset type ="customerlist">
		<cfset trantype = "SUPPLIER ITEM TRANSACTION LISTING">
...
<cfif type eq "customerlist">
	...
	<form name="saleslist" action="supplieritem1.cfm?trantype=#trantype#" method="post" target="_blank">
...
<input type="text" name="searchsuppto" onKeyUp="getCust('suppto','Supplier');">
			</cfif>
		</td>
    </tr>
	<tr> 
