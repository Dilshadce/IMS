...
<link href="/SpryAssets/SpryCollapsiblePanel.css" rel="stylesheet" type="text/css" />
	...
	var ajaxurl = '/default/report-stock/expressadjustment/addproductsAjax.cfm?itemno='+escape(expressservice)+'&desp='+escape(desp)+'&qtyonhand='+escape(qtyonhand)+'&qtyactual='+escape(qtyactual)+'&qtydiff='+escape(qtydiff)+'&refno='+escape(refno)+'&unit1='+escape(unit1)+'&ucost='+escape(ucost)+'&date='+escape(date)+'&period='+escape(period)+'&uuid=#URLEncodedFormat(uuid)#';
...
<cfoutput>
<h1>Express Quantity Adjustment</h1>
...
<td colspan="3"><cfinput type="text" name="wos_date" id="wos_date" value="#dateformat(now(),'DD/MM/YYYY')#"/><img id="imagedate" src="/images/cal.gif" width=17 height=15 border=0 onClick="showCalendarControl(wos_date);">&nbsp;(DD/MM/YYYY)<font color="FF0000"><br>Please Check Your Date With Your Selected Period !</font></td>
...
<cfwindow center="true" width="600" height="400" name="searchitem" refreshOnShow="true" closable="true" modal="false" title="Search Item" initshow="false"
        source="/default/report-stock/expressadjustment/searchitem.cfm" /></body></html>