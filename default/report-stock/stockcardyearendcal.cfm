...
<!---<cfquery name="getservices" datasource="#dts#">
    select itemtype from icitem where itemno='#getitem.itemno#'
    </cfquery>
...
<cfform action="stockcard2yearendcal.cfm" name="form" method="post" target="_blank">
...
<table border="0" align="center" width="80%" class="data">
    ...
    <tr> 
      ...
      <td colspan="7">
      <cfinput type="checkbox" name="cbcate" value="checkbox" >      </td></tr>
      <tr>
      <th><cfoutput>#getgeneral.Lbrand#</cfoutput></th>
      <td><cfinput type="checkbox" name="cbbrand" value="checkbox" ></td>
      </tr>
      <tr>
      <th><cfoutput>#getgeneral.lrating#</cfoutput></th>
