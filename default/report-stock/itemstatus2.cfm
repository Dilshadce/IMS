...
<cfelseif getgeneral.cost eq "FIFO">
	...
	<cfif isdefined("form.thislastaccdate") and form.thislastaccdate neq "">
		...
		<cfquery name="getictranin" datasource="#dts#">
			...
			and wos_date <= #getdate.ThisAccDate# 
			and (void = '' or void is null) 
			and (linecode <> 'SV' or linecode is null) <cfif lcase(left(hcomid,5)) eq "widos" or lcase(left(hcomid,5)) eq "derotech">and ((invlinklist='' or invlinklist is null) and (invcnitem="" or invcnitem is null))</cfif>
        ...
        <cfif lcase(left(hcomid,5)) eq "widos" or lcase(left(hcomid,5)) eq "derotech">
                    ...
                    <cfset totalrcqty = fifoqty>
		  			...
		  			<cfif isdefined("form.thislastaccdate") and form.thislastaccdate neq "">
			  			<cfquery name="getrc" datasource="#dts#">
                            ...
                            <cfif lcase(left(hcomid,5)) eq "widos" or lcase(left(hcomid,5)) eq "derotech">and ((invlinklist='' or invlinklist is null) and (invcnitem="" or invcnitem is null))</cfif>
        ...
        <tr onMouseOut="javascript:this.style.backgroundColor='';" onMouseOver="javascript:this.style.backgroundColor='99FF00';">
            ...
            <td><div align="left"><font size="2" face="Times New Roman, Times, serif">#getsuppliercode.custno# - #getsuppliername.name#</font></div></td>
                ...
                <cfquery name="getictraninwidos" datasource="#dts#">
                    ...
                    and (void = '' or void is null) 
                    and (linecode <> 'SV' or linecode is null) <cfif lcase(left(hcomid,5)) eq "widos" or lcase(left(hcomid,5)) eq "derotech">and (invlinklist<>'' and invcnitem<>'')</cfif>
                    <cfif ndateto neq ''>
                    and wos_date<='#ndateto#'
                    </cfif>
...
<cfelseif getgeneral.cost eq "FIFO">
	...
	<cfelse>
        ...
        <cfquery name="getictranout" datasource="#dts#">
			...
			from ictran as a
            left join 
            (select sum(qty) as cnqty,itemno,invcnitem,invlinklist,fperiod from ictran where type='CN'
            and fperiod<>'99' 
            <cfif ndateto neq ''>
            and wos_date<='#ndateto#'
            </cfif>
        ...
        <cfwddx action = "cfml2wddx" input = "#runno#." output = "wddxText">
            ...
            <cfif lcase(hcomid) eq "viva_i" or lcase(hcomid) eq "kjcpl_i" or lcase(hcomid) eq "mlpl_i">
                ...
                <cfset getitem.outnow=val(getitem.outnow)+val(getictranoutwidos.cnqty)>
                        ...
                        <Cell ss:StyleID="s40"><Data ss:Type="Number">#val(innow)#</Data></Cell>
						<Cell ss:StyleID="s40"><Data ss:Type="Number">#val(outnow)#</Data></Cell>
						<Cell ss:StyleID="s40"><Data ss:Type="Number">#val(balancenow)#</Data></Cell>
                        <cfif getpin2.h42A0 eq 'T'>
