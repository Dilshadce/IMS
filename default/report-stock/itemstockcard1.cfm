<cfinclude template = 
"/CFC/convert_single_double_quote_script.cfm">
...
<h3>
	<a href="/default/report-stock/stock_listingmenu.cfm">Inventory Listing Menu</a> >> 
	<a><font size="2">Item Stock Check</font></a>
</h3>

<cfform action="itemstockcheck2.cfm" name="form" method="post" target="_blank">
...
<table border="0" align="center" width="80%" class="data">
	...
	<tr>
		<td nowrap>
        	<input type="checkbox" name="include0" id="1" value="yes"> 
            <label for="include0">Include 0 Figure</label>
        </td>
        <td colspan="3">
        	<input type="checkbox" name="exclude" id="1" value="yes"> 
            <label for="include0">Exclude Updated Bill</label>
			<cfif lcase(hcomid) eq "leatat_i"><cfelse>&nbsp;&nbsp;&nbsp;
            <input type="checkbox" name="include" id="1" value="yes"> <label for="include0">Show Updated Bill Only</label></cfif>&nbsp;&nbsp;&nbsp;<input type="checkbox" name="dodate" id="dodate" value="yes" checked> <label for="include0">According to DO Date</label>&nbsp;&nbsp;&nbsp;</td>
	</tr>
	<tr>
      	<td colspan="5"><hr></td>
    </tr>
    ...
    <tr>
      	<th width="16%">#getgeneral.lbrand#</th>
      	<td width="5%"><div align="center">From</div></td>
      	<td colspan="2">
			<select name="brandfrom" id="brandfrom">
          		<option value="">Choose a #getgeneral.lbrand#</option>
    ...
    <tr>
      	...
      	<td width="5%"> <div align="center">From</div></td>
      	<td colspan="2">
        	<cfinput type="text" name="datefrom" id="datefrom" maxlength="10" validate="eurodate" size="10">(DD/MM/YYYY)
        </td>
    </tr>
    <tr>
      	<th width="16%">Date</th>
    ...
    <tr> 
        ...
        <td colspan="7">
        	<cfinput type="checkbox" name="cbcate" id="cbcate" value="checkbox" >     
        </td>
	</tr>
    
    <tr>
        <th>#getgeneral.lbrand#</th>
        <td><cfinput type="checkbox" name="cbbrand" id="cbbrand" value="checkbox" ></td>
    </tr>
    
    <tr>
        <th>#getgeneral.lrating#</th>
        <td><cfinput type="checkbox" name="cbrating" id="cbrating" value="checkbox"></td>
    </tr>
    ...
    <tr>
      	<td colspan='7'>
            <div align='center'>
            	<input type="Submit" name="Submit" id="Submit "value="Submit" <cfif lcase(hcomid) eq "ecraft_i" or lcase(hcomid) eq "ovas_i" or lcase(hcomid) eq "mhca_i">onclick="return CheckAssign();"</cfif>>
            </div>
        </td>
    </tr>
</table>
