...
<cfquery name="getgroup" datasource="#dts#">
	...
	<cfif form.period neq "">
		<Row ss:AutoFitHeight="0" ss:Height="20.0625">
		<Cell ss:MergeAcross="#c#" ss:StyleID="s24"><Data ss:Type="String">PERIOD: #form.period#</Data></Cell>
		</Row>
	</cfif>
	<cfif form.date neq "">
    
		<Row ss:AutoFitHeight="0" ss:Height="20.0625">
			<Cell ss:MergeAcross="#c#" ss:StyleID="s24"><Data ss:Type="String">DATE: #form.date#</Data></Cell>
		</Row>
	</cfif>
...
<table align="center" width="100%" border="0" cellspacing="0">
	...
	<cfif form.date neq "">
		<tr>
			<td colspan="8"><div align="center"><font size="2" face="Times New Roman, Times, serif">DATE: #dateformat(form.date,"dd-mm-yyyy")#</font></div></td>
		</tr>
	</cfif>
	<tr>
