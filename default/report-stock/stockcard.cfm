...
<table border="0" align="center" width="80%" class="data">
	...
	<tr>
        ...
        <td  colspan="3">&nbsp;&nbsp;&nbsp;<input type="checkbox" name="dodate" id="dodate" value="yes" checked> <label for="include0">According to DO Date</label>&nbsp;&nbsp;&nbsp;<input type="checkbox" name="showdetail" id="showdetail" value="yes" > <label for="showdetail">Stock Card Detail</label></td>
	</tr>
	<tr>
      	<td colspan="5"><hr></td>
    </tr>
    ...
    <tr>
      	...
      	<td colspan="2">
			...
			<cfif getgeneral.filterall eq "1">
				<input type="button" size="10" value="Ajax Search" onClick="document.getElementById('fromto').value='from';ColdFusion.Window.show('findCustomer');" />&nbsp;<input type="text" name="searchsuppfr" id="searchsuppfr" onKeyUp="getSupp('suppfrom','Supplier');">
			</cfif>		</td>
    </tr>
    <tr>
      	<th width="16%">Supplier</th>
      	...
      	<td colspan="2">
			...
			<cfif getgeneral.filterall eq "1">
				<input type="button" size="10" value="Ajax Search" onClick="document.getElementById('fromto').value='to';ColdFusion.Window.show('findCustomer');" />&nbsp;<input type="text" name="searchsuppto"  id="searchsuppto" onKeyUp="getSupp('suppto','Supplier');">
			</cfif>		</td>
    </tr>
    <tr>
      	<td colspan="5"><hr></td>
    ...
    <tr>
      	<th width="16%">Date</th>
      	<td width="5%"> <div align="center">From</div></td>
      	<td colspan="2"><cfinput type="text" id="datefrom" name="datefrom" maxlength="10" validate="eurodate" size="10">(DD/MM/YYYY)</td>
    </tr>
    <tr>
      	<th width="16%">Date</th>
      	<td width="5%"> <div align="center">To</div></td>
      	<td width="69%"><cfinput type="text" id="dateto" name="dateto" maxlength="10" validate="eurodate" size="10">(DD/MM/YYYY)&nbsp;</td>
        </tr>
        <tr> 
      <td colspan="8">&nbsp;</td>
    </tr>
    <tr>
    <td  colspan="3">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<input type="checkbox" name="exclude" id="1" value="yes"> <label for="include0">Exclude Updated Bill</label><cfif lcase(hcomid) eq "leatat_i"><cfelse>&nbsp;&nbsp;&nbsp;<input type="checkbox" name="include" id="1" value="yes"> <label for="include0">Show Updated Bill Only</label></cfif>
    </tr>
