...
<cfset payrollyear = getpayroll.myear>
		...
		<cfquery name="getartran" datasource="#dts#">
            SELECT grand_bil, tax_bil, fperiod, custno, refno, type, wos_date
            FROM artran
            WHERE 1=1
    ...
    <cfelse>
    	...
    	<cfloop query="getartran">
            ...
            <cfquery name="getictran" datasource="#dts#">
                SELECT ics.desp as icsdesp, ic.desp, ic.amt_bil, ic.taxamt_bil, ic.brem5, ic.brem6, pmt.placementno, pmt.jobpostype,
				...
				ON pmt.placementno = CASE WHEN ic.brem1 != "" THEN ic.brem1 ELSE aslip.placementno END
                ...
                GROUP BY ic.trancode,ic.itemno
                ORDER by ic.desp
        	</cfquery>
            <!---modified query--->
			...
			<cffile action="APPEND" file="#HRootPath#\Excel_Report\MPpostingCNDN#timenow#.csv"
   			output="#dateformat(getdate.wos_date,'yyyymmdd')#,0,#dateformat(getdate.duedate,'yyyymmdd')#,1,1,#CODETAXGRP#,#TAXSTTS1#,"
			addnewline="No">
