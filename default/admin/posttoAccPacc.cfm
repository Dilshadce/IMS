...
<option value="#userlist.userid#">#userlist.userid#</option>
    ...
    <tr>
        ...
        <td align="center">
        	&nbsp;&nbsp;&nbsp;
			<input type="Submit" name="Submit" value="AS + S" onClick="document.form123.action = 'accpaccInvReport2.cfm';">
			&nbsp;&nbsp;&nbsp;
			<input type="Submit" name="Submit" value="AS + L" onClick="document.form123.action = 'accpaccInvReport3.cfm';">
			&nbsp;&nbsp;&nbsp;
			<input type="Submit" name="Submit" value="AS + L (MSS)" onClick="document.form123.action = 'accpaccInvReport4.cfm';">
			&nbsp;&nbsp;&nbsp;
			<input type="Submit" name="Submit" value="P + SL" onClick="document.form123.action = 'accpaccInvReport5.cfm';">
			&nbsp;&nbsp;&nbsp;
    ...
    <tr>
        ...
        <td> </td>
        <td align="center">
        	&nbsp;&nbsp;&nbsp;<input type="Submit" name="Submit" value="AS + S" onClick="document.form123.action = 'accpaccCNDNReport2.cfm';">
        	&nbsp;&nbsp;&nbsp;<input type="Submit" name="Submit" value="AS + L" onClick="document.form123.action = 'accpaccCNDNReport3.cfm';">
        	&nbsp;&nbsp;&nbsp;<input type="Submit" name="Submit" value="AS + L (MSS)" onClick="document.form123.action = 'accpaccCNDNReport4.cfm';">
        	&nbsp;&nbsp;&nbsp;<input type="Submit" name="Submit" value="P + SL" onClick="document.form123.action = 'accpaccCNDNReport5.cfm';">
    ...
    <tr>
        ...
        <td> </td>
        <td align="center">
			&nbsp;&nbsp;&nbsp;<input type="Submit" name="Submit" value="Customer Report" onClick="document.form123.action = 'accpaccCustReport2.cfm';">
        </td>
        <td width="15%"> </td>
    </tr>
    <tr>
