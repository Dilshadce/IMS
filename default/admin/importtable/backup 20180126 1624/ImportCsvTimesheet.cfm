...
<head>
	<script type="text/javascript">
		...
		function checkExcel()
		{
			if(document.getElementById('generateFile').value.match(".xlsx"))
			{
...
<body>
	...
	<h2>Generate CSV Timesheet (Maximum 60 tab of sheet in excel file)</h2>
	
	<form name="form2" id="form2" method="post" action="ImportCsvTimesheetProcess.cfm" target="_blank" enctype="multipart/form-data">
        <div align="center">
            <input type="file" name="generateFile" id="generateFile" size="50" accept=".xlsx" onChange="checkExcel()">
