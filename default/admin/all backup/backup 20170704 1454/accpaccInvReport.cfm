    ...
    <cfelse>
    	...
    	<cfloop query="getartran">
            ...
            <cfquery name="getictran" datasource="#dts#">
                SELECT ic.itemno, ics.desp as icsdesp, ic.desp, ic.amt_bil, ic.taxamt_bil, ic.brem5, ic.brem6, aslip.placementno, pmt.location, pmt.jobpostype
                FROM ictran as ic
                LEFT JOIN assignmentslip as aslip
                ON ic.brem6 = aslip.refno
                LEFT JOIN placement as pmt
				ON aslip.placementno = pmt.placementno
                LEFT JOIN icshelf as ics
                ON ic.itemno = ics.shelf
                ...
                <cfloop query="getictran">
            		...
            		<!---<cfquery name="getjobno" datasource="#dts#">
             		...
             		<cfquery name="chartofaccount" datasource="#dts#">
                        ...
                        FROM chartofaccount
                        WHERE type1_id = <cfif getictran.jobpostype eq ''>3<cfelse>"#getictran.jobpostype#"</cfif>
                        AND
