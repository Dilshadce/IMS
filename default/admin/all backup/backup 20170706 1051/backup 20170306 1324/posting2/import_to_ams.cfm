...
{
	alert('Kindly create batchcode for this period');
	return false;
}
else
{
...
{
ajaxFunction(document.getElementById('ajaxcontrol'),'validpost.cfm?type='+document.getElementById('transaction_type').value+'&period='+document.getElementById('period').value);
...
<cfquery name="getgeneral" datasource="#dts#">
	SELECT 
	date_format(lastaccyear,'%d-%m-%Y') as lastaccyear,periodficposting,cost,linv,lcs,lcn,ldn,lpr,lrc
	FROM gsetup;
</cfquery>
...
<h3 align="center">
    ...
    || <a href="postingcheck.cfm">Posting Check</a> 
    </cfif>
    || 
	<cfif Hlinkams neq "Y">
	...
	<a href="glpost.cfm">List Not Exported</a> </cfif>
...
<cfform name="import_to_ams" id="import_to_ams" action="import_to_ams.cfm" method="post" onsubmit="return validatesubmit()">
	<table class="data" align="center" width="50%">
		<tr>
			<th>Bill Type To Import</th>
			<cfoutput>
            <td>
				<input name="transaction_type" id="transaction_type" type="radio" value="INV" <cfif getgeneral.periodficposting eq "Y">checked</cfif>> #getgeneral.linv#<br/>
				<input name="transaction_type" id="transaction_type" type="radio" value="CS"> #getgeneral.lcs#<br/>
				<input name="transaction_type" id="transaction_type" type="radio" value="CN"> #getgeneral.lcn#<br/>
				<input name="transaction_type" id="transaction_type" type="radio" value="DN"> #getgeneral.ldn#<br/>
				<input name="transaction_type" id="transaction_type" type="radio" value="RC"> #getgeneral.lrc#<br/>
				<input name="transaction_type" id="transaction_type" type="radio" value="PR"> #getgeneral.lpr#<br/>
                <cfif getgeneral.periodficposting eq "Y">
                <cfelse>
				<input name="transaction_type" id="transaction_type" type="radio" value="ALL" checked> All Bills
                </cfif>
			</td>
            </cfoutput>
		</tr>
