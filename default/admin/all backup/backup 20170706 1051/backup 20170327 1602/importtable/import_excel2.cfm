                ...
                <!--- <cftry> --->
                    ...
                    <cfif submiticitem eq 'Submit' and trim(column1) neq "">
                        ...
                        <cfquery name="inserticitem" datasource="#dts#">
                            ...
                            salec,salecsc,salecnc,purc,purprec,unit2,factor1,factor2,priceu2,remark1,barcode,custprice_rate,fcurrcode,fucost,fprice,fcurrcode2,fucost2,fprice2,fcurrcode3,fucost3,fprice3,fcurrcode4,fucost4,fprice4,fcurrcode5,fucost5,fprice5,itemtype,comment,nonstkitem<cfif isdefined('column61')>,taxcode</cfif><cfif isdefined('column62')>,purtaxcode</cfif>
							<cfif isdefined('column63')>,price5</cfif><cfif isdefined('column64')>,price6</cfif>)
                            values
                            ...
                            '#val(column56)#',
                            '#val(column57)#',<cfqueryparam cfsqltype="cf_sql_varchar" value="#column58#">,<cfqueryparam cfsqltype="cf_sql_varchar" value="#column59#">,<cfqueryparam cfsqltype="cf_sql_varchar" value="#column60#"><cfif isdefined('column61')>,<cfqueryparam cfsqltype="cf_sql_varchar" value="#column61#"></cfif>
							<cfif isdefined('column62')>,<cfqueryparam cfsqltype="cf_sql_varchar" value="#column62#"></cfif>
							<cfif isdefined('column63')>,'#val(column63)#'</cfif>
							<cfif isdefined('column64')>,'#val(column64)#'</cfif>
							)
                        </cfquery>
                    </cfif>
            <!--- 	<cfcatch type="any">
