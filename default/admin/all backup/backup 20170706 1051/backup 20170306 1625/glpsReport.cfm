                                ...
                                <cfelse>
                                    ...
                                    AND c_debit != ""
                                      ...
                                      <cfif #chartofaccount.c_debitbranch# eq 'Y'>
                                          ...
                                          <cfelse>
                                          <cffile action="APPEND" file="#HRootPath#\Excel_Report\MPpostingPS#dateformat(now(),'ddmmyyyy')#.csv"
                                          output="2,#getbatches.batches#,#counter#,#itemcounter#,#chartofaccount.c_debit#,#evaluate('getassignmentslip.awee#a#')#,/TS## /Job###getassignmentslip.placementno#,#dateformat(getartran.wos_date,'yyyymmdd')#,GL,JE,/Batch ###getbatches.batches# /TSheet ## /PaySlip ## /Item: #type2#,#type2#"
                                              addnewline="yes">
                                      </cfif>
                                      <cfset itemcounter += 1>
                                      <cfif #chartofaccount.c_creditbranch# eq 'Y'>
