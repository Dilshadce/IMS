...
<cfquery name="getrefnotype" datasource="#dts#">
	...
	from refnoset
	where type not in ('ASSM','SAM','CUST','PACK','SUPP')
	group by type 
</cfquery>

<body>
<h1 align="center">View Audit Trail</h1>
<form name="form" action="viewaudit_trail1.cfm" method="post" target="_blank">
<table border="0" align="center" width="65%" class="data">
	<tr>
	  	<td nowrap>
			<input type="radio" name="result" value="instock" checked>Transactions in Stock<br/>
			<input type="radio" name="result" value="modified">Transactions Modified<br/>
			<input type="radio" name="result" value="deleted">Deleted Transaction
		</td>
	</tr>
	<tr>
      	...
      	<td colspan="2">
        	...
        	</select>&nbsp;<input type="text" name="monthfrom" value="" size="6" readonly>
		</td>
    </tr>
    <tr>
      	<th width="16%">Period</th>
      	...
      	<td colspan="2">
			<select name="periodto"  onChange="displaymonth()">
         		...
         		<option value="10">10</option>
	          	...
	          	<option value="17">17</option>
          		<option value="18">18</option>
        	</select>&nbsp;<input type="text" name="monthto" value="" size="6" readonly>
		</td>
    </tr>
	<tr>
		<th>Type</th>
		...
		<td colspan="2">
			<select name="type">
				...
				<cfloop query="getrefnotype">
					...
					<cfoutput><option value="#refnotype#">#refnoname#</option></cfoutput>
				</cfloop>
			</select>
		</td>
	</tr>
    ...
    <tr>
    <th>Include Period 99</th>
    <td></td>
    <td><input type="checkbox" name="include99" id="include99" value=""></td>
    </tr>
	<tr> 
...
<script language="JavaScript">
	...
	{	
		...
		document.form.monthfrom.value = "";
		document.form.monthto.value="";	
	}
