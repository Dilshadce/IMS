...
<cfif submiticitem eq 'Submit'>
	...
	<!---<cfcatch type="any">
    Please upload using latest item format!.
	</cfcatch>
	</cftry>--->
	<cftry>
			...
			<cfloop query="gettempitem">
				...
				<cfif checkexist.recordcount eq 0>
					<cfquery name="insert" datasource="#dts#">
						...
						`SALEC`,`SALECSC`,`SALECNC`,`PURC`,`PURPREC`,`CREATED_BY`,`CREATED_ON`,`factor1`,`factor2`,`priceu2`,`remark1`,`wos_date`,`barcode`,`custprice_rate`,`fcurrcode`,`fucost`,`fprice`,`fcurrcode2`,`fucost2`,`fprice2`,`fcurrcode3`,`fucost3`,`fprice3`,`fcurrcode4`,`fucost4`,`fprice4`,`fcurrcode5`,`fucost5`,`fprice5`,`itemtype`,`comment`,`NONSTKITEM`<cfif gettempitem.taxcode neq "">,`taxcode`</cfif><cfif gettempitem.purtaxcode neq "">,`purtaxcode`</cfif>)
						values
						...
						'#gettempitem.price4#',<cfif gettempitem.wserialno eq "Y" or gettempitem.wserialno eq "T">'T'<cfelse>'#gettempitem.wserialno#'</cfif>,'#gettempitem.graded#',
						...
						'#gettempitem.purprec#','#Huserid#',now(),'#gettempitem.factor1#','#gettempitem.factor2#','#gettempitem.priceu2#',<cfqueryparam cfsqltype="cf_sql_varchar" value="#gettempitem.remark1#">,'#dateformat(now(),'YYYY-MM-DD')#',<cfqueryparam cfsqltype="cf_sql_varchar" value="#gettempitem.barcode#">,<cfqueryparam cfsqltype="cf_sql_varchar" value="#gettempitem.custprice_rate#">,<cfqueryparam cfsqltype="cf_sql_varchar" value="#gettempitem.fcurrcode#">,'#gettempitem.fucost#','#gettempitem.fprice#',<cfqueryparam cfsqltype="cf_sql_varchar" value="#gettempitem.fcurrcode2#">,'#gettempitem.fucost2#','#gettempitem.fprice2#',<cfqueryparam cfsqltype="cf_sql_varchar" value="#gettempitem.fcurrcode3#">,'#gettempitem.fucost3#','#gettempitem.fprice3#',<cfqueryparam cfsqltype="cf_sql_varchar" value="#gettempitem.fcurrcode4#">,'#gettempitem.fucost4#','#gettempitem.fprice4#',<cfqueryparam cfsqltype="cf_sql_varchar" value="#gettempitem.fcurrcode5#">,'#gettempitem.fucost5#','#gettempitem.fprice5#',<cfqueryparam cfsqltype="cf_sql_varchar" value="#gettempitem.itemtype#">,<cfqueryparam cfsqltype="cf_sql_varchar" value="#gettempitem.comment#">,<cfqueryparam cfsqltype="cf_sql_varchar" value="#gettempitem.nonstkitem#"><cfif gettempitem.taxcode neq "">,<cfqueryparam cfsqltype="cf_sql_varchar" value="#gettempitem.taxcode#"></cfif><cfif gettempitem.purtaxcode neq "">,<cfqueryparam cfsqltype="cf_sql_varchar" value="#gettempitem.purtaxcode#"></cfif>)
					</cfquery>
					<cfset count=count+1>
				<cfelse>
					<cfset thisstatus="U">
				  ...
				  a.UPDATED_ON,<cfqueryparam cfsqltype="cf_sql_varchar" value="#Huserid#">,now()
					...
					<cfquery name="update" datasource="#dts#">
						...
						WSERIALNO=<cfif gettempitem.wserialno eq "Y" or gettempitem.wserialno eq "T">'T'<cfelse>'#gettempitem.wserialno#'</cfif>,
                        ...
                        <cfif gettempitem.taxcode neq "">
                        ,taxcode = <cfqueryparam cfsqltype="cf_sql_varchar" value="#gettempitem.taxcode#"></cfif>
						<cfif gettempitem.purtaxcode neq "">,purtaxcode=<cfqueryparam cfsqltype="cf_sql_varchar" value="#gettempitem.purtaxcode#"></cfif>
					...
					<cfquery name="insertInto_arcust" datasource="#dts1#">
						INSERT IGNORE INTO arcust (	custno,name,name2,comUEN,
                                        			...
                                        			dispec_cat,dispec1,dispec2,dispec3,normal_rate,offer_rate,others_rate,
                                         			business,area,end_user,agent,groupTo,arrem1,arrem2,arrem3,arrem4,status,
				...
				<cfelse>
                    <cfquery name="update_arcust" datasource="#dts1#">
                        ...
                        SET	
                            ...
                            status = '#get_arcustTemp.badStatus#',
                            updated_by = '#HuserID#',
                            updated_on = NOW()
			...
			<cfloop query="get_apvendTemp">
				...
				<cfelse>
                	<cfquery name="update_apvend" datasource="#dts1#">
						UPDATE apvend 
                        SET	
                            name = <cfqueryparam cfsqltype="cf_sql_varchar" value="#get_apvendTemp.name#">,
                            name2 = <cfqueryparam cfsqltype="cf_sql_varchar" value="#get_apvendTemp.name2#">,
                            comUEN = <cfqueryparam cfsqltype="cf_sql_varchar" value="#get_apvendTemp.comUEN#">,	
                            
                            add1 = <cfqueryparam cfsqltype="cf_sql_varchar" value="#get_apvendTemp.add1#">,
                            add2 = <cfqueryparam cfsqltype="cf_sql_varchar" value="#get_apvendTemp.add2#">,
                            add3 = <cfqueryparam cfsqltype="cf_sql_varchar" value="#get_apvendTemp.add3#">,
                            add4 = <cfqueryparam cfsqltype="cf_sql_varchar" value="#get_apvendTemp.add4#">,
                            country = <cfqueryparam cfsqltype="cf_sql_varchar" value="#get_apvendTemp.country#">,
                            postalCode = <cfqueryparam cfsqltype="cf_sql_varchar" value="#get_apvendTemp.postalCode#">,	
                            attn = <cfqueryparam cfsqltype="cf_sql_varchar" value="#get_apvendTemp.attn#">,
                            phone = <cfqueryparam cfsqltype="cf_sql_varchar" value="#get_apvendTemp.phone#">,
                            phonea = <cfqueryparam cfsqltype="cf_sql_varchar" value="#get_apvendTemp.phonea#">,
                            fax = <cfqueryparam cfsqltype="cf_sql_varchar" value="#get_apvendTemp.fax#">,
                            e_mail = <cfqueryparam cfsqltype="cf_sql_varchar" value="#get_apvendTemp.e_mail#">,
                            
                            daddr1 = <cfqueryparam cfsqltype="cf_sql_varchar" value="#get_apvendTemp.daddr1#">,
                            daddr2 = <cfqueryparam cfsqltype="cf_sql_varchar" value="#get_apvendTemp.daddr2#">,
                            daddr3 = <cfqueryparam cfsqltype="cf_sql_varchar" value="#get_apvendTemp.daddr3#">,
                            daddr4 = <cfqueryparam cfsqltype="cf_sql_varchar" value="#get_apvendTemp.daddr4#">,
                            d_country = <cfqueryparam cfsqltype="cf_sql_varchar" value="#get_apvendTemp.d_country#">,
                            d_postalCode = <cfqueryparam cfsqltype="cf_sql_varchar" value="#get_apvendTemp.d_postalCode#">,	
                            dattn = <cfqueryparam cfsqltype="cf_sql_varchar" value="#get_apvendTemp.dattn#">,
                            dphone = <cfqueryparam cfsqltype="cf_sql_varchar" value="#get_apvendTemp.dphone#">,
                            contact = <cfqueryparam cfsqltype="cf_sql_varchar" value="#get_apvendTemp.contact#">,
                            dfax = <cfqueryparam cfsqltype="cf_sql_varchar" value="#get_apvendTemp.dfax#">,
                            d_email = <cfqueryparam cfsqltype="cf_sql_varchar" value="#get_apvendTemp.d_email#">,
                            
                            ngst_cust = '#get_apvendTemp.ngst_cust#',
                            GSTno = <cfqueryparam cfsqltype="cf_sql_varchar" value="#get_apvendTemp.GSTno#">,
                            saleC = <cfqueryparam cfsqltype="cf_sql_varchar" value="#get_apvendTemp.saleC#">,
                            saleCNC = <cfqueryparam cfsqltype="cf_sql_varchar" value="#get_apvendTemp.saleCNC#">,
                            
                            currCode = <cfqueryparam cfsqltype="cf_sql_varchar" value="#get_apvendTemp.currCode#">,
                            currency = <cfqueryparam cfsqltype="cf_sql_varchar" value="#get_apvendTemp.currency#">,
                            currency1 = <cfqueryparam cfsqltype="cf_sql_varchar" value="#get_apvendTemp.currency1#">,
                            term = <cfqueryparam cfsqltype="cf_sql_varchar" value="#get_apvendTemp.term#">,
                            crLimit = '#val(get_apvendTemp.crLimit)#',
                            invLimit = '#val(get_apvendTemp.invLimit)#',
                            
                            dispec_cat = <cfqueryparam cfsqltype="cf_sql_varchar" value="#get_apvendTemp.dispec_cat#">,
                            dispec1 = '#val(get_apvendTemp.dispec1)#',
                            dispec2 = '#val(get_apvendTemp.dispec2)#',
                            dispec3 = '#val(get_apvendTemp.dispec3)#',
                            
                            business = <cfqueryparam cfsqltype="cf_sql_varchar" value="#get_apvendTemp.business#">,
                            area = <cfqueryparam cfsqltype="cf_sql_varchar" value="#get_apvendTemp.area#">,
                            end_user = <cfqueryparam cfsqltype="cf_sql_varchar" value="#get_apvendTemp.end_user#">,
                            agent = <cfqueryparam cfsqltype="cf_sql_varchar" value="#get_apvendTemp.agent#">,
                            groupTo = <cfqueryparam cfsqltype="cf_sql_varchar" value="#get_apvendTemp.groupTo#">,
                            arrem1 = <cfqueryparam cfsqltype="cf_sql_varchar" value="#get_apvendTemp.arrem1#">,
                            arrem2 = <cfqueryparam cfsqltype="cf_sql_varchar" value="#get_apvendTemp.arrem2#">,
                            arrem3 = <cfqueryparam cfsqltype="cf_sql_varchar" value="#get_apvendTemp.arrem3#">,
                            arrem4 = <cfqueryparam cfsqltype="cf_sql_varchar" value="#get_apvendTemp.arrem4#">,
                            status = '#get_apvendTemp.badStatus#',
                            updated_by = '#HuserID#',
                            updated_on = NOW()
                            
                    	WHERE custno = <cfqueryparam cfsqltype="cf_sql_varchar" value="#get_apvendTemp.custno#">;
					</cfquery>
