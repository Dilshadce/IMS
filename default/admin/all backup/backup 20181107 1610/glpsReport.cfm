...
<cfset payrollyear = getpayroll.myear>
    ...
    <cfloop query="getbatches">
        ...
        <!--Commented by Nieo 20180828 1730, remove the 'selftotal neq 0'--->
            ...
            <!---Allowance --->
            <cfloop from="1" to="18" index="a">
                <cfif "#evaluate('getbatches.awee#a#')#" NEQ 0 AND "#Evaluate('getbatches.allowance#a#')#" NEQ '1003' AND "#Evaluate('getbatches.allowance#a#')#" NEQ '1005' AND "#Evaluate('getbatches.allowance#a#')#" NEQ '1006'>
            ...
            <cfloop from="1" to="3" index="a">
                ...
                <cfif "#evaluate('getbatches.#addchargedesp1#')#" CONTAINS "tax refund" OR "#Evaluate('getbatches.#addchargecode1#')#" EQ '1003' OR "#Evaluate('getbatches.#addchargecode1#')#" EQ '1005' OR "#Evaluate('getbatches.#addchargecode1#')#" EQ '1006'>
