...
<cfform name="form" action="act_enableedit.cfm" method="post">
<H1>Enable Edit of Transaction</H1>
...
<tr>
	...
	<tr>
		<td colspan="100%" align="center">
			<input type="submit" name="submit" value="Unlock" onClick="return checkValidate();"></td>
	</tr>
</table>
</cfform>
</body>
