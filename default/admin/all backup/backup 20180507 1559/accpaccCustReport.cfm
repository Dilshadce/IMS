...
<cfsetting showdebugoutput="yes">
	...
	<cfloop query="getCustno">
      ...
      <!---  <cfquery name="getlocation" datasource="#dts#">
        ...
        <cffile action="APPEND" file="#HRootPath#\Excel_Report\MPpostingCust_#timenow#.csv" 
            output="1,#getCustno.custno#,#lsdateformat(getCustno.created_on,'yyyymmdd', 'English (Australian)')#,#getCustno.name#,""#getCustno.add1#"",""#getCustno.add2#"",""#getCustno.add3#"",""#getCustno.add4#"",,""#getCustno.postalcode#"",""#getCustno.country#"",""#getCustno.agent#"",""#getCustno.phone#"",,Trade,Mthly,INT,""#getCustno.arrem6#"",NCA,GST"
            addnewline="Yes">
