    ...
    <cfelse>
    	...
    	<cfloop query="getartran">
            ...
            <cfquery name="getictran" datasource="#dts#">
                SELECT ic.itemno, ic.trancode, ics.desp as icsdesp, ic.desp, ic.amt_bil, ic.taxamt_bil, ic.brem5, ic.brem6, aslip.placementno,
			...
			<cfif #getartran.fperiod# GT 12>
            	<cffile action="APPEND" file="#HRootPath#\Excel_Report\MPpostingInv#timenow#.csv"
   				output="1,#getbatches2.batches#,#counter#,#getartran.custno#,#getartran.refno#,1,AP-MONTH=#evaluate('getartran.fperiod MOD 12')#,#dateformat(getdate.wos_date,'yyyymmdd')#,0,#dateformat(getdate.duedate,'yyyymmdd')#,1,0,GST,3,#NumberFormat(getartran.tax_bil, '.__')#,#dateformat(getdate.wos_date,'yyyy')#,#evaluate('getartran.fperiod MOD 12')#,"
  				addnewline="Yes">
            <cfelse>
            	<cffile action="APPEND" file="#HRootPath#\Excel_Report\MPpostingInv#timenow#.csv"
   				output="1,#getbatches2.batches#,#counter#,#getartran.custno#,#getartran.refno#,1,AP-MONTH=#getartran.fperiod#,#dateformat(getdate.wos_date,'yyyymmdd')#,0,#dateformat(getdate.duedate,'yyyymmdd')#,1,0,GST,3,#NumberFormat(getartran.tax_bil, '.__')#,#dateformat(getdate.wos_date,'yyyy')#,#getartran.fperiod#,"
  				addnewline="Yes">
            </cfif>
