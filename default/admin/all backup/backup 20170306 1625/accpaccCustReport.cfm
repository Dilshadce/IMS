...
<cfset payrollyear = getpayroll.myear>
    ...
    <cffile action="WRITE" file="#HRootPath#\Excel_Report\#dts#_MPpostingCust_#huserid#.csv"
	...
	<cffile action="APPEND" file="#HRootPath#\Excel_Report\#dts#_MPpostingCust_#huserid#.csv" 
	...
	<cfset filename = hcomid&"_"&payrollmonth&"Post_toAccCustPacc_"&getauthuser()&".csv">

	<cfheader name="Content-Disposition" value="inline; filename=#filename#">		
	<cfcontent type="application/vnd.ms-excel" deletefile="yes" file="#HRootPath#\Excel_Report\#dts#_MPpostingCust_#huserid#.csv">
