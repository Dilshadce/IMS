...
<cfset cost1=listgetat(ucost,1,'.')>
        ...
        update icitem set costformula='#myresult#' where itemno='#getitem.itemno#'
        </cfquery>
       </cfloop>
        </cfoutput>
		
<h2 align="center"><font face="Times New Roman, Times, serif" color="red">Update item cost code has been done !!!</font></h2>
</body>
</html>