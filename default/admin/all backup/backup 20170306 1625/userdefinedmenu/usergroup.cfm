...
function submitaction(){
 	if(document.itemform.newgroup.value == ''){
 		...
 		var newgroupname = document.getElementById('newgroup').value;
		ajaxFunction(document.getElementById('ajaxField'),'databind/formcheckAjax.cfm?action=add&groupname='+ newgroupname);
 ...
 function confirmdelete(usergroup){
 	if (confirm("Are you sure you want to delete")) {
		...
		ajaxFunction(document.getElementById('ajaxField'),'databind/formcheckAjax.cfm?action=delete&groupname='+ usergroup);
		setTimeout('location.reload()',500);
...
<form name="itemform" id="itemform" action="index.cfm">
	<table align="center" width="50%">
		<tr>
			<td>New Group Name :&nbsp;&nbsp; <input type="text" name="newgroup" id="newgroup" value="" size="25">&nbsp;<font color="red" face="arial">*maximun 10 characters</font></td>
