...
<table class="data" width="100%">
	...
	<cfif gettran.recordcount gt 0>
        ...
        <cfif Hlinkams eq "Y">
		<cfoutput><cfif huserid eq "ultralum">#comlist#<br>#hcomid#<br>#dts#<br>#replace(LCASE(dts),"_i","_a","all")#</cfif></cfoutput>
        ...
        <cfquery name="getglpostdetail" datasource="#replace(dts,'_i','_a','all')#">
        	SELECT * FROM glpost
            WHERE
