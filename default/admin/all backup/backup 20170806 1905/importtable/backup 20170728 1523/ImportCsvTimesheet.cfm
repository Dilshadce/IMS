...
<body>
    ...
    <h3> Sample format: <a href="download/timesheet_format.xlsx"> timesheet_format.xlsx </a>(Empty excel) 
    ...
    <cfif IsDefined('form.path')>
        ...
        <cfquery name="InsertIntoTimesheet" datasource="manpowertest_p"><!---change to manpower_p to import live--->
    ...
    <form name="form1" id="form1" method="post" action="ImportCsvTimesheet.cfm" target="_self" enctype="multipart/form-data">
        <div align="center">
