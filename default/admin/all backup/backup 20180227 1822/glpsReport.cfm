...
<cfset payrollyear = getpayroll.myear>
        ...
        <!---Added by Nieo 20180129 1508--->
    
        <cfquery datasource="#dts#">
            SET SESSION binlog_format = 'MIXED';
        </cfquery>
        
        <cfquery name="preparetempictran" datasource="#dts#">
            create table if not exists ictran_glps like ictran
        </cfquery>
    
        <cfquery name="preparetempictran" datasource="#dts#">
            ALTER TABLE ictran_glps ENGINE=INNODB
        </cfquery>
            
        <cfquery name="preparetempictran" datasource="#dts#">
            INSERT IGNORE ictran_glps 
            SELECT * FROM ictran 
            WHERE refno in 
            (
                ...
                <cfelse>
                    ...
                    addnewline="Yes">
                        ...
                        <cfloop from="8" to="1" step="-1" index="ot">
                            <cfif #evaluate('getassignmentslip.selfot#ot#')# neq 0>
                                ...
                                <cfif #chartofaccount.c_debitbranch# eq 'Y'>
                                    <cffile action="APPEND" file="#HRootPath#\Excel_Report\MPpostingPS_#url.branch#_#timenow#.csv"
                                        output="2,#getbatches.batches#,#counter#,#itemcounter#,#chartofaccount.c_debit#-#getplacementno.location#,#evaluate('getassignmentslip.selfot#ot#')#,/TS## /Job###getassignmentslip.placementno#,#dateformat(getassignmentslip.assignmentslipdate,'yyyymmdd')#,GL,JE,/Batch ###getbatches.batches# /TSheet ## /PaySlip ## /Item: ""#type2#"",""#type2#"""
                                        addnewline="yes">
                                    <cfelse>
                                    <cffile action="APPEND" file="#HRootPath#\Excel_Report\MPpostingPS_#url.branch#_#timenow#.csv"
                                     output="2,#getbatches.batches#,#counter#,#itemcounter#,#chartofaccount.c_debit#,#evaluate('getassignmentslip.selfot#ot#')#,/TS## /Job###getassignmentslip.placementno#,#dateformat(getassignmentslip.assignmentslipdate,'yyyymmdd')#,GL,JE,/Batch ###getbatches.batches# /TSheet ## /PaySlip ## /Item: ""#type2#"",""#type2#"""
                                        addnewline="yes">
                                </cfif>
                                <cfset itemcounter += 1>
                                <cfif #chartofaccount.c_creditbranch# eq 'Y'>
                                    <cffile action="APPEND" file="#HRootPath#\Excel_Report\MPpostingPS_#url.branch#_#timenow#.csv"
                                        output="2,#getbatches.batches#,#counter#,#itemcounter#,#chartofaccount.c_credit#-#getplacementno.location#,#val(evaluate('getassignmentslip.selfot#ot#'))*-1#,/TS## /Job###getassignmentslip.placementno#,#dateformat(getassignmentslip.assignmentslipdate,'yyyymmdd')#,GL,JE,/Batch ###getbatches.batches# /TSheet ## /PaySlip ## /Item: ""#type2#"",""#type2#"""
                                        addnewline="yes">
                                    <cfelse>
                                    <cffile action="APPEND" file="#HRootPath#\Excel_Report\MPpostingPS_#url.branch#_#timenow#.csv"
                                     output="2,#getbatches.batches#,#counter#,#itemcounter#,#chartofaccount.c_credit#,#val(evaluate('getassignmentslip.selfot#ot#'))*-1#,/TS## /Job###getassignmentslip.placementno#,#dateformat(getassignmentslip.assignmentslipdate,'yyyymmdd')#,GL,JE,/Batch ###getbatches.batches# /TSheet ## /PaySlip ## /Item: ""#type2#"",""#type2#"""
                                        addnewline="yes">
                                </cfif>
                                <cfset itemcounter += 1>
                            </cfif>
                      ...
                      <cfloop from="1" to="6" index="a">
                          <cfif evaluate('getassignmentslip.fixawee#a#') neq 0>
                              ...
                              <cfquery name="getICShelf" datasource="#dts#">
                                ...
                                WHERE itemno = "#evaluate('getassignmentslip.fixawcode#a#')#"
                              	 <!---SELECT desp FROM icshelf
                              	 WHERE shelf = "#evaluate('getassignmentslip.fixawcode#a#')#"--->
                              </cfquery>
                              ...
                              <cfquery name="chartofaccount" datasource="#dts#">
                                ...
                                <cfelseif #type2# CONTAINS "OT2.0" OR #type2# CONTAINS "OT 2.0">
                                    type2 = "OT 2.0"
                                    AND c_debit != ""
                                <cfelseif #type2# CONTAINS "PH1.0" or #getictran.desp# CONTAINS "PH 1.0">
                                    type2 = "PH 2.0"
                                    AND c_debit != ""
                                <cfelse>
                                    type2 = "#type2#"
                      ...
                      <cfloop from="1" to="18" index="a">
                          <cfif evaluate('getassignmentslip.awee#a#') neq 0>
                              <cfquery name="getICShelf" datasource="#dts#">
                                ...
                                WHERE itemno = "#evaluate('getassignmentslip.allowance#a#')#"
                              	 <!---SELECT desp FROM icshelf
                              	 WHERE shelf = "#evaluate('getassignmentslip.allowance#a#')#"--->
                              </cfquery>
                              ...
                              <cfquery name="chartofaccount" datasource="#dts#">
                                ...
                                <cfelseif #type2# CONTAINS "PH1.0" or #getictran.desp# CONTAINS "PH 1.0">
                                    type2 = "PH 2.0"
                                    AND c_debit != ""
                                <cfelseif #type2# CONTAINS "Reimbursement" >
                                    type2 = "Reimbursement/Claim"
                                    AND c_debit != ""
                                <cfelseif #type2# CONTAINS "Unpaid Leave" >
                                    type2 = "Unpaid Leave"
                                    AND c_debit != ""
                                <cfelseif #type2# CONTAINS "Performance Bonus" >
                                    type2 = "Bonus"
                                    AND c_debit != ""
                                <cfelseif #type2# CONTAINS "Grooming Allowance">
                                	type2 = "Grooming Allowance"
                                	AND c_debit != ""
                                <cfelseif #type2# CONTAINS "Auto Allowance">
                                	type2 = "Auto Allowance"
                                	AND c_debit != ""
                                <cfelseif #type2# CONTAINS "Pay Adjustment">
                                	type2 = "Pay Adjustment"
                                	AND c_debit != ""
                                <cfelseif #type2# CONTAINS "Advance Pay">
                                	type2 = "Advance Pay"
                                	AND c_debit != ""
                                <cfelse>
                                    type2 = "#type2#"
                      ...
                      <!---Additional Item--->
                        ...
                        <cfloop from="1" to="3" index="a">
                        	...
                        	<cfif #a# eq 1>
                                ...
                                <cfset addchargecode = "addchargecode">
                            <cfelse>
                            	<cfset addchargeself = "addchargeself#a#">
                                <cfset addchargedesp = "addchargedesp#a#">
                                <cfset addchargecode = "addchargecode#a#">
                            </cfif>
							
							<cfif #evaluate('getassignmentslip.addchargedesp')# CONTAINS "tax refund">
								<cfcontinue>
							</cfif>
							...
							<cfif evaluate('getassignmentslip.#addchargeself#') neq 0>
								<cfset type2 = evaluate('getassignmentslip.#addchargedesp#')>
                               	...
                               	<cfquery name="getICShelf" datasource="#dts#">
                                    ...
                                    WHERE itemno = "#evaluate('getassignmentslip.#addchargecode#')#"
									<!---SELECT desp FROM icshelf
									WHERE shelf = "#evaluate('getassignmentslip.#addchargecode#')#"--->
							  	</cfquery>
