...
<cfloop query="getartran">
	...
	<tr>
		...
		<td><cfif acctype eq "D"><div align="right">#numberformat(getartran.amtt+check_misc.summisc-get_multiple_payments.sum_payments,".__")#</div></cfif></td>
		<td><cfif acctype eq "Cr"><div align="right">#numberformat(getartran.amtt+check_misc.summisc-get_multiple_payments.sum_payments,".__")#</div></cfif></td>
		<td>&nbsp;</td>
