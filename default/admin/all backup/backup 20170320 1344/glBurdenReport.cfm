...
<cfset payrollyear = getpayroll.myear>
		...
		<cffile action="WRITE" file="#HRootPath#\Excel_Report\MPpostingPS_#timenow#.csv"
        output="RECTYPE,BATCHID,BTCHENTRY,SRCELEDGER,SRCETYPE,DATEENTRY,JRNLDESC,FSCSYR,FSCSPERD" 
        addnewline="yes">
        
        <cffile action="APPEND" file="#HRootPath#\Excel_Report\MPpostingPS_#timenow#.csv"
		...
		<cfset filename = "MPpostingPS_#timenow#.csv">

		<cfheader name="Content-Disposition" value="inline; filename=#filename#">		
		<cfcontent type="application/vnd.ms-excel" deletefile="yes" file="#HRootPath#\Excel_Report\MPpostingPS_#timenow#.csv">
