...
select * from gsetup
    ...
    <tr id="tr#getitem1.currentrow#" onMouseOut="javascript:this.style.backgroundColor='';" onMouseOver="javascript:this.style.backgroundColor='99FF00';" <cfif lcase(hcomid) eq "acht_i">onClick="selectlist('#URLEncodedFormat(getitem1.itemno)#','#fromto#');ColdFusion.Window.hide('finditem');"</cfif>>
    <cfif getdisplay.itemsearch_itemno eq 'Y'>
