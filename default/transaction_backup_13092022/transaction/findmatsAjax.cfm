 ...
 <table width="680px">
    ...
    <td><a onMouseOver="JavaScript:this.style.cursor='hand';" onClick="document.getElementById('comm5').value = unescape(decodeURI(document.getElementById('#getComment.code#').value));ColdFusion.Window.hide('findmats');"><u>SELECT</u></a></td>
    </tr>
    </cfloop>
