...
<input type="button" name="search_btn" id="search_btn" value="Search" onclick="ajaxFunction(document.getElementById('searchmemberajax'),'searchmemberajax.cfm?driverno='+escape(document.getElementById('searchmemberid').value)+'&name='+escape(document.getElementById('searchmembername').value)+'&icno='+escape(document.getElementById('searchmembericno').value)+'&contact='+escape(document.getElementById('searchmembertel').value)+'&address='+escape(document.getElementById('searchmemberadd').value));"  />
</td>
</tr>
</table>
