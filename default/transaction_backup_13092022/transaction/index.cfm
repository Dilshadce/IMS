...
<cfoutput>
	var itemdespurl = '/default/transaction/expresstran/itemdespprocess.cfm?uuid=#URLEncodedFormat(uuid)#&trancode='+escape(itemdesptrancode)+'&itemdesp='+escape(itemdesp)+'&itemdespa='+escape(itemdespa)+'&itemcomment='+escape(itemcomment);
	...
	var ajaxurl2 = '/default/transaction/expresstran/addmultiproductsAjax.cfm?tran='+escape(tran)+'&tranno='+refno+'&uuid=#URLEncodedFormat(uuid)#&trancode='+escape(trancode)+'&custno='+escape(custno)+'&location='+escape(location)+itemlisting;
...
<th <cfif getmodule.auto eq 1>style="display:none" </cfif>>Delivery Name</th><td <cfif getmodule.auto eq 1>style="display:none" </cfif>><input type="text" name="d_name" id="d_name" value="" maxlength="35" size="40"></td>
</tr>
<tr>
<th></th>
<td><input type="text" name="b_name2" id="b_name2" value="" maxlength="35" size="40"/></td>
<th></th><td <cfif getmodule.auto eq 1>style="display:none" </cfif>><input type="text" name="d_name2" id="d_name2" value="" maxlength="35" size="40"></td>
</tr>
<tr>
<th>Address</th>
<td>
...
<th <cfif getmodule.auto eq 1>style="display:none" </cfif>></th><td <cfif getmodule.auto eq 1>style="display:none" </cfif>><input type="text" name="d_add2" id="d_add2" value="" maxlength="35" size="40"></td>
</tr>
<tr>
<th></th>
<td>
...
<th <cfif getmodule.auto eq 1>style="display:none" </cfif>>Tel</th><td <cfif getmodule.auto eq 1>style="display:none" </cfif>><input type="text" name="d_phone" id="d_phone" value="" maxlength="35" size="40"></td>
</tr>
<tr>
<th>Fax</th>
<td>
<input type="text" name="b_fax" id="b_fax" value="" maxlength="35" size="40"></td>
<th <cfif getmodule.auto eq 1>style="display:none" </cfif>>Fax</th>
<td <cfif getmodule.auto eq 1>style="display:none" </cfif>><input type="text" name="d_fax" id="d_fax" value="" maxlength="35" size="40"></td>
</tr>
<tr>
<th>Attention</th>
<td>
...
<td <cfif getmodule.auto eq 1>style="display:none" </cfif>><input type="text" name="d_attn" id="d_attn" value="" maxlength="35" size="40"></td>
</tr>
...
<tr>
<td></td><td></td><th>Total Amount</th><td><cfinput type="text" style="font: x-large bolder; color:##000; background-color:##FFFF66" name="grand" id="grand" value="0.00" readonly="yes" /></td>
</tr>


<tr><td colspan="4" align="center"><input type="hidden" name="paytype" id="paytype" value=""><cfif lcase(hcomid) eq "ssuni_i"><input name="btn_add" style="font: medium bolder" id="btn_add" type="button" value="Add" onClick="addnewitem2();"><cfelse><input name="btn_add" style="font: medium bolder" id="btn_add" type="button" value="Add" style="display:none" onClick="addnewitem2();"></cfif>&nbsp;&nbsp;&nbsp;
