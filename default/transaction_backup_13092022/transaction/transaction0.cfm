...
<cfform name="form1" action="transaction1.cfm?ttype=create&nexttranno=&tran=#tran#&first=0" method="post">
	...
	<cfloop query="getRefnoset">
        <cfif getRefnoset.counter lt 2 or  getRefnoset.counter gt 6>
		<tr onMouseOut="javascript:this.style.backgroundColor='';" onMouseOver="javascript:this.style.backgroundColor='99FF00';">
			...
			<cfelse>
                <cfif tran eq 'INV'>
                    <cfif getRefnoset.counter eq '1'>
                    APMR
                    <cfelseif getRefnoset.counter eq '7'>
                    MSS
                    <cfelseif getRefnoset.counter eq '8'>
                    MBS
                    <cfelseif getRefnoset.counter eq '9'>
                    Experis
                    <cfelse>
                    Set #getRefnoset.counter#
                    </cfif>
            ...
            </cfif> - <cfif getRefnoset.refnocode neq '' and getRefnoset.presuffixuse eq '1'>#getRefnoset.refnocode#</cfif>#getRefnoset.lastUsedNo#<cfif getRefnoset.refnocode2 neq '' and getRefnoset.presuffixuse eq '1'>#getRefnoset.refnocode2#</cfif></td>
    		<td align="center"><input name="invset" type="radio" value="#getRefnoset.counter#" <cfif getRefnoset.counter eq defaultset>checked</cfif> <cfif getRefnoset.counter gt 1 and getRefnoset.counter lt 7> disabled</cfif>></td>
		</tr>
        </cfif>
	</cfloop>
	<!--- REMARK ON 200608 --->
