<cfif isdefined("form.submit") and form.submit eq "Select #getGeneralInfo.lbatch# Code">
	<cfform name="done" action="selectbatch.cfm" method="post">
        ...
        <cfinput type="hidden" name="batchqtyhid" value="#form.qty#">
        <cfinput type="hidden" name="batchpricehid" value="#form.price#">
        <cfinput type="hidden" name="batchbrem2hid" value="#form.crequestdate#">
	</cfform>
