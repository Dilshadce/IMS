...
<cfquery name="gettranname" datasource="#dts#">
	select lRQ,lPO,lSO from gsetup
</cfquery>
...
<cfswitch expression="#url.type#">
	...
	<cfcase value="rq">
		<cfset trantype = gettranname.lRQ>
		<cfset trancode = "RQ">
	</cfcase>
</cfswitch>
<cfquery name="getinfo" datasource="#dts#">
	select b.desp,a.refno,a.type,a.custno,a.name,a.wos_date,b.itemno,b.qty_bil,b.writeoff,b.shipped,b.trancode 
	from artran a,ictran b 
	where a.refno = b.refno and a.type = b.type and a.type = '#url.type#' 
	and b.shipped < b.qty_bil
	...
	and b.writeoff < b.qty_bil-b.shipped
	</cfif>
...
<table border="0" align="center" width="65%" class="data">
	...
	<cfloop query="getinfo">
		...
		<cfset balqty = val(getinfo.qty_bil) - val(getinfo.shipped)>
	...
	<tr>
		...
		<td><div align="center">#getinfo.qty_bil#</div></td>
