<cfcomponent>
	<cffunction name="getcurrrate" access="remote" returntype="string">
        ...
        <cfargument name="invoicedate" type="string" required="yes">
        <cfargument name="footercurrcode" type="string" required="no">
	...
	<cfif readperiod eq '00'>
		...
		<cfset myResult=Numberformat(rates2, '._____')>
		<cfreturn myResult>
	</cffunction>
