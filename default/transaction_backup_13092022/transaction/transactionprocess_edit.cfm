...
(<cfqueryparam cfsqltype="cf_sql_varchar" value="#form.voucherno#">,'Value','#val(amt_bil)#',<cfqueryparam cfsqltype="cf_sql_varchar" value="#form.desp#">,'#HUserID#',now(),<cfqueryparam cfsqltype="cf_sql_varchar" value="#form.custno#" >)
	...
	<cfset act_qty_bil = val(form.qty) / val(form.factor1) * val(form.factor2)>
    <cfelse>
    <cfset act_qty_bil = act_qty>
    </cfif>
    
    <cfif val(form.factor1) neq 0>
	<cfset oldqty_bil = val(oldqty) / val(form.factor1) * val(form.factor2)>
    <cfelse>
    <cfset oldqty_bil = oldqty>
    </cfif>
    ...
    <cfif act_qty_bil neq oldqty_bil>
    ...
    select ifnull(qty_bil,0) as qty,ifnull(shipped,0) as shipped from ictran where refno='#checkiclinkexist.frrefno#' and type='#checkiclinkexist.frtype#' and trancode='#checkiclinkexist.frtrancode#'
    </cfquery>
    <cfif act_qty_bil gt oldqty_bil>
    <cfif val(act_qty_bil)-val(oldqty_bil) gt val(getupdatedfromrefno.qty)-val(getupdatedfromrefno.shipped)>
    <!--- --->
    ...
    update ictran set shipped=qty_bil,toship=0 where refno='#checkiclinkexist.frrefno#' and type='#checkiclinkexist.frtype#' and trancode='#checkiclinkexist.frtrancode#'
    </cfquery>
    </cfif>
    <cfquery datasource="#dts#" name="updateiclink">
    update iclink set qty='#val(getupdatedfromrefno.qty)#' where refno='#nexttranno#' and type='#tran#' and trancode='#itemcount#'
    </cfquery>
    <!--- --->
    <cfelse>
    <!--- --->
    ...
    <cfelse>
    <cfquery datasource="#dts#" name="updatefromrefno">
    update ictran set shipped='#getupdatedfromrefno.shipped+(act_qty_bil-oldqty_bil)#' where refno='#checkiclinkexist.frrefno#' and type='#checkiclinkexist.frtype#' and trancode='#checkiclinkexist.frtrancode#'
    </cfquery>
    <cfquery datasource="#dts#" name="updatefromrefno2">
    update ictran set toship=qty_bil-shipped where refno='#checkiclinkexist.frrefno#' and type='#checkiclinkexist.frtype#' and trancode='#checkiclinkexist.frtrancode#'
    </cfquery>
    </cfif>
    <cfquery datasource="#dts#" name="updateiclink">
    update iclink set qty='#getupdatedfromrefno.shipped+(act_qty_bil-oldqty_bil)#' where refno='#nexttranno#' and type='#tran#' and trancode='#itemcount#'
    </cfquery>
    <!--- --->
    </cfif>
    <cfquery datasource="#dts#" name="checkordercl">
    select sum(qty_bil)-sum(shipped) as qty from ictran where refno='#checkiclinkexist.frrefno#' and type='#checkiclinkexist.frtype#'
    </cfquery>
    
    <cfif checkordercl.qty eq 0>
    <cfif (tran eq 'RC' or tran eq 'PO' or tran eq 'INV' or tran eq 'SAM') and (checkiclinkexist.frtype eq 'SO' or checkiclinkexist.frtype eq 'DO')>
    <cfelse>
    ...
    <cfif val(act_qty_bil) gt 0>
    <cfif (tran eq 'RC' or tran eq 'PO' or tran eq 'SAM') and checkiclinkexist.frtype eq 'SO'>
    <cfelse>
    <cfquery datasource="#dts#" name="updatefromrefno">
    update ictran set shipped='#val(act_qty_bil)#' where refno='#checkiclinkexist.frrefno#' and type='#checkiclinkexist.frtype#' and trancode='#checkiclinkexist.frtrancode#'
    </cfquery>
    <cfquery datasource="#dts#" name="updatefromrefno2">
    update ictran set toship=qty_bil-shipped where refno='#checkiclinkexist.frrefno#' and type='#checkiclinkexist.frtype#' and trancode='#checkiclinkexist.frtrancode#'
    </cfquery>
    ...
    <cfquery datasource="#dts#" name="updateiclink">
    update iclink set qty='#val(act_qty_bil)#' where refno='#nexttranno#' and type='#tran#' and trancode='#itemcount#'
    </cfquery>
    <cfelse>
    <cfif (tran eq 'RC' or tran eq 'PO' or tran eq 'SAM') and checkiclinkexist.frtype eq 'SO'>
    <cfelse>
