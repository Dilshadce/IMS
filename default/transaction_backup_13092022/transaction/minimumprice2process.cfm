...
document.getElementById('sellingbelowcostpassword').value='N';
ColdFusion.Window.hide('minimumprice2');
</script>
<cfelse>
<h4>Wrong Password</h4>
<cfform action="minimumprice2.cfm" method="post" name="wrongpass" id="wrongpass">
