...
<cfif getdisablefoc.gpricemin eq "1" and is_service neq 1 and tran neq "RC" and tran neq "PR" and tran neq "CN" and tran neq "DN">
    ...
    SELECT PRICE_MIN,FCURRCODE,FPRICE_MIN<cfloop from="2" to="10" index="i">,FCURRCODE#i#,FPRICE#i#_MIN</cfloop> FROM icitem WHERE itemno = <cfqueryparam cfsqltype="cf_sql_varchar" value="#itemno#">
    </cfquery>
    
    <cfif getbillcurrcode.currcode eq getminprice.FCURRCODE and val(getminprice.fprice_min) neq 0>
    <cfset getminprice.price_min=getminprice.fprice_min>
    </cfif>
    
    <cfloop from="2" to="10" index="i">
    <cfif val(evaluate('getminprice.FPRICE#i#_MIN')) neq 0 and evaluate('getminprice.FCURRCODE#i#') eq getbillcurrcode.currcode>
    <cfset getminprice.price_min=evaluate('getminprice.FPRICE#i#_MIN')>
    </cfif>
    </cfloop>
...
<script type="text/javascript">
	...
	{
		<!---<cfif lcase(hcomid) eq "iaf_i">--->
		<cfif is_service neq 1  and tran neq "RC" and tran neq "PR" and tran neq "CN" and tran neq "DN"and tran neq "PO">
