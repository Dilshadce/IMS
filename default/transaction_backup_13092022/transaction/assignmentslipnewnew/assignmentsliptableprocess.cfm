...
<cfquery name="getcustdetails" datasource="#dts#">
...
<cfif form.mode eq "Create"> <!-- Cfif check status = create at line 91, 836, 1420-->
	  ...
	  <cfif checkexistrefno.recordcount neq 0> <!-- If found existing invoice from artran, CFIF end at line 193 -->
			...
			<cfif checkexistrefno.recordcount neq 0> <!-- Check another time for reference no and grab invoice running number here-->
				  <cfset refnocheck = 0>
                    <!---Improved by Nieo 20171103 1728 to avoid infinite loop--->
                    <cfset loop = 0>
                  <cfloop condition="refnocheck eq 0">
                      <cfif loop eq 10>
                        <cfquery name="getlastestrefno" datasource="#dts#">
                            select refno from assignmentslip 
                            where left(refno,3)='S#numberformat(company_details.mmonth,'00')#' 
                            order by refno desc 
                            limit 1
                        </cfquery>
                        <cfset refno = getlastestrefno.refno>
                      </cfif>
                      <cftry>
                            <cfinvoke component="cfc.IncrementValue" method="getIncreament" input="#refno#" returnvariable="refnonew"/>
                            <cfcatch>
			...
			<!---<cfif form.assignmenttype neq "invoice">--->
            <cfif counter eq 2 and left(refno,1) eq 'S'>
                  <cfquery datasource="#dts#" name="getGeneralInfo">
...
<!---             '#val(form.selfexceptionday)#', --->
            ...
            <cfloop from="1" to="6" index="i">
                  ...
                  <cfqueryparam cfsqltype="cf_sql_varchar" value="#evaluate('form.fixawdesp#i#')#">,
                    ...
                    <cfqueryparam cfsqltype="cf_sql_double" value="#evaluate('form.fixaweerate#i#')#">,
                    <cfqueryparam cfsqltype="cf_sql_double" value="#evaluate('form.fixawerrate#i#')#">,
                    <cfqueryparam cfsqltype="cf_sql_double" value="#evaluate('form.fixaweeqty#i#')#">,
                    <cfqueryparam cfsqltype="cf_sql_double" value="#evaluate('form.fixawerqty#i#')#">,
                    <!---Added by Nieo 20171213 1131 to add ability to show rate and qty in invoice--->
            ...
            <cfloop from="1" to="18" index="a">
                  ...
                  <cfqueryparam cfsqltype="cf_sql_varchar" value="#evaluate('form.allowancedesp#a#')#">,
                    <!---Added by Nieo 20171213 1131 to add ability to show rate and qty in invoice--->
                    <cfqueryparam cfsqltype="cf_sql_double" value="#evaluate('form.aweerate#a#')#">,
                    <cfqueryparam cfsqltype="cf_sql_double" value="#evaluate('form.awerrate#a#')#">,
                    <cfqueryparam cfsqltype="cf_sql_double" value="#evaluate('form.aweeqty#a#')#">,
                    <cfqueryparam cfsqltype="cf_sql_double" value="#evaluate('form.awerqty#a#')#">,
                    <!---Added by Nieo 20171213 1131 to add ability to show rate and qty in invoice--->
            ...
            <cfif isdefined('form.cosworkday')>
                ,<cfqueryparam cfsqltype="cf_sql_varchar" value="T">
            <cfelse>
                ,<cfqueryparam cfsqltype="cf_sql_varchar" value="F">
            </cfif>
            ,<cfqueryparam cfsqltype="cf_sql_varchar" value="#form.lorealremarks#">
        ...
        <!---Added by Nieo 20170927 1503, Auto get Foerign Currency--->

        <cfif getcustdetails.currcode eq ''>
        <cfset getcustdetails.currcode = "MYR">
        </cfif>
        <!---Added by Nieo 20170927 1503, Auto get Foerign Currency--->
	  ...
	  <!---<cfif form.assignmenttype neq 'invoice'>--->
            ...
            <cfquery name="checkinvoiceexist" datasource="#dts#">
                ...
                <cfif trim(form.custno) neq '300033162'>
...
<!---         <cfif form.assignmenttype eq 'invoice'> --->
      ...
      <cfif form.custtotalgross neq 0> <!-- This cfif is to check if form.custtotalgross is zero or not. -- start from line 716 to line 832--->
			<cfif isdefined('refnofound') eq false> <!-- Line 717, 826 -->
                  <cfquery name="insertartran" datasource="#dts#">
                        ...
                        <cfqueryparam cfsqltype="cf_sql_varchar" value="#getcustdetails.add1#">,
                      <cfqueryparam cfsqltype="cf_sql_varchar" value="#getcustdetails.add2#">,
                      <cfqueryparam cfsqltype="cf_sql_varchar" value="#getcustdetails.add3#">,
                      <cfqueryparam cfsqltype="cf_sql_varchar" value="#getcustdetails.add4#">,
                        <cfqueryparam cfsqltype="cf_sql_varchar" value="">,
                        <cfqueryparam cfsqltype="cf_sql_varchar" value="">,
                        <cfqueryparam cfsqltype="cf_sql_varchar" value="#left(form.custname2,45)#">,
                        <cfqueryparam cfsqltype="cf_sql_varchar" value="">,
                        ...
                        <cfqueryparam cfsqltype="cf_sql_varchar" value="Profile">,
                        <cfqueryparam cfsqltype="cf_sql_varchar" value="">,
                        <cfqueryparam cfsqltype="cf_sql_varchar" value="#getcustdetails.currcode#">,
                        <cfqueryparam cfsqltype="cf_sql_varchar" value="">,
                        <cfqueryparam cfsqltype="cf_sql_varchar" value="">,
                        <cfqueryparam cfsqltype="cf_sql_varchar" value="">,
                        <cfqueryparam cfsqltype="cf_sql_varchar" value="">,
                        ...
                        now(),
                        <cfqueryparam cfsqltype="cf_sql_varchar" value="">,
                        <Cfif getcustdetails.term eq "">
                              <cfqueryparam cfsqltype="cf_sql_varchar" value="14">,
                        <cfelse>
                              <cfqueryparam cfsqltype="cf_sql_varchar" value="#getcustdetails.term#">,
                        </Cfif>
                        <cfqueryparam cfsqltype="cf_sql_varchar" value="">,
                        <cfqueryparam cfsqltype="cf_sql_varchar" value="#getcustdetails.currcode#">,"#assignmentslipno#"<cfif form.assignmenttype neq "invoice">,
                        "#trim(form.assignmenttype)#"
                        ,"#assignmentslipno#"
                        </cfif>
                        ,"#getaddress.shortcode#"
                        )
                  ...
                  <!---<cfif form.assignmenttype neq "invoice">--->
                        ...
                        <cfelseif form.custtotalgross eq 0.00 and left(refnofound,1) neq 'S'>
                                    <cfquery name="updateinv" datasource="#dts#">
                                        UPDATE assignmentslip SET invoiceno = "" WHERE refno = "#assignmentno#"
                                  </cfquery>
						</cfif>
                  <!---</cfif>--->
    ...
    <cfif isdefined('refnofound')>
        <cfif form.custtotalgross neq 0.00 and left(refnofound,1) neq 'S'>
            <cfquery name="getInvoicerRemark" datasource="#dts#"> 
                SELECT * FROM (
                    SELECT invrem FROM assignmentslip
                    WHERE invoiceno = "#refnofound#"
                    AND custtotalgross

                    UNION ALL

                    SELECT "#trim(form.invrem)#" as invrem
                ) a
                GROUP BY invrem
                HAVING invrem !=''
                LIMIT 1
            </cfquery>
            <cfquery name="updateInvoiceRemarkAssign" datasource="#dts#"> 
                UPDATE assignmentslip SET invrem = <cfqueryparam cfsqltype="cf_sql_varchar" value="#form.invrem#">
                WHERE refno = "#assignmentno#"
            </cfquery>
            <cfquery name="updateInvoiceRemark" datasource="#dts#"> 
                UPDATE artran SET rem6 = <cfqueryparam cfsqltype="cf_sql_varchar" value="#getInvoicerRemark.invrem#">
...
<cfelse> <!-- Cfif check status = create at line 91, 836. 1420 -->
      ...
      <cfif checkitemExist.recordcount neq 0 > <!-- Coding from line 839 check if record exist till line 881-->
			<cfif form.mode eq "Delete"> <!-- Coding from line 840 check if mode is delete till line 881-->
                ...
                <!---Added by Nieo 20180119 1211--->
                <cfquery name="deletebatches" datasource="#dts#">
                DELETE FROM assignbatches WHERE batches = <cfqueryparam cfsqltype="cf_sql_varchar" value="#checkitemExist.batches#"> and refno = <cfqueryparam cfsqltype="cf_sql_varchar" value="#form.refnotrue#">
                </cfquery>
                <!---Added by Nieo 20180119 1211--->
			...
			<cfif form.mode eq "Edit"> <!-- Edit Mode start from line 883 until line 1416-->
                ...
                <cfquery name="getprevinvoiceno" datasource="#dts#">
                  ...
                  <cfquery datasource='#dts#' name="updateassignmentslip">
                    ...
                    selfeis='#val(form.selfeis)#',
                    custeis='#val(form.custeis)#',
                        ...
                        AL='#val(form.AL)#',
                        MC='#val(form.MC)#',
                        assignmenttype=<cfqueryparam cfsqltype="cf_sql_varchar" value="#trim(form.assignmenttype)#">,
                        ...
                        <cfloop from="1" to="6" index="i">
                            ...
                            <!---Added by Nieo 20171213 1131 to add ability to show rate and qty in invoice--->
                            fixaweerate#i# = <cfqueryparam cfsqltype="cf_sql_double" value="#evaluate('form.fixaweerate#i#')#">,
                            fixawerrate#i# = <cfqueryparam cfsqltype="cf_sql_double" value="#evaluate('form.fixawerrate#i#')#">,
                            fixaweeqty#i# = <cfqueryparam cfsqltype="cf_sql_double" value="#evaluate('form.fixaweeqty#i#')#">,
                            fixawerqty#i# = <cfqueryparam cfsqltype="cf_sql_double" value="#evaluate('form.fixawerqty#i#')#">,
                            <!---Added by Nieo 20171213 1131 to add ability to show rate and qty in invoice--->
                        ...
                        <cfloop from="1" to="18" index="a">
                            ...
                            <!---Added by Nieo 20171213 1131 to add ability to show rate and qty in invoice--->
                            aweerate#a# = <cfqueryparam cfsqltype="cf_sql_double" value="#evaluate('form.aweerate#a#')#">,
                            awerrate#a# = <cfqueryparam cfsqltype="cf_sql_double" value="#evaluate('form.awerrate#a#')#">,
                            aweeqty#a# = <cfqueryparam cfsqltype="cf_sql_double" value="#evaluate('form.aweeqty#a#')#">,
                            awerqty#a# = <cfqueryparam cfsqltype="cf_sql_double" value="#evaluate('form.awerqty#a#')#">,
                            <!---Added by Nieo 20171213 1131 to add ability to show rate and qty in invoice--->
                        ...
                        <cfif isdefined('form.cosworkday')>
                            ,cosworkday = <cfqueryparam cfsqltype="cf_sql_varchar" value="T">
                        <cfelse>
                            ,cosworkday = <cfqueryparam cfsqltype="cf_sql_varchar" value="F">
                        </cfif>
                        ,lorealremarks=<cfqueryparam cfsqltype="cf_sql_varchar" value="#form.lorealremarks#">
                        <cfif isdefined('form.include')>
                            ,include = <cfqueryparam cfsqltype="cf_sql_varchar" value="T">
                        <cfelse>
                            ,include = <cfqueryparam cfsqltype="cf_sql_varchar" value="F">
                        </cfif>
                        where refno = '#form.refnotrue#'
                        and posted=''
                  </cfquery>
   ...
   <!---              <cfif form.assignmenttype neq 'sinvoice'> --->
				  ...
				  <!---<cfif form.assignmenttype neq 'invoice'> ---> <!---Removed by Nieo 20170913 1001 due to invoice assignment type fixed of creating duplicated invoices--->
						...
						<cfif checkinvoiceexist.recordcount eq 0>
                            <cfif isdefined('refnofound') eq false and form.custtotalgross neq 0>
                                <cfquery name="checkentity" datasource="#dts#">
                                      SELECT location,jobpostype,custno FROM placement WHERE placementno = <cfqueryparam cfsqltype="cf_sql_varchar" value="#form.placementno#">
                                </cfquery>
                                <cfquery name="getlastno" datasource="#dts#">
                            ...
                            <cfif form.custtotalgross neq 0  and left(form.refno,1) neq "S"> <!-- Do not allow to insert when value is zero, finish at line 1393 -->
                                    <cfquery name="insertartran" datasource="#dts#">
                                          ...
                                          <cfqueryparam cfsqltype="cf_sql_varchar" value="">,
                                          <cfqueryparam cfsqltype="cf_sql_varchar" value="#getcustdetails.currcode#">,"#assignmentslipno#"
                                          <cfif form.assignmenttype neq "invoice">
                                                ,"#trim(form.assignmenttype)#"
                                          </cfif>
                                          )
                              ...
                              <cfif form.custtotalgross neq 0.00 and left(form.refno,1) neq 'S'>
                                ...
                                <cfelseif form.custtotalgross eq 0.00 and left(refnofound,1) neq 'S'>
                                    <cfquery name="updateinv" datasource="#dts#">
                                        UPDATE assignmentslip SET invoiceno = "" WHERE refno = "#assignmentslipno#"
                                  </cfquery>
                              </cfif>
                            </cfif>                            
                        <cfelse>
                  ...
                  <cfif isdefined('isfirst')> <!-- CF for isfirst start at line 1234 and end at line 1396 -->
						...
						<cfif checkartranexist.recordcount neq 0><!-- Comment if artran contain the data for line 1240 line 1289 to line 1394-->
                              ...
                              <cfif form.custtotalgross neq 0> <!-- Similar stopper along the coding as no time to clean the coding, therefore adding a few checkpoint -->
                                    <cfquery datasource='#dts#' name="updateartran"> 
                                          ...
                                          rem3=<cfqueryparam cfsqltype="cf_sql_varchar" value="#getcustdetails.currency#">,
                                          currcode=<cfqueryparam cfsqltype="cf_sql_varchar" value="#getcustdetails.currcode#">,
                                        ...
                                        frem1 = <cfqueryparam cfsqltype="cf_sql_varchar" value="#getcustdetails.add1#">,
                                          frem2 = <cfqueryparam cfsqltype="cf_sql_varchar" value="#getcustdetails.add2#">,
                                          frem3 = <cfqueryparam cfsqltype="cf_sql_varchar" value="#getcustdetails.add3#">,
                                          frem4 = <cfqueryparam cfsqltype="cf_sql_varchar" value="#getcustdetails.add4#">,
                                          ...
                                          <cfelse>
                                                term = <cfqueryparam cfsqltype="cf_sql_varchar" value="#getcustdetails.term#">,
                                          </Cfif>
                          <!--- refno = <cfqueryparam cfsqltype="cf_sql_varchar" value="#form.refno#">, --->
                                          rem40 = "#assignmentslipno#"
                                          <cfif form.assignmenttype neq "invoice">,rem11="#trim(form.assignmenttype)#"</cfif>
                                    ...
                                    <cfif templistlen gt 1>
                                          ...
                                          <cfquery datasource='#dts#' name="updateartran"> 
                                                ...
                                                frem1 = <cfqueryparam cfsqltype="cf_sql_varchar" value="#getcustdetails.add1#">,
                                                  frem2 = <cfqueryparam cfsqltype="cf_sql_varchar" value="#getcustdetails.add2#">,
                                                  frem3 = <cfqueryparam cfsqltype="cf_sql_varchar" value="#getcustdetails.add3#">,
                                                  frem4 = <cfqueryparam cfsqltype="cf_sql_varchar" value="#getcustdetails.add4#">,frem2 = <cfqueryparam cfsqltype="cf_sql_varchar" value="#getcustdetails.add2#">,
                                                  frem3 = <cfqueryparam cfsqltype="cf_sql_varchar" value="#getcustdetails.add3#">,
                                                  frem4 = <cfqueryparam cfsqltype="cf_sql_varchar" value="#getcustdetails.add4#">,
                                                frem7 = <cfqueryparam cfsqltype="cf_sql_varchar" value="#left(form.custname2,45)#">,
                                                <Cfif getcustdetails.term eq "">
                        ...
                        <cfelse><!-- Comment artran cannot find the record, then insert new data for line 1240 to line 1289 to line 1394  -->
                              <!---Added by Nieo 20170927 1503, Auto get Foerign Currency--->
                            <cfquery name="getcustdetails" datasource="#dts#">
                                select name,term,currcode,currency from #target_arcust# where custno='#form.custno#'
                            </cfquery>
 				  ...
 				  <cfif form.assignmenttype neq 'invoice'><!-- Must let line 1397 run till 1412 so that ictran will be deleted -->
                        ...
                        <cfif isdefined('getprevinvoiceno.invoiceno')>
                            <cfquery name="deleteictran" datasource="#dts#">
                            delete from ictran where type='INV'
                            AND brem6 = "#assignmentslipno#"
                            AND refno="#getprevinvoiceno.invoiceno#"
                            <cfif trim(form.custno) neq '300033162'>
                                AND refno not in (select refno from artran where posted='p')
                            </cfif>
                            </cfquery>
                  ...
                  <cfelse>
                        <cfquery name="emptyallictran" datasource="#dts#">
                              delete from ictran where refno = '#getprevinvoiceno.invoiceno#' 
                              and brem6='#assignmentslipno#'   
                              and type='INV'
                              AND refno not in (select refno from artran where posted='p')
                        </cfquery>
