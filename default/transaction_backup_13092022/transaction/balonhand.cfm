...
<cfif getGeneralInfo.deductso eq "Y">
    ...
    <cfoutput>
Balance: <input type="text" readonly name="balonhand" id="balonhand" value="#balonhand#" size="7" ><input type="hidden" readonly name="stkcost" id="stkcost" value="#val(checkitemexist.ucost)#" size="7" >
</cfoutput>
</cfif>
</cfif>