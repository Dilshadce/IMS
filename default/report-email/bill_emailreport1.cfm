...
<cfquery datasource="#dts#" name="gettran">
	...
	<cfif trim(form.billfrom) neq "" and trim(form.billto) neq "">
		and a.refno between '#form.billfrom#' and '#form.billto#'
	</cfif>
	...
	order by a.refno
		...
		<cfoutput>
			...
			<tr>
				<td colspan="100%"><div align="center"><font size="3" face="Arial, Helvetica, sans-serif"><strong>#form.reftype# Report</strong></font></div><input type="hidden" name="totalrecord" id="totalrecord" value="#gettran.recordcount#"><input type="hidden" name="trancode" id="trancode" value="#form.reftype#"><input type="hidden" name="format" id="format" value="#form.format#"></td>
			</tr>
		<!---  <cfif form.billfrom neq "" and form.billto neq "">
				<tr>
    ...
    <cfif form.userfrom neq "" and form.userto neq "">
	 ...
	 <tr>
        ...
        <cfif form.billfrom neq "" and form.billto neq "">
	 <tr>
					<td colspan="100%"><div align="center"><font size="1.5" face="Arial, Helvetica, sans-serif">Ref From #form.billfrom# To #form.billto#</font></div></td>
				</tr>
		</cfif>
			<tr>
		  ...
		  <cfoutput query="gettran">
				...
				<cfelse>
					...
					<td><div align="center"><font size="1.5" face="Arial, Helvetica, sans-serif">
						<cfif form.reftype eq "CS" and lcase(Hcomid) eq "ovas_i">
							#agenno#
						<cfelse>
							#userid#
						</cfif>
