...
<body>
<cfform action="bill_emailreport1.cfm?alown=#alown#" method="post" name="form123" target="_blank">

<!--- <h2>Print <cfoutput>#trantype#</cfoutput> Listing Report</h2> --->
<h3>
	<a><font size="2">Send Email Report</font></a>
</h3>
...
<input type="hidden" name="fromto" id="fromto" value="" />
    ...
    <tr>
        ...
        <td></td>
		<td>
			<select name="reftype" onChange="ajaxFunction(document.getElementById('ajaxField'),'getformat.cfm?reftype='+this.value);">
