...
<tr>
<td class="tabletitle1">Item No.</td>
<td class="tabletitle1" >Description</td>
<td class="tabletitle1" >Created On</td>
</tr>

<cfoutput>
    <cfquery name="getnewitem" datasource="#dts#">
    select itemno, desp, created_on
    from icitem
    ...
    <cfloop query="getnewitem">
        ...
        <td class="tablecontent1" nowarp>#itemno#</td>
        <td class="tablecontent1" nowarp>#desp#</td>
