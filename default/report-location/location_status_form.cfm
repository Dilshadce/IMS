...
<cfswitch expression="#url.type#">
	...
	<table border="0" align="center" width="70%" class="data">
		...
		<tr> 
			...
			<td width="85%">
            <input type="text" name="productfrom" id="productfrom" size="12"> 
			<cfif getgeneral.filterall eq "1">
            	<input type="button" size="11" value="Ajax Search" onClick="document.getElementById('fromto').value='from';ColdFusion.Window.show('finditem');" />&nbsp;
            </cfif>
			</td>
		</tr>
		<tr> 
			<th>Product To</th>
			<td nowrap>
           	<input type="text" name="productto" id="productto" size="12">
			<cfif getgeneral.filterall eq "1">
            	<input type="button" size="11" value="Ajax Search" onClick="document.getElementById('fromto').value='to';ColdFusion.Window.show('finditem');" />&nbsp;
            </cfif>
			</td>
		</tr>
		<tr> 
