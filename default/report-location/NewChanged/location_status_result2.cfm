...
<Table x:FullColumns="1" x:FullRows="1" ss:DefaultColumnWidth="54" ss:DefaultRowHeight="11.25">
	...
	<cfinvoke component = "locationstatus" method = "get_location" returnvariable = "getlocation">
		...
		<cfloop query="getlocation">
			...
			select a.LastAccDate,a.ThisAccDate,b.avcost2,b.locqfield as qtybf FROM icitem_last_year as a left join (select locqfield,itemno,avcost2 from locqdbf_last_year where itemno='#getitem.itemno#' and location='#target_location#' and LastAccDate = #thislastaccdate# )as b on a.itemno=b.itemno
            ...
            <cfelse>
            <cfquery name="getqtybf" datasource="#dts#">
			select locqfield as qtybf,itemno,avcost2 from locqdbf where itemno='#getitem.itemno#' and location='#target_location#' limit 1
            </cfquery>
