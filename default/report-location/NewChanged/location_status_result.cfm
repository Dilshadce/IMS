...
<cfxml variable="data">
		...
		<cfelseif getgeneral.cost eq "FIFO" or getgeneral.cost eq "LIFO">
			...
			select a.LastAccDate,a.ThisAccDate,b.avcost2,b.locqfield as qtybf FROM icitem_last_year as a left join (select locqfield,itemno,avcost2 from locqdbf_last_year where itemno='#getitem.itemno#' and location='#getitem.location#' and LastAccDate = #thislastaccdate# )as b on a.itemno=b.itemno
            ...
            <cfelse>
            <cfquery name="getqtybf" datasource="#dts#">
			select locqfield as qtybf,itemno,avcost2 from locqdbf where itemno='#getitem.itemno#' and location='#getitem.location#' limit 1
            </cfquery>
