...
function getItem1(){
	...
	function change_link()
	{
		...
		{
			document.location_physical_worksheet.action="location_physical_worksheetDOadjust.cfm";
		}
		else
		{
			document.location_physical_worksheet.action="location_physical_worksheetDO2.cfm";
		}
	}
...
<h3>
	...
	<a><font size="2">View <cfoutput>#getgeneral.lLOCATION#</cfoutput> Physical Worksheet Report DO</font></a>
</h3>

<cfform action="location_physical_worksheetDO2.cfm" name="location_physical_worksheet" method="post" target="_blank">
<table border="0" align="center" width="65%" class="data">
	<tr>
		<th>Report Format<input type="hidden" name="fromto" id="fromto" value="" /></th>
	</tr>
    <tr>
    <td><input type="radio" name="result" value="HTML" checked>HTML</td></tr>
    <tr>
    <td><input type="radio" name="result" value="EXCELDEFAULT">EXCEL DEFAULT</td>
    </trs>
	<tr> 
		<td nowrap>
			<input type="checkbox" name="update_actual_qty" id="3" value="yes" onClick="change_link();"> UPDATE ACTUAL QUANTITY<br/>
			<input type="checkbox" name="generate_adjustment_transaction" id="4" value="yes"> GENERATE DO TRANSACTIONS<br/>
            
		</td>
        <td><input type="checkbox" name="exclude_actual" id="6" value="yes"> EXCLUDE 0 ACTUAL QTY<br/>
