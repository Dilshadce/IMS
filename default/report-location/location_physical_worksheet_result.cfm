...
<Row ss:AutoFitHeight="0" ss:Height="20.0625">
	...
	<cfif trim(form.itemfrom) neq "" and trim(form.itemto) neq "">
<Row ss:AutoFitHeight="0" ss:Height="20.0625">
  		   <cfwddx action = "cfml2wddx" input = "#form.itemfrom# - #form.itemto#" output = "wddxText">
    ...
    <cfif trim(form.catefrom) neq "" and trim(form.cateto) neq "">
<Row ss:AutoFitHeight="0" ss:Height="20.0625">
  		   <cfwddx action = "cfml2wddx" input = "#form.catefrom# - #form.cateto#" output = "wddxText1">
...
<Row ss:AutoFitHeight="0" ss:Height="20.0625">
	...
	<cfif form.period neq "">
<Row ss:AutoFitHeight="0" ss:Height="20.0625">
  		   <cfwddx action = "cfml2wddx" input = "#form.period#" output = "wddxText3">
