...
<cfelse>
            ...
            <cfquery name="insertpost1" datasource="#dts#">
                ...
                '#numberformat(getdeposit.cs_pm_cash,".__")#',
                '1',
                '#getdeposit.taxcode#','',#getdeposit.wos_date#,'#HUserID#','')
			</cfquery>
            ...
            <cfif val(getdeposit.ptax) neq 0>
			...
			<cfquery name="insertpost4" datasource="#dts#">
				...
				'#numberformat(firstcredit,".__")#',
                '-#numberformat(firstcredit,".__")#',
                '1','#getdeposit.taxcode#','',#getdeposit.wos_date#,'#HUserID#','')
			</cfquery>
            
            <cfquery name="insertpost3" datasource="#dts#">
				insert into glpost9
                (acc_code,accno,fperiod,date,reference,refno,desp,despa,creditamt,fcamt,exc_rate,rem4,rem5,bdate,userid,agent)			
				values('Dep','#getgsetup.gstsales#','#getdeposit.fperiod#',#getdeposit.wos_date#,'#getdeposit.depositno#','#getdeposit.sono#',
				'Deposit','',
				'#numberformat(secondcredit,".__")#',
                '#numberformat(secondcredit,".__")#',
                '1',
                '#getdeposit.taxcode#','',#getdeposit.wos_date#,'#HUserID#','')
			</cfquery>
...
<script type="text/javascript">
	...
	window.location.href='depositimport_to_ams.cfm';
</script>
</cfoutput>