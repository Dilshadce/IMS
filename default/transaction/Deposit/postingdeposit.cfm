...
<cfform name="postdepositform" id="postdeposit" action="postingdepositprocess.cfm" method="post">
Type : 
    <select name="Sort" id="sort" onChange="ajaxFunction(document.getElementById('ajaxField'),'postingdepositfilterajax.cfm?sort='+document.getElementById('sort').value);">
		<option value="-">-</option>
