...
<cfoutput>
<h1>Print Claim Cheque</h1>
<cfform name="assignment1" id="assignment1" action="../assignmentslipnew/printchequeprocess.cfm" method="post">
...
<th>Cheque No To</th>
<td>
<div id="assigntoajax" style="display:inline"><cfselect name="assignmentto" id="assignmentto" query="getlist" value="refno" display="desp"></cfselect></div>&nbsp;<input type="text" name="searchrefnoto" id="searchrefnoto" onKeyUp="searchSel('assignmentto','searchrefnoto')"></td>
</tr>
...
<th>Cheque Date</th>
<td>
<cfinput type="text" name="cheqdate" id="cheqdate" validate="eurodate" validateat="onsubmit" required="yes" message="Cheque Date is Required or Not Valid" value="#dateformat(now(),'dd/mm/yyyy')#">&nbsp;&nbsp;<img src="/images/cal.gif" width=17 height=15 border=0 onClick="showCalendarControl(document.getElementById('cheqdate'));">
</td>
</tr>
<tr>
