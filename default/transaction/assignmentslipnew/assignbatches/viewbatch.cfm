...
</div><cfif getbatches.locked neq "Y">
<cfform name="lockb" id="lockb" method="post" action="lockbatches.cfm">
...
<cfelse>
<h1>This bactch has been locked on #dateformat(getbatches.locked_on,'dd/mm/yyyy')# #timeformat(getbatches.locked_on,'hh:mm:ss')# with GIRO refno of #getbatches.girono#</h1>
</cfif>
</cfoutput>
</cfif>