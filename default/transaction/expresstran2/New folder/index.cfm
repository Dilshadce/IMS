...
<cfoutput>
	...
	var jobbody = trim(document.getElementById('jobbody').value);
	if (isNaN(expqty))
	{
...
<td <cfif getmodule.auto eq 1>style="display:none" </cfif>><input type="text" name="d_attn" id="d_attn" value="" maxlength="35" size="40"><input type="button" name="Sattn2" value="Ajax Search" onClick="javascript:ColdFusion.Window.show('findattention2');"></td>
</tr>
...
<th>PO No</th><td><input type="text" name="pono" id="pono" value=""></td>
<cfelse>
...
<tr>
<div <cfif getmodule.job neq "1">style="visibility:hidden"</cfif>>
<th style="vertical-align:top">Job</th>
</div>
...
<tr>
<cfif getdisplay.simple_job eq 'Y'>
<th>#getgsetup.ljob#</th>
<td>
<select name="jobbody" id="jobbody">
<option value="">Choose a #getgsetup.ljob#</option>
<cfloop query="getjob">
<option value="#getjob.source#" <cfif getictrantemp.job eq getjob.source>selected</cfif>>#getjob.source# - #getjob.project#</option>
</cfloop>
...
</td><cfelse><td></td><td><input type="hidden" name="jobbody" id="jobbody" value=""></td></cfif>
<th>Tax</th>
<td>
