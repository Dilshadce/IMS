...
<input type="button" name="Searchbtn" id="Searchbtn" value="Go" onclick="document.getElementById('loading').style.visibility='visible';ajaxFunction1(document.getElementById('ajaxField'),'findCustomerAjax.cfm?type=Customer&dbtype=#url.dbtype#&custno='+document.getElementById('custno1').value+'&custname='+document.getElementById('custname1').value+'&leftcustname='+document.getElementById('custname2').value);" >
    ...
    <table width="100%">
    <tr>
    <th width="100px"><font style="text-transform:uppercase">Customer NO</font></th>
