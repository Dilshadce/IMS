...
<div id="content">
 ...
 <table width="100%" cellpadding="3" cellspacing="1" class="example_table">
  			<tr>
				<td colspan="11"><div align="center"><font color="#FF0000" size="3" face="Arial, Helvetica, sans-serif"><strong><cfoutput>#tranname#</cfoutput></strong></font></div></td>
  			</tr>
...
<cfform action="pages.cfm?tran=INV" method="post">
Page <cfinput name="skeypage" type="text" size="2" validate="integer" message="Wrong value in Page field.">
</cfform>

<cfif begin_page EQ 1>
&nbsp;[Previous]
<cfelse>
&nbsp;<a href="pages.cfm?tran=INV&page=#begin_page-1#">[Previous]</a>
</cfif>
...
<div align="right">
<!---{ First Page Link }--->
&nbsp;<a href="pages.cfm?tran=INV&page=1">[First Page]</a>

<!---{ Last Page Link }--->
&nbsp;<a href="pages.cfm?tran=INV&page=#total_pages#">[Last Page]</a></div>
<hr>
	</div>	</div>
