<cfif isdefined("session.f#replace(form.uuid,'-','','all')#")>
<cfset StructDelete(Session, "f#replace(form.uuid,'-','','all')#")>
<cfelse>
<cfoutput>
<cfquery name="getoldno" datasource="#dts#">
SELECT refno FROM artran WHERE type = "#tran#" order by created_on desc limit 1
</cfquery>
<cflocation url="/default/transaction/newvehicletrandone.cfm?type=#tran#&refno=#getoldno.refno#&print=#form.acceptprint#" addtoken="no">
</cfoutput>
<cfabort>
</cfif>
...
<cfquery datasource="#dts#" name="updatevehicle">
	update vehicles set lastmileage="#val(form.rem9)#",nextmileage="#val(form.rem10)#",lastserdate=<cfqueryparam cfsqltype="cf_sql_varchar" value="#wos_date#">,nextserdate=<cfqueryparam cfsqltype="cf_sql_varchar" value="#rem8#"> where entryno=<cfqueryparam cfsqltype="cf_sql_varchar" value="#form.rem5#">
</cfquery>
...
<cflocation url="/default/transaction/newvehicletrandone.cfm?type=#type#&refno=#refno#&print=#form.acceptprint#" addtoken="no">
