...
<!--- 		if(nextflow != "")
	...
	if(answer)
	{
	var onholdurl = '/default/transaction/newvehicletran/onholdajax.cfm?uuid='+document.getElementById("uuid").value;
	...
	if(answer)
	{
	var onholdurl = '/default/transaction/newvehicletran/onholdajax.cfm?uuid='+document.getElementById("uuid").value+'&remark='+document.getElementById("rem9").value;
	ajaxFunction(document.getElementById('onholdajax'),onholdurl);
	<cfoutput>
	window.location.href="index.cfm?tran=#url.tran#";
	</cfoutput>
...
<!--- 		ajaxFunction(document.getElementById('ajaxfieldgetunitprice'),'/default/transaction/newvehicletran/getunitpriceAjax.cfm?itemno='+document.getElementById('expressservicelist').value+'&unit='+document.getElementById('expunit').value);
...
<cfoutput>
	var itemdespurl = '/default/transaction/newvehicletran/itemdespprocess.cfm?uuid=#URLEncodedFormat(uuid)#&trancode='+escape(itemdesptrancode)+'&itemdesp='+escape(itemdesp)+'&itemdespa='+escape(itemdespa)+'&itemcomment='+escape(itemcomment);
	...
	var ajaxurl2 = '/default/transaction/newvehicletran/addmultiproductsAjax.cfm?tran='+escape(tran)+'&tranno='+refno+'&uuid=#URLEncodedFormat(uuid)#&trancode='+escape(trancode)+'&custno='+escape(custno)+itemlisting;
	...
	var ajaxurl2 = '/default/transaction/newvehicletran/addpackageprocessAjax.cfm?tran='+escape(tran)+'&tranno='+refno+'&uuid=#URLEncodedFormat(uuid)#&trancode='+escape(trancode)+'&custno='+escape(custno)+'&packagecode='+escape(packagecode);
	...
	{
    var urlloaditemdetail = '/default/transaction/newvehicletran/addItemAjax.cfm?itemno='+escape(encodeURI(detailitemno))+'&reftype='+document.getElementById('tran').value+'&custno='+document.getElementById('custno').value;
	...
	{
	  var urlloaditembal = '/default/transaction/newvehicletran/balonhand.cfm?itemno='+encodeURI(itemnobal)+'&location='+escape(document.getElementById('locationfr').value);
	...
	{
	<cfoutput>
    var urlload = '/default/transaction/newvehicletran/recalculateAjax.cfm?uuid=#URLEncodedFormat(uuid)#';
	</cfoutput>
	...
	{
	var ajaxurl = '/default/transaction/newvehicletran/recalculateAjax.cfm?uuid=#URLEncodedFormat(uuid)#';
	new Ajax.Request(ajaxurl,
      {
        method:'get',
        onSuccess: function(getdetailback){
	...
	{
		<cfoutput>
	var customerurl = '/default/transaction/newvehicletran/memberdetailajax.cfm?detail=1&tran=#url.tran#&member='+document.getElementById("custno").value;
	</cfoutput>
	...
	{
	<cfoutput>
	var depositurl = '/default/transaction/newvehicletran/getdepositajax.cfm?depositno='+document.getElementById("depositno").value;
	</cfoutput>
	...
	{
	var vehiclesurl = '/default/transaction/newvehicletran/vehiclesdetailajax.cfm?detail=1&vehicle='+document.getElementById("rem5").value;
...
<td width="40%"><input type="text" name="wos_date" id="wos_date" value="#dateformat(datenow,'DD/MM/YYYY')#" onKeyUp="nextIndex(event,'wos_date','expressservicelist');" readonly /><!--- <img src="/images/cal.gif" width=17 height=15 border=0 onClick="showCalendarControl(document.getElementById('wos_date'));">&nbsp;(DD/MM/YYYY) ---></td>
<th width="10%">#tranname# No</th>
<td width="40%" style="font-family:'Times New Roman', Times, serif; font-size:14">
...
<cfinput type="hidden" name="headerdesp" size="50" id="headerdesp" onKeyUp="nextIndex(event,'headerdesp','headerdesp2');" value="" maxlength="40" >
<cfinput type="hidden" name="headerdesp2" size="50" id="headerdesp2" onKeyUp="nextIndex(event,'headerdesp2','custno');" value="" maxlength="40">
</td>
</tr>
<tr>
<th>Vehicle No</th>
...
<th>#getgsetup.rem9#<div id="ajaxFieldPro2" name="ajaxFieldPro2" style="display:none"></div></th>
<td>
<input type="text" name="rem9" id="rem9" value="" maxlength="15" size="40">
<div style="display:none">
<cfinput type="text" name="currcode" id="currcode" size="10"  /><input type="hidden" name="currcodehid" id="currcodehid" value="">&nbsp;<cfinput type="text" name="currrate" id="currrate" bind="cfc:custsupp.getcurrrate('#dts#',{currcode},'#target_currency#')" bindonload="yes" size="5" />
...
<td ><input type="text" name="b_name" id="b_name" value="" maxlength="40" size="25"/></td>
<td><input type="text" name="b_name2" id="b_name2" value="" maxlength="40" size="25"/></td>
</tr>
<tr>
<th>Address</th>
<td>
<input type="text" name="b_add1" id="b_add1" value="" maxlength="35" size="35"></td>
</tr>
<tr>
<th></th>
<td>
<input type="text" name="b_add2" id="b_add2" value="" maxlength="35" size="35"></td>
</tr>
<tr>
<th></th>
<td>
<input type="text" name="b_add3" id="b_add3" value="" maxlength="35" size="35"></td>
</tr>
<tr>
<th></th>
<td>
<input type="text" name="b_add4" id="b_add4" value="" maxlength="35" size="35"></td>
</tr>
<tr>
<th>Tel</th>
<td>
<input type="text" name="b_phone" id="b_phone" value="" maxlength="25" size="35"></td>
</tr>
<tr>
<th>Attention</th>
<td nowrap>
<input type="text" name="b_attn" id="b_attn" value="" maxlength="35" size="20"><input type="button" name="Sattn1" value="Search" onClick="javascript:ColdFusion.Window.show('findattention');"></td>
</tr>
</table>
</div>
</td>
...
<td><input type="text" name="rem10" id="rem10" value="" maxlength="15" size="40">
</td>
</tr>
...
<div id="itemlist" style="height:218px; overflow:scroll;">
<table width="100%">
<tr>
<th width="2%">No</th>
...
<td colspan="1">
<cfinput type="text" name="expressservicelist" id="expressservicelist" size="15" onBlur="this.value = this.value.split('___', 1);getitemdetail(this.value);" onKeyUp="nextIndex(event,'expressservicelist','expqty');" autosuggest="cfc:itemno.findItem({cfautosuggestvalue},'#dts#')" autosuggestminlength="1"/>
...
<tr>
<td align="center" valign="middle" style="font:'Times New Roman', Times, serif; font-size:16px;" bgcolor="##CCFF33" onMouseOver="this.style.cursor='hand'"><a onClick="ctrl1();" style="cursor:pointer">On Hold</a></td>
<td align="center" valign="middle" style="font:'Times New Roman', Times, serif; font-size:16px" bgcolor="##CCFF33" onMouseOver="this.style.cursor='hand'"><a onClick="ctrl7();" style="cursor:pointer">On Hold Transactions</a></td>
</tr>
</table>
</td><th>Total Amount</th><td><cfinput type="text" style="font: x-large bolder; color:##000; background-color:##FFFF66" name="grand" id="grand" value="0.00" readonly="yes" onClick="calcfoot();"/></td>
</tr>
...
<tr>
<td colspan="10">
<table colspan="100%" align="center">
<tr>
...
<cfwindow center="true" width="700" height="500" name="searchitem" refreshOnShow="true" closable="true" modal="false" title="Search Item" initshow="false"
        source="/default/transaction/newvehicletran/searchitem2.cfm?reftype={tran}" />
<cfelse>
<cfwindow center="true" width="700" height="500" name="searchitem" refreshOnShow="true" closable="true" modal="false" title="Search Item" initshow="false"
        source="/default/transaction/newvehicletran/searchitem.cfm?reftype={tran}" />
</cfif>
...
<cfwindow center="true" width="700" height="500" name="addpackage" refreshOnShow="true" closable="true" modal="false" title="Package" initshow="false"
        source="/default/transaction/newvehicletran/addpackage.cfm?reftype={tran}" />
...
<cfwindow center="true" width="600" height="400" name="changedaddr" refreshOnShow="true" closable="true" modal="false" title="Search Address" initshow="false"
        source="/default/transaction/newvehicletran/searchaddress.cfm" /> 
