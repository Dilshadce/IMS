...
<cfquery name="getpricehis" datasource="#dts#">
		select 
		wos_date,price_bil,dispec1,dispec2,dispec3,qty
		from ictran 
...
<tr><td>#dateformat(getpricehis.wos_date,'YYYY-MM-DD')#</td><td>&nbsp;</td><td>#numberformat(getpricehis.price_bil,'.__')#</td></tr>
</cfloop>
</table>
</cfoutput>