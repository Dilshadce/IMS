...
SELECT grosspay,empno,paydate,nsded FROM payweek#a# WHERE grosspay <> "0" and grosspay is not null and grosspay <> "" and payyes = "Y" and paydate <> "" and paydate is not null 
...
earlyhr = 0,
nopayhr = 0,
AW#val(100 + a)# = #val(getgrosspay.grosspay)#,
PAYYES = "Y"
