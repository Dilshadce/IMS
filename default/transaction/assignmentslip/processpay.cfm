...
<cfif val(url.npl) neq 0>
basicpay = "#val(url.basicpay)#",
</cfif>
AL = "#val(url.AL)#",
MC = "#val(url.MC)#",
...
<cfif val(url.npl) neq 0>
<cfset basicpay = val(url.basicpay) >
</cfif>
...
<!--- 		        <cfif epf1hd eq "Y">
            ...
            <input type="text" name="basicpay" id="basicpay" value="#numberformat(val(getpaydata.basicpay),'.__')#" />
            ...
            <input type="text" name="otpay" id="otpay" value="#numberformat(val(getpaydata.otpay) - val(getpaydata.OT5) - val(getpaydata.OT6),'.__')#" />
            ...
            <cfinclude template="employerpay.cfm">
             <cfquery name="getpaydata" datasource="#paydts#">
