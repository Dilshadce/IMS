...
<cfset words_id_list = "1178,1190,1191,1192,1187,1188,1189,1179,1180,1181,1182,1184,1183,1185,953,1186,352">
<cfinclude template="/latest/words.cfm">
<html>
<head>
<title><cfoutput>#words[1178]#</cfoutput></title>
...
<cfquery name="getrcno" datasource="#dts#">
	SELECT refno 
    FROM artran 
    WHERE (void = '' OR void IS NULL) AND posted='' AND type='RC' 
    ORDER BY refno
</cfquery>
...
<cfoutput>
<h2 align="center">#words[1178]#</h2>
<table align="center">
<tr><td></td></tr>
	<tr><td><div align="justify">- #words[1190]# <font color="red">#UCase(words[1191])#</font> #words[1192]#</div></td></tr>
	<tr><td><div align="justify">- #words[1187]# <font color="red">#words[1188]#</font> #words[1189]#</div></td></tr>
	<tr><td><div align="justify">- #words[1179]# <font color="red">#words[1180]#</font></div></td></tr>
</table>
...
<table width="60%" border="0" cellspacing="0" cellpadding="3" class="data" align="center">
	<tr>
		...
		<td colspan="2"><input type="checkbox" name="distriall" id="distriall" value="1">&nbsp; #words[1181]# <br>
        <input type="hidden" name="fromto" id="fromto" value="" /><input type="checkbox" name="updateitemcost" id="updateitemcost" value="1">&nbsp; #words[1182]#
        </td>
      	</tr>
	<tr>
		<th>#words[1184]#</th>
		...
		<tr>
		  	<th nowrap>#words[1185]#</th>
        	<td><input type="text" name="enterreffrom" maxlength="8" size="9"><input type="button" size="10" value="#words[953]#" onClick="document.getElementById('fromto').value='from';ColdFusion.Window.show('findrefno');" /></td>
      	</tr>
      	<tr> 
        	<th nowrap>#words[1186]#</th>
        	<td><input type="text" name="enterrefto" maxlength="8" size="9"><input type="button" size="10" value="#words[953]#" onClick="document.getElementById('fromto').value='to';ColdFusion.Window.show('findrefno');" /></td>
      	</tr>
		<tr> 
			<td colspan="2" align="right"><input type="submit" name="Submit" value="#words[352]#"></td>
		</tr>
	</table>
</form>
