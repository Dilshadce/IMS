...
<!---Added by Nieo 20171229 to add ability to debatch all at once--->
   <tr>
    <td colspan="5"></td>
    <td><cfif getbatches.locked neq "Y"><u><a style="cursor:pointer" onclick="confirmdebatch('deleteall','#getbatches.refno#','#url.batchno#')" >Debatch All</a></u></cfif></td>
    </tr> 
<!---Added by Nieo 20171229 to add ability to debatch all at once--->
</table>
</div>
