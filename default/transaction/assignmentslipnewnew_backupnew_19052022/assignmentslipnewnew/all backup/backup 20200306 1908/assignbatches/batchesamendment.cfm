...
<cfif type eq "deleteall">
	<cfquery name="updateempty" datasource="#dts#">
    UPDATE assignmentslip SET batches = "" WHERE batches = <cfqueryparam cfsqltype="cf_sql_varchar" value="#URLDECODE(url.batchno)#">
    </cfquery>
    ...
    SELECT batches,invoiceno,refno FROM assignmentslip WHERE batches = <cfqueryparam cfsqltype="cf_sql_varchar" value="#URLDECODE(url.batchno)#">
    </cfquery>
    ...
    <cfif checkbatch.recordcount eq 0>
        ...
        <cfloop query="checkbatch">
            <cfquery name="unlockartran" datasource="#dts2#">
            UPDATE artran SET posted = '' 
            WHERE refno = <cfqueryparam cfsqltype="cf_sql_varchar" value="#checkbatch.invoiceno#">
            </cfquery>
                
            <cfquery name="lockassign" datasource="#dts2#">
            UPDATE assignmentslip SET posted = '' 
            WHERE refno = <cfqueryparam cfsqltype="cf_sql_varchar" value="#checkbatch.refno#">
            </cfquery>
        </cfloop>
