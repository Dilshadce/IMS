			...
			<cfif form.mode eq "Delete"> <!-- Coding from line 840 check if mode is delete till line 881-->
				  <cfif checkitemExist.assignmenttype eq "invoice">
                        ...
                        <cfquery datasource='#dts#' name="deleteartran">
                            UPDATE artran SET void = "Y",updated_on= now(),rem30 = <cfqueryparam cfsqltype="cf_sql_varchar" value="#form.reason#"> where refno='#form.refnotrue#' and type='INV' 
                        </cfquery>
                  ...
                  <cfelse>
						...
						<cfif checkempty.recordcount eq 0>
                              <cfquery datasource='#dts#' name="deleteartran">
                                  UPDATE artran SET void = "Y",updated_on=now(),rem30 = <cfqueryparam cfsqltype="cf_sql_varchar" value="#form.reason#"> where refno='#gettrancodes.orirefno#' and type='INV'
                              </cfquery>
                        <cfelse>
                              <cfquery datasource='#dts#' name="deleteartran">
                          ...
                          <!--- refno = <cfqueryparam cfsqltype="cf_sql_varchar" value="#form.refno#">, --->
                              ...
                              <cfelse> <!-- Below coding will handle existing value turn to zero -->
                                    ...
                                    <cfif templistlen gt 1>
                                          ...
                                          <cfif listfirst(checkrem15list.rem15) eq  assignmentslipno>
                                          
                                          <cfset newfirst = listfirst(after_deleted_element)>
                                    ...
                                    <cfelse>
                                          ...
                                          <cfquery datasource='#dts#' name="deleteartran">
                                              UPDATE artran SET void = "Y",updated_on=now(),rem30 = "System auto void due to zero billing" where refno='#form.refnotrue#' and type='INV'
                                          </cfquery>
                                          <cfquery datasource='#dts#' name="deleteictran">
                                              UPDATE ictran SET void = "Y" where refno='#form.refnotrue#' and type='INV'
                                          </cfquery>
