...
function leavecust()
{
 ...
 function dateajaxfunction(<cfif dts eq 'manpowertest_i'>newworkd</cfif>)
{
	getpanel(document.getElementById('placementno').value<cfif dts eq 'manpowertest_i'>,newworkd</cfif>);
}
				...
				<cfoutput>
					...
					<tr>
						...
						<td>
							...
							<cfif url.type eq "edit">
								onChange="if(this.value != '#paydate#'){alert('Please Remember to Calculate Pay On Change Pay Day Before Save');}"
							</cfif>
					...
					<tr>
                        ...
                        <th>Exclude Weekend: </th>
                          <td>
                              <input type="checkbox" name="cosworkday" id="cosworkday" value="N" onclick="if(this.value =='N'){dateajaxfunction('Y');this.value='Y';}else{dateajaxfunction('N');this.value='N';}">
                          </td>
                        </cfif>
					</tr>
