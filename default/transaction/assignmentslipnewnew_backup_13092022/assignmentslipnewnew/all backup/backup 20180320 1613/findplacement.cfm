...
<cfset dts1 = replace(dts,'_i','_p','All')>
	<cfquery name="getitemno" datasource="#dts#">
        ...
        where placementno not like '%test%'
        </cfif>		
