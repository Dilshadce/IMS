...
<!--- 			<cfif grosspay neq 0>
            ...
            <cfquery name="getpm" datasource="#dts#">
            SELECT * FROM manpowerpricematrixdetail WHERE priceid = "#getplacement.pm#" and itemid not in ('EPFYER','SOCSOYER','EISYER') ORDER BY Trancode
            </cfquery>
            <cfbreak>
			</cfif>
            </cfloop>
            ...
            SELECT * FROM manpowerpricematrixdetail WHERE priceid = "#getplacement.pm#"  and itemid = 'EISYER' ORDER BY Trancode
            </cfquery>
