    ...
    <cfif left(form.refno,1) neq "S">
     ...
     <cfif checkassign.trancodestart eq 0 and checkassign.trancodeend eq 0>
        ...
        UPDATE assignmentslip set trancodestart = "#getlatesttrancode.trancodeend+21#",trancodeend ="#getlatesttrancode.trancodeend+71#",orirefno = "#form.refno#" WHERE refno = "#assignmentslipno#"
        </cfquery>
         </cftransaction>
