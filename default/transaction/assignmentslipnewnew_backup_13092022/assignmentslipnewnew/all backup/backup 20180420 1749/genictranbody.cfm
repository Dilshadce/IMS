...
<cfif left(form.refno,1) neq 's'>
    ...
    <cfset xunit = "Unit">
     ...
     <cfif checkassign.trancodestart eq 0 and checkassign.trancodeend eq 0>
         ...
         <cfif getlatesttrancode.recordcount eq 0>
         	<cfset trancodestarttemp = 0>
         <cfelse>
         	<cfset trancodestarttemp = val(getlatesttrancode.trancodeend)+56>
            <br> trancodestarttemp = val(getlatesttrancode.trancodeend)+56
         </cfif>
     <cfelse>
    ...
    <cfset form.custno = getassignment.custno>
