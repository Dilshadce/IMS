...
SELECT paydate,empno,assignmentslipdate,placementno,payrollperiod FROM assignmentslip WHERE refno in (<cfqueryparam cfsqltype="cf_sql_varchar" value="#form.asnrefno#" list="yes" separator=",">)
</cfquery>
...
and placementno in ( <cfqueryparam cfsqltype="cf_sql_varchar" value="#valuelist(checkassignnew.placementno)#">)

</cfif>
and payrollperiod = <cfqueryparam cfsqltype="cf_sql_varchar" value="#checkassignnew.payrollperiod#">
and assignmentslipdate = "#checkassignnew.assignmentslipdate#"
</cfquery>
