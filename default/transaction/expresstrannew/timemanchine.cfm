...
SELECT uuid,trdatetime,type,driver,rem9 from ictrantemp where   type='#url.type#' <cfif lcase(hcomid) neq 'ssuni_i'>and onhold='Y'</cfif> group by uuid order by trdatetime desc limit 30 
</cfquery>
<cfoutput>
<table>
<tr>
