...
<cfqueryparam cfsqltype="cf_sql_varchar" value="#remark11#">,
'#val(form.deposit)#'
)
</cfquery>
...
<cfquery datasource="#dts#" name="getGeneralInfo">
    ...
    <cfform name="form1" id="form1" action="/default/transaction/ovasdone.cfm" method="post">
    <cfinput type="hidden" name="type" id="type" value="#type#">
    <cfinput type="hidden" name="refno" id="refno" value="#refno#">
    </cfform>
    <cfelse>
    <cfform name="form1" id="form1" action="/default/transaction/ovasexpressbill/" method="post">
    </cfform>
    </cfif>
