...
SELECT desp,despa,unit,unit2,unit3,unit4,unit5,unit6,price,ucost,costformula,"0" as isservi from icitem where itemno = <cfqueryparam cfsqltype="cf_sql_varchar" value="#trim(url.itemno)#">
</cfquery>
...
<cfif url.reftype eq 'PO' or url.reftype eq 'RC'>
