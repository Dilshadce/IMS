...
<cfoutput>
    ...
    <td><a onMouseOver="JavaScript:this.style.cursor='hand';" onClick="document.getElementById('delname').value =unescape('#URLENCODEDFORMAT(getaddress.name)#');document.getElementById('deladd1').value =unescape('#URLENCODEDFORMAT(getaddress.add1)#');document.getElementById('deladd2').value =unescape('#URLENCODEDFORMAT(getaddress.add2)#');document.getElementById('deladd3').value =unescape('#URLENCODEDFORMAT(getaddress.add3)#');document.getElementById('deladd4').value =unescape('#URLENCODEDFORMAT(getaddress.add4)#');document.getElementById('delattn').value =unescape('#URLENCODEDFORMAT(getaddress.attn)#');document.getElementById('deltel').value =unescape('#URLENCODEDFORMAT(getaddress.phone)#');document.getElementById('delfax').value =unescape('#URLENCODEDFORMAT(getaddress.fax)#');ColdFusion.Window.hide('changedaddr');"><u>SELECT</u></a></td>
    </tr>
    </cfloop>
