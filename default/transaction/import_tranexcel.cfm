...
<body>
<cfform action="import_tranexcel.cfm?type=#type#&refno=#URLENCODEDFORMAT(refno)#" method="post" enctype="multipart/form-data">
...
<cfdirectory action = "create" directory = "#currentDirectory#" >
	...
	<cftry>
		<CFFILE DESTINATION="C:\importtranbody\#dts#\" ACTION="UPLOAD" FILEFIELD="form.geticitem"  nameconflict="makeunique" accept="application/excel,application/vnd.openxmlformats-officedocument.spreadsheetml.sheet">
	<cfcatch type="any">
	...
	<cfset filename="C:/importtranbody/#dts#/"&file.serverfile>
	
		<cfinclude template = "import_tranexcel2.cfm">
        ...
        <cfset trancode=getictrantrancode.trancode+1>
            ...
            <cfif gettempitem.qty eq 0>
            <cfset gettempitem.qty = 1>
            </cfif>
            <cfset price_bil=gettempitem.price/gettempitem.qty>
            <cfset amt1_bil=gettempitem.price>
...
<cfset disamt_bil = 0>
            ...
            <cfset amt_bil=amt1_bil>
            <cfset taxamt_bil=gettempitem.dispec1>
            
            <cfif type eq 'OAI' or type eq 'OAR'>
            <cfset pricelocal= gettempitem.price*1>
            <cfset disamtlocal=disamt_bil*1>
            <cfset taxamtlocal=taxamt_bil*1>
            <cfset amt1local=amt1_bil*1>
            <cfset amtlocal=amt_bil*1>
            <cfelse>
          ...
          '1',
           '1',
            ...
            '',
              ...
              <cfqueryparam cfsqltype="cf_sql_varchar" value="#gettempitem.brem1#">,
              <cfqueryparam cfsqltype="cf_sql_varchar" value="#gettempitem.brem2#">,
              <cfqueryparam cfsqltype="cf_sql_varchar" value="#gettempitem.brem3#">,
              <cfqueryparam cfsqltype="cf_sql_varchar" value="#gettempitem.brem4#">,
              '', 
              '',
              '', 
              0.00000, 
...
<cfset disamt_bil = disamt_bil1 + disamt_bil2 + disamt_bil3>
	...
	(
       ...
       <!---  <cfcatch>
        <h3>Please Upload the correct file.</h3>
        </cfcatch>
        </cftry> --->
        </cfif>
</cfoutput>
