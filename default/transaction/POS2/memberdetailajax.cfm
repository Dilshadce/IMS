...
<tr>
<th>Member Name</th>
<td><input type="text" name="membername" id="membername" value="#getdriverdetail.name#" maxlength="35" size="40"/><a style="cursor:pointer" onClick="document.getElementById('checkmain').value='out';ColdFusion.Window.show('searchmember')">Search</a></td>
</tr>
<tr>
<th>Tel</th>
<td>
