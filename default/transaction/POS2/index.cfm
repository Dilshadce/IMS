...
<!--- 		if(nextflow != "")
	...
	if(answer)
	{
	var onholdurl = '/default/transaction/POS2/onholdajax.cfm?uuid='+document.getElementById("uuid").value;
	...
	if(answer)
	{
	var onholdurl = '/default/transaction/POS2/onholdajax.cfm?uuid='+document.getElementById("uuid").value+'&remark='+document.getElementById("rem9").value;
	ajaxFunction(document.getElementById('onholdajax'),onholdurl);
	...
	{
    var urlloaditemdetail = '/default/transaction/POS2/addItemAjax.cfm?itemno='+escape(encodeURI(detailitemno))+'&reftype='+document.getElementById('tran').value;
	...
	{
	  var urlloaditembal = '/default/transaction/POS2/balonhand.cfm?itemno='+encodeURI(itemnobal)+'&location='+escape(document.getElementById('locationfr').value);
	...
	{
	<cfoutput>
    var urlload = '/default/transaction/POS2/recalculateAjax.cfm?uuid=#URLEncodedFormat(uuid)#';
	</cfoutput>
	...
	{
	var ajaxurl = '/default/transaction/POS2/recalculateAjax.cfm?uuid=#URLEncodedFormat(uuid)#';
	new Ajax.Request(ajaxurl,
      {
        method:'get',
        onSuccess: function(getdetailback){
	...
	function getmember()
	{
	var memberurl = '/default/transaction/POS2/memberdetailajax.cfm?detail=1&member='+document.getElementById("driver").value;
	ajaxFunction(document.getElementById('getmemberajax'),memberurl);
	
	var memberurl2 = '/default/transaction/POS2/memberdeliverydetailajax.cfm?detail=1&member='+document.getElementById("driver").value;
	ajaxFunction(document.getElementById('getmemberdeliveryajax'),memberurl2);
	}
    </script>
...
<cfinput type="text" style="font: x-large bolder; color:##000; background-color:##FFFF66" name="grand" id="grand" value="0.00" readonly="yes" />
</td>
</tr>
<tr>
...
<cfinput type="text" name="refno" id="refno" required="yes" onKeyUp="nextIndex(event,'refno','wos_date');" value="#nexttranno#" readonly>&nbsp;&nbsp;&nbsp;&nbsp;<b>INVOICE</b></td>
</tr>
...
<cfselect name="driver" id="driver" query="geteuqry" display="eudesp" value="driverno" onChange="getmember();" />&nbsp;&nbsp;<a style="cursor:pointer" onClick="ColdFusion.Window.show('neweu')">New</a> <input type="hidden" name="driverhid" id="driverhid"> &nbsp;&nbsp;  <input type="hidden" name="driverhid" id="driverhid"></td>
<td colspan="2">
...
<tr>
<th>Member Name</th>
<td><input type="text" name="membername" id="membername" value="" maxlength="35" size="40"/><a style="cursor:pointer" onClick="document.getElementById('checkmain').value='out';ColdFusion.Window.show('searchmember')">Search</a></td>
</tr>
<tr>
<th>Tel</th>
<td>
<input type="text" name="membertel" id="membertel" value="" maxlength="35" size="40"></td>
</tr>
<tr>
<th>Address</th>
<td>
<input type="text" name="memberadd1" id="memberadd1" value="" maxlength="35" size="40"></td>
</tr>
<tr>
<th></th>
<td>
<input type="text" name="memberadd2" id="memberadd2" value="" maxlength="35" size="40"></td>
</tr>
<tr>
<th></th>
<td>
<input type="text" name="memberadd3" id="memberadd3" value="" maxlength="35" size="40"></td>
</tr>
</table>
</div>
</td>
<td colspan="2">
<div id="getmemberdeliveryajax">
<table align="center">
<tr>
<th>Delivery Tel</th>
<td>
<input type="text" name="Dmembertel" id="Dmembertel" value="" maxlength="35" size="40"></td>
</tr>
<tr>
<th>Delivery Address</th>
<td>
<input type="text" name="Dmemberadd1" id="Dmemberadd1" value="" maxlength="35" size="40"></td>
</tr>
<tr>
<th></th>
<td>
<input type="text" name="Dmemberadd2" id="Dmemberadd2" value="" maxlength="35" size="40"></td>
</tr>
<tr>
<th></th>
<td>
<input type="text" name="Dmemberadd3" id="Dmemberadd3" value="" maxlength="35" size="40"></td>
</tr>
</table>
</div>
</td>
...
<tr>
<th><cfselect name="nextransac" id="nextransac" query="newtranqy" display="trancode" value="trancode" />
&nbsp;Choose a product</th>
<td colspan="1">
...
<tr>
<a onClick="ctrl1();"><td align="center" valign="middle" style="font:'Times New Roman', Times, serif; font-size:16px;" bgcolor="##CCFF33" onMouseOver="this.style.cursor='hand'">On Hold<br><font size="1">ctrl+1</font></td></a>
...
<a onClick="ctrl7();"><td align="center" valign="middle" style="font:'Times New Roman', Times, serif; font-size:16px" bgcolor="##CCFF33" onMouseOver="this.style.cursor='hand'">On Hold Transactions<br><font size="1">ctrl+8</font></td></a>
</tr>
<tr>
<td colspan="3">
...
<cfwindow center="true" width="700" height="500" name="searchitem" refreshOnShow="true" closable="true" modal="false" title="Search Item" initshow="false"
        source="/default/transaction/POS2/searchitem2.cfm?reftype={tran}" />
<cfelse>
<cfwindow center="true" width="700" height="500" name="searchitem" refreshOnShow="true" closable="true" modal="false" title="Search Item" initshow="false"
        source="/default/transaction/POS2/searchitem.cfm?reftype={tran}" />
</cfif>
...
<!--- <cfwindow center="true" width="600" height="400" name="changedaddr" refreshOnShow="true" closable="true" modal="false" title="Search Address" initshow="false"
        source="/default/transaction/POS2/searchaddress.cfm" /> --->
