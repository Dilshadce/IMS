...
<th><input type="text" name="balance" id="balance" value="#numberformat(totalamount,'.__')#" size="20" readonly /></th>
</tr>
<tr>
<th><div align="left">Item Description</div></th>
<th><div align="left">Quantity</div></th>
...
<td><input type="text" name="amount" id="amount" value="0.00" size="20" readonly /></td>
</tr>
<tr>
<td colspan="100%"><div align="center"><cfif numberformat(totalamount,'.__') neq 0><input type="button" name="groupitem" id="groupitem" value="Insert Item" onClick="groupitemfunc();"><cfelse><input type="submit" name="sub_btn" id="sub_btn" value="Create Big Invoice" onClick="this.disabled=true;"></cfif></div></td>
</tr>
</table>
</cfoutput>
</cfif>
