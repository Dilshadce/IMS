...
<cfquery name="getprojectlist" datasource="#dts#">
SELECT "" as source,"Choose a project" as project
union all
...
<cfform name="finishedgoodsreport" action="finishedgoodreportpro.cfm" method="post">
<table width="65%" border="0" cellspacing="0" cellpadding="3" class="data" align="center">
	<tr>   
    <th>Sales Order From</th>
        <td><cfselect name="projectfrom" id="projectfrom" query="getprojectlist" value="source" display="project" ></cfselect>
		</td>
    </tr>
    <tr> 
        <th>Sales Order To</th>
        <td><cfselect name="projectto" id="projectto" query="getprojectlist" value="source" display="project" ></cfselect>
		</td>
    </tr>
