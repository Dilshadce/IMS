...
<cfif getGsetup.alloweditposted neq 'Y'>
	<cfif getartran.posted eq "P">
        ...
        <cfoutput>
        <br>
        <h4>To <span style="color: red">update</span> currency rate, click <a href="tran_edit2.cfm?tran=#tran#&ttype=Edit&refno=#URLEncodedFormat(refno)#&custno=#URLEncodedFormat(custno)#&first=0&currency=Y">here</a>.</h4>        
