...
<cfif text neq "">
<cfif lcase(HcomID) eq "kjcpl_i" or lcase(HcomID) eq "mlpl_i" or lcase(HcomID) eq "viva_i" or lcase(hcomid) eq "tlxil_i" or lcase(HcomID) eq "maven_i" or lcase(HcomID) eq "uniq_i" or lcase(HcomID) eq "unqhk_i" or lcase(HcomID) eq "bloom_i">
	<cfquery name="getitem" datasource="#dts#">
		...
		<cfif searchtype neq "" and text neq "">
            ...
            <cfelseif searchtype eq "barcode">
				and upper(barcode) like '#ucase(text)#%'
            <cfelseif searchtype eq "all">
				and (
                upper(barcode) like '#ucase(text)#%'
                or upper(itemno) like '%#ucase(text)#%'
                or upper(desp) like '%#ucase(text)#%' or upper(despa) LIKE '%#ucase(text)#%'
                or upper(category) like '%#ucase(text)#%'
                or upper(aitemno) like '#ucase(text)#%'
                or upper(wos_group) like '%#ucase(text)#%'
                or upper(brand) like '%#ucase(text)#%'
                or upper(sizeid) like '%#ucase(text)#%'
                or upper(colorid) like '%#ucase(text)#%'
                )
...
<cfelseif lcase(hcomid) eq "excelhw_i" or lcase(hcomid) eq "exceljb_i">
