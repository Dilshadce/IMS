...
<cfif getpin2.h2J01 eq "T"><a  style="cursor:pointer;" onClick="document.getElementById('hidtrancode').value='#getictrantemp.trancode#';ColdFusion.Window.show('changediscount');getfocus4();">#numberformat(val(getictrantemp.disamt_bil),'.__')#</a><cfelse>#numberformat(val(getictrantemp.disamt_bil),stDecl_UPrice)#</cfif>
