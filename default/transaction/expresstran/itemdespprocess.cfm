...
gltradac=<cfqueryparam cfsqltype="cf_sql_varchar" value="#form.glt6#"> where trancode=<cfqueryparam cfsqltype="cf_sql_varchar" value="#form.itemdesptrancodenew#">  and uuid=<cfqueryparam cfsqltype="cf_sql_varchar" value="#form.itemdespuuid#"> 
</cfquery>
