...
function selectmemberlist(custno){	
  ...
  for(var i=0;i<output.length;i++) {
	...
	function updaterow(rowno)
	{
		...
		var updateurl = 'updaterow.cfm?uuid='+escape(uuid)+'&coltype='+escape(coltypedata)+'&qty='+escape(qtylistdata)+'&trancode='+rowno+'&brem1='+escape(brem1data)+'&brem2='+escape(brem2data)+'&brem3='+escape(brem3data)+'&brem4='+escape(brem4data)+'&job='+escape(joblistdata)+'&promotiontype='+escape(promotiontypedata);
		new Ajax.Request(updateurl,
      {
        method:'get',
        onSuccess: function(getdetailback){
...
<cfform name="invoicesheet" id="invoicesheet" action="../IMS OLD/CRM/saleforecast/process2.cfm" method="post">
<cfoutput>
...
<cfquery name="getDefaultDate" datasource="#dts#">
	SELECT defaultTransactionDate
    FROM main.users
    WHERE userID = '#HuserID#';
</cfquery>
<td width="30%"><input type="text" name="wos_date" id="wos_date" value="#dateformat(getDefaultDate.defaultTransactionDate,'DD/MM/YYYY')#" onKeyUp="nextIndex(event,'wos_date','expressservicelist');" readonly /> <img src="/images/cal.gif" width=17 height=15 border=0 onClick="showCalendarControl(document.getElementById('wos_date'));"></td>
...
<tr>
    <th>Desp</th>
    <td>
   		<input type="text" name="desp" id="desp" value="" maxlength="40" width="40px;">
    </td>
</tr>
...
<tr>
    <th>Desp 2</th>
    <td>
   		<input type="text" name="despa" id="despa" value="" maxlength="40" width="40px;">
    </td>
</tr>
...
<th width="10%" >#getgsetup.brem1#</th>
<th width="10%" >#getgsetup.brem2#</th>
<th width="10%" >#getgsetup.brem3#</th>
<!---<th width="10%" >#getgsetup.brem4#</th>--->
...
<td>
	<input type="text" name="brem3list#getictrantemp.trancode#" id="brem3list#getictrantemp.trancode#" value="#getictrantemp.brem3#" />
</td>
<!---<td>
	<input type="text" name="brem4list#getictrantemp.trancode#" id="brem4list#getictrantemp.trancode#" value="#getictrantemp.brem4#" />
</td>--->
...
<cfelseif getdealermenu.itemformat eq '2'>
<cfwindow center="true" width="1100" height="500" name="searchitem" refreshOnShow="true" closable="true" modal="false" title="Search Item" initshow="false"
