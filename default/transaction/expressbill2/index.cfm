...
<cfset words_id_list = "1088,666,668,673,185,690,665,664,188,689,667,1070,1087,959,963,953,702,29,23,67,506,957,954,475,1286,1287,9,795,892,1288,793,440,1289,65,1290,51,300,58,120,65,227,1096,1097,1131,11,1082,65,127,1291,227,492,1096,592,1097,1116,1292,1293,202,1098,592,1294,1295,1099,1296,1297,1298,1104,960">
<cfinclude template="/latest/words.cfm">
<cfajaximport tags="cfform">
<cfsetting showdebugoutput="no">
<cfquery name="getgsetup" datasource="#dts#">
    SELECT filterall,ECAOTA,ECAMTOTA,negstk,PCBLTC,ddlbilltype,expressdisc,displaycostcode,ldriver,autonextdate,ddllocation ,rem5,rem6,rem11 
    FROM gsetup
</cfquery>
...
<head>
    ...
    <script type="text/javascript">
		...
		function gettitle() {
			var ajaxurl5 = '/default/transaction/expressbill2/locationajax.cfm?type='+document.getElementById('tran').value;
			ajaxFunction(document.getElementById('ajaxField5'),ajaxurl5);
			var ajaxurl6 = '/default/transaction/expressbill2/itemlocationajax.cfm?type='+document.getElementById('tran').value;
		...
		function getfocus4() {
			t1 = setTimeout("document.getElementById('custname2').focus();",750);
		}
		...
		function getitemdetail(detailitemno) {
			var urlloaditemdetail = '/default/transaction/expressbill2/addItemAjax.cfm?itemno='+escape(encodeURI(detailitemno))+'&custno='+document.getElementById('custno').value+'&reftype='+document.getElementById('tran').value;
		...
		function getlocationbal(itemnobal) {
			var urlloaditembal = '/default/transaction/expressbill2/balonhand.cfm?itemno='+encodeURI(itemnobal)+'&location='+escape(document.getElementById('locationfr').value);
		...
		function recalculateall() {
			<cfoutput>
			var urlload = '/default/transaction/expressbill2/recalculateAjax.cfm?uuid=#URLEncodedFormat(uuid)#';
			</cfoutput>
		...
		function recalculateamt() {
			var ajaxurl = '/default/transaction/expressbill2/recalculateAjax.cfm?uuid=#URLEncodedFormat(uuid)#';
			ajaxFunction(document.getElementById('ajaxFieldPro'),ajaxurl);
			setTimeout('calculatefooter();',750);
		}
		function expand() {
...
<cfform name="invoicesheet" id="invoicesheet" action="process.cfm" method="post">
    <div id="CollapsiblePanel1" class="CollapsiblePanel">
        ...
        <div class="CollapsiblePanelContent">
            ...
            <table width="100%" >
                <tr>
                    <th width="10%">#words[1088]#</th>
                    <td width="20%">
                    <select name="tran" id="tran" onKeyUp="nextIndex('tran','refno');" onChange="gettitle()">
                        <cfif getpin2.h2401 eq "T"><option value="INV" <cfif getgsetup.ddlbilltype eq "INV">selected</cfif>>#words[666]#</option></cfif>
                        <cfif getpin2.h2871 eq "T"><option value="QUO" <cfif getgsetup.ddlbilltype eq "QUO">selected</cfif>>#words[668]#</option></cfif>
                        <cfif getpin2.h2881 eq "T"><option value="SO" <cfif getgsetup.ddlbilltype eq "SO">selected</cfif>>#words[673]#</option></cfif>
                        <cfif getpin2.h2501 eq "T"><option value="CS" <cfif getgsetup.ddlbilltype eq "CS">selected</cfif>>#words[185]#</option></cfif>
                        <cfif getpin2.h2861 eq "T"><option value="PO" <cfif getgsetup.ddlbilltype eq "PO">selected</cfif>>#words[690]#</option></cfif>
                        <cfif getpin2.h2301 eq "T"><option value="DO" <cfif getgsetup.ddlbilltype eq "DO">selected</cfif>>#words[665]#</option></cfif>
                        <cfif getpin2.h2102 eq "T"><option value="RC" <cfif getgsetup.ddlbilltype eq "RC">selected</cfif>>#words[664]#</option></cfif>
                        <cfif getpin2.h2201 eq "T"><option value="PR" <cfif getgsetup.ddlbilltype eq "PR">selected</cfif>>#words[188]#</option></cfif>
                        <cfif getpin2.h2601 eq "T"><option value="CN" <cfif getgsetup.ddlbilltype eq "CN">selected</cfif>>#words[689]#</option></cfif>
                        <cfif getpin2.h2701 eq "T"><option value="DN" <cfif getgsetup.ddlbilltype eq "DN">selected</cfif>>#words[667]#</option></cfif>
                        <cfif getpin2.h28A0 eq "T"><option value="TR" <cfif getgsetup.ddlbilltype eq "TR">selected</cfif>>#words[1070]#</option></cfif>
                    </select>
                    <cfselect name="refnoset" id="refnoset" bind="cfc:refnobill.getrefnoset({tran},'#dts#')" bindonload="yes" display="lastno" value="counter" />
                    </td>
                    <td width="5%"></td>
                    <th width="10%">#words[1087]#</th>
                    <td width="20%">
                    <cfif hcomid eq "hairo_i">
                        <cfinput type="text" name="refno" id="refno" bind="cfc:refnobill.getrefno({tran},'#dts#',{refnoset})" bindonload="yes" required="yes" onKeyUp="nextIndex('refno','custno');" readonly>
                    <cfelse>
                ...
                <tr>
                    ...
                    <td colspan="2">
                    <cfif getGsetup.filterall eq "1">
                        <cfinput name="custno" id="custno" type="text" value=""  size="20" maxlength="8" onKeyUp="nextIndex('custno','wos_date');" onBlur="updateDetails(this.value);" required="yes" message="Customer/Supplier is Required">
                        <cfif getdealermenu.custformat eq '2'>
                            <input type="button" name="Scust1" value="#words[953]#" onClick="javascript:ColdFusion.Window.show('findCustomer');getfocus4();" >
                        <cfelse>
                            <input type="button" name="Scust1" value="#words[953]#" onClick="javascript:ColdFusion.Window.show('findCustomer');getfocus();" >
                        </cfif>
                    <cfelse>
                        <cfselect name="custno" id="custno" bind="cfc:custsupp.getlist({tran},'#target_arcust#','#target_apvend#','#dts#')" bindonload="yes" required="yes" display="custname" value="custno" onChange="updateDetails(this.value);" onKeyUp="nextIndex('custno','wos_date');" message="Customer/Supplier is Required" />
                    </cfif>
                    </td>
                    <th>#words[702]#</th>
                    <cfset datenow=now()>
                    ...
                    <td>
                    <cfif hcomid eq "hairo_i">
                        <input type="text" name="wos_date" id="wos_date" value="#dateformat(datenow,'DD/MM/YYYY')#" onKeyUp="nextIndex('wos_date','searchitembtn');" />
                    <cfelse>
                        <input type="text" name="wos_date" id="wos_date" value="#dateformat(datenow,'DD/MM/YYYY')#" onKeyUp="nextIndex('wos_date','expressservicelist');" />
                    </cfif>
                    <img src="/images/cal.gif" width=17 height=15 border=0 onClick="showCalendarControl(wos_date);">&nbsp;(DD/MM/YYYY)
                    </td>
                    <td></td>
                    <th>
                    <cfif hcomid eq "ulp_i">
                    <cfelse>
                        #words[29]#
                    </cfif>
                    </th>
                    ...
                    <cfif hcomid eq "ulp_i">
                        <div style="visibility:hidden">
                            <cfselect name="agent" id="agent" bind="cfc:custsupp.getagent('#dts#','#Hlinkams#')" bindonload="yes" display="agentdesp" value="agent" />
                ...
                <tr>
                    ...
                    <td>
                    <cfinput type="text" name="b_name" id="b_name" size="40" maxlength="35" /></td>
                    <td></td>
                    <th>
                    #words[23]#
                    &nbsp;&nbsp;
                    ...
                    <th>#words[67]#</th>
                    <td>
                    <cfselect name="term" id="term" bind="cfc:custsupp.getterms('#dts#','#target_icterm#')" bindonload="yes" display="termdesp" value="term" />
                    <input type="hidden" name="termhid" id="termhid" value="">
                    </td>
                </tr>
                <tr>
                    <td>
                    <input type="text" name="bcode" id="bcode" value="Profile" <cfif getgsetup.ECAOTA eq "N" and (HUserGrpID neq "admin" and HUserGrpID neq "super")>readonly</cfif> />
                    </td>
                    <td><cfinput type="text" name="b_name2" id="b_name2" size="40" maxlength="35" /></td>
                    <td></td>
                    <td>
                    <input type="text" name="DCode" id="DCode" value="Profile" <cfif getgsetup.ECAOTA eq "N" and (HUserGrpID neq "admin" and HUserGrpID neq "super")>readonly</cfif> />
                    </td>
                ...
                <tr>
                    <th>#words[957]#</th>
                    <td> <cfinput type="text" name="b_add1" id="b_add1" size="40" maxlength="35" /></td>
                    <td></td>
                    <th>#words[954]#</th>
                    <td><cfinput type="text" name="d_add1" id="d_add1" size="40" maxlength="35" /></td>
                    <td>&nbsp;</td>
                    <th>#words[475]#</th>
                    <td>
                ...
                <tr>
                    <td>
                    <cfquery name="getlastran" datasource="#dts#">
                        SELECT type,refno 
                        FROM artran 
                        WHERE created_by = <cfqueryparam cfsqltype="cf_sql_varchar" value="#huserid#"> 
                    ...
                    <td></td>
                    <td><cfinput type="button" name="changedaddr" id="changedaddr" onClick="ColdFusion.Window.show('changedaddr');" value="#words[1287]#">
                    </td>
                    ...
                    <cfif hcomid eq "ulp_i">
                        <div style="visibility:hidden">
                            <cfselect name="driver" id="driver" bind="cfc:custsupp.geteu('#dts#')" bindonload="yes" display="eudesp" value="driverno" />
                            <input type="hidden" name="driverhid" id="driverhid" value="">
                        </div>
                    <cfelse>
                        <cfselect name="driver" id="driver" bind="cfc:custsupp.geteu('#dts#')" bindonload="yes" display="eudesp" value="driverno" />
                        <input type="hidden" name="driverhid" id="driverhid" value="">
                ...
                <tr>
                    ...
                    <cfelse>
                        <cfinput type="text" name="currcode" id="currcode" size="10"  />
                        <input type="hidden" name="currcodehid" id="currcodehid" value="">&nbsp;
                        <cfinput type="text" name="currrate" id="currrate" bind="cfc:custsupp.getcurrrate('#dts#',{currcode},'#target_currency#')" bindonload="yes" size="5" />
                    </cfif>
                    </td>
                </tr>
                <tr>
                    ...
                    <td>
                    <cfif hcomid eq "ulp_i">
                        <cfinput type="hidden" name="PONO" id="PONO" size="30" />
                    <cfelse>
                        <cfinput type="text" name="PONO" id="PONO" size="30" />
                    </cfif>
                    </td>
                </tr>
                <tr>
                    ...
                    <td>
                    <cfif hcomid eq "ulp_i">
                        <cfinput type="hidden" name="DONO" id="DONO" size="30" />
                    <cfelse>
                        <cfinput type="text" name="DONO" id="DONO" size="30" />
                    </cfif>
                    </td>
                </tr>
                <tr>
                    ...
                    <td>
                    <cfif hcomid eq "ulp_i">
                        <cfinput type="hidden" name="desp" id="desp" size="40" maxlength="40" />
                    <cfelse>
                        <cfinput type="text" name="desp" id="desp" size="40" maxlength="40" />
                    </cfif>
                    </td>
                </tr>
                <tr>
                    ...
                    <td>&nbsp;</td>
                    <td rowspan="2">
                    <a href="##" id="timemachine" onClick="ColdFusion.Window.show('timemanchine');">
                    <img src="/images/appointment.png" height="32" width="32" border="0" alt="Time Manchines" />
                    </a>
                    </td>
                    <td>
                    <cfif hcomid eq "ulp_i">
                        <cfinput type="hidden" name="despa" id="despa" size="40" maxlength="40" />
                    <cfelse>
                        <cfinput type="text" name="despa" id="despa" size="40" maxlength="40" />
                    </cfif>
                    </td>
                </tr>
                <tr>
                    <th>#words[300]#</th>
                    <td>
                    <cfinput type="text" name="b_fax" id="b_fax" size="40" maxlength="35" />
                    ...
                    <div id="ajaxField5" name="ajaxField5"></div>
                    </th>
                    <td></td>
                </tr>
                <cfif lcase(hcomid) eq "kjcpl_i" or lcase(hcomid) eq "kjctrial_i" or lcase(hcomid) eq "mlpl_i" or lcase(hcomid) eq "viva_i">
                    ...
                    <tr>
                        ...
                        <td><input type="text" name="rem5" id="rem5" value="" size="40" maxlength="35"></td>
                        <td></td>
                        <th>#getgsetup.rem6#</th>
                        <td><input type="text" name="rem6" id="rem6" value="" size="40" maxlength="35"></td>
                        <td></td>
                        <th>#getgsetup.rem11#</th>
                        <td><textarea name="rem11" id="rem11" cols='40' rows='3' onKeyDown="limitText(this.form.rem11,200);" onKeyUp="limitText(this.form.rem11,200);"></textarea></td>
                    </tr>
                </cfif>
            </table>
        </div>
        ...
        <div class="CollapsiblePanelContent">
            <table width="100%" border="0">
                <tr onClick="setTimeout('recalculateamt();',750)">
                    ...
                    <cfgrid name="itemlist" pagesize="7" format="html" width="950" height="1000"
                    bind="cfc:itemlist.getictran({cfgridpage},{cfgridpagesize},{cfgridsortcolumn},{cfgridsortdirection},'#dts#','#uuid#',{pagesize})"
                    onchange="cfc:itemlist.editictran({cfgridaction},{cfgridrow},{cfgridchanged},'#dts#','#HUserID#')" 
                    selectmode="edit" textcolor="##000000" delete="yes" deletebutton="Delete" selectonload="false">
                        <cfgridcolumn name="trancode" header="#words[58]#" dataalign="center" select="no" width="30">
                        <cfgridcolumn name="itemno" header="#words[120]#" dataalign="left" select="no" width="100">
                        <cfgridcolumn name="desp" header="#words[65]#" dataalign="left" select="no" width="300">
                        <cfgridcolumn name="qty_bil" header="#words[227]#" dataalign="center" select="no" width="100">
                        <cfgridcolumn name="price_bil" header="#words[1096]#" dataalign="right" select="no" width="150" display="#datashow#">
                        <cfgridcolumn name="amt_bil" header="#words[1097]#" dataalign="right" select="no" width="150" display="#datashow#">
                        <cfgridcolumn name="uuid" header="uuid" dataalign="right" display="no">       
                    </cfgrid>
                    </td>
                </tr>
                <tr>
                    <th width="10%">#words[1131]#</th>
                    <td width="23%" nowrap>
                    <cfif hcomid eq "hairo_i">
                        <cfinput type="text" name="expressservicelist" id="expressservicelist" size="26" onBlur="this.value = this.value.split('___', 1);getitemdetail(this.value);" onKeyUp="nextIndex('expressservicelist','desp2');" autosuggest="cfc:itemno.findItem({cfautosuggestvalue},'#dts#')" autosuggestminlength="1" autosuggestBindDelay="1" readonly/>
                    <cfelseif lcase(hcomid) eq "kjcpl_i" or lcase(hcomid) eq "kjctrial_i" or lcase(hcomid) eq "mlpl_i" or lcase(hcomid) eq "viva_i">
                        <cfinput type="text" name="expressservicelist" id="expressservicelist" size="26" onBlur="this.value = this.value.split('___', 1);getitemdetail(this.value);" onKeyUp="nextIndex('expressservicelist','desp2');" autosuggest="cfc:itemno.findItem({cfautosuggestvalue},'#dts#','#hcomid#','#Huserloc#')" autosuggestminlength="1"/>
                    <cfelse>
                        <cfinput type="text" name="expressservicelist" id="expressservicelist" size="26" onBlur="this.value = this.value.split('___', 1);getitemdetail(this.value);" onKeyUp="nextIndex('expressservicelist','desp2');" autosuggest="cfc:itemno.findItem({cfautosuggestvalue},'#dts#')" autosuggestminlength="1"/>
                    </cfif>
                    <cfif getdealermenu.itemformat eq '2'>
                        <input type="button" id="searchitembtn" onClick="ColdFusion.Window.show('searchitem');getfocus3();" value="#words[11]#" align="right" />
                    <cfelse>
                    ...
                    <cfif getpin2.h1310 eq 'T'>
                        <a onMouseOver="JavaScript:this.style.cursor='hand';" onClick="window.open('/default/maintenance/icitem2.cfm?type=Create&express=1');">CNI</a>
                    </cfif>
                    <cfif lcase(hcomid) eq "kjcpl_i" or lcase(hcomid) eq "kjctrial_i" or lcase(hcomid) eq "mlpl_i" or lcase(hcomid) eq "viva_i">
                        <input type="button" value="Location balance" onClick="ColdFusion.Window.show('itembalance');">
                    </cfif>
                    <br>
                    <div id="itemlocationajax">
                        <select name="locationfr" id="locationfr" onChange="ajaxFunction(window.document.getElementById('itembal'),'/default/transaction/expressbill2/balonhand.cfm?itemno='+encodeURI(document.getElementById('expressservicelist').value)+'&location='+escape(this.value));getitemdetail(this.value);">
                    ...
                    <td width="1%">&nbsp;</td>
                    <th width="10%">#words[65]#</th>
                    <td width="20%">
                    <input type="text" name="desp2" id="desp2" size="40" onKeyUp="nextIndex('desp','<cfif lcase(hcomid) eq "hairo_i">expqty<cfelse>expcomment</cfif>');" >
                    </td>
                    <td width="1%">&nbsp;</td>
                    <th width="10%">#words[127]#</th>
                    <td rowspan="2" width="20%">
                    <textarea name="expcomment" id="expcomment" cols="40" rows="3" onKeyUp="nextIndex('expcomment','expqty');" >
                    </textarea>
                    </td>
                </tr>
                <tr>
                    ...
                    <td>&nbsp;</td>
                    <td><input type="button" name="SearchComment" value="#words[1291]#" onClick="javascript:ColdFusion.Window.show('findComment');"></td>
                </tr>
                <tr>
                    <th>#words[227]#</th>
                    <td>
                    <cfif hcomid eq "hairo_i">
                        <input type="text" style="font: large bolder" name="expqty" id="expqty" size="10" maxlength="10" value="" onKeyUp="calamtadvance();nextIndex('expqty','<cfif getpin2.h1360 eq 'T'>expprice<cfelse>btn_add</cfif>');<cfif getgsetup.expressdisc neq "1">document.getElementById('expqtycount').value = this.value;</cfif>" >
                    <cfelse>
                        <input type="text" style="font: large bolder" name="expqty" id="expqty" size="10" maxlength="10" value="1" onKeyUp="calamtadvance();nextIndex('expqty','<cfif getpin2.h1360 eq 'T'>expunit<cfelse>btn_add</cfif>');<cfif getgsetup.expressdisc neq "1">document.getElementById('expqtycount').value = this.value;</cfif>" >
                    </cfif>
                    </td>
                    <td>&nbsp;</td>
                    <th>#words[492]#</th>
                    <td>
                    <cfselect name="expunit" id="expunit"  onKeyUp="nextIndex('expunit','expprice');" onChange="ajaxFunction(document.getElementById('ajaxfieldgetunitprice'),'/default/transaction/expressbill2/getunitpriceAjax.cfm?itemno='+document.getElementById('expressservicelist').value+'&unit='+document.getElementById('expunit').value);setunitprice();"></cfselect>
                    </td>
                    <td><div id="ajaxfieldgetunitprice"></div>&nbsp;</td>
                    <th>#words[1096]#</th>
                    <td><input type="<cfif getpin2.h1360 eq 'T'>text<cfelse>hidden</cfif>" name="expprice" id="expprice" size="15" maxlength="15" value="0.00" onKeyUp="calamtadvance();nextIndex('expprice',<cfif hcomid eq "hairo_i">'btn_add'<cfelse><cfif getgsetup.expressdisc eq "1">'expunitdis1'<cfelse>'expqtycount'</cfif></cfif>)"></td>
                </tr>
                <tr>
                    <th>#words[592]#</th>
                    <td>
                    <cfif getgsetup.expressdisc eq "1">
                        <input <cfif hcomid eq "hairo_i">style="visibility:hidden"</cfif> type="<cfif getpin2.h1360 eq 'T'>text<cfelse>hidden</cfif>" name="expunitdis1" id="expunitdis1" size="5" value="0" onKeyUp="caldisamt();calamtadvance();nextIndex('expunitdis1','expunitdis2')"  >
                    %&nbsp;&nbsp;
                        <input <cfif hcomid eq "hairo_i">style="visibility:hidden"</cfif> type="<cfif getpin2.h1360 eq 'T' >text<cfelse>hidden</cfif>" name="expunitdis2" id="expunitdis2" size="5" value="0" onKeyUp="caldisamt();calamtadvance();nextIndex('expunitdis2','expunitdis3')" />
                    %&nbsp;&nbsp;
                        <input <cfif hcomid eq "hairo_i">style="visibility:hidden"</cfif> type="<cfif getpin2.h1360 eq 'T'>text<cfelse>hidden</cfif>" name="expunitdis3" id="expunitdis3" size="5" value="0" onKeyUp="caldisamt();calamtadvance();nextIndex('expunitdis3','expdis')" />%
                        <br>
                    <cfelse>
                        ...
                        <input <cfif hcomid eq "hairo_i">style="visibility:hidden"</cfif> type="<cfif getpin2.h1360 eq 'T'>text<cfelse>hidden</cfif>" name="expqtycount" id="expqtycount" size="3" value="1" onKeyUp="caldisamt();calamtadvance();nextIndex('expqtycount','expunitdis')" >
                        &nbsp;&nbsp;
                        <input <cfif hcomid eq "hairo_i">style="visibility:hidden"</cfif> type="<cfif getpin2.h1360 eq 'T'>text<cfelse>hidden</cfif>" name="expunitdis" id="expunitdis" size="5" value="0.00" onKeyUp="caldisamt();calamtadvance();nextIndex('expdis','btn_add')" />
                        &nbsp;&nbsp;
                    </cfif>
                    <input <cfif hcomid eq "hairo_i">style="visibility:hidden"</cfif> type="<cfif getpin2.h1360 eq 'T'>text<cfelse>hidden</cfif>" name="expdis" id="expdis" size="10" maxlength="10" value="0.00" onKeyUp="calamtadvance();nextIndex('expdis','btn_add')" onBlur="calamtadvance();"></td>
                    <td>&nbsp;</td>
                    <th>#words[1097]#</th>
                    <td>
                    <input type="<cfif getpin2.h1360 eq 'T'>text<cfelse>hidden</cfif>" style="font: large bolder" name="expressamt" id="expressamt" size="10" value="0.00" readonly >
                    &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                    <input name="btn_add" style="font: medium bolder" id="btn_add" type="button" value="#words[1116]#" onClick="addnewitem2();">
                    </td>
                    <td>&nbsp;</td>
                    <th><!--- Activate Barcode Scan --->#words[1292]#</th>
                    <td>
                ...
                <tr>
                    ...
                    <td>
                    <cfselect name="taxcode" id="taxcode" bind="CFC:tax.getTaxQry('#dts#','#target_taxtable#',{tran})" value="code" display="code" onChange="setTimeout('caltax()',500);" bindonload="yes"/>
                    &nbsp;&nbsp;
                ...
                <cfif lcase(hcomid) eq "kjcpl_i" or lcase(hcomid) eq "kjctrial_i" or lcase(hcomid) eq "mlpl_i" or lcase(hcomid) eq "viva_i">
                    ...
                    <th>#words[1297]#</th>
                    <td>
                    <cfinput name="cash" type="hidden" value="0.00" maxlength="15">
                    <input type="checkbox" name="checkcash" onClick="copygrandtocash();">
                    </td>
                    <td></td>
                    <th>#words[1298]#</th>
                    <td>
                    <cfinput name="cheque" type="hidden" value="0.00" maxlength="15">
                ...
                <tr>
                    ...
                    <td>&nbsp;</td>
                    <td>&nbsp;</td>
                    <th><cfinput type="button" style="font: medium bolder" name="Submit" id="Submit" value="#words[1104]#" onClick="validformfield();" disabled/></th>
                    <td><cfinput type="button" style="font: medium bolder" name="Close" id="Close" value="#words[960]#" onClick="window.close();"/></td>
                    <td>&nbsp;</td>
                    <th>&nbsp;</th>
                    <td>&nbsp;</td>
                </tr>
...
<cfif getdealermenu.custformat eq '2'>
    <cfwindow center="true" width="550" height="400" name="findCustomer" refreshOnShow="true"
        ...
        source="/default/transaction/expressbill2/findCustomer2.cfm?type={tran}&custno={custno}" />
<cfelse>
    <cfwindow center="true" width="550" height="400" name="findCustomer" refreshOnShow="true"
        title="Find Customer or Supplier" initshow="false"
        source="/default/transaction/expressbill2/findCustomer.cfm?type={tran}&custno={custno}" />
</cfif>
<cfif getdealermenu.itemformat eq '2'>
    <cfwindow center="true" width="700" height="500" name="searchitem" refreshOnShow="true" closable="true" modal="false" 
        ...
        source="/default/transaction/expressbill2/searchitem2.cfm?reftype={tran}" />
<cfelse>
    <cfwindow center="true" width="700" height="500" name="searchitem" refreshOnShow="true" closable="true" modal="false" 
        title="Search Item" initshow="false"
        source="/default/transaction/expressbill2/searchitem.cfm?reftype={tran}" />
</cfif>
<cfwindow center="true" width="600" height="400" name="changedaddr" refreshOnShow="true" closable="true" modal="false" 
	title="Search Address" initshow="false"
    source="/default/transaction/expressbill2/searchaddress.cfm" />
...
<cfwindow center="true" width="300" height="300" name="timemanchine" refreshOnShow="true" closable="true" modal="true" 
	title="Revert Back To Previous Entry" initshow="false"
...
<cfwindow center="true" width="700" height="500" name="findComment" refreshOnShow="true"
    ...
    source="/default/transaction/expressbill2/findComment.cfm" />
<cfwindow center="true" width="700" height="500" name="itembalance" refreshOnShow="true" closable="true" modal="false" 
	title="Location Qty Balance" initshow="false"
