...
<cfquery datasource="#dts#" name="getGeneralInfo">
    ...
    <cfform name="form1" id="form1" action="/default/transaction/done2.cfm" method="post">
    <cfinput type="hidden" name="type" id="type" value="#type#">
    <cfinput type="hidden" name="refno" id="refno" value="#refno#">
    </cfform>
    <cfelse>
    <cfform name="form1" id="form1" action="/default/transaction/expressbill2/" method="post">
    </cfform>
    </cfif>
