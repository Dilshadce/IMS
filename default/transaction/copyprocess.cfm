    ...
    <cffunction name="updateIgrade" output="false">
        ...
        <cfquery name="insertigrade" datasource="#dts#">
            ...
            <cfif form.ft_type neq "TR">
				<cfif form.ft_type eq "RC" or form.ft_type eq "PO" or form.ft_type eq "RQ" or form.ft_type eq "CN" or form.ft_type eq "OAI">'1'<cfelse>'-1'</cfif>
			<cfelse>
        ...
        <cfif form.ft_type neq "SO" and form.ft_type neq "PO" and form.ft_type neq "RQ" and form.ft_type neq "QUO" and form.ft_type neq "SAM">
			<cfif form.ft_type neq "TR">
	...
	<cfif getartran.recordcount gt 0>
		...
		<cfelse><!--- More than 1 cust --->
			<cfquery name="get_cust" datasource="#dts#">
				...
				<cfif ft_type eq "RC" or ft_type eq "PO" or ft_type eq "RQ" or ft_type eq "PR">#target_apvend#<cfelse>#target_arcust#</cfif>
