	...
	<cfif #exactResult.recordCount# neq 0>
	  <table align="center" class="data" width="700px">
	    <tr>
		  ...
		  <th>Description</th>
		  <cfif lcase(hcomid) neq "jithinheng_i">
			  <cfif getdisplaydetail.itemsearch_cate eq 'Y'>
                <th>Brand</th>
              </cfif>
              <cfif getdisplaydetail.itemsearch_cate eq 'Y'>
              <th>Category</th>
          ...
          <cfif getdisplaydetail.itemsearch_group eq 'Y'>
		  <th>Group</th>
          </cfif>
		...
		<cfoutput query="exactResult">
		  <tr>
		    ...
		    <td  nowrap>#exactResult.desp#<br>#exactResult.despa#</td>
            <cfif lcase(hcomid) neq "jithinheng_i">
            	<cfif getdisplaydetail.itemsearch_cate eq 'Y'>
	  ...
	  <table align="center" class="data" width="700px">
		...
		<cfoutput query="similarResult">
          ...
          <td>#similarResult.aitemno#</td>
		    ...
		    <td  nowrap>#similarResult.desp#<br>#similarResult.despa#</td>
            <cfif lcase(hcomid) neq "jithinheng_i">
            	<cfif getdisplaydetail.itemsearch_cate eq 'Y'>
	  ...
	  <table align="center" class="data" width="700px">
		...
		<cfoutput query="type1" maxrows="20">
		  <tr>
		    ...
		    <td nowrap>#type1.desp#<br>#type1.despa#</td>
            <cfif lcase(hcomid) neq "jithinheng_i">
            	<cfif getdisplaydetail.itemsearch_cate eq 'Y'>
                	<td>#type1.brand#</td>
                </cfif>
