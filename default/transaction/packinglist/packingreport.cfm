...
<cfset words_id_list = "1229,1224,1225,1226,1227,1228,1229,1230,1435,501,1260,1257,1258,352">
...
<cfform action="packingreport2.cfm" name="form" method="post" target="_blank">
    <table border="0" align="center" width="90%" class="data">
        <tr>
            <td nowrap>
            <input type="radio" name="result" value="PDF" checked>#words[1435]#<br/>
            <input type="radio" name="result" value="HTML">#words[501]#<br/>
            </td>
        </tr>
        <tr> 
