...
location=<cfqueryparam cfsqltype="cf_sql_varchar" value="#source#">,
...
<cfquery name="createprojectlocation" datasource="#dts#">
	insert ignore into iclocation (location,desp) values (<cfqueryparam cfsqltype="cf_sql_varchar" value="#source#">,<cfqueryparam cfsqltype="cf_sql_varchar" value="#source#">)
</cfquery>
...
<cflocation url="/default/transaction/expresshaikhimdone.cfm?type=#type#&refno=#refno#" addtoken="no">
