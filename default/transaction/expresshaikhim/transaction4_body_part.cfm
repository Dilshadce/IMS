...
<table align='center' class='data' width='85%' cellspacing="0">
    ...
    <tr>
        ...
        <td colspan='2'>
            ...
            <cfif lcase(hcomid) neq "mastercare_i" and lcase(hcomid) neq "gorgeous_i">
                ...
                <br />
                <input type="button" name="searchmaterial" value="Search Material" onClick="javascript:ColdFusion.Window.show('findmats');">
            </cfif>
			</cfif>
			<br>
            <cfif lcase(hcomid) neq "mastercare_i" and lcase(hcomid) neq "gorgeous_i">
    ...
    <tr>
        <th nowrap <cfif getdisplaysetup2.body_serialno neq "Y">style="visibility:hidden"</cfif>><cfif lcase(hcomid) eq "bnbm_i" or lcase(hcomid) eq "bnbp_i"><cfif tran eq 'RQ'>#getgeneralinfo.brem1#</cfif><cfelse>#getgeneralinfo.brem1#</cfif></th>
        ...
        <cfquery datasource="#dts#" name="getcategory">
    ...
    <th <cfif getdisplaysetup2.body_note1 neq "Y">style="visibility:hidden"</cfif>>Why Free?</th>
    <td <cfif getdisplaysetup2.body_note1 neq "Y">style="visibility:hidden"</cfif>><input type='text' name='note1' id="note1" maxlength='40' value='#convertquote(note1)#' size='20'></td>
    ...
    <tr><th>Price</th><td><input type='text' name='displayprice1' id="displayprice1" value="#numberformat(getallprice.price,',_.__')#" readonly></td></tr>
    <tr><th>Price 2</th><td><input type='text' name='displayprice2' id="displayprice2" value="#numberformat(getallprice.price2,',_.__')#" readonly></td></tr>
	<tr><th>Price 3</th><td><input type='text' name='displayprice3' id="displayprice3" value="#numberformat(getallprice.price3,',_.__')#" readonly></td></tr>
	<tr><th>Price 4</th><td><input type='text' name='displayprice4' id="displayprice4" value="#numberformat(getallprice.price4,',_.__')#" readonly></td></tr>
 ...
 <cfif getmodule.job eq "1">
	...
	<tr>
        ...
        <td colspan="3" <cfif getdisplaysetup2.body_titledesp neq "Y">style="visibility:hidden"</cfif>>
			<cfif lcase(hcomid) eq "topsteel_i" or lcase(HcomID) eq "topsteelhol_i" or lcase(hcomid) eq "kingston_i" or lcase(hcomid) eq "cstct_i" or lcase(hcomid) eq "vsolutionspteltd_i" or lcase(hcomid) eq "ascend_i" or lcase(hcomid) eq "vsyspteltd_i">
