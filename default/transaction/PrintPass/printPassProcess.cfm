...
and (userGrpId in (<cfqueryparam cfsqltype="cf_sql_varchar" list="yes" separator="," value="#getgeneralsetup.printapprovelevel1#">) or userGrpId = 'admin' or userGrpId = 'super')
<cfelseif getbillstatus.printstatus eq "a2">
and (userGrpId in (<cfqueryparam cfsqltype="cf_sql_varchar" list="yes" separator="," value="#getgeneralsetup.printapprovelevel2#">) or userGrpId = 'admin' or userGrpId = 'super')
</cfif>
...
select useremail from users where userDept = "#dts#" and userGrpId in (<cfqueryparam cfsqltype="cf_sql_varchar" list="yes" separator="," value="#getgeneralsetup.printapprovelevel2#">) and useremail <> ""
</cfquery>
<cfset email1=''>
...
Company Name: #getgeneralsetup.compro#
...
<cfif getgeneralsetup.printapproveamt neq 0 and getbillstatus.grand lte getgeneralsetup.printapproveamt>
...
<!---<cfelse>
<h4>Email has already been send to general</h4>
</cfif>--->
<cfelse>
...
<!---<cfif checkadmin.userGrpId eq 'admin' or checkadmin.userGrpId eq 'super'>--->
<cfquery name="updatestatus" datasource="#dts#">
update artran set printstatus='a3' where type='#url.type#'and refno='#url.refno#'
</cfquery>

<cfquery name="getbillstatus" datasource="#dts#">
select created_by from artran where type='#url.type#' and refno='#url.refno#'
</cfquery>

<cfquery name="getlimitedmail" datasource="main">
select useremail from users where userDept = "#dts#" and userGrpId="luser" and useremail <> "" and userid = <cfqueryparam cfsqltype="cf_sql_varchar" value="#getbillstatus.created_by#">
</cfquery>
<cfset email1=''>
...
<!---<cfelse>
<h4>Email has already been send to admin</h4>
</cfif>--->
