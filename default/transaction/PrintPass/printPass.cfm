...
<cfquery name="getgeneralmail" datasource="main">
select useremail from users where userDept = "#dts#" and userGrpId in (<cfqueryparam cfsqltype="cf_sql_varchar" list="yes" separator="," value="#getgeneralsetup.printapprovelevel1#">) and useremail <> ""
</cfquery>
<cfset email1=''>
<cfloop query="getgeneralmail">
<cfset email1=email1&getgeneralmail.useremail>
