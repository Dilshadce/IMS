...
<table align="center">
	...
	<tr>
		...
		<td>
			...
			/ <input name="enterbatch2" id="enterbatch2" type="text" size="10" value="#xbatchcode#">
			<input name="oldenterbatch" id="oldenterbatch" type="hidden" size="10" value="#xbatchcode#">
		</td>
	</tr>
	<tr>
		<th>Expiry Date</th>
    ...
    <tr>
		...
		<td><input name="milcert" id="milcert" type="text" size="10" value="#milcert#"></td>
	</tr>
	<tr>
		<th>Quantity</th>
		<input type="hidden" name="oldqty" id="oldqty" value="#oldqty#">
		<td><input name="batchqty" id="batchqty" type="text" size="5" value="#numberformat(qty,'0')#" onKeyPress="return onlyNumbers();"></td>	
	</tr>
	<tr><td><br></td></tr>
	<tr>
