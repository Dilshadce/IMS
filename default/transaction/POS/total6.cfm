...
{
submitpay();document.getElementById('sub_btn').disabled=true;
return false;
...
<cfloop query="getCreditCard">
	<input type="radio" name="cctype16" id="cctype16" value="#getCreditCard.cardName#" />#getCreditCard.cardName#&nbsp;&nbsp;
</cfloop>
...
<cfloop query="getCreditCard">
	<input type="radio" name="cctype26" id="cctype26" value="#getCreditCard.cardName#" />#getCreditCard.cardName#&nbsp;&nbsp;
</cfloop>
