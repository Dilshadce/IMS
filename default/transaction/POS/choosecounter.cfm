...
<cfset words_id_list = "1276,1349,585,1348">
    ...
    <table>
        <tr>
            ...
            <cfquery name="getcounter" datasource="#dts#">
                SELECT "" AS counterid,"#words[1348]#" AS counterdesp
                union all
                SELECT * from (
            ...
            <cfquery name="getbond" datasource="#dts#">
                SELECT counterid 
                FROM counter 
                WHERE bonduser = <cfqueryparam cfsqltype="cf_sql_varchar" value="#huserid#">
            </cfquery>
            <cfselect name="counterlist" id="counterlist" query="getcounter" value="counterid" display="counterdesp" selected="#getbond.counterid#"></cfselect>
            </td>
        </tr>
        <tr>
