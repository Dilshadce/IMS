    ...
    <input name="hidpackagecode" id="hidpackagecode" type="hidden" value=""/>
    <table width="650px">
    <tr>
    ...
    <td style="cursor:pointer"><cftooltip sourceForTooltip="packageitemlist.cfm?packcode=#URLENCODEDFORMAT(getitem1.packcode)#" showdelay="200" hidedelay="500">#getitem1.packcode#</cftooltip></td>
