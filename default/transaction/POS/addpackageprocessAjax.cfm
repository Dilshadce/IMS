...
<cfif getproductdetail.recordcount neq 0>

<cfset price = getpackageitem.price_bil>
<cfset desp = getproductdetail.desp>
<cfset despa = getpackageitem.despa>
<cfset comment = tostring(getpackageitem.comment)>
<cfset brem1 = getpackageitem.brem1>
<cfset brem2 = getpackageitem.brem2>
          ...
          '1',
           '1',
            ...
            '',
              ...
              '#driver#',
              '#rem9#',
              <cfqueryparam cfsqltype="cf_sql_varchar" value="#packagecode#">
        )
</cfquery>
...
<input type="hidden" name="hidfooterdiscount" id="hidfooterdiscount" value="0.00" />
<input type="hidden" name="updatefooterdiscount" id="updatefooterdiscount" value="0" />
