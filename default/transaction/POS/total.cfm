...
<form action="processprint.cfm" method="post" onsubmit="if(document.getElementById('change0').value*1 < 0){alert('Payment is not Enough');return false;}else{submitpay();document.getElementById('sub_btn').disabled=true;return false;}">
<table width="570px" >
<tr>
