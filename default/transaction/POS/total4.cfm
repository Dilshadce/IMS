...
<form action="processprint.cfm" method="post" onsubmit="if(document.getElementById('change4').value*1 < 0){alert('Payment is not Enough');return false;}else{submitpay();document.getElementById('sub_btn').disabled=true;return false;}" name="ccform"  id="ccform">
<table width="570px" >
<tr>
