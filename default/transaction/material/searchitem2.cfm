...
<cfset reftype= url.reftype>
	<cfquery name="getitem" datasource="#dts#">
   		select itemno,aitemno,desp,ucost,price from icitem order by itemno limit 100
	</cfquery>
    ...
    <cfif hcomid neq "acht_i"><th width="300px">PRODUCT CODE</th></cfif>
