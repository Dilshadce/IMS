...
<cfif getproductdetail.itemtype eq 'SV'>
<cfset isservi = '1'>
</cfif>
...
select * from icl3p<cfif url.tran eq 'PO' or url.tran eq 'RC' or url.tran eq 'PR'><cfelse>2</cfif> where itemno='#getproductdetail.itemno#' and custno='#custno#'
</cfquery>
