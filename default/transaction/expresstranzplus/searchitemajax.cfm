...
select * from gsetup
    ...
    and barcode like <cfqueryparam cfsqltype="cf_sql_varchar" value="%#URLDECODE(url.catename)#%" />
    </cfif>
    ...
    <th width="300px"><font style="text-transform:uppercase; font-size:#defaultfontsize#">NAME</font></th>
    </cfif>
    ...
    <td style="font:'Times New Roman', Times, serif; font-size:#defaultfontsize#">#getitembalance1.poqty#</td>
    <td style="font:'Times New Roman', Times, serif; font-size:#defaultfontsize#">#getitembalance1.soqty#</td>
    </cfif>
    </cfif>
    <cfif lcase(hcomid) neq "acht_i">
