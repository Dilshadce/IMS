...
<cfset reftype= url.reftype>
    ...
    <td style="cursor:pointer"><cftooltip sourceForTooltip="packageitemlist.cfm?packcode=#URLENCODEDFORMAT(getitem.packcode)#" showdelay="200" hidedelay="2000">#getitem.packcode#  </cftooltip> </td>
