...
FROM ictrantemp WHERE itemno = <cfqueryparam cfsqltype="cf_sql_varchar" value="#itemno#"> and 
price_bil=<cfqueryparam cfsqltype="cf_sql_varchar" value="#price#">
...
<cfquery name="getitemdetail" datasource="#dts#">
	select '' as wos_group,'' as category,'' as despa,desp,'' as barcode,'' as comment,servi as itemno from icservi
    where servi = <cfqueryparam cfsqltype="cf_sql_varchar" value="#itemno#">
    union all
    select 
    wos_group,category,despa,desp,barcode,comment,itemno
    from icitem
