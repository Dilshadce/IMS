...
<cfif isdefined("url.process")>
	...
	<!--- QCH <cfset strNo = "start">  --->
      ...
      <table align="center" class="data" width="550px">
        ...
        <tr> 
          <td colspan="2"><div align="right"><a href="/default/transaction/assignmentslipnewnew/assignmentsliptable2.cfm?type=Delete&refno=#evaluate(strNo)#"><img height="18px" width="18px" src="/images/delete.ICO" alt="Delete" border="0"> 
              Delete</a> <a href="/default/transaction/assignmentslipnewnew/assignmentsliptable2.cfm?type=Edit&refno=#evaluate(strNo)#"><img height="18px" width="18px" src="/images/edit.ICO" alt="Edit" border="0">Edit</a></div></td>
        </tr><!---</cfif>---->
      </table>
