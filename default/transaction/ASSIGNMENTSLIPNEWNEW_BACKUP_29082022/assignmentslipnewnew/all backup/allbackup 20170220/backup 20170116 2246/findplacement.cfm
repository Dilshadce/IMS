...
<cfset dts1 = replace(dts,'_i','_p','All')>
    ...
    <td><a style="cursor:pointer" onClick="<cfif getemployeename.paystatus neq "A">alert('Emplyee Pay Status is Not Active');<cfelseif getemployeename.dbirth eq "" or  getemployeename.dbirth eq "0000-00-00">alert('Emplyee Date Of Birth is Empty');<cfelse>document.getElementById('placementno').value='#getitemno.xplacementno#';document.getElementById('custno').value='#getitemno.xcustno#';selectlist('#getitemno.clienttype#','paymenttype');document.getElementById('paymenttype2').value='#getitemno.clienttype#';document.getElementById('lastworkingdate').value='#dateformat(getlastworkingdate.assignmentslipdate,'DD/MM/YYYY')#';document.getElementById('empno').value='#getitemno.xempno#';document.getElementById('custname').value=unescape('#URLEncodedFormat(getitemno.xcustname)#');document.getElementById('custname2').value=unescape('#URLEncodedFormat(getitemno.xcustname)#');document.getElementById('empname').value='#replace(getemployeename.name,"'","","all")#';document.getElementById('assignmenttype').value=<cfif getbillref.arrem10 eq '0'><cfif trim(getitemno.invoicegroup) neq ''>'#getitemno.invoicegroup#'<cfelse>'#getitemno.xcustno#'</cfif><cfelse>'invoice'</cfif>;document.getElementById('iname').value='#getitemno.iname#';document.getElementById('supervisor').value='#getitemno.supervisor#';<cfif gettimesheet.recordcount neq 0>gettimesheet('#getitemno.xplacementno#','#getitemno.xempno#');<cfelse>getpanel('#getitemno.xplacementno#');</cfif>ColdFusion.Window.hide('findplacement');</cfif>"><u>SELECT</u></a></td>
    </tr>
    </cfloop>
