...
<!---            <cfif select_empdata.itaxno neq "" and select_empdata.itaxcat neq "X">--->
	  ...
	  <cfquery name="awqry" datasource="#db#">
            ...
            <cfset avgepf = numberformat((int(capepf-val(epfnow)-val(preepfww))/(divby)*100)/100,'.__')>
            ...
            <cfif val(checkbonus.bonus) gt 0 >
                ...
                <cfset currentpcb12 = (Ceiling(currentpcb12*20)/20)>
                    
                <cfset pcbbonus = (Ceiling(pcbbonus*20)/20)>
