...
<!--- 			<cfif grosspay neq 0>
            ...
            <cfloop list="bill" index="a">
                	<cfif evaluate('getpm.#a#able') eq "Y" and evaluate('getpm.#a#adminfee') neq "">
						<cfif findnocase('%',evaluate('getpm.#a#adminfee'))>
                        <cfset calculateadminfee =  numberformat((val(BASIC) * replacenocase(evaluate('getpm.#a#adminfee'),'%','')/100),'.__')>
                         <tr>
                        <td>#getpm.itemname#*</td>
                        <td>#val(BASIC)#</td>
                        ...
                        <cfset calculateadminfee =  numberformat(evaluate(con),'.__')>
                          <tr>
                        <td>#getpm.itemname#**</td>
                        <td>#val(BASIC)#</td>
                        <td>#numberformat(evaluate(con),'.__')#</td>
            ...
            <cfloop query="getpmsafaw">
                ...
                <cfif checkdetails.aw_epf eq 1 and isdefined('totalA#replace(getpmsafaw.itemid,'A-','')#') and val(url.epfpayin) neq 0>
                    ...
                    <cfset calculateadminfee = calculateadminfee + numberformat(numberformat(((awamt/val(url.epfpayin)) * EPFYER),'.__') * (replacenocase(getpmsafaw.billadminfee,'%','')/100),'.__')>
                     <tr>
                        <td>#getpmsafaw.itemname# EPF</td>
                        <td>#numberformat(((awamt/val(url.epfpayin)) * EPFYER),'.__')#</td>                        <td>#numberformat(numberformat(((awamt/val(url.epfpayin)) * EPFYER),'.__') * (replacenocase(getpmsafaw.billadminfee,'%','')/100),'.__')#</td>
                        </tr>
                 ...
                 <cfif checkdetails.aw_hrd eq 1 and isdefined('totalA#replace(getpmsafaw.itemid,'A-','')#') and val(url.socsopayin) neq 0 and socsoremain gt 0>
                    ...
                    <cfset calculateadminfee = calculateadminfee + numberformat(numberformat(((awamt/val(url.socsopayin)) * SOCSOYER),'.__') * (replacenocase(getpmsafaw.billadminfee,'%','')/100),'.__')>
                     <tr>
                        <td>#getpmsafaw.itemname# SOCSO</td>
                        <td>#numberformat(((awamt/val(url.socsopayin)) * SOCSOYER),'.__')#</td>
                        <td>#numberformat(numberformat(((awamt/val(url.socsopayin)) * SOCSOYER),'.__') * (replacenocase(getpmsafaw.billadminfee,'%','')/100),'.__')#</td>
                        </tr>                     
                ...
                <cfif checkdetails.aw_hrd eq 1 and isdefined('totalA#replace(getpmsafaw.itemid,'A-','')#') and val(url.socsopayin) neq 0 and eisremain gt 0>
                    ...
                    <cfset calculateadminfee = calculateadminfee + numberformat(numberformat(((awamt/val(url.socsopayin)) * EISYER),'.__') * (replacenocase(getpmsafaw.billadminfee,'%','')/100),'.__')>
                     <tr>
                        <td>#getpmsafaw.itemname# EIS</td>
                        <td>#numberformat(((awamt/val(url.socsopayin)) * EISYER),'.__')#</td>
                        <td>#numberformat(numberformat(((awamt/val(url.socsopayin)) * EISYER),'.__') * (replacenocase(getpmsafaw.billadminfee,'%','')/100),'.__')#</td>
                        </tr>
                  	...
                  	<cfif listfindnocase(excludeaw,evaluate('url.fixawcode#aa#')) eq false>
                       <cfset awexc = val(evaluate('url.fixawer#aa#'))>
                        ...
                        <cfif checkdetails.aw_epf eq 1 and awexc neq 0 and val(url.epfpayin) neq 0>
                            <cfset awamt = awexc>
                            <cfset calculateadminfee = calculateadminfee + numberformat(numberformat(((awamt/val(url.epfpayin)) * EPFYER),'.__') * (replacenocase(getpmsafexc.billadminfee,'%','')/100),'.__')>
                            <tr>
                            <td>#checkable.desp# EPF</td>
                            <td>#numberformat(((awamt/val(url.epfpayin)) * EPFYER),'.__')#</td><td>#numberformat(numberformat(((awamt/val(url.epfpayin)) * EPFYER),'.__') * (replacenocase(getpmsafexc.billadminfee,'%','')/100),'.__')#</td>
                            </tr>
                         ...
                         <cfif checkdetails.aw_hrd eq 1 and awexc neq 0 and val(url.socsopayin) neq 0 and socsoremain gt 0>
                            ...
                            <cfset socsoremain = SOCSOREMAIN - awamt>
                            <cfset calculateadminfee = calculateadminfee + numberformat(numberformat(((awamt/val(url.socsopayin)) * SOCSOYER),'.__') * (replacenocase(getpmsafexc.billadminfee,'%','')/100),'.__')>
                            <tr>
                            <td>#checkable.desp# SOCSO</td>
                            <td>#numberformat(((awamt/val(url.socsopayin)) * SOCSOYER),'.__')#</td>
                            <td>#numberformat(numberformat(((awamt/val(url.socsopayin)) * SOCSOYER),'.__') * (replacenocase(getpmsafexc.billadminfee,'%','')/100),'.__')#</td>
                            </tr>
                        ...
                        <cfif checkdetails.aw_hrd eq 1 and awexc neq 0 and val(url.socsopayin) neq 0 and eisremain gt 0>
                            ...
                            <cfset eisremain = eisremain - awamt>
                            <cfset calculateadminfee = calculateadminfee + numberformat(numberformat(((awamt/val(url.socsopayin)) * EISYER),'.__') * (replacenocase(getpmsafexc.billadminfee,'%','')/100),'.__')>
                            <tr>
                            <td>#checkable.desp# EIS</td>
                            <td>#numberformat(((awamt/val(url.socsopayin)) * EISYER),'.__')#</td>
                            <td>#numberformat(numberformat(((awamt/val(url.socsopayin)) * EISYER),'.__') * (replacenocase(getpmsafexc.billadminfee,'%','')/100),'.__')#</td>
                            </tr>
                    ...
                    <cfloop from="1" to="18" index="aa">
                  	<cfif listfindnocase(excludeaw,evaluate('url.allowance#aa#')) eq false>
                        ...
                        <cfif checkdetails.aw_epf eq 1 and awexc neq 0 and val(url.epfpayin) neq 0>
                            ...
                            <td>#numberformat(numberformat(((awamt/val(url.epfpayin)) * EPFYER),'.__') * (replacenocase(getpmsafexc.billadminfee,'%','')/100),'.__')#</td>
                            </tr>
            ...
            <cfloop query="getpmsafOT"> 
				...
				<cfset otamt = socsoremain>
                 ...
                 <cfset socsoremain = SOCSOREMAIN - otamt>
                    ...
                    <cfset calculateadminfee = calculateadminfee + numberformat(numberformat((val(otamt/val(url.socsopayin))* SOCSOYER),'.__') * (replacenocase(getpmsafOT.billadminfee,'%','')/100),'.__')>
                    <tr>
                        <td>#getpmsafOT.itemname# SOCSO</td>
                        <td>#numberformat((val(otamt/val(url.socsopayin))* SOCSOYER),'.__')#</td>
                        <td>#numberformat(numberformat((val(otamt/val(url.socsopayin))* SOCSOYER),'.__') * (replacenocase(getpmsafOT.billadminfee,'%','')/100),'.__')#</td>
                        </tr>
				...
				<cfset otamt = eisremain>
                 ...
                 <cfset eisremain = eisremain - otamt>
                    ...
                    <cfset calculateadminfee = calculateadminfee + numberformat(numberformat((val(otamt/val(url.socsopayin))* EISYER),'.__') * (replacenocase(getpmsafOT.billadminfee,'%','')/100),'.__')>
                    <tr>
                        <td>#getpmsafOT.itemname# EIS</td>
                        <td>#numberformat((val(otamt/val(url.socsopayin))* EISYER),'.__')#</td>
                        <td>#numberformat(numberformat((val(otamt/val(url.socsopayin))* EISYER),'.__') * (replacenocase(getpmsafOT.billadminfee,'%','')/100),'.__')#</td>
                        </tr>
            ...
            <cfloop list="pay,bill" index="a">
                	<cfif evaluate('getpmsocso.#a#able') eq "Y" and evaluate('getpmsocso.#a#adminfee') neq "">
                        ...
                        <td>
						<cfif numberformat((val(evaluate('#getpmsocso.itemid#')) * replacenocase(evaluate('getpmsocso.#a#adminfee'),'%','')/100),'.__') gte 0.00>
						#numberformat((val(evaluate('#getpmsocso.itemid#')) * replacenocase(evaluate('getpmsocso.#a#adminfee'),'%','')/100),'.__')#
						<cfelse>
						0.00
						</cfif>
						</td>
            ...
            <cfloop list="pay,bill" index="a">
                	<cfif evaluate('getpmeis.#a#able') eq "Y" and evaluate('getpmeis.#a#adminfee') neq "">
                        ...
                        <cfset calculateadminfee = calculateadminfee + numberformat((val(evaluate('#getpmeis.itemid#')) * replacenocase(evaluate('getpmeis.#a#adminfee'),'%','')/100),'.__')>
						</cfif>
                         <tr>
                        ...
                        <td>
						<cfif numberformat((val(evaluate('#getpmeis.itemid#')) * replacenocase(evaluate('getpmeis.#a#adminfee'),'%','')/100),'.__') gte 0.00>
						#numberformat((val(evaluate('#getpmeis.itemid#')) * replacenocase(evaluate('getpmeis.#a#adminfee'),'%','')/100),'.__')#
						<cfelse>
						0.00
						</cfif>
						</td>
