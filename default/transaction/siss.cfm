...
<script type="application/javascript">
	function centraltruss(refno,action){
		if(confirm("Confirm "+action+" transfer?")){
		window.open("centraltrussprocess.cfm?action="+action+"&refno="+refno)	
		}
	}
</script>
...
<cfquery datasource='#dts#' name="getjob">
	Select refno,agenno,wos_date,name,fperiod,custno,rem8,rem9,rem0,rem1,rem2,rem13,rem14,rem49,source,refno2,userid,void,type,(select name from #target_arcust# where custno=a.rem0) as custname from artran as a where type = '#tran#' 
	<cfif alown eq 1>and (userid = '#huserid#' or agenno = '#huserid#')</cfif> 
    and consignment='#consignment#' 
    <cfif tran eq 'TR' and lcase(huserloc) neq "all_loc">
    and (rem1="#huserloc#" or rem2="#huserloc#")
    </cfif>
    order by <cfif getdealer_menu.transactionSortBy neq "">#getdealer_menu.transactionSortBy#<cfelse>wos_date desc</cfif>
</cfquery>
...
<cfquery datasource="#dts#" name="exactResult">
		select b.refno,b.agenno,b.wos_date,b.fperiod,b.source,b.refno2,b.rem0,b.rem1,b.rem2,b.rem8,b.rem9,b.rem13,b.rem14,b.rem49,b.custno,b.name,b.userid,b.void,b.type,(select name from #target_arcust# where custno=b.rem0) as custname from ictran as a left join(select refno,agenno,wos_date,fperiod,custno,name,userid,void,type,refno2,source,rem8,rem9,rem14,rem49,rem0,rem1,rem2, rem13 from artran where type='TR') as b on a.refno=b.refno where a.type = 'TROU' and a.location =  <cfqueryparam cfsqltype="cf_sql_varchar" value="#form.searchStr#"> and consignment='#consignment#' 
        <cfif tran eq 'TR' and lcase(huserloc) neq "all_loc">
    	and (b.rem1="#huserloc#" or b.rem2="#huserloc#")
    	</cfif>
        group by a.refno order by a.location 
		
    </cfquery>
	
	<cfquery datasource="#dts#" name="similarResult">
        select b.refno,b.agenno,b.wos_date,b.fperiod,b.refno2,b.source,b.rem8,b.rem0,b.rem1,b.rem2,b.rem9,b.rem13,b.rem14,b.rem49,b.custno,b.name,b.userid,b.void,b.type,(select name from #target_arcust# where custno=b.rem0) as custname from ictran as a left join(select refno,agenno,wos_date,fperiod,custno,name,userid,void,type,refno2,source,rem8,rem9,rem14,rem49,rem0,rem1,rem2, rem13 from artran where type='TR') as b on a.refno=b.refno where a.type = 'TROU' and a.location LIKE <cfqueryparam cfsqltype="cf_sql_varchar" value="%#form.searchStr#%"> and consignment='#consignment#' 
        <cfif tran eq 'TR' and lcase(huserloc) neq "all_loc">
    	and (b.rem1="#huserloc#" or b.rem2="#huserloc#")
    	</cfif>
        group by a.refno order by a.location
...
<cfquery datasource="#dts#" name="exactResult">
		select b.refno,b.agenno,b.wos_date,b.fperiod,b.name,b.source,b.rem8,b.rem9,b.rem0,b.rem1,b.rem2,b.rem13,b.rem14,b.rem49,b.refno2,b.custno,b.userid,b.void,b.type,(select name from #target_arcust# where custno=b.rem0) as custname from ictran as a left join(select refno,agenno,wos_date,fperiod,custno,name,userid,void,type,refno2,source,rem8,rem9,rem14,rem49,rem0,rem1,rem2, rem13 from artran where type='TR') as b on a.refno=b.refno where a.type = 'TRIN' and a.location =  <cfqueryparam cfsqltype="cf_sql_varchar" value="#form.searchStr#">  and consignment='#consignment#' 
        <cfif tran eq 'TR' and lcase(huserloc) neq "all_loc">
    	and (b.rem1="#huserloc#" or b.rem2="#huserloc#")
    	</cfif>
        group by a.refno order by a.location 
	...
	<cfquery datasource="#dts#" name="similarResult">
        select b.refno,b.agenno,b.wos_date,b.fperiod,b.refno2,b.source,b.rem8,b.rem9,b.rem0,b.rem1,b.rem2,b.rem13,b.rem14,b.rem49,b.custno,b.name,b.userid,b.void,b.type,(select name from #target_arcust# where custno=b.rem0) as custname from ictran as a left join(select refno,agenno,wos_date,fperiod,custno,userid,void,type,name,refno2,source,rem8,rem9,rem0,rem14,rem49,rem1,rem2, rem13 from artran where type='TR') as b on a.refno=b.refno where a.type = 'TRIN' and a.location LIKE <cfqueryparam cfsqltype="cf_sql_varchar" value="%#form.searchStr#%"> and consignment='#consignment#'
        <cfif tran eq 'TR' and lcase(huserloc) neq "all_loc">
    	and (b.rem1="#huserloc#" or b.rem2="#huserloc#")
    	</cfif>
        group by a.refno order by a.location
...
<cfelse>
	<cfquery datasource="#dts#" name="exactResult">
		select refno,agenno,wos_date,fperiod,custno,userid,source,refno2,rem0,void,type,name,rem0,rem1,rem2,rem8,rem9,rem13,rem14,rem49,rem1,rem2,(select name from #target_arcust# where custno=a.rem0) as custname from artran as a where type = '#tran#' 
        
        <cfif form.searchType eq "Order Pending" or form.searchType eq "In Transit" or form.searchType eq "Received">
		and rem14 =  <cfqueryparam cfsqltype="cf_sql_varchar" value="#form.searchType#">
        <cfelse>
        and #form.searchType# =  <cfqueryparam cfsqltype="cf_sql_varchar" value="#form.searchStr#">
        </cfif>
         and consignment='#consignment#'
        <cfif tran eq 'TR' and lcase(huserloc) neq "all_loc">
    	and (rem1="#huserloc#" or rem2="#huserloc#")
    	</cfif>
        order by <cfif form.searchType eq "Order Pending" or form.searchType eq "In Transit" or form.searchType eq "Received">wos_date desc<cfelse>#form.searchType#</cfif>
	</cfquery>
	
	<cfquery datasource="#dts#" name="similarResult">
		select refno,agenno,wos_date,fperiod,custno,userid,source,refno2,rem0,void,type,name,rem1,rem2,rem8,rem9,rem13,rem14,rem49,rem1,rem2,(select name from #target_arcust# where custno=a.rem0) as custname from artran as a where type = '#tran#' 
        <cfif form.searchType eq "Order Pending" or form.searchType eq "In Transit" or form.searchType eq "Received">
        and rem14 LIKE  <cfqueryparam cfsqltype="cf_sql_varchar" value="Y">
        <cfelse>
        and #ucase(form.searchType)# LIKE  <cfqueryparam cfsqltype="cf_sql_varchar" value="%#form.searchStr#%">
        </cfif>
        and consignment='#consignment#' 
        <cfif tran eq 'TR' and lcase(huserloc) neq "all_loc">
    	and (rem1="#huserloc#" or rem2="#huserloc#")
	...
	<cfif exactResult.recordCount neq 0>
		<table align="center" class="data">
			<tr>
				...
				<th>Status</th>
                <cfif tran eq "TR" and lcase(hcomid) eq "amgworld_i">
                <th>Received by</th>
                </cfif>
  			  	<th>Action</th>
			</tr>
  			<cfoutput query="exactresult">
				<tr>
                    ...
                    <cfif lcase(hcomid) eq "vsolutionspteltd_i" or lcase(hcomid) eq "amgworld_i">
                ...
                <cfelse>
					...
					<td align="center"><cfif lcase(hcomid) eq "centraltruss_i" or lcase(hcomid) eq "demoindo_i" or lcase(hcomid) eq "amgworld_i">#exactresult.rem14#&nbsp;</cfif><cfif exactresult.void neq ""><font color="red"><strong>Void</strong></font></cfif> <cfif exactresult.rem49 eq "Done"><strong>Cleared</strong></cfif></td>
					
                    <cfif tran eq "TR" and lcase(hcomid) eq "amgworld_i">
                    <td>#exactresult.rem13#</td>
                    </cfif>
				...
				<a href="../../billformat/printoptionpage.cfm?tran=#tran#&nexttranno=#refno#&consignment=#consignment#" target="_blank">Print</a>&nbsp;
						...
						<cfif aledit eq 1 and exactresult.fperiod neq "99" and exactresult.void eq "" and ((rem14 neq "Received" and rem14 neq "In transit") or lcase(husergrpid) eq "super")>
                        ...
                        <cfif getpin2.H2890 eq 'T' and rem14 neq "Received" and rem14 neq "In transit">
                <img height="18px" width="18px" src="../../images/Copy Icon.jpg" alt="Copy" border="0"><a onMouseOver="this.style.cursor='hand'" onClick="window.open('copyfunction.cfm?refno=#refno#&type=#tran#');">Copy</a>
						...
						<cfif aldelete eq 1 and exactresult.fperiod neq "99" and exactresult.void eq "">
							<a href="iss2.cfm?tran=#tran#&ttype=Delete&refno=#refno#&custno=#URLEncodedFormat(exactresult.custno)#&consignment=#consignment#">
                        ...
                        <cfif alcreate eq 1>
                        <cfif (lcase(hcomid) eq "centraltruss_i"  or lcase(hcomid) eq "demoindo_i"  or lcase(hcomid) eq "amgworld_i") and rem14 eq "Order Pending" and (rem1 eq Huserloc or lcase(Huserloc) eq 'all_loc')>
                        <a onMouseOver="this.style.cursor='hand'" onClick="centraltruss('#refno#','send');"><img height="18px" width="18px" src="/images/foldoutmenu2_arrow.gif" border="0">Send Order</a>
                        <cfelseif (lcase(hcomid) eq "centraltruss_i"  or lcase(hcomid) eq "demoindo_i" or lcase(hcomid) eq "amgworld_i") and rem14 eq "In transit" and (rem2 eq Huserloc or lcase(Huserloc) eq 'all_loc')>
                        <a onMouseOver="this.style.cursor='hand'" onClick="centraltruss('#refno#','receive');"><img height="18px" width="18px" src="/images/foldoutmenu2_arrow.gif" border="0">Receive Order</a>
                        </cfif>
                        </cfif>
					</td>
				</tr>
			...
			<tr>
  			...
  			<cfoutput query="similarResult">
        		...
        		<cfelse>
					...
					<td align="center"><cfif lcase(hcomid) eq "centraltruss_i"  or lcase(hcomid) eq "demoindo_i" or lcase(hcomid) eq "amgworld_i">#similarResult.rem14#&nbsp;</cfif><cfif similarResult.void neq ""><font color="red"><strong>Void</strong></font></cfif> <cfif similarResult.rem49 eq "Done"><strong>Cleared</strong></cfif></td>
					<cfif tran eq "TR" and lcase(hcomid) eq "amgworld_i">
                    <td>#similarResult.rem13#</td>
                    </cfif>
				...
				<a href="../../billformat/printoptionpage.cfm?tran=#tran#&nexttranno=#refno#&consignment=#consignment#" target="_blank">Print</a>&nbsp;
						...
						<cfif aledit eq 1 and similarResult.fperiod neq "99" and similarResult.void eq "" and  ((rem14 neq "Received" and rem14 neq "In transit") or lcase(husergrpid) eq "super")>
                ...
                <img height="18px" width="18px" src="../../images/Copy Icon.jpg" alt="Copy" border="0"><a onMouseOver="this.style.cursor='hand'" onClick="window.open('copyfunction.cfm?refno=#refno#&type=#tran#');">Copy</a>
            			...
            			<cfif aldelete eq 1 and similarResult.fperiod neq "99" and similarResult.void eq "">
							<a href="iss2.cfm?tran=#tran#&ttype=Delete&refno=#refno#&custno=#URLEncodedFormat(similarResult.custno)#&consignment=#consignment#">
								<img height="18px" width="18px" src="../../images/delete.ICO" alt="Delete" border="0">Delete
							</a>
						<cfelse>
							<img height="18px" width="18px" src="../../images/delete.ICO" alt="Not Allowed to Delete" border="0">Delete
			...
			<table align="center" class="data">
			 ...
			 <cfoutput query="getjob" startrow="#start#" maxrows="20">
        		...
        		<cfelse>
					...
					<td align="center"><cfif lcase(hcomid) eq "centraltruss_i"  or lcase(hcomid) eq "demoindo_i" or lcase(hcomid) eq "amgworld_i">#getjob.rem14#&nbsp;</cfif><cfif getjob.void neq ""><font color="red"><strong>Void</strong></font></cfif> <cfif getjob.rem49 eq "Done"><strong>Cleared</strong></cfif></td>
          			<cfif tran eq "TR" and lcase(hcomid) eq "amgworld_i">
                    <td>#getjob.rem13#</td>
                    </cfif>
                    <td align="right" nowrap>
				...
				<a href="../../billformat/printoptionpage.cfm?tran=#tran#&nexttranno=#refno#&consignment=#consignment#" target="_blank">Print</a>&nbsp;
						...
						<cfif aledit eq 1 and getjob.fperiod neq "99" and getjob.void eq "" and ((rem14 neq "Received" and rem14 neq "In transit") or lcase(husergrpid) eq "super")>
                ...
                <img height="18px" width="18px" src="../../images/Copy Icon.jpg" alt="Copy" border="0"><a onMouseOver="this.style.cursor='hand'" onClick="window.open('copyfunction.cfm?refno=#refno#&type=#tran#');">Copy</a>
            			...
            			<cfif aldelete eq 1 and getjob.fperiod neq "99" and getjob.void eq "">
							<a href="iss2.cfm?tran=#tran#&ttype=Delete&refno=#refno#&custno=#URLEncodedFormat(getjob.custno)#&consignment=#consignment#">
								<img height="18px" width="18px" src="../../images/delete.ICO" alt="Delete" border="0">Delete
							</a>
						<cfelse>
							<img height="18px" width="18px" src="../../images/delete.ICO" alt="Not Allowed to Delete" border="0">Delete
