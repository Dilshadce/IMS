...
<input type="hidden" name="price" value="#val(url.price)#">
<input type="hidden" name="qty" value="#val(url.qty)#">
<input type="hidden" name="formula" value="#formula#">
<input type="hidden" name="formulatype" value="#url.formulatype#">
...
<table border="0" align="center" width="400px" cellpadding="0" cellspacing="2">
	<cfif FindNoCase('xqty1',formula) neq 0>
		<tr>
			...
			<td><input type="text" name="qty1" value="#qty1#"></td>
		</tr>
	<cfelse>
	...
	<cfif FindNoCase('xqty2',formula) neq 0>
		<tr>
			...
			<td><input type="text" name="qty2" value="#qty2#"></td>
		</tr>
	<cfelse>
	...
	<cfif FindNoCase('xqty3',formula) neq 0>
		<tr>
			...
			<td><input type="text" name="qty3" value="#qty3#"></td>
		</tr>
	<cfelse>
	...
	<cfif FindNoCase('xqty4',formula) neq 0>
		<tr>
			...
			<td><input type="text" name="qty4" value="#qty4#"></td>
		</tr>
	<cfelse>
	...
	<cfif FindNoCase('xqty5',formula) neq 0>
		<tr>
			...
			<td><input type="text" name="qty5" value="#qty5#"></td>
		</tr>
	<cfelse>
	...
	<cfif FindNoCase('xqty6',formula) neq 0>
		<tr>
			...
			<td><input type="text" name="qty6" value="#qty6#"></td>
		</tr>
	<cfelse>
	...
	<cfif FindNoCase('xqty7',formula) neq 0>
		<tr>
			...
			<td><input type="text" name="qty7" value="#qty7#"></td>
		</tr>
	<cfelse>
