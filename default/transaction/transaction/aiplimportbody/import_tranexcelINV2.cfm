		...
		<cftry>
			...
			<cfif trim(column1) neq "">
				<cfquery name="inserticitem" datasource="#dts#">
					...
					values
					(<cfqueryparam cfsqltype="cf_sql_varchar" value="#column1#">,<cfqueryparam cfsqltype="cf_sql_varchar" value="#column6#">,'','','','','',<cfqueryparam cfsqltype="cf_sql_varchar" value="#column8#">, '#val(column2)#', '#val(column3)#','#val(column4)#', '0', '0',<cfqueryparam cfsqltype="cf_sql_varchar" value="#column10#">, <cfif val(column11) eq 0>'0'<cfelse>'7'</cfif>)
				</cfquery>
			</cfif>
		<cfcatch type="any">
