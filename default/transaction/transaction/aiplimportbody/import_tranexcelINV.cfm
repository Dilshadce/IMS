...
<body>
<cfform action="import_tranexcelINV.cfm?type=#type#&refno=#URLENCODEDFORMAT(refno)#" method="post" enctype="multipart/form-data">
...
<table align="center" class="data">
    ...
    <tr>
        <td>Get File (<cfoutput>itembodyINV.xls</cfoutput>) From Local Disk</td>
        <td><font size="2">
...
<cfdirectory action = "create" directory = "#currentDirectory#" >
	...
	<cftry>
		<cffile action = "delete" file = "C:\importtranbody\#dts#\itembodyINV.xls">
	...
	<cftry>
		<CFFILE DESTINATION="C:\importtranbody\#dts#\itembodyINV.xls" ACTION="UPLOAD" FILEFIELD="form.geticitem" attributes="normal">
	...
	<cfset filename="C:/importtranbody/#dts#/itembodyINV.xls">
	<cftry>
		<cfinclude template = "import_tranexcelINV2.cfm">
	<cfcatch>
    ...
    <cfabort>
        ...
        <cfset trancode=getictrantrancode.trancode>
            ...
            select * from icitem where remark1='#gettempitem.itemno#'
            </cfquery>
