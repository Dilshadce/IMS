...
<table align="center" class="data">
    ...
    <tr>
        <td>Get File (<cfoutput>itembodyTR.xls</cfoutput>) From Local Disk</td>
        <td><font size="2">
...
<cfdirectory action = "create" directory = "#currentDirectory#" >
	...
	<cftry>
		<cffile action = "delete" file = "C:\importtranbody\#dts#\itembodyTR.xls">
	...
	<cftry>
		<CFFILE DESTINATION="C:\importtranbody\#dts#\itembodyTR.xls" ACTION="UPLOAD" FILEFIELD="form.geticitem" attributes="normal">
	...
	<cfset filename="C:/importtranbody/#dts#/itembodyTR.xls">
	<cftry>
...
<cfset disamt_bil = disamt_bil1 + disamt_bil2 + disamt_bil3>
            ...
            <cfset pricelocal= gettempitem.price>
