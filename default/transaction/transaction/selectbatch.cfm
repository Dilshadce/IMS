	...
	<cfif getitembatch.recordcount neq 0>
		...
		>
			<table align="center">
                ...
                <td><input type="text" name="importpermit" id="importpermit" value="#getitembatch.importpermit#" maxlength="100" readonly> </td>
                </tr>
                <tr>
				...
				<tr>
					...
					<cfelse>
                        ...
                        <cfinput name="batchqty" type="text" size="5" validate="integer" message="Please Enter Correct Quantity !" value="#val(form.batchqtyhid)#" >
                        <cfelseif hcomid eq "bestform_i">
                        <cfinput name="batchqty" type="text" size="5" value="1" validate="integer" message="Please Enter Correct Quantity !" >
						<cfelse>
                        <cfinput name="batchqty" type="text" size="5" validate="integer" message="Please Enter Correct Quantity !" >
						</cfif></td>	
					</cfif>
	...
	<cfelseif getitembatch.recordcount eq 0 and (form.type1 eq "Add" or form.type1 eq "Edit") and (form.tran eq "RC" or form.tran eq "CN" or form.tran eq "OAI" or quovalid eq 1)>
		...
		>
			<table align="center">
                ...
                <tr>
                <th>Import Permit</th>
                <td><input type="text" name="importpermit" id="importpermit" value="<cfif lcase(hcomid) eq 'marquis_i' and isdefined('form.batchbrem2hid')>#trim(form.batchbrem2hid)#<cfelse>  #getitembatch.importpermit#</cfif>" maxlength="100"> </td>
                </tr>
                <tr>
                <th>Country Of Origin</th>
                <td>
                ...
                <tr>
                <th>Pallet</th>
                <td><input type="text" name="pallet" id="pallet" value="#getitembatch.pallet#" maxlength="100"> </td>
                </tr>
				<tr>
					<th>Quantity</th>
					<input type="hidden" name="oldqty" value="#listfirst(oldqty)#">
