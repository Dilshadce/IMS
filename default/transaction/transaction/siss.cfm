...
<cfelse>
	<cfquery datasource="#dts#" name="exactResult">
		select refno,agenno,wos_date,fperiod,custno,userid,source,refno2,void,type,name,rem8,rem9 from artran where type = '#tran#' and #form.searchType# =  <cfqueryparam cfsqltype="cf_sql_varchar" value="#form.searchStr#"> and consignment='#consignment#' order by #form.searchType#
	</cfquery>
	
	<cfquery datasource="#dts#" name="similarResult">
		select refno,agenno,wos_date,fperiod,custno,userid,source,refno2,void,type,name,rem8,rem9 from artran where type = '#tran#' and #ucase(form.searchType)# LIKE  <cfqueryparam cfsqltype="cf_sql_varchar" value="%#form.searchStr#%"> and consignment='#consignment#' order by #form.searchType#
	</cfquery>
</cfif>
	<h2>Exact Result</h2>
