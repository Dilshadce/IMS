...
<cfoutput>
	...
	<input type="hidden" name="tran" value="#type#">
	<input type="hidden" name="refno" value="#refno#">
	<input type="hidden" name="price_bil" value="#price_bil#">
	<input type="hidden" name="locationlist" value="#ValueList(getlocation.location,";")#">
</cfoutput>
...
<table border="0" cellpadding="2" align="center" width="90%">
		...
		<tr onMouseOut="javascript:this.style.backgroundColor='';" onMouseOver="javascript:this.style.backgroundColor='99FF00';">
			...
			<td>
				<div align="center">
					...
					<cfelse> --->
						<input type="text" name="qty_#xlocation#" value="#val(xqty_bil)#" size="10" onKeyUp="checknum(this);" onBlur="UpdateTotalQty();">		
						<input type="hidden" name="oldqty_#xlocation#" value="#val(xqty_bil)#">			
					<!--- </cfif> --->				
				</div>
			</td>
			<td><div align="center">
				...
				<input type="hidden" name="batch_#xlocation#" value="#xbatchcode#">
				<input type="hidden" name="oldbatch_#xlocation#" value="#xbatchcode#">
				<input type="hidden" name="mc1bil_#xlocation#" value="#xmc1bil#">
				<input type="hidden" name="mc2bil_#xlocation#" value="#xmc2bil#">
				<input type="hidden" name="sodate_#xlocation#" value="#xsodate#">
				<input type="hidden" name="dodate_#xlocation#" value="#xdodate#">
				<input type="hidden" name="expdate_#xlocation#" value="#xexpdate#">
				<input type="hidden" name="defective_#xlocation#" value="#xdefective#">
                <input type="hidden" name="milcert_#xlocation#" value="#xmilcert#">
	...
	<tr>
		...
		<td>
			<div align="center"><cfoutput><input type="text" name="totqty" value="#totqty#" size="10" style="background-color: ##FFFAFA;"></cfoutput></div>
		</td>
	</tr>
