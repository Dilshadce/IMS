...
<cfform name="form" method="post" action="copyfunctionprocess.cfm" target="_self">
    ...
    <table class="data" align="center" width="200px">
        ...
        <tr>
            ...
            <cfif getpin2.H2831 eq 'T'><option value="OAI" <cfif url.type eq 'OAI'>selected</cfif>>Adjustment Increase</option></cfif>
            <cfif getpin2.H2841 eq 'T'><option value="OAR" <cfif url.type eq 'OAR'>selected</cfif>>Adjustment Reduce</option></cfif>
            </select>
            </td>
        </tr>
        <script type="text/javascript">
    	...
    	<tr>
            ...
            <input type="text" name="ft_refnofrom" value=""><input id="ft_actualrefno" type="hidden" name="ft_actualrefno">
            </td>
        </tr>
        <tr>
