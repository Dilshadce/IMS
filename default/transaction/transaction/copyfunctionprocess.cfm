...
<cfif not isdefined("url.status")>
	...
	<cffunction name="updateArtran" output="false">
		...
		<cfquery datasource="#dts#" name="insertartran">
			...
			m_charge6,m_charge7,special_account_code,created_by,created_on,updated_by,updated_on,termscondition,consignment)
			...
			'#resultSet.m_charge6#','#resultSet.m_charge7#','#resultSet.special_account_code#','#HUserID#',#now()#,'#HUserID#',#now()#,'#resultSet.termscondition#','#resultSet.consignment#')
		</cfquery>
	</cffunction>
	...
	<cffunction name="updateIctran" output="false">
		...
		<cfquery name="insertictran" datasource="#dts#">
			...
			mc6_bil,mc7_bil,note_a,TITLE_ID,title_desp,consignment)
			...
			'#resultSet.mc6_bil#','#resultSet.mc7_bil#','#resultSet.note_a#','#resultSet.TITLE_ID#','#resultSet.title_desp#','#resultSet.consignment#')
		</cfquery>	
	</cffunction>
