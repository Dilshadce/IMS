...
function calselfexception()
{
	...
	document.getElementById('selfexception').value=(selfexceptionrate*selfexceptionhrs).toFixed(2);
...
function calselfot1()
{
	...
	document.getElementById('selfot1').value=(selfotrate1*selfothour1).toFixed(2);
...
function calselfot2()
{
	...
	document.getElementById('selfot2').value=(selfotrate2*selfothour2).toFixed(2);
...
function calselfot3()
{
	...
	document.getElementById('selfot3').value=(selfotrate3*selfothour3).toFixed(2);
...
function calselfot4()
{
	...
	document.getElementById('selfot4').value=(selfotrate4*selfothour4).toFixed(2);
...
function calselfottotal()
{
	...
	document.getElementById('selfottotal').value=(selfot1+selfot2+selfot3+selfot4).toFixed(2);
...
function calcustot1()
{
	...
	document.getElementById('custot1').value=(custotrate1*custothour1).toFixed(2);
...
function calcustot2()
{
	...
	document.getElementById('custot2').value=(custotrate2*custothour2).toFixed(2);
...
function calcustot3()
{
	...
	document.getElementById('custot3').value=(custotrate3*custothour3).toFixed(2);
...
function calcustot4()
{
	...
	document.getElementById('custot4').value=(custotrate4*custothour4).toFixed(2);
...
function calselfallow()
{
	...
	selfallowancerate1 = ((selfallowancerate1 * 1).toFixed(2)) * 1;
	selfallowancehour1 = ((selfallowancehour1 * 1).toFixed(2)) * 1;
	selfallowancerate2 = ((selfallowancerate2 * 1).toFixed(2)) * 1;
	selfallowancehour2 = ((selfallowancehour2 * 1).toFixed(2)) * 1;
	selfallowancerate3 = ((selfallowancerate3 * 1).toFixed(2)) * 1;
	selfallowancehour3 = ((selfallowancehour3 * 1).toFixed(2)) * 1;
	selfallowancerate4 = ((selfallowancerate4 * 1).toFixed(2)) * 1;
	selfallowancerate5 = ((selfallowancerate5 * 1).toFixed(2)) * 1;
	selfallowancerate6 = ((selfallowancerate6 * 1).toFixed(2)) * 1;
	
	document.getElementById('selfallowance').value=((selfallowancerate1*selfallowancehour1)+(selfallowancerate2*selfallowancehour2)+(selfallowancerate3*selfallowancehour3)+(selfallowancerate4+selfallowancerate5+selfallowancerate6)).toFixed(2);
...
function calcustallow()
{
	...
	custallowancerate1 = ((custallowancerate1 * 1).toFixed(2)) * 1;
	custallowancehour1 = ((custallowancehour1 * 1).toFixed(2)) * 1;
	custallowancerate2 = ((custallowancerate2 * 1).toFixed(2)) * 1;
	custallowancehour2 = ((custallowancehour2 * 1).toFixed(2)) * 1;
	custallowancerate3 = ((custallowancerate3 * 1).toFixed(2)) * 1;
	custallowancehour3 = ((custallowancehour3 * 1).toFixed(2)) * 1;
	custallowancerate4 = ((custallowancerate4 * 1).toFixed(2)) * 1;
	custallowancerate5 = ((custallowancerate5 * 1).toFixed(2)) * 1;
	custallowancerate6 = ((custallowancerate6 * 1).toFixed(2)) * 1;
	
	document.getElementById('custallowance').value=((custallowancerate1*custallowancehour1)+(custallowancerate2*custallowancehour2)+(custallowancerate3*custallowancehour3)+(custallowancerate4+custallowancerate5+custallowancerate6)).toFixed(2);
...
function caltax2()
	...
	var custallowancerate1 = ((document.getElementById('custallowancerate1').value * 1).toFixed(2)) * 1;
	var custallowancehour1 = ((document.getElementById('custallowancehour1').value * 1).toFixed(2)) * 1;
	
	var custallowancerate2 = ((document.getElementById('custallowancerate2').value * 1).toFixed(2)) * 1;
	var custallowancehour2 = ((document.getElementById('custallowancehour2').value * 1).toFixed(2)) * 1;
	
	var custallowancerate3 = ((document.getElementById('custallowancerate3').value * 1).toFixed(2)) * 1;
	var custallowancehour3 = ((document.getElementById('custallowancehour3').value * 1).toFixed(2)) * 1;
	
	var custallowancerate4 = ((document.getElementById('custallowancerate4').value * 1).toFixed(2)) * 1;
	var custallowancerate5 = ((document.getElementById('custallowancerate5').value * 1).toFixed(2)) * 1;
	var custallowancerate6 = ((document.getElementById('custallowancerate6').value * 1).toFixed(2)) * 1;
	
	taxval1 = ((taxper/100)*custsalary).toFixed(2);
	taxval2 = ((taxper/100)*custottotal).toFixed(2);
	taxval3 = 0;
	taxval4 = ((taxper/100)*custcpf).toFixed(2);
	taxval5 = ((taxper/100)*custsdf).toFixed(2);
	taxval6 = ((taxper/100)*addchargecust).toFixed(2);
	taxval7 = ((taxper/100)*addchargecust2).toFixed(2);
	taxval8 = ((taxper/100)*addchargecust3).toFixed(2);
	taxval9 = ((taxper/100)*addchargecust4).toFixed(2);
	taxval10 = ((taxper/100)*custpayback).toFixed(2);
	taxval11 = ((taxper/100)*addchargecust5).toFixed(2);
	taxval12 = ((taxper/100)*addchargecust6).toFixed(2);
	taxval13 = ((taxper/100)*custallowancerate1*custallowancehour1).toFixed(2);
	taxval14 = ((taxper/100)*custallowancerate2*custallowancehour2).toFixed(2);
	taxval15 = ((taxper/100)*custallowancerate3*custallowancehour3).toFixed(2);
	taxval16 = ((taxper/100)*custallowancerate4).toFixed(2);
	taxval17 = ((taxper/100)*custallowancerate5).toFixed(2);
	taxval18 = ((taxper/100)*custallowancerate6).toFixed(2);
	
	taxval = ((taxval1*1)+(taxval2*1)+(taxval3*1)+(taxval4*1)+(taxval5*1)+(taxval6*1)+(taxval7*1)+(taxval8*1)+(taxval9*1)+(taxval10*1)+(taxval11*1)+(taxval12*1)+(taxval13*1)+(taxval14*1)+(taxval15*1)+(taxval16*1)+(taxval17*1)+(taxval18*1)).toFixed(2);
...
{
document.getElementById('selfsalary').value=document.getElementById('selfsalaryhrs').value*document.getElementById('selfusualpay').value;
hrotrate('self');
calselfot1();
calselfot2();
calselfot3();
...
document.getElementById('selfsalary').value=document.getElementById('selfsalaryday').value*document.getElementById('selfusualpay').value;
calselftotal();
}
}
...
function selfnpl()
{
		if(document.getElementById('paymenttype').value == "mth"){
			...
			{
				var newpay = ((workingday - selfnpl) / workingday) * selfrate;
...
if(document.getElementById('paymenttype').value == "hr")
{
document.getElementById('custsalary').value=document.getElementById('custsalaryhrs').value*document.getElementById('custusualpay').value;
hrotrate('cust');
calcustot1();
calcustot2();
calcustot3();
...
document.getElementById('custsalary').value=document.getElementById('custsalaryday').value*document.getElementById('custusualpay').value;
calcusttotal();
}
}
...
function getpaydata()
{
	...
	document.getElementById('selfnet').value=document.getElementById('grosspay').value;
	document.getElementById('selftotal').value=document.getElementById('netpay').value;
...
function hrotrate(custselfvar)
{
	if(document.getElementById('paymenttype').value == "hr")
	{
		...
		document.getElementById(custselfvar+'otrate2').value = (brate * 1.5).toFixed(2);
		document.getElementById(custselfvar+'otrate3').value = (brate * 2).toFixed(2);
...
<cfform name="AssignmentslipForm" action="Assignmentsliptableprocess.cfm" method="post" >
  <cfoutput> 
    ...
    <cfoutput> 
      <tr> 
        ...
        <td>
				...
				<cfinput type="text" size="20" name="Assignmentslipdate" id="Assignmentslipdate" value="#Assignmentslipdate#" maxlength="10" validate="eurodate" message="Please check Date Format" readonly>
				<cfelse>
...
<td><input type="text" size='10' name="selfdeduction" id="selfdeduction" value="#selfdeduction#" > </td>
  ...
  <td colspan="4"><input type="hidden" name="tran" id="tran" value="INV">   </td>
      ...
      <td>&nbsp;</td>
      <th>Tax</th>
      <td><cfselect name="taxcode" id="taxcode" bind="CFC:tax.getTaxQry('#dts#','#target_taxtable#',{tran})" value="code" display="code" onChange="<!--- setTimeout('caltax()',500); --->setTimeout('caltax2()',500);" bindonload="yes"/>&nbsp;&nbsp;<cfinput type="text" name="taxper" id="taxper" value="0" size="3" bind="CFC:tax.getTax('#dts#','#target_taxtable#',{taxcode})" onKeyUp="<!--- caltax(); --->caltax2();" bindonload="yes"  /></td>
      <td>
  <cfinput type="text" name="taxamt" id="taxamt" value="0.00" size="10" onKeyUp="<!--- caltax(); --->caltax2();" readonly/></td>
      </tr>
      <tr>
      <td>&nbsp;</td>
      <td></td>
    ...
    <tr> 
      ...
      <input type="button" name="calculateemppay" value="Calculate Employee Pay" onClick="checkpay();">&nbsp;&nbsp;&nbsp;&nbsp;
          <input name="submit" type="submit" value="  #button#  ">
          &nbsp;&nbsp;&nbsp;&nbsp;
          <input name="submit" type="submit" value="#button# and Create New">
        </cfoutput></td>
    </tr>
  </table>
</cfform>
