...
<cfif isdefined("form.invset") or isdefined("invset") and invset neq 0>
	...
	<cfquery datasource="#dts#" name="getGeneralInfo">
		Select #invset# as tranno, #tranarun# as arun,invoneset,filterall,suppcustdropdown,attnddl,transactiondate,collectaddress from GSetup
	</cfquery>
<cfelse>
	<cfquery datasource="#dts#" name="getGeneralInfo">
		Select #trancode# as tranno, #tranarun# as arun,invoneset,filterall,suppcustdropdown,attnddl,transactiondate,collectaddress from GSetup
	</cfquery>
	<cfset invset=0>
</cfif>
<!--- Add On 11-01-2010 --->
...
<cfoutput>
	<cfif isdefined("form.submit") and submit eq "Save & continue">	
		...
		<cfquery name="update_artran" datasource="#dts#">
			...
			, frem8 = '#form.d_name2#'
			, comm0='#form.d_add1#', comm1='#form.d_add2#', comm2='#form.d_add3#'
			, comm3='#form.d_add4#', comm4='#form.d_fax#',d_phone2='#form.d_phone2#'
...
<form name="invoicesheet" action="" method="post">
	...
	<tr>
		...
		<tr>
			...
			<th colspan="3">Name</th>
			<td><input type="text" name="d_name" value="#convertquote(d_name)#" size="45" maxlength="45"></td>
		</tr>
		<tr>
			<td colspan="3">&nbsp;</td>
		...
		<tr>
            ...
            <input type="text" name="d_add1" value="#d_add1#" size="45" maxlength="55">
            <cfelse>
		...
		<tr>
            ...
            <cfelseif lcase(HcomID) eq "sumiden_i">
            <input type="text" name="d_add2" value="#d_add2#" size="45" maxlength="55">
            <cfelse>
		...
		<tr>
            ...
            <cfelseif lcase(HcomID) eq "sumiden_i">
            <input type="text" name="d_add3" value="#d_add3#" size="45" maxlength="55">
            <cfelse>
		...
		<tr>
            ...
            <cfelseif lcase(HcomID) eq "sumiden_i">
            <input type="text" name="d_add4" value="#d_add4#" size="45" maxlength="55">
            <cfelse>
		...
		<tr>
            ...
            <th colspan="3"><cfif lcase(HcomID) eq "varz_i">REP<cfelseif lcase(HcomID) eq "mastercare_i" or lcase(HcomID) eq "gorgeous_i">Delivery HP<cfelse>Contact</cfif> :</th>
			<td><input type="text" name="d_phone2" value="#d_phone2#" size="45" maxlength="35"></td>
		</tr>
        <tr>
