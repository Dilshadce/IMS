...
<table width="1000px" align="center">
    ...
    <td align="center">
    <h3>
    <a href="/default/transaction/shelltran/index.cfm?tran=#url.tran#" ><img src="/images/Create.png" width="32" height="32" />&nbsp;Create Another Bill</a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<a href="##" onclick="window.close()"><img src="/images/Close.png" width="32" height="32" />&nbsp;Close</a>
    </h3>
    </td>
    </tr>
    <tr>
