...
function updateDetails(columnvalue){
		...
		<tr>
			...
			<th><cfif checkcustom.customcompany eq "Y">#getGsetup.rem6#<cfelseif lcase(HcomID) eq "vsolutionspteltd_i">Invoice No.<cfelseif lcase(HcomID) eq "aipl_i">Ref. Doc. No.<cfelse>Remark 6</cfif></th>
			<td><input type="text" name="remark6" value="#remark6#" maxlength="35" size="35"></td>
		</tr>
		<tr> 
			...
			<th><cfif checkcustom.customcompany eq "Y">#getGsetup.rem7#<cfelseif lcase(HcomID) eq "vsolutionspteltd_i">PO No<cfelse>Remark 7</cfif></th>
			<td><input type="text" name="remark7" value="#remark7#" maxlength="35" size="35"></td>
		</tr>
		<tr>
			...
			<th><cfif checkcustom.customcompany eq "Y">#getGsetup.rem8#<cfelseif lcase(HcomID) eq "vsolutionspteltd_i">Duration<cfelse>Remark 8</cfif></th>
			<td><input type="text" name="remark8" value="#remark8#" maxlength="35" size="35"></td>
		</tr>
		<tr> 
		...
		<tr> 
			<th><cfif lcase(HcomID) eq "chemline_i" and tran eq "ISS">Tel / Fax<cfelseif lcase(HcomID) eq "vsolutionspteltd_i">Email<cfelse>Remark 4</cfif></th>
