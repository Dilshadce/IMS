...
<body>
 ...
 <cfwindow name="approvesample" width="400" height="400" source="approvesample.cfm?tran=#tran#&refno={samid}" modal="true" title="Approval" closable="true" draggable="true" center="true" refreshonshow="true" />
  ...
  <cfif hcomid eq "asiasoft_i" and tran eq "SO" and (HUserGrpID eq "Admin" or HUserGrpID eq "Super" or HUserGrpID eq "General")>
...
<table align="center" class="data">
    ...
    <tr onMouseOut="javascript:this.style.backgroundColor='';" onMouseOver="javascript:this.style.backgroundColor='99FF00';">
        ...
        <cfif getdisplaysetup.bill_driver eq 'Y'>
        <td nowrap>#gettransaction.van#</td>
        </cfif>
        <cfif getdisplaysetup.bill_project eq 'Y'>
...
<cfif lcase(hcomid) eq "asiasoft_i" and tran eq 'SO' and toinv eq '' and printstatus eq 'a3'>Approved</cfif>
...
<font style="color:red">Attached</font>
        ...
        <div id="getdepositajax"></div>
            ...
            <a onMouseOver="JavaScript:this.style.cursor='hand';" onClick="window.open('paybill.cfm?type=#type#&refno=#refno#','_blank','height=630,width=700,scrollbar=yes,')">Pay</a>
                ...
                <cfif hcomid eq "asiasoft_i" and gettransaction.printstatus neq "a3"  and gettransaction.printstatus neq "REJECT" and tran eq "SO" and (HUserGrpID eq "Admin" or HUserGrpID eq "Super" or HUserGrpID eq "General")><a style="cursor:pointer" onClick="document.getElementById('soid').value='#refno#';ColdFusion.Window.show('approveso');"><img height="18px" width="18px" src="/images/tick.gif" alt="Edit" border="0">Approve</a>
