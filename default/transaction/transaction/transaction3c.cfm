  	...
  	<tr>
        ...
        <cfquery name="getformat" datasource="#getlistbill.company#">
			...
			<cfloop query="getformat">
				...
				<div align="center">
					<a href="/billformat/#dts#/#getlistbill.company#/preprintedformat.cfm?tran=#tran#&nexttranno=#nexttranno#&BillName=#getformat.file_name#&doption=#getformat.d_option#" target="_blank" <cfif getSetting.EDControl eq "Y"> onClick="ajaxFunction(window.document.getElementById('ajaxField'),'/default/transaction/examPass/updatePrint.cfm?tran=#tran#&nexttranno=#nexttranno#');"</cfif> ><font size="2"><strong>#getformat.display_name#</strong></font></a>
	        	...
	        	<cfdefaultcase> 
	 	      		<div align="center">
                        ...
                        <cfif tran neq "cs">
                            ...
                            <br/><br/>
                            <a href="../../billformat/#dts#/preprintedformat.cfm?tran=#tran#&nexttranno=#nexttranno#&company=Veillux"><font size="2"><strong><cfif tran eq 'PO'>Veillux Purchase Order<cfelseif tran eq 'CN'>Veillux Credit Note<cfelseif tran eq 'DN'>Veillux Debit Note<cfelseif tran eq 'SO'>Veillux Sales Order<cfelseif tran eq 'QUO'>Veillux Quotation<cfelse>Veillux View</cfif></strong></font></a>
                            <br/><br/>
                            <a href="../../billformat/#dts#/preprintedformat.cfm?tran=#tran#&nexttranno=#nexttranno#&company=Art"><font size="2"><strong><cfif tran eq 'PO'>Art Gallery Purchase Order<cfelseif tran eq 'CN'>Art Gallery Credit Note<cfelseif tran eq 'DN'>Art Gallery Debit Note<cfelseif tran eq 'SO'>Art Gallery Sales Order<cfelseif tran eq 'QUO'>Art Gallery Quotation<cfelse>Art Gallery View</cfif></strong></font></a>
                            
                            <br/><br/>
                            <a href="../../billformat/#dts#/preprintedformat.cfm?tran=#tran#&nexttranno=#nexttranno#&company=All"><font size="2"><strong><cfif tran eq 'PO'>All Logo Purchase Order<cfelseif tran eq 'CN'>All Logo Credit Note<cfelseif tran eq 'DN'>All Logo Debit Note<cfelseif tran eq 'SO'>All Logo Sales Order<cfelseif tran eq 'QUO'>All Logo Quotation<cfelse>All Logo View</cfif></strong></font></a>
                            </cfif>
                        <cfelse>
       ...
       <div align="center"> <a onMouseOver="this.style.cursor='hand'" onClick="ColdFusion.Window.show('chooseformat');"><font size="2"><strong>Email Format</strong></font></a></div>
    	...
    	<td <cfif lcase(hcomid) eq "SDC_i">style="visibility:hidden"</cfif>><div align="center"><a href="../../billformat/#dts#/transactionformat.cfm?tran=#tran#&nexttranno=#nexttranno#" <cfif getSetting.EDControl eq "Y">onClick="ajaxFunction(window.document.getElementById('ajaxField'),'/default/transaction/examPass/updatePrint.cfm?tran=#tran#&nexttranno=#nexttranno#');"</cfif>><font size="2"><strong><cfif tran eq 'PO'>Purchase Order<cfelseif tran eq 'CN'>Credit Note<cfelseif tran eq 'DN'>Debit Note<cfelseif tran eq 'SO'>Sales Order<cfelseif tran eq 'QUO'>Quotation<cfelse>View</cfif></strong></font></a>
        <br/>
