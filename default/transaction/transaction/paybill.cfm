...
<script language="javascript" type="text/javascript">
	...
	var cashamt = parseFloat(document.getElementById('paycash').value);
		...
		document.getElementById('balanceamt').value=(gtamt-cashamt).toFixed(2);
...
<option value="#getdepositno.depositno#" <cfif xdepositno eq getdepositno.depositno>selected</cfif>>#getdepositno.depositno#</option>
</cfloop>
</select>
