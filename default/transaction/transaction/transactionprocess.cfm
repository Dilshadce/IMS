...
<cfset dispriceno = numberformat(dispriceno,'.__')>
<cfset netamttemp = numberformat(dispriceno * val(form.qty),'.__')>
<cfset disamt_bil = numberformat(val(form.price) * val(form.qty),'.__') - netamttemp>
...
<cfif getitem.wserialno eq "T" and (tran neq "QUO" and tran neq "SO" and tran neq "PO" and tran neq "SAM" and tran neq "RQ")>
