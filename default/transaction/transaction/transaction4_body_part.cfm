...
function settaxcode()
	...
	document.getElementById('pri6').value=document.getElementById('sdcoriprice').value*document.getElementById('creq4').value
	}
...
<table align='center' class='data' width='85%' cellspacing="0">
    ...
    <tr>
    	...
    	<td <cfif getdisplaysetup2.body_bal_on_hand neq "Y">style="visibility:hidden"</cfif>><input name='balance' id='balance' type='text' size='10' maxlength='10' value='#listfirst(balonhand)#' readonly></td>
    </tr>
    <tr>
    ...
    <tr>
        ...
        <td colspan='2'>
            ...
            <cfif lcase(hcomid) neq "mastercare_i" and lcase(hcomid) neq "gorgeous_i">
                ...
                <br />
                <input type="button" name="Extend Comment" value="Extend Comment" onClick="javascript:ColdFusion.Window.show('extendcomment');"><br />
                <input type="button" name="createComment" value="Create New Comment" onClick="window.open('/default/maintenance/commenttable2.cfm?type=Create')">
    ...
    <cfquery name="checkpromotion2" datasource="#dts#">
        ...
        <input name="amt" id="amt" tabindex="6" type='text' size='10' maxlength='10' value='#numberformat(amt,".__")#'<cfif lcase(hcomid) eq "gel_i" and husergrpid neq "Admin" and husergrpid neq "Super">readonly</cfif> onkeyup="getDiscount2();">
        <cfelse>
			<input name="amt" id="amt" tabindex="6" type='text' size='10' maxlength='10' value='#numberformat(amt,".__")#'<cfif lcase(hcomid) eq "gel_i" and husergrpid neq "Admin" and husergrpid neq "Super">readonly</cfif> onkeyup="getDiscount();">
            </cfif>
           	</td>
            <cfelseif getpin2.h1361 eq 'T' and (tran eq 'INV' or tran eq 'DO' or tran eq 'CS' or tran eq 'CN' or tran eq 'DN' or tran eq 'QUO' or tran eq 'SO' or tran eq 'SAM')>
    ...
    <tr>
        <th <cfif getdisplaysetup2.body_location neq "Y">style="visibility:hidden"</cfif>><cfif lcase(hcomid) eq "mhca_i">Marketer<cfelseif lcase(hcomid) eq "nikbra_i">Dept Code<cfelse>Location</cfif></th>
		<input type="hidden" name="oldlocation" value="#xlocation#">
        <td <cfif getdisplaysetup2.body_location neq "Y">style="visibility:hidden"</cfif>>
			<cfif multilocation eq "Y" and is_service neq 1>
        ...
        <td <cfif getdisplaysetup2.body_gl_ac neq "Y">style="visibility:hidden"</cfif>><input name='gltradac' id="glt6"  type='text' value='#gltradac#' size='10' maxlength='8'></td>
        <cfif getpin2.h1360 eq 'T' and (tran eq 'PO' or tran eq 'RC' or tran eq 'PR' or tran eq 'RQ')>
    ...
    <tr>
        <th nowrap <cfif getdisplaysetup2.body_serialno neq "Y">style="visibility:hidden"</cfif>>#getgeneralinfo.brem1#</th>
        ...
        <th nowrap <cfif getdisplaysetup2.body_remark2 neq "Y">style="visibility:hidden"</cfif>>#getgeneralinfo.brem2#</th>
        <cfif lcase(hcomid) eq "SDC_i">
        ...
        <cfelse>
        <td nowrap <cfif getdisplaysetup2.body_remark2 neq "Y">style="visibility:hidden"</cfif>> <input type='text' name='crequestdate' id="creq4"  maxlength='40' value='<cfif (lcase(hcomid) eq "marquis_i" or lcase(HcomID) eq "hempel_i") and isdefined('form.importpermit')>#form.importpermit#<cfelse>#convertquote(brem2)#</cfif>' size='20'>        </td>
        </cfif>
        <td></td>
        <cfif getpin2.h1360 eq 'T' and (tran eq 'PO' or tran eq 'RC' or tran eq 'PR' or tran eq 'RQ')>
    ...
    <tr>
        <th <cfif getdisplaysetup2.body_remark3 neq "Y">style="visibility:hidden"</cfif>>#getgeneralinfo.brem3#</th>
        <td <cfif getdisplaysetup2.body_remark3 neq "Y">style="visibility:hidden"</cfif>><cfif lcase(hcomid) eq "aimpest_i"><textarea name='brem3' id="br36" size='20' rows="3">#convertquote(brem3)#</textarea> <cfelse> 
        ...
        <td <cfif getdisplaysetup2.body_remark4 neq "Y">style="visibility:hidden"</cfif>><cfif lcase(hcomid) eq "aimpest_i"><textarea name='brem4' id="br46" size='20' rows="3">#convertquote(brem4)#</textarea><cfelse><input type='text' name='brem4' id="br46" maxlength='40' value='#convertquote(brem4)#' size='20'></cfif></td>
        <td>&nbsp;</td>
         <cfif getpin2.h1360 eq 'T' and (tran eq 'PO' or tran eq 'RC' or tran eq 'PR' or tran eq 'RQ')>
        <td <cfif lcase(hcomid) eq "visionlaw_i">style="visibility:hidden"</cfif>>
			<cfif (lcase(hcomid) eq "ideal_i" or lcase(hcomid) eq "idealb_i") and husergrpid neq "Admin" and husergrpid neq "Super">
    ...
    <tr>
		...
		<cfelse>
            ...
            <td <cfif getdisplaysetup2.body_nodisplay neq "Y">style="visibility:hidden"</cfif>><input type='checkbox' name='nodisplay' id="nodisplay" value='Y' <cfif nodisplay eq "Y">checked</cfif>></td>
            <cfif tran eq "CN">
    ...
    <cfif tran eq 'PO'>
		<tr>
	        ...
	        <td <cfif getdisplaysetup2.body_requiredate neq "Y">style="visibility:hidden"</cfif>>
				<input type='text' name='requiredate' id="requiredate" maxlength='40' value="#requiredate#" size='10' readonly>	<img src="/images/cal.gif" width=17 height=15 border=0 onClick="showCalendarControl(requiredate);">		</td>
	        ...
	        <td <cfif getdisplaysetup2.body_replydate neq "Y">style="visibility:hidden"</cfif>>
				<input type='text' name='replydate' id="replydate" maxlength='40' value="#replydate#" size='10' readonly> <img src="/images/cal.gif" width=17 height=15 border=0 onClick="showCalendarControl(replydate);">			</td>
	    </tr>
    <cfelse>
    <input type='hidden' name='requiredate' id="requiredate" maxlength='40' value="" size='10' readonly>
    <input type='hidden' name='replydate' id="replydate" maxlength='40' value="" size='10' readonly>
    </cfif>
    <cfif tran eq 'SO'>
        <tr>
	        ...
	        <td <cfif getdisplaysetup2.body_deliverydate neq "Y">style="visibility:hidden"</cfif>>
				<input type='text' name='deliverydate' id="deliverydate" maxlength='40' value="#deliverydate#" size='10' readonly> <img src="/images/cal.gif" width=17 height=15 border=0 onClick="showCalendarControl(deliverydate);"></td>
	    </tr>
     <cfelse>
	...
	<!--- ADD ON 10-12-2009 --->
	<tr>
		<th <cfif getdisplaysetup2.body_project neq "Y">style="visibility:hidden"</cfif>><!--- Project / Job --->#getGeneralInfo.lPROJECT# / #getGeneralInfo.lJOB#</th>
		<td colspan="3" <cfif getdisplaysetup2.body_project neq "Y">style="visibility:hidden"</cfif>>
            ...
            <cfset glac = "cashsales">
                ...
                <br /><a onClick="ColdFusion.Window.show('createProjectAjax');" onMouseOver="this.style.cursor='hand';" >Create New Project</a>&nbsp;&nbsp;&nbsp;&nbsp;<a onClick="ColdFusion.Window.show('createJobAjax');" onMouseOver="this.style.cursor='hand';" >Create New Job</a>	</td>
			</cfif>	
        <cfif wpitemtax eq "Y">
	...
	<tr>
        <th <cfif getdisplaysetup2.body_titledesp neq "Y">style="visibility:hidden"</cfif>>&nbsp;</th>
        <td colspan="3" <cfif getdisplaysetup2.body_titledesp neq "Y">style="visibility:hidden"</cfif>>
			<cfif lcase(hcomid) eq "topsteel_i" or lcase(HcomID) eq "topsteelhol_i" or lcase(hcomid) eq "kingston_i" or lcase(hcomid) eq "cstct_i" or lcase(hcomid) eq "vsolutionspteltd_i" or lcase(hcomid) eq "ascend_i">
...
<script type="text/javascript">
<cfif lcase(hcomid) eq "topsteelhol_i" or lcase(hcomid) eq "topsteel_i">checkqtytopsteel();<cfelse>checkqty();</cfif>
