...
<cfoutput>
    ...
    <cfset xformat=len(serialnoto)>
    <cfset xformat2="">
    <cfloop from="1" to="#xformat#" index="i">
    <cfset xformat2=xformat2&"0">
    </cfloop>
...
<!---	<cfif len(serialnofr) gt 5>
	...
	<cfif len(serialnofr) gt 5>
	<cfset serialnum = prefix&numberformat(left(serialnofr,serialleftlength),xformat2)&i&endfix>
	<cfelse>
	<cfset serialnum = prefix&numberformat(i,xformat2)&endfix>
    </cfif>--->
