		...
		<cftry>
			...
			<cfif trim(column1) neq "">
				<cfquery name="inserticitem" datasource="#dts#">
					...
					values
					(<cfqueryparam cfsqltype="cf_sql_varchar" value="#column1#">,<cfqueryparam cfsqltype="cf_sql_varchar" value="#column2#">,<cfqueryparam cfsqltype="cf_sql_varchar" value="#column3#">,<cfqueryparam cfsqltype="cf_sql_varchar" value="#column4#">,<cfqueryparam cfsqltype="cf_sql_varchar" value="#column5#">,<cfqueryparam cfsqltype="cf_sql_varchar" value="#column6#">,<cfqueryparam cfsqltype="cf_sql_varchar" value="#column7#">,'', '#val(column9)#', '#val(column10)#', '#val(column11)#', '#val(column12)#', '#val(column13)#',<cfqueryparam cfsqltype="cf_sql_varchar" value="#column14#">, '#val(column15)#')
