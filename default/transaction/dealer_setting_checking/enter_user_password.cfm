...
<script language="javascript">
	...
	function check(){
		...
		if(password==''){
			...
			if(document.getElementById('password').value!=document.getElementById('hidpassword').value)
			{
...
<cfform name="check_password" action="" method="post">
	<table width="50%" align="center" class="data" border="0" cellpadding="1" cellspacing="0">
		...
		<tr>
			...
			<cfoutput><input type="hidden" name="hidpassword" id="hidpassword" value="#check.password#"></cfoutput>
        </tr>
		<tr>
