...
<cfquery name="getassignment" datasource="#dts#" cachedwithin="#createtimespan(0,0,1,0)#">
SELECT * from assignmentslip 
where <!---invoiceno='' 
and custtotalgross<>0
and year(assignmentslipdate)=2017 
and month(assignmentslipdate)=2 
and left(refno,1)='s' 
and assignmenttype <> 'invoice'
and custname like '%venture%'--->
refno in (
<!---'S0209357',
'S0209351',
'S0209350',
...
<cfif getassignment.assignmenttype neq 'invoice'>
            ...
            <cfquery name="checkinvoiceexist" datasource="#dts#">
                  ...
                  and day(created_on)=14
                  and month(created_on)=3
...
<cfquery name="insertartran" datasource="#dts#">
                        ...
                        <cfqueryparam cfsqltype="cf_sql_varchar" value="2017-02-28">,
