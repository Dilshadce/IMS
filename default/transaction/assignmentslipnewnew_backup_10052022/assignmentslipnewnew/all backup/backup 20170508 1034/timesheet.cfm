...
<cfset dts2=replace(dts,'_i','','all')>
 <cfquery name="company_details" datasource="payroll_main">
        ...
        <cfset currentdate = createdate(val(company_details.myear),val(company_details.mmonth-1),1)>
       
        <cfif isdefined('url.yearval')>
        <cfset currentdate = createdate(val(url.yearval),val(url.monthval),1)>
        <cfset company_details.mmonth = val(url.monthval) >
		</cfif>
...
<cfset endno = mid(trim(getplacementlist.timesheet),4,2)>
        ...
        <cfoutput>
        <cfif isdefined('url.yearval') eq false>
        <h1>No Time Sheet Assigned. Please Contact Business Edge!</h1></cfif>
        </cfoutput>
        <cfif isdefined('url.yearval') eq false>
        <cfabort>
        </cfif>
...
<form name="form1" id="form1" method="post" action="tsprocess.cfm">
<table border=0 cellpadding=0 cellspacing=0 width=735 style='border-collapse:
 ...
 <tr height=26 style='height:18.5pt'>
  ...
  <td colspan=10 class=xl1138828 width=669 style='width:502pt'>
<cfif isdefined('url.yearval') eq false>
<!---<cfif gettimesheet.editable eq "Y">--->TIME SHEET EXIST! RETRIEVE DATA FROM TIME SHEET?<br />
<input type="button" name="btn1" id="btn1" value="YES" onClick="if(confirm('Are You Sure You WANT to retrieve from time sheet?')){processtimesheet('#url.placementno#','#url.empno#');ColdFusion.Window.hide('timesheet');}"/>&nbsp;&nbsp;&nbsp;&nbsp; <input type="button" name="btn1" id="btn1" value="NO" onClick="if(confirm('Are You Sure You DONT WANT to retrieve from time sheet?')){getpanel('#url.placementno#');ColdFusion.Window.hide('timesheet');}"/>
<!---</cfif>--->
</cfif>
 ...
 <tr height=20 style='height:14.0pt'>
  <td colspan=2 rowspan=3 height=60 class=xl1188828 style='border-right:.5pt solid black;
  border-bottom:.5pt solid black;height:40.0pt'>Client</td>
 ...
 <tr height=20 style='height:14.0pt'>
  <td colspan=7 height=20 class=xl1028828 style='height:14.0pt;border-left:
 ...
 <tr height=20 style='height:14.0pt'>
  ...
  height:14.0pt;border-left:none'>#getplacementlist.empname#</td>
 ...
 <tr height=20 style='height:14.0pt'>
  <td height=20 class=xl748828 style='height:14.0pt;border-top:none'>#dateformat(gettimesheet.assigndate,'dd/mm/yyyy')#</td>
  <td class=xl158828></td>
  <td class=xl158828></td>
 </tr>
 <tr height=20 style='height:14.0pt'>
  <td colspan=8 height=20 class=xl1038828 style='height:14.0pt'></td>
...
(Full Day/AM/PM)</td>
    ...
    <input type="hidden" name="updatefile" id="updatefile" value="">
     <cfloop query="gettimesheet">
           ...
           <input type="hidden" name="day#gettimesheet.tsrowcount#" id="day#gettimesheet.tsrowcount#" value="#dateformat(currentdate,'yyyy-mm-dd')#">
            ...
            <tr height=20 style='height:14.0pt'>
  <td height=20 class=xl948828 style='height:14.0pt;border-top:none;<cfif gettimesheet.recordcount eq gettimesheet.currentrow>; border-bottom:.5pt solid black;</cfif>'><cfif startmonth neq dateformat(currentdate,'Mmm - yyyy')>#dateformat(currentdate,'Mmm - yyyy')#<cfset startmonth = dateformat(currentdate,'Mmm - yyyy')></cfif></td>
 ...
 <tr height=20 style='height:14.0pt'>
  ...
  height:14.0pt;width:336pt'>Total hours for the period (exclude breaks)</td>
 ...
 <tr height=20 style='height:14.0pt'>
  <td height=20 class=xl158828 style='height:14.0pt'></td>
 ...
 <tr height=20 style='height:14.0pt'>
  <td colspan=12 rowspan=2 height=40 class=xl658828 width=735 style='border-right:
  .5pt solid black;border-bottom:.5pt solid black;height:30.0pt;width:552pt'>Please
  email / fax completed &amp; stamped timesheet to with all supporting documents &quot;timesheet@businessedge.com.sg&quot; / fax ## 6745-8955<br>
