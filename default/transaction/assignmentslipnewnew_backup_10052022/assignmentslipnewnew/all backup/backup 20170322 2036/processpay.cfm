...
<cfset basicpay = val(url.basicpay)+val(url.selfphnlsalary) >
           ...
           <cfset OT6 = roundno(OT6,'#get_now_month.sud_otrnd#','#get_now_month.sud_otpsu#')>
	        ...
	        <cfif epfno neq "" and epfcat neq "X" and fix_cpf eq 0 and epf_selected neq 0>
                ...
                payin bonus added:<cfdump var="#PAYIN#"><br>
				...
				<cfif left(dts,12) eq 'manpowertest'>
					<cfoutput>
					<br>
					epf_yer:<cfdump var="#epf_yer#"><br>
					<br>
					epf_yee:<cfdump var="#epf_yee#"><br>
					</cfoutput>
				</cfif>
		      ...
		      <!---   cpf amount not round --->
				...
				<br>
					...
					epf_yee:<cfdump var="#epf_yee#"><br>
				<br>
                2. PAYIN:<cfdump var="#PAYIN#"><br>
                <br>
                EPFY:<cfdump var="#EPFY#"><br>
				<br>
...
<!--- 		        <cfif epf1hd eq "Y">
				...
				<cfif left(dts,12) eq 'manpowertest'>
				<cfoutput>
                final EPFY:<cfdump var="#EPFY#"><br>
				<br>
                final EPFW:<cfdump var="#EPFW#"><br>
                </cfoutput>
				</cfif>
            ...
            <cfelse>
                ...
                <cfloop query="getcurrentassign">
					<cfif right(trim(getcurrentassign.emppaymenttype),1) lt right(weekpay,1)>
						...
						<cfif left(dts,12) eq 'manpowertest'>
							<cfoutput>
							<br>
							totalsocso:<cfdump var="#totalsocso#"><br>
							</cfoutput>
						</cfif>
				...
				<cfif left(dts,12) eq 'manpowertest'>
					<cfoutput>
					<br>
					socso_rate:<cfdump var="#socso_rate#"><br>
					</cfoutput>
				</cfif>
