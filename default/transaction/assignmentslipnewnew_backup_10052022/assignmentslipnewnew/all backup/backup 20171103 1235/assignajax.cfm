 ...
 <!---   <input type="hidden" name="startdate" id="startdate" value="#lsdateformat(url.startdate, 'yyyy-mm-dd', 'en_AU')#">
    ...
    <tr> 
      ...
      <input type="button" id="calculateemppay" name="calculateemppay" value="Calculate Employee Pay" <cfif posted eq "P">disabled </cfif> onClick="<cfif locked eq "Y">alert('This Assignment Has Been Locked')<cfelseif combine eq "Y">alert('This Assignment Has Been Combine')<cfelseif posted neq "P">checkpay()<cfelse>alert('This assignment has been posted!')</cfif>;">&nbsp;&nbsp;&nbsp;&nbsp;
        ...
        <input name="submit1" id="submit1" type="button" onClick="this.disabled=true;<cfif combine eq "Y">alert('This Assignment Has Been Combine')<cfelse>submitform()</cfif>;" value="  #button#  " <cfif url.type eq "create" or posted eq "P">disabled</cfif>>
          &nbsp;&nbsp;&nbsp;&nbsp;
          <input name="submit2" id="submit2" type="button" onClick="this.disabled=true;<cfif combine eq "Y">alert('This Assignment Has Been Combine')<cfelse>submitform2();</cfif>"  value="#button# and Create New"<cfif url.type eq "create" or posted eq "P">disabled</cfif>>
        </cfoutput></td>
    </tr>
    </cfif>
</table>