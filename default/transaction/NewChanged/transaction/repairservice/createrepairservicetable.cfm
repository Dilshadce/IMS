...
<html>
<head>
	<title>Create Repair Service</title>
...
<cfoutput>
	...
	<cfswitch expression="#url.type#">
        ...
        select max(repairno) as repairno from Repairtran
        </cfquery>
	...
	<cfform name="repairserviceform" action="createrepairservicetableprocess.cfm" method="post">
		...
		<h1 align="center">Create Repair Service</h1>
		...
		<table align="center" class="data" width="70%">
            ...
            <tr>
            <th nowrap></th>
            <td><input type="text" name="b_add2" id="b_add2" value="" maxlength="35" size="40">
                </td>
            ...
            <tr>
            <th nowrap></th>
            <td><input type="text" name="b_add3" id="b_add3" value="" maxlength="35" size="40">
                </td>
            ...
            <tr>
            <th nowrap></th>
            <td><input type="text" name="b_add4" id="b_add4" value="" maxlength="35" size="40">
                </td>
            ...
            <tr>
            <th nowrap>Phone</th>
            <td><input type="text" name="b_phone" id="b_phone" value="" maxlength="25" size="40">
                </td>
...
<input type="button" id="searchitembtn" onClick="ColdFusion.Window.show('searchrepairitem');getfocus2();" value="Search" align="right" />
				</td>
      		</tr>
            <tr>
        		<th>Description</th>
            ...
            <tr>
        		<td align="center" colspan="100%"><cfinput name="subbtn" id="subbtn" type="submit" value="  #button#  "></td>
      		</tr>
            </table>
