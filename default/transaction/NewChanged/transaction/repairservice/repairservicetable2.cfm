...
<cfoutput>
    ...
    select refno from artran where type='RC' and refno='#repairno#'
    </cfquery>
	...
	<cfform name="repairserviceform" action="repairservicetableprocess.cfm" method="post">
		...
		<table align="center" class="data" width="70%">
            ...
            <td>
                <cfinput type="text" name="wos_date" size="10" value="#dateformat(now(),"dd/mm/yyyy")#" validate="eurodate" maxlength="10">(DD/MM/YYYY) 
                </td>
      		</tr>
            ...
            <tr>
        		<th>Address:</th>
        		<td><input type="text" name="b_add1" id="b_add1" value="#add1#" maxlength="35" size="40">
				</td>
                <th>Estimated Completion Date :</th>
                <td>
                <cfinput type="text" name="completedate" size="10" value="#dateformat(completedate,"dd/mm/yyyy")#" readonly maxlength="10">(DD/MM/YYYY) 
                </td>
      		</tr>
            
            <tr>
            <th></th>
        		<td><input type="text" name="b_add2" id="b_add2" value="#add2#" maxlength="35" size="40">
				</td>
            <th>Delivery Status</th>
            <td>
            <cfinput type="text" size="40" name="deliverystatus" id="deliverystatus" value="#deliverystatus#" required="no" maxlength="40" readonly>
            </td>
            </tr>
            ...
            <tr>
            <th></th>
        		<td><input type="text" name="b_add3" id="b_add3" value="#add3#" maxlength="35" size="40">
				</td>
            ...
            <tr>
            <th></th>
        		<td><input type="text" name="b_add4" id="b_add4" value="#add4#" maxlength="35" size="40">
				</td>
            ...
            <tr>
        		<th>Phone:</th>
        		<td><input type="text" name="b_phone" id="b_phone" value="#phone#" maxlength="35" size="40">
				</td>
            ...
            <tr>
            <th>HP:</th>
        		<td><input type="text" name="b_phone2" id="b_phone2" value="#phonea#" maxlength="35" size="40">
				</td>
            ...
            <tr>
            <th>FAX:</th>
        		<td><input type="text" name="b_fax" id="b_fax" value="#fax#" maxlength="35" size="40">
				</td>
            ...
            <tr>
        		<th>Item No</th>
        		<td><cfinput type="text" name="repairitem" id="repairitem" size="26" value="#repairitem#" readonly required="yes" message="Please choose item to repair"/>
				</td>
      		</tr>
            <tr>
        		<th>Description</th>
        		<td><cfinput type="text" name="desp" id="desp" value="" size="70" maxlength="100" readonly/>
				</td>
      		</tr>
            <tr>
        		<th>Location</th>
...
SELECT * FROM repairdet WHERE repairno = <cfqueryparam cfsqltype="cf_sql_varchar" value="#repairno#"> order by trancode desc
</cfquery>
...
SELECT sum(qty_bil)as sumqty FROM repairdet WHERE repairno = <cfqueryparam cfsqltype="cf_sql_varchar" value="#repairno#"> order by trancode desc
</cfquery>
</table>
</div>
</td>
