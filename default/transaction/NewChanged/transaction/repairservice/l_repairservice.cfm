...
<cfquery name="getGroup" datasource="#dts#">
  select * from repairtran
  <cfif form.groupfrom neq "" and form.groupto neq "">
	where repairno >= '#form.groupfrom#' and repairno <= '#form.groupto#'
  </cfif>
  order by repairno
</cfquery>
  ...
  <cfif getGroup.recordCount gt 0>
	...
	<table width="95%" border="0" class="" align="center">
	  ...
	  <tr>
        ...
        <td><strong><font size="2" face="Arial, Helvetica, sans-serif"><cfoutput>Repair No</cfoutput></font></strong></td>
	  ...
	  <cfloop query="getGroup">
	    ...
	    <tr>
	      ...
	      <td><cfif getpin2.h1511 eq 'T'><a href="Packagetable2.cfm?type=Edit&packcode=#packcode#">#repairno#</a><cfelse>#repairno#</cfif></td>
	      <td>#desp#</td>
