<html>
<head>
	<title>Maintenance Repair Transaction</title></title>
...
<h1>View Repair Informations</h1>
...
<cfoutput>
	...
	|| <a href="s_repairservicetable.cfm?type=package">Search For Repair Transaction</a>
		...
		<cfoutput query="getPersonnel" startrow="#start#" maxrows="5">
			...
			<table align="center" class="data" width="50%">
				...
				<tr>
					...
					<a href="repairservicetable2.cfm?type=Delete&repairno=#evaluate(strNo)#"><img height="18px" width="18px" src="/images/delete.ICO" alt="Delete" border="0">Delete</a>
			  		<a href="repairservicetable2.cfm?type=Edit&repairno=#evaluate(strNo)#"><img height="18px" width="18px" src="/images/edit.ICO" alt="Edit" border="0">Edit</a></div></td>
        		</tr>
				</cfif>
     	 	</table>
			<br>
