        ...
        <div id="getdepositajax"></div>
	      	<td align="left" nowrap>
                ...
                <img height="18px" width="18px" src="../../images/edit.ICO" alt="Not Allowed to Edit" border="0">Edit
                    ...
                    <a onMouseOver="JavaScript:this.style.cursor='hand';" target="mainFrame" onClick="window.open('expresstranedit/index.cfm?tran=#tran#&ttype=Edit&refno=#refno#&custno=#URLEncodedFormat(gettransaction.custno)#&first=0','','fullscreen=yes,scrollbars=yes')">
