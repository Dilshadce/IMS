...
SELECT filterall,ECAOTA,ECAMTOTA,negstk,PCBLTC,ddlbilltype,expressdisc,displaycostcode,ldriver,autonextdate,ddllocation ,rem5,rem6,rem11 FROM gsetup
</cfquery>
...
<td><cfif hcomid eq "hairo_i"><input type="text" name="wos_date" id="wos_date" value="#dateformat(datenow,'DD/MM/YYYY')#" onKeyUp="nextIndex('wos_date','searchitembtn');" /><cfelse><input type="text" name="wos_date" id="wos_date" value="#dateformat(datenow,'DD/MM/YYYY')#" onKeyUp="nextIndex('wos_date','expressservicelist');" /></cfif><img src="/images/cal.gif" width=17 height=15 border=0 onClick="showCalendarControl(wos_date);">&nbsp;(DD/MM/YYYY)</td>
<td></td>
...
<td width="20%"><input type="text" name="desp2" id="desp2" size="40" onKeyUp="nextIndex('desp','<cfif lcase(hcomid) eq "hairo_i">expqty<cfelse>expcomment</cfif>');" ></td>
<td width="1%">&nbsp;</td>
...
<tr>
  ...
  <td><cfselect name="taxcode" id="taxcode" bind="CFC:tax.getTaxQry('#dts#','#target_taxtable#',{tran})" value="code" display="code" onChange="setTimeout('caltax()',500);" bindonload="yes"/>&nbsp;&nbsp;<cfinput type="#inputtype#" name="taxper" id="taxper" value="0" size="8" bind="CFC:tax.getTax('#dts#','#target_taxtable#',{taxcode})" onKeyUp="caltax()" bindonload="yes"  />&nbsp;&nbsp;&nbsp;
