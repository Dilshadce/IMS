...
<body>
    ...
    <cfif lcase(HcomID) eq "shell_i">
        ...
        ||<a href="unclosequo.cfm">Unclose #tranname#</a>
         ...
         <cfif alsimple eq 1>
         <cfif tran eq 'INV'>
         <cfif getGeneralInfo.simpleinvtype eq '2'>
         ...
         <cfif alsimple eq 1>
         <cfif lcase(HcomID) eq "ltm_i" or lcase(HcomID) eq "imperial1_i" or lcase(HcomID) eq "coolnlite_i" or lcase(HcomID) eq "sosbat_i" or lcase(hcomid) eq "netivan_i">
...
<cfif tran eq "DO">
		...
		<h2>
			<cfif getpin2.h28G5 eq 'T'>
				<a href="update/update.cfm?t1=RQ&t2=PO"><img src="../../images/arrow.png" alt="Update to Purchase Order" name="updateBtn4" border="0"> Update To #getGeneralInfo.lPO#</a>&nbsp;&nbsp;&nbsp;&nbsp;
			</cfif>
        </h2>
        </cfif>
		<cfif tran eq "SO">
		<h2>
			...
			<cfif getpin2.h2887 eq 'T'>
                ...
                <a href="update/update.cfm?t1=SO&t2=RC"><img src="../../images/arrow.png" alt="Update to Purchase Receive" name="updateBtn6" border="0"> Update To #getGeneralInfo.lRC#</a>
				<a href="update/update.cfm?t1=SO&t2=RQ"><img src="../../images/arrow.png" alt="Update to Purchase requisition " name="updateBtn6" border="0"> Update To #getGeneralInfo.lRQ#</a>
            ...
            <cfif getpin2.H2879 eq 'T'>
				<a href="update/update.cfm?t1=SO&t2=CS"><img src="../../images/arrow.png" alt="Update to Cash Sales" name="updateBtn8" border="0"> Update To #getGeneralInfo.lCS#</a>
			</cfif>
		</h2>
		</cfif>
		<cfif tran eq "QUO">
