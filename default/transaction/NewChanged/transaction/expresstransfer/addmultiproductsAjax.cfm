...
<cfquery name="insertictran2" datasource="#dts#">
	insert into ictrantemp
	(
		type,
        refno,
...
SELECT SUM(amt1_bil) as sumsubtotal,count(itemno) as countitemno FROM ictrantemp where uuid = <cfqueryparam cfsqltype="cf_sql_varchar" value="#uuid#" /> and type='TROU'
</cfquery>
