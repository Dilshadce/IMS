...
SELECT printed,custno,printstatus,permitno FROM artran where refno = <cfqueryparam cfsqltype="cf_sql_varchar" value="#url.nexttranno#"> and type =<cfqueryparam cfsqltype="cf_sql_varchar" value="#url.tran#" >
</cfquery>
...
<table width="50%" border="0" cellspacing="0" cellpadding="0" align="center" class="data">
    ...
    <a href="stransaction.cfm?tran=#tran#" target="_self" >
...
<cfif tran eq "SAM">
	...
	<cfif getpin2.h2852 eq 'T'>
  		<cfset aledit = 1>
                    ...
                    <a href="javascript:void(0)" onClick="PopupCenter('editbillcontrol.cfm?tran=#tran#&refno=#nexttranno#&parentpage=no','linkname','300','150');"><font size="2"><b>Edit</b></font></a>
                    <cfelse>
         ...
         <cfif lcase(hcomid) eq "net_i" or lcase(hcomid) eq "demo_i">
