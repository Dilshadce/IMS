...
<cfelse>
 ...
 <cfquery name="getitem2" datasource="#dts#">
	...
	<cfset amt1_bil = val(bmqty) * val(itemprice) * val(currrate)>
	<cfset totalprice = val(totalprice) + val(amt1_bil)>
</cfoutput>
...
<cfoutput> 
	...
	<table align="center" class="data">
    	...
    	<cfoutput> 
        <tr><th>#getgeneralinfo.brem1#</th><td><input type="text" name="brem1" id="brem1" value=""></td><th>#getgeneralinfo.brem2#</th><td>
        ...
        <input type="text" name="brem2" id="brem2" value=""></td></tr>
      	</cfif>
        <tr> 
        	<th></th>
        	<td></td>
