...
SELECT desp,unit,unit2,unit3,unit4,unit5,unit6,price,ucost,price2,price3,price4,comment from icitem where itemno = <cfqueryparam cfsqltype="cf_sql_varchar" value="#trim(url.itemno)#">
<cfif Hitemgroup neq ''>
