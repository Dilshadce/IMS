...
<td style="font-size:16px;">:</td>
<td style="font-size:16px;" align="left">
<input type="text" name="hidrem5" id="hidrem5" value="" maxlength="10" size="10" onblur="validatedate('hidrem5')" />
<input type="button" name="generatedatetime" id="generatedatetime" onclick="document.getElementById('hidrem5').value='#dateformat(now(),'DD/MM/YYYY')#'" value="Set Date" />
</td>
</tr>
...
<td style="font-size:16px;">:</td>
<td style="font-size:16px;" align="left">
<input type="text" name="hidrem6" id="hidrem6" value="" maxlength="80" size="30" />
</td>
</tr>
...
<td style="font-size:16px;">:</td>
<td style="font-size:16px;" align="left">
<input type="text" name="hidrem7" id="hidrem7" value="" maxlength="2" size="5" />
</td>
</tr>
...
<td style="font-size:16px;">:</td>
<td style="font-size:16px;" align="left">
<input type="text" name="hidrem8" id="hidrem8" value="" maxlength="2" size="5" />
</td>
</tr>
...
<td style="font-size:16px;">:</td>
<td style="font-size:16px;" align="left">
<input type="text" name="hidrem9" id="hidrem9" value="" maxlength="80" size="30" />
</td>
</tr>
...
<td style="font-size:16px;">:</td>
<td style="font-size:16px;" align="left">
<input type="text" name="hidrem10" id="hidrem10" value="" maxlength="200" size="50" />
</td>
</tr>
