...
<cfform name="customerform" height="100%" width="100%" action="/default/transaction/expressatc/index.cfm?first=true&type=SO&custno=#URLEncodedFormat(custno)#" target="new"  method="post">
...
<th>Postal Code</th><td>:</td><td><input type="text" style="font-size:10px" name="d_postalcode" id="d_postalcode" value="#getlist.postalcode#" maxlength="35" size="40"></td>
</tr>
<tr>
<th>Tel</th>
<td>:</td>
...
<td colspan="6"><input type="submit" name="createsobtn" id="createsobtn" value="Create Job Order" onClick="window.location.href='/default/transaction/expressatc/searchmember.cfm'"/></td>
