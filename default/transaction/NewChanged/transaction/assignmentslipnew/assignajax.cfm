...
and startdate >= "#dateformatnew(URLDECODE(url.startdate),'YYYY-MM-DD')#"
and enddate <= "#dateformatnew(URLDECODE(url.enddate),'YYYY-MM-DD')#"
</cfif>
...
hol_date >= "#dateformatnew(URLDECODE(url.startdate),'YYYY-MM-DD')#"
and hol_date <="#dateformatnew(URLDECODE(url.enddate),'YYYY-MM-DD')#"
</cfquery>
...
<cfset datestartwork = createdate(year(datestartwork),month(datestartwork),day(datestartwork))>
    ...
    <cfset employerpay = evaluate('getplacement.employer_rate_#i#')>
        ...
        <cfset activateeffcal = 1>
			<cfset totalday = datediff('d',datestartof,dateendof) + 1>
            <cfset countdays = 0>
            <cfset noofdayscount = datediff('d',datestartof,datestartwork)-1>
			<cfset newdaycount = val(getplacement.wd_p_week)>
            <cfset gethalfday = 0>
            <cfif newdaycount mod 1 eq "0.5">
            <cfset newdaycount = val(getplacement.wd_p_week) - 0.5>
            <cfset gethalfday =  val(getplacement.wd_p_week) + 0.5>
            </cfif>
            <cfset dayslist = "">
            <cfloop from="1" to="#newdaycount#" index="aa">
            <cfset adddays = aa + 1>
            <cfset dayslist = dayslist&adddays>
            <cfif aa neq newdaycount>
            ...
            <cfset noofdayscount = datediff('d',datestartwork,dateendof)>
			<cfset newdaycount = val(getplacement.wd_p_week)>
            <cfset gethalfday = 0>
            <cfset countdays = 0>
            <cfif newdaycount mod 1 eq "0.5">
            ...
            <cfset oldratedaynew = day(datestartwork) - day(datestartof)>
            <cfloop from="0" to="#val(oldratedaynew)-1#" index="a">
            <cfset currentdate = dateadd('d','#a#',datestartof)>
            <cfset firsteffdatelist = firsteffdatelist&dateformat(currentdate,'dd/mm/yyyy')>
			...
			<cfset newratedaynew = day(dateendof) - day(datestartwork) + 1>
             <cfloop from="0" to="#val(newratedaynew)-1#" index="b">
            <cfset currentdate = dateadd('d','#b#',datestartwork)>
            <cfset secondeffdatelist = secondeffdatelist&dateformat(currentdate,'dd/mm/yyyy')>
        ...
        <cfset oldrateday = day(datestartwork) - day(datestartof)>
            ...
            <cfset newrateday = day(dateendof) - day(datestartwork) + 1>
            ...
            <cfset realdatediff = datediff('d',datestartof,dateendof)+1>
...
<cfif  getplacement.clienttype eq "mth" or getplacement.clienttype eq "day" >
    <cfloop query="getNPL">
    	<cfif listfind(firsteffdatelist,dateformat(getNPL.startdate,'dd/mm/yyyy')) neq 0>
        <cfset firstnplval = firstnplval + val(getNPL.days)>
        <cfelseif listfind(secondeffdatelist,dateformat(getNPL.startdate,'dd/mm/yyyy')) neq 0>
    ...
    <cfset noofdayscount = datediff('d',datestartof,dateendof)>
		<cfset newdaycount = val(getplacement.wd_p_week)>
        <cfset gethalfday = 0>
		<cfif newdaycount mod 1 eq "0.5">
        <cfset newdaycount = val(getplacement.wd_p_week) - 0.5>
        ...
        <cfloop query="holiday_qry">
			...
			<cfif DayOfWeek(holiday_qry.Hol_Date) eq gethalfday>
            
            <cfif listfind(firsteffdatelist,dateformat(holiday_qry.Hol_Date,'dd/mm/yyyy')) neq 0>
                <cfset firstnplval = firstnplval + 0.5>
            <cfelseif listfind(secondeffdatelist,dateformat(holiday_qry.Hol_Date,'dd/mm/yyyy')) neq 0>
                <cfset secondnplval = secondnplval + 0.5>
            <cfelse>
                <cfset secondnplval = secondnplval + 0.5>
            </cfif>
            
            <cfelseif listfind(dayslist,DayOfWeek(holiday_qry.Hol_Date)) neq 0>
           ...
           <cfloop from="0" to="#noofdayscount#" index="i">
			...
			<cfif listfind(firsteffdatelist,dateformat(currentdate,'dd/mm/yyyy')) neq 0>
                <cfset firstdaysval = firstdaysval + 0.5>
            <cfelseif listfind(secondeffdatelist,dateformat(currentdate,'dd/mm/yyyy')) neq 0>
...
<cfset dayslist = "">
  ...
  <cfset countdays = 0>
    <cfif getplacement.wd_p_week eq "5">
    	<cfset noofdayscount = datediff('d',datestartof,dateendof)>
        <cfloop from="0" to="#noofdayscount#" index="i">
        <cfset currentdate = dateadd('d','#i#',datestartof)>
    ...
    <cfelseif getplacement.wd_p_week eq "5.5">
    	<cfset noofdayscount = datediff('d',datestartof,dateendof)>
        <cfloop from="0" to="#noofdayscount#" index="i">
        <cfset currentdate = dateadd('d','#i#',datestartof)>
    ...
    <cfset noofdays = countdays>
    <cfelseif getplacement.wd_p_week eq "7">
    <cfset noofdays = datediff('d',datestartof,dateendof) + 1>
    <cfelse>
    	<cfset noofdayscount = datediff('d',datestartof,dateendof)>
		<cfset newdaycount = val(getplacement.wd_p_week)>
        <cfset gethalfday = 0>
...
<cfset selfsalarydayrecord = val(noofdays) - val(getleavedays.days)-val(holiday_qry.recordcount)>
<cfset custsalarydayrecord = val(noofdays) - val(getleavedays.days)-val(holiday_qry.recordcount)>
<cfelseif  getplacement.clienttype eq "day">
<cfset dayholidayday = 0 >
<cfloop query="holiday_qry">

<cfset holidaydate = createdate(year(holiday_qry.Hol_Date),month(holiday_qry.Hol_Date),day(holiday_qry.Hol_Date))>
<cfset getdateofweek = dayofweek(holidaydate)>
<cfif getdateofweek eq "1">
<cfset getdateofweek = 7>
<cfelse>
<cfset getdateofweek = getdateofweek - 1>
</cfif>

<cfif getdateofweek lte getplacement.wd_p_week>
<cfset dayholidayday = dayholidayday + 1>
</cfif>
...
<cfif getnpldays.recordcount neq 0>
    ...
    <cfloop query="getnpldays">
    	...
    	<cfset nonplcount = datediff('d',nplstartdate,nplenddate)>
         <cfloop from="0" to="#nonplcount#" index="i">
            <cfset currentdate = dateadd('d','#i#',nplstartdate)>
            <cfif listfind(dayslist,DayOfWeek(currentdate)) neq 0>
            ...
            <cfif i eq 0 and getnpldays.startampm neq "FULL DAY" and DayOfWeek(currentdate) neq gethalfday>
            	<cfset hourofleave = evaluate('getplacement.#ivar#totalhour') * 0.5 >
			<cfelseif i eq nonplcount and getnpldays.endampm neq "FULL DAY" and DayOfWeek(currentdate) neq gethalfday>
           		<cfset hourofleave = evaluate('getplacement.#ivar#totalhour') * 0.5>
			<cfelse>
            ...
            <cfset npldays = npldays&dateformat(currentdate,'yyyy-mm-dd')>
            <cfset "#getnpldays.leavetype#list" = evaluate("#getnpldays.leavetype#list")&dateformat(currentdate,'yyyy-mm-dd')>
          ...
          <cfif isdefined('activateeffcal')>
          	...
          	<cfif listfind(firsteffdatelist,dateformat(nplstartdate,'dd/mm/yyyy')) neq 0>
            	<cfset totalfirstdaysnpl = totalfirstdaysnpl + val(getnpldays.days)>

                <cfset firstnplval = firstnplval + nowcounthour>
            <cfelseif listfind(secondeffdatelist,dateformat(nplstartdate,'dd/mm/yyyy')) neq 0>		<cfset totalseconddaysnpl = totalseconddaysnpl + val(getnpldays.days)>
...
<cfif isdefined('activateeffcal')>
	...
	<cfif listfind(firsteffdatelist,dateformat(holidaydate,'dd/mm/yyyy')) neq 0>
        <cfset firstnplval = firstnplval + val(leavedayscount)>
        <cfset totalfirstdaysnpl = totalfirstdaysnpl + 1>
    <cfelseif listfind(secondeffdatelist,dateformat(holidaydate,'dd/mm/yyyy')) neq 0>
...
<cfif daysinmonth(dateendof) neq day(dateendof) or day(datestartof) neq 1>
...
<cfset newdateend = createdate(listlast(URLDECODE(url.enddate),'/'),listgetat(URLDECODE(url.enddate),'2','/'),daysinmonth(dateendof))>	
		<cfset countdays = 0>
		<cfset noofdayscount = datediff('d',newdatestart,newdateend)>
		<cfset newdaycount = val(getplacement.wd_p_week)>
        <cfset gethalfday = 0>
		<cfif newdaycount mod 1 eq "0.5">
        <cfset newdaycount = val(getplacement.wd_p_week) - 0.5>
...
<cfloop query="getplacementleave">
        ...
        <cfif getplacementleave.startdate neq getplacementleave.enddate>
            <cfset leavedesp = dateformat(getplacementleave.startdate,'dd')&"-"&dateformat(getplacementleave.enddate,'dd mmm')>
        <cfelse>
        	<cfset leavedesp = dateformat(getplacementleave.enddate,'dd mmm')>
        </cfif>
        ...
        <cfif isdefined('activateeffcal')>
        <cfif listfind(firsteffdatelist,dateformat(getplacementleave.startdate,'dd/mm/yyyy')) neq 0>
       ...
       <cfelse>
         ...
         <cfif isdefined('activateeffcal')>
				<cfif listfind(firsteffdatelist,dateformat(getplacementleave.startdate,'dd/mm/yyyy')) neq 0>
                	<cfset "lvlerrate#getplacementleave.leavetype#" = numberformat(firstemployerpay,'.__')>
                <cfelse>
                 	<cfset "lvlerrate#getplacementleave.leavetype#2" = numberformat(secondemployerpay,'.__')>
                </cfif>
            <cfelse>
        <cfset "lvlerrate#getplacementleave.leavetype#" = numberformat(employerpay,'.__')>
        </cfif>
        <cfelse>
...
&dateformat(holiday_qry.hol_date,'dd mmm')&")">
  ...
  <cfloop from="1" to="3" index="i">
    ...
    <cfif isdefined('AWSTEXT') eq false>
      ...
      <cfloop query="getplacementleavens">
		...
		<cfset nsdeddesp = nsdeddesp&"National Service "&dateformat(getplacementleavens.startdate,'dd/mm/yyyy')&" - "&dateformat(getplacementleavens.enddate,'dd/mm/yyyy')>
        
		  <cfif getplacement.clienttype eq "mth">
          		
                
          <cfif isdefined('activateeffcal')>
          	<cfif listfind(firsteffdatelist,dateformat(getplacementleavens.startdate,'dd/mm/yyyy')) neq 0>
         ...
         <cfif isdefined('activateeffcal')>
          ...
          <cfelseif getplacement.clienttype eq "hr">
                        ...
                        <cfset nonscount = datediff('d',nsstartdate,nsenddate)>
                         <cfloop from="0" to="#nonscount#" index="i">
                            ...
                            <cfif i eq 0 and getplacementleavens.startampm neq "FULL DAY" and DayOfWeek(currentdate) neq gethalfday>
                                <cfset hourofleave = evaluate('getplacement.#ivar#totalhour') * 0.5 >
                            <cfelseif i eq nonscount and getplacementleavens.endampm neq "FULL DAY" and DayOfWeek(currentdate) neq gethalfday>
                                <cfset hourofleave = evaluate('getplacement.#ivar#totalhour') * 0.5>
                            <cfelse>
                                <cfset hourofleave = evaluate('getplacement.#ivar#totalhour')>
                            </cfif>
       ...
       <!---  <cfif isdefined('activateeffcal') >
        ...
        <cfif getplacement.clienttype eq "mth">
        		<cfset invdesp = "Services from "&dateformat(datestartof,'dd/mm/yyyy')&" to "&dateformat(dateadd('d',-1,datestartwork),'dd/mm/yyyy')&" ( "&numberformat(val(oldrateday) - val(firstnplval),'.__')&"/"&numberformat(val(oldrateday) + val(newrateday),'.__')&" days * "&firstemployerpay&")">
                <cfset invdesp2 = "Services from "&dateformat(datestartwork,'dd/mm/yyyy')&" to "&dateformat(dateendof,'dd/mm/yyyy')&" ( "&numberformat(val(newrateday) - val(secondnplval),'.__')&"/"&numberformat(val(oldrateday) + val(newrateday),'.__')&" days * "&secondemployerpay&")">
                <cfset paydesp = "Being Salary from "&dateformat(datestartof,'dd/mm/yyyy')&" to "&dateformat(dateendof,'dd/mm/yyyy')&" ( "&numberformat(val(oldrateday) - val(firstnplval),'.__')&"/"&numberformat(val(oldrateday) + val(newrateday),'.__')&" days * "&firstemployeepay&" and "&numberformat(val(newrateday) - val(secondnplval),'.__')&"/"&numberformat(val(oldrateday) + val(newrateday),'.__')&" days * "&secondemployeepay&")">
			<cfelseif getplacement.clienttype eq "hr">
            
            	<cfset invdesp = "Services from "&dateformat(datestartof,'dd/mm/yyyy')&" to "&dateformat(dateadd('d',-1,datestartwork),'dd/mm/yyyy')&" "&numberformat(val(oldrateday)-val(totalfirstdaysnpl),'.__')&" days ("&numberformat(val(firstdaysval) - val(firstnplval),'.__')&" hrs *"&numberformat(firstemployerpay,'.__')&")">
                <cfset invdesp2 = "Services from "&dateformat(datestartwork,'dd/mm/yyyy')&" to "&dateformat(dateendof,'dd/mm/yyyy')&" "&numberformat(val(newrateday)-val(totalseconddaysnpl),'.__')&" days ("&numberformat(val(seconddaysval) - val(secondnplval),'.__')&" hrs *"&numberformat(secondemployerpay,'.__')&")">
                <cfset paydesp = "Being Salary from "&dateformat(datestartof,'dd/mm/yyyy')&" to "&dateformat(dateendof,'dd/mm/yyyy')&" "&selfsalaryday&" days ("&numberformat(val(firstdaysval) - val(firstnplval),'.__')&" hrs *"&numberformat(firstemployeepay,'.__')&" and "&numberformat(val(seconddaysval) - val(secondnplval),'.__')&" hrs *"&numberformat(secondemployeepay,'.__')&")">
                
			<cfelseif  getplacement.clienttype eq "day">
          
            	<cfset invdesp = "Services from "&dateformat(datestartof,'dd/mm/yyyy')&" to "&dateformat(dateadd('d',-1,datestartwork),'dd/mm/yyyy')&" "&numberformat(val(firstdaysval) - val(firstnplval),'.__')&" days ("&numberformat(val(firstdaysval) - val(firstnplval),'.__')&" days *"&numberformat(firstemployerpay,'.__')&")">
                <cfset invdesp2 = "Services from "&dateformat(datestartwork,'dd/mm/yyyy')&" to "&dateformat(dateendof,'dd/mm/yyyy')&" "&numberformat(val(seconddaysval) - val(secondnplval),'.__')&" days ("&numberformat(val(seconddaysval) - val(secondnplval),'.__')&" days *"&numberformat(secondemployerpay,'.__')&")">
                <cfset paydesp = "Being Salary from "&dateformat(datestartof,'dd/mm/yyyy')&" to "&dateformat(dateendof,'dd/mm/yyyy')&" "&selfsalaryday&" days ("&numberformat(val(firstdaysval) - val(firstnplval),'.__')&" days *"&numberformat(firstemployeepay,'.__')&" and "&numberformat(val(seconddaysval) - val(secondnplval),'.__')&" days *"&numberformat(secondemployeepay,'.__')&")">
                
			</cfif>
        
        <cfelse>
        	<cfif getplacement.clienttype eq "mth">
        		<cfset invdesp = "Services from "&dateformat(datestartof,'dd/mm/yyyy')&" to "&dateformat(dateendof,'dd/mm/yyyy')>
                <cfset paydesp = "Being Salary from "&dateformat(datestartof,'dd/mm/yyyy')&" to "&dateformat(dateendof,'dd/mm/yyyy')>
			...
			<cfelseif getplacement.clienttype eq "hr">
            	...
            	<cfset invdesp = "Services from "&dateformat(datestartof,'dd/mm/yyyy')&" to "&dateformat(dateendof,'dd/mm/yyyy')&" "&custsalaryday&" days ("&custsalaryhrs&" hrs *"&custusualpay&")">
                <cfset paydesp = "Being Salary from "&dateformat(datestartof,'dd/mm/yyyy')&" to "&dateformat(dateendof,'dd/mm/yyyy')&" "&selfsalaryday&" days ("&selfsalaryhrs&" hrs *"&selfusualpay&")">
                
			<cfelseif  getplacement.clienttype eq "day">
            
            	<cfset invdesp = "Services from "&dateformat(datestartof,'dd/mm/yyyy')&" to "&dateformat(dateendof,'dd/mm/yyyy')&" "&custsalaryday&" days ("&custsalaryday&"*"&custusualpay&")">
                <cfset paydesp = "Being Salary from "&dateformat(datestartof,'dd/mm/yyyy')&" to "&dateformat(dateendof,'dd/mm/yyyy')&" "&selfsalaryday&" days ("&selfsalaryday&" days *"&selfusualpay&")">
...
SELECT * FROM placement WHERE placementno = <cfqueryparam cfsqltype="cf_sql_varchar" value="#getitem.placementno#">
        ...
        <cfset "lvleerate#i#" = numberformat(evaluate('getitem.lvleerate#i#'),'.__')>
        <cfset "lvlerdayhr#i#" = evaluate('getitem.lvlerdayhr#i#')>
        <cfset "lvlerrate#i#" = numberformat(evaluate('getitem.lvlerrate#i#'),'.__')>
...
Please verify to ensure amounts are correct. </font></td></cfif>
      ...
      <td  style="background-color:#bgcolor#"><input type="text" size='10' name="CUSTNPL" id="CUSTNPL" value="#CUSTNPL#"></td>
      </tr>
      <tr>
      <th>Days Worked</th>
      <td></td>
      ...
      <td style="background-color:#bgcolor#" colspan="3"><input type="text" name="invdesp" id="invdesp" value="#invdesp#" size="90" /></td>
      ...
      <td style="background-color:#bgcolor#" colspan="3"><input type="text" name="invdesp2" id="invdesp2" value="#invdesp2#" size="90" /></td>
      <td><input type="text" size="10" name="secondrate" id="secondrate" value="#numberformat(secondrate,'.__')#" onkeyup="calextra();"/></td>
      </tr>
      <tr>
      <th>Pay Slip Desp:</th>
      <td colspan="3"><input type="text" name="paydesp" id="paydesp" value="#paydesp#" size="90" /></td>
      </tr>
      <tr><td>&nbsp;</td></tr>
      <tr>
      ...
      <tr>
      <td>
      <input type="text" name="lvltype#i#" id="lvltype#i#" value="#evaluate('lvltype#i#')#" size="10" readonly="readonly" />
      </td>
      <td>
      ...
      <td>
      <input type="hidden" name="lvltotalee#i#" id="lvltotalee#i#" value="#evaluate('lvltotalee#i#')#" />
      </td>
      <td>
      <input type="hidden" name="lvltotaler#i#" id="lvltotaler#i#" value="#evaluate('lvltotaler#i#')#" />
      </td>
      </tr>
      <cfelseif i eq 1>
      <tr>
      <td>
       <cfquery name="getleave" datasource="#dts#">
        ...
        <select name="lvltype#i#" id="lvltype#i#" style="width:100px">
      ...
      <td>
	  <input type="text" name="lvldesp#i#" id="lvldesp#i#" value="" size="30" />
      </td>
      <td>
      <input type="text" name="lvleedayhr#i#" id="lvleedayhr#i#" value="0.00" size="10" onkeyup="leaveself();" />
      </td>
      <td>
      <input type="text" name="lvleerate#i#" id="lvleerate#i#" value="0.00" size="10" onkeyup="leaveself();" />
      </td>
      <td style="background-color:#bgcolor#">
      <input type="text" name="lvlerdayhr#i#" id="lvlerdayhr#i#" value="0.00" size="10" onkeyup="leavecust();" />
      </td>
      <td style="background-color:#bgcolor#">
      <input type="text" name="lvlerrate#i#" id="lvlerrate#i#" value="0.00" size="10" onkeyup="leavecust();" />
      </td>
      <td>
      ...
      <tr>
       <th colspan="6"><div align="right">Paid PH and Leaves</div></th>
             <td><input type="text" size='10' name="selfphnlsalary" id="selfphnlsalary" value="#numberformat(selfphnlsalary,'_.__')#" onKeyUp="calselftotal();"></td>
       <td style="background-color:#bgcolor#"><input type="text" size='10' name="custphnlsalary" id="custphnlsalary" value="#numberformat(custphnlsalary,'_.__')#" onKeyUp="calcusttotal();"></td>
      </tr>
      <tr>
      <td>&nbsp;</td>
      </tr>
      ...
      <td style="background-color:#bgcolor#"><input type="text" size='10' name="custothour1" id="custothour1" value="#custothour1#" onKeyUp="calcustot1();"> Hours</td>
      ...
      <td style="background-color:#bgcolor#"><input type="text" size='10' name="custothour2" id="custothour2" value="#custothour2#" onKeyUp="calcustot2();"> Hours</td>
      ...
      <td style="background-color:#bgcolor#"><input type="text" size='10' name="custothour3" id="custothour3" value="#custothour3#" onKeyUp="calcustot3();"> Hours</td>
      ...
      <td style="background-color:#bgcolor#"><input type="text" size='10' name="custothour4" id="custothour4" value="#custothour4#" onKeyUp="calcustot4();"> Hours</td>
      ...
      <cfif isdefined('fixawcode1') or isdefined('fixawcode2') or isdefined('fixawcode3')>
      <tr>
      ...
      <tr>
      <td><input type="text" name="fixawcode#i#" id="fixawcode#i#" value="#evaluate('fixawcode#i#')#" /></td>
      <td><input type="text" name="fixawdesp#i#" id="fixawdesp#i#" value="#evaluate('fixawdesp#i#')#" /></td>
      <td><input type="text" name="fixawee#i#" id="fixawee#i#" value="#numberformat(evaluate('fixawee#i#'),'.__')#" onkeyup="calselfallow();" /></td>
       <td style="background-color:#bgcolor#"><input type="text" name="fixawer#i#" id="fixawer#i#" value="#numberformat(evaluate('fixawer#i#'),'.__')#" onkeyup="calcustallow();"  /></td>
      ...
      <th><div align="left">Description</div></th>
      </tr> <cfquery name="getaw" datasource="#dts1#">
                SELECT * FROM awtable where aw_cou > 3 and aw_cou <=15 order by aw_cou
                </cfquery>
      <cfloop from="1" to="3" index="a">
      <tr>
            <td>
      ...
      <tr><th colspan="8"><div align="left">AWS and PB</div></th></tr>
      <tr>
      <td></td>
      <td></td>
      <th><div align="left">Employee</div></th>
      ...
      <td></td>
      <td></td>
      <td style="background-color:#bgcolor#">Billable CPF</td>
      <td style="background-color:#bgcolor#">Billable SDF</td>
      ...
      <td><input type="hidden" id="adminfeepercent" name="adminfeepercent" value="#adminfeepercent#" />
      <input type="hidden" id="adminfeeminamt" name="adminfeeminamt" value="#adminfeeminamt#" /></td>
      <td></td>
      ...
      <tr>
      <th colspan="100%" style="background-color:#bgcolor#"><div align="left">Monthly Billable Item</div></th>
      </tr>
       <cfquery name="getcate" datasource="#dts#">
                select * from iccate
                </cfquery>
      ...
      <tr>
      <td style="background-color:#bgcolor#"><input type="text" name="billitem#i#" id="billitem#i#" value="#evaluate('billitem#i#')#" readonly="readonly" /></td>
      <td style="background-color:#bgcolor#">
      ...
      <cfelse>
    	<tr>
      <td style="background-color:#bgcolor#">
                <select name="billitem#i#" id="billitem#i#">
      ...
      <tr>
      <th><div align="left">Reimbursement</div></th>
      <th><div align="left">Description</div></th>
      <td></td>
      <td></td>
      ...
      <tr>
      <th>
      <select name="addchargecode" id="addchargecode" onChange="document.getElementById('addchargedesp').value=this.options[this.selectedIndex].id">
      <option value="" id="">Choose a Claim</option>
      <cfloop query="getclaimlist">
      <option <cfif addchargecode eq getclaimlist.wos_group>Selected</cfif> value="#getclaimlist.wos_group#" id="#getclaimlist.desp#">#getclaimlist.desp#</option>
      </cfloop>
      </select>
      </th>
      <td><input type="text" name="addchargedesp" id="addchargedesp" value="#addchargedesp#"></td>
       ...
       <tr>
      <th> <select name="addchargecode2" id="addchargecode2" onChange="document.getElementById('addchargedesp2').value=this.options[this.selectedIndex].id">
      <option value="">Choose a Claim</option>
      <cfloop query="getclaimlist">
      <option <cfif addchargecode2 eq getclaimlist.wos_group>Selected</cfif> value="#getclaimlist.wos_group#" id="#getclaimlist.desp#">#getclaimlist.desp#</option>
      </cfloop>
      </select></th>
      <td ><input type="text" name="addchargedesp2" id="addchargedesp2"  value="#addchargedesp2#"></td>
       ...
       <tr>
      <th><select name="addchargecode3" id="addchargecode3" onChange="document.getElementById('addchargedesp3').value=this.options[this.selectedIndex].id">
      <option value="">Choose a Claim</option>
      <cfloop query="getclaimlist">
      <option <cfif addchargecode3 eq getclaimlist.wos_group>Selected</cfif> value="#getclaimlist.wos_group#" id="#getclaimlist.desp#">#getclaimlist.desp#</option>
      </cfloop>
      </select></th>
      <td ><input type="text" name="addchargedesp3" id="addchargedesp3" value="#addchargedesp3#"></td>
     ...
     <tr>
     <th><div align="left">Deductions (Do Not Enter "-")</div></th>
     </tr>
      <tr>
      <td colspan="2"><input type="text" name="ded1desp" id="ded1desp" size="50" value="#ded1desp#"></td>
      ...
      <tr>
      <td colspan="2"><input type="text" name="ded2desp" id="ded2desp" size="50" value="#ded2desp#"></td>
      ...
      <tr>
      <td colspan="2"><input type="text" name="ded3desp" id="ded3desp" size="50" value="#ded3desp#"></td>
...
<td><input type="text" size='10' name="selfdeduction" id="selfdeduction" value="#selfdeduction#" readonly="readonly" > </td>
      <td style="background-color:#bgcolor#">
      <input type="text" size='10' name="custdeduction" id="custdeduction" value="#custdeduction#" onKeyUp="calcusttotal();" readonly="readonly">      </td>
      </tr>
  ...
  <td colspan="4"><input type="hidden" name="tran" id="tran" value="INV">   </td>
      ...
      <td><input type="text" size='10' name="selftotal" id="selftotal" value="#numberformat(selftotal,'_.__')#" readonly="readonly"></td>
      <td></td>
      ...
      <td>&nbsp;</td>
      <td>&nbsp;</td>
      <th style="background-color:#bgcolor#">Customer Gross Pay Amount</th>
      <td></td>
       <td style="background-color:#bgcolor#"><input type="text" size='10' name="custtotalgross" id="custtotalgross" value="#numberformat(custtotalgross,'_.__')#" readonly="readonly"></td>
      <tr>
      </tr>
      <tr>
      <td>&nbsp;</td>
  ...
  <input type="text" name="taxamt" id="taxamt" value="#numberformat(taxamt,'.__')#" size="10" readonly/></td>
      ...
      <td></td>
      <td style="background-color:#bgcolor#"><input type="text" size='10' name="custtotal" id="custtotal" value="#numberformat(custtotal,'_.__')#" readonly="readonly"></td>
      </tr>
    ...
    <tr> 
      ...
      <input type="button" name="calculateemppay" value="Calculate Employee Pay" <cfif posted eq "P">disabled </cfif> onClick="<cfif locked eq "Y">alert('This Assignment Has Been Locked')<cfelseif posted neq "P">checkpay()<cfelse>alert('This assignment has been posted!')</cfif>;">&nbsp;&nbsp;&nbsp;&nbsp;
