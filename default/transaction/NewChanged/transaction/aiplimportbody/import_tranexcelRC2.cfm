		...
		<cftry>
			...
			select ddllocation from gsetup
				...
				<cfquery name="inserticitem" datasource="#dts#">
					...
					values
					(<cfqueryparam cfsqltype="cf_sql_varchar" value="#column1#">,<cfqueryparam cfsqltype="cf_sql_varchar" value="#column5#">,<cfqueryparam cfsqltype="cf_sql_varchar" value="#column7#">,'','','','',<cfif column10 neq ''><cfqueryparam cfsqltype="cf_sql_varchar" value="#column10#"><cfelse><cfqueryparam cfsqltype="cf_sql_varchar" value="#getgsetup.ddllocation#"></cfif>, '#val(column2)#', '#val(column3)#','0', '0', '0',<cfqueryparam cfsqltype="cf_sql_varchar" value="#column15#">, <cfif val(column11) eq 0>'0'<cfelse>'7'</cfif>)
				</cfquery>
			</cfif>
		<cfcatch type="any">
