		...
		<cftry>
			...
			<cfif trim(column1) neq "">
				<cfquery name="inserticitem" datasource="#dts#">
					insert into ictran_excel2
					(itemno,color,size,qty1,qty2,qty3,qty4,qty5,qty6,qty7,qty8,qty9,qty10,qtyall,price,location,dispec1,dispec2,dispec3)
					values
					(<cfqueryparam cfsqltype="cf_sql_varchar" value="#column1#">,<cfqueryparam cfsqltype="cf_sql_varchar" value="#column2#">,"",'#val(column3)#','#val(column4)#','0','0','0','0','0','0','0','0','0','#val(column4)#','','#val(column5)#','#val(column6)#','0')
				</cfquery>
			</cfif>
		<cfcatch type="any">
