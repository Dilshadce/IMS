<cfcomponent output="false">
	...
	<cffunction name="getBill" access="remote" returntype="any">
	    ...
	    <cfquery name="selUsers" datasource="#dts#">
			SELECT type,a.desp,source,job,concat('R-',refno) as refno,custno,name,wos_date,if(void = "","Y","N") as void,counter,eInvoice_Submited,b.nextdate FROM currartran as a left join (select nextdate,groupid from recurrgroup) as b on a.eInvoice_Submited =b.groupid
            WHERE 0 = 0
