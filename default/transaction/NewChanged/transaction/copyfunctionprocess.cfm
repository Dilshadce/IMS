...
<cfif not isdefined("url.status")>
	...
	<cffunction name="updateArtran" output="false">
		...
		<cfquery datasource="#dts#" name="insertartran">
			...
			m_charge6,m_charge7,special_account_code,created_by,created_on,updated_by,updated_on,termscondition,consignment,e_mail,d_email,rem30,rem31,rem32,rem33,rem34,rem35,rem36,rem37,rem38,rem39,rem40,rem41,rem42,rem43,rem44,rem45,rem46,rem47,rem48,rem49)
			...
			'#resultSet.m_charge6#','#resultSet.m_charge7#','#resultSet.special_account_code#','#HUserID#',#now()#,'#HUserID#',#now()#,'#resultSet.termscondition#',<cfif crossover eq '1'><cfif resultSet.consignment eq 'out'>'return'<cfelse>'out'</cfif><cfelse>'#resultSet.consignment#'</cfif>,'#resultSet.e_mail#','#resultSet.d_email#'
	...
	<cffunction name="updateIctran" output="false">
		...
		<cfquery name="insertictran" datasource="#dts#">
			...
			'#resultSet.mc6_bil#','#resultSet.mc7_bil#','#resultSet.note_a#','#resultSet.TITLE_ID#','#resultSet.title_desp#',<cfif crossover eq "1"><cfif resultSet.consignment eq 'out'>'return'<cfelse>'out'</cfif><cfelse>'#resultSet.consignment#'</cfif><cfif lcase(dts) eq "mastercare_i" or lcase(dts) eq "gorgeous_i">,'#resultSet.ictranfilename#'</cfif>)
		</cfquery>	
	</cffunction>
