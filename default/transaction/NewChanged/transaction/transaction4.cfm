...
<cfquery datasource="#dts#" name="getGeneralInfo">
    ...
    qtyformula,priceformula,wpitemtax,wpitemtax1,projectbybill,lPROJECT,lJOB,prozero,prodisprice,commenttext,commentlimit,displaycostcode,quobatch,jobbyitem,itemdiscmethod,lbatch,asvoucher,itempriceprior,remainloc,showservicepart,df_purchasetaxzero,df_salestaxzero,histpriceinv,proavailqty,df_qty,disclimit,locationwithqty,lightloc,quotationchangeitem,editamount,periodficposting,cost,appDisSupCusitem
	from gsetup;
</cfquery>
