...
select refno from artran where type='#type#' and refno=<cfqueryparam cfsqltype="cf_sql_varchar" value="#refno#">
        ...
        <cftry>
        <cfinvoke component="cfc.IncrementValue" method="getIncreament" input="#checkexistrefno.refno#" returnvariable="refno"/>
		<cfcatch>
		<cfinvoke component="cfc.refno" method="processNum" oldNum="#checkexistrefno.refno#" returnvariable="refno" />	
		</cfcatch>
        </cftry>
