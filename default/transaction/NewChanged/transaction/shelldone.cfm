...
<table width="1000px" align="center">
    ...
    <h3>
    <cfoutput>
    <a href="/default/transaction/shelltran/index.cfm?tran=#url.type#" ><img src="/images/Create.png" width="32" height="32" />&nbsp;Create Another Bill</a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<a href="##" onclick="window.close()"><img src="/images/Close.png" width="32" height="32" />&nbsp;Close</a>
    </cfoutput>
    </h3>
    </td>
    </tr>
