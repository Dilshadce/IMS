...
SELECT type,refno,custno,frem7,frem8,rem3,comm0,comm1,comm2,comm3,rem14,rem12,comm4,rem1,custno FROM packlistbill as pa left join artran as ic on pa.billrefno = ic.refno where ic.type = "#getPackId.reftype#" and pa.packID = "#packid#" 
</cfquery>
