...
select * from displaysetup
    ...
    <cfif getdisplay.itemsearch_qty eq 'Y'>
    <td style="font:'Times New Roman', Times, serif; font-size:16px">#getitembalance1.balance#</td>
    </cfif>
    </cfif>
    <cfif lcase(hcomid) neq "acht_i">
    ...
    <td style="font:'Times New Roman', Times, serif; font-size:16px"><input name="additem_#getitem1.currentrow#" id="additem_#getitem1.currentrow#" type="checkbox" value="#getitem1.itemno#" onclick="itemcheckbox(this);"/></td>
    </cfif>
    </tr>
    </cfloop>
    </table>
