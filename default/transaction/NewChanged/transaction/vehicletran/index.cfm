...
<cfselect name="agent" id="agent" bind="cfc:custsupp.getagent('#dts#')" selected="#agenno#" bindonload="yes" display="agentdesp" value="agent" required="yes" message="Please Select Agent"  />
<cfelse>
<cfselect name="agent" id="agent" bind="cfc:custsupp.getagent('#dts#')" selected="#agenno#" bindonload="yes" display="agentdesp" value="agent"  />
</cfif>
...
<div <cfif lcase(HcomID) eq "imperial1_i" or lcase(HcomID) eq "coolnlite_i">style="display:none"</cfif>><cfselect name="multiagent1" id="multiagent1" selected="#zmultiagent1#" bind="cfc:custsupp.getagent('#dts#')" bindonload="yes" display="agentdesp" value="agent" /></div>
...
<cfselect name="project" id="project" bind="cfc:custsupp.getproject('#dts#')" selected="#Huserproject#" bindonload="yes" display="projectdesp" value="source" />
</td>
</tr>
