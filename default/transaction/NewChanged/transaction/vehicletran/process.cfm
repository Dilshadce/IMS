...
<cfqueryparam cfsqltype="cf_sql_varchar" value="#headerdesp#">,
<cfqueryparam cfsqltype="cf_sql_varchar" value="#headerdesp2#">,
...
"#form.cctype2#",
'',
<cfqueryparam cfsqltype="cf_sql_varchar" value="#trim(form.rem7)#">,
<cfqueryparam cfsqltype="cf_sql_varchar" value="#trim(form.rem6)#">,
<cfqueryparam cfsqltype="cf_sql_varchar" value="#trim(form.rem5)#">,
...
<cfqueryparam cfsqltype="cf_sql_varchar" value="#form.onholdfield#">,
...
<!--- SOSBAT --->
<cfinclude template = "sosbatprocess.cfm">
</cfif>
...
<cflocation url="/default/transaction/vehicledone.cfm?type=#type#&refno=#refno#&print=#form.acceptprint#" addtoken="no">
