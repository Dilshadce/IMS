...
and trancode = <cfqueryparam cfsqltype="cf_sql_varchar" value="#url.trancode#"> and itemno = <cfqueryparam cfsqltype="cf_sql_varchar" value="#URLDECODE(url.itemno)#">
</cfquery>
...
SELECT itemno,desp,unit,currrate,price_bil,brem4,qty,qty_bil FROM ictrantemp WHERE 
trancode = <cfqueryparam cfsqltype="cf_sql_varchar" value="#url.trancode#">
and uuid = <cfqueryparam cfsqltype="cf_sql_varchar" value="#url.uuid#">
and itemno = <cfqueryparam cfsqltype="cf_sql_varchar" value="#URLDECODE(url.itemno)#">
</cfquery>
...
<cfquery name="getsum10" datasource="#dts#">
SELECT SUM(amt1_bil) as sumsubtotal,count(itemno) as countitemno FROM ictrantemp where uuid = <cfqueryparam cfsqltype="cf_sql_varchar" value="#url.uuid#" />
</cfquery>


<cfquery name="getamtforitem" datasource="#dts#">
select amt from ictrantemp
WHERE 
trancode = <cfqueryparam cfsqltype="cf_sql_varchar" value="#url.trancode#">
and uuid = <cfqueryparam cfsqltype="cf_sql_varchar" value="#url.uuid#">
and itemno = <cfqueryparam cfsqltype="cf_sql_varchar" value="#URLDECODE(url.itemno)#">
...
<cfinvoke component="cfc.comboard" method="display" firstline="#getitemdetail.desp#" secondlineleft="#numberformat(getamtforitem.amt,',_.__')#" secondlineright="#numberformat(getsum10.sumsubtotal,',_.__')#" comchannel="#getgsetup.comboardport#" returnvariable="test"/></div>
<cfoutput>
<cfset test=replace(replace(test,'"','','all'),"'","","all")>
</cfoutput>
