...
and uuid = <cfqueryparam cfsqltype="cf_sql_varchar" value="#uuid#">
and itemno = <cfqueryparam cfsqltype="cf_sql_varchar" value="#validitemexist.itemno#">
</cfquery>
...
amt_bil = round((price_bil * qty_bil)+0.000001,3),
amt1_bil = round((price_bil * qty_bil)+0.000001,3)
WHERE 
trancode = <cfqueryparam cfsqltype="cf_sql_varchar" value="#validitemexist.trancode#">
and uuid = <cfqueryparam cfsqltype="cf_sql_varchar" value="#uuid#">
and itemno = <cfqueryparam cfsqltype="cf_sql_varchar" value="#validitemexist.itemno#">
...
<cfset desp=replace(desp,"'","","all")>
<cfinvoke component="cfc.comboard" method="display" firstline="#replace(desp,'&','','all')#" secondlineleft="#numberformat(amt,',_.__')#" secondlineright="(#numberformat(getsum.sumsubtotal,',_.__')#)" comchannel="#getgsetup.comboardport#" returnvariable="test"/></div>
<cfoutput>
<input type=hidden name='displayitem' id='displayitem' value='#test#'>
</cfoutput>
