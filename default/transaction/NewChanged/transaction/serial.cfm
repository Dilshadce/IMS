...
<!---
	...
	<body>
		...
		<tr>
			<td>New</td>
			<td align="right"><input type="text" name="text_serialno" id="text_serialno" maxlength="<cfif lcase(hcomid) neq "dental_i" or lcase(hcomid) neq "dental10_i" or lcase(hcomid) neq "mfss_i" or lcase(hcomid) neq "hcss_i" or lcase(hcomid) neq "iaf_i" or lcase(hcomid) eq "scpl_i">100<cfelse>100</cfif>" size="30" onKeyPress="return handleEnter(event)"></td>
