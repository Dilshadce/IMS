	...
	<cffunction name="getlist" access="remote" returntype="query" securejson="false">
        ...
        <cfargument name="dts" type="string">
      		...
      		<cfquery name="getcust" datasource="#dts#">
                ...
                union all
        		Select concat(refno,'--',name) as billdes,concat('a',refno) as refno from artran WHERE type = "#tran#" and (Posted = "" or posted is null) and (toinv = "" or toinv is null)  order by refno
      		</cfquery>
