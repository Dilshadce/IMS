        ...
        <cfqueryparam cfsqltype="cf_sql_varchar" value="SGD">
          ...
          <cfquery name="insertictran" datasource="#dts#">
            ...
            <cfquery name="updatecombine" datasource="#dts#">
            	UPDATE assignmentslip SET combine = "Y",biginvoice = concat(biginvoice,' ','#refno#') WHERE refno in (<cfqueryparam cfsqltype="cf_sql_varchar"  value="#form.checklist#" list="yes" separator=",">) and combine <> "Y"
            </cfquery>
...
<cfquery name="insertictran" datasource="#dts#">
            ...
            <cfquery name="updatecombine" datasource="#dts#">
            	UPDATE assignmentslip SET combine = "Y",biginvoice = concat(biginvoice,' ','#refno#') WHERE refno in (<cfqueryparam cfsqltype="cf_sql_varchar"  value="#valuelist(getinvlist.refno)#" list="yes" separator=",">) and combine <> "Y"
            </cfquery>
...
<!---          <cfif form.combinationtype eq "me"> --->
    ...
    SELECT refno FROM tempcreatebiitem WHERE uuid = "#form.uuid#" and orderno = "#getuuid.orderno#" GROUP BY refno
     ...
     <cfquery name="updatecombine" datasource="#dts#">
           UPDATE assignmentslip SET combine = "Y",biginvoice = concat(biginvoice,' ','#refno#') WHERE refno in (<cfqueryparam cfsqltype="cf_sql_varchar"  value="#valuelist(getallrefno.refno)#" list="yes" separator=",">) and combine <> "Y"
     </cfquery>
