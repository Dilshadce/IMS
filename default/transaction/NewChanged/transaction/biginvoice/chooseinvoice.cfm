...
select refno,assignmentslipdate,custno,custname,custtotal,custtotalgross,created_by,empno,empname from assignmentslip where assignmenttype = "sinvoice" and combine <> "Y" and custno = "#form.custno#"
...
<th colspan="100%">
<div align="center">
<input type="submit" name="sub_btn" id="sub_btn" value="Create Big Invoice">
</div>
</th>
</tr>
</table>
...
<input type="submit" name="sub_btn" id="sub_btn" value="Create Big Invoice" style="display:none">
</div>
</th>
</tr>
</table>
