...
<cfif url.type1 eq "Add">
	...
	<cfquery name="getitembal" datasource="#dts#">
		select qtybf,price,graded,ucost,comment,packing,qty2 from icitem where itemno = '#itemno#'
	</cfquery>
  ...
  <table align="center" class="data">
			...
			order by a.location
                ...
                <!---- ---->
      			...
      			<td width="60" <cfif lcase(hcomid) eq "meisei_i">style="visibility:hidden"</cfif>><input name="balance" id="balance" type="text" size="6" maxlength="10" value="#balonhand#" readonly></td>
