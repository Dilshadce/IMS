...
SELECT price,price2,price3,price4,desp,despa,unit from icitem WHERE itemno = <cfqueryparam cfsqltype="cf_sql_varchar" value="#itemno#"> 
</cfquery>

<cfquery name="getcustomerbusiness" datasource="#dts#">
select business from #target_arcust# where custno=<cfqueryparam cfsqltype="cf_sql_varchar" value="#url.custno#"> 
</cfquery>
...
<cfelseif getbusinesspricetype.pricelvl eq '4'>
<cfset price = val(validitem.price4)>
<cfelse>
