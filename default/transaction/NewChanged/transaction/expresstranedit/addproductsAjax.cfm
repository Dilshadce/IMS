...
FROM ictran WHERE itemno = <cfqueryparam cfsqltype="cf_sql_varchar" value="#itemno#"> and location=<cfqueryparam cfsqltype="cf_sql_varchar" value="#location#"> and 
...
SELECT SUM(amt1_bil) as sumsubtotal,count(itemno) as countitemno FROM ictran where 
