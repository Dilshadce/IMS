...
SELECT price_bil FROM ictran where refno = <cfqueryparam cfsqltype="cf_sql_varchar" value="#url.refno#"> and type = <cfqueryparam cfsqltype="cf_sql_varchar" value="#url.tran#"> and trancode = <cfqueryparam cfsqltype="cf_sql_varchar" value="#url.trancode#">
</cfquery>
...
SELECT itemno,unit,currrate,price_bil,brem4,qty,qty_bil FROM ictran WHERE 
trancode = <cfqueryparam cfsqltype="cf_sql_varchar" value="#url.trancode#">
and refno = <cfqueryparam cfsqltype="cf_sql_varchar" value="#url.refno#"> and type = <cfqueryparam cfsqltype="cf_sql_varchar" value="#url.tran#">
</cfquery>
