...
SELECT hol_date FROM holtable WHERE hol_date >= "#dateformat( datestartof,'YYYY-MM-DD')#" and hol_date <="#dateformat( dateendof,'YYYY-MM-DD')#"
</cfquery>
    ...
    <cfloop query="getnpldays">
    	...
    	<cfset nonplcount = abs(datediff('d',nplstartdate,nplenddate))>
         <cfloop from="0" to="#nonplcount#" index="i">
            ...
            <cfif  (listfind(fulldaylist,DayOfWeek(currentdate)) neq 0 or  listfind(halfdaylist,DayOfWeek(currentdate)) neq 0) and listfind(holidaylist,dateformat(currentdate,'dd/mm/yyyy')) eq 0>
...
Please verify to ensure amounts are correct. </font></td></cfif>
      ...
      <td style="background-color:#bgcolor#"><input type="text" size='10' name="custpbaws"  id="custpbaws" value="#numberformat(custpbaws,'_.__')#"></td>
       ...
       <td colspan="3">
       <input type="text" name="backpaydesp" id="backpaydesp" value="#backpaydesp#" size="90" />
       </td>
