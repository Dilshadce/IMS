...
UPDATE assignmentslip SET batches = "#batchstart#" WHERE refno in (<cfqueryparam cfsqltype="cf_sql_varchar" value="#form.asnrefno#" list="yes" separator=",">) and (batches = "" or batches is null)
</cfquery>
