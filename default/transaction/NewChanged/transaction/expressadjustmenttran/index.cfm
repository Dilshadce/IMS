        ...
        <tr> 
          ...
          <td width="10%" nowrap> 
            <div align="center"><a href="index2.cfm?type=Delete&refno=#exactResult.refno#&uuid=#exactResult.uuid#"><img height="18px" width="18px" src="/images/delete.ICO" alt="Delete" border="0">Delete</a>&nbsp; 
              <a href="index2.cfm?type=Edit&refno=#exactResult.refno#&uuid=#exactResult.uuid#"><img height="18px" width="18px" src="/images/edit.ICO" alt="Edit" border="0">Edit</a></div></td>
        </tr>
      </cfoutput> 
    </table>
			<cfelse>
        ...
        <tr> 
          ...
          <td width="10%" nowrap> 
            <div align="center"><a href="index2.cfm?type=Delete&refno=#similarResult.refno#&uuid=#similarResult.uuid#"><img height="18px" width="18px" src="/images/delete.ICO" alt="Delete" border="0">Delete</a>&nbsp; 
              <a href="index2.cfm?type=Edit&refno=#similarResult.refno#&uuid=#similarResult.uuid#"><img height="18px" width="18px" src="/images/edit.ICO" alt="Edit" border="0">Edit</a></div></td>
        </tr>
      </cfoutput> 
    </table>
			<cfelse>
      ...
      <tr> 
        ...
        <td width="10%" nowrap> 
          <div align="center"><a href="index2.cfm?type=Delete&refno=#type.refno#&uuid=#type.uuid#"><img height="18px" width="18px" src="/images/delete.ICO" alt="Delete" border="0">Delete</a>&nbsp; 
            <a href="index2.cfm?type=Edit&refno=#type.refno#&uuid=#type.uuid#"><img height="18px" width="18px" src="/images/edit.ICO" alt="Edit" border="0">Edit</a></div></td>
      </tr>
