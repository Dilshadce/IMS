...
<tr>
<td width="250px" style="font-size:16px;" height="30px">#dbname#</td>
...
<tr>
<td colspan="3">
<input type="radio" name="cctype16" id="cctype16MASTER" value="MASTER" checked="checked"/>Mastercard&nbsp;&nbsp;&nbsp;
<input type="radio" name="cctype16" id="cctype16VISA" value="VISA" />Visa&nbsp;&nbsp;&nbsp;
<input type="radio" name="cctype16" id="cctype16AMEX" value="AMEX" />American Express&nbsp;&nbsp;
<input type="radio" name="cctype16" id="cctype16DINERS" value="DINERS" />Diners Club
</td>
</tr>
<tr>
...
<tr>
<td colspan="3">
<input type="radio" name="cctype26" id="cctype26MASTER" value="MASTER" checked="checked"/>Mastercard&nbsp;&nbsp;&nbsp;
<input type="radio" name="cctype26" id="cctype26VISA" value="VISA" />Visa&nbsp;&nbsp;&nbsp;
<input type="radio" name="cctype26" id="cctype26AMEX" value="AMEX" />American Express&nbsp;&nbsp;
<input type="radio" name="cctype26" id="cctype26DINERS" value="DINERS" />Diners Club
</td>
</tr>
<tr>
...
<select name="depositno" id="depositno" onchange="getdeposit();">
...
<tr>
<td align="center" colspan="3"><input type="button" name="cancelbtn" id="cancelbtn" value="Cancel" style="font: large bolder;" onclick="ColdFusion.Window.hide('totalup6');"/>&nbsp;&nbsp;&nbsp;<input type="submit" name="sub_btn" id="sub_btn" value="Accept" style="font: large bolder;" /></td>
</tr>
</table>
</form>
