...
select trancode,itemno from ictrantemp
WHERE 
...
update ictrantemp set trancode="#url.trancode#"
WHERE 
trancode = "#val(url.trancode)-1#"
and uuid = <cfqueryparam cfsqltype="cf_sql_varchar" value="#url.uuid#">
...
update ictrantemp set trancode="#val(url.trancode)-1#"
WHERE 
...
select trancode from ictrantemp
WHERE 
...
<cfoutput>
<input type="text" name="hidsubtotal" id="hidsubtotal" value="#numberformat(getsum.sumsubtotal,'.__')#" />
<input type="text" name="hiditemcount" id="hiditemcount" value="#getsum.notran#" />
</cfoutput>
