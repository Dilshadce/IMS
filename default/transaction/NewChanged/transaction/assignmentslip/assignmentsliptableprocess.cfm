	...
	"Being services rendered from #dateformat(startdate,'DD/MM/YYYY')# to #dateformat(completedate,'DD/MM/YYYY')# by Mr #form.empname# - #getposition.position#"
     ...
     <cfquery name="insertictran" datasource="#dts#">
        ...
        (
            ...
            'Salary', 
            <cfif getempinfo.sex eq "Female" or getempinfo.sex eq "F">
        	"Being services rendered from #dateformat(startdate,'DD/MM/YYYY')# to #dateformat(completedate,'DD/MM/YYYY')# by Ms #form.empname# - #getposition.position#<cfif val(form.CUSTNPL) neq 0 and (form.paymenttype eq 'mth' or form.paymenttype eq '')> $#numberformat(val(form.SELFUSUALPAY),'.__')# / #val(form.workd)# x #val(form.custsalaryday)#</cfif>"
			<cfelse>
			"Being services rendered from #dateformat(startdate,'DD/MM/YYYY')# to #dateformat(completedate,'DD/MM/YYYY')# by Mr #form.empname# - #getposition.position# <cfif val(form.CUSTNPL) neq 0 and (form.paymenttype eq 'mth' or form.paymenttype eq '')> $#numberformat(val(form.SELFUSUALPAY),'.__')# / #val(form.workd)# x #val(form.custsalaryday)#</cfif>"
			</cfif>, 
            '', 
            '',
            '#val(xqty)#',
     ...
     <cfif val(form.custottotal) neq 0> 
     <!---OT---->
     <cfquery name="insertictran" datasource="#dts#">
        insert into ictran
        (
       ...
       <cfif val(form.custallowancerate1) neq 0 and val(custallowancehour1) neq 0>
     <!---Allowance 1---->
     <cfquery name="insertictran" datasource="#dts#">
        insert into ictran
        (
               ...
               '1',
                ...
                '',
                  ...
                  0.00000,1
                      ...
                      <cfif val(form.custallowancerate2) neq 0 and val(custallowancehour2) neq 0>
     <!---Allowance 2---->
     <cfquery name="insertictran" datasource="#dts#">
        insert into ictran
        (
            ...
            #numberformat(val(form.custallowancehour2),'.__')#,
             #numberformat(val(form.custallowancerate2),'.__')#,
              ...
              <cfif val(form.custallowancerate3) neq 0 and val(form.custallowancehour3) neq 0>
     <!---Allowance 3---->
     <cfquery name="insertictran" datasource="#dts#">
        insert into ictran
        (
     ...
     <cfif val(form.addchargecust4) neq 0>
     <!---other 4---->
     <cfquery name="insertictran" datasource="#dts#">
        insert into ictran
        (
     ...
     <cfif val(form.addchargecust5) neq 0>
     <!---other 5---->
     <cfquery name="insertictran" datasource="#dts#">
        insert into ictran
        (
     ...
     <cfif val(form.addchargecust6) neq 0>
      <!---other 6---->
     <cfquery name="insertictran" datasource="#dts#">
        insert into ictran
        (
	...
	"Being services rendered from #dateformat(startdate,'DD/MM/YYYY')# to #dateformat(completedate,'DD/MM/YYYY')# by Mr #form.empname# - #getposition.position#"
        ...
        <cfqueryparam cfsqltype="cf_sql_varchar" value="SGD">
               ...
               <cfset xprice=val(form.custusualpay)>
                ...
                <cfif checksalaryexist.recordcount neq 0>
                ...
                <!---Allowance---->
                <cfif val(form.custallowancerate1) neq 0 and val(form.custallowancehour1) neq 0>
                ...
                <cfif checkallowanceexist.recordcount neq 0>
...
qty = #numberformat(val(form.custallowancehour1),'.__')#,         price_bil=#numberformat(val(form.custallowancerate1),'.__')#,
   ...
   <cfquery name="insertictran" datasource="#dts#">
     ...
     <!---Allowance 2---->
<cfif val(form.custallowancerate2) neq 0 and val(form.custallowancehour2) neq 0>
<cfquery datasource='#dts#' name="checkallowanceexist">
...
delete from ictran where refno = '#form.refno#' and type='INV' and itemno='allowance6'
                ...
                <cfif checkcpfexist.recordcount neq 0>
                ...
                <cfif checksdfexist.recordcount neq 0>
                ...
                <cfif checkother2exist.recordcount neq 0>
                ...
                <cfif checkother3exist.recordcount neq 0>
                ...
                <cfif checkother4exist.recordcount neq 0>
                ...
                <cfif checkother5exist.recordcount neq 0>
                ...
                <cfif checkother6exist.recordcount neq 0>
...
<form name="done" action="s_assignmentsliptable.cfm?type=assignmentslip&process=done" method="post">
 ...
 SELECT coalesce(selfsalary,0) + coalesce(selfottotal,0)+coalesce(selfallowance,0)+coalesce(selfpayback,0)+coalesce(selfexception,0) as gp FROM assignmentslip WHERE refno = <cfqueryparam cfsqltype="cf_sql_varchar" value="#form.refno#">
 </cfquery>
 
 <cfif val(checkpaydetail.grosspay) neq val(getassignmentdetail.gp)>
