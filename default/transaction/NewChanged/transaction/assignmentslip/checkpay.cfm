<cfif isdefined('url.newassignment')>
<cfquery name="checkartran" datasource="#dts#">
SELECT refno FROM artran WHERE refno = <cfqueryparam cfsqltype="cf_sql_varchar" value="#url.refno#">
</cfquery>

<cfif checkartran.recordcount neq 0>
<cfoutput>
<input type="hidden" id="checkclash" name="checkclash" value="#checkartran.refno#">
</cfoutput>
<cfabort>
</cfif>
