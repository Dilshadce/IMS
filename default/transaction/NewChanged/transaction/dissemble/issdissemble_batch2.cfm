...
where 
uuid=<cfqueryparam cfsqltype="cf_sql_varchar" value="#form.issdissembleuuid#"> 
and trancode=<cfqueryparam cfsqltype="cf_sql_varchar" value="#form.issdissembletrancode#">

</cfquery>

<script type="text/javascript">
ColdFusion.Window.hide('issbatch');
</script>