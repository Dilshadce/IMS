...
select * from displaysetup
    ...
    <cfif URLDECODE(url.aitemno2) neq "">
    and aitemno like <cfqueryparam cfsqltype="cf_sql_varchar" value="%#URLDECODE(url.aitemno2)#%" />
    </cfif>
