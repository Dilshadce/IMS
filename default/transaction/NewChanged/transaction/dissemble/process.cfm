...
select refno from artran where type='ISS' and refno=<cfqueryparam cfsqltype="cf_sql_varchar" value="#refno#">
</cfquery>

<cfquery name="checkexistrefno2" datasource="#dts#">
select refno from artran where type='RC' and refno=<cfqueryparam cfsqltype="cf_sql_varchar" value="#refno#">
</cfquery>
        ...
        refno = <cfqueryparam cfsqltype="cf_sql_varchar" value="#refno#"> and type = 'ISS'
        </cfquery>
...
select sum(amt) as amt,type from issuetemp where uuid = <cfqueryparam cfsqltype="cf_sql_varchar" value="#uuid#">
</cfquery>
...
select sum(amt) as amt,type from receivetemp where uuid = <cfqueryparam cfsqltype="cf_sql_varchar" value="#uuid#">
</cfquery>
...
insert into assmtran (refno,wos_date,created_on,created_by) values (<cfqueryparam cfsqltype="cf_sql_varchar" value="#refno#">,<cfqueryparam cfsqltype="cf_sql_varchar" value="#wos_date#">,now(),<cfqueryparam cfsqltype="cf_sql_varchar" value="#huserid#">)
</cfquery>

<!--- Batch ISS Function--->

<cfquery name="getissbody" datasource="#dts#">
select * from issuetemp where refno=<cfqueryparam cfsqltype="cf_sql_varchar" value="#refno#">
and uuid = <cfqueryparam cfsqltype="cf_sql_varchar" value="#uuid#">
</cfquery>
...
<cfquery name="checkbatch" datasource="#dts#">
			...
			batchcode 
			from obbatch 
			where batchcode='#getissbody.batchcode#' 
			and itemno='#getissbody.itemno#';
		</cfquery>
		...
		<cfelse>
			...
			<cfquery name="updateobbatch" datasource="#dts#">
				update obbatch set 
				BTH_QUT=(BTH_QUT+#getissbody.qty#) 
				where itemno='#getissbody.itemno#' 
				and batchcode='#getissbody.batchcode#';
			</cfquery>
		</cfif>
		...
		<cfif getissbody.location neq "">
			<cfquery name="checklobthob" datasource="#dts#">
				...
				batchcode 
				from lobthob 
				where location='#getissbody.location#' 
				and batchcode='#getissbody.batchcode#' 
				and itemno='#getissbody.itemno#';
			</cfquery>
...
select * from receivetemp where refno=<cfqueryparam cfsqltype="cf_sql_varchar" value="#refno#">
and uuid = <cfqueryparam cfsqltype="cf_sql_varchar" value="#uuid#">
</cfquery>
...
<cfquery name="checkbatch" datasource="#dts#">
			...
			batchcode 
			from obbatch 
			where batchcode='#getrcbody.batchcode#' 
			and itemno='#getrcbody.itemno#';
		</cfquery>
		...
		<cfelse>
			...
			<cfquery name="updateobbatch" datasource="#dts#">
				update obbatch set 
				BTH_QIN=(BTH_QIN+#getrcbody.qty#) 
				where itemno='#getrcbody.itemno#' 
				and batchcode='#getrcbody.batchcode#';
			</cfquery>
		</cfif>
		...
		<cfif getrcbody.location neq "">
			<cfquery name="checklobthob" datasource="#dts#">
				...
				batchcode 
				from lobthob 
				where location='#getrcbody.location#' 
				and batchcode='#getrcbody.batchcode#' 
				and itemno='#getrcbody.itemno#';
			</cfquery>
...
select * from iserialtemp where uuid='#uuid#'
</cfquery>

<cfloop query="gettempserialno">

<cfquery name="checkexistserialno" datasource="#dts#">
select sum(sign) as qty from iserial where itemno='#itemno#' and serialno='#gettempserialno.serialno#'
</cfquery>
...
select 
type,refno,trancode,custno,fperiod,wos_date,itemno,serialno,agenno,location,currrate,sign,price from iserialtemp
...
<cfquery datasource="#dts#" name="getGeneralInfo">
    ...
    <cfoutput>
			<input name="status" value="Assemble/Dissemble No #refno# is Created!" type="hidden">
    </cfoutput>
		</form>
