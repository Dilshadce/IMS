...
<cfelseif url.t2 eq "RC" and url.t1 eq "PO">
	<cfquery datasource="#dts#" name="getupdate">
		...
		and order_cl = '' and (void = '' or void is null) <cfif lcase(hcomid) eq "hunting_i" and t1 eq "Sam">and printstatus = "a3"</cfif><cfif getgeneral.poapproval eq 'Y'>and printstatus = "a3"</cfif> group by custno order by custno
	</cfquery>
<!--- t1 = DO t1 = DO t1 = DO t1 = DO t1 = DO t1 = DO t1 = DO t1 = DO t1 = DO t1 = DO t1 = DO t1 = DO t1 = DO t1 = DO t1 = DO --->
<cfelseif t1 eq "DO">
	<cfquery datasource="#dts#" name="getupdate">
		Select count(refno) as cnt, lower(custno) as custno, lower(name) as name, userid,refno,source,lower(rem5) as rem5,permitno from artran where type = '#t1#'
		and toinv = '' and (void = '' or void is null) group by custno order by custno
	</cfquery>
<!--- t1=PO to t2=INV ---->	
...
<cfelse>
	...
	<cfquery datasource="#dts#" name="getupdate">
		Select count(refno) as cnt, lower(custno) as custno,lower(rem5) as rem5, lower(name) as name, userid,refno,source,permitno from artran where type = '#t1#'
		and order_cl = '' and (void = '' or void is null) <cfif lcase(hcomid) eq "hunting_i" and t1 eq "Sam">and printstatus = "a3"</cfif><cfif lcase(hcomid) eq "ltm_i"> and (rem45='' or rem45 is null or rem45='A')</cfif> group by custno order by custno
	</cfquery>
</cfif>
