        ...
        <cfset session.formName="updatepage">
			...
			<cfloop from="1" to="#cnt#" index="i" step="+3">
				...
				<cfoutput query="getupdate"> 
                    ...
                    <cfif (getitemqtyonhand.balance lt qtytoful) and getGsetup.negstk neq '1'>
				...
				<cfloop from="1" to="#cnt#" index="i" step="+3">
					...
					<cfoutput query="getupdate">				
                    	...
                    	<td>#brem4#</td>
                            ...
                            <td><div align="center">
                            <cfif getupdate.linecode eq 'SV'><input type="hidden" name="balanceqty" id="balanceqty_#t1#_#refno#_#trancode#" value="SV" size="6"><cfelse><input type="hidden" name="balanceqty" id="balanceqty_#t1#_#refno#_#trancode#" value="#getitemqtyonhand.balance#" size="6"></cfif>#getitemqtyonhand.balance#</div></td>
							<input type="hidden" name="qtytoful" value="#qtytoful#">
							<!--- <td><input type="text" name="fulfill" value="#qtytoful#"></td> --->
							<!--- Add & modified on 031008 --->
                    		<cfquery name="getigrade" datasource="#dts#">
			...
			<cfloop from="1" to="#cnt#" index="i" step="+3">
				...
				<cfoutput query="getupdate"> 				
					...
					<tr onMouseOut="javascript:this.style.backgroundColor='';" onMouseOver="javascript:this.style.backgroundColor='99FF00';"> 					 
                        ...
                        <td>
                            <input type="text" name="itemcost" id="itemcost_#t1#_#refno#_#trancode#" value="0" <cfif getigrade.recordcount neq 0>readonly</cfif>>
                        </td>
