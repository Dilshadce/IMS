...
<cfif left(form.refno,1) neq 's'>
    ...
    <!---  refresh ictran --->
     ...
     <cfif checkassign.trancodestart eq 0 and checkassign.trancodeend eq 0>
         ...
         SELECT max(trancode) trancode FROM ictran WHERE refno = "#refnofound#"
         ...
         <cfif getlatesttrancode.recordcount eq 0>
         	<cfset trancodestarttemp = 0>
         <cfelse>
         	<cfset trancodestarttemp = val(getlatesttrancode.trancodeend)+100>
            <br> trancodestarttemp = val(getlatesttrancode.trancodeend)+100
         </cfif>
     <cfelse>
     ...
     <cfquery name="insertictran" datasource="#dts#">
        ...
        (
        	...
        	<cfqueryparam cfsqltype="cf_sql_varchar" value="#dateformat(getassignment.assignmentslipdate,'yyyy-mm-dd')#">,
     ...
     <!---<cfif form.invdesp2 eq "">--->
        ...
        <cfelse>
            <cfif val(getassignment.workd) neq 0>
                <cfset datestartof = getassignment.startdate>
                <cfset dateendof = getassignment.completedate>
                <cfset monthprorate = ROUND((val(DateDiff("d", datestartof, dateendof) + 1)/val(getassignment.workd))*100000)/100000>
            <cfelse>
        ...
        <cfset xprice=val(getassignment.custsalary)>
         ...
         <cfelseif getassignment.paymenttype eq 'day' >
            ...
            <cfset xunit ="Day">
        <cfelse>
            <cfset xprice = numberformat(getassignment.custusualpay,'_.__')>
            <cfset xunit ="Month">
         </cfif>
	 ...
	 <cfif evaluate('getassignment.fixawcode#i#') neq "" and val(evaluate('getassignment.fixawer#i#')) neq 0>
          <cfquery name="insertictran" datasource="#dts#">
            ...
            (
                ...
                '', 
                '',
                <cfqueryparam cfsqltype="cf_sql_double" value="#evaluate('getassignment.fixawerqty#i#')#">,
                <cfqueryparam cfsqltype="cf_sql_double" value="#evaluate('getassignment.fixawerrate#i#')#">,
                '#xunit#',
	 ...
	 <cfif evaluate('getassignment.allowance#i#') neq "" and val(evaluate('getassignment.awer#i#')) neq 0>
          <cfquery name="insertictran" datasource="#dts#">
            ...
            (
                ...
                '', 
                '',
                <cfqueryparam cfsqltype="cf_sql_double" value="#evaluate('getassignment.awerqty#i#')#">,
                 <cfqueryparam cfsqltype="cf_sql_double" value="#evaluate('getassignment.awerrate#i#')#">, 
                '#xunit#',
    ...
    <cfset trancodestarttemp = trancodestarttemp + 1>
     ...
     UPDATE ictran SET brem3 = "#dateformat(startdate,'dd Mmm YYYY')#-#dateformat(completedate,'dd Mmm YYYY')#"
     WHERE refno = '#form.refno#'  and type ='INV'
     </cfquery>
     
     <cfquery name="gettaxprofile" datasource="#dts#">
     SELECT arrem5,arrem7 FROM arcust WHERE custno = "#getassignment.custno#"
     </cfquery>
     
     <cfif gettaxprofile.arrem5 neq "">
         
    <cfif trim(gettaxprofile.arrem7) eq "1" and datediff('d',lsdateformat("31/08/2018",'YYYY-MM-DD', 'en_AU'),lsdateformat((completedate),'YYYY-MM-DD', 'en_AU')) gt 0>
     ...
     <cfif gettaxmethod.billtaxable eq "Y">
    			...
    			<cfquery datasource='#dts#' name="updateictran">                    
                    Update ictran a, (select refno,taxper from assignmentslip where invoiceno='#form.refno#') b
                    set 
                    taxpec1=b.taxper,
    ...
    <cfset tran = "INV">
    <cfset url.nexttranno = getassignment.invoiceno>
