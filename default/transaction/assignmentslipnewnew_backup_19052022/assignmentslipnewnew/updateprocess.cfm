...
SELECT grosspay,empno,paydate,nsded,aw104,aw105,aw106,aw107,aw108,aw109,aw110,aw115,aw116,aw117,taw FROM payweek#a# WHERE grosspay <> "0" and grosspay is not null and grosspay <> "" and payyes = "Y" and paydate <> "" and paydate is not null 
...
earlyhr = 0,
nopayhr = 0,
<!---Updated by Nieo 20171011 1832--->
<!---AW#val(100 + a)# = #val(getgrosspay.grosspay)-val(getgrosspay.taw)#,--->
    AW104 = <cfif a neq 1>coalesce(AW104,0) + </cfif>#val(getgrosspay.aw104)#,
AW105 = <cfif a neq 1>coalesce(AW105,0) + </cfif>#val(getgrosspay.aw105)#,
AW106 = <cfif a neq 1>coalesce(AW106,0) + </cfif>#val(getgrosspay.aw106)#,
AW107 = <cfif a neq 1>coalesce(AW107,0) + </cfif>#val(getgrosspay.aw107)#,
AW108 = <cfif a neq 1>coalesce(AW108,0) + </cfif>#val(getgrosspay.aw108)#,
AW109 = <cfif a neq 1>coalesce(AW109,0) + </cfif>#val(getgrosspay.aw109)#,
AW110 = <cfif a neq 1>coalesce(AW110,0) + </cfif>#val(getgrosspay.aw110)#,
AW116 = <cfif a neq 1>coalesce(AW116,0) + </cfif>#val(getgrosspay.aw116)#,
AW117 = <cfif a neq 1>coalesce(AW117,0) + </cfif>#val(getgrosspay.aw117)#<!---,
PAYYES = "Y"--->
<!---Updated by Nieo 20171011 1832--->
