      ...
      <cfloop query="getplacementleavens">
        ...
        <cfloop query="getpm">
			<cfif getpm.itemname eq "OT1">
                ...
                <cfset selfotrate1= numberformat(evaluate(replace(getpm.payableamt,'=','')),'.__')>
                </cfif>
                
                <cfif getpm.billable eq "Y">
                <cfset BASIC = selfusualpay>
                <cfset custotrate1= numberformat(evaluate(replace(getpm.billableamt,'=','')),'.__')>
                </cfif>
            <cfelseif getpm.itemname eq "OT1.5">
                <cfif getpm.payable eq "Y">
                <cfset BASIC = selfusualpay>
                <cfset selfotrate2= numberformat(evaluate(replace(getpm.payableamt,'=','')),'.__')>
                </cfif>
                
                <cfif getpm.billable eq "Y">
                <cfset BASIC = selfusualpay>
                <cfset custotrate2= numberformat(evaluate(replace(getpm.billableamt,'=','')),'.__')>
                </cfif>
            <cfelseif getpm.itemname eq "OT2">
                <cfif getpm.payable eq "Y">
                <cfset BASIC = selfusualpay>
                <cfset selfotrate3= numberformat(evaluate(replace(getpm.payableamt,'=','')),'.__')>
                </cfif>
                
                <cfif getpm.billable eq "Y">
                <cfset BASIC = selfusualpay>
                <cfset custotrate3= numberformat(evaluate(replace(getpm.billableamt,'=','')),'.__')>
                </cfif>
            <cfelseif getpm.itemname eq "OT3">
                <cfif getpm.payable eq "Y">
                <cfset BASIC = selfusualpay>
                <cfset selfotrate4= numberformat(evaluate(replace(getpm.payableamt,'=','')),'.__')>
                </cfif>
                
                <cfif getpm.billable eq "Y">
                <cfset BASIC = selfusualpay>
                <cfset custotrate4= numberformat(evaluate(replace(getpm.billableamt,'=','')),'.__')>
           		</cfif>
            </cfif>
        </cfloop>
		</cfif>
...
Please verify to ensure amounts are correct. </font></td></cfif>
   ...
   <cfset selfothour1 =val(getot.oth)>
   <cfset selfothour2 =val(getot.oth15)>
   <cfset selfothour3 =val(getot.oth2)>
   <cfset selfothour4 =val(getot.oth3)>
   <cfset custothour1 =val(getot.oth)>
   <cfset custothour2 =val(getot.oth15)>
   <cfset custothour3 =val(getot.oth2)>
   <cfset custothour4 =val(getot.oth3)>
...
order by  id
	 ...
	 <cfelse>
      ...
      <tr style="display:none">
      <td>
      <input type="text" name="lvltype#i#" id="lvltype#i#" value="#evaluate('lvltype#i#')#" size="10" readonly />
      </td>
      <td>
      ...
      <td>
      <input type="text" name="lvlhr#i#" id="lvlhr#i#" value="#evaluate('lvlhr#i#')#" size="10" />
...
<cfset govlist = "15,16,42">
      ...
      <tr>
            ...
            <cfloop query="getaw">
            <option title="#getaw.allowance#" value="#getaw.aw_cou#" <cfif url.type eq "create" and isdefined('url.auto2') eq false><cfif a eq getaw.currentrow>selected<cfset awnowdesp = getaw.aw_cou></cfif><cfelse> <cfif evaluate('aw#a#') eq  getaw.aw_cou>Selected</cfif></cfif> id="#getaw.aw_desp#">#getaw.aw_desp#</option>
            </cfloop>
            </select></td>
            <cfif awnowdesp neq "">
            ...
            <td colspan="2">
            <input type="text" name="allowancedesp#a#" id="allowancedesp#a#" size="30" value="<cfif url.type eq "create"><cfif awnowdesp neq "">#getawdesp.dballname#</cfif><cfelse>#evaluate('allowancedesp#a#')#</cfif>">
            </td>
            <td>
