...
<!---             '#val(form.selfexceptionday)#', --->
	  ...
	  <cfif form.assignmenttype neq 'invoice'>
            ...
            <cfquery name="checkinvoiceexist" datasource="#dts#">
                  ...
                  and day(wos_date) = "#dateformat(assignmentslipdate,'d')#"
...
<!---         <cfif form.assignmenttype eq 'invoice'> --->
      ...
      <cfif form.assignmenttype neq "invoice" and isdefined('refnofound') eq false>
            <cfquery name="checkentity" datasource="#dts#">
                  SELECT location,jobpostype,custno FROM placement WHERE placementno = <cfqueryparam cfsqltype="cf_sql_varchar" value="#form.placementno#">
            </cfquery>
            <cfquery name="getlastno" datasource="#dts#">
      ...
      <cfif checkitemExist.recordcount neq 0 > <!-- Coding from line 839 check if record exist till line 881-->
			<cfif form.mode eq "Delete"> <!-- Coding from line 840 check if mode is delete till line 881-->
                  ...
                  <cfelse>
                        ...
                        <cfquery datasource='#dts#' name="deleteictran">
                              UPDATE ictran SET void = "Y" where refno='#gettrancodes.orirefno#' and type='INV' and trancode between "#gettrancodes.trancodestart#" and "#gettrancodes.trancodeend#"
                        </cfquery>
						...
						<cfif checkempty.recordcount eq 0>
                              <cfquery datasource='#dts#' name="deleteartran">
                                  UPDATE artran SET void = "Y",rem30 = <cfqueryparam cfsqltype="cf_sql_varchar" value="#form.reason#"> where refno='#gettrancodes.orirefno#' and type='INV'
                              </cfquery>
                        <cfelse>
                              <cfquery datasource='#dts#' name="deleteartran">
   ...
   <!---              <cfif form.assignmenttype neq 'sinvoice'> --->
                  ...
                  <cfif isdefined('isfirst')> <!-- CF for isfirst start at line 1234 and end at line 1396 -->
                          ...
                          <!--- refno = <cfqueryparam cfsqltype="cf_sql_varchar" value="#form.refno#">, --->
                              ...
                              <cfelse> <!-- Below coding will handle existing value turn to zero -->
                                    ...
                                    <cfelse>
                                          ...
                                          <cfquery datasource='#dts#' name="deleteartran">
                                              UPDATE artran SET void = "Y",rem30 = "System auto void due to zero billing" where refno='#form.refnotrue#' and type='INV'
                                          </cfquery>
                                          <cfquery datasource='#dts#' name="deleteictran">
                                              UPDATE ictran SET void = "Y" where refno='#form.refnotrue#' and type='INV'
                                          </cfquery>
                        ...
                        <cfelse><!-- Comment artran cannot find the record, then insert new data for line 1240 to line 1289 to line 1394  -->
                              ...
                              <cfif form.custtotalgross neq 0> <!-- Do not allow to insert when value is zero, finish at line 1393 -->
                                    <cfquery name="insertartran" datasource="#dts#">
                                          INSERT INTO artran
                                          ...
                                          <cfif form.assignmenttype neq "invoide">
                                                ,"#form.assignmenttype#"
                                          </cfif>
                                          )
                                    </cfquery>
 				  ...
 				  <cfif form.assignmenttype neq 'invoice'><!-- Must let line 1397 run till 1412 so that ictran will be deleted -->
						<cfif isdefined('refnofound')>
                              ...
                              <cfquery name="deleteictran" datasource="#dts#">
                                    delete from ictran where refno = '#refnofound#' and type='INV'
                                    AND trancode BETWEEN "#val(gettrancodes.trancodestart)#" and "#val(gettrancodes.trancodeend)#"
                              </cfquery>
                        </cfif>
                  <cfelse>
                  ...
                  <cfif form.custtotalgross neq 0> <!-- If custtotalgross is not zero, system will go calculate the ictran -->
                        <cfinclude template="/default/transaction/assignmentslipnewnew//ictranbody.cfm">
                  </cfif> <!-- Assume that calling ictranbody will insert data again, i do not have to care about ictran since it will be delete and inserted again -->
...
<cfoutput>
<cfif isdefined('form.validatetimesheet')>
      <cfquery name="validatetimesheet" datasource="#dts#">
	  ...
	  <script type="text/javascript">
			...
			window.location.href='/latest/customization/manpower_i/mpapproval/TimesheetApprovalMain.cfm';
      </script>
      <cfabort>
</cfif>
