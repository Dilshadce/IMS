...
<!---proration rate for 2 month if timesheet cycle is not 01-31, [20170219, Alvin]--->
	<cfif month(lsdateformat(realstartdate, 'yyyy-mm-dd', "en_AU")) neq month(lsdateformat(realenddate, 'yyyy-mm-dd', "en_AU"))>
        ...
        <cfif val(noofdays) neq 0> <!---if eq 0 means work for 0 days--->
            ...
            <cfset lvleerate2 = numberformat(employeepay/val(realdayswork),'.__')*-1>
            <cfset lvlerrate2 = numberformat(employerpay/val(realdayswork),'.__')*-1>
        <cfelse>
			<cfset lvleerate1 = 0>
            <cfset lvlerrate1 = 0>
            <cfset lvleerate2 = 0>
...
<cfif isdefined('url.newworkd')>
    <cfif lcase(url.newworkd) eq 'y'>
        <cfset noofdays = businessDaysBetween(createDate(year(datestartof),month(datestartof),1),dateAdd('d',-1,createDate(year(datestartof),month(datestartof)+1,1)))>        
...
<cfset totalfixawamter =0>
  ...
  <cfif getplacement.pm neq "">
        ...
        <cfloop query="getpm">
            ...
            <cfelseif getpm.itemname eq "Over Time 1.5" OR getpm.itemname eq "OT1.5" OR getpm.itemname eq "OT 1.5"> <!---Added new itemname for OT, [20170508, Alvin]--->
                <cfif getpm.payable eq "Y">
                <cfset BASIC = selfusualpay>
            ...
            <cfelseif getpm.itemname eq "OT2" OR getpm.itemname eq "Over Time 2.0" OR getpm.itemname eq "OT 2.0">	<!---Added new itemname for OT, [20170508, Alvin]--->
                <cfif getpm.payable eq "Y">
                <cfset BASIC = selfusualpay>
            ...
            <cfelseif getpm.itemname eq "OT3" OR getpm.itemname eq "Over Time 3.0" OR getpm.itemname eq "OT 3.0">	<!---Added new itemname for OT, [20170508, Alvin]--->
                <cfif getpm.payable eq "Y">
                <cfset BASIC = selfusualpay>
...
order by  id
	 ...
	 <cfelse>
      ...
      <th><div align="right">Basic Pay</div></th>
       ...
       <td style="background-color:#bgcolor#"><input type="text" size='10' name="custsalary" id="custsalary" value="#numberformat(custsalary,'_.__')#" onKeyUp="calcusttotal();" onBlur="calcusttotal();"></td>
      </tr>
      <tr>
      ...
      <td>
      <input type="text" name="lvleerate#i#" id="lvleerate#i#" value="#numberformat(evaluate('lvleerate#i#'),'_.__')#" size="10" onkeyup="leaveself();" />
      </td>
      <td style="background-color:#bgcolor#">
      <input type="text" name="lvlerdayhr#i#" id="lvlerdayhr#i#" value="#evaluate('lvlerdayhr#i#')#" size="10" onkeyup="leavecust();" />
      </td>
      <td style="background-color:#bgcolor#">
      <input type="text" name="lvlerrate#i#" id="lvlerrate#i#" value="#numberformat(evaluate('lvlerrate#i#'),'_.__')#" size="10" onkeyup="leavecust();" />
      </td>
      <td>
      ...
      <td><input type="text" name="fixawdesp#i#" id="fixawdesp#i#" size="30" value="#evaluate('fixawdesp#i#')#"  readOnly/></td>
        <td>
            <input type="number" name="fixaweerate#i#" id="fixaweerate#i#" value="<cfif val(evaluate('fixawee#i#')) neq 0>#numberformat(evaluate('fixawee#i#'),'.__')#<cfelse>0.00</cfif>" onkeyup="if(this.readOnly == false){document.getElementById('fixawerrate#i#').value=this.value;calcvaraw(this.value,document.getElementById('fixaweeqty#i#').value,'fixawee#i#');calselfallow();calcvaraw(document.getElementById('fixawerrate#i#').value,document.getElementById('fixawerqty#i#').value,'fixawer#i#');calcustallow();}" onBlur="if(this.readOnly == false){document.getElementById('fixawerrate#i#').value=this.value;calcvaraw(this.value,document.getElementById('fixaweeqty#i#').value,'fixawee#i#');calselfallow();calcvaraw(document.getElementById('fixawerrate#i#').value,document.getElementById('fixawerqty#i#').value,'fixawer#i#');calcustallow();}" style="width: 100px"  />
        </td>
        <td>
            <input type="number" name="fixaweeqty#i#" id="fixaweeqty#i#" value="<cfif evaluate('fixawee#i#') neq 0>1<cfelse>0</cfif>" onkeyup="if(this.readOnly == false){document.getElementById('fixawerqty#i#').value=this.value;calcvaraw(document.getElementById('fixaweerate#i#').value,this.value,'fixawee#i#');calselfallow();calcvaraw(document.getElementById('fixawerrate#i#').value,document.getElementById('fixawerqty#i#').value,'fixawer#i#');calcustallow();}" onBlur="if(this.readOnly == false){document.getElementById('fixawerqty#i#').value=this.value;calcvaraw(document.getElementById('fixaweerate#i#').value,this.value,'fixawee#i#');calselfallow();calcvaraw(document.getElementById('fixawerrate#i#').value,document.getElementById('fixawerqty#i#').value,'fixawer#i#');calcustallow();}" style="width: 100px"  />
        </td>
        <td style="background-color:#bgcolor#">
            <input type="number" name="fixawerrate#i#" id="fixawerrate#i#" value="<cfif evaluate('fixawer#i#') neq 0>#numberformat(evaluate('fixawer#i#'),'.__')#<cfelse>0.00</cfif>" onkeyup="calcvaraw(this.value,document.getElementById('fixawerqty#i#').value,'fixawer#i#');calcustallow();" onBlur="calcvaraw(this.value,document.getElementById('fixawerqty#i#').value,'fixawer#i#');calcustallow();" style="width: 100px"  />
        </td>
        <td style="background-color:#bgcolor#">
            <input type="number" name="fixawerqty#i#" id="fixawerqty#i#" value="<cfif evaluate('fixawer#i#') neq 0>1<cfelse>0</cfif>" onkeyup="calcvaraw(document.getElementById('fixawerrate#i#').value,this.value,'fixawer#i#');calcustallow();" onBlur="calcvaraw(document.getElementById('fixawerrate#i#').value,this.value,'fixawer#i#');calcustallow();" style="width: 100px"  />
        </td>
      <td><input type="text" name="fixawee#i#" id="fixawee#i#" value="#numberformat(evaluate('fixawee#i#'),'.__')#" onkeyup="calselfallow();" style="width: 100px" readOnly/></td>
       <td style="background-color:#bgcolor#"><input type="text" name="fixawer#i#" id="fixawer#i#" value="#numberformat(evaluate('fixawer#i#'),'.__')#" onkeyup="calcustallow();" style="width: 100px" readOnly/></td>
...
<cfset govlist = "15,16,42">
      ...
      <tr>
            ...
            <select style="width:200px" name="allowance#a#" id="allowance#a#" onChange="document.getElementById('allowancedesp#a#').value=this.options[this.selectedIndex].id;document.getElementById('allowancedesp#a#').readOnly = false;document.getElementById('aweerate#a#').readOnly = false;document.getElementById('awerrate#a#').readOnly = false;document.getElementById('aweeqty#a#').readOnly = false;document.getElementById('awerqty#a#').readOnly = false;document.getElementById('awee#a#').readOnly = false;document.getElementById('awer#a#').readOnly = false;checkitem(this.value,#a#);">
...
<!---             <cfif awnowdesp neq "">
            ...
            <cfif evaluate('aw#a#') neq "">
                ...
                <cfif isdefined('aweeexp#awid#')>
                    <!---EE: #numberformat(evaluate('aweeexp#awid#'),'.__')# / ER: #numberformat(evaluate('awerexp#awid#'),'.__')#<br>--->
                    <td>
                     <input type="number" name="aweerate#a#" id="aweerate#a#" style="width: 100px" value="<cfif val(evaluate('aweerate#a#')) neq 0>#numberformat(evaluate('aweerate#a#'),'.__')#<cfelse><cfif val(evaluate('aweeexp#awid#')) neq 0>#numberformat(evaluate('aweeexp#awid#'),'.__')#<cfelse>#numberformat(evaluate('awee#a#'),'.__')#</cfif></cfif>" onKeyUp="if(this.readOnly == false){document.getElementById('awerrate#a#').value=this.value;calcvaraw(this.value,document.getElementById('aweeqty#a#').value,'awee#a#');calselfallow();calcvaraw(document.getElementById('awerrate#a#').value,document.getElementById('awerqty#a#').value,'awer#a#');calcustallow();}" onBlur="if(this.readOnly == false){document.getElementById('awerrate#a#').value=this.value;calcvaraw(this.value,document.getElementById('aweeqty#a#').value,'awee#a#');calselfallow();calcvaraw(document.getElementById('awerrate#a#').value,document.getElementById('awerqty#a#').value,'awer#a#');calcustallow();}" onclick="if(document.getElementById('allowancedesp#a#').value == ''){alert('Please select an Allowance to edit this field')}" <cfif evaluate('allowancedesp#a#') eq ''>readOnly</cfif>>
                    </td>
                    <td>
                     <input type="number" name="aweeqty#a#" id="aweeqty#a#" style="width: 100px" value="<cfif evaluate('aweeqty#a#') neq 0>#numberformat(evaluate('aweeqty#a#'),'.__')#<cfelse><cfif evaluate('awee#a#') neq 0 and url.type neq 'create'>1<cfelse>0</cfif></cfif>" onKeyUp="if(this.readOnly == false){document.getElementById('awerqty#a#').value=this.value;calcvaraw(document.getElementById('aweerate#a#').value,this.value,'awee#a#');calselfallow();calcvaraw(document.getElementById('awerrate#a#').value,document.getElementById('awerqty#a#').value,'awer#a#');calcustallow();}" onBlur="if(this.readOnly == false){document.getElementById('awerqty#a#').value=this.value;calcvaraw(document.getElementById('aweerate#a#').value,this.value,'awee#a#');calselfallow();calcvaraw(document.getElementById('awerrate#a#').value,document.getElementById('awerqty#a#').value,'awer#a#');calcustallow();}" onclick="if(document.getElementById('allowancedesp#a#').value == ''){alert('Please select an Allowance to edit this field')}" <cfif evaluate('allowancedesp#a#') eq ''>readOnly</cfif>>
                    </td>
                <cfelse>
                    <td>
                     <input type="number" name="aweerate#a#" id="aweerate#a#" style="width: 100px" value="<cfif evaluate('aweerate#a#') neq 0>#numberformat(evaluate('aweerate#a#'),'.__')#<cfelse><cfif evaluate('awee#a#') neq 0>#numberformat(evaluate('awee#a#'),'.__')#<cfelse>0</cfif></cfif>" onKeyUp="if(this.readOnly == false){document.getElementById('awerrate#a#').value=this.value;calcvaraw(this.value,document.getElementById('aweeqty#a#').value,'awee#a#');calselfallow();calcvaraw(document.getElementById('awerrate#a#').value,document.getElementById('awerqty#a#').value,'awer#a#');calcustallow();}" onBlur="if(this.readOnly == false){document.getElementById('awerrate#a#').value=this.value;calcvaraw(this.value,document.getElementById('aweeqty#a#').value,'awee#a#');calselfallow();calcvaraw(document.getElementById('awerrate#a#').value,document.getElementById('awerqty#a#').value,'awer#a#');calcustallow();}" onclick="if(document.getElementById('allowancedesp#a#').value == ''){alert('Please select an Allowance to edit this field')}" <cfif evaluate('allowancedesp#a#') eq ''>readOnly</cfif>>
                    </td>
                    <td>
                     <input type="number" name="aweeqty#a#" id="aweeqty#a#" style="width: 100px" value="<cfif evaluate('aweeqty#a#') neq 0>#numberformat(evaluate('aweeqty#a#'),'.__')#<cfelse><cfif evaluate('awee#a#') neq 0 and url.type neq 'create'>1<cfelse>0</cfif></cfif>" onKeyUp="if(this.readOnly == false){document.getElementById('awerqty#a#').value=this.value;calcvaraw(document.getElementById('aweerate#a#').value,this.value,'awee#a#');calselfallow();calcvaraw(document.getElementById('awerrate#a#').value,document.getElementById('awerqty#a#').value,'awer#a#');calcustallow();}" onBlur="if(this.readOnly == false){document.getElementById('awerqty#a#').value=this.value;calcvaraw(document.getElementById('aweerate#a#').value,this.value,'awee#a#');calselfallow();calcvaraw(document.getElementById('awerrate#a#').value,document.getElementById('awerqty#a#').value,'awer#a#');calcustallow();}" onclick="if(document.getElementById('allowancedesp#a#').value == ''){alert('Please select an Allowance to edit this field')}" <cfif evaluate('allowancedesp#a#') eq ''>readOnly</cfif>>
                    </td>
            ...
            <cfif evaluate('aw#a#') neq "">
                ...
                <cfif isdefined('aweeexp#awid#')>
                     <td style="background-color:#bgcolor#">
                     <input type="number" name="awerrate#a#" id="awerrate#a#" style="width: 100px" value="<cfif val(evaluate('awerrate#a#')) neq 0>#numberformat(evaluate('awerrate#a#'),'.__')#<cfelse><cfif val(evaluate('awerexp#awid#')) neq 0>#numberformat(evaluate('awerexp#awid#'),'.__')#<cfelse>#numberformat(evaluate('awee#a#'),'.__')#</cfif></cfif>" onkeyup="calcvaraw(this.value,document.getElementById('awerqty#a#').value,'awer#a#');calcustallow();" onBlur="calcvaraw(this.value,document.getElementById('awerqty#a#').value,'awer#a#');calcustallow();" onclick="if(document.getElementById('allowancedesp#a#').value == ''){alert('Please select an Allowance to edit this field')}" <cfif evaluate('allowancedesp#a#') eq ''>readOnly</cfif>>
                    </td>
                    <td style="background-color:#bgcolor#">
                     <input type="number" name="awerqty#a#" id="awerqty#a#" style="width: 100px" value="<cfif evaluate('awerqty#a#') neq 0>#numberformat(evaluate('awerqty#a#'),'.__')#<cfelse><cfif evaluate('awer#a#') neq 0 and url.type neq 'create'>1<cfelse>0</cfif></cfif>" onkeyup="calcvaraw(document.getElementById('awerrate#a#').value,this.value,'awer#a#');calcustallow();" onBlur="calcvaraw(document.getElementById('awerrate#a#').value,this.value,'awer#a#');calcustallow();" onclick="if(document.getElementById('allowancedesp#a#').value == ''){alert('Please select an Allowance to edit this field')}" <cfif evaluate('allowancedesp#a#') eq ''>readOnly</cfif>>
                    </td>
                <cfelse>
                     <td style="background-color:#bgcolor#">
                     <input type="number" name="awerrate#a#" id="awerrate#a#" style="width: 100px" value="<cfif evaluate('awerrate#a#') neq 0>#numberformat(evaluate('awerrate#a#'),'.__')#<cfelse><cfif evaluate('awer#a#') neq 0>#numberformat(evaluate('awer#a#'),'.__')#<cfelse>0</cfif></cfif>" onkeyup="calcvaraw(this.value,document.getElementById('awerqty#a#').value,'awer#a#');calcustallow();" onBlur="calcvaraw(this.value,document.getElementById('awerqty#a#').value,'awer#a#');calcustallow();" onclick="if(document.getElementById('allowancedesp#a#').value == ''){alert('Please select an Allowance to edit this field')}" <cfif evaluate('allowancedesp#a#') eq ''>readOnly</cfif>>
                    </td>
                     <td style="background-color:#bgcolor#">
                     <input type="number" name="awerqty#a#" id="awerqty#a#" style="width: 100px" value="<cfif evaluate('awerqty#a#') neq 0>#numberformat(evaluate('awerqty#a#'),'.__')#<cfelse><cfif evaluate('awer#a#') neq 0 and url.type neq 'create'>1<cfelse>0</cfif></cfif>" onkeyup="calcvaraw(document.getElementById('awerrate#a#').value,this.value,'awer#a#');calcustallow();" onBlur="calcvaraw(document.getElementById('awerrate#a#').value,this.value,'awer#a#');calcustallow();" onclick="if(document.getElementById('allowancedesp#a#').value == ''){alert('Please select an Allowance to edit this field')}" <cfif evaluate('allowancedesp#a#') eq ''>readOnly</cfif>>
                    </td>
      ...
      <td><input type="text" size='10' name="selfcpf" id="selfcpf" value="#numberformat(selfcpf,'_.__')#" onKeyUp="calselftotal();" readOnly></td>
      ...
      <td><input type="Text" size='10' name="selfsdf" id="selfsdf" value="#numberformat(selfsdf,'_.__')#" onKeyUp="calselftotal();" readOnly></td>
    ...
    <tr>
      ...
      <td><input type="Text" size='10' name="selfeis" id="selfeis" value="#numberformat(selfeis,'_.__')#" onKeyUp="calselftotal();" readOnly></td>
