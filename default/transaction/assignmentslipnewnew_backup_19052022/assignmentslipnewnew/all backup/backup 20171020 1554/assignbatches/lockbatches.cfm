...
SELECT empno,paydate,invoiceno,refno FROM assignmentslip WHERE batches = <cfqueryparam cfsqltype="cf_sql_varchar" value="#form.hidbatch#">
</cfquery>
...
WHERE refno = <cfqueryparam cfsqltype="cf_sql_varchar" value="#getemployee.invoiceno#">
</cfquery>
<cfquery name="lockassign" datasource="#dts#">
UPDATE assignmentslip SET posted = 'P' 
WHERE refno = <cfqueryparam cfsqltype="cf_sql_varchar" value="#getemployee.refno#">
</cfquery>
</cfloop>
