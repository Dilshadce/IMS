...
<cfif isdefined('url.newworkd')  and dts eq 'manpowertest_i'>
    <cfif url.newworkd eq 'y'>
        ...
        <cfset selfsalarydayrecord = businessDaysBetween(createDate(year(datestartof),month(datestartof),1),createDate(year(dateendof),month(dateendof),day(dateendof)))>
...
<!---             <cfif awnowdesp neq "">
    ...
    <tr>
      ...
      <td><input type="Text" size='10' name="selfeis" id="selfeis" value="#numberformat(selfeis,'_.__')#" onKeyUp="calselftotal();"></td>
