...
<!---             <cfif awnowdesp neq "">
            ...
            <cfif evaluate('aw#a#') neq "">
                ...
                <cfif isdefined('aweeexp#awid#')>
                    ...
                    <td>
                     <input type="number" name="aweerate#a#" id="aweerate#a#" style="width: 100px" value="<cfif evaluate('aweeexp#awid#') neq 0>#numberformat(evaluate('aweeexp#awid#'),'.__')#<cfelse>#numberformat(evaluate('awee#a#'),'.__')#</cfif>" onKeyUp="document.getElementById('awerrate#a#').value=this.value;calcvaraw(this.value,document.getElementById('aweeqty#a#').value,'awee#a#');calselfallow();calcvaraw(document.getElementById('awerrate#a#').value,document.getElementById('awerqty#a#').value,'awer#a#');calcustallow();" onBlur="document.getElementById('awerrate#a#').value=this.value;calcvaraw(this.value,document.getElementById('aweeqty#a#').value,'awee#a#');calselfallow();calcvaraw(document.getElementById('awerrate#a#').value,document.getElementById('awerqty#a#').value,'awer#a#');calcustallow();" onclick="if(document.getElementById('allowancedesp#a#').value == ''){alert('Please select an Allowance to edit this field')}" <cfif evaluate('allowancedesp#a#') eq ''>readonly</cfif>>
                    </td>
                    <td>
            ...
            <cfif evaluate('aw#a#') neq "">
                ...
                <cfif isdefined('aweeexp#awid#')>
                     <td style="background-color:#bgcolor#">
                     <input type="number" name="awerrate#a#" id="awerrate#a#" style="width: 100px" value="<cfif evaluate('awerexp#awid#') neq 0>#numberformat(evaluate('awerexp#awid#'),'.__')#<cfelse>#numberformat(evaluate('awee#a#'),'.__')#</cfif>" onkeyup="calcvaraw(this.value,document.getElementById('awerqty#a#').value,'awer#a#');calcustallow();" onBlur="calcvaraw(this.value,document.getElementById('awerqty#a#').value,'awer#a#');calcustallow();" onclick="if(document.getElementById('allowancedesp#a#').value == ''){alert('Please select an Allowance to edit this field')}" <cfif evaluate('allowancedesp#a#') eq ''>readonly</cfif>>
                    </td>
                    <td style="background-color:#bgcolor#">
