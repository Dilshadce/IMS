...
AW104 = coalesce(AW104,0) + #val(getgrosspay.aw104)#,
AW105 = coalesce(AW105,0) + #val(getgrosspay.aw105)#,
AW106 = coalesce(AW106,0) + #val(getgrosspay.aw106)#,
AW107 = coalesce(AW107,0) + #val(getgrosspay.aw107)#,
AW108 = coalesce(AW108,0) + #val(getgrosspay.aw108)#,
AW109 = coalesce(AW109,0) + #val(getgrosspay.aw109)#,
AW110 = coalesce(AW110,0) + #val(getgrosspay.aw110)#,
