...
<!---proration rate for 2 month if timesheet cycle is not 01-31, [20170219, Alvin]--->
    ...
    <cfelse> <!---cycle is 01-31--->
        ...
        <cfif #IsDefined('url.bdflag')# AND '#url.bdflag#' EQ 'Yes'>
            ...
            <cfset lvleedayhr2 = #getnpltaken.npltaken#>
            <cfset lvlerdayhr2 = #getnpltaken.npltaken#>
...
order by  id
	 ...
	 <cfelse>
      ...
      <td><input type="text" name="fixawdesp#i#" id="fixawdesp#i#" size="30" value="#evaluate('fixawdesp#i#')#"  readonly/></td>
        <td>
            <input type="number" name="fixaweerate#i#" id="fixaweerate#i#" value="<cfif val(evaluate('fixawee#i#')) neq 0>#numberformat(evaluate('fixawee#i#'),'.__')#<cfelse>0.00</cfif>" onkeyup="document.getElementById('fixawerrate#i#').value=this.value;calcvaraw(this.value,document.getElementById('fixaweeqty#i#').value,'fixawee#i#');calselfallow();calcvaraw(document.getElementById('fixawerrate#i#').value,document.getElementById('fixawerqty#i#').value,'fixawer#i#');calcustallow();" onBlur="document.getElementById('fixawerrate#i#').value=this.value;calcvaraw(this.value,document.getElementById('fixaweeqty#i#').value,'fixawee#i#');calselfallow();calcvaraw(document.getElementById('fixawerrate#i#').value,document.getElementById('fixawerqty#i#').value,'fixawer#i#');calcustallow();" style="width: 100px"  />
        </td>
        <td>
            <input type="number" name="fixaweeqty#i#" id="fixaweeqty#i#" value="<cfif evaluate('fixawee#i#') neq 0>1<cfelse>0</cfif>" onkeyup="document.getElementById('fixawerqty#i#').value=this.value;calcvaraw(document.getElementById('fixaweerate#i#').value,this.value,'fixawee#i#');calselfallow();calcvaraw(document.getElementById('fixawerrate#i#').value,document.getElementById('fixawerqty#i#').value,'fixawer#i#');calcustallow();" onBlur="document.getElementById('fixawerqty#i#').value=this.value;calcvaraw(document.getElementById('fixaweerate#i#').value,this.value,'fixawee#i#');calselfallow();calcvaraw(document.getElementById('fixawerrate#i#').value,document.getElementById('fixawerqty#i#').value,'fixawer#i#');calcustallow();" style="width: 100px"  />
        </td>
        <td style="background-color:#bgcolor#">
...
<cfset govlist = "15,16,42">
      ...
      <tr>
            <td>
            <cfset awnowdesp = "">
            <select style="width:200px" name="allowance#a#" id="allowance#a#" onChange="document.getElementById('allowancedesp#a#').value=this.options[this.selectedIndex].id;document.getElementById('allowancedesp#a#').readOnly = false;document.getElementById('aweerate#a#').readOnly = false;document.getElementById('awerrate#a#').readOnly = false;document.getElementById('aweeqty#a#').readOnly = false;document.getElementById('awerqty#a#').readOnly = false;document.getElementById('awee#a#').readOnly = false;document.getElementById('awer#a#').readOnly = false;">
...
<!---             <cfif awnowdesp neq "">
            ...
            <cfif evaluate('aw#a#') neq "">
                ...
                <cfif isdefined('aweeexp#awid#')>
                    ...
                    <td>
                     <input type="number" name="aweerate#a#" id="aweerate#a#" style="width: 100px" value="<cfif val(evaluate('aweerate#a#')) neq 0>#numberformat(evaluate('aweerate#a#'),'.__')#<cfelse><cfif val(evaluate('aweeexp#awid#')) neq 0>#numberformat(evaluate('aweeexp#awid#'),'.__')#<cfelse>#numberformat(evaluate('awee#a#'),'.__')#</cfif></cfif>" onKeyUp="document.getElementById('awerrate#a#').value=this.value;calcvaraw(this.value,document.getElementById('aweeqty#a#').value,'awee#a#');calselfallow();calcvaraw(document.getElementById('awerrate#a#').value,document.getElementById('awerqty#a#').value,'awer#a#');calcustallow();" onBlur="document.getElementById('awerrate#a#').value=this.value;calcvaraw(this.value,document.getElementById('aweeqty#a#').value,'awee#a#');calselfallow();calcvaraw(document.getElementById('awerrate#a#').value,document.getElementById('awerqty#a#').value,'awer#a#');calcustallow();" onclick="if(document.getElementById('allowancedesp#a#').value == ''){alert('Please select an Allowance to edit this field')}" <cfif evaluate('allowancedesp#a#') eq ''>readonly</cfif>>
                    </td>
                    <td>
                     <input type="number" name="aweeqty#a#" id="aweeqty#a#" style="width: 100px" value="<cfif evaluate('aweeqty#a#') neq 0>#numberformat(evaluate('aweeqty#a#'),'.__')#<cfelse><cfif evaluate('awee#a#') neq 0 and url.type neq 'create'>1<cfelse>0</cfif></cfif>" onKeyUp="document.getElementById('awerqty#a#').value=this.value;calcvaraw(document.getElementById('aweerate#a#').value,this.value,'awee#a#');calselfallow();calcvaraw(document.getElementById('awerrate#a#').value,document.getElementById('awerqty#a#').value,'awer#a#');calcustallow();" onBlur="document.getElementById('awerqty#a#').value=this.value;calcvaraw(document.getElementById('aweerate#a#').value,this.value,'awee#a#');calselfallow();calcvaraw(document.getElementById('awerrate#a#').value,document.getElementById('awerqty#a#').value,'awer#a#');calcustallow();" onclick="if(document.getElementById('allowancedesp#a#').value == ''){alert('Please select an Allowance to edit this field')}" <cfif evaluate('allowancedesp#a#') eq ''>readonly</cfif>>
                    </td>
                <cfelse>
                    <td>
                     <input type="number" name="aweerate#a#" id="aweerate#a#" style="width: 100px" value="<cfif evaluate('aweerate#a#') neq 0>#numberformat(evaluate('aweerate#a#'),'.__')#<cfelse><cfif evaluate('awee#a#') neq 0>#numberformat(evaluate('awee#a#'),'.__')#<cfelse>0</cfif></cfif>" onKeyUp="document.getElementById('awerrate#a#').value=this.value;calcvaraw(this.value,document.getElementById('aweeqty#a#').value,'awee#a#');calselfallow();calcvaraw(document.getElementById('awerrate#a#').value,document.getElementById('awerqty#a#').value,'awer#a#');calcustallow();" onBlur="document.getElementById('awerrate#a#').value=this.value;calcvaraw(this.value,document.getElementById('aweeqty#a#').value,'awee#a#');calselfallow();calcvaraw(document.getElementById('awerrate#a#').value,document.getElementById('awerqty#a#').value,'awer#a#');calcustallow();" onclick="if(document.getElementById('allowancedesp#a#').value == ''){alert('Please select an Allowance to edit this field')}" <cfif evaluate('allowancedesp#a#') eq ''>readonly</cfif>>
                    </td>
                    <td>
                     <input type="number" name="aweeqty#a#" id="aweeqty#a#" style="width: 100px" value="<cfif evaluate('aweeqty#a#') neq 0>#numberformat(evaluate('aweeqty#a#'),'.__')#<cfelse><cfif evaluate('awee#a#') neq 0 and url.type neq 'create'>1<cfelse>0</cfif></cfif>" onKeyUp="document.getElementById('awerqty#a#').value=this.value;calcvaraw(document.getElementById('aweerate#a#').value,this.value,'awee#a#');calselfallow();calcvaraw(document.getElementById('awerrate#a#').value,document.getElementById('awerqty#a#').value,'awer#a#');calcustallow();" onBlur="document.getElementById('awerqty#a#').value=this.value;calcvaraw(document.getElementById('aweerate#a#').value,this.value,'awee#a#');calselfallow();calcvaraw(document.getElementById('awerrate#a#').value,document.getElementById('awerqty#a#').value,'awer#a#');calcustallow();" onclick="if(document.getElementById('allowancedesp#a#').value == ''){alert('Please select an Allowance to edit this field')}" <cfif evaluate('allowancedesp#a#') eq ''>readonly</cfif>>
                    </td>
