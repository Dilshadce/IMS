<!---added for recalculation after assignmentslip deleted multiple assignments by Nieo--->
...
<cfset tded114 =0>
			...
			<cfif getcurrentassign.recordcount neq 0>
                <cfquery name="updatedw" datasource="#db#">
                    ...
                    EPFCC=#val(tEPFER)#, 
                    SOCSOWW=IF(#(val(tSOCSOWW))#>=24.75, 24.75,#(val(tSOCSOWW))#), 
                    SOCSOCC=IF(#(val(tSOCSOCC))#>=86.65, 86.65,#(val(tSOCSOCC))#) ,                 
