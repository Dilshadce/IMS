                ...
                <cfif epf_fyee neq '' and epf_fyee neq '0' and epf_yee neq 0>
                    <cfif findnocase('%',epf_fyee)>
                        ...
                        <cfif isdefined('volpercee')>
                            ...
                            <!---Updated by Nieo 20200601, on KWSP update 7% to voluntary percentage--->
                            <!---Updated by Nieo 20200601, on KWSP update 9% to voluntary percentage--->
                            <cfset epf_yee = replace(replace(epf_yee,'0.09','#volpercee#'),'0.11','#volpercee#')>
                            <!---Updated by Nieo 20200601, on KWSP update 9% to voluntary percentage--->
                        </cfif>
                    <cfelse>
...
<!--- </cfif> --->
			...
			<cfloop list="paytra1,paytran" index="a">
                ...
                <cfquery name="updatedwfinal" datasource="#db#">
                    ...
                    EPFCC=#val(tEPFER)#, 
                    SOCSOWW = IF(#val(tSOCSOEE)# >= 24.75, 24.75, #val(tSOCSOEE)# ),
                    SOCSOCC = IF(#val(tSOCSOER)# >= 86.65 or #val(tSOCSOEE)# >= 24.75 , 86.65, #val(tSOCSOER)# ),
                    EISWW = IF(#val(tEISEE)# >= 9.90, 9.90, #val(tEISEE)# ),
                    EISCC = IF(#val(tEISER)# >= 9.90, 9.90, #val(tEISER)# ),
