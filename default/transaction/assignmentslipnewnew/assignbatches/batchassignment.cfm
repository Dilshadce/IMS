...
<cfoutput>
	<h4>
        ...
        || <a href="/default/transaction/assignmentslipnewnew/assignbatches/listunprocessassignment.cfm">List Unprocess Assignement</a>
    ...
    <link rel="stylesheet" href="/default/transaction/assignmentslipnewnew/assignbatches/select2/select2.css" />
    <link rel="stylesheet" href="/latest/css/form.css" />
    <script type="text/javascript" src="/default/transaction/assignmentslipnewnew/assignbatches/jquery-1.10.2.min.js"></script>
    <script type="text/javascript" src="/latest/js/jqueryui/jquery-ui-1.10.3.custom.min.js"></script>
    <script type="text/javascript" src="/default/transaction/assignmentslipnewnew/assignbatches/select2/select2.min.js"></script>
...
ORDER BY userid
 ...
 <cfset dts2=lcase(replace(dts,"_i","","all"))>
...
<td><select name="paymeth" id="paymeth" >
      ...
      <option value="D">Duitnow Account</option>
      </select></td>
</tr>
 <tr>
 <th>User</th>
...
<tr>
 <th>Customer From</th>
 <td>:</td>
 <td><input type="text" name="comfrm" id="comfrm" class="customerFilter"></td>
</tr>
<tr>
 <th>Customer To</th>
 <td>:</td>
 <td><input type="text" name="comto" id="comto" class="customerFilter"></td>
</tr>
        <!---<cfquery name="getemployee" datasource="#dts#">
            SELECT empno,empname 
            FROM placement 
            WHERE empno <> ""
            AND year(completedate)>=(#getmonth.myear#-1)
            GROUP BY empno 
            ORDER BY empno
        </cfquery>--->
  <tr> 
        	<th>Employee From</th>
            <td>:</td>
            <td><input type="text" name="empfrom" id="empfrom" class="employeeFilter"></td>
            <!---<td>
		...
		<tr>
        	<th>Employee To</th>
            <td>:</td>
             <td><input type="text" name="empto" id="empto" class="employeeFilter"></td>
            <!---<td>
  ...
  <tr> 
            ...
            <td>:</td>
            <td><input type="text" name="placementfrom" id="placementfrom" value="">
            	<input type="button" size="10" value="Ajax Search" onClick="document.getElementById('fromto').value='placementfrom';ColdFusion.Window.show('findplacementnonew');" />
            </td>
		</tr>
		...
		<tr>
        	<th>Placement To</th>
            <td>:</td>
            <td><input type="text" name="placementto" id="placementto" value="">
