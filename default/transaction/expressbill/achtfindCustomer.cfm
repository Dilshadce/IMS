...
<cfset nametype = "Cust">
    ...
    <font style="text-transform:uppercase">#nametype# NO.</font>&nbsp;<input type="text" name="custno1" size="8" id="custno1" onfocus="clearTimeout(t1);clearTimeout(t11);" <!--- onblur="document.getElementById('loading').style.visibility='visible';ajaxFunction1(document.getElementById('ajaxField'),'achtfindCustomerAjax.cfm?type=#url.type#&dbtype=#url.dbtype#&custno='+document.getElementById('custno1').value+'&custname='+document.getElementById('custname1').value+'&leftcustname='+document.getElementById('custname2').value);" ---> onkeyup="if(event.keyCode==9 || event.keyCode==13){document.getElementById('loading').style.visibility='visible';ajaxFunction1(document.getElementById('ajaxField'),'achtfindCustomerAjax.cfm?type=#url.type#&dbtype=#url.dbtype#&custno='+document.getElementById('custno1').value+'&custname='+document.getElementById('custname1').value+'&leftcustname='+document.getElementById('custname2').value);if(event.keyCode==13){document.getElementById('custname2').focus();}} else if (event.keyCode==40){document.getElementById('b1').focus()} " <cfif isdefined('url.custno')>value="#url.custno#"</cfif>  />
    &nbsp;LEFT NAME:&nbsp;
