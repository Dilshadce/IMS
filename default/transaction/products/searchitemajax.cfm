...
select * from displaysetup
    ...
    Select Servi as itemno, desp,0 as ucost,0 as price,'' as aitemno,"" as fcurrcode,0 as fprice,0 as fucost<cfloop from="2" to="10" index="i">,"" as fcurrcode#i#,0 as fprice#i#,0 as fucost#i#</cfloop> from icservi WHERE
    1=1 
    ...
    union all
    select itemno,desp,ucost,price,aitemno,fcurrcode,fprice,fucost<cfloop from="2" to="10" index="i">,fcurrcode#i#,fprice#i#,fucost#i#</cfloop> from icitem WHERE 
    1=1
    <cfif URLDECODE(url.itemno) neq "">
