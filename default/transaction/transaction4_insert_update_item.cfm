...
<cfif isdefined("form.multilocation") and form.multilocation eq "Y" and listfirst(service) eq "">
	...
	<form name='form1' method='post' action='transactionprocess2.cfm?nDateCreate=#nDateCreate#'>
        ...
        <input type='hidden' name='dono' id="dono" value='#convertquote(dono)#'>
        ...
        <cfif tran eq 'QUO'>
        <input type='hidden' name='itemno' id="itm1" value='#convertquote(listfirst(form.itemno))#'>
        <cfelse>
        ...
        <cfif isdefined("form.totalupdisplay")>
  			<input type='hidden' id="totalupdisplay" name='totalupdisplay' value='Y'>
		<cfelse>
			<input type='hidden' id="totalupdisplay" name='totalupdisplay' value='N'>
		</cfif>
        <cfif isdefined("form.deductableitem")>
  			<input type='hidden' id="deductableitem" name='deductableitem' value='Y'>
		<cfelse>
			<input type='hidden' id="deductableitem" name='deductableitem' value='N'>
		</cfif>
        	<input type='hidden' name='note1' id="note1" value='#convertquote(listfirst(note1))#'>
        ...
        <cfif isdefined('form.selectPPH') AND isdefined('form.pph_amt_bil')>
            <input type="hidden" name="selectPPH" value="#trim(selectPPH)#" />
            <input type="hidden" name="pph_amt_bil" value="#val(pph_amt_bil)#" />
        </cfif>
...
<cfelse>
	...
	<form name='form1' method='post' action='transactionprocess.cfm?nDateCreate=#nDateCreate#' <cfif mode neq 'delete'>onsubmit='return validate()'</cfif>>
        ...
        <input type="hidden" id="invlinklist" name="invlinklist" value="#form.invlinklist#">
		</cfif>
		<cfif isdefined('form.invcnitem')> 
        <input type="hidden" id="invcnitem" name="invcnitem" value="#form.invcnitem#">
		</cfif>
        
        <cfif isdefined('form.sono')>
        <input type="hidden" id="sono" name="sono" value="#form.sono#">
		</cfif>
		<cfif isdefined('form.soitem')> 
        <input type="hidden" id="soitem" name="soitem" value="#form.soitem#">
		</cfif>
		...
		<cfoutput>
        #form.comment#
        <textarea name="a" cols="80">#replace(form.comment,chr(10),'-','all')#</textarea>
        </cfoutput>
        <cfabort>
        </cfif>--->
