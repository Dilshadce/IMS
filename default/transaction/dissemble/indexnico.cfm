...
<cfoutput> 
	<table width="80%" border="0" cellspacing="0" cellpadding="0" align="center" class="data">
        ...
        <tr>
            <th>#words[1097]#</th>
            <td><cfinput type="text" name="amount" id="amount" size="10" value="0.00" readonly  onKeyUp="nextIndex(event,'amount','btn_add');" >&nbsp;&nbsp;&nbsp;&nbsp;<cfinput name="issbtn_add" id="issbtn_add" type="button" value="#words[1116]#" onClick="addnewitem();"></td>
            <td>&nbsp;</td>
            <th>#words[1097]#</th>
            <td><cfinput type="text" name="amount2" id="amount2" size="10" value="0.00" readonly  onKeyUp="nextIndex(event,'amount2','btn_add2');" >&nbsp;&nbsp;&nbsp;&nbsp;<cfinput name="rcbtn_add"  id="rcbtn_add" type="button" value="#words[1116]#" onClick="addnewitem2();"></td>
        </tr>
        <tr>
            <td colspan="2">
