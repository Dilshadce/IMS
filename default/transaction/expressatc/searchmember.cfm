...
<script type='text/javascript' src='/ajax/core/engine.js'></script>
	...
	function createjob(custno){
	<cfoutput>
	document.customerform.action = '/default/transaction/expressatc/index.cfm?first=true&type=SO&custno='+custno;
 	document.customerform.submit();
	</cfoutput>
}

function createjob2(custno){
	<cfoutput>
	document.customerform.action = '/default/transaction/expressatc/index2.cfm?first=true&type=SO&custno='+custno;
 	document.customerform.submit();
	</cfoutput>
