...
<cfif isdefined('form.mc1_bil')>
<cfset mc1_bil = form.mc1_bil>
<cfset m_charge1 = mc1_bil * val(currrate)>
</cfif>
...
<cfqueryparam cfsqltype="cf_sql_varchar" value="#form.b_add5#">,
<cfqueryparam cfsqltype="cf_sql_varchar" value="#form.d_add5#">,
<cfqueryparam cfsqltype="cf_sql_varchar" value="#form.b_postalcode#">,
...
<cfqueryparam cfsqltype="cf_sql_varchar" value="#form.cardno#">,
<cfqueryparam cfsqltype="cf_sql_varchar" value="#form.expirydate#">,
<cfqueryparam cfsqltype="cf_sql_varchar" value="#form.d_phone2#">,
<cfqueryparam cfsqltype="cf_sql_varchar" value="#form.permitno#">,
<cfqueryparam cfsqltype="cf_sql_varchar" value="#form.cardissue#">,
<cfqueryparam cfsqltype="cf_sql_varchar" value="#form.rem30#">,
<cfqueryparam cfsqltype="cf_sql_varchar" value="#phonea#">,
<cfqueryparam cfsqltype="cf_sql_varchar" value="#form.rem31#">,
<cfqueryparam cfsqltype="cf_sql_varchar" value="#form.rem32#">,
<cfqueryparam cfsqltype="cf_sql_varchar" value="#form.rem33#">
<cfif isdefined('form.mc1_bil')>
,'#val(mc1_bil)#'
,'#val(m_charge1)#'</cfif>
)
...
<cflocation url="/default/transaction/expressatcdone.cfm?type=#type#&refno=#refno#" addtoken="no">
