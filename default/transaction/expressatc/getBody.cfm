...
<input type="text" size="3" name="colorlistalt#getictrantemp.trancode#" value="#getictrantemp.brem1#" id="colorlistalt#getictrantemp.trancode#" onBlur="selectlist(this.value,'colorlist#getictrantemp.trancode#');updaterow('#getictrantemp.trancode#','colorlist');" onKeyUp="nextIndex(event,'colorlist#getictrantemp.trancode#','sizelist#getictrantemp.trancode#');">
</cfif>
<select name="colorlist#getictrantemp.trancode#" id="colorlist#getictrantemp.trancode#" onBlur="updaterow('#getictrantemp.trancode#','colorlist');" onKeyUp="nextIndex(event,'colorlist#getictrantemp.trancode#','sizelist#getictrantemp.trancode#');">
...
<cfif husergrpid eq 'super'>
<input type="text" size="3" name="sizelistalt#getictrantemp.trancode#" value="#getictrantemp.brem2#" id="sizelistalt#getictrantemp.trancode#" onBlur="selectlist(this.value,'sizelist#getictrantemp.trancode#');updaterow('#getictrantemp.trancode#','sizelist');" onKeyUp="nextIndex(event,'sizelist#getictrantemp.trancode#','ratinglist#getictrantemp.trancode#');">
</cfif>

<select name="sizelist#getictrantemp.trancode#" id="sizelist#getictrantemp.trancode#" onBlur="updaterow('#getictrantemp.trancode#','sizelist');" onKeyUp="nextIndex(event,'sizelist#getictrantemp.trancode#','ratinglist#getictrantemp.trancode#');">
...
<td nowrap>
<cfif husergrpid eq 'super'>
<input type="text" size="3" name="ratinglistalt#getictrantemp.trancode#" value="#getictrantemp.brem3#" id="ratinglistalt#getictrantemp.trancode#" onBlur="selectlist(this.value,'ratinglist#getictrantemp.trancode#');updaterow('#getictrantemp.trancode#','ratinglist');" onKeyUp="nextIndex(event,'ratinglist#getictrantemp.trancode#','qtylist#getictrantemp.trancode#');">
</cfif>

<select name="ratinglist#getictrantemp.trancode#" id="ratinglist#getictrantemp.trancode#" onBlur="updaterow('#getictrantemp.trancode#','ratinglist');" onKeyUp="nextIndex(event,'ratinglist#getictrantemp.trancode#','qtylist#getictrantemp.trancode#');">
...
<cfset getpacking.packingqty5=1>
            ...
            <cfif getdisplay.simple_freeqty eq 'Y'><td nowrap align="right">
            #itemfreeqty#
            </td></cfif>
...
<cfif getdisplay.simple_price eq 'Y'><td nowrap align="right"><a style="cursor:pointer" onClick="document.getElementById('hidtrancode').value='#getictrantemp.trancode#';ColdFusion.Window.show('changeprice');getfocus4();">#numberformat(val(getictrantemp.price_bil),',.__')#</a></td></cfif>
...
<input type="hidden" name="lastitemtrancode" id="lastitemtrancode" value="#getictrantemp.recordcount#" />
