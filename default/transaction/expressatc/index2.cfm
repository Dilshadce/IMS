...
<!--- 		if(nextflow != "")
	...
	{
		if(e.keyCode==40){
		document.getElementById('rem11').focus();
		document.getElementById('rem11').select();
		}
		if(e.keyCode==39){
		document.getElementById('coltype').focus();
		}
		if(e.keyCode==38){
		document.getElementById('rem32').focus();
		}
		if(e.keyCode==13){
	...
	{
		if(document.getElementById('rem5').value.length == 2 ||document.getElementById('rem5').value.length == 5){
			document.getElementById('rem5').value=document.getElementById('rem5').value+'/'
		}
		if(e.keyCode==40){
		document.getElementById('rem7').focus();
		document.getElementById('rem7').select();
		}
        if(e.keyCode==39){
		document.getElementById('rem6').focus();
		document.getElementById('rem6').select();
		}
		if(e.keyCode==13){
		document.getElementById('rem6').focus();
		document.getElementById('rem6').select();
	...
	else if (thisid == 'rem6')
	{
        ...
        if(e.keyCode==39){
		document.getElementById('driveralt').focus();
		document.getElementById('driveralt').select();
		}
        if(e.keyCode==37){
		document.getElementById('rem5').focus();
		document.getElementById('rem5').select();
		}
		if(e.keyCode==13){
		document.getElementById('rem7').focus();
		document.getElementById('rem7').select();
	...
	else if (thisid == 'driveralt')
	{
		if(e.keyCode==40){
		document.getElementById('agentalt').focus();
		document.getElementById('agentalt').select();
		}
        if(e.keyCode==39){
		document.getElementById('rem7').focus();
		document.getElementById('rem7').select();
	...
	{
		if(e.keyCode==40){
		document.getElementById('permitnoalt').focus();
		document.getElementById('permitnoalt').select();
		}
        if(e.keyCode==39){
		document.getElementById('rem8').focus();
		document.getElementById('rem8').select();
		}
        if(e.keyCode==37){
		document.getElementById('driveralt').focus();
		document.getElementById('driveralt').select();
	...
	else if (thisid == 'agentalt')
	{
		if(e.keyCode==40){
		document.getElementById('termalt').focus();
		document.getElementById('termalt').select();
		}
        if(e.keyCode==39){
		document.getElementById('permitnoalt').focus();
		document.getElementById('permitnoalt').select();
	...
	else if (thisid == 'permitnoalt')
	{
		if(e.keyCode==40){
		document.getElementById('rem30').focus();
		document.getElementById('rem30').select();
		}
        if(e.keyCode==39){
		document.getElementById('termalt').focus();
		document.getElementById('termalt').select();
	...
	else if (thisid == 'termalt')
	{
		if(e.keyCode==40){
		document.getElementById('jobalt').focus();
		document.getElementById('jobalt').select();
		}
        if(e.keyCode==39){
		document.getElementById('rem30').focus();
		document.getElementById('rem30').select();
	...
	else if (thisid == 'rem30')
	{
		if(e.keyCode==40){
		document.getElementById('rem9').focus();
		document.getElementById('rem9').select();
		}
        if(e.keyCode==39){
		document.getElementById('jobalt').focus();
		document.getElementById('jobalt').select();
	...
	else if (thisid == 'jobalt')
	{
		if(e.keyCode==40){
		document.getElementById('projectalt').focus();
		document.getElementById('projectalt').select();
		}
        if(e.keyCode==39){
		document.getElementById('rem10').focus();
		document.getElementById('rem10').select();
		}
        if(e.keyCode==37){
		document.getElementById('rem9').focus();
		document.getElementById('rem9').select();
	...
	else if (thisid == 'projectalt')
	{
		if(e.keyCode==40){
		document.getElementById('rem31alt').focus();
		document.getElementById('rem31alt').select();
		}
        if(e.keyCode==39){
		document.getElementById('rem10').focus();
		document.getElementById('rem10').select();
	...
	else if (thisid == 'rem10')
	{
		if(e.keyCode==40){
		document.getElementById('rem32').focus();
		document.getElementById('rem32').select();
		}
        if(e.keyCode==39){
		document.getElementById('rem31alt').focus();
		document.getElementById('rem31alt').select();
	...
	else if (thisid == 'rem31alt')
	{
		if(e.keyCode==40){
		document.getElementById('rem33alt').focus();
		document.getElementById('rem33alt').select();
		}
        if(e.keyCode==39){
		document.getElementById('rem32').focus();
		document.getElementById('rem32').select();
	...
	else if (thisid == 'rem32')
	{
		if(e.keyCode==40){
		document.getElementById('expressservicelist').focus();
		document.getElementById('expressservicelist').select();
		}
        if(e.keyCode==39){
		document.getElementById('rem33alt').focus();
		document.getElementById('rem33alt').select();
	...
	else if (thisid == 'rem11')
	{
		if(e.keyCode==40){
		document.getElementById('dispec1').focus();
		document.getElementById('dispec1').select();
		}
        if(e.keyCode==39){
		document.getElementById('dispec1').focus();
		document.getElementById('dispec1').select();
	...
	else if (thisid == 'dispec1')
	{
		if(e.keyCode==40){
		document.getElementById('grand').focus();
		document.getElementById('grand').select();
		}
        if(e.keyCode==39){
		document.getElementById('grand').focus();
		document.getElementById('grand').select();
...
<cfoutput>
	...
	new Ajax.Request('getBody.cfm?uuid='+document.getElementById('uuid').value,
      {
		...
		onComplete: function(transport){
		 if(field =='colorlist'){
		 document.getElementById('sizelistalt'+document.getElementById('lastitemtrancode').value).focus();
		 }
		 else if(field =='sizelist'){
		 document.getElementById('ratinglistalt'+document.getElementById('lastitemtrancode').value).focus();
		 }
	...
	grand.value = ((net.value*1)+(document.getElementById('mc1_bil').value * 1)).toFixed(2);
	...
	<cfoutput>
	<cfif getgsetup.dfpos eq "0.05">
	grand.value = ((((netb*2).toFixed(1))/2)+(document.getElementById('mc1_bil').value * 1)).toFixed(2);
	<cfelse>
	grand.value = (netb+(document.getElementById('mc1_bil').value * 1)).toFixed(2);
	</cfif>
	</cfoutput>
	}
	...
	function selectlist(varval,varattb){		
		...
		{
			if (varval.toUpperCase()==document.getElementById(varattb).options[idx].value.toUpperCase()) 
			{
...
<td style="display:none"><cfinput type="text" name="currcode" id="currcode" size="10"  /><input type="hidden" name="currcodehid" id="currcodehid" value="">&nbsp;<cfinput type="text" name="currrate" id="currrate" bind="cfc:custsupp.getcurrrate('#dts#',{currcode},'#target_currency#')" bindonload="yes" size="5" /><div id="onholdajax"></div>
...
#getgsetup.rem5#</th>
<td><cfinput type="text" name="rem5" id="rem5" value="#dateformat(now(),'dd/mm/yyyy')#" mask="99/99/9999" maxlength="10" size="12" onKeyUp="nextIndex(event,'rem5','rem6');"  onBlur="validatedate('rem5')" >&nbsp;&nbsp;<!---<input type="button" name="generatedatetime" id="generatedatetime" onClick="document.getElementById('rem5').value='#dateformat(now(),'DD/MM/YYYY')#'" value="Set Date" />---></td>
<th>#getgsetup.rem6#</th><td><input type="text" name="rem6" id="rem6" value="" maxlength="80" size="30" onKeyUp="nextIndex(event,'rem6','driveralt');" /></td>
<th>#getgsetup.ldriver#</th>
<td>
<input type="text" size="3" name="driveralt" id="driveralt" onBlur="selectlist(this.value,'driver')"  onKeyUp="nextIndex(event,'driveralt','rem7');">
...
<td colspan="3">(B)<input type="text" name="rem7" id="rem7" value="" maxlength="2" size="5" onKeyUp="nextIndex(event,'rem7','rem8');" /> (S) <input type="text" name="rem8" id="rem8" value="" maxlength="2" size="5" onKeyUp="nextIndex(event,'rem8','agentalt');" /></td>

<th>#getgsetup.lagent#</th>
<td>
<input type="text" size="3" name="agentalt" id="agentalt" onBlur="selectlist(this.value,'agent')" onKeyUp="nextIndex(event,'agentalt','permitnoalt');">
...
<th>Tag</th>
<td colspan="3">
<input type="text" size="3" name="permitnoalt" id="permitnoalt" onKeyUp="nextIndex(event,'permitnoalt','termalt');" onBlur="selectlist(this.value,'permitno')">
...
<th>Term</th>
<td>
<input type="text" size="3" name="termalt" id="termalt" onBlur="selectlist(this.value,'term')" onKeyUp="nextIndex(event,'termalt','rem30');">
<cfselect name="term" id="term" bind="cfc:custsupp.getterms('#dts#','#target_icterm#')" bindonload="yes" display="termdesp" value="term" onKeyUp="nextIndex(event,'term','rem11');" /><input type="hidden" name="termhid" id="termhid" value=""></td>
</tr>
<tr>
...
<td colspan="3">
<input type="text" name="rem30" id="rem30" value="" maxlength="200" size="80" onKeyUp="nextIndex(event,'rem30','termalt');"/></td>
<th>#getgsetup.ljob#</th>
<td>
<input type="text" size="3" name="jobalt" id="jobalt" onBlur="selectlist(this.value,'job')" onKeyUp="nextIndex(event,'jobalt','rem9');">
...
<td colspan="3"><input type="text" name="rem9" id="rem9" value="" maxlength="80" size="80" onKeyUp="nextIndex(event,'rem9','projectalt');" /></td>
<th>#getgsetup.lproject#</th>
<td>
<input type="text" size="3" name="projectalt" id="projectalt" onBlur="selectlist(this.value,'project')" onKeyUp="nextIndex(event,'projectalt','rem10');">
...
<tr>
<th>#getgsetup.rem10#</th><td colspan="3"><input type="text" name="rem10" id="rem10" value="" maxlength="200" size="80" onKeyUp="nextIndex(event,'rem10','rem31alt');" /></td>
<th>Show</th>
<td>
<input type="text" size="3" name="rem31alt" id="rem31alt" onBlur="selectlist(this.value,'rem31')" onKeyUp="nextIndex(event,'rem31alt','rem10');">
...
<tr>
<th>Driver Remark</th><td colspan="3"><input type="text" name="rem32" id="rem32" value="" size="80" maxlength="80" onKeyUp="nextIndex(event,'rem32','rem33alt');"></td>
<th>Area</th>
<td>
<input type="text" size="3" name="rem33alt" id="rem33alt" onBlur="selectlist(this.value,'rem33')" onKeyUp="nextIndex(event,'rem33alt','');">
...
<div id="itemlist" style="height:100px; overflow:scroll;">
<table width="100%">
<tr>
<th width="2%">No</th>
...
<tr>
<th colspan="2" rowspan="2">#getgsetup.rem11#</th>
<td colspan="2"rowspan="2"><textarea name="rem11" id="rem11" cols="60" rows="3" onKeyUp="nextIndex(event,'rem11','rem10');"></textarea></td>
<th>Total Qty</th>
...
<tr>
<th>Misc Charges</th>
<td><cfinput type="#inputtype#" name="mc1_bil" id="mc1_bil" value="0.00" onKeyUp="calcdisc();caltax();calcfoot();" /></td>
</tr>
...
<td colspan="2">
 <cfinput type="#inputtype#" size="3" name="dispec1" id="dispec1" value="0" validate="float" validateat="onblur" message="Please key in numeric value" onKeyUp="calcdisc();caltax();calcfoot();nextIndex(event,'dispec1','grand');" />%<input type="hidden" name="disbil1" id="disbil1" />&nbsp;&nbsp;
...
<td><cfinput type="text" style="font: x-large bolder; color:##000; background-color:##FFFF66" name="grand" id="grand" value="0.00" readonly="yes" onKeyUp="nextIndex(event,'grand','grand');" /></td>
</tr>
...
<input name="pay_btn" style="font: medium bolder;background-color:##FC9;" id="btn_add" type="button" value="COD" size="15" onClick="document.getElementById('paytype').value='8';gopay('totalup8');">&nbsp;&nbsp;&nbsp;
<input name="pay_btn" style="font: medium bolder;background-color:##F9C;" id="btn_add" type="button" value="CUC" size="15" onClick="document.getElementById('paytype').value='8';gopay('totalup9');">&nbsp;&nbsp;&nbsp;
<!---<br>
...
--->
<input name="pay_btn" style="font: medium bolder;background-color:##F6C" id="btn_add" type="button" value="MULTI PAYMENT" onClick="document.getElementById('paytype').value='5';gopay('totalup5');" size="15" />&nbsp;&nbsp;&nbsp;
<br><br>
...
<input name="pay_btn" style="font: medium bolder;background-color:##933; color:##FFFFFF" id="btn_add" type="button" value="Accept" size="15" onClick="document.getElementById('paytype').value='6';gopay('totalup6');">
</div></td>
</tr>
