...
document.getElementById('adminfee').value = document.getElementById('totaladminfee').value;
            var totalhrdf = document.getElementById('totalhrdf').value;
            for(var i=1;i<=6;i++)
            {
                // only for hrdf
                if (document.getElementById('billitem'+i).value == '136' && !totalhrdf) {
                    document.getElementById('billitemamt'+i).value = totalhrdf;
                    break;
                } 
            }
dedcalcust();
