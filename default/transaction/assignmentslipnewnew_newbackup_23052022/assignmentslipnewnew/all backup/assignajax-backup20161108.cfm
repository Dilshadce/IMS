...
<cfelse>
<cfset lvltype1 = "NPL">
<cfset lvldesp1 = "No Pay Leave">
<cfset lvleedayhr1 = 0>
<cfset lvlerdayhr1 = 0>
<cfif val(noofdays) neq 0>
<cfset lvleerate1 = numberformat(employeepay/val(noofdays),'.____')*-1>
<cfset lvlerrate1 = numberformat(employerpay/val(noofdays),'.____')*-1>
<cfelse>
<cfset lvleerate1 = 0>
<cfset lvlerrate1 = 0>
</cfif>
  ...
  <cfif getplacement.pm neq "">
        ...
        <cfloop query="getpm">
            ...
            <cfelseif getpm.itemname eq "OT5">
                <cfif getpm.payable eq "Y">
                <cfset BASIC = selfusualpay>
                <cfset selfotrate5= numberformat(evaluate(replace(getpm.payableamt,'=','')),'.__')>
                </cfif>
                
                <cfif getpm.billable eq "Y">
                <cfset BASIC = selfusualpay>
                <cfset custotrate5= numberformat(evaluate(replace(getpm.billableamt,'=','')),'.__')>
           		</cfif>
                
            <cfelseif getpm.itemname eq "OT6">
                <cfif getpm.payable eq "Y">
                <cfset BASIC = selfusualpay>
                <cfset selfotrate6= numberformat(evaluate(replace(getpm.payableamt,'=','')),'.__')>
                </cfif>
                
                <cfif getpm.billable eq "Y">
                <cfset BASIC = selfusualpay>
                <cfset custotrate6= numberformat(evaluate(replace(getpm.billableamt,'=','')),'.__')>
           		</cfif>
            <cfelseif getpm.itemname eq "OT7">
                <cfif getpm.payable eq "Y">
                <cfset BASIC = selfusualpay>
                <cfset selfotrate7= numberformat(evaluate(replace(getpm.payableamt,'=','')),'.__')>
                </cfif>
                
                <cfif getpm.billable eq "Y">
                <cfset BASIC = selfusualpay>
                <cfset custotrate7= numberformat(evaluate(replace(getpm.billableamt,'=','')),'.__')>
           		</cfif>
            <cfelseif getpm.itemname eq "OT8">
                <cfif getpm.payable eq "Y">
                <cfset BASIC = selfusualpay>
                <cfset selfotrate8= numberformat(evaluate(replace(getpm.payableamt,'=','')),'.__')>
                </cfif>
                
                <cfif getpm.billable eq "Y">
                <cfset BASIC = selfusualpay>
                <cfset custotrate8= numberformat(evaluate(replace(getpm.billableamt,'=','')),'.__')>
           		</cfif>
            </cfif>
        </cfloop>
		</cfif>
