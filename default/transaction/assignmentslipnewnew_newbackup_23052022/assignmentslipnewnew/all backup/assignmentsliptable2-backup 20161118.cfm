...
function calcusttotal()
{
	...
	document.getElementById('custtotal').value=(custsalary+custottotal+custphnlsalaryamt+custallowance+custcpf+custsdf+custpbawsamt+custdeductionamt+custpayback+adminfeeamt+taxamtamt).toFixed(2);
	document.getElementById('custtotalgross').value=(custsalary+custottotal+custphnlsalaryamt+custallowance+custcpf+custsdf+custpbawsamt+custdeductionamt+custpayback+adminfeeamt).toFixed(2);
