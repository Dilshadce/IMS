...
<cfoutput>
	<h4>
        <cfif dts eq 'manpower_i' or dts eq 'manpowertest_i'>
		<a href="/default/transaction/assignmentslipnewnew/Assignmentsliptable2.cfm?type=Create">Create Assignment Slip</a> 
		||</cfif> <a href="/default/transaction/assignmentslipnewnew/Assignmentsliptable.cfm?">List all Assignment Slip</a> 
      ...
      <input type="text" name="searchStr" value=""> </h1>
		...
		<cfif isdefined("form.searchStr")>
			<cfquery datasource='#dts#' name="exactResult">
				Select * from assignmentslip where #form.searchType# = <cfqueryparam cfsqltype="cf_sql_varchar" value="#form.searchStr#"> order by #form.searchType#
			</cfquery>
			
			<cfquery datasource='#dts#' name="similarResult">
				Select * from assignmentslip where #form.searchType# LIKE <cfqueryparam cfsqltype="cf_sql_varchar" value="%#form.searchStr#%"> order by #form.searchType#
			</cfquery>
    ...
    <table align="center" class="data" width="1000px">
      ...
      <cfoutput query="exactResult"> 
        <tr> 
          ...
          <td>#exactResult.posted# <cfif exactResult.locked eq "Y">#exactResult.locked#</cfif> <cfif exactResult.combine eq "Y">C</cfif></td>
          <td>#exactResult.batches#</td>
		  <td>#exactresult.created_by#</td>
          <!---<cfif getpin2.h1H11 eq 'T'>---><td width="10%" nowrap> 
            <div align="center"><a href="/default/transaction/assignmentslipnewnew/assignmentsliptable2.cfm?type=Delete&refno=#exactResult.refno#" ><img height="18px" width="18px" src="/images/delete.ICO" alt="Delete" border="0">Delete</a>&nbsp; 
              <a href="/default/transaction/assignmentslipnewnew/assignmentsliptable2.cfm?type=Edit&refno=#exactResult.refno#" ><img height="18px" width="18px" src="/images/edit.ICO" alt="Edit" border="0">Edit</a></div></td><!---</cfif>---->
        </tr>
      </cfoutput> 
    </table>
			<cfelse>
    ...
    <table align="center" class="data" width="1000px">
      ...
      <cfoutput query="similarResult"> 
        <tr> 
          ...
          <td>#similarResult.posted# <cfif similarResult.locked eq "Y">#similarResult.locked#</cfif> <cfif similarResult.combine eq "Y">C</cfif></td>
          <td>#similarResult.created_by#</td>
          <td width="10%" nowrap> 
            <div align="center"><a href="/default/transaction/assignmentslipnewnew/assignmentsliptable2.cfm?type=Delete&refno=#similarResult.refno#"  ><img height="18px" width="18px" src="/images/delete.ICO" alt="Delete" border="0">Delete</a>&nbsp; 
              <a href="/default/transaction/assignmentslipnewnew/assignmentsliptable2.cfm?type=Edit&refno=#similarResult.refno#" ><img height="18px" width="18px" src="/images/edit.ICO" alt="Edit" border="0" >Edit</a></div></td>
        </tr>
      </cfoutput> 
    </table>
			<cfelse>
