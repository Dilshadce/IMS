...
SELECT price_bil,itemno FROM ictran where refno = <cfqueryparam cfsqltype="cf_sql_varchar" value="#refno#"> and type = <cfqueryparam cfsqltype="cf_sql_varchar" value="#tran#"> and trancode = <cfqueryparam cfsqltype="cf_sql_varchar" value="#url.trancode#">
</cfquery>
<cfoutput>
...
<cfinput type="hidden" name="changepriceitemno" id="changepriceitemno" value="#url.itemno#" />
<table>
<tr>
<th>Price</th>
