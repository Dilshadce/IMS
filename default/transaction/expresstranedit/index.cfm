...
<cfquery name='getcustremark' datasource='#dts#'>
    ...
    <cfset pono = getcustremark.pono>
    <cfset xcurrcode = getcustremark.currcode>
    <cfset xcurrrate = getcustremark.currrate>
    <cfset van = getcustremark.van>
    <cfset project = getcustremark.source>
    <cfset job = getcustremark.job>
    
    <cfset xtaxinclude = getcustremark.taxincl>
    <cfset xtaxcode = getcustremark.note>
    <cfset xtaxpec = getcustremark.taxp1>
    <cfset xtax = getcustremark.tax>
    
    <cfset xdispec1 = getcustremark.disp1>
    <cfset xdispec2 = getcustremark.disp2>
    <cfset xdispec3 = getcustremark.disp3>
    <cfset xdisamt = getcustremark.disc_bil>
...
<link href="/SpryAssets/SpryCollapsiblePanel.css" rel="stylesheet" type="text/css" />
	...
	var ajaxurl2 = '/default/transaction/expresstranedit/addpackageprocessAjax.cfm?tran='+escape(tran)+'&refno='+refno+'&trancode='+escape(trancode)+'&custno='+escape(custno)+'&packagecode='+escape(packagecode)+'&location='+escape(location);
...
function selectmemberlist(custno){	
  ...
  for(var i=0;i<output.length;i++) {
	...
	function updaterow(rowno,itemno)
	{
		...
		var updateurl = 'updaterow.cfm?tran='+escape(tran)+'&refno='+escape(refno)+'&coltype='+escape(coltypedata)+'&qty='+escape(qtylistdata)+'&trancode='+rowno+'&itemno='+escape(itemno)+'&brem4='+escape(brem4data)+'&brem1='+escape(brem1data)+'&job='+escape(joblistdata);
	...
	function deleterow(rowno)
	{
		...
		var updateurl = 'deleterow.cfm?refno='+escape(refno)+'&tran='+tran+'&trancode='+rowno;
		new Ajax.Request(updateurl,
      {
        method:'get',
        onSuccess: function(getdetailback){
...
<!--- 		if(nextflow != "")
	...
	{
		var ajaxurl = '/default/transaction/expresstranedit/getunitpriceAjax.cfm?itemno='+trim(document.getElementById('expressservicelist').value)+'&unit='+document.getElementById('expunit').value;
	...
	{
	var itemno = trim(document.getElementById('expressservicelist').value);
	...
	var ajaxurl2 = '/default/transaction/expresstranedit/addmultiproductsAjax.cfm?tran='+escape(tran)+'&refno='+refno+'&trancode='+escape(trancode)+'&custno='+escape(custno)+'&location='+escape(location)+'&itemlisting='+escape(itemlisting);
	...
	{
	<!---ajaxFunction(document.getElementById('itemlist'),'getBody.cfm?<cfif dts eq "tcds_i"><cfoutput>type=#url.tran#&</cfoutput></cfif>uuid='+document.getElementById('uuid').value);
	...
	function bluradditem(detailitemno)
	{
		...
		setTimeout("getitemdetail(trim(document.getElementById('expressservicelist').value));",500);
	}
	...
	{
    var urlloaditemdetail = '/default/transaction/expresstranedit/addItemAjax.cfm?itemno='+escape(encodeURI(detailitemno))+'&reftype='+document.getElementById('tran').value+'&custno='+document.getElementById('custno').value;
	...
	{
	  var urlloaditembal = '/default/transaction/expresstranedit/balonhand.cfm?itemno='+encodeURI(itemnobal)+'&location='+escape(document.getElementById('locationfr').value);
	...
	{
	<cfoutput>
    var urlload = '/default/transaction/expresstranedit/recalculateAjax.cfm?refno=#URLEncodedFormat(refno)#&tran=#URLEncodedFormat(tran)#';
	...
	{
	var ajaxurl = '/default/transaction/expresstranedit/recalculateAjax.cfm?refno=#URLEncodedFormat(refno)#&tran=#URLEncodedFormat(tran)#';
	new Ajax.Request(ajaxurl,
      {
        method:'get',
        onSuccess: function(getdetailback){
	...
	{
		<cfoutput>
	var customerurl = '/default/transaction/expresstranedit/memberdetailajax.cfm?detail=1&type=#url.tran#&member='+document.getElementById("custno").value;
...
updatecustomerdetail();
	...
	var outstandingurl = '/default/transaction/expresstranedit/outstandinglimitajax.cfm?custno='+document.getElementById("custno").value;
...
<input type="hidden" name="hidupdateitemno" id="hidupdateitemno" value="">
<cfif tran eq 'ISS'>
...
<tr>
<th width="20%">Date</th>
<cfset datenow=getcustremark.wos_date>
...
<cfinput type="text" name="refno" id="refno" val required="yes" onKeyUp="nextIndex('refno','custno');" value="#refno#" readonly>
&nbsp;&nbsp;&nbsp;&nbsp;<b>#url.tran#</b></td>
...
<cfif tran eq 'ISS'>
<!---Issue--->
<cfinput type="text" name="custno" id="custno" value="#custno#" required="yes" message="Please key in Authorised By">
<!--- --->
<cfelse>
...
<td <cfif tran eq 'ISS'>style="display:none" </cfif>><cfinput type="text" name="currcode" id="currcode" value="#xcurrcode#" size="10"  /><input type="hidden" name="currcodehid" id="currcodehid" value="">&nbsp;<cfinput type="text" name="currrate" id="currrate" value="#xcurrrate#" bind="cfc:custsupp.getcurrrate('#dts#',{currcode},'#target_currency#')" bindonload="yes" size="5" /></td>
</tr>

<tr>
<td colspan="2" onClick="javascript:shoh('r1');" ><div align="center"><strong style="cursor:pointer">Address Information<img src="/images/u.gif" name="imgr1" align="center"></strong></div></td>
<td colspan="2" onClick="javascript:shoh('r2');"><div align="center"><strong  style="cursor:pointer">Header Information<img src="/images/u.gif" name="imgr2" align="center"></strong></div></td>
</tr>
...
<td><cfinput type="text" name="b_name" id="b_name" value="#getcustremark.name#" maxlength="35" size="40" required="yes" message="Reason for Issue"></td>
<th></th><td><input type="hidden" name="d_name" id="d_name" value="#getcustremark.frem7#" maxlength="35" size="40">
<input type="hidden" name="bcode" id="bcode" value="#getcustremark.rem0#"/>

<input type="hidden" name="d_name2" id="d_name2" value="#getcustremark.frem8#" maxlength="35" size="40">
<input type="hidden" name="b_name2" id="b_name2" value="#getcustremark.frem1#" maxlength="35" size="40"/>
<input type="hidden" name="b_add1" id="b_add1" value="#getcustremark.frem2#" maxlength="35" size="40">
<input type="hidden" name="d_add1" id="d_add1" value="#getcustremark.comm0#" maxlength="35" size="40">
<input type="hidden" name="b_add2" id="b_add2" value="#getcustremark.frem3#" maxlength="35" size="40">
<input type="hidden" name="d_add2" id="d_add2" value="#getcustremark.comm1#" maxlength="35" size="40">
<input type="hidden" name="b_add3" id="b_add3" value="#getcustremark.frem4#" maxlength="35" size="40">
<input type="hidden" name="d_add3" id="d_add3" value="#getcustremark.comm2#" maxlength="35" size="40">
<input type="hidden" name="b_add4" id="b_add4" value="#getcustremark.frem5#" maxlength="35" size="40">
<input type="hidden" name="d_add4" id="d_add4" value="#getcustremark.comm3#" maxlength="35" size="40">
...
<input type="hidden" name="b_email" id="b_email" value="#getcustremark.e_mail#" maxlength="35" size="40">
<input type="hidden" name="d_email" id="d_email" value="#getcustremark.d_email#" maxlength="35" size="40">
</td>
</tr>
<tr>
<th>Remark 1</th>
<td><input type="text" name="DCode" id="DCode" value="#getcustremark.rem1#"></td>
<th></th><td></td>
</tr>
<tr>
<th>Remark 2</th>
<td><input type="text" name="b_attn" id="b_attn" value="#getcustremark.rem2#" maxlength="35" size="40"></td>
<th></th><td></td>
</tr>
<tr>
<th>Remark 3</th>
<td><input type="text" name="d_attn" id="d_attn" value="#getcustremark.rem3#" maxlength="35" size="40"></td>
<th></th><td></td>
</tr>
<tr>
<th>Remark 4</th>
<td><input type="text" name="b_phone" id="b_phone" value="#getcustremark.rem4#" maxlength="25" size="40"></td>
<th></th><td></td>
</tr>
<tr>
<th></th>
...
<tr>
<th>Customer Name</th>
<td><input type="text" name="b_name" id="b_name" value="#getcustremark.frem0#" maxlength="35" size="40" <cfif getdealer_menu.tran_edit_name neq 'Y'>readonly</cfif>/></td>
<th <cfif getmodule.auto eq 1>style="display:none" </cfif>>Delivery Name</th><td <cfif getmodule.auto eq 1>style="display:none" </cfif>><input type="#custinputtype#" name="d_name" id="d_name" value="#getcustremark.frem7#" maxlength="35" size="40" ></td>
</tr>
<tr>
<th><input type="text" name="bcode" id="bcode" value="#getcustremark.rem0#"></th>
<td><input type="text" name="b_name2" id="b_name2" value="#getcustremark.frem1#" maxlength="35" size="40" <cfif getdealer_menu.tran_edit_name neq 'Y'>readonly</cfif>/></td>
<th><input type="text" name="DCode" id="DCode" value="#getcustremark.rem1#"></th><td <cfif getmodule.auto eq 1>style="display:none" </cfif>><input type="text" name="d_name2" id="d_name2" value="#getcustremark.frem8#" maxlength="35" size="40" ></td>
</tr>
<tr>
<th>Address</th>
<td>
<input type="text" name="b_add1" id="b_add1" value="#getcustremark.frem2#" maxlength="35" size="40"></td>
<th <cfif getmodule.auto eq 1>style="display:none" </cfif>>Address</th><td <cfif getmodule.auto eq 1>style="display:none" </cfif>><input type="text" name="d_add1" id="d_add1" value="#getcustremark.comm0#" maxlength="35" size="40"></td>
</tr>
<tr>
<th></th>
<td>
<input type="text" name="b_add2" id="b_add2" value="#getcustremark.frem3#" maxlength="35" size="40"></td>
<th <cfif getmodule.auto eq 1>style="display:none" </cfif>><cfinput type="button" name="changedaddr" id="changedaddr" onClick="ColdFusion.Window.show('changedaddr');" value="Change Del Add"></th><td <cfif getmodule.auto eq 1>style="display:none" </cfif>><input type="text" name="d_add2" id="d_add2" value="#getcustremark.comm1#" maxlength="35" size="40"></td>
</tr>
<tr>
<th></th>
<td>
<input type="text" name="b_add3" id="b_add3" value="#getcustremark.frem4#" maxlength="35" size="40"></td>
<th <cfif getmodule.auto eq 1>style="display:none" </cfif>></th><td <cfif getmodule.auto eq 1>style="display:none" </cfif>><input type="text" name="d_add3" id="d_add3" value="#getcustremark.comm2#" maxlength="35" size="40"></td>
</tr>
<tr>
<th></th>
<td>
<input type="text" name="b_add4" id="b_add4" value="#getcustremark.frem5#" maxlength="35" size="40"></td>
<th <cfif getmodule.auto eq 1>style="display:none" </cfif>></th><td <cfif getmodule.auto eq 1>style="display:none" </cfif>><input type="text" name="d_add4" id="d_add4" value="#getcustremark.comm3#" maxlength="35" size="40"></td>
</tr>
<tr>
<th>Tel</th>
<td>
<input type="text" name="b_phone" id="b_phone" value="#getcustremark.rem4#" maxlength="25" size="40"></td>
<th <cfif getmodule.auto eq 1>style="display:none" </cfif>>Tel</th><td <cfif getmodule.auto eq 1>style="display:none" </cfif>><input type="text" name="d_phone" id="d_phone" value="#getcustremark.rem12#" maxlength="25" size="40"></td>
</tr>

<tr>
<th>Hp</th>
<td>
<input type="text" name="b_phone2" id="b_phone2" value="#getcustremark.phonea#" maxlength="25" size="40"></td>
<th <cfif getmodule.auto eq 1>style="display:none" </cfif>>Hp</th><td <cfif getmodule.auto eq 1>style="display:none" </cfif>><input type="text" name="d_phone2" id="d_phone2" value="#getcustremark.d_phone2#" maxlength="25" size="40"></td>
</tr>

<tr>
<th>Fax</th>
<td>
<input type="text" name="b_fax" id="b_fax" value="#getcustremark.frem6#" maxlength="25" size="40"></td>
<th <cfif getmodule.auto eq 1>style="display:none" </cfif>>Fax</th>
<td <cfif getmodule.auto eq 1>style="display:none" </cfif>><input type="text" name="d_fax" id="d_fax" value="#getcustremark.comm4#" maxlength="25" size="40"></td>
</tr>
<tr>
<th>Attention</th>
<td>
<input type="text" name="b_attn" id="b_attn" value="#getcustremark.rem2#" maxlength="35" size="20"><cfif (lcase(hcomid) neq "bnbm_i" and lcase(hcomid) neq "bnbp_i")><input type="button" name="Sattn1" value="Ajax Search" onClick="javascript:ColdFusion.Window.show('findattention');"></cfif></td>
<th <cfif getmodule.auto eq 1>style="display:none" </cfif>>Attention</th>
<td <cfif getmodule.auto eq 1>style="display:none" </cfif>><input type="text" name="d_attn" id="d_attn" value="#getcustremark.rem3#" maxlength="35" size="20"><cfif (lcase(hcomid) neq "bnbm_i" and lcase(hcomid) neq "bnbp_i")><input type="button" name="Sattn2" value="Ajax Search" onClick="javascript:ColdFusion.Window.show('findattention2');"></cfif></td>
</tr>

<tr>
<th>E-mail</th>
<td>
<input type="text" name="b_email" id="b_email" value="#getcustremark.e_mail#" maxlength="35" size="40"></td>
<th <cfif getmodule.auto eq 1>style="display:none" </cfif>>E-mail</th>
<td <cfif getmodule.auto eq 1>style="display:none" </cfif>><input type="text" name="d_email" id="d_email" value="#getcustremark.d_email#" maxlength="35" size="40"></td>
</tr>
</table>
</cfif>
</div>
...
<div align="left">
<table align="left" width="100%" id="r2" style="display:none">
<tr>
<th width="25%">#getGsetup.refno2#</th>
<td width="75%"><cfinput type="text" name="refno2" id="refno2" value="" maxlength="20"/></td>
...
<th>Agent</th>
<td>
<cfselect name="agent" id="agent" bind="cfc:custsupp.getagent('#dts#','#Hlinkams#')" bindonload="yes" display="agentdesp" value="agent" /><input type="hidden" name="agenthid" id="agenthid" value=""></td>
</tr>
...
<cfselect name="project" id="project" bind="cfc:custsupp.getproject('#dts#','#Hlinkams#')" bindonload="yes" display="projectdesp" value="source" />
</td>
</tr>
<cfelse>
<tr>
...
<cfif tran eq 'QUO' and getgsetup.quotationlead eq 'Y'>
<tr><th>Lead No</th><td><input type="text" name="leadno" id="leadno" value="#permitno#" readonly></td></tr>
</cfif>
<cfif getdisplaysetup2.f_crlimit eq 'Y'>
...
<div id="itemlist" style="height:438px; overflow:scroll;">
<table width="100%">
<tr>
<th width="2%">No</th>
...
<!---<input type="text" name="coltypelist#getictrantemp.trancode#" id="coltypelist#getictrantemp.trancode#" value="#getictrantemp.brem1#" onClick="if(this.value=='Collection'){this.value = 'Delivery';updaterow('#getictrantemp.trancode#','#getictrantemp.itemno#');} else {this.value = 'Collection';updaterow('#getictrantemp.trancode#','#getictrantemp.itemno#');}"  readonly="readonly">---->
</td></cfif>
...
<cfif getdisplay.simple_price eq 'Y'><td nowrap align="right"><cfif getpin2.h2J01 eq "T"><a style="cursor:pointer;color:##000" onClick="document.getElementById('hidtrancode').value='#getictrantemp.trancode#';document.getElementById('hidupdateitemno').value='#getictrantemp.itemno#';ColdFusion.Window.show('changeprice');getfocus5();">#numberformat(val(getictrantemp.price_bil),',.__')#</a><cfelse>#numberformat(val(getictrantemp.price_bil),',.__')#</a></cfif></td></cfif>

<cfif getdisplay.simple_disc eq 'Y'><td nowrap align="right">
<cfif getpin2.h2J01 eq "T"><a style="cursor:pointer;color:##000" onClick="document.getElementById('hidtrancode').value='#getictrantemp.trancode#';document.getElementById('hidupdateitemno').value='#getictrantemp.itemno#';ColdFusion.Window.show('changediscount');getfocus4();">#numberformat(val(getictrantemp.disamt_bil),'.__')#</a><cfelse>#numberformat(val(getictrantemp.disamt_bil),stDecl_UPrice)#</cfif>
...
<tr>
  ...
  <th>Discount</th>
<td>
 <cfinput type="#inputtype#" size="3" name="dispec1" id="dispec1" value="#val(xdispec1)#" validate="float" validateat="onblur" message="Please key in numeric value" onKeyUp="calcdisc();caltax();calcfoot();" />%<input type="hidden" name="disbil1" id="disbil1" />&nbsp;&nbsp;
  <cfinput type="#inputtype#" size="3" name="dispec2" id="dispec2" value="#val(xdispec2)#" validate="float" validateat="onblur" message="Please key in numeric value" onKeyUp="calcdisc();caltax();calcfoot();"/>%<input type="hidden" name="disbil2" id="disbil2" />&nbsp;&nbsp;
  <cfinput type="#inputtype#" size="3" name="dispec3" id="dispec3" value="#val(xdispec3)#" validate="float" validateat="onblur" message="Please key in numeric value" onKeyUp="calcdisc();caltax();calcfoot();"/>%<input type="hidden" name="disbil3" id="disbil3" />&nbsp;&nbsp;&nbsp;
  <cfinput type="#inputtype#" size="5" name="disamt_bil" id="disamt_bil" value="#val(xdisamt)#" validate="float" validateat="onblur" message="Please key in numeric value" onKeyUp="caltax();calcfoot();" />
</td> 
  </td>
</tr>
...
<input type="checkbox" name="taxincl" id="taxincl" value="T" onClick="caltax()" <cfif xtaxinclude eq "T">checked </cfif> />&nbsp;
...
<cfselect name="taxcode" id="taxcode" query="taxrate" value="code" display="code" onChange="setTimeout('caltax()',500);" bindonload="yes"/>
  ...
  <cfinput type="#inputtype#" name="taxamt" id="taxamt" value="#numberformat(xtax,'.__')#" size="10" onKeyUp="calcfoot();" />  
</td>
</tr>
...
<tr>
<td colspan="3">
<input type="hidden" name="rem5" id="rem5" value="#rem5#">
<input type="hidden" name="rem6" id="rem6" value="#rem6#">
<input type="hidden" name="rem7" id="rem7" value="#rem7#">
<input type="hidden" name="rem8" id="rem8" value="#rem8#">
<input type="hidden" name="rem9" id="rem9" value="#rem9#">
<input type="hidden" name="rem10" id="rem10" value="#rem10#">
<input type="hidden" name="rem11" id="rem11" value="#rem11#">
<!---
...
Note :<br>
<textarea name="termscondition" id="termscondition" cols="100" rows="5">#getcustremark.termscondition#</textarea>
</td>
</tr>
...
<cfwindow center="true" width="1100" height="500" name="searchitem" refreshOnShow="true" closable="true" modal="false" title="Search Item" initshow="false"
        source="/default/transaction/expresstranedit/searchitem2.cfm?reftype={tran}" />
<cfelse>
<cfwindow center="true" width="1100" height="500" name="searchitem" refreshOnShow="true" closable="true" modal="false" title="Search Item" initshow="false"
        source="/default/transaction/expresstranedit/searchitem.cfm?reftype={tran}" />
</cfif>
...
<cfwindow center="true" width="600" height="400" name="changedaddr" refreshOnShow="true" closable="true" modal="false" title="Search Address" initshow="false"
        source="/default/transaction/expresstranedit/searchaddress.cfm" /> 
...
<cfwindow center="true" width="700" height="300" name="totalup" refreshOnShow="true" closable="true" modal="true" title="Total" initshow="false" source="total.cfm?grandtotal={grand}&tran=#tran#&refno=#refno#" />   
<cfwindow center="true" width="700" height="250" name="totalup1" refreshOnShow="true" closable="true" modal="true" title="Total" initshow="false" source="total1.cfm?grandtotal={grand}&tran=#tran#&refno=#refno#" /> 
<cfwindow center="true" width="700" height="250" name="totalup2" refreshOnShow="true" closable="true" modal="true" title="Total" initshow="false" source="total2.cfm?grandtotal={grand}&tran=#tran#&refno=#refno#" /> 
<cfwindow center="true" width="700" height="250" name="totalup3" refreshOnShow="true" closable="true" modal="true" title="Total" initshow="false" source="total3.cfm?grandtotal={grand}&tran=#tran#&refno=#refno#" /> 
<cfwindow center="true" width="700" height="250" name="totalup4" refreshOnShow="true" closable="true" modal="true" title="Total" initshow="false" source="total4.cfm?grandtotal={grand}&tran=#tran#&refno=#refno#" /> 
<cfwindow center="true" width="700" height="600" name="totalup5" refreshOnShow="true" closable="true" modal="true" title="Total" initshow="false" source="total5.cfm?grandtotal={grand}&tran=#tran#&refno=#refno#" />  
<cfwindow center="true" width="700" height="600" name="totalup6" refreshOnShow="true" closable="true" modal="true" title="Payment" initshow="false" source="total6.cfm?grandtotal={grand}&tran=#tran#&refno=#refno#&custno={custno}" /> 
...
<cfwindow center="true" width="700" height="500" name="changeprice" refreshOnShow="true" closable="true" modal="true" title="Edit Price" initshow="false" source="changeprice.cfm?tran=#tran#&refno=#refno#&trancode={hidtrancode}&itemno={hidupdateitemno}&custno={custno}" />  
<cfwindow center="true" width="700" height="500" name="changediscount" refreshOnShow="true" closable="true" modal="true" title="Edit Discount" initshow="false" source="changediscount.cfm?tran=#tran#&refno=#refno#&trancode={hidtrancode}&itemno={hidupdateitemno}&custno={custno}" /> 
<cfif dts eq "tcds_i" and url.tran eq "RC">
<cfwindow center="true" width="250" height="150" name="changesellingprice" refreshOnShow="true" closable="true" modal="true" title="Edit Selling Price" initshow="false" source="changesellingprice.cfm?tran=#tran#&refno=#refno#&trancode={hidtrancode}" />  
</cfif>
<cfwindow center="true" width="250" height="150" name="updatefreeqty" refreshOnShow="true" closable="true" modal="true" title="Edit Free Quantity" initshow="false" source="updatefreeqty.cfm?tran=#tran#&refno=#refno#&trancode={hidtrancode}" />  
...
<cfwindow center="true" width="700" height="550" name="itemdesp" refreshOnShow="true" closable="true" modal="true" title="Change Item Description" initshow="false" source="itemdesp.cfm?tran=#tran#&refno=#refno#&trancode={itemdesptrancode}" /> 
...
<cfwindow center="true" width="580" height="400" name="findattention2" refreshOnShow="true"
        ...
        source="/default/transaction/expresstranedit/addpackage.cfm?reftype={tran}" />
...
<cfif tran eq 'QUO' and getgsetup.quotationlead eq 'Y'>
        ...
        source="/default/transaction/expresstranedit/findlead.cfm" />
        </cfif>
...
<cfoutput>
 ...
 setTimeout('caltax()','3000');
 </cfif>
 
 setTimeout("selectOptionByValue(document.getElementById('term'),'#zterm#');",3500);
 setTimeout("selectOptionByValue(document.getElementById('project'),'#project#');",3500);
 setTimeout("selectOptionByValue(document.getElementById('job'),'#job#');",3500);
 setTimeout("selectOptionByValue(document.getElementById('driver'),'#van#');",3500);
 </script>
 </cfoutput>
