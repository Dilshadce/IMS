...
select itemno from locadjtran_temp where refno='#refno#' and itemno='#itemno#' and uuid='#uuid#'
</cfquery>
...
select ifnull(max(trancode),0) as trancode from locadjtran_temp where refno='#refno#' and uuid='#uuid#'
</cfquery>

<cfquery name="insertictran" datasource="#dts#">
	insert into locadjtran_temp
	(
    	trancode,
		refno,
        itemno,
