...
<cfoutput>
    ...
    <cfelse>
    <cfif trim(getremarkdetail.remark30list) eq ''>
            	<input type="text" name="remark30" id="remark30" value="#remark30#" size="40" maxlength="100">
            <cfelse>
            	<select name="remark30" id="remark30">
            	<option value="">Please choose</option>
            	<cfloop list="#getremarkdetail.remark30list#" index="i">
            	<option value="#i#" <cfif remark30 eq i>selected</cfif>>#i#</option>
            	</cfloop>
            	</select>
    </cfif>
    </cfif>
    ...
    <cfelse>
    	<cfif trim(getremarkdetail.remark31list) eq ''>
            	<input type="text" name="remark31" id="remark31" value="#remark31#" size="40" maxlength="100">
            <cfelse>
            	<select name="remark31" id="remark31">
            	<option value="">Please choose</option>
            	<cfloop list="#getremarkdetail.remark31list#" index="i">
            	<option value="#i#" <cfif remark31 eq i>selected</cfif>>#i#</option>
            	</cfloop>
            	</select>
        </cfif>
    </cfif>
    ...
    <cfelse>
    		<cfif trim(getremarkdetail.remark32list) eq ''>
            	<input type="text" name="remark32" id="remark32" value="#remark32#" size="40" maxlength="100">
            <cfelse>
            	<select name="remark32" id="remark32">
            	<option value="">Please choose</option>
            	<cfloop list="#getremarkdetail.remark32list#" index="i">
            	<option value="#i#" <cfif remark32 eq i>selected</cfif>>#i#</option>
            	</cfloop>
            	</select>
            </cfif>
    </cfif>
    ...
    <cfelse>
    		<cfif trim(getremarkdetail.remark33list) eq ''>
            	<input type="text" name="remark33" id="remark33" value="#remark33#" size="40" maxlength="100">
            <cfelse>
            	<select name="remark33" id="remark33">
            	<option value="">Please choose</option>
            	<cfloop list="#getremarkdetail.remark33list#" index="i">
            	<option value="#i#" <cfif remark33 eq i>selected</cfif>>#i#</option>
            	</cfloop>
            	</select>
            </cfif>
    </cfif>
    ...
    <cfelse>
    		<cfif trim(getremarkdetail.remark34list) eq ''>
            	<input type="text" name="remark34" id="remark34" value="#remark34#" size="40" maxlength="100">
            <cfelse>
            	<select name="remark34" id="remark34">
            	<option value="">Please choose</option>
            	<cfloop list="#getremarkdetail.remark34list#" index="i">
            	<option value="#i#" <cfif remark34 eq i>selected</cfif>>#i#</option>
            	</cfloop>
            	</select>
            </cfif>
    </cfif></td>
    ...
    <cfelse>
    		<cfif trim(getremarkdetail.remark35list) eq ''>
            	<input type="text" name="remark35" id="remark35" value="#remark35#" size="40" maxlength="100">
            <cfelse>
            	<select name="remark35" id="remark35">
            	<option value="">Please choose</option>
            	<cfloop list="#getremarkdetail.remark35list#" index="i">
            	<option value="#i#" <cfif remark35 eq i>selected</cfif>>#i#</option>
            	</cfloop>
            	</select>
            </cfif>
    </cfif>
    ...
    <cfelse>
			<cfif trim(getremarkdetail.remark36list) eq ''>
            	<input type="text" name="remark36" id="remark36" value="#remark36#" size="40" maxlength="100">
            <cfelse>
            	<select name="remark36" id="remark36">
            	<option value="">Please choose</option>
            	<cfloop list="#getremarkdetail.remark36list#" index="i">
            	<option value="#i#" <cfif remark36 eq i>selected</cfif>>#i#</option>
            	</cfloop>
            	</select>
            </cfif>
	</cfif>
    ...
    <cfif lcase(hcomid) eq "sdc_i">
         ...
         <cfelse>
    		<cfif trim(getremarkdetail.remark37list) eq ''>
            	<input type="text" name="remark37" id="remark37" value="#remark37#" size="40" maxlength="100">
            <cfelse>
            	<select name="remark37" id="remark37">
            	<option value="">Please choose</option>
            	<cfloop list="#getremarkdetail.remark37list#" index="i">
            	<option value="#i#" <cfif remark37 eq i>selected</cfif>>#i#</option>
            	</cfloop>
            	</select>
            </cfif>
    </cfif></td>
    ...
    <cfif trim(getremarkdetail.remark38list) eq ''>
            	<input type="text" name="remark38" id="remark38" value="#remark38#" size="40" maxlength="100">
            <cfelse>
            	<select name="remark38" id="remark38">
            	<option value="">Please choose</option>
            	<cfloop list="#getremarkdetail.remark38list#" index="i">
            	<option value="#i#" <cfif remark38 eq i>selected</cfif>>#i#</option>
            	</cfloop>
            	</select>
            </cfif>
    </td>
    ...
    <cfif lcase(hcomid) eq "sdc_i">
         ...
         <cfelse>
    		<cfif trim(getremarkdetail.remark39list) eq ''>
            	<input type="text" name="remark39" id="remark39" value="#remark39#" size="40" maxlength="100">
            <cfelse>
            	<select name="remark39" id="remark39">
            	<option value="">Please choose</option>
            	<cfloop list="#getremarkdetail.remark39list#" index="i">
            	<option value="#i#" <cfif remark39 eq i>selected</cfif>>#i#</option>
            	</cfloop>
            	</select>
            </cfif>
    </cfif></td>
    ...
    <td <cfif rem40display neq "Y">style="visibility:hidden"</cfif>>
    		<cfif trim(getremarkdetail.remark40list) eq ''>
            	<input type="text" name="remark40" id="remark40" value="#remark40#" size="40" maxlength="100">
            <cfelse>
            	<select name="remark40" id="remark40">
            	<option value="">Please choose</option>
            	<cfloop list="#getremarkdetail.remark40list#" index="i">
            	<option value="#i#" <cfif remark40 eq i>selected</cfif>>#i#</option>
            	</cfloop>
            	</select>
            </cfif>
    ...
    <td <cfif rem41display neq "Y">style="visibility:hidden"</cfif>>
    		<cfif trim(getremarkdetail.remark41list) eq ''>
            	<input type="text" name="remark41" id="remark41" value="#remark41#" size="40" maxlength="100">
            <cfelse>
            	<select name="remark41" id="remark41">
            	<option value="">Please choose</option>
            	<cfloop list="#getremarkdetail.remark41list#" index="i">
            	<option value="#i#" <cfif remark41 eq i>selected</cfif>>#i#</option>
            	</cfloop>
            	</select>
            </cfif>
    ...
    <td <cfif rem42display neq "Y">style="visibility:hidden"</cfif>>
    		<cfif trim(getremarkdetail.remark42list) eq ''>
            	<input type="text" name="remark42" id="remark42" value="#remark42#" size="40" maxlength="100">
            <cfelse>
            	<select name="remark42" id="remark42">
            	<option value="">Please choose</option>
            	<cfloop list="#getremarkdetail.remark42list#" index="i">
            	<option value="#i#" <cfif remark42 eq i>selected</cfif>>#i#</option>
            	</cfloop>
            	</select>
            </cfif>
    ...
    <td <cfif rem43display neq "Y">style="visibility:hidden"</cfif>>
    		<cfif trim(getremarkdetail.remark43list) eq ''>
            	<input type="text" name="remark43" id="remark43" value="#remark43#" size="40" maxlength="100">
            <cfelse>
            	<select name="remark43" id="remark43">
            	<option value="">Please choose</option>
            	<cfloop list="#getremarkdetail.remark43list#" index="i">
            	<option value="#i#" <cfif remark43 eq i>selected</cfif>>#i#</option>
            	</cfloop>
            	</select>
            </cfif>
    ...
    <cfelse>
    		<cfif trim(getremarkdetail.remark44list) eq ''>
            	<input type="text" name="remark44" id="remark44" value="#remark44#" size="40" maxlength="100">
            <cfelse>
            	<select name="remark44" id="remark44">
            	<option value="">Please choose</option>
            	<cfloop list="#getremarkdetail.remark44list#" index="i">
            	<option value="#i#" <cfif remark44 eq i>selected</cfif>>#i#</option>
            	</cfloop>
            	</select>
            </cfif>
    </cfif>
    ...
    <td <cfif rem45display neq "Y">style="visibility:hidden"</cfif>><cfif getgsetup.autooutstandingreport eq 'Y'><input type="text" name="remark45" value="#convertquote(remark45)#" size="40" maxlength="10"><img src="../../images/cal.gif" width=17 height=15 border=0 onClick="showCalendarControl(remark45);">(DD/MM/YYYY)</td><cfelse>
    		<cfif trim(getremarkdetail.remark45list) eq ''>
            	<input type="text" name="remark45" id="remark45" value="#remark45#" size="40" maxlength="100">
            <cfelse>
            	<select name="remark45" id="remark45">
            	<option value="">Please choose</option>
            	<cfloop list="#getremarkdetail.remark45list#" index="i">
            	<option value="#i#" <cfif remark45 eq i>selected</cfif>>#i#</option>
            	</cfloop>
            	</select>
            </cfif>
    ...
    <td <cfif rem46display neq "Y">style="visibility:hidden"</cfif>><cfif getgsetup.autooutstandingreport eq 'Y'><input type="text" name="remark46" value="#convertquote(remark46)#" size="40" maxlength="10"><img src="../../images/cal.gif" width=17 height=15 border=0 onClick="showCalendarControl(remark46);">(DD/MM/YYYY)<cfelse>
    		<cfif trim(getremarkdetail.remark46list) eq ''>
            	<input type="text" name="remark46" id="remark46" value="#remark46#" size="40" maxlength="100">
            <cfelse>
            	<select name="remark46" id="remark46">
            	<option value="">Please choose</option>
            	<cfloop list="#getremarkdetail.remark46list#" index="i">
            	<option value="#i#" <cfif remark46 eq i>selected</cfif>>#i#</option>
            	</cfloop>
            	</select>
            </cfif>
    ...
    <td <cfif rem47display neq "Y">style="visibility:hidden"</cfif>><cfif getgsetup.autooutstandingreport eq 'Y'><input type="text" name="remark47" value="#convertquote(remark47)#" size="40" maxlength="10"><img src="../../images/cal.gif" width=17 height=15 border=0 onClick="showCalendarControl(remark47);">(DD/MM/YYYY)<cfelse>
    		<cfif trim(getremarkdetail.remark47list) eq ''>
            	<input type="text" name="remark47" id="remark47" value="#remark47#" size="40" maxlength="100">
            <cfelse>
            	<select name="remark47" id="remark47">
            	<option value="">Please choose</option>
            	<cfloop list="#getremarkdetail.remark47list#" index="i">
            	<option value="#i#" <cfif remark47 eq i>selected</cfif>>#i#</option>
            	</cfloop>
            	</select>
            </cfif>
    ...
    <th nowrap <cfif rem48display neq "Y">style="visibility:hidden"</cfif>><cfif getgsetup.bcurr eq 'MYR' and (tran eq "CN" or tran eq "DN")>Reason<cfelse>#getremarkdetail.rem48#</cfif></th>
    <td <cfif rem48display neq "Y">style="visibility:hidden"</cfif>><cfif getgsetup.bcurr eq 'MYR' and (tran eq "CN" or tran eq "DN")><cfinput type="text" name="remark48" value="#remark48#" size="40" maxlength="100" ><cfelseif getgsetup.autooutstandingreport eq 'Y'><input type="text" name="remark48" value="#convertquote(remark48)#" size="40" maxlength="10"><img src="../../images/cal.gif" width=17 height=15 border=0 onClick="showCalendarControl(remark48);">(DD/MM/YYYY)<cfelse>
    		<cfif trim(getremarkdetail.remark48list) eq ''>
            	<input type="text" name="remark48" id="remark48" value="#remark48#" size="40" maxlength="100">
            <cfelse>
            	<select name="remark48" id="remark48">
            	<option value="">Please choose</option>
            	<cfloop list="#getremarkdetail.remark48list#" index="i">
            	<option value="#i#" <cfif remark48 eq i>selected</cfif>>#i#</option>
            	</cfloop>
            	</select>
            </cfif>
    
    </cfif></td>
     <th nowrap <cfif rem49display neq "Y">style="visibility:hidden"</cfif>><cfif getgsetup.bcurr eq 'MYR' and (tran eq "CN" or tran eq "DN")>Invoice No<cfelse>#getremarkdetail.rem49#</cfif></th>
    <td <cfif rem49display neq "Y">style="visibility:hidden"</cfif>><cfif getgsetup.bcurr eq 'MYR' and (tran eq "CN" or tran eq "DN")><cfinput type="text" name="remark49" value="#remark49#" size="40" maxlength="100"><cfelseif getgsetup.autooutstandingreport eq 'Y'><input type="text" name="remark49" value="#convertquote(remark49)#" size="40" maxlength="10"><img src="../../images/cal.gif" width=17 height=15 border=0 onClick="showCalendarControl(remark49);">(DD/MM/YYYY)<cfelse>
    		<cfif trim(getremarkdetail.remark49list) eq ''>
            	<input type="text" name="remark49" id="remark49" value="#remark49#" size="40" maxlength="100">
            <cfelse>
            	<select name="remark49" id="remark49">
            	<option value="">Please choose</option>
            	<cfloop list="#getremarkdetail.remark49list#" index="i">
            	<option value="#i#" <cfif remark49 eq i>selected</cfif>>#i#</option>
            	</cfloop>
            	</select>
            </cfif>
    </cfif></td>
