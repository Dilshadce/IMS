...
brem4 = "#url.brem4#"<cfif right(url.brem4,1) eq "%">,dispec1='#val(url.brem4)#'</cfif>
WHERE 
trancode = <cfqueryparam cfsqltype="cf_sql_varchar" value="#url.trancode#">
and uuid = <cfqueryparam cfsqltype="cf_sql_varchar" value="#url.uuid#">
and itemno = <cfqueryparam cfsqltype="cf_sql_varchar" value="#url.itemno#">
...
<cfinvoke component="cfc.comboard" method="display" firstline="#getamt.desp#" secondlineleft="#numberformat(getamt.amt,',_.__')#" secondlineright="(#numberformat(getsum.sumsubtotal,'.__')#)" comchannel="#getgsetup.comboardport#" returnvariable="test"/></div>
<cfoutput>
<input type=hidden name='displayitem5' id='displayitem5' value='#test#'>
</cfoutput>
