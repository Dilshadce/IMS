...
<cftry>
<cfinvoke component="cfc.comboard" method="display" firstline="#numberformat(grand,',_.__')#" secondlineleft="Change:" secondlineright="#numberformat(form.changeamt1,',_.__')#" comchannel="#getgsetup.comboardport#" returnvariable="test"/>
<cfoutput>
