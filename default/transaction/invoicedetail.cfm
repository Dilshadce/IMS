...
and brem3 = "#form.tsstartdate#"
and wos_group = <cfqueryparam cfsqltype="cf_sql_varchar" value="#evaluate('form.groupdata#i#')#"> 
</cfquery>
...
<cfset comment = "From "&form.tsstartdate&" To "&form.tsenddate&chr(10)&chr(13)&"Our Ref : "&evaluate('form.letterreference#i#')&" dated "&dateformat(evaluate('form.letterreferencedate#i#'),'dd/mm/yyyy') >
...
,'#evaluate('form.timesheetid#i#')#'
,'#evaluate('form.phday#i#')#'
,'#evaluate('form.phtime#i#')#'
,'#evaluate('form.phrate#i#')#'
,'#evaluate('form.phbasic#i#')#'
,'#form.tsstartdate#'
,'#form.tsenddate#'
,'#evaluate('form.groupdata#i#')#'
)
</cfquery>
</cfif>
</cfif>
