    ...
    <tr>
        ...
        <cfelse> 
          ...
          <cfif trim(getGeneralInfo.bodyremark3list) eq ''>
            <input type='text' name='brem3' id="br36" maxlength='40' value='#convertquote(brem3)#' size='20'<cfif lcase(hcomid) eq "accord_i">onblur='JavaScript:changebrem4(this.value);'</cfif> >
            <cfelse>
            <select name="brem3" id="br36">
            <option value="">Please choose</option>
