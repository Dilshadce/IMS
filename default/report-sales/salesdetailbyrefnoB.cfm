...
<cfquery name="getgeneral" datasource="#dts#">
	select lastaccyear,filterall,lCATEGORY,lGROUP,lSIZE,lMATERIAL,lMODEL,lRATING,lAGENT,lDRIVER,lLOCATION,lproject ,lJOB,FILTERITEMREPORT,DDLITEM from gsetup
</cfquery>
