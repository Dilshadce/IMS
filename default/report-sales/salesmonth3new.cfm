...
and aa.van between "#form.userfrom#" and "#form.userto#"
</cfif>
...
<cfif form.period eq "1">
and aa.fperiod between "01" and "06"
<cfelseif form.period eq "2">
and aa.fperiod between "07" and "12"
<cfelseif form.period eq "3">
and aa.fperiod between "13" and "18"
<cfelseif form.period eq "4">
and aa.fperiod between "01" and "18"
<cfelseif form.period eq "5">
and aa.fperiod = "#form.poption#"
<cfelseif form.period eq "6">
