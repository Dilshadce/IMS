...
<cfquery name="getgeneral" datasource="#dts#">
	select lastaccyear,filterall,lCATEGORY,lGROUP,lSIZE,lMATERIAL,lMODEL,lRATING,lAGENT,lDRIVER,lLOCATION,lproject ,lJOB,lbrand,FILTERITEMREPORT,DDLITEM,reportagentfromcust  from gsetup
</cfquery>
