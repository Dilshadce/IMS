...
<cfquery name="getgeneral" datasource="#dts#">
	select lastaccyear,filterall,lCATEGORY,lGROUP,lSIZE,lMATERIAL,lMODEL,lRATING,lAGENT,lDRIVER,lLOCATION,lbrand,FILTERITEMREPORT,DDLITEM from gsetup
</cfquery>
...
<table width="60%" border="0" cellspacing="0" cellpadding="3" class="data" align="center">
    ...
    <tr> 
     ...
     <tr> 
        <th>#getgeneral.lbrand# From</th>
        <td><select name="brandfrom">
				<option value="">Choose an #getgeneral.lbrand#</option>
