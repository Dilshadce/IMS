...
<cfif form.colorfrom neq "" and form.colorto neq "">
and colorid >='#form.colorfrom#' and colorid <='#form.colorto#'
</cfif>
	...
	<cfcase value="EXCELDEFAULT">
		...
		<Worksheet ss:Name="Product_Sales_Report">
  		...
  		<Table ss:ExpandedColumnCount="#20#" x:FullColumns="1" x:FullRows="1">
			...
			<cfelse>
				<Row ss:AutoFitHeight="0" ss:Height="23.0625">
    				<Cell ss:MergeAcross="#c#" ss:StyleID="s34"><Data ss:Type="String">#trantype# PRODUCT SALES REPORT - #msg#</Data></Cell>
   				</Row>
			</cfif>
		...
		<cfoutput>
		  <table width="100%" border="0" cellspacing="0" cellpadding="2">
			<tr>
				...
				<cfelse>
					<td colspan="100%"><div align="center"><font size="3" face="Times New Roman, Times, serif"><strong>#trantype# PRODUCT SALES REPORT - #msg#</strong></font></div></td>
				</cfif>
			</tr>
			<cfif form.periodfrom neq "" and form.periodto neq "">
				<tr>
            ...
            <cfif form.colorfrom neq "" and form.colorto neq "">
				<tr>
					<td colspan="100%"><div align="center"><font size="2" face="Times New Roman, Times, serif">#getgeneral.lmaterial#: #form.colorfrom# - #form.colorto#</font></div></td>
				</tr>
			</cfif>
