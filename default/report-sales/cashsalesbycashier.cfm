...
<html>
<head>
<title>Daily Cash Sales Report</title>
...
<cfoutput> 
  ...
  <h3> <a href="salesmenu.cfm">Sales Report Menu</a> >> <a><font size="2">Print Daily Cash Sales Report</font></a></h3>
  ...
  <form name="saleslist" action="cashsalesbycashier2.cfm?alown=#alown#" method="post" target="_blank">
    <table width="70%" border="0" cellspacing="0" cellpadding="3" class="data" align="center">
      <tr>
        ...
        <th>Report Format</th>
        <td><input type="radio" name="result" value="HTML" checked>
          HTML<br/>
          <input type="radio" name="result" value="EXCELDEFAULT">
          EXCEL DEFAULT 		
          &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
          &nbsp;&nbsp;&nbsp;
          <input type="checkbox" name="include_CN" value="include_CN">Include Credit Note 
          </td>
      </tr>
      <tr>
        <td colspan="4"><hr></td>
      ...
      <tr>
        <th>Date From</th>
        <td><input type="text" name="datefrom" maxlength="10" size="11">
          (DD/MM/YYYY)</td>
      </tr>
      <tr>
        <th>Date To</th>
        <td><input type="text" name="dateto" maxlength="10" size="11">
          (DD/MM/YYYY)</td>
      </tr>
      <tr>
        <td colspan="4"><hr></td>
