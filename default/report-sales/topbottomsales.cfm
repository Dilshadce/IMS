...
<input type="text" name="searchsuppto" onKeyUp="getSupp('custto','Customer');">
    ...
    <tr> 
        <th>#getgeneral.lsize# From</th>
        <td><select name="sizefrom">
				<option value="">Choose an #getgeneral.lsize#</option>
    ...
    <tr> 
        <th>#getgeneral.lsize# To</th>
        <td><select name="sizeto">
				<option value="">Choose an #getgeneral.lsize#</option>
				<cfloop query="getsize">
				<option value="#sizeid#">#sizeid# - #desp#</option>
				</cfloop>
    ...
    <tr> 
        <th>#getgeneral.lmaterial# From</th>
        <td><select name="colorfrom">
				<option value="">Choose an #getgeneral.lmaterial#</option>
    ...
    <tr> 
        <th>#getgeneral.lmaterial# To</th>
        <td><select name="colorto">
				<option value="">Choose an #getgeneral.lmaterial#</option>
				<cfloop query="getcolor">
				<option value="#colorid#">#colorid# - #desp#</option>
				</cfloop>
