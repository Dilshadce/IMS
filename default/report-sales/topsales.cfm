...
<cfquery name="getgeneral" datasource="#dts#">
	select lastaccyear,filterall,lAGENT,agentuserid,lTEAM,reportagentfromcust from gsetup
</cfquery>
<!--- Add On 15-01-2010 --->
...
<table width="65%" border="0" cellspacing="0" cellpadding="3" class="data" align="center">
	...
	<tr>
    <td></td>
		<td nowrap><input type="checkbox" name="include0" id="1" value="yes"> <label for="include0">Include 0 Figure</label>
        <br>
