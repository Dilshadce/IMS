...
<script type="text/javascript">
	...
	function show_info(rset){
		...
		for(i=0;i<itemnoArray.length;i++){
			...
			document.saleslist.itemfrom.options.add(myoption);
		}
	}
	...
	function show_info1(rset){
		...
		for(i=0;i<itemnoArray.length;i++){
			...
			myoption.value = itemnoArray[i];
			document.saleslist.itemto.options.add(myoption);
			}	
	}

	function getItem(){
		
		var text = document.saleslist.letter.value;
		var w = document.saleslist.searchtype.selectedIndex;
		var searchtype = document.saleslist.searchtype.options[w].value;
	...
	function getItem1(){
		...
		var text = document.saleslist.letter1.value;
		var w = document.saleslist.searchtype1.selectedIndex;
		var searchtype = document.saleslist.searchtype1.options[w].value;
