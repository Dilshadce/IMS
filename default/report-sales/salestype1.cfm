...
<cfdirectory action = "create" directory = "#currentDirectory#" >
        ...
        <cfif form.custfrom neq "" and form.custto neq "">
            ...
            <cfwddx action = "cfml2wddx" input = "Customer : #form.custfrom# - #custnamefr.name#" output = "wddxText">
            <cfelse>
            <cfwddx action = "cfml2wddx" input = "Customer : #form.custfrom# #custnamefr.name#- #form.custto# #custnameto.name#" output = "wddxText">
            </cfif>
		...
		<cfif form.periodfrom neq "" and form.periodto neq "">
			<Row ss:AutoFitHeight="0" ss:Height="20.0625">
				<Cell ss:MergeAcross="#c#" ss:StyleID="s35"><Data ss:Type="String"><cfif periodfrom eq periodto>#form.monthfrom#<cfelse>PERIOD: #form.periodfrom# - #form.periodto#</cfif></Data></Cell>
			</Row>
		</cfif>
		<cfif form.datefrom neq "" and form.dateto neq "">
			<Row ss:AutoFitHeight="0" ss:Height="20.0625">
...
<cfdirectory action = "create" directory = "#currentDirectory#" >
        ...
        <cfif form.custfrom neq "" and form.custto neq "">
			...
			<Row ss:AutoFitHeight="0" ss:Height="20.0625">
				<Cell ss:MergeAcross="#c#" ss:StyleID="s35"><Data ss:Type="String"><cfif form.custfrom eq form.custto>Customer : #custnamefr.name#<cfelse>Customer : #custnamefr.name# - #custnameto.name#</cfif></Data></Cell>
			</Row>
			</cfif>
		<cfif form.periodfrom neq "" and form.periodto neq "">
			<Row ss:AutoFitHeight="0" ss:Height="20.0625">
				<Cell ss:MergeAcross="#c#" ss:StyleID="s38"><Data ss:Type="String"><cfif periodfrom eq periodto>#form.monthfrom#<cfelse>PERIOD: #form.periodfrom# - #form.periodto#</cfif></Data></Cell>
			</Row>
		</cfif>
		<cfif form.datefrom neq "" and form.dateto neq "">
			<Row ss:AutoFitHeight="0" ss:Height="20.0625">
