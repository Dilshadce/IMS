...
<cfset nametype = url.type>
    ...
    <td><a onMouseOver="JavaScript:this.style.cursor='hand';" onClick="selectlist('#getproject.xsource#','job#url.fromto#');ColdFusion.Window.hide('findjob');"><u>SELECT</u></a></td>
    </tr>
    </cfloop>
