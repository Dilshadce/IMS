...
<table align="center" width="90%" border="0" cellspacing="0" cellpadding="1">
   ...
   <tr><td colspan="100%"><hr></td></tr>
    ...
    <cfset totalgroupamt = 0>
		...
		<tr onMouseOut="javascript:this.style.backgroundColor='';" onMouseOver="javascript:this.style.backgroundColor='99FF00';">
            ...
            <cfif lcase(hcomid) eq 'gorgeous_i' or lcase(hcomid) eq 'mastercare_i'>
        	<cfelse>
			<td><div align="left"><font size="2" face="Times New Roman, Times, serif">#getinfo.type#</font></div></td>		</cfif>
            ...
            <td><div align="left"><font size="2" face="Times New Roman, Times, serif"><cfif lcase(hcomid) eq 'gorgeous_i' or lcase(hcomid) eq 'mastercare_i'>#getinfo.name#<cfelse>#getinfo.custno# - #getinfo.name#</cfif></font></div></td>
			...
			<td><div align="right"><font size="2" face="Times New Roman, Times, serif"><cfif type eq "RC" and (lcase(hcomid) eq 'gorgeous_i' or lcase(hcomid) eq 'mastercare_i' )>(#numberformat(val(getinfo.amt),stDecl_UPrice)#)<cfelse>#numberformat(val(getinfo.amt),stDecl_UPrice)#</cfif></font></div></td>
   ...
   <tr><td colspan="100%"><hr></td></tr>
	<tr>
        ...
        <cfif lcase(hcomid) eq 'gorgeous_i' or lcase(hcomid) eq 'mastercare_i'>
        <cfelse>
		<td><div align="right"><font size="2" face="Times New Roman, Times, serif"><strong></strong></font></div></td>	</cfif>
		<td><div align="right"><font size="2" face="Times New Roman, Times, serif"><strong></strong></font></div></td>
		<td><div align="right"><font size="2" face="Times New Roman, Times, serif"><strong></strong></font></div></td>
		<td><div align="right"><font size="2" face="Times New Roman, Times, serif"><strong>#numberformat(totalgroupamt,",.__")#</strong></font></div></td>
        <cfif lcase(hcomid) neq "decor_i">
