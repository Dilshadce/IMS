    ...
    <cfquery name="getproject" datasource="#dts#">
   		select source as xsource,project from project where porj='P' and source like <cfqueryparam cfsqltype="cf_sql_varchar" value="%#url.project#%"> and project like <cfqueryparam cfsqltype="cf_sql_varchar" value="%#url.custname#%">  order by source limit 500
	</cfquery>
