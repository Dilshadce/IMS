...
<cfquery name="getlocationopeningqty" datasource="#dts#">
	select a.itemno,a.aitemno,a.desp,a.qtybf,ifnull(b.locationqty,0) as locationqty from icitem as a left join (select sum(grd11<cfloop from="12" to="310" index="i">+grd#i#</cfloop>) as locationqty ,itemno from itemgrd group by itemno)as b on a.itemno=b.itemno
    where a.graded='Y'
</cfquery>
...
<table align="center" border="0" width="100%">
	<tr>
		<td colspan="8"><div align="center"><font size="3" face="Times New Roman,Times,serif"><strong>Grade Opening Quantity</strong></font></div></td>
	</tr>
	<cfoutput>
	...
	<tr>
		...
		<td><div align="right"><font size="2" face="Times New Roman,Times,serif">GRADE OPENING</font></div></td>
    </tr>
	<tr>
      	<td colspan="8"><hr></td>
    </tr>
