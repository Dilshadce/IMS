...
<cfswitch expression="#url.type#">
	...
	<cfcase value="gradedcheckstock">
		<cfset trantype = "Location - Graded Item Stock Card Report">
		<form name="form" action="gradedstockcheck2.cfm" method="post" target="_blank">
	</cfcase>
</cfswitch>
...
<table width="65%" border="0" cellspacing="0" cellpadding="3" class="data" align="center">
	<cfif url.type neq "stockcard" and url.type neq "locitemstockcard" and url.type neq "gradedcheckstock">
		<tr>
	...
	<cfif url.type eq "sales" or url.type eq "stockcard" or url.type eq "itemlocsales" or url.type eq "locitemsales" or url.type eq "locitemstockcard" or url.type eq "gradedcheckstock">
		<tr>
      		<td colspan="100%"><hr></td>
   	 	</tr>
		<tr>
	...
	<cfif url.type eq "status" or url.type eq "itemlocstatus" or url.type eq "locitemstatus">
		...
		<tr>
			<th>Date</th>
      		<td colspan="2">
				<input name="date" type="text" value="" size="11" onKeyUp="DateFormat(this,this.value,event,false,'3');" onBlur="DateFormat(this,this.value,event,true,'3');"> (DD/MM/YYYY)
			</td>
		</tr>
	</cfif>
	<tr>
