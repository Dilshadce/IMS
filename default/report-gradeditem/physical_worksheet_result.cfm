...
<body>
<table align="center" width="700px" border="0" cellspacing="0">
	<tr>
		<td colspan="100%">
			<div align="center"><font size="3" face="Times New Roman, Times, serif"><strong>GRADED ITEM PHYSICAL WORKSHEET</strong></font></div>
		</td>
	</tr>
	<cfoutput>
	<cfif trim(form.catefrom) neq "" and trim(form.cateto) neq "">
	...
	<cfoutput query="getiteminfo">
		<cfif thisgroup neq getiteminfo.wos_group>
			...
			<tr>
				<td height="21"><div align="left"><font size="2" face="Times New Roman,Times,serif"><strong>GROUP: #getiteminfo.wos_group#</strong></font></div></td>
				<td><div align="left"><font size="2" face="Times New Roman,Times,serif"><strong>#getiteminfo.groupdesp#</strong></font></div></td>
			</tr>
		</cfif>
		<tr>
