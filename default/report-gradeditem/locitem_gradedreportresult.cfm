...
<html>
<head>
<title>Location - Graded Item Report</title>
...
<cfif url.type eq "locitemstatus">
	<cfif form.date neq "">
...
<cfswitch expression="#url.type#">
	<cfcase value="locitemopening">
		<cfset title = "LOCATION - GRADED ITEM OPENING">
	...
	<cfcase value="locitemsales">
		<cfset title = "LOCATION - GRADED ITEM SALES">
		<cfquery name="getiteminfo" datasource="#dts#">
			select 
			<cfloop from="#startgrade+10#" to="#tograde#" index="i">
	...
	<cfcase value="locitemstatus">
		<cfset title = "LOCATION - GRADED ITEM STATUS">
		<cfquery name="getiteminfo" datasource="#dts#">
			select 
			<cfloop from="#startgrade+10#" to="#tograde#" index="i">
...
<table width="80%" border="0" align="center" cellspacing="0">
	...
	<cfset thislocation2 = initializelocation>
	<cfset subtotalArray = "">
	<cfoutput query="getiteminfo">
		<cfif thislocation2 neq getiteminfo.wos_group&getiteminfo.location>
			<cfif thislocation2 neq initializelocation>
			...
			<cfset thislocation2 = getiteminfo.wos_group&getiteminfo.location>
		</cfif>
		...
		<!--- IF THE LOCATION CHANGED, 1.OUTPUT THE NEW LOCATION & LOCATION DESP 2.INITIALIZE THE SUBTOTAL ARRAY FOR THE LOCATION --->
		<cfif thislocation neq getiteminfo.wos_group&getiteminfo.location>	
			<cfset thislocation = getiteminfo.wos_group&getiteminfo.location>
			...
			<tr>
				<td height="24" colspan="100%"><div align="left"><font size="2" face="Times New Roman,Times,serif"><strong>LOCATION: #getiteminfo.location# - #getiteminfo.locdesp#</strong></font></div></td>
			</tr>
		<cfelse>	<!--- IF IT'S THE SAME LOCATION, 1.SET THE CURRENT ROW QTY FIGURE IN ARRAY  2.THEN ADD UP TO THE SUBTOTAL ARRAY --->
			<cfloop from="1" to="#totalgrade#" index="x">
