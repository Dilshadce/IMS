<html>
<head>
<title>Location - Graded Item Stock Card Details</title>
...
<cfquery name="getiteminfo" datasource="#dts#">
	select a.type,a.refno,a.wos_date,a.itemno,a.grd#url.gradenum# as qty,b.importpermit,b.batchcode,b.price,b.toinv,
...
<table width="80%" border="0" align="center" cellspacing="0">
	...
	<tr><td height="10"></td></tr>
	<tr>
        <td colspan="100%"><font size="2" face="Times New Roman, Times, serif"><b>LOCATION: #url.location#&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;#url.locationdesp#</b></font></td>
    </tr>
	...
	<cfoutput query="getiteminfo">
		<tr onMouseOut="javascript:this.style.backgroundColor='';" onMouseOver="javascript:this.style.backgroundColor='99FF00';">
            ...
            <td><font size="2" face="Times New Roman, Times, serif">#getpermitno.permit_no2#</font></td>
