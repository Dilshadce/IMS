...
<cfloop from="1" to="#form.totalrecord#" index="i">
	<cfquery name="updateitemgrd" datasource="#dts#">
		...
		and location = <cfqueryparam cfsqltype="cf_sql_char" value="#form["location_#i#"]#">
	</cfquery>
</cfloop>
			...
			<cfif val(form["balance_#i#_#j#"]) lt val(form["qtyactual_#i#_#j#"])>
				...
				<cfelse>
					<cfquery name="insert_oai_into_ictran" datasource="#dts#">
						...
						qty,price,name,factor1,factor2,location) 
						values 
						...
						#oaiqty#,'#oaicost#',#oaiqty#,'#oaicost#','ADJUSTMENT','1','1',<cfqueryparam cfsqltype="cf_sql_char" value="#form["location_#i#"]#">)	
					</cfquery>
					
					<cfquery name="insertigrade" datasource="#dts#">
						insert into igrade
						(type,refno,trancode,fperiod,wos_date,itemno,sign,factor1,factor2,GRD#j#,location)
						values
						('OAI','#nexttranno1#',#a#,'#form.period#',#form.date#,<cfqueryparam cfsqltype="cf_sql_char" value="#form["itemno_#i#"]#">,
						'1','1','1',#oaiqty#,<cfqueryparam cfsqltype="cf_sql_char" value="#form["location_#i#"]#">)
					</cfquery>
					<cfset a = a + 1>
				</cfif>
			...
			<cfelseif val(form["balance_#i#_#j#"]) gt val(form["qtyactual_#i#_#j#"])>
				...
				<cfelse>
					<cfquery name="insert_oar_into_ictran" datasource="#dts#">
						...
						<cfqueryparam cfsqltype="cf_sql_varchar" value="#form["itemdesp_#i#"]#">,'#form["unit_#i#"]#','#form["unit_#i#"]#',
						#oarqty#,'#oarcost#',#oarqty#,'#oarcost#','ADJUSTMENT','1','1',<cfqueryparam cfsqltype="cf_sql_char" value="#form["location_#i#"]#">)	
					</cfquery>
					...
					<cfquery name="insertigrade" datasource="#dts#">
						...
						'-1','1','1',#oarqty#,<cfqueryparam cfsqltype="cf_sql_char" value="#form["location_#i#"]#">)
					</cfquery>
					<cfset b = b + 1>
				</cfif>
