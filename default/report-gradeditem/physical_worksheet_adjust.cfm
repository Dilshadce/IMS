...
<cfquery name="getiteminfo" datasource="#dts#">
	...
	left join
	(
		select x.itemno,x.desp as itemdesp,x.wos_group,x.category,x.graded,x.shelf,x.ucost,x.unit
		<cfloop from="#frgrade#" to="#tograde#" index="i">
			,y.gradd#i#
		</cfloop>
...
<body>
<h1 align="center">GRADED ITEM PHYSICAL WORKSHEET</h1>
...
<table border="0" align="center" width="65%" class="data">
	...
	<cfform name="form" action="physical_worksheet_adjust_process.cfm" method="post">	
	<cfoutput>
			...
			<cfif isdefined("form.include_stock")>
				<cfif getiteminfo["gradd#i#"][getiteminfo.currentrow] neq "">
					<tr>
						...
						<td><div align="center">
							<cfinput type="text" id="qtyactual_#getiteminfo.currentrow#_#i#" name="qtyactual_#getiteminfo.currentrow#_#i#" value="#getiteminfo["qtyactual#i#"][getiteminfo.currentrow]#" size="10" message="Please Enter A Correct Quantity !" required="no" validate="float" onKeyUp="javascript:document.form.adjqty_#getiteminfo.currentrow#_#i#.value=calculate_adjusted_qty(document.form.balance_#getiteminfo.currentrow#_#i#.value,document.form.qtyactual_#getiteminfo.currentrow#_#i#.value);">
						</div></td>
	...
	<tr>
		<td colspan="7">
			<input type="checkbox" name="generate_adjustment_transaction" id="4" value="yes"> GENERATE ADJUSTMENT TRANSACTIONS &nbsp;
