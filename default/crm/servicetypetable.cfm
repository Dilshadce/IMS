<html>
<head>
<title>Service Type Maintenance</title>
...
<h1>View Service Type Informations</h1>
...
<cfif getPersonnel.recordcount neq 0>
	...
	<cfform action="servicetypetable.cfm" method="post">
		...
		<cfif start neq 1>
			<cfoutput>|| <a href="servicetypetable.cfm?start=#prevFive#">Previous</a> ||</cfoutput>
		</cfif>
		
		<cfif page neq noOfPage>
			<cfoutput> <a href="servicetypetable.cfm?start=#evaluate(nextFive)#">Next</a> ||</cfoutput>
		</cfif>
		...
		<cfoutput query="getPersonnel" startrow="#start#" maxrows="5">
			<cfset strNo = "getPersonnel.servicetypeid">
			
			<table align="center" class="data" width="450px">
        		<tr> 
          			<th width="20%">Process Code</th>
          			<td>#getPersonnel.servicetypeid#</td>
        		</tr>
        		<tr> 
          			<th>Description</th>
        		...
        		<tr> 
          			<td colspan="2"><div align="right"><a href="servicetypetable2.cfm?type=Delete&servicetypeid=#evaluate(strNo)#">
					<img height="18px" width="18px" src="/images/delete.ICO" alt="Delete" border="0">Delete</a> 
					<a href="servicetypetable2.cfm?type=Edit&servicetypeid=#evaluate(strNo)#">
