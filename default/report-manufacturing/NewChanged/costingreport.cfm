...
<cfquery name="getgroup" datasource="#dts#">
	...
	<cfquery datasource="#dts#" name="getbill">
		select refno from artran where type = 'RC' and fperiod <> '99'order by refno
	</cfquery>

<cfquery datasource="#dts#" name="getagent">
	select agent,desp from #target_icagent#
    where 0=0
    <cfif alown eq 1>
...
<body>
<cfform action="costingreport1.cfm?type=#trantype#&trancode=#trancode#&alown=#alown#" method="post" name="form123" target="_blank">

<!--- <h2>Print <cfoutput>#trantype#</cfoutput> Listing Report</h2> --->
<h3>
	<a href="manufacturingmenu.cfm">Manufacturing Menu</a> >> 
	<a><font size="2">Print Assemble Costing Report</font></a>
</h3>
...
<table border="0" align="center" width="80%" class="data">
	...
	<cfoutput><input type="hidden" name="tran" id="tran" value="#target_apvend#" /><input type="hidden" name="fromto" id="fromto" value="" /></cfoutput>
...
<cfoutput><input type="text" name="searchsuppfr" onKeyUp="getSupp('getfrom','#title#');"></cfoutput>
			</cfif>
		</td>
    </tr>
    <tr>
...
<cfoutput><input type="text" name="searchsuppto" onKeyUp="getSupp('getto','#title#');"></cfoutput>
			</cfif>
		</td>
    </tr>
    <tr>
