...
<cfquery name="getgroup" datasource="#dts#">
	...
	<cfquery datasource="#dts#" name="getbill">
		select refno from artran where type = 'RC' and custno ='ASSM/999' and fperiod <> '99' order by refno
	</cfquery>
...
<body>
<cfform action="assemblesummaryreport1.cfm" method="post" name="form123" target="_blank">

<!--- <h2>Print <cfoutput>#trantype#</cfoutput> Listing Report</h2> --->
<h3>
	<a href="manufacturingmenu.cfm">Manufacturing Menu</a> >> 
	<a><font size="2">Print Assemble Summary Report</font></a>
</h3>
