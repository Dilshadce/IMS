...
<body>
<h3> <a href="servicereportmenu.cfm"><cfoutput>Service</cfoutput> Report</a> >> <a><font size="2"><cfoutput>Customer - Service Report</cfoutput></font></a> </h3>
<cfset trantype = getgeneral.lPROJECT&" Transaction Listing Report">
<cfform name="form" action="servicereportresult2.cfm?type=#url.type#" method="post" target="_blank">
  <table width="65%" border="0" cellspacing="0" cellpadding="3" class="data" align="center">
    ...
    <tr>
      ...
      <td width="75%"><select name="customerfrom">
        ...
        <cfif getgeneral.filterall eq "1">
          ...
          &nbsp;
          <input type="text" name="searchcustomerfr" onKeyUp="getcust('customerfrom');">
        </cfif></td>
    </tr>
    <tr>
      <th>Customer To</th>
      <td><select name="customerto">
        ...
        <cfif getgeneral.filterall eq "1">
          ...
          &nbsp;
          <input type="text" name="searchCustomerto" onKeyUp="getCust('Customerto');">
        </cfif></td>
    </tr>
    <tr>
      <td colspan="100%"><hr></td>
    ...
    <tr>
      <th width="25%">Agent From</th>
      <td width="75%"><select name="Agentfrom">
          <option value="">Choose a Agent</option>
          <cfoutput query="getAgent">
            <option value="#convertquote(Agent)#">#Agent# - #desp#</option>
          </cfoutput>
        </select>
        <cfif getgeneral.filterall eq "1">
    ...
    <tr>
      <th>Date From</th>
      <td><input name="datefrom" type="text" value="" size="11" validate="eurodate" message="Wrong Date format!">
        (DD/MM/YYYY) </td>
    </tr>
    <tr>
      <th>Date To</th>
      <td><input name="dateto" type="text" value="" size="11" validate="eurodate" message="Wrong Date format!">
        (DD/MM/YYYY) </td>
    </tr>
    <tr>
      <td colspan="100%"><hr></td>
