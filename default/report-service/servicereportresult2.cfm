...
<cfparam name="i" default="1" type="numeric">
		...
		<html>
		<head>
		<title>Customer - ServiceReport </title>
		...
		<table width="100%" border="0" cellspacing="0" cellpadding="2">
            ...
            <tr>
				<td colspan="9"><div align="center"><font size="3" face="Times New Roman, Times, serif"><strong> Customer - Service Report </strong></font></div></td>
			</tr>
            ...
            <cfif form.customerfrom neq "" and form.customerto neq "">
				<tr>
					<td colspan="9"><div align="center"><font size="2" face="Times New Roman, Times, serif">project  #form.customerfrom# - #form.customerto#</font></div></td>
				</tr>
			</cfif>
...
<td align="center" width="9%"><strong><font size="2" face="Arial, Helvetica, sans-serif"><cfoutput>CS</cfoutput></font></strong></td>
      ...
      <tr>
				...
				select a.itemno as itemno, b.desp as desp,a.custno as custno,a.name as name from ictran a, icservi b
				where (a.type = 'INV' or a.type = 'DN' or a.type = 'CN' or a.type = 'CS') and b.servi = a.itemno and (a.void = '' or a.void is null)
				...
				and a.itemno >='#form.servicefrom#' and a.itemno <= '#form.serviceto#'
				</cfif>
				<cfif form.periodfrom neq "" and form.periodto neq "">
				...
				<tr>
					<td width="20%"><div align="left" ><font size="2" face="Times New Roman, Times, serif"><strong><u>#getcustomer.currentrow#.CUSTOMER NO: #getcustomer.custno#</u></strong></font></div></td>
     ...
     <cfquery name="getdata" datasource="#dts#">
					...
					and custno = '#getcustomer.custno#' and linecode = 'SV' and (void = '' or void is null)
					<cfif form.agentfrom neq "" and form.agentto neq "">
...
<cfxml variable="data">
        ...
        <cfoutput>
            <Row ss:AutoFitHeight="0" ss:Height="23.0625">
				<Cell ss:MergeAcross="#c#" ss:StyleID="s22"><Data ss:Type="String">Customer - Service Report</Data></Cell>
			</Row>
            ...
            <cfif form.customerfrom neq "" and form.customerto neq "">
				<Row ss:AutoFitHeight="0" ss:Height="20.0625">
     				<cfwddx action = "cfml2wddx" input = "#form.customerfrom# - #form.customerto#" output = "wddxText">
	...
	<Row ss:AutoFitHeight="0" ss:Height="20.0625">
			...
			<cfwddx action = "cfml2wddx" input = "#numberformat(subtotal,stDecl_UPrice)#" output = "wddxText18">
	...
	<Row ss:AutoFitHeight="0" ss:Height="20.0625">
			<cfwddx action = "cfml2wddx" input = "#numberformat(totalinv,",.__")#" output = "wddxText12">
			<cfwddx action = "cfml2wddx" input = "#numberformat(totaldn,",.__")#" output = "wddxText13">
			<cfwddx action = "cfml2wddx" input = "#numberformat(totalcs,",.__")#" output = "wddxText14">
			<cfwddx action = "cfml2wddx" input = "#numberformat(total,",.__")#" output = "wddxText15">
			<cfwddx action = "cfml2wddx" input = "#numberformat(totalcn,",.__")#" output = "wddxText16">
			<cfwddx action = "cfml2wddx" input = "#numberformat(total,",.__")#" output = "wddxText17">
                <Cell ss:StyleID="s90"><Data ss:Type="String"></Data></Cell>
				<Cell ss:StyleID="s90"><Data ss:Type="String">TOTAL:</Data></Cell>
                <Cell ss:StyleID="s90"><Data ss:Type="String"></Data></Cell>
				<Cell ss:StyleID="s90"><Data ss:Type="String">#wddxText12#</Data></Cell>
