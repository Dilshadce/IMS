...
<body>
<h3> <a href="servicereportmenu.cfm"><cfoutput>Service</cfoutput> Report</a> >> <a><font size="2"><cfoutput>Service Income Report</cfoutput></font></a> </h3>
<cfset trantype = getgeneral.lPROJECT&" Transaction Listing Report">
<cfform name="form" action="servicereportresult1.cfm?type=#url.type#" method="post" target="_blank">
