...
<cfset iDecl_UPrice = getgsetup2.Decl_UPrice>
 ...
 <cfoutput>
          ...
          <Row ss:AutoFitHeight="0" ss:Height="20.0625">
							<Cell ss:MergeAcross="#c#" ss:StyleID="s22"><Data ss:Type="String">Print Service Profit Margin - Transactions Report</Data></Cell>
		</Row>
...
<Row ss:AutoFitHeight="0" ss:Height="20.0625">
			<cfwddx action = "cfml2wddx" input = "#gettran.type#" output = "wddxText3">
			<cfwddx action = "cfml2wddx" input = "#gettran.refno#" output = "wddxText4">
...
<Row ss:AutoFitHeight="0" ss:Height="20.0625">
			...
			<cfwddx action = "cfml2wddx" input = "#NumberFormat(0,"0.00")#" output = "wddxText14">
				...
				<Cell ss:StyleID="s90"><Data ss:Type="String">#wddxText11#</Data></Cell>
				...
				<Cell ss:StyleID="s90"><Data ss:Type="String">#NumberFormat(totalprofit / totalsales * 100,"0.00")#</Data></Cell>
				<cfelse>
