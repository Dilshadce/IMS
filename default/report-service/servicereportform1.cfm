...
<cfoutput>
		...
		<form name="form" action="servicereportresult1.cfm?type=#url.type#" method="post" target="_blank">
	
</cfoutput>
<body>
<h3>
	<a href="servicereportmenu.cfm"><cfoutput>Service</cfoutput> Report</a> >> 
	<a><font size="2"><cfoutput>Service Income Report</cfoutput></font></a>
</h3>
<table width="65%" border="0" cellspacing="0" cellpadding="3" class="data" align="center">
	...
	<tr>
      	<th width="25%">Project From</th>
      	<td width="75%">
			<select name="projectfrom">
          		<option value="">Choose a project</option>
          		<cfoutput query="getproject">
            		<option value="#convertquote(project)#">#source# - #project#</option>
          		</cfoutput>
			</select>
			<cfif getgeneral.filterall eq "1">
				<input type="text" name="searchprojectfr" onKeyUp="getproject('projectfrom');">
			</cfif>		</td>
    </tr>
    <tr>
      	<th>Project To</th>
      	<td>
			...
			<cfif getgeneral.filterall eq "1">
				<input type="text" name="searchprojectto" onKeyUp="getproject('projectto');">
			</cfif>		</td>
    </tr>
	<tr>
      	<td colspan="100%"><hr></td>
