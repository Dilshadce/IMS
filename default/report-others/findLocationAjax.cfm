...
<cfquery name="getLocation" datasource="#dts#">
    ...
    <table width="480px">
        ...
        <tr>
            ...
            <td><a onMouseOver="JavaScript:this.style.cursor='hand';" onClick="document.getElementById('loc#url.fromto#').value='#getLocation.location#';ColdFusion.Window.hide('findLocation');" >SELECT</a></td>
        </tr>
        </cfloop>
