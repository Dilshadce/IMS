...
<table border="0" align="center" class="data">
  <tr>
	...
	<cfquery datasource="#dts#" name="getperiod1">
		select sum(price) as sumperiod1 from ictran where custno = "#url.custno#" and wos_group = "#url.wos_group#" and currrate like "1.0%" and type = "INV"
		and fperiod >= 0 and fperiod <= 3 group by itemno
	</cfquery>
	<cfquery datasource="#dts#" name="getperiod2">
		select sum(price) as sumperiod2 from ictran where custno = "#url.custno#" and wos_group = "#url.wos_group#" and currrate like "1.0%" and type = "INV"
		and fperiod >= 3 and fperiod <= 6 group by itemno
	</cfquery>
	<cfquery datasource="#dts#" name="getperiod3">
		select sum(price) as sumperiod3 from ictran where custno = "#url.custno#" and wos_group = "#url.wos_group#" and currrate like "1.0%" and type = "INV"
		and fperiod >= 7 and fperiod <= 9 group by itemno
	</cfquery>
	<cfquery datasource="#dts#" name="getperiod4">
		select sum(price) as sumperiod4 from ictran where custno = "#url.custno#" and wos_group = "#url.wos_group#" and currrate like "1.0%" and type = "INV"
		and fperiod >= 10 and fperiod <= 12 group by itemno
	</cfquery>
	<cfquery datasource="#dts#" name="getinv1">
		select sum(price) as sumprice from ictran where custno = "#url.custno#" and wos_group = "#url.wos_group#" and currrate like "1.0%" and type = "INV" group by itemno
	</cfquery>
	<cfoutput>
    <tr>
