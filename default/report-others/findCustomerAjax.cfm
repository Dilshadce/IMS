...
<cfset ptype = url.type >
    ...
    <td><a onMouseOver="JavaScript:this.style.cursor='hand';" onClick="document.getElementById('#nametype##url.fromto#').value='#getcustsupp.xcustno#';ColdFusion.Window.hide('findCustomer');" >SELECT</a></td>
    <cfelseif url.displaytype eq 'name2'>
    <td>#getcustsupp.name#</td>
