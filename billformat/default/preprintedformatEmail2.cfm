...
<cfquery name="customerSupplierEmail" datasource="#dts#">
	SELECT a.custno, b.e_mail
    FROM artran AS a
...
<cfset clientList = customerSupplierEmail.e_mail>
<cfset userList = userEmail.userEmail>

<cfif clientList EQ ''>
	<script>
		alert('No customer/supplier email found!')
		window.history.back();
	</script>
	<cfabort>	
</cfif>
<cfmail from="noreply@mynetiquette.com" to="#clientList#" cc="#userList#" subject="#getheaderinfo.refno#"> 
	<cfmailparam file = "\billformat\default\#filename1#" > 
</cfmail> 
</cfoutput>
