...
<cfoutput>
	<cfif isDefined("isMobile") AND isMobile EQ TRUE>
    	<cfset thisPath = "/#billformat#/#dts#/companyLogo.jpg">
        <cfset thisDirectory = GetDirectoryFromPath(thisPath)>
...
<cfoutput>
    <cfreport template="#fname#" format="pdf" query="MyQuery" filename="temp/#newfname#" overwrite="yes">
