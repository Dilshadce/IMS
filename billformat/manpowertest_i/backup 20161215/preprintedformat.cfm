   ...
   <cfelse>
	...
	<cfquery name="InsertICBil_M" datasource="#dts#">
		INSERT INTO r_icbil_m ( B_Name, B_Name2, B_Add1, B_Add2, B_Add3, B_Add4, B_Country, B_PostalCode, B_Attn, B_Tel, B_HP, B_Fax, B_Email, B_GSTno,
								...
								GSTcode, GSTtaxPercentage, GSTamt, GSTtaxAmt,dept)
		VALUES (
                    ...
                    <cfqueryparam cfsqltype="cf_sql_varchar" value="#getCustSuppGSTinfo.dept1#">
				)
	</cfquery>
	
    <!---<cfif right(UCASE(UCASE(report.toword(val(getHeaderInfo.grand)))),4) neq "ONLY">
		<cfset totaltemp = "#UCASE(UCASE(report.toword(val(getHeaderInfo.grand))))#"&"ONLY">
    <cfelse>
    	<cfset total = "#UCASE(UCASE(report.toword(val(getHeaderInfo.grand))))#">
    </cfif>--->
	...
	<cfelseif getinvoicetype.invoicegrouping eq "4" or getinvoicetype.invoicegrouping eq "6" or getinvoicetype.invoicegrouping eq "11">
	<cfquery name="getBodyInfo" datasource="#dts#">
...
<cfquery name="getplacement" datasource="#dts#">
	SELECT location,po_no,jobpostype FROM placement
