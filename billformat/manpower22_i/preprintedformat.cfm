...
<cfloop query="getHeaderInfo">
	...
	<cfif  getDeliveryAdd.GSTno EQ ''>
		<cfquery name="getCustSuppGSTinfo" datasource="#dts#">
			SELECT vatno as gstno,arrem6,dept1,business,arrem1
			FROM #ptype#
			WHERE custno = "#getheaderinfo.custno#";
		</cfquery>    
...
<cfquery name="getaddress" datasource="#dts#">
	...
	<cfelse>
		<cfif left(getHeaderInfo.refno,1) eq '5' or (not isNumeric(left(getHeaderInfo.refno,1)) and mid(getHeaderInfo.refno,3,1) eq '5')>
			1
		<cfelseif left(getHeaderInfo.refno,1) eq '6' or (not isNumeric(left(getHeaderInfo.refno,1)) and mid(getHeaderInfo.refno,3,1) eq '6')>
			7
		<cfelseif left(getHeaderInfo.refno,1) eq '2' or (not isNumeric(left(getHeaderInfo.refno,1)) and mid(getHeaderInfo.refno,3,1) eq '2')>
			5
		<cfelse>
			3
		</cfif>
...
<cfoutput>
            ...
            <cfelse>
                ...
                <cfelseif getHeaderInfo.type eq 'cn' or getHeaderInfo.type eq 'dn'>
                    ...
                    <cfif getrefno2period.recordcount neq 0>
                        <cfif year(getrefno2period.wos_date) eq 2018>
                            <cfif month(getrefno2period.wos_date) gte 9>
                                <cfset sstformat = "sst">
                            </cfif>
                        <cfelseif year(getrefno2period.wos_date) gt 2018>
                            <cfset sstformat = "sst">
                        </cfif>
                    <cfelse>
                        <cfif year(getHeaderInfo.wos_date) eq 2018>
                            <cfif month(getHeaderInfo.wos_date) gte 9>
                                <cfset sstformat = "sst">
                            </cfif>
                        <cfelseif year(getHeaderInfo.wos_date) gt 2018>
                            <cfset sstformat = "sst">
                        </cfif>
                    </cfif>
                <cfelse>
	...
	<cfquery name="InsertICBil_M" datasource="#dts#">
		...
		VALUES (
                    ...
                    <cfqueryparam cfsqltype="cf_sql_varchar" value="#getaddress.name2#">,
    ...
    <cfelseif getHeaderInfo.custno eq "300033162" and getHeaderInfo.type eq "INV">
...
<cfset getGsetup.compro2=getaddress.name2>
<cfset getGsetup.compro3=getaddress.add1>
<cfset getGsetup.compro4=getaddress.add2>
<cfset getGsetup.compro5=getaddress.add3>
<cfset getGsetup.compro6=getaddress.add4>
<cfset getGsetup.compro7=getaddress.add5>
