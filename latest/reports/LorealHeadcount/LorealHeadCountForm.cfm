...
<cfset consignment=''>
	<cfset pageTitle = "Headcount Report">
...
<cfoutput>
	<cfform class="formContainer form3Button" name="LorealHeadCountReport" id="LorealHeadCountReport" action="LorealHeadCountReport.cfm" method="post" target="_blank">
        <div>#pageTitle#</div>
        <div>
        <table>
