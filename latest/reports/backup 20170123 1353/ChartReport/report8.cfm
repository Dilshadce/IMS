...
<title>Chart Report - By Item Profit Margin Chart</title>
</head>
...
<cfoutput>
  <form name="chartform" id="chartform" action="report8.cfm?alown=#url.alown#" method="post">
  	<input type="hidden" id="itemfrom" name="itemfrom" value="#form.productfrom#">
	<input type="hidden" id="itemto" name="itemto" value="#form.productto#">
...
select itemno,sum(qty) as sumqty, sum(amt) as sumSales,sum(it_cos) as sumCost,sum(amt)- sum(it_cos) as sumProfit 
from ictran
...
<h1>By Item Profit Margin Chart</h1>
<cfchart backgroundcolor="eff8ff" fontsize="12" xAxisTitle="Item" yAxisTitle="Sales / Cost / Profit" title="" showborder="no" show3d="no" chartheight="500" chartwidth="1500">
<cfchartseries type="#charttype#" query="getagentdata" valueColumn="sumSales" itemColumn="itemno" colorlist="34ABEF"/>
<cfchartseries type="#charttype#" query="getagentdata" valueColumn="sumCost" itemColumn="itemno" colorlist="97150A"/>
<cfchartseries type="#charttype#" query="getagentdata" valueColumn="sumProfit" itemColumn="itemno" colorlist="43C94E"/>
</cfchart>
</body>
</html>