...
<cfset words_id_list = "1460,123,495,496,146,497,498,1302,1417,1418,104,1354,1355,122,1373,1374,703,1361,688,1406,1462,1463,501,1399">
...
<cfoutput>
	<cfform class="formContainer form3Button" name="dailyStockCardForm" id="dailyStockCardForm" action="dailystockcard2.cfm" method="post" target="_blank">
		<div>#pageTitle#</div>
        <div>
            <table> 
