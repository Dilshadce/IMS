...
<cfif IsDefined('form.periodfrom')>
	<cfset startperiod = val(form.periodfrom) + 10>
    <cfset calperiod = (val(form.periodfrom)-6) + 10>
<cfelse>
  ...
  <Table x:FullColumns="1" x:FullRows="1" ss:DefaultColumnWidth="54" ss:DefaultRowHeight="11.25">
   ...
   <Column ss:AutoFitWidth="0" ss:Width="63.75" ss:Span="8"/>
	...
	<Row ss:AutoFitHeight="0" ss:Height="23.0625">
   	...
   	<cfif trim(form.categoryfrom) neq "" and trim(form.categoryto) neq "">
	<cfwddx action = "cfml2wddx" input = "CATE: #form.categoryfrom# - #form.categoryto#" output = "wddxText">
	<Row ss:AutoFitHeight="0" ss:Height="23.0625">
	...
	<cfwddx action = "cfml2wddx" input = "SUPP.NO.: #form.supplierfrom# - #form.supplierto#" output = "wddxText">
	<Row ss:AutoFitHeight="0" ss:Height="23.0625">
    	<Cell ss:MergeAcross="10" ss:StyleID="s22"><Data ss:Type="String">#wddxText#</Data></Cell>
   	</Row>
	</cfif>
	<cfif form.periodfrom neq "">
	<cfwddx action = "cfml2wddx" input = "PERIOD TO: #form.periodfrom#" output = "wddxText">
	<Row ss:AutoFitHeight="0" ss:Height="23.0625">
    	<Cell ss:MergeAcross="10" ss:StyleID="s22"><Data ss:Type="String">#wddxText#</Data></Cell>
   	</Row>
	</cfif>
	...
	<cfloop query="getgroup">
        ...
        <cfquery name="create" datasource="#dts#">
				...
				(
					...
					where type in ('RC','CN','OAI','TRIN') and (void = '' or void is null)
					<cfif form.periodfrom neq "">
					and fperiod+0 between '1' and '#form.periodfrom#'
					</cfif> 
					group by itemno
		...
		<cfset periodextra = (maxcounter + 1) - form.periodfrom>
   ...
   <WorksheetOptions xmlns="urn:schemas-microsoft-com:office:excel">
    ...
    <cfheader name="Content-Disposition" value="inline; filename=#dts#_IL_SA_#huserid#.xls">
...
<cfif getgeneral.cost neq "FIFO" and getgeneral.cost neq "LIFO">
	<table width="100%" border="0" align="center" cellspacing="0">
		...
		<cfif trim(form.categoryfrom) neq "" and trim(form.categoryto) neq "">
			<tr>
				<td colspan="100%"><div align="center"><font size="2" face="Times New Roman, Times, serif">CATE: #form.categoryfrom# - #form.categoryto#</font></div></td>
			</tr>
		</cfif>
		<cfif trim(form.groupfrom) neq "" and trim(form.groupto) neq "">
			<tr>
		...
		<cfif trim(form.supplierfrom) neq "" and trim(form.supplierto) neq "">
			<tr>
				<td colspan="100%"><div align="center"><font size="2" face="Times New Roman, Times, serif">SUPP.NO.: #form.supplierfrom# - #form.supplierto#</font></div></td>
			</tr>
		</cfif>
		<cfif form.periodfrom neq "">
			<tr>
				<td colspan="100%"><div align="center"><font size="2" face="Times New Roman, Times, serif">PERIOD TO: #form.periodfrom#</font></div></td>
			</tr>
		</cfif>
		<tr>
		...
		<cfset periodextra = (val(maxcounter) + 1) - val(form.periodfrom)>
...
<cfelseif getgeneral.cost eq "FIFO">
	<table width="100%" border="0" align="center" cellspacing="0">
		...
		<cfloop query="getgroup">
			...
			<!--- <cfset periodextra = (maxcounter+1) - form.periodfrom> --->
			<cfset periodextra = (maxcounter) - form.periodfrom>
			...
			<cfloop query="getitem">
				...
				<tr onMouseOut="javascript:this.style.backgroundColor='';" onMouseOver="javascript:this.style.backgroundColor='99FF00';">
					...
					<cfif maxcounter eq "12">
                        ...
                        <cfinvoke component="CFC.fifoValue" method="fifovalue" dts = "#dts#" period="-12" itemno="#getitem.itemno#" itemqty="#thisbal12#" monthp="#form.periodfrom#" returnvariable="myResult" >
                        #numberformat(myResult,'.__')#</font></div>
                        </td></cfif>
						<td width="5%"><div align="right"><font size="2" face="Times New Roman, Times, serif">#thisbal11#</font></div></td>
                        <cfif lcase(hcomid) eq "mhca_i"><td width="5%"><div align="right"><font size="2" face="Times New Roman, Times, serif">
                        <cfinvoke component="CFC.fifoValue" method="fifovalue" dts = "#dts#" period="-11" itemno="#getitem.itemno#" itemqty="#thisbal11#" monthp="#form.periodfrom#" returnvariable="myResult" >
                        #numberformat(myResult,'.__')#</font></div>
                        </td></cfif>
						<td width="5%"><div align="right"><font size="2" face="Times New Roman, Times, serif">#thisbal10#</font></div></td>
                        <cfif lcase(hcomid) eq "mhca_i"><td width="5%"><div align="right"><font size="2" face="Times New Roman, Times, serif">
                        <cfinvoke component="CFC.fifoValue" method="fifovalue" dts = "#dts#" period="-10" itemno="#getitem.itemno#" itemqty="#thisbal10#" monthp="#form.periodfrom#" returnvariable="myResult" >
                        #numberformat(myResult,'.__')#</font></div>
                        </td></cfif>
						<td width="5%"><div align="right"><font size="2" face="Times New Roman, Times, serif">#thisbal9#</font></div></td>
                      <cfif lcase(hcomid) eq "mhca_i">  <td width="5%"><div align="right"><font size="2" face="Times New Roman, Times, serif">
                        <cfinvoke component="CFC.fifoValue" method="fifovalue" dts = "#dts#" period="-9" itemno="#getitem.itemno#" itemqty="#thisbal9#" monthp="#form.periodfrom#" returnvariable="myResult" >
                        #numberformat(myResult,'.__')#</font></div>
                        </td></cfif>
						<td width="5%"><div align="right"><font size="2" face="Times New Roman, Times, serif">#thisbal8#</font></div></td>
                       <cfif lcase(hcomid) eq "mhca_i"> <td width="5%"><div align="right"><font size="2" face="Times New Roman, Times, serif">
                        <cfinvoke component="CFC.fifoValue" method="fifovalue" dts = "#dts#" period="-8" itemno="#getitem.itemno#" itemqty="#thisbal8#" monthp="#form.periodfrom#" returnvariable="myResult" >
                        #numberformat(myResult,'.__')#</font></div>
                        </td></cfif>
						<td width="5%"><div align="right"><font size="2" face="Times New Roman, Times, serif">#thisbal7#</font></div></td>
                        <cfif lcase(hcomid) eq "mhca_i"><td width="5%"><div align="right"><font size="2" face="Times New Roman, Times, serif">
                        <cfinvoke component="CFC.fifoValue" method="fifovalue" dts = "#dts#" period="-7" itemno="#getitem.itemno#" itemqty="#thisbal7#" monthp="#form.periodfrom#" returnvariable="myResult" >
                        #numberformat(myResult,'.__')#</font></div>
                        </td></cfif>
					</cfif>
					<td width="5%"><div align="right"><font size="2" face="Times New Roman, Times, serif">#thisbal6#</font></div></td>
                    <cfif lcase(hcomid) eq "mhca_i"><td width="5%"><div align="right"><font size="2" face="Times New Roman, Times, serif">
                        <cfinvoke component="CFC.fifoValue" method="fifovalue" dts = "#dts#" period="-6" itemno="#getitem.itemno#" itemqty="#thisbal6#" monthp="#form.periodfrom#" returnvariable="myResult" >
                        #numberformat(myResult,'.__')#</font></div>
                        </td></cfif>
					<td width="5%"><div align="right"><font size="2" face="Times New Roman, Times, serif">#thisbal5#</font></div></td>
                    <cfif lcase(hcomid) eq "mhca_i"><td width="5%"><div align="right"><font size="2" face="Times New Roman, Times, serif">
                        <cfinvoke component="CFC.fifoValue" method="fifovalue" dts = "#dts#" period="-5" itemno="#getitem.itemno#" itemqty="#thisbal5#" monthp="#form.periodfrom#" returnvariable="myResult" >
                        #numberformat(myResult,'.__')#</font></div>
                        </td></cfif>
					<td width="5%"><div align="right"><font size="2" face="Times New Roman, Times, serif">#thisbal4#</font></div></td>
                    <cfif lcase(hcomid) eq "mhca_i"><td width="5%"><div align="right"><font size="2" face="Times New Roman, Times, serif">
                        <cfinvoke component="CFC.fifoValue" method="fifovalue" dts = "#dts#" period="-4" itemno="#getitem.itemno#" itemqty="#thisbal4#" monthp="#form.periodfrom#" returnvariable="myResult" >
                        #numberformat(myResult,'.__')#</font></div>
                        </td></cfif>
					<td width="5%"><div align="right"><font size="2" face="Times New Roman, Times, serif">#thisbal3#</font></div></td>
                    <cfif lcase(hcomid) eq "mhca_i"><td width="5%"><div align="right"><font size="2" face="Times New Roman, Times, serif">
                        <cfinvoke component="CFC.fifoValue" method="fifovalue" dts = "#dts#" period="-3" itemno="#getitem.itemno#" itemqty="#thisbal3#" monthp="#form.periodfrom#" returnvariable="myResult" >
                        #numberformat(myResult,'.__')#</font></div>
                        </td></cfif>
					<td width="5%"><div align="right"><font size="2" face="Times New Roman, Times, serif">#thisbal2#</font></div></td>
                    <cfif lcase(hcomid) eq "mhca_i"><td width="5%"><div align="right"><font size="2" face="Times New Roman, Times, serif">
                        <cfinvoke component="CFC.fifoValue" method="fifovalue" dts = "#dts#" period="-2" itemno="#getitem.itemno#" itemqty="#thisbal2#" monthp="#form.periodfrom#" returnvariable="myResult" >
                        #numberformat(myResult,'.__')#</font></div>
                        </td></cfif>
					<td width="5%"><div align="right"><font size="2" face="Times New Roman, Times, serif">#thisbal1#</font></div></td>
                    <cfif lcase(hcomid) eq "mhca_i"><td width="5%"><div align="right"><font size="2" face="Times New Roman, Times, serif">
                        <cfinvoke component="CFC.fifoValue" method="fifovalue" dts = "#dts#" period="-1" itemno="#getitem.itemno#" itemqty="#thisbal1#" monthp="#form.periodfrom#" returnvariable="myResult" >
                        #numberformat(myResult,'.__')#</font></div>
                        </td></cfif>
					<td width="5%"><div align="right"><font size="2" face="Times New Roman, Times, serif">#thisbal0#</font></div></td>
                    <cfif lcase(hcomid) eq "mhca_i"><td width="5%"><div align="right"><font size="2" face="Times New Roman, Times, serif">
                        <cfinvoke component="CFC.fifoValue" method="fifovalue" dts = "#dts#" period="0" itemno="#getitem.itemno#" itemqty="#thisbal0#" monthp="#form.periodfrom#" returnvariable="myResult" >
                        #numberformat(myResult,'.__')#</font></div>
                        </td></cfif>
