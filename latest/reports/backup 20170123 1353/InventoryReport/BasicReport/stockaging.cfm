...
<cfset words_id_list = "1466,123,495,496,146,497,498,1302,1417,1418,104,1354,1355,703,1183,688,1406,1467,1468,1469,1470,1471,1472,501,1399">
...
<cfoutput>
	<cfform class="formContainer form3Button" name="stockAgingForm" id="stockAgingForm" action="stockaging1.cfm" method="post" target="_blank">
		<div>#pageTitle#</div>
        <div>
            <table> 
            ...
            <th><label for="other">#words[688]#</label></th>
                <td>
                    ...
                    <div><input type="checkbox" name="includeCategory" id="includeCategory" value="yes" > #words[1467]#</div>
                    <div><input type="checkbox" name="recalculateinout" id="recalculateinout" value="yes"> #words[1468]#</div>
                </td>
			</tr>
            <tr>
            <th></th>
                <td>
                    <div><input type="radio" name="view" id="view" value="view6" checked="checked"> #words[1469]#</div>
                    <div><input type="radio" name="view" id="view" value="view12" > #words[1470]#</div>
                </td>
			</tr>
            <tr>
            <th></th>
                <td>
                    <div><input type="radio" name="type" value="bymonth" checked> #words[1471]#</div>
