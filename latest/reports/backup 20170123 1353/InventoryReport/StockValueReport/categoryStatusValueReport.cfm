...
<cfquery name="getitem" datasource="#dts#">
	select itemno,desp,wos_group,category,sum(qtybf) as qtybf,ucost 
    from icitem
    where itemno <> '' and category <>''
...
<cfif #stDecl_UPrice# neq ''>
    ...
    (
			select a.itemno,a.aitemno,a.unit,a.category,a.desp,a.despa,a.ucost,(ifnull(a.qtybf,0)+ifnull(b.lastin,0)-ifnull(c.lastout,0)) as qtybf,b.lastin,c.lastout,d.qin,e.qout,f.rcamt,f.rcqty,g.pramt,g.prqty,h.movqin,i.movqout,((ifnull(a.qtybf,0))+ifnull(b.lastin,0)-ifnull(c.lastout,0)+ifnull(d.qin,0)-ifnull(e.qout,0)) as balance,
    ...
    <cfset totalbf=totalbf +val(getstkvalue.qtybf)>
    <cfset totalin=totalin+val(getstkvalue.qin)>
    <cfset totalout=totalout+val(getstkvalue.qout)>
    <cfset totalbal=totalbal+val(getstkvalue.balance)>
