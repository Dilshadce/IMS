...
<cfswitch expression="#form.result#">
	...
	<Row ss:AutoFitHeight="0" ss:Height="23.0625">
		<Cell ss:MergeAcross="7" ss:StyleID="s22"><Data ss:Type="String">Print Product <cfif checkcustom.customcompany eq "Y">- Lot Number<cfelse>Batch</cfif> Status Report</Data></Cell>
	</Row>
    ...
    <cfheader name="Content-Disposition" value="inline; filename=BatchCodeR_IBStatus_#huserid#.xls">
...
--->
	...
	<html>
	<head>
	<title>Product Batch Status Report</title>
	...
	<table width="100%" border="0" cellspacing="1" cellpadding="2">
		<tr>
			<td colspan="100%"><div align="center"><font size="3" face="Times New Roman, Times, serif"><strong>Print Product <cfif checkcustom.customcompany eq "Y">- Lot Number<cfelse>Batch</cfif> Status Report</strong></font></div></td>
		</tr>
		<cfif form.datefrom neq "" and form.dateto neq "">
			<tr>
