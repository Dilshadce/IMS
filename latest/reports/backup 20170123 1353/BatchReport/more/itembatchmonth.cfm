...
<html>
<head>
<title>Product Batch Stock Card</title>
...
select location from iclocation where right(location,4) not in (
	...
	(	select sum(qty) as getlastin,itemno,batchcode,location  
		...
		and (void = '' or void is null) and (fperiod < '#form.periodfrom#' or fperiod = 99) and batchcode<>'' and location<>''
	...
	(	select sum(qty) as getlastout,itemno,batchcode,location 
		...
		and (void = '' or void is null) and (fperiod < '#form.periodfrom#' or fperiod = 99) and toinv='' and batchcode<>'' and location<>''
		<cfif form.batchcodefrom neq "" and form.batchcodeto neq "">
			and batchcode between '#form.batchcodefrom#' and '#form.batchcodeto#'
		</cfif>
		<cfif trim(form.productfrom) neq "" and trim(form.productto) neq "">
...
<table width="100%" border="0" align="center" cellspacing="0">
	...
	<tr>
		<td colspan="100%"><div align="center"><font size="2" face="Times New Roman, Times, serif">MONTH : #ucase(dateformat(dateadd('m',val(form.periodfrom),getgeneral.lastaccyear),"mmm yy"))#</font></div></td>
	</tr>
    <tr>
...
<table width="100%" border="0" align="center" cellspacing="0">
	...
	<tr>
		...
		<td><div align="left"><font size="2" face="Times New Roman, Times, serif">PRODUCT DESCRIPTION</font></div></td>
...
<cfxml variable="data">
		   ...
		   <cfwddx action = "cfml2wddx" input = "Without Qty Location Report" output = "wddxText">
			...
			<cfwddx action = "cfml2wddx" input = "MONTH : #ucase(dateformat(dateadd('m',val(form.periodfrom),getgeneral.lastaccyear),"mmm yy"))#" output = "wddxText">
			<Row ss:AutoFitHeight="0" ss:Height="20.0625">
			<Cell ss:MergeAcross="#c#" ss:StyleID="s24"><Data ss:Type="String">#wddxText#</Data></Cell>
			</Row>
...
<cfelse>
		...
		<cfxml variable="data">
			...
			<Worksheet ss:Name="Product Batch Stock Card">
				<Table x:FullColumns="1" x:FullRows="1" ss:DefaultColumnWidth="54" ss:DefaultRowHeight="11.25">
					<Column ss:Width="64.5"/>
					<Column ss:Width="60.25"/>
					<Column ss:Width="60.75"/>
...
<cfquery name="getitem" datasource="#dts#">
	...
	order by <cfif isdefined('form.bylocation')>a.location,a.batchcode<cfelse>a.itemno,a.batchcode</cfif>
		   ...
		   <cfoutput>
					<cfwddx action = "cfml2wddx" input = "Product Batch Stock Card" output = "wddxText">
					<Row ss:AutoFitHeight="0" ss:Height="23.0625">
						<Cell ss:MergeAcross="#c#" ss:StyleID="s22"><Data ss:Type="String">#wddxText#</Data></Cell>
					</Row>
			...
			<Cell ss:MergeAcross="#c#" ss:StyleID="s24"><Data ss:Type="String">#wddxText#</Data></Cell>
				...
				<Row ss:AutoFitHeight="0" ss:Height="23.0625">
					...
					<Cell ss:StyleID="s27"><Data ss:Type="String">PRODUCT DESCRIPTION</Data></Cell>
