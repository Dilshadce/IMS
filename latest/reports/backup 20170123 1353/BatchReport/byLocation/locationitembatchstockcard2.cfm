<html>
<head>
<title>Location Product Batch Stock Card</title>
...
<body>
<p align="center"><font color="#000000" size="4" face="Times New Roman, Times, serif"><strong>LOCATION PRODUCT <cfif checkcustom.customcompany eq "Y">- LOT NUMBER<cfelse>BATCH</cfif> STOCK CARD</strong></font></p>
...
<cfloop query="getlocation">
	...
	<cfquery name="getitem" datasource="#dts#">
		...
		a.location,a.bth_qob,a.bth_qin,a.bth_qut,a.expdate,b.getlastin,c.getlastout,(ifnull(a.bth_qob,0) + ifnull(b.getlastin,0) - ifnull(c.getlastout,0)) as balance
		from lobthob as a
		...
		<cfif trim(form.categoryfrom) neq "" and trim(form.categoryto) neq "">
			and d.category between '#form.categoryfrom#' and '#form.categoryto#'
		</cfif>
		<cfif trim(form.groupfrom) neq "" and trim(form.groupto) neq "">
	...
	<cfloop query="getitem">
        ...
        <cfquery name="getunit" datasource="#dts#">
			...
			<tr>
				...
				<cfif val(xfactor1) neq 0>
					<cfif val(getitem.balance) gte 0>
						<cfset xqtybf=val(getitem.balance)/val(getitem.factor1)*val(xfactor2)>
					<cfelse>
						<cfset xqtybf=-(val(getitem.balance)/val(getitem.factor1)*val(xfactor2))>
					</cfif>
			...
			<cfloop query="getictran">
				<tr onMouseOut="javascript:this.style.backgroundColor='';" onMouseOver="javascript:this.style.backgroundColor='99FF00';">
					...
					<cfif getictran.type eq "RC" or getictran.type eq "CN" or getictran.type eq "OAI" or getictran.type eq "TRIN">
						...
						<td><div align="right"><font size="2" face="Times New Roman, Times, serif">#xqty# #xunit2# #yqty# #xunit#</font></div></td>
						<td></td>
					<cfelse>
					...
					<td><div align="right"><font size="2" face="Times New Roman, Times, serif">#xbal# #xunit2# #ybal# #xunit#</font></div></td>
			...
			<tr>
		      	...
		      	<td><font size="2" face="Times New Roman, Times, serif"><div align="right"><strong>#xtotalin# #xunit2# #ytotalin# #xunit#</strong></div></font></td>
		      	<td><font size="2" face="Times New Roman, Times, serif"><div align="right"><strong>#xtotalout# #xunit2# #ytotalout# #xunit#</strong></div></font></td>
		      	<td><font size="2" face="Times New Roman, Times, serif"><div align="right"><strong>#xbal# #xunit2# #ybal# #xunit#</strong></div></font></td>
		      	<td></td>
		      	<td></td>
		      	<td></td>
		    </tr>
