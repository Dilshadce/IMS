    ...
    <Row ss:AutoFitHeight="0" ss:Height="20.0625">
        ...
        <Row ss:AutoFitHeight="0" ss:Height="20.0625">
				...
				<Row ss:AutoFitHeight="0" ss:Height="23.0625">
					...
					<Cell ss:StyleID="s27"><Data ss:Type="String"><cfif url.trancode eq "TR">Transfer No<cfelse>Invoice No.</cfif></Data></Cell>
                    <Cell ss:StyleID="s27"><Data ss:Type="String"><cfif url.trancode eq "TR">Authorised by<cfelse>Account No.</cfif></Data></Cell>
					<Cell ss:StyleID="s27"><Data ss:Type="String"><cfif url.trancode eq "TR">Reason for transfer<cfelse>Account Name.</cfif></Data></Cell>
				   <!---<cfif url.trancode eq "TR">
                        <Cell ss:StyleID="s27">
					...
					<Cell ss:StyleID="s27"><Data ss:Type="String">Project NO</Data></Cell>
                    </cfif>
                    <cfif isdefined('form.cbjob')>
					<Cell ss:StyleID="s27"><Data ss:Type="String">Job NO</Data></Cell>
                    </cfif>
                   <cfif isdefined('form.cbagent')>
					...
					<Cell ss:StyleID="s27"><Data ss:Type="String">Product Name</Data></Cell>
                    <cfif url.trancode eq "TR">
                    <Cell ss:StyleID="s27"><Data ss:Type="String">Location From</Data></Cell>
                    <Cell ss:StyleID="s27"><Data ss:Type="String">Location To</Data></Cell>
                    <cfelse>
                    ...
                    <Cell ss:StyleID="s27"><Data ss:Type="String">Grand Foreign Rate</Data></Cell>
                    <Cell ss:StyleID="s27"><Data ss:Type="String">Grand Foreign Amount</Data></Cell>
...
<cfset gettran.invgross = val(gettran.invgross) + val(gettran.discount)>
				...
				<cfloop query="getbodydetail">
                    ...
                    <cfif isdefined('form.checkbox4')>
                        ...
                        <Cell ss:StyleID="s32"><Data ss:Type="String">#getbodydetail.qty#</Data></Cell>
                        
						<Cell ss:StyleID="s33"><Data ss:Type="Number">#getbodydetail.taxpec1#</Data></Cell>
						<Cell ss:StyleID="s33"><Data ss:Type="Number">#getbodydetail.price#</Data></Cell>
                        <Cell ss:StyleID="s33"><Data ss:Type="Number">#getbodydetail.dispec1#</Data></Cell>
						<Cell ss:StyleID="s33"><Data ss:Type="Number">#getbodydetail.amt#</Data></Cell>
                        
                        <Cell ss:StyleID="s32"><Data ss:Type="String">#wddxText8#</Data></Cell>
                        <Cell ss:StyleID="s32"><Data ss:Type="String">#wddxText9#</Data></Cell>
                        <Cell ss:StyleID="s33"><Data ss:Type="Number">#gettran.currrate#</Data></Cell>
                        <Cell ss:StyleID="s33"><Data ss:Type="Number">#getbodydetail.amt_bil#</Data></Cell>
                ...
                <cfoutput>
                    ...
                    <Cell ss:StyleID="s32"><Data ss:Type="String"></Data></Cell>
                        ...
                        <Cell ss:StyleID="s32"><Data ss:Type="String"></Data></Cell>
                        <Cell ss:StyleID="s32"><Data ss:Type="String"></Data></Cell>
                        <Cell ss:StyleID="s32"><Data ss:Type="String">Total Discount</Data></Cell>
						<Cell ss:StyleID="s37"><Data ss:Type="Number">#gettran.discount#</Data></Cell>
                        <Cell ss:StyleID="s32"><Data ss:Type="String"></Data></Cell>
                        <Cell ss:StyleID="s32"><Data ss:Type="String"></Data></Cell>
                        <Cell ss:StyleID="s32"><Data ss:Type="String"></Data></Cell>
						<Cell ss:StyleID="s37"><Data ss:Type="Number">#gettran.disc_bil#</Data></Cell>
                    </Row>
                    ...
                    <cfif isdefined('form.checkbox4')>
                        ...
                        <Cell ss:StyleID="s32"><Data ss:Type="String"></Data></Cell>
                        <Cell ss:StyleID="s32"><Data ss:Type="String"></Data></Cell>
						<Cell ss:StyleID="s37"><Data ss:Type="Number">#gettran.net#</Data></Cell>
                        <Cell ss:StyleID="s32"><Data ss:Type="String"></Data></Cell>
                        <Cell ss:StyleID="s32"><Data ss:Type="String"></Data></Cell>
                        <Cell ss:StyleID="s32"><Data ss:Type="String"></Data></Cell>
						<Cell ss:StyleID="s37"><Data ss:Type="Number">#gettran.net_bil#</Data></Cell>
                    ...
                    <cfif isdefined('form.checkbox4')>
                        ...
                        <Cell ss:StyleID="s32"><Data ss:Type="String"></Data></Cell>
						<Cell ss:StyleID="s32"><Data ss:Type="String"></Data></Cell>
                        <Cell ss:StyleID="s32"><Data ss:Type="String">GST</Data></Cell>
						<Cell ss:StyleID="s37"><Data ss:Type="Number">#gettran.tax#</Data></Cell>
                        <Cell ss:StyleID="s32"><Data ss:Type="String"></Data></Cell>
                        <Cell ss:StyleID="s32"><Data ss:Type="String"></Data></Cell>
                        <Cell ss:StyleID="s32"><Data ss:Type="String"></Data></Cell>
						<Cell ss:StyleID="s37"><Data ss:Type="Number">#gettran.tax_bil#</Data></Cell>
                    ...
                    <cfif isdefined('form.checkbox4')>
						...
						<Cell ss:StyleID="s32"><Data ss:Type="String"></Data></Cell>
                        <Cell ss:StyleID="s32"><Data ss:Type="String"></Data></Cell>
						<Cell ss:StyleID="s39"><Data ss:Type="Number">#gettran.grand#</Data></Cell>
                        <Cell ss:StyleID="s32"><Data ss:Type="String"></Data></Cell>
                        <Cell ss:StyleID="s32"><Data ss:Type="String"></Data></Cell>
                        <Cell ss:StyleID="s32"><Data ss:Type="String"></Data></Cell>
						<Cell ss:StyleID="s37"><Data ss:Type="Number">#gettran.grand_bil#</Data></Cell>
    ...
    <cfelse>
		...
		<cfxml variable="data">
			...
			<Worksheet ss:Name="Bills Listing">
				...
				<Row ss:AutoFitHeight="0" ss:Height="23.0625">
					...
					<Cell ss:StyleID="s27"><Data ss:Type="String"><cfif url.trancode eq "TR">Authorised by<cfelse>Cust./Supp.</cfif></Data></Cell>
					<Cell ss:StyleID="s27"><Data ss:Type="String"><cfif url.trancode eq "TR">Reason for transfer<cfelse>Name</cfif></Data></Cell>
                    <cfif url.trancode eq "TR">
                    	<Cell ss:StyleID="s27"><Data ss:Type="String">Transfer From</Data></Cell>
                        <Cell ss:StyleID="s27"><Data ss:Type="String">Transfer To</Data></Cell>
                    </cfif>
					...
					<cfif lcase(HcomID) eq "powernas_i">
						<Cell ss:StyleID="s27"><Data ss:Type="String">Policy No</Data></Cell>
					</cfif>
        ...
        <cfif lcase(HcomID) eq "manhattan_i" or lcase(Hcomid) eq "elmanhattan_i">
                    <Cell ss:StyleID="s27"><Data ss:Type="String">Agent No</Data></Cell>
                    <Cell ss:StyleID="s27"><Data ss:Type="String">Est. Delivery Date</Data></Cell>
                    </cfif>
					...
					<Cell ss:StyleID="s27"><Data ss:Type="String">Grand Foreign</Data></Cell></cfif>
                    
                    <cfif lcase(HcomID) eq "manhattan_i" or lcase(Hcomid) eq "elmanhattan_i">
                    <Cell ss:StyleID="s27"><Data ss:Type="String">Paid By</Data></Cell>
...
<cfset gettran.invgross = val(gettran.invgross) + val(gettran.discount)>
			...
			<cfwddx action = "cfml2wddx" input = "#gettran.sONO#" output = "wddxText10">
			<cfwddx action = "cfml2wddx" input = "#gettran.source#" output = "wddxText11">
			<cfwddx action = "cfml2wddx" input = "#gettran.job#" output = "wddxText12">
             <cfwddx action = "cfml2wddx" input = "#gettran.agenno#" output = "wddxText13">
             <cfwddx action = "cfml2wddx" input = "#gettran.rem5#" output = "wddxText14">  
             <cfwddx action = "cfml2wddx" input = "#gettran.note#" output = "wddxText15"> 
             <cfif lcase(hcomid) eq "elitez_i">
             <cfwddx action = "cfml2wddx" input = "#gettran.comm0#" output = "wddxText16"> 
             <cfwddx action = "cfml2wddx" input = "#gettran.comm1#" output = "wddxText17">
             <cfwddx action = "cfml2wddx" input = "#gettran.comm2#" output = "wddxText18">
             <cfwddx action = "cfml2wddx" input = "#gettran.comm3#" output = "wddxText19"> 
             <cfwddx action = "cfml2wddx" input = "#gettran.rem14#" output = "wddxText20">
             </cfif>
					...
					<cfif url.trancode neq "TR">
						...
						<!---<cfset xgrand =numberformat(xnet,'.__')+numberformat(xtax,'.__')+val(gettran.m_charge1)+val(gettran.m_charge2)+val(gettran.m_charge3)+val(gettran.m_charge4)+val(gettran.m_charge5)+val(gettran.m_charge6)+val(gettran.m_charge7) <!--- val(gettran.grand) --->>
						--->
					...
					<Row ss:AutoFitHeight="0">
                        ...
                        <Cell ss:StyleID="s32"><Data ss:Type="String">#wddxText16# #wddxText17# #wddxText18# #wddxText19# #wddxText20#</Data></Cell>
                        </cfif>
                    ...
                    <cfif lcase(HcomID) eq "manhattan_i" or lcase(Hcomid) eq "elmanhattan_i">
                        ...
                        <cfwddx action = "cfml2wddx" input = "#gettran.rem5#" output = "wddxText13">
						...
						<cfwddx action = "cfml2wddx" input = "#getpolicy.brem2#" output = "wddxText9">
						<Cell ss:StyleID="s32"><Data ss:Type="String">#wddxText9#</Data></Cell>
                        </cfif>
                        ...
                        <cfif isdefined('form.cbgst')>
							<cfif getgeneral.wpitemtax NEQ ''>
                                ...
                                <Cell ss:StyleID="s32"><Data ss:Type="String">#taxCodeList#</Data></Cell>
                            <cfelse>
                    ...
                    <Cell ss:StyleID="s33"><Data ss:Type="Number">#numberformat(gettran.cs_pm_cash+gettran.cs_pm_cheq+gettran.cs_pm_crcd+gettran.cs_pm_crc2+gettran.cs_pm_dbcd+gettran.cs_pm_vouc+gettran.deposit,",.__")#</Data></Cell>
                     <Cell ss:StyleID="s33"><Data ss:Type="Number">#numberformat(xgrand-(gettran.cs_pm_cash+gettran.cs_pm_cheq+gettran.cs_pm_crcd+gettran.cs_pm_crc2+gettran.cs_pm_dbcd+gettran.cs_pm_vouc+gettran.deposit),",.__")#</Data></Cell>
                    
                      <cfset totaldeposit = totaldeposit+ gettran.cs_pm_cash+gettran.cs_pm_cheq+gettran.cs_pm_crcd+gettran.cs_pm_crc2+gettran.cs_pm_dbcd+gettran.cs_pm_vouc+gettran.deposit>
                    <cfset totalbalance = totalbalance + xgrand-(gettran.cs_pm_cash+gettran.cs_pm_cheq+gettran.cs_pm_crcd+gettran.cs_pm_crc2+gettran.cs_pm_dbcd+gettran.cs_pm_vouc+gettran.deposit)>
		    ...
		    <cfif isdefined('form.cbjob')>
					...
					<Cell ss:StyleID="s39"><Data ss:Type="Number">#numberformat(totalfcamt,",.__")#</Data></Cell>
                      <cfif lcase(HcomID) eq "manhattan_i" or lcase(Hcomid) eq "elmanhattan_i">
                    <Cell ss:StyleID="s39"><Data ss:Type="Number">#numberformat(totaldeposit,",.__")#</Data></Cell>
                    <Cell ss:StyleID="s39"><Data ss:Type="Number">#numberformat(totalbalance,",.__")#</Data></Cell>
                    </cfif>
					<Cell ss:StyleID="s38"/>
...
<!--- PDF report---->
	<cfcase value="PDF2"> 
        <cfreport template="reportbilling.cfr" format="PDF" query="gettran"><!--- or "FlashPaper" or "Excel" or "RTF" --->
...
<!--- PDF report2---->
	<cfcase value="PDF"> 
        ...
        <cfreport template="reportbilling2.cfr" format="PDF" query="gettran"><!--- or "FlashPaper" or "Excel" or "RTF" --->
            <cfreportparam name="compro" value="#getgeneral.compro#">
            <cfreportparam name="compro7" value="#getgeneral.compro7#">
...
<!---- End PDF report --->
    ...
    <cfif form.driverFrom neq "" and form.userTo neq "">
	 ...
	 <tr>
			...
			<tr>
				<td><div align="left"><font size="1.5" face="Arial, Helvetica, sans-serif"><strong><cfif url.trancode eq "TR">Authorised by.<br>Transfer No.<cfelse>Account No.<br>Bill No.</cfif></strong></font></div></td>
				<td><div align="left"><font size="1.5" face="Arial, Helvetica, sans-serif"><strong><cfif url.trancode eq "TR">Reason for transfer.<br>Date.<cfelse>Account Name.<br>Date</cfif></strong></font></div></td>
                <cfif isdefined('form.checkbox1')>
...
<cfset gettran.invgross = val(gettran.invgross) + val(gettran.discount)>
		    ...
		    <cfif isdefined('form.cbjob')>
               ...
               <cfif isdefined('form.checkbox3')>
                ...
                <td><div align="left"><font size="1.5" face="Arial, Helvetica, sans-serif">#getbodydetail.desp#<cfif getbodydetail.despa neq ''><br>#getbodydetail.despa#</cfif><cfif tostring(getbodydetail.comment) neq ''><br>#tostring(getbodydetail.comment)#</cfif></font></div></td>
                <cfelse>
				<td nowrap><div align="left"><font size="1.5" face="Arial, Helvetica, sans-serif">#getbodydetail.itemno# <cfif lcase(hcomid) eq "bestform_i"> <br> #getbodydetail.batchcode#</cfif></font></div></td>
                <cfif getdisplaydetail.report_aitemno eq 'Y'>
                <cfquery name="getproductcode" datasource="#dts#">
                    select aitemno from icitem where itemno='#getbodydetail.itemno#'
                    </cfquery>
                ...
                <td nowrap><div align="left"><font size="1.5" face="Arial, Helvetica, sans-serif">#getbodydetail.desp#<cfif getbodydetail.despa neq ''><br>#getbodydetail.despa#</cfif><cfif tostring(getbodydetail.comment) neq ''><br>#tostring(getbodydetail.comment)#</cfif></font></div></td>
                </cfif>
                <cfif isdefined('form.cbdetail') and form.result eq 'HTML'>
                <cfif url.trancode eq "TR">
     ...
     <cfset detailforeigntotalgrand = detailforeigntotalgrand + val(numberformat(gettran.grand_bil,".__"))>
            ...
            <cfoutput>
            <tr><td><b>Total</b></td><cfif url.trancode eq "TR"><td></td></cfif><td></td><td></td><td></td><td></td><td></td><td></td><td></td><td></td><td><b>#numberformat(detailtotalgrand,",_.__")#</b></td><td></td><td></td><td></td>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<td><b>#numberformat(detailforeigntotalgrand,",_.__")#</b></td></tr>
			<tr><td></td></tr>
            </cfoutput>
		<tr>
            <td colspan="100%"><hr></td>
	 ...
	 <tr>
        ...
        <cfif IsDefined('form.customerFrom') eq IsDefined('form.customerTo')>
			...
			<tr>
				...
				<td><div align="left"><font size="1.5" face="Arial, Helvetica, sans-serif"><strong><cfif url.trancode eq "TR">Authorised by<cfelse>Cust No</cfif></strong></font></div></td>
				<td><div align="left"><font size="1.5" face="Arial, Helvetica, sans-serif"><strong><cfif url.trancode eq "TR">Reason for transfer<cfelse>Name</cfif></strong></font></div></td>
                        <cfif lcase(hcomid) eq "elitez_i">

                <td><div align="left"><font size="1.5" face="Arial, Helvetica, sans-serif"><strong>Delivery Address</strong></font></div></td></cfif>
		...
		<td><div align="left"><font size="1.5" face="Arial, Helvetica, sans-serif"><strong>Policy No</strong></font></div></td>
                ...
                <td><div align="right"><font size="1.5" face="Arial, Helvetica, sans-serif"><strong>Amount</strong></font></div></td>
				<td><div align="right"><font size="1.5" face="Arial, Helvetica, sans-serif"><strong><cfif lcase(HcomID) eq "taftc_i">Grant<cfelse>Discount</cfif></strong></font></div></td>
                </cfif>
...
<cfset gettran.invgross = val(gettran.invgross) + val(gettran.discount)>
		    ...
		    select brem2 from ictran where refno='#gettran.refno#' and type='#gettran.type#'
		     ...
		     <td nowrap><div align="left"><font size="1.5" face="Arial, Helvetica, sans-serif">#getpolicy.brem2#</font></div></td>
				...
				<cfelse>
						...
						<cfif xcurrrate eq "1" or xcurrrate eq "0"><cfelse><cfset totalfcamt = totalfcamt + xfcamt></cfif>
					</cfif>
                    </cfif>
                    <cfif lcase(HcomID) eq "atc2005_i">
			...
			<tr>
				...
				<cfif lcase(HcomID) eq "mhca_i" or lcase(HcomID) eq "bestform_i"><td><div align="right"><font size="1.5" face="Arial, Helvetica, sans-serif"></font></div></td></cfif>
                <cfif lcase(HcomID) eq "bestform_i">
                <td><div align="right"><font size="1.5" face="Arial, Helvetica, sans-serif"></font></div></td>
                </cfif>
                <cfif url.trancode neq 'ISS'>
				<td><div align="right"><font size="1.5" face="Arial, Helvetica, sans-serif"><strong><cfif totalfcamt neq 0>#numberformat(totalfcamt,",.__")#</cfif></strong></font></div></td>
                </cfif>
				</cfoutput>
				<td></td>
