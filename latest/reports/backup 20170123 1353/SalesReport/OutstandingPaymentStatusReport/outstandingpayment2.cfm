...
<cfset iDecl_UPrice = getgsetup2.Decl_UPrice>
		...
		<cfquery name="gettotal" datasource="#dts#">
			...
			and refno in (select refno from ictran where location >='#form.locationfrom#' and location <= '#form.locationto#' group by refno)
			</cfif>
...
<cfswitch expression="#form.result#">
    ...
    <cfxml variable="data">
	     ...
	     <Row ss:AutoFitHeight="0" ss:Height="20.0625">
			<Cell ss:MergeAcross="#c#" ss:StyleID="s22"><Data ss:Type="String">Invoice Cash Summary Report</Data></Cell>
		</Row>
	     ...
	     <Row ss:AutoFitHeight="0" ss:Height="20.0625">
			...
			<Cell ss:MergeAcross="#c#" ss:StyleID="s22"><Data ss:Type="String">DATE: #wddxText1#</Data></Cell>
		</Row>
			</cfif>
	     ...
	     <Row ss:AutoFitHeight="0" ss:Height="20.0625">
				<Cell ss:StyleID="s38"><Data ss:Type="String">Sales Record</Data></Cell>
	     ...
	     <Row ss:AutoFitHeight="0" ss:Height="20.0625">
  		   <cfwddx action = "cfml2wddx" input = "#numberformat(gettotal.net,',_.__')#" output = "wddxText7">
				<Cell ss:StyleID="s26"><Data ss:Type="String">Nett Total :</Data></Cell>
	     ...
	     <Row ss:AutoFitHeight="0" ss:Height="20.0625">
  		   <cfwddx action = "cfml2wddx" input = "#numberformat(gettotal.grand,',_.__')#" output = "wddxText9">
	     ...
	     <Row ss:AutoFitHeight="0" ss:Height="20.0625">
			<Cell ss:StyleID="s52"><Data ss:Type="String">Collection Record</Data></Cell>
		</Row>

	     <Row ss:AutoFitHeight="0" ss:Height="20.0625">
			<Cell ss:StyleID="s50"><Data ss:Type="String">Mode of Payment</Data></Cell>
			<Cell ss:StyleID="s50"><Data ss:Type="String">Amount</Data></Cell>
            <Cell ss:StyleID="s50"><Data ss:Type="String">%</Data></Cell>
            <Cell ss:StyleID="s50"><Data ss:Type="String">No. of Transaction</Data></Cell>
            <Cell ss:StyleID="s50"><Data ss:Type="String">%</Data></Cell>
            <Cell ss:StyleID="s50"><Data ss:Type="String"></Data></Cell>
        ...
        <cfquery name="getcashrecord" datasource="#dts#">
			select refno from artran
			where type='INV' and (void = '' or void is null) and CS_PM_cash !=0
			<cfif form.agentfrom neq "" and form.agentto neq "">
			and agenno >='#form.agentfrom#' and agenno <= '#form.agentto#'
			</cfif>
            <cfif form.locationfrom neq "" and form.locationto neq "">
        ...
        <cfquery name="getdbcdrecord" datasource="#dts#">
			select refno from artran
			where type='INV' and (void = '' or void is null) and CS_PM_dbcd !=0
			<cfif form.agentfrom neq "" and form.agentto neq "">
			and agenno >='#form.agentfrom#' and agenno <= '#form.agentto#'
			</cfif>
            <cfif form.locationfrom neq "" and form.locationto neq "">
        ...
        <cfquery name="getcashcdrecord" datasource="#dts#">
			select refno from artran
			where type='INV' and (void = '' or void is null) and CS_PM_cashcd !=0
			<cfif form.agentfrom neq "" and form.agentto neq "">
			and agenno >='#form.agentfrom#' and agenno <= '#form.agentto#'
			</cfif>
            <cfif form.locationfrom neq "" and form.locationto neq "">
        ...
        <cfquery name="getcrcdrecord" datasource="#dts#">
			select refno from artran
			where type='INV' and (void = '' or void is null) and (CS_PM_crcd !=0 or CS_PM_crc2 !=0)
			<cfif form.agentfrom neq "" and form.agentto neq "">
			and agenno >='#form.agentfrom#' and agenno <= '#form.agentto#'
			</cfif>
            <cfif form.locationfrom neq "" and form.locationto neq "">
        ...
        <cfquery name="getcheqrecord" datasource="#dts#">
			select refno from artran
			where type='INV' and (void = '' or void is null) and CS_PM_cheq !=0
			<cfif form.agentfrom neq "" and form.agentto neq "">
			and agenno >='#form.agentfrom#' and agenno <= '#form.agentto#'
			</cfif>
            <cfif form.locationfrom neq "" and form.locationto neq "">
        ...
        <cfquery name="getvoucrecord" datasource="#dts#">
			select refno from artran
			where type='INV' and (void = '' or void is null) and CS_PM_vouc !=0
			<cfif form.agentfrom neq "" and form.agentto neq "">
			and agenno >='#form.agentfrom#' and agenno <= '#form.agentto#'
			</cfif>
            <cfif form.locationfrom neq "" and form.locationto neq "">
...
<cfset gettotal.grand=1>
	    ...
	    <Row ss:AutoFitHeight="0" ss:Height="20.0625">
			...
			<Cell ss:StyleID="s26"><Data ss:Type="String">Cash :</Data></Cell>
				<Cell ss:StyleID="s26"><Data ss:Type="String">#numberformat(gettotal.CS_PM_Cash,',_.__')#</Data></Cell>
                <Cell ss:StyleID="s26"><Data ss:Type="String">#numberformat((val(gettotal.cs_pm_cash)/val(gettotal.grand))*100,',_.__')#%</Data></Cell>
                <Cell ss:StyleID="s26"><Data ss:Type="String">#getcashrecord.recordcount#</Data></Cell>
	    ...
	    <Row ss:AutoFitHeight="0" ss:Height="20.0625">
			<Cell ss:StyleID="s26"><Data ss:Type="String">Nets :</Data></Cell>
				<Cell ss:StyleID="s26"><Data ss:Type="String">#numberformat(gettotal.CS_PM_dbcd,',_.__')#</Data></Cell>
                <Cell ss:StyleID="s26"><Data ss:Type="String">#numberformat((val(gettotal.cs_pm_cash)/val(gettotal.grand))*100,',_.__')#%</Data></Cell>
                <Cell ss:StyleID="s26"><Data ss:Type="String">#getdbcdrecord.recordcount#</Data></Cell>
	    ...
	    <Row ss:AutoFitHeight="0" ss:Height="20.0625">
			...
			<Cell ss:StyleID="s26"><Data ss:Type="String">#numberformat(gettotal.CS_PM_Cashcd,',_.__')#</Data></Cell>
            <Cell ss:StyleID="s26"><Data ss:Type="String">#numberformat((val(gettotal.cs_pm_cash)/val(gettotal.grand))*100,',_.__')#%</Data></Cell>
            <Cell ss:StyleID="s26"><Data ss:Type="String">#getcashcdrecord.recordcount#</Data></Cell>
	    ...
	    <Row ss:AutoFitHeight="0" ss:Height="20.0625">
			...
			<Cell ss:StyleID="s26"><Data ss:Type="String">#numberformat(gettotal.CS_PM_crcd,',_.__')#</Data></Cell>
            <Cell ss:StyleID="s26"><Data ss:Type="String">#numberformat((val(gettotal.CS_PM_crcd)/val(gettotal.grand))*100,',_.__')#%</Data></Cell>
            <Cell ss:StyleID="s26"><Data ss:Type="String">#getcrcdrecord.recordcount#</Data></Cell>
	    ...
	    <Row ss:AutoFitHeight="0" ss:Height="20.0625">
			...
			<Cell ss:StyleID="s26"><Data ss:Type="String">#numberformat(gettotal.CS_PM_cheq,',_.__')#</Data></Cell>
            <Cell ss:StyleID="s26"><Data ss:Type="String">#numberformat((val(gettotal.CS_PM_cheq)/val(gettotal.grand))*100,',_.__')#%</Data></Cell>
            <Cell ss:StyleID="s26"><Data ss:Type="String">#getcheqrecord.recordcount#</Data></Cell>
	    ...
	    <Row ss:AutoFitHeight="0" ss:Height="20.0625">
			...
			<Cell ss:StyleID="s51"><Data ss:Type="String">#numberformat(gettotal.CS_PM_vouc,',_.__')#</Data></Cell>
            <Cell ss:StyleID="s51"><Data ss:Type="String">#numberformat((val(gettotal.CS_PM_vouc)/val(gettotal.grand))*100,',_.__')#%</Data></Cell>
            <Cell ss:StyleID="s51"><Data ss:Type="String">#getvoucrecord.recordcount#</Data></Cell>
            <Cell ss:StyleID="s51"><Data ss:Type="String"><cfif gettotalrecord.recordcount eq 0><cfelse>#numberformat((val(getvoucrecord.recordcount)/val(gettotalrecord.recordcount))*100,',_.__')#</cfif></Data></Cell>
            <Cell ss:StyleID="s51"><Data ss:Type="String"></Data></Cell>
	    ...
	    <Row ss:AutoFitHeight="0" ss:Height="20.0625">
			<Cell ss:StyleID="s52"><Data ss:Type="String">Credit Card Record</Data></Cell>
			</Row>
            
            <cfquery name="getvisa" datasource="#dts#">
			select sum(CS_PM_crcd) as CS_PM_crcd from artran
			where type='INV' and (void = '' or void is null) and (creditcardtype1='VISA')
        ...
        <cfquery name="getmaster" datasource="#dts#">
			select sum(CS_PM_crcd) as CS_PM_crcd from artran
			where type='INV' and (void = '' or void is null) and (creditcardtype1='MASTER')
        ...
        <cfquery name="getamex" datasource="#dts#">
			select sum(CS_PM_crcd) as CS_PM_crcd from artran
			where type='INV' and (void = '' or void is null) and (creditcardtype1='AMEX')
        ...
        <cfquery name="getjcb" datasource="#dts#">
			select sum(CS_PM_crcd) as CS_PM_crcd from artran
			where type='INV' and (void = '' or void is null) and (creditcardtype1='JCB')
        ...
        <cfquery name="getdiners" datasource="#dts#">
			select sum(CS_PM_crcd) as CS_PM_crcd from artran
			where type='INV' and (void = '' or void is null) and (creditcardtype1='DINERS')
        ...
        <cfquery name="getvisa2" datasource="#dts#">
			...
			where type='INV' and (void = '' or void is null) and (creditcardtype2='VISA')
        ...
        <cfquery name="getmaster2" datasource="#dts#">
			select sum(CS_PM_crc2) as CS_PM_crcd from artran
			where type='INV' and (void = '' or void is null) and (creditcardtype2='MASTER')
        ...
        <cfquery name="getamex2" datasource="#dts#">
			select sum(CS_PM_crc2) as CS_PM_crcd from artran
			where type='INV' and (void = '' or void is null) and (creditcardtype2='AMEX')
        ...
        <cfquery name="getjcb2" datasource="#dts#">
			select sum(CS_PM_crc2) as CS_PM_crcd from artran
			where type='INV' and (void = '' or void is null) and (creditcardtype2='JCB')
        ...
        <cfquery name="getdiners2" datasource="#dts#">
			select sum(CS_PM_crc2) as CS_PM_crcd from artran
			where type='INV' and (void = '' or void is null) and (creditcardtype2='DINERS')
	     ...
	     <Row ss:AutoFitHeight="0" ss:Height="20.0625">
                ...
                <Cell ss:StyleID="s50"><Data ss:Type="String">Charges</Data></Cell>
                <Cell ss:StyleID="s50"><Data ss:Type="String">Usage%</Data></Cell>
                <Cell ss:StyleID="s50"><Data ss:Type="String"></Data></Cell>
                <Cell ss:StyleID="s50"><Data ss:Type="String"></Data></Cell>
			</Row>
	     ...
	     <Row ss:AutoFitHeight="0" ss:Height="20.0625">
			 ...
			 <Cell ss:StyleID="s26"><Data ss:Type="String">#numberformat(val(getvisa.CS_PM_crcd)+val(getvisa2.CS_PM_crcd),',_.__')#</Data></Cell>
             <Cell ss:StyleID="s26"><Data ss:Type="String"></Data></Cell>
             <Cell ss:StyleID="s26"><Data ss:Type="String">#numberformat(((val(getvisa.CS_PM_crcd)+val(getvisa2.CS_PM_crcd))/val(gettotal.CS_PM_crcd))*100,',_.__')#%</Data></Cell>
			</Row>
            
	     <Row ss:AutoFitHeight="0" ss:Height="20.0625">
          <Cell ss:StyleID="s26"><Data ss:Type="String">Master</Data></Cell>
	     <Cell ss:StyleID="s26"><Data ss:Type="String">#numberformat(val(getmaster.CS_PM_crcd)+val(getmaster2.CS_PM_crcd),',_.__')#</Data></Cell>
         <Cell ss:StyleID="s26"><Data ss:Type="String"></Data></Cell>
         <Cell ss:StyleID="s26"><Data ss:Type="String">#numberformat(((val(getmaster.CS_PM_crcd)+val(getmaster2.CS_PM_crcd))/val(gettotal.CS_PM_crcd))*100,',_.__')#%</Data></Cell>
			</Row>
            
	     <Row ss:AutoFitHeight="0" ss:Height="20.0625">
          <Cell ss:StyleID="s26"><Data ss:Type="String">Amex</Data></Cell>
		  <Cell ss:StyleID="s26"><Data ss:Type="String">#numberformat(val(getamex.CS_PM_crcd)+val(getamex2.CS_PM_crcd),',_.__')#</Data></Cell>
          <Cell ss:StyleID="s26"><Data ss:Type="String"></Data></Cell>
          <Cell ss:StyleID="s26"><Data ss:Type="String">#numberformat(((val(getamex.CS_PM_crcd)+val(getamex2.CS_PM_crcd))/val(gettotal.CS_PM_crcd))*100,',_.__')#%</Data></Cell>
			</Row>
            
	     <Row ss:AutoFitHeight="0" ss:Height="20.0625">
          <Cell ss:StyleID="s26"><Data ss:Type="String">JCB</Data></Cell>
		  <Cell ss:StyleID="s26"><Data ss:Type="String">#numberformat(val(getjcb.CS_PM_crcd)+val(getjcb2.CS_PM_crcd),',_.__')#</Data></Cell>
          <Cell ss:StyleID="s26"><Data ss:Type="String"></Data></Cell>
          <Cell ss:StyleID="s26"><Data ss:Type="String">#numberformat(((val(getjcb.CS_PM_crcd)+val(getjcb2.CS_PM_crcd))/val(gettotal.CS_PM_crcd))*100,',_.__')#%</Data></Cell>
			</Row>
            
	     <Row ss:AutoFitHeight="0" ss:Height="20.0625">
          <Cell ss:StyleID="s26"><Data ss:Type="String">DINERS</Data></Cell>
		  <Cell ss:StyleID="s26"><Data ss:Type="String">#numberformat(val(getdiners.CS_PM_crcd)+val(getdiners2.CS_PM_crcd),',_.__')#</Data></Cell>
          <Cell ss:StyleID="s26"><Data ss:Type="String"></Data></Cell>
         <Cell ss:StyleID="s26"><Data ss:Type="String">#numberformat(((val(getdiners.CS_PM_crcd)+val(getdiners2.CS_PM_crcd))/val(gettotal.CS_PM_crcd))*100,',_.__')#%</Data></Cell>
			</Row>
		...
		<html>
		<head>
		<title>Invoice Cash Summary Report</title>
		...
		<table width="100%" border="0" cellspacing="0" cellpadding="2">
			<tr>
				<td colspan="100%"><div align="center"><font size="3" face="Times New Roman, Times, serif"><strong>Invoice Cash Summary Report</strong></font></div></td>
			</tr>
			<cfif form.periodfrom neq "" and form.periodto neq "">
			<tr>
            ...
            <tr>
            	<td><font size="2" face="Times New Roman, Times, serif">Nett Total :</font></td>
