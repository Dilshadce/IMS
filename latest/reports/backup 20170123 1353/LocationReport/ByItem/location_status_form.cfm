...
<cfset words_id_list = "1438,1440,495,496,123,146,497,498,1302,1417,1418,104,1354,1355,482,499,500,703,1361,1362,702,1300,1301,1406,1441,1407,501,1399,688">
...
<cfif url.type EQ "item_location">
	...
	<cfset formAction="location_status_result.cfm">
<cfelseif url.type EQ "location_item">  
    <cfset pageTitle = "#words[1440]#">              
	<cfset formAction="location_status_result2.cfm">  
</cfif>
...
<cfoutput>
	<cfform class="formContainer form3Button" name="location_listing_report" id="billListingForm" action="#formAction#" method="post" target="_blank">
		<div>#pageTitle#</div>
        <div>
            <table> 
            ...
            <th><label for="other">#words[688]#</label></th>
                <td>
                    <div><input type="checkbox" name="include0" id="include0" value="checkbox1" checked="checked">#words[1406]#</div>
                    <div><input type="checkbox" name="qty0" id="qty0" value="checkbox2">#words[1441]#</div>
                </td>
			</tr>
            <tr>
            <th></th>
                <td>
                    <div><input type="checkbox" name="dodate" id="dodate" value="checkbox3" checked="checked">#words[1407]#</div>
                </td>
			</tr>
