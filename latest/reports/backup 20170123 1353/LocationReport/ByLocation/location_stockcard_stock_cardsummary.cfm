...
<cfset words_id_list = "1458,123,495,496,146,497,498,1302,1417,1418,482,499,500,703,1361,1362,702,1300,1301,1406,1443,1407,501,1399,688">
...
<cfoutput>
	<cfform class="formContainer form3Button" name="location_listing_report" id="billListingForm" action="location_stockcard_stock_cardsummary1.cfm" method="post" target="_blank">
		<div>#pageTitle#</div>
        <div>
            <table> 
            ...
            <th><label for="other">#words[688]#</label></th>
                <td>
                    ...
                    <div><input type="checkbox" name="groupitem" id="groupitem" value="checkbox2"> #words[1443]#</div>
