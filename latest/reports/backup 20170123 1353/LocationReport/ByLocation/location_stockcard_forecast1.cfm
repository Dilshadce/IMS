...
<cfquery name="getictran" datasource="#dts#">
	...
	<cfif form.locationfrom eq "" and form.locationto eq "">
	group by b.itemno order by b.itemno
	</cfif>
</cfquery>

<cfif form.locationfrom neq "" and form.locationto neq "">
	<cfif lcase(hcomid) eq "mhca_i">Marketer<cfelse>Location</cfif> - <cfoutput>#form.locationfrom# - #form.locationto#</cfoutput>
<cfelse>
