...
<cfquery name="getgeneral" datasource="#dts#">
	select compro,singlelocation,lmodel from gsetup;
</cfquery>
...
<cfquery name="getexpresstran" datasource="#dts#">
select location,itemno,qtyactual from locadjtran where  location ='gwc'
</cfquery>
<cfset expresstranitem=valuelist(getexpresstran.itemno)>
...
<cfquery name="getiteminfo" datasource="#dts#">
	...
	(
		...
		(
            ...
            <!---
            <cfif huserid eq 'ultralung'>
    and itemno in (<cfqueryparam cfsqltype="cf_sql_varchar" list="yes" separator="," value="#expresstranitem#">)
    and location='gwc'
    </cfif>--->
    ...
    <!---
    <cfif huserid eq 'ultralung'>
    and a.itemno in (<cfqueryparam cfsqltype="cf_sql_varchar" list="yes" separator="," value="#expresstranitem#">)
    and b.location='gwc'
    </cfif>--->
...
<table align="center" class="data" width="100%" border="0" cellspacing="0">
	...
	<cfform name="location_physical_worksheet_adjust" action="location_physical_worksheet_update_stock.cfm" method="post">
		...
		<cfinput type="hidden" name="period" value="#form.periodfrom#">
		<cfinput type="hidden" name="target_date" value="#dateformat(form.dateFrom,'YYYY-MM-DD')#">
		<cfinput type="hidden" name="totalitem" value="#getiteminfo.recordcount#">
		
		<cfoutput query="getiteminfo">
			<tr onClick="javascript:document.location_physical_worksheet_adjust.actualqty#getiteminfo.currentrow#.select();" onMouseOut="javascript:this.style.backgroundColor='';" onMouseOver="javascript:this.style.backgroundColor='99FF00';">
				<td nowrap>
				...
				<td nowrap>
					...
					<div align="right"><cfinput type="text" id="actualqty#getiteminfo.currentrow#" name="actualqty#getiteminfo.currentrow#" value="#getiteminfo.locqactual#" size="5" message="Please Enter A Correct Quantity !" required="no" validate="float" onKeyUp="javascript:document.location_physical_worksheet_adjust.adjqty#getiteminfo.currentrow#.value=calculate_adjusted_qty(document.location_physical_worksheet_adjust.balance#getiteminfo.currentrow#.value,document.location_physical_worksheet_adjust.actualqty#getiteminfo.currentrow#.value);"></div>
				</td>
				<td nowrap>
