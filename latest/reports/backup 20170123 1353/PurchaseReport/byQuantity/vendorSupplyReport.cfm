...
<cfswitch expression="#form.result#">
	...
	<cfif trim(form.supplierfrom) neq "" and trim(form.supplierto) neq "">
		<cfwddx action = "cfml2wddx" input = "SUPP_NO: #form.supplierfrom# - #form.supplierto#" output = "wddxText">
		<Row ss:AutoFitHeight="0" ss:Height="20.0625">
			<Cell ss:MergeAcross="5" ss:StyleID="s24"><Data ss:Type="String">#wddxText#</Data></Cell>
		</Row>
	</cfif>
	...
	<cfif trim(form.productfrom) neq "" and trim(form.productto) neq "">
		<cfwddx action = "cfml2wddx" input = "ITEM_NO: #form.productfrom# - #form.productto#" output = "wddxText">
		<Row ss:AutoFitHeight="0" ss:Height="20.0625">
			<Cell ss:MergeAcross="5" ss:StyleID="s24"><Data ss:Type="String">#wddxText#</Data></Cell>
		</Row>
	</cfif>
    ...
    <cfheader name="Content-Disposition" value="inline; filename=ProductR_PV_Quantity_#huserid#.xls">
	...
	<table width="100%" border="0" cellspacing="0" cellpadding="2">
		...
		<cfif trim(form.supplierfrom) neq "" and trim(form.supplierto) neq "">
			<tr>
				<td colspan="6"><div align="center"><font size="2" face="Times New Roman, Times, serif">SUPP_NO: #form.supplierfrom# - #form.supplierto#</font></div></td>
			</tr>
		</cfif>
		<cfif trim(form.categoryfrom) neq "" and trim(form.categoryto) neq "">
			<tr>
				<td colspan="6"><div align="center"><font size="2" face="Times New Roman, Times, serif">CATEGORY: #form.categoryfrom# - #form.categoryto#</font></div></td>
			</tr>
		</cfif>
		<cfif trim(form.groupfrom) neq "" and trim(form.groupto) neq "">
			<tr>
		...
		<cfif trim(form.productfrom) neq "" and trim(form.productto) neq "">
			<tr>
				<td colspan="6"><div align="center"><font size="2" face="Times New Roman, Times, serif">ITEM_NO: #form.productfrom# - #form.productto#</font></div></td>
			</tr>
		</cfif>
		<tr>
