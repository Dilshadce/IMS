<cfquery name="getgeneral" datasource="#dts#">
	select compro,lastaccyear,wpitemtax from gsetup
</cfquery>
...
<cfswitch expression="#form.result#">
	...
	<Row ss:AutoFitHeight="0" ss:Height="20.0625">
		<Cell ss:MergeAcross="5" ss:StyleID="s26"><Data ss:Type="String"><cfif getgeneral.compro neq "">#Replace(getgeneral.compro, "&", "&amp;", "all")#</cfif></Data></Cell>
	...
	<cfset totalqty = 0>
		...
		<cfloop query="getitem">
			<cfif type eq 'RC'>
                ...
                <cfset subdiscount = subdiscount + val(getitem.disamt)>
                <cfelseif type eq 'PR'>
                <cfset subamt = subamt - val(getitem.amt)>
                <cfset subdiscount = subdiscount - val(getitem.disamt)>
                </cfif>
    ...
    select currcode from #target_apvend# where custno='#getgroup.custno#'
		...
		<Row ss:AutoFitHeight="0" ss:Height="12">
            ...
            <Cell ss:StyleID="s30"/>
            <Cell ss:StyleID="s30"/>
            <Cell ss:StyleID="s31"><Data ss:Type="Number">#subdiscount#</Data></Cell>
	...
	<Row ss:AutoFitHeight="0" ss:Height="12">
		...
		<Cell ss:StyleID="s33"><Data ss:Type="Number">#totaldiscount#</Data></Cell>
	...
	<table width="100%" border="0" cellspacing="0" cellpadding="2">
		<tr>
			<td colspan="9"><div align="center"><font size="3" face="Times New Roman, Times, serif"><strong>PURCHASE REPORT DETAIL (BY SUPPLIER)</strong></font></div></td>
		</tr>
		<cfif isdefined("form.periodfrom") and form.periodfrom neq "" and form.periodto neq "">
			<tr>
    ...
    select currcode from #target_apvend# where custno='#getgroup.custno#'
                    ...
                    <td><div align="right"><font size="2" face="Times New Roman, Times, serif">#numberformat(disamt,stDecl_UPrice)#</font></div></td>
            ...
            <cfif trim(form.categoryfrom) eq "" and trim(form.categoryto) eq "" and trim(form.productfrom) eq "" and trim(form.productto) eq "">
            ...
            <cfset totaldiscount = totaldiscount + subdiscount>
			...
			<tr>
				...
				<td><div align="right"><font size="2" face="Times New Roman, Times, serif"><cfif trim(form.categoryfrom) eq "" and trim(form.categoryto) eq "" and trim(form.productfrom) eq "" and trim(form.productto) eq "" and getgeneral.wpitemtax neq "1">#numberformat(getbill.net,stDecl_UPrice)#<cfelse>#numberformat(subamt,stDecl_UPrice)#</cfif></font></div></td>
			</tr>
		...
		<tr>
            ...
            <cfif lcase(hcomid) eq "vsolutionspteltd_i">
                ...
                <td></td>
           <td><div align="right"><font size="2" face="Times New Roman, Times, serif">#numberformat(totaldiscount,stDecl_UPrice)#</font></div></td>
