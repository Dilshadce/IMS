...
<cfquery name="getlocation" datasource="#dts#">
	...
	and b.category between <cfqueryparam cfsqltype="cf_sql_char" value="#form.categoryfrom#"> and <cfqueryparam cfsqltype="cf_sql_char" value="#form.categoryto#">
	</cfif>
	...
	and a.location =<cfqueryparam cfsqltype="cf_sql_char" value="#form.locationfrom#">
	</cfif>
     <cfelse>
	<cfif form.locationfrom neq "" and form.locationto neq "">
	and a.location between <cfqueryparam cfsqltype="cf_sql_char" value="#form.locationfrom#"> and <cfqueryparam cfsqltype="cf_sql_char" value="#form.locationto#">
	</cfif>
    </cfif>
	...
	and a.wos_date between <cfqueryparam cfsqltype="cf_sql_char" value="#ndatefrom#"> and <cfqueryparam cfsqltype="cf_sql_char" value="#ndateto#">
	<cfelse>
	...
	<cfif form.type eq "1">
		...
		<cfloop query="getlocation">
			...
			<cfquery name="getitem" datasource="#dts#">
				...
				<cfif trim(form.categoryfrom) neq "" and trim(form.categoryto) neq "">
				and aa.category between <cfqueryparam cfsqltype="cf_sql_char" value="#form.categoryfrom#"> and <cfqueryparam cfsqltype="cf_sql_char" value="#form.categoryto#">
				</cfif>
				<cfif trim(form.groupfrom) neq "" and trim(form.groupto) neq "">
...
<cfif form.type eq "1">
    ...
    <cfheader name="Content-Disposition" value="inline; filename=LocationR_ILS_#huserid#.xls">
