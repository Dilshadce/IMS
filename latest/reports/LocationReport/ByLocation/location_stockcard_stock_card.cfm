...
<cfoutput>
	<cfform class="formContainer form3Button" name="locationStockCardForm" id="locationStockCardForm" action="location_stockcard_stock_card1.cfm" method="post" target="_blank">
		<div>#pageTitle#</div>
        <div>
            <table> 
            ...
            <tr>
            	<th></th>
                <td>
                	<div><input type="checkbox" name="cbdetail" value="cbdetail"/> #words[1444]#</div>
                    <div><input type="checkbox" name="cbdate" value="cbdate" /> #words[1445]#</div>
                </td>
            </tr>
            </table>
		</div>
