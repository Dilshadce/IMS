...
<cfset words_id_list = "29, 1387, 1388, 517, 1483, 1484, 86, 1485, 1486, 67, 5, 1352, 1353, 703, 1361, 1362, 702, 1300, 1301, 2051, 2052, 2053">
...
<cfoutput>
	<cfform class="formContainer form3Button" name="statementForm" id="statementForm" action="statement.cfm" method="post" target="_blank">
		<div>#pageTitle#</div>
        <div>
            <table>
                ...
                <tr> 
                    ...
                    <td>
                        <input type="hidden" id="termFrom" name="termFrom" class="termFilter" data-placeholder="#words[2052]#" />
                        <input type="hidden" id="termTo" name="termTo" class="termFilter" placeholder="#words[2053]#" />
                    </td>
                </tr>
                <tr> 
