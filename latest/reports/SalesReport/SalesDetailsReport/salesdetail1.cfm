...
<cfswitch expression="#form.result#">
	...
	<table width="100%" border="0" cellspacing="0" cellpadding="2">
        ...
        <cfif trim(form.enduserfrom) neq "" and trim(form.enduserto) neq "">
			<tr>
            ...
            <cfset getitem.price=getitem.amt/getitem.qty>
				...
				<tr onMouseOut="javascript:this.style.backgroundColor='';" onMouseOver="javascript:this.style.backgroundColor='99FF00';">
                  ...
                  <!---  <cfif lcase(hcomid) eq "vsolutionspteltd_i" or lcase(hcomid) eq "vsyspteltd_i">
					...
					<td><div align="right"><font size="2" face="Times New Roman, Times, serif"><cfif type eq 'PR'>-</cfif>#numberformat(getitem.amt,stDecl_Amt)#</font></div></td>
				</tr>
