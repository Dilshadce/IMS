...
<cfset words_id_list = "29, 1387, 1388, 517, 1483, 1484, 86, 1485, 1486, 5, 1352, 1353, 703, 1361, 1362, 702, 1300, 1301, 688, 1406, 1977, 1978, 1979, 1921, 1922, 1924">
...
<cfif type eq "customertype">
	...
	<cfset pageTitle = "#words[1977]#">
    <cfset actionForm = "topsales1.cfm?trantype=#trantype#">
<cfelseif type eq "agenttype">
	<cfset trantype = "AGENT">	
	<cfset pageTitle = "#words[1978]#">
    <cfset actionForm = "topsales2.cfm?trantype=#trantype#">
<cfelseif type eq "areatype">
	<cfset trantype = "AREA">
	<cfset pageTitle = "#words[1979]#">
    <cfset actionForm = "topsales3.cfm?trantype=#trantype#">
</cfif>
        ...
        <div>
            <table>
                ...
                <cfif type eq "customertype">
                    ...
                    <tr>
                        <th><cfif type neq "customertype"><label for="other">#words[688]#</label></cfif></th>
                        <td>
