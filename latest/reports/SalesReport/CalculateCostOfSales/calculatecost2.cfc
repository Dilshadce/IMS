	...
	<cffunction name="calculate_month_average_cost">
		...
		<cfquery name="calculate_item_info" datasource="#arguments.dts#">
			...
			(
				...
				left join 
				(select itemno,sum(qty)as qty1,sum(if(taxincl="T",amt-taxamt,amt))as amt1 from ictran where fperiod='01' and (type='RC' or type='OAI' or type='CN') and (void = '' or void is null)  
                <cfif arguments.itemfrom neq "" and arguments.itemto neq "">
					and itemno between '#arguments.itemfrom#' and '#arguments.itemto#'
				</cfif>
                group by itemno) as b on a.itemno=b.itemno
				left join 
				(select itemno,sum(qty)as qty2,sum(if(taxincl="T",amt-taxamt,amt))as amt2 from ictran where fperiod='01' and type='PR' and (void = '' or void is null) 
                <cfif arguments.itemfrom neq "" and arguments.itemto neq "">
					and itemno between '#arguments.itemfrom#' and '#arguments.itemto#'
				</cfif>
			...
			(
				...
				left join 
				(select itemno,sum(qty)as qty1,sum(if(taxincl="T",amt-taxamt,amt))as amt1 from ictran where fperiod='02' and (type='RC' or type='OAI' or type='CN') and (void = '' or void is null) 
                <cfif arguments.itemfrom neq "" and arguments.itemto neq "">
					and itemno between '#arguments.itemfrom#' and '#arguments.itemto#'
				</cfif>
                group by itemno) as b on a.itemno=b.itemno
				left join 
				(select itemno,sum(qty)as qty2,sum(if(taxincl="T",amt-taxamt,amt))as amt2 from ictran where fperiod='02' and type='PR' and (void = '' or void is null) 
                <cfif arguments.itemfrom neq "" and arguments.itemto neq "">
					and itemno between '#arguments.itemfrom#' and '#arguments.itemto#'
				</cfif>
                group by itemno) as c on a.itemno=c.itemno 
			...
			(
				...
				left join 
				(select itemno,sum(qty)as qty1,sum(if(taxincl="T",amt-taxamt,amt))as amt1 from ictran where fperiod='03' and (type='RC' or type='OAI' or type='CN') and (void = '' or void is null) 
                <cfif arguments.itemfrom neq "" and arguments.itemto neq "">
					and itemno between '#arguments.itemfrom#' and '#arguments.itemto#'
				</cfif>
                group by itemno) as b on a.itemno=b.itemno
				left join 
				(select itemno,sum(qty)as qty2,sum(if(taxincl="T",amt-taxamt,amt))as amt2 from ictran where fperiod='03' and type='PR' and (void = '' or void is null) 
                <cfif arguments.itemfrom neq "" and arguments.itemto neq "">
					and itemno between '#arguments.itemfrom#' and '#arguments.itemto#'
				</cfif>
                group by itemno) as c on a.itemno=c.itemno 
			...
			(
				...
				left join 
				(select itemno,sum(qty)as qty1,sum(if(taxincl="T",amt-taxamt,amt))as amt1 from ictran where fperiod='04' and (type='RC' or type='OAI' or type='CN') and (void = '' or void is null) 
                <cfif arguments.itemfrom neq "" and arguments.itemto neq "">
					and itemno between '#arguments.itemfrom#' and '#arguments.itemto#'
				</cfif>
                group by itemno) as b on a.itemno=b.itemno
				left join 
				(select itemno,sum(qty)as qty2,sum(if(taxincl="T",amt-taxamt,amt))as amt2 from ictran where fperiod='04' and type='PR' and (void = '' or void is null) 
                <cfif arguments.itemfrom neq "" and arguments.itemto neq "">
					and itemno between '#arguments.itemfrom#' and '#arguments.itemto#'
				</cfif>
                group by itemno) as c on a.itemno=c.itemno 
			...
			(
				...
				left join 
				(select itemno,sum(qty)as qty1,sum(if(taxincl="T",amt-taxamt,amt))as amt1 from ictran where fperiod='05' and (type='RC' or type='OAI' or type='CN') and (void = '' or void is null) 
                <cfif arguments.itemfrom neq "" and arguments.itemto neq "">
					and itemno between '#arguments.itemfrom#' and '#arguments.itemto#'
				</cfif>
                group by itemno) as b on a.itemno=b.itemno
				left join 
				(select itemno,sum(qty)as qty2,sum(if(taxincl="T",amt-taxamt,amt))as amt2 from ictran where fperiod='05' and type='PR' and (void = '' or void is null) 
                <cfif arguments.itemfrom neq "" and arguments.itemto neq "">
					and itemno between '#arguments.itemfrom#' and '#arguments.itemto#'
				</cfif>
                group by itemno) as c on a.itemno=c.itemno 
			...
			(
				...
				left join 
				(select itemno,sum(qty)as qty1,sum(if(taxincl="T",amt-taxamt,amt))as amt1 from ictran where fperiod='06' and (type='RC' or type='OAI' or type='CN') and (void = '' or void is null) 
                <cfif arguments.itemfrom neq "" and arguments.itemto neq "">
					and itemno between '#arguments.itemfrom#' and '#arguments.itemto#'
				</cfif>
                group by itemno) as b on a.itemno=b.itemno
				left join 
				(select itemno,sum(qty)as qty2,sum(if(taxincl="T",amt-taxamt,amt))as amt2 from ictran where fperiod='06' and type='PR' and (void = '' or void is null) 
                <cfif arguments.itemfrom neq "" and arguments.itemto neq "">
					and itemno between '#arguments.itemfrom#' and '#arguments.itemto#'
				</cfif>
                group by itemno) as c on a.itemno=c.itemno 
			...
			(
				...
				left join 
				(select itemno,sum(qty)as qty1,sum(if(taxincl="T",amt-taxamt,amt))as amt1 from ictran where fperiod='07' and (type='RC' or type='OAI' or type='CN') and (void = '' or void is null) 
                <cfif arguments.itemfrom neq "" and arguments.itemto neq "">
					and itemno between '#arguments.itemfrom#' and '#arguments.itemto#'
				</cfif>
                group by itemno) as b on a.itemno=b.itemno
				left join 
				(select itemno,sum(qty)as qty2,sum(if(taxincl="T",amt-taxamt,amt))as amt2 from ictran where fperiod='07' and type='PR' and (void = '' or void is null) 
                <cfif arguments.itemfrom neq "" and arguments.itemto neq "">
					and itemno between '#arguments.itemfrom#' and '#arguments.itemto#'
				</cfif>
                group by itemno) as c on a.itemno=c.itemno 
			...
			(
				...
				left join 
				(select itemno,sum(qty)as qty1,sum(if(taxincl="T",amt-taxamt,amt))as amt1 from ictran where fperiod='08' and (type='RC' or type='OAI' or type='CN') and (void = '' or void is null) 
                <cfif arguments.itemfrom neq "" and arguments.itemto neq "">
					and itemno between '#arguments.itemfrom#' and '#arguments.itemto#'
				</cfif>
                group by itemno) as b on a.itemno=b.itemno
				left join 
				(select itemno,sum(qty)as qty2,sum(if(taxincl="T",amt-taxamt,amt))as amt2 from ictran where fperiod='08' and type='PR' and (void = '' or void is null) 
                <cfif arguments.itemfrom neq "" and arguments.itemto neq "">
					and itemno between '#arguments.itemfrom#' and '#arguments.itemto#'
				</cfif>
                group by itemno) as c on a.itemno=c.itemno 
			...
			(
				...
				left join 
				(select itemno,sum(qty)as qty1,sum(if(taxincl="T",amt-taxamt,amt))as amt1 from ictran where fperiod='09' and (type='RC' or type='OAI' or type='CN') and (void = '' or void is null) 
                <cfif arguments.itemfrom neq "" and arguments.itemto neq "">
					and itemno between '#arguments.itemfrom#' and '#arguments.itemto#'
				</cfif>
                group by itemno) as b on a.itemno=b.itemno
				left join 
				(select itemno,sum(qty)as qty2,sum(if(taxincl="T",amt-taxamt,amt))as amt2 from ictran where fperiod='09' and type='PR' and (void = '' or void is null) 
                <cfif arguments.itemfrom neq "" and arguments.itemto neq "">
					and itemno between '#arguments.itemfrom#' and '#arguments.itemto#'
				</cfif>
                group by itemno) as c on a.itemno=c.itemno 
			...
			(
				...
				left join 
				(select itemno,sum(qty)as qty1,sum(if(taxincl="T",amt-taxamt,amt))as amt1 from ictran where fperiod='10' and (type='RC' or type='OAI' or type='CN') and (void = '' or void is null) 
                <cfif arguments.itemfrom neq "" and arguments.itemto neq "">
					and itemno between '#arguments.itemfrom#' and '#arguments.itemto#'
				</cfif>
                group by itemno) as b on a.itemno=b.itemno
				left join 
				(select itemno,sum(qty)as qty2,sum(if(taxincl="T",amt-taxamt,amt))as amt2 from ictran where fperiod='10' and type='PR' and (void = '' or void is null) 
                <cfif arguments.itemfrom neq "" and arguments.itemto neq "">
					and itemno between '#arguments.itemfrom#' and '#arguments.itemto#'
				</cfif>
                group by itemno) as c on a.itemno=c.itemno 
			...
			(
				...
				left join 
				(select itemno,sum(qty)as qty1,sum(if(taxincl="T",amt-taxamt,amt))as amt1 from ictran where fperiod='11' and (type='RC' or type='OAI' or type='CN') and (void = '' or void is null) 
                <cfif arguments.itemfrom neq "" and arguments.itemto neq "">
					and itemno between '#arguments.itemfrom#' and '#arguments.itemto#'
				</cfif>
                group by itemno) as b on a.itemno=b.itemno
				left join 
				(select itemno,sum(qty)as qty2,sum(if(taxincl="T",amt-taxamt,amt))as amt2 from ictran where fperiod='11' and type='PR' and (void = '' or void is null) 
                <cfif arguments.itemfrom neq "" and arguments.itemto neq "">
					and itemno between '#arguments.itemfrom#' and '#arguments.itemto#'
				</cfif>
                group by itemno) as c on a.itemno=c.itemno 
			...
			(
				...
				left join 
				(select itemno,sum(qty)as qty1,sum(if(taxincl="T",amt-taxamt,amt))as amt1 from ictran where fperiod='12' and (type='RC' or type='OAI' or type='CN') and (void = '' or void is null) 
                <cfif arguments.itemfrom neq "" and arguments.itemto neq "">
					and itemno between '#arguments.itemfrom#' and '#arguments.itemto#'
				</cfif>
                group by itemno) as b on a.itemno=b.itemno
				left join 
				(select itemno,sum(qty)as qty2,sum(if(taxincl="T",amt-taxamt,amt))as amt2 from ictran where fperiod='12' and type='PR' and (void = '' or void is null) 
                <cfif arguments.itemfrom neq "" and arguments.itemto neq "">
					and itemno between '#arguments.itemfrom#' and '#arguments.itemto#'
				</cfif>
                group by itemno) as c on a.itemno=c.itemno 
			...
			(
				...
				left join 
				(select itemno,sum(qty)as qty1,sum(if(taxincl="T",amt-taxamt,amt))as amt1 from ictran where fperiod='13' and (type='RC' or type='OAI' or type='CN') and (void = '' or void is null) 
                <cfif arguments.itemfrom neq "" and arguments.itemto neq "">
					and itemno between '#arguments.itemfrom#' and '#arguments.itemto#'
				</cfif>
                group by itemno) as b on a.itemno=b.itemno
				left join 
				(select itemno,sum(qty)as qty2,sum(if(taxincl="T",amt-taxamt,amt))as amt2 from ictran where fperiod='13' and type='PR' and (void = '' or void is null) 
                <cfif arguments.itemfrom neq "" and arguments.itemto neq "">
					and itemno between '#arguments.itemfrom#' and '#arguments.itemto#'
				</cfif>
                group by itemno) as c on a.itemno=c.itemno 
			...
			(
				...
				left join 
				(select itemno,sum(qty)as qty1,sum(if(taxincl="T",amt-taxamt,amt))as amt1 from ictran where fperiod='14' and (type='RC' or type='OAI' or type='CN') and (void = '' or void is null) 
                <cfif arguments.itemfrom neq "" and arguments.itemto neq "">
					and itemno between '#arguments.itemfrom#' and '#arguments.itemto#'
				</cfif>
                group by itemno) as b on a.itemno=b.itemno
				left join 
				(select itemno,sum(qty)as qty2,sum(if(taxincl="T",amt-taxamt,amt))as amt2 from ictran where fperiod='14' and type='PR' and (void = '' or void is null) 
                <cfif arguments.itemfrom neq "" and arguments.itemto neq "">
					and itemno between '#arguments.itemfrom#' and '#arguments.itemto#'
				</cfif>
                group by itemno) as c on a.itemno=c.itemno 
			...
			(
				...
				left join 
				(select itemno,sum(qty)as qty1,sum(if(taxincl="T",amt-taxamt,amt))as amt1 from ictran where fperiod='15' and (type='RC' or type='OAI' or type='CN') and (void = '' or void is null) 
                <cfif arguments.itemfrom neq "" and arguments.itemto neq "">
					and itemno between '#arguments.itemfrom#' and '#arguments.itemto#'
				</cfif>
                group by itemno) as b on a.itemno=b.itemno
				left join 
				(select itemno,sum(qty)as qty2,sum(if(taxincl="T",amt-taxamt,amt))as amt2 from ictran where fperiod='15' and type='PR' and (void = '' or void is null) 
                <cfif arguments.itemfrom neq "" and arguments.itemto neq "">
					and itemno between '#arguments.itemfrom#' and '#arguments.itemto#'
				</cfif>
                group by itemno) as c on a.itemno=c.itemno 
			...
			(
				...
				left join 
				(select itemno,sum(qty)as qty1,sum(if(taxincl="T",amt-taxamt,amt))as amt1 from ictran where fperiod='16' and (type='RC' or type='OAI' or type='CN') and (void = '' or void is null) 
                <cfif arguments.itemfrom neq "" and arguments.itemto neq "">
					and itemno between '#arguments.itemfrom#' and '#arguments.itemto#'
				</cfif>
                group by itemno) as b on a.itemno=b.itemno
				left join 
				(select itemno,sum(qty)as qty2,sum(if(taxincl="T",amt-taxamt,amt))as amt2 from ictran where fperiod='16' and type='PR' and (void = '' or void is null) 
                <cfif arguments.itemfrom neq "" and arguments.itemto neq "">
					and itemno between '#arguments.itemfrom#' and '#arguments.itemto#'
				</cfif>
                group by itemno) as c on a.itemno=c.itemno 
			...
			(
				...
				left join 
				(select itemno,sum(qty)as qty1,sum(if(taxincl="T",amt-taxamt,amt))as amt1 from ictran where fperiod='17' and (type='RC' or type='OAI' or type='CN') and (void = '' or void is null) 
                <cfif arguments.itemfrom neq "" and arguments.itemto neq "">
					and itemno between '#arguments.itemfrom#' and '#arguments.itemto#'
				</cfif>
                group by itemno) as b on a.itemno=b.itemno
				left join 
				(select itemno,sum(qty)as qty2,sum(if(taxincl="T",amt-taxamt,amt))as amt2 from ictran where fperiod='17' and type='PR' and (void = '' or void is null) 
                <cfif arguments.itemfrom neq "" and arguments.itemto neq "">
					and itemno between '#arguments.itemfrom#' and '#arguments.itemto#'
				</cfif>
                group by itemno) as c on a.itemno=c.itemno 
			...
			(
				...
				left join 
				(select itemno,sum(qty)as qty1,sum(if(taxincl="T",amt-taxamt,amt))as amt1 from ictran where fperiod='18' and (type='RC' or type='OAI' or type='CN') and (void = '' or void is null) 
                <cfif arguments.itemfrom neq "" and arguments.itemto neq "">
					and itemno between '#arguments.itemfrom#' and '#arguments.itemto#'
				</cfif>
                group by itemno) as b on a.itemno=b.itemno
				left join 
				(select itemno,sum(qty)as qty2,sum(if(taxincl="T",amt-taxamt,amt))as amt2 from ictran where fperiod='18' and type='PR' and (void = '' or void is null) 
                <cfif arguments.itemfrom neq "" and arguments.itemto neq "">
					and itemno between '#arguments.itemfrom#' and '#arguments.itemto#'
				</cfif>
                group by itemno) as c on a.itemno=c.itemno 
        ...
        <cfset lastremainqty=xremainqty>
        <cfset xremainqty=xremainqty+xinqty-xoutqty>
        
		<cfset xavamt=xavamt+xinamt>
		
		<cfif currentqtytotal gt 0>
        <cfif lastremainqty gt 0>
        <cfif currentqtytotal neq 0>
        <cfset currentmonthxavcost=xavamt/currentqtytotal>
        <cfelse>
        <cfset currentmonthxavcost=xavamt>
        </cfif>
        <cfelse>
        <!---New condition on 20140923--->
		<cfif xinqty neq 0>
		<cfset currentmonthxavcost=xavamt/xinqty>
        <cfelse>
        <cfset currentmonthxavcost=xavamt>
        </cfif>
        </cfif>
        ...
        <cfif xremainqty gt 0>
        	<cfif currentqtytotal NEQ 0>
        		<cfset variableQtyTotal = currentqtytotal> 
            <cfelse>
            	<cfset variableQtyTotal = 1> 
            </cfif>
            <cfif lastremainqty gt 0>
            <cfset xavcost=val(xavamt)/val(variableQtyTotal)>
            <cfelse>
        	<cfset xavcost=val(xavamt)/val(xinqty)>
        	</cfif>
        <cfelse>
        <cfset xavcost=0>
        </cfif>
       <!---  <cfoutput>
        #xremainqty#-#xavamt# -#currentqtytotal# -#currentmonthxavcost#<br>
        </cfoutput> --->
