...
<cfquery name="getdisplaysetup" datasource="#dts#">
  ...
  <Row ss:AutoFitHeight="0" ss:Height="20.0625">
    	...
    	<Cell ss:MergeAcross="#c#" ss:StyleID="s24"><Data ss:Type="String">MONTH: #dateformat(fccurr,"mmm yy")#</Data></Cell>
    </Row>
  ...
  <Row ss:AutoFitHeight="0" ss:Height="20.0625">
  		   <cfwddx action = "cfml2wddx" input = "#form.productfrom# - #form.productto#" output = "wddxText5">
          	<Cell ss:StyleID="s26"><Data ss:Type="String">PRODUCT NO: #wddxText5#</Data></Cell>
        </Row>
    </cfif>
  <Row ss:AutoFitHeight="0" ss:Height="20.0625">
  ...
  <Row ss:AutoFitHeight="0" ss:Height="20.0625">
		...
		<Cell ss:StyleID="s51"><Data ss:Type="String">PRODUCT NO.</Data></Cell>
