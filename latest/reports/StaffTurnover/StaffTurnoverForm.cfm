...
<cfset consignment=''>
	<cfset pageTitle = "Staff Turnover Report">
...
<cfoutput>
	<cfform class="formContainer form3Button" name="StaffTurnoverForm" id="StaffTurnoverForm" action="StaffTurnoverReport.cfm" method="post" target="_blank">
        <div>#pageTitle#</div>
        <div>
        <table>
