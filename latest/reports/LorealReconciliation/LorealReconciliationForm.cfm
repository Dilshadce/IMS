...
<cfset consignment=''>
	<cfset pageTitle = "Reconciliation Report">
...
<cfoutput>
	<cfform class="formContainer form3Button" name="ReconciliationForm" id="ReconciliationForm" action="LorealReconciliationReport.cfm" method="post" target="_blank">
        <div>#pageTitle#</div>
        <div>
        <table>
            ...
            <tr>
                ...
                <td>
                    <select name="jobpostype" id="jobpostype">
                        <option value="3,5">Perm</option>
                        <option value="1,2">Temp</option>
                    </select>
                </td>
            </tr>
