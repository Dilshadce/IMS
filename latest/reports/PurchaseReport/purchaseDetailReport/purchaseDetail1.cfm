...
<cfswitch expression="#form.result#">
    ...
    <cfset iDecl_Amt = getgsetup2.Decl_totalamt>
	<cfset stDecl_UPrice = "">
    <cfset stDecl_Amt = "">

	<cfloop index="LoopCount" from="1" to="#iDecl_Amt#">
		<cfset stDecl_Amt = stDecl_Amt & "0">
	</cfloop>
	...
	<cfquery name="getgroup" datasource="#dts#">
		SELECT a.refno,a.itemno,a.desp,a.type,a.custno, a.name from ictran AS a
	...
	<NumberFormat ss:Format="#,###,###,##0.<cfoutput>#trim(stDecl_amt)#</cfoutput>"/>
	</Style>
	<Style ss:ID="s32">
    ...
    select currcode from #target_apvend# where custno='#getitem.custno#'
        ...
        <Cell ss:StyleID="s30"><Data ss:Type="String">SUB-TOTAL</Data></Cell>
			...
			<Cell ss:StyleID="s38"><Data ss:Type="Number">#subamt#</Data></Cell>
		</Row>
		<Row ss:AutoFitHeight="0" ss:Height="12"/>
	</cfloop>
	<Row ss:AutoFitHeight="0" ss:Height="12">
	...
	<table width="100%" border="0" cellspacing="0" cellpadding="2">
		<tr>
			<td colspan="9"><div align="center"><font size="3" face="Times New Roman, Times, serif"><strong>PURCHASE REPORT DETAIL (By ITEM)</strong></font></div></td>
		</tr>
		<cfif isdefined("form.periodfrom") and form.periodfrom neq "" and form.periodto neq "">
			<tr>
    ...
    select currcode from #target_apvend# where custno='#getitem.custno#'
					...
					<td><div align="right"><font size="2" face="Times New Roman, Times, serif"><cfif type eq 'PR'>-</cfif>#numberformat(amt,stDecl_amt)#</font></div></td>
				</tr>
			...
			<tr>
                ...
                <td></td>
				<td><div align="right"><font size="2" face="Times New Roman, Times, serif">#numberformat(subamt,stDecl_amt)#</font></div></td>
			</tr>
