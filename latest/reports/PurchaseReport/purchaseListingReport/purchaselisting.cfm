...
<cfset words_id_list = "104, 1354, 1355, 29, 1387, 1388, 86, 1485, 1486, 703, 1361, 1362, 702, 1300, 1301, 1992">
...
<cfoutput>
	<cfform class="formContainer form2Button" name="byTypeForm" id="byTypeForm" action="purchaselisting1.cfm" method="post" target="_blank">
        <div>#pageTitle#</div>
        <div>
        <table> 
