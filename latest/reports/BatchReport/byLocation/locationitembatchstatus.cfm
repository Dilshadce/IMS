...
<cfswitch expression="#form.result#">
	...
	<Row ss:AutoFitHeight="0" ss:Height="23.0625">
		<Cell ss:MergeAcross="7" ss:StyleID="s22"><Data ss:Type="String">Print Location Product <cfif checkcustom.customcompany eq "Y">- Lot Number<cfelse>Batch</cfif> Status Report</Data></Cell>
	</Row>

	<cfif form.datefrom neq "" and form.dateto neq "">
		<cfwddx action = "cfml2wddx" input = "EXPIRE DATE: #form.datefrom# - #form.dateto#" output = "wddxText">
	...
	<cfloop query="getlocation">
		...
		<cfquery name="getitem" datasource="#dts#">
			...
			<cfif trim(form.categoryfrom) neq "" and trim(form.categoryto) neq "">
				and f.category between '#form.categoryfrom#' and '#form.categoryto#'
			</cfif>
			<cfif trim(form.groupfrom) neq "" and trim(form.groupto) neq "">
...
<cfquery name="getunit" datasource="#dts#">
    ...
    <cfheader name="Content-Disposition" value="inline; filename=BatchCodeR_LIBStatus_#huserid#.xls">
...
--->
	...
	<html>
	<head>
	<title>Location Product Batch Status Report</title>
	...
	<cfquery name="getlocation" datasource="#dts#">
		...
		<cfif form.datefrom neq "" and form.dateto neq "">
			and b.exp_date between '#dateformatnew(form.datefrom,'YYYY-MM-DD')#' and '#dateformatnew(form.dateto,'YYYY-MM-DD')#'
		</cfif>
		<cfif checkcustom.customcompany eq "Y">
			<cfif trim(form.permitno) neq "">
	...
	<table width="100%" border="0" cellspacing="1" cellpadding="2">
		<tr>
			<td colspan="100%"><div align="center"><font size="3" face="Times New Roman, Times, serif"><strong>Print Location Product <cfif checkcustom.customcompany eq "Y">- Lot Number<cfelse>Batch</cfif> Status Report</strong></font></div></td>
		</tr>
		<cfif form.datefrom neq "" and form.dateto neq "">
			<tr>
				<td colspan="100%"><div align="center"><font size="2" face="Times New Roman, Times, serif">EXPIRE DATE: #form.datefrom# - #form.dateto#</font></div></td>
			</tr>
		</cfif>
		<cfif form.batchcodefrom neq "" and form.batchcodeto neq "">
			<tr>
