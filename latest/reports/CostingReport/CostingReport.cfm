...
(CASE WHEN billitem1 = '17' then billitemamt1 else 0 end +
CASE when billitem2 = '17' then billitemamt2 else 0 end +
CASE when billitem3 = '17' then billitemamt3 else 0 end +
CASE when billitem4 = '17' then billitemamt4 else 0 end +
CASE when billitem5 = '17' then billitemamt5 else 0 end +
CASE when billitem6 = '17' then billitemamt6 else 0 end) as medical,
...
<cfswitch expression="#form.result#">
	<cfcase value="EXCEL">
        ...
        <cfelseif isdefined('PUIG') eq true>
			...
			"AL in Lieu","Unpaid Leave","Notice in Lieu","Disbursement","","Outsource Fee","Other Admin Fee","Commission","Deposit Deduction",
			"Professional Fee","Recruitment Fee","SOCSO OT","Day Shift Allowance",
			"Language Allowance","Advance Pay","Pay Adjustment","OT Adjustment","Piece Work","Consultancy Fee","Ex-Gratia","Fluctuation Service Fee","Grooming Allowance","Perfect Attendance","Phone allowance","Scope Allowance","Technical Allowance","Training fee","Transport Charges","Travel Claims",
            "Transport Allowance",
            "Operations allowance",
            "Inconvenience allowance",
            "Chargeman allowance",
            ...
            "Laundry Allowance",
            "Background Check",
            "Miscellaneous","Others-Sub Total","Admin Fee","Total",
					...
					<cfscript>
                        ...
                        if(isdefined('form.fieldglass') == true){
                            ...
                            getCostingQuery.site,
                                    ...
                                    findItem(143,getCostingQuery),  // Transport Allowance
                                    findItem(137,getCostingQuery),  // Operations Allowance
                                    findItem(138,getCostingQuery),  // Inconvenience Allowance
                                    findItem(139,getCostingQuery),  // Chargeman Allowance
                                    findItem(140,getCostingQuery),  // ROC shift Allowance
                                    findItem(141,getCostingQuery),  // Site safety manager Allowance
                                    findItem(142,getCostingQuery),  // Car Allowance
                                    findItem(144,getCostingQuery),  // Laundry Allowance
                                    findItem(96,getCostingQuery),  // Background Check
									taxable,
									nonTaxable,
									val(gst),
