...
<cfswitch expression="#form.result#">
	...
	<cfquery name="getgroup" datasource="#dts#">
        ...
        <cfif url.alown eq 1>
						<cfif getgeneral.agentlistuserid eq "Y">and ucase(b.agenno) in (SELECT agent FROM icagent WHERE agentlist like "%#ucase(huserid)#%")
						<cfelse>
    ...
    <cfheader name="Content-Disposition" value="inline; filename=ItemSaleRType_PC_Sales_#huserid#.xls">
...
--->
	...
	<html>
	<head>
	<title>Cust/Supp/Agent/Area Product Report</title>
