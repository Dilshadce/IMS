...
SELECT custno,name,name2,add1,add2,add3,add4,arrem1,arrem2,arrem3,arrem4 from #target_arcust# order by created_on desc
</cfquery>
...
<cfoutput>
<cfform action="createvehprocess.cfm" method="post" name="createvehform">
<table width="750">
<tr>
<th>Customer Code</th>
<td colspan="3">
<cfselect name="custcode" id="custcode" required="yes" message="Customer Code Is Required" onChange="ajaxFunction(document.getElementById('ajaxField1'),'addvehicleAjax.cfm?custno='+document.getElementById('custcode').value);">
<option value="">Please select a customer</option>
<cfloop query="getcust">
<cfset namefull = getcust.name&" "&getcust.name2 >
<cfset addfull = getcust.add1&" "&getcust.add2&" "&getcust.add3&" "&getcust.add4 >
<option value="#getcust.custno#" id="#namefull#" title="#addfull#" >#getcust.custno#-#getcust.name#</option>
</cfloop>
</cfselect><img src="/images/find.jpg" width="20" height="14.5" onClick="javascript:ColdFusion.Window.show('findCustomer');" /></td>
</tr></table>
<div id="ajaxField1" name="ajaxField1">
<table>
<tr>
<th width="100px">Customer Name</th>
<td width="150px"><input type="text" name="custname" id="custname" value="" /></td>
<th width="100px">Customer IC</th>
<td width="150px"><input type="text" name="custic" id="custic" value="" /></td>
</tr>
<tr>
  <th>Customer Address</th>
  <td colspan="3">
  <textarea name="custadd" id="custadd" cols="55" rows="2">
  </textarea>  </td> 
</tr>
<tr>
  <th>Email Address</th>
...
<tr>
<th>License Date</th>
<td><input type="text" name="licdate" id="licdate" value="" />&nbsp;<img src="/images/cal.gif" width=17 height=15 border=0 onClick="showCalendarControl(licdate);"> (DD/MM/YYYY)</td>
<th>Vehicle Number</th>
<td><cfinput type="text" name="carno" id="carno" required="yes" message="Vehicles No is Required" /></td>  
</tr>
<tr>
  <th>NCD</th>
  <td>
...
<td><input type="text" name="inexpdate" id="inexpdate" value="" />
  &nbsp;<img src="/images/cal.gif" width=17 height=15 border=0 onclick="showCalendarControl(inexpdate);" /> (DD/MM/YYYY)</td>
</tr>
<tr>
<th>Market Value</th>
<td>
...
<input type="radio" name="suminsured" id="suminsured" value="3" />2.
...
<input type="radio" name="commission" id="commission" value="2" />2.
<input type="text" name="commission2" id="commission2" value=""></td></tr><tr>
<th>Referred By</th>
<td><input type="text" name="referred" id="referred" value=""></td>
...
<th>Excess</th>
<td><input type="text" name="excess" id="excess" value="" /></td>
