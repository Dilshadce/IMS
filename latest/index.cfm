...
<head>
    ...
    <title>Netiquette Inventory Management System</title>
    <link rel="shortcut icon" href="/IMS.ico" />
</head>

<cfoutput>
	<cfif husergrpid NEQ 'super' AND dts EQ 'trialmy_i'>
        ...
        <cfif getPasswordHistory.recordcount EQ 0> 
            <script type="text/javascript">
                alert('Welcome On Board IMS!! You are required to change your password....');
                window.open('../latest/generalSetup/userMaintenance/changePassword.cfm?fromMainPage=1','_self');
            </script>
            <cfabort>
        </cfif> 
