...
<cfoutput>
	<form action="location_opening_qty_maintenance_search_location.cfm" method="post">
...
<cfif isdefined("form.searchStr")>
	...
	<cfif exactResult.recordCount neq 0>
		<table align="center" class="data" width="550px">					
			...
			<form action="location_opening_qty_maintenance.cfm?modeaction=add" name="done" method="post">
				<cfoutput>
				<input type="hidden" name="items" value="#items#">
				<input type="hidden" name="qtybf" value="#qtybf#">
				<input type="hidden" name="minimum" value="#minimum#">
			...
			<cfoutput query="exactResult">
				<tr>
					...
					<td>
						<input type="submit" name="select1" value="#exactResult.location#" style="background-color:##CCCCFF; border-color:##CCCCFF; border-style:none">
					</td>
				</tr>
	    	</cfoutput>
			</form>
