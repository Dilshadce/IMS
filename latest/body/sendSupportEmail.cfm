...
<cfset userGrpID=form.userGrpID>
...
<cftry>
    <cfmail to="support@mynetiquette.com" from="noreply@mynetiquette.com" subject="[IMS ASIA CUSTOMER SUPPORT REQUEST] - #subject#" type="html">
            <p>Company ID: #companyid#</p>
            <p>User ID: #userID#</p>
            <p>User Level: #userGrpID#</p>
            <p>User Email: #userEmail#</p>
            <p>Subject: #subject#</p>
            <p>Description: #description#</p>
            <p>Attachments:
                            <cfif attachmentsNumber GT 0>
                                There are total #attachmentsNumber# attachments. <em>Please see attached files</em>
                            <cfelse>
                                No attachement.
                            </cfif>
            </p>
