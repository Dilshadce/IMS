...
and itemid = <cfqueryparam cfsqltype="cf_sql_varchar" value="#itemid#" />
    ...
    <cfquery name="getpriceiddetail" datasource="#dts#">
			INSERT INTO manpowerpricematrixdetail (priceid, itemid, itemname, trancode, payable, billable, payadminfee, billadminfee, payableamt, billableamt, created_by, created_on,saf,statutoryBillingType)
			VALUES
			(
			...
			<cfqueryparam cfsqltype="cf_sql_varchar" value="#statutoryBillingType#" />
			)
