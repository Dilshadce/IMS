...
<body>
	<div class="container">
        ...
        <cfset thList = "Category,On / Off,Day(s) Before Closing,Frequency">
        <cfset settingNo = 1>       
                        ...
                        <div role="tabpanel" class="tab-pane <cfif i EQ "Timesheet">active</cfif>" id="#i#" style="margin-top:50px">
                       		<div class="panel">
                                <div class="panel panel-default">
                                    <div class="panel-heading" data-toggle="collapse" href="###i#EmailTemplate">
                                        <h4 class="panel-title accordion-toggle">#i# Notification Email Content Template</h4>
                                    </div>                
                                    <div class="panel-collapse collapse in" id="#i#EmailTemplate" >
                                        <div class="panel-body">
                                            <textarea class="form-control" id="#i#Template" name="#i#Template" style="width:100%">#Evaluate('getNotiSetting.#i#Template')#</textarea>
                                        </div>
                                    </div>
                                </div>                            
                                
                                <div class="panel panel-default">
                                    <div class="panel-heading" data-toggle="collapse" href="##tsNotiCat">
                                        <h4 class="panel-title accordion-toggle">#i# Notification Categories</h4>
                                    </div>                
                                    <div class="panel-collapse collapse in" id="tsNotiCat">
                                        <div class="panel-body">
                                            <table class="table table-bordered table-hover" style="width:100%">
                                                <thead>
                                                	<cfloop list="#thList#" delimiters="," index="i">
                                                        ...
                                                        <cfelseif i EQ "On / Off">
                                                        	<cfset perc = "10">
                                                        <cfelseif i EQ "Days Before Closing">
                                                        	<cfset perc = "15">
                                                ...
                                                <tbody>                                              
                                                    <cfloop list="#cateList#" delimiters="," index="i">
                                                        <tr>
                                                            <td>#i#</td>
                                                            <td  align="center"><input type="checkbox" id="setting#settingNo#" name="setting#settingNo#" data-toggle="toggle" <cfif Evaluate("getNotiSetting.setting#settingNo#") EQ "Y">checked</cfif>></td>
                                                            <td> <input type="number" class="form-control" id="days#settingNo#" name="days#settingNo#" placeholder="Day(s) Before Closing" value="#Evaluate('getNotiSetting.days#settingNo#')#" style="text-align:right" /></td>
                                                            <td>
                                                                <div class="input-group">
                                                                    <span class="input-group-addon">
                                                                        <span>Every</span>
                                                                    </span>                                       										
                                                                    <input type="number" class="form-control input-sm" id="hours#settingNo#" name="hours#settingNo#" placeholder="Frequency" value="#Evaluate('getNotiSetting.hours#settingNo#')#" style="text-align:right" />
                                                                    <span class="input-group-addon">
                                                                        <span>Hour(s)</span>
                                                                    </span>
                                                                </div>                                           
