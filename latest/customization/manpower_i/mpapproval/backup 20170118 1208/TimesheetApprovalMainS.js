	...
	var resultTable1=$('#resultTable1')
		.dataTable({
			...
			'aoColumnDefs':[
				...
				{'aTargets':[9],'sTitle':'MONTH','mData':'id','bSortable':true,'sWidth':'15%',
				'mRender':function(data,type,object){
						return ''+object.tmonth+'';
					}
				
				},
				{'aTargets':[10],'sTitle':'DATE START','mData':'id','bSortable':true,'sWidth':'15%',
				'mRender':function(data,type,object){
						return ''+object.first+'';
					}
				
				},
				{'aTargets':[11],'sTitle':'DATE END','mData':'id','bSortable':true,'sWidth':'15%',
				'mRender':function(data,type,object){
						return ''+object.last+'';
					}
				
				},
				{'aTargets':[12],'sTitle':'TIMESHEET','mData':'id','bSortable':true,'sWidth':'15%',
				'mRender':function(data,type,object){
				...
				{'aTargets':[13],'sTitle':'HM REMARKS','mData':'id','bSortable':true,'sWidth':'15%',
				'mRender':function(data,type,object){
						return ''+object.MGMTREMARKS+'';
					}
				
				},
				{'aTargets':[14],'sTitle':'MP REMARKS','mData':'id','bSortable':true,'sWidth':'15%',
				'mRender':function(data,type,object){
						return ''+object.mpremarks+'';
					}
			...
			'sAjaxSource':'/latest/customization/manpower_i/mpapproval/TimesheetApprovalMainS.cfc',
			'sServerMethod':'POST',
        	'sScrollX':'100%'
		})
		.fadeIn();
