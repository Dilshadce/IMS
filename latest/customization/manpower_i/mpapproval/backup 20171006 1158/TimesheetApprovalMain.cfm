...
<!---         <td align="center" valign="top">Pending</td> --->
        ...
        <table>
            ...
            <td valign="top">
            	 <a href="##" onclick="if(document.getElementById('management_#getposlist.tmonth#_#getposlist.placementno#').value == ''){alert('Please fill in the reason in Cancel Remarks to cancel')}else{confirmDecline('dec','#getposlist.tmonth#','#getposlist.placementno#')}"><img height="30px" width="30px" src="/images/2.jpg" alt="Approve" border="0"><br/>Cancel</a>
            </td>        
            </tr>
        </table>
