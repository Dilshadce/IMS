...
<cfquery datasource="#dts#">UPDATE manpower_i.manpowerpricematrix SET foreignerEPFType = #form.foreignerEPFType# WHERE priceid = #form.priceID#</cfquery>
	<cfif structKeyExists(form,'statutoryBillingType') >
    	<cfquery datasource="#dts#">UPDATE manpower_i.manpowerpricematrix SET statutoryBillingType = 'Y' WHERE priceid = #form.priceID#</cfquery>
    <cfelse>
    	<cfquery datasource="#dts#">UPDATE manpower_i.manpowerpricematrix SET statutoryBillingType = 'N' WHERE priceid = #form.priceID#</cfquery>
    </cfif>
</cfif>
