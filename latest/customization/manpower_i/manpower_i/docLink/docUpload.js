	...
	var resultTable=$('#resultTable')
		.dataTable({
			...
			'aoColumnDefs':[
				...
				{'aTargets':[1],'sTitle':fileName.toUpperCase(),'mData':'name','bSortable':true,'sWidth':'40%'},
				{'aTargets':[2],'sTitle':uploadedBy.toUpperCase(),'mData':'uploaded_by','bSortable':true,'sWidth':'15%'},
				{'aTargets':[3],'sTitle':uploadedOn.toUpperCase(),'mData':'uploaded_on','bSortable':true,'sWidth':'15%'},
				{
					'aTargets':[4],
