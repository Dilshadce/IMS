<cfset targetTitle="Document Type Profile">
<cfset targetTable="doctype">
<cfset pageTitle="Document Type Profile">
...
<head>
    ...
    <script type="text/javascript" src="/latest/customization/manpower_i/docMgmt/docType.js"></script>
</head>
		...
		<div class="page-header">
			<h2>
				...
				<div class="pull-right">			
						<button type="button" class="btn btn-default" onclick="window.open('/latest/customization/manpower_i/docMgmt/docTypeDetail.cfm?action=create','_self');">
							<span class="glyphicon glyphicon-plus"></span> New Document Type
						</button>               
					
						<button type="button" class="btn btn-default" onclick="window.open('/latest/customization/manpower_i/docMgmt/docTypeProcess.cfm?action=print','_blank');">
