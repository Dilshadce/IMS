							...
							<div class="row">
								<div class="col-sm-6">      
                                    ...
                                    <div class="form-group">
										...
										<div class="col-sm-8">
											<cfinput type="text" class="form-control input-sm" id="desp" name="desp" value="#desp#" placeholder="#words[65]#">								
						...
						<div class="panel-body">
							<div class="row">
                                ...
                                <div class="col-sm-6">                                        
                                    ...
                                    <div class="form-group">
										<label for="stock" class="col-sm-4 control-label">#words[189]#</label>
										<div class="col-sm-8">
							...
							<div class="row">
                                <div class="col-sm-6">    
                                	<div class="form-group">
										...
										<div class="col-sm-8">
											<input type="text" class="form-control input-sm" id="unitSellingPrice1" name="unitSellingPrice1" value="#NumberFormat(unitSellingPrice1,',_.__')#" placeholder="#words[191]#">	
										</div>
									</div>	
                                    <div class="form-group">
										<label for="unitSellingPrice2" class="col-sm-4 control-label">#words[192]#</label>
										<div class="col-sm-8">
											<input type="text" class="form-control input-sm" id="unitSellingPrice2" name="unitSellingPrice2" value="#NumberFormat(unitSellingPrice2,',_.__')#" placeholder="#words[192]#">	
										</div>
									</div>
                                    <div class="form-group">
										...
										<div class="col-sm-6">
											<input type="text" class="form-control input-sm" id="unitSellingPrice3" name="unitSellingPrice3" value="#NumberFormat(unitSellingPrice3,',_.__')#" placeholder="#words[195]#">	
										</div>
									</div>
                                    <div class="form-group">
										<label for="unitSellingPrice4" class="col-sm-4 control-label">#words[196]#</label>
										<div class="col-sm-8">
											<input type="text" class="form-control input-sm" id="unitSellingPrice4" name="unitSellingPrice4" value="#NumberFormat(unitSellingPrice4,',_.__')#" placeholder="#words[196]#">	
										</div>
									</div>	
                                    <div class="form-group">
										<label for="unitSellingPrice5" class="col-sm-4 control-label">#words[197]#</label>
										<div class="col-sm-8">
											<input type="text" class="form-control input-sm" id="unitSellingPrice5" name="unitSellingPrice5" value="#NumberFormat(unitSellingPrice5,',_.__')#" placeholder="#words[197]#">	
										</div>
									</div>	
                                    <div class="form-group">
										<label for="unitSellingPrice6" class="col-sm-4 control-label">#words[198]#</label>
										<div class="col-sm-8">
											<input type="text" class="form-control input-sm" id="unitSellingPrice6" name="unitSellingPrice6" value="#NumberFormat(unitSellingPrice6,',_.__')#" placeholder="#words[198]#">	
										</div>
									</div>                        						
								</div>
                                <div class="col-sm-6">                   
                                    ...
                                    <cfif getUserPin2.H10103_3e EQ 'T'> 
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-8">
                                                <input type="text" class="form-control input-sm" id="unitCostPrice" name="unitCostPrice" value="#NumberFormat(unitCostPrice,',_.__')#" placeholder="#words[201]#">	
                                            </div>
                                        </div>
                                        <div class="form-group">
                                    ...
                                    <div class="form-group">
										...
										<div class="col-sm-8">
											<input type="text" class="form-control input-sm" id="minSellingPrice" name="minSellingPrice" value="#NumberFormat(minSellingPrice,',_.__')#" placeholder="#words[203]#">	
										</div>
									</div>
                                    <div class="form-group">
							...
							<div class="row">
                                ...
                                <div class="col-sm-2">                      	
                                    <div class="form-group">                               
                                    	<cfloop index="i" from="1" to="10">
                                            <div class="col-sm-8">
                                                <input type="text" class="form-control input-sm" id="foreignUnitCost#i#" name="foreignUnitCost#i#" value="#NumberFormat(evaluate('foreignUnitCost#i#'),',_.__')#" placeholder="#words[i+321]#">	
                                            </div>
                                        </cfloop>     
									</div>
								</div>
                                ...
                                <div class="col-sm-2">                      	
                                    <div class="form-group">                               
                                    	<cfloop index="i" from="1" to="10">
                                            <div class="col-sm-8">
                                                <input type="text" class="form-control input-sm" id="foreignSellingPrice#i#" name="foreignSellingPrice#i#" value="#NumberFormat(evaluate('foreignSellingPrice#i#'),',_.__')#" placeholder="#words[i+331]#">	
                                            </div>
                                        </cfloop>     
									</div>
								</div>
                                ...
                                <div class="col-sm-2">                      	
                                    <div class="form-group">                               
                                    	<cfloop index="i" from="1" to="10">
                                            <div class="col-sm-8">
                                                <input type="text" class="form-control input-sm" id="foreignMinSellingPrice#i#" name="foreignMinSellingPrice#i#" value="#NumberFormat(evaluate('foreignMinSellingPrice#i#'),',_.__')#" placeholder="#words[i+341]#">	
                                            </div>
                                        </cfloop>     
									</div>
								</div>
