...
<cfset words_id_list = "437,438,23,10,11,439,3">
<cfinclude template="/latest/words.cfm">
<cfset pageTitle="Invoice Address">
<cfset targetTitle="Invoice Address">
<cfset targetTable="bo_invno">
...
<head>
    ...
    <script type="text/javascript">
        ...
        var code='Invoice Address';
        var name='Name';
        var action='Edit';
        var SEARCH='Search';
    </script>
    </cfoutput>
    <script type="text/javascript" src="/latest/js/maintenance/invaddressProfile.js"></script>
