...
<cfset words_id_list = "596,598,599,10,11,597,3">
<cfinclude template="/latest/words.cfm">
<cfset pageTitle="#words[596]#">
...
<head>
    ...
    <script type="text/javascript">
        ...
        var english='#words[598]#';
        var chinese='#words[599]#';
        var action='#words[10]#';
        var SEARCH='#words[11]#';
    </script>
    </cfoutput>
	...
	<div class="page-header">
		<h2>
			...
			<button type="button" class="btn btn-default" onclick="window.open('/latest/maintenance/language.cfm?action=create','_self');">
				<span class="glyphicon glyphicon-plus"></span> #words[597]#
			</button>
                </cfif>
