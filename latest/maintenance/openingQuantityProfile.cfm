...
<cfset words_id_list = "504, 11, 10, 120, 504, 503">
<cfinclude template="/latest/words.cfm">

<cfset pageTitle="#words[504]#">
	...
	<div class="page-header">
		<h2>
			...
			<div class="pull-right">
                    ...
                    <button type="button" class="btn btn-default" onclick="window.open('/latest/maintenance/generatelocationitem.cfm','_blank');">
                        <span class="glyphicon glyphicon-plus"></span> Generate Item Into Location
                    </button>
