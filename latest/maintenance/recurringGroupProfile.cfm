...
<cfset words_id_list = "632,65,634,10,11,633,3">
<cfinclude template="/latest/words.cfm">
<cfset pageTitle="#words[632]#">
<cfset targetTitle="Recurring Group">
<cfset targetTable="recurrgroup">
<cfset displayEditDelete=getUserPin2.H10419a_3b>
...
<head>
   ...
   <!--- <meta name="viewport" content="width=device-width, initial-scale=1.0" />--->
    ...
    <script type="text/javascript">
        ...
        var recurringtype='#words[634]#';
        var action='#words[10]#';
        var SEARCH='#words[11]#';
    </script>
    </cfoutput>
    
    <script type="text/javascript" src="/latest/js/maintenance/recurringProfile.js"></script>
	...
	<div class="page-header">
		<h2>
			...
			<div class="pull-right">
				<cfif getUserPin2.H10419a_3a EQ 'T'>
					<button type="button" class="btn btn-default" onclick="window.open('/latest/maintenance/recurringGroup.cfm?action=create','_self');">
						<span class="glyphicon glyphicon-plus"></span> #words[633]#
					</button>
                </cfif>
                <cfif getUserPin2.H10419a_3c EQ 'T'>
					<button type="button" class="btn btn-default" onclick="window.open('/latest/maintenance/recurringGroupProcess.cfm?action=print','_blank');">
