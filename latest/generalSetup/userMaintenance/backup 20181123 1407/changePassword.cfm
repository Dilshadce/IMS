...
<cfquery name="getLastChange" datasource="main">
    ...
    WHERE userid = <cfqueryparam cfsqltype="cf_sql_varchar" value="#trim(getauthuser())#">
    AND companyID = <cfqueryparam cfsqltype="cf_sql_varchar" value="#trim(dts)#">
...
<head>
    ...
    <script type="text/javascript"> 
        ...
        function validateStrength(){
            ...
            var regularExpression = /((?=.*\d)(?=.*[a-z])(?=.*[A-Z])(?=.*[0-9])(?=.*[^a-zA-Z!”$%&’()*\+,\/;\[\\\]\^_`{|}~+$]).{#minPasswordLength#,20})/;
            var password = document.getElementById("newPassword").value;
        ...
        <div>
            <table>
                ...
                <tr>
                    ...
                    <td>
                        <input type="password" id="newPassword2" name="newPassword2" required onChange="confirmPassword()" placeholder="#words[1792]#" autocomplete="off"/>                   
                    </td>
                </tr> 
            </table>
        </div>
