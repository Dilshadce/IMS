	...
	<cfif checkexist.recordcount neq 0>
		...
		<cfif val(qtyArray[i]) neq 0>
			<cfquery datasource="#dts#" name="updateartran">
                ...
                note1=<cfqueryparam cfsqltype="cf_sql_varchar" value="#form.note1#">,
		...
		<cfif val(qtyArray[i]) neq 0>
			<cfquery name="insertictran" datasource="#dts#" >
				...
				(
					...
					'#disamt_bil#','#val(amt_bil)#','#val(form.taxpec1)#','#trim(form.gltradac)#','#val(taxamt_bil)#',
					...
					'#val(mc1bil)#','#val(mc2bil)#','#defective#','#form.nodisplay#','#form.title_id#','#form.title_desp#',
