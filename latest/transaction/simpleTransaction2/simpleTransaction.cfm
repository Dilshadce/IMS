...
<cfif IsDefined("url.type")>
    ...
    <cfelseif type EQ "PR">
        ...
        <cfset defaultTaxCode=getGsetup.df_purchasetax>    
     <cfelseif type EQ "RQ">
		<cfset title="Purchase Requisition">
		<cfset target="Supplier">
		<cfset targetTable="apvend">
		<cfset taxException="PT">
		<cfset itemPriceType="ucost">
...
<body>  
    ...
    <div id="header">
        <div class="col-row" id="h3">
            <h4 class="title-uppercase" >#action# #title#</h4>
        </div>
        <div class="row">
            <div class="col-sm-6">
                ...
                <ul class="nav nav-tabs uppercase">
                    <cfloop index="i" from="1" to="#sectionCount#">
                        <li <cfif i EQ 1>class="active"</cfif>>
                            <a href="##tab#i#" data-toggle="tab">Section #i#</a>
                        </li>
                    </cfloop>
                ...
                <div class="col-sm-6 addressHeight">
                    <div id="showLabel1">
                        <label for="billToLabel" class="col-sm-4 control-label" data-toggle="modal" data-target="##myModalBillingAddress">
                            <abbr title="Click to change">Bill To</abbr>
                        </label>
                    </div>    
                ...
                <div class="col-sm-6 addressHeight">
                    <div id="showLabel2">
                        <label for="deliveryToLabel" class="col-sm-4 control-label" data-toggle="modal" data-target="##myModalDeliveryAddress">
                            <abbr title="Click to change">Delivery To</abbr>
                        </label>
                    </div>
				...
				<div class="tab-content">
            		<div class="tab-pane active" id="#tab1#">
                        <form class="form-horizontal formTabSection min-padding" role="form">
                            <div class="form-group" >
                                <label for="refnoLabel" class="col-sm-6 control-label">Reference Number</label>
                                <div class="col-sm-6">
                                        ...
                                        <cfif action EQ 'Create'>
                                            <div class="col-sm-6" id="Step3">
                                                <select class="form-control input-sm" id="RefNoSet" name="RefNoSet">
                                                    <option value="">Ref No Set</option>
                            ...
                            <div class="form-group">
                                <label for="dateLabel" class="col-sm-6 control-label">Date</label>
                                <div class="col-sm-6">
                            ...
                            <div class="form-group">
                                <label for="currcodeLabel" class="col-sm-6 control-label">Currency</label>
                                <div class="col-sm-6">
                                    <div class="row no-pad">
                            ...
                            <div class="form-group">
                                <label for="termLabel" class="col-sm-6 control-label">Term</label>
                                <div class="col-sm-6">
            		...
            		<div class="tab-pane" id="#tab2#">
                    	<form class="form-horizontal formTabSection min-padding" role="form">
                            ...
                            <div class="form-group">
                                <label for="refno2Label" class="col-sm-2 control-label">Ref No 2</label>
                                <div class="col-sm-10">
                            ...
                            <div class="form-group">
                            	<cfif type NEQ 'PO'>
                                    <label for="poNoLabel" class="col-sm-2 control-label">PO No</label>
                                    <div class="col-sm-4">
                        		...
                        		<cfif type NEQ 'QUO'>
                                    <label for="quoNoLabel" class="col-sm-2 control-label">QUO No</label>
                                    <div class="col-sm-4">
                            ...
                            <div class="form-group">
                            	<cfif type NEQ 'SO'>
                                    <label for="soNoLabel" class="col-sm-2 control-label">SO No</label>
                                    <div class="col-sm-4">
                        		...
                        		<cfif type NEQ 'DO'>
                                    <label for="doNoLabel" class="col-sm-2 control-label">DO No</label>
                                    <div class="col-sm-4">
                    ...
                    <div class="tab-pane" id="#tab3#">
                    	<form class="form-horizontal formTabSection min-padding" role="form">
							<cfif getProject.recordCount GT 0>
                                <div class="form-group">
                                    <label for="projectLabel" class="col-sm-6 control-label">Project</label>
                                    <div class="col-sm-6">
                            ...
                            <cfif getJob.recordCount GT 0> 
                                <div class="form-group">
                                    <label for="jobLabel" class="col-sm-6 control-label">Job</label>
                                    <div class="col-sm-6">
                            ...
                            <cfif getAgent.recordCount GT 0>
                                <div class="form-group">
                                    <label for="agentLabel" class="col-sm-6 control-label">Agent</label>
                                    <div class="col-sm-6">
                            ...
                            <cfif getDriver.recordCount GT 0>
                                <div class="form-group">
                                    <label for="driverLabel" class="col-sm-6 control-label">Customer Service</label>
                                    <div class="col-sm-6">
            ...
            <table class="itemTable">
                <thead>
                    <tr class="itemTableTR">
                        <th class="th_one itemTableTH">No</th>
                        <th class="th_two itemTableTH">Item</th>
                        <th class="th_three itemTableTH">Description</th>
                        <th class="th_four itemTableTH">Location</th>
                        <th class="th_five itemTableTH">Quantity</th>
                        <th class="th_six itemTableTH">Price <label for="currencyCodeLabel" id="currencyCode" class="currencyCode"></label></th>
                        <th class="th_seven itemTableTH">Discount</th>
                        <th class="th_eight itemTableTH">Tax</th>
                        <th class="th_nine itemTableTH">Total <label for="currencyCodeLabel" id="currencyCode" class="currencyCode"></label></th>
    ...
    <div class="row" id="footer_section">
    	<div class="col-sm-6" id="footer_left_section">
        	<div class="form-group" id="Step7">
                <label for="termConditionLabel" class="sr-only">Terms and Conditions</label>
                <div class="col-sm-12">
        ...
        <div class="col-sm-6" id="footer_right_section">
       		<form class="form-horizontal" role="form">
            	<div class="form-group">
                   <label for="totalQtyLabel" class="col-sm-6 control-label">Total Qty</label>
                    <div class="col-sm-6">
                ...
                <div class="form-group">
                	<label for="discountLabel" class="col-sm-6 control-label">Discount</label>
                    <div class="col-sm-6">
                ...
                <div class="form-group">
                    <label for="netLabel" class="col-sm-6 control-label">Net</label>
                    <div class="col-sm-6">
                ...
                <div class="form-group">
                    <label for="taxLabel" id="taxLabel" class="col-sm-6 control-label">(Plus) Tax</label>
                    <div class="col-sm-6">
                ...
                <div class="form-group">
                	<cfif type EQ "CS">
						<label for="roundingAdjustmentLabel" class="col-sm-6 control-label">Rounding</label>
                        <div class="col-sm-6">
                ...
                <div class="form-group">
                    <label for="grandTotalLabel" class="col-sm-6 control-label">Grand Total</label>
                    <div class="col-sm-6">
        ...
        <div class="row col-xs-offset-4" id="footer_sticky_section">
            <div class="btn-group dropup" id="finalStep">
                <button type="button" class="btn btn-primary saveTransaction createButton" id="create" data-loading-text="Saving...">#action#</button>
                ...
                <ul class="dropdown-menu" role="menu">
                    <cfif HuserID EQ 'ultraprinesh'>
                        <li><a class="" data-toggle="modal" data-target="##myEmailBill">#action# and Email</a></li>
                    </cfif>
                    <li><a class="" id="createAndNew">#action# and New</a></li>
                </ul>
            </div>  
            <button type="button" class="btn btn-default cancelButton" id="cancel" data-loading-text="Cancelling...">Cancel</button>
        </div>
    </div>       
</body>
</html>
