...
<head>
    ...
    <title><cfoutput>Update To #url.pageTitle#</cfoutput></title>
    ...
    <script type="text/javascript" src="/latest/js/transaction/update/updateProfile.js"></script>
