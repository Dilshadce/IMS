...
<cfoutput>
    ...
    <cfif trim(groupFrom) neq "" and trim(groupTo) neq "">
      	...
      	<tr>
        	<td colspan="100%"><div align="center"><font size="2" face="Times New Roman, Times, serif">Product <cfif isdefined('form.productform')>#itemFrom#<cfelse></cfif></font></div></td>
      	</tr>
    ...
    <cfif thislastaccdate neq "" AND IsDefined('thislastaccdate')>
