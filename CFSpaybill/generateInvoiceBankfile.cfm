...
SELECT id,profilename FROM paybillprofile ORDER BY profilename
</cfquery>
...
<cfoutput>
    ...
    <table class="form">
            ...
            <td>
                <select name="cfsprofile" id="cfsprofile" onChange="window.frames['newframe'].location ='/CFSpaybill/generateInvoiceBankfileData.cfm?profileid='+this.value;">
                    <cfloop query="getCFSprofilelist">
                        <option value="#getCFSprofilelist.id#">#getCFSprofilelist.id# | #getCFSprofilelist.profilename#&nbsp;&nbsp;</option>
                    </cfloop>
                </select>
            </td>
        </tr>
        ...
        <iframe src="/CFSpaybill/generateInvoiceBankfileData.cfm?profileid=#getCFSprofilelist.id[1]#" name="newframe" id="newframe" width="100%" height="900" frameborder="0"></iframe>
