...
<cfloop query="getPaytran_qry">
    ...
    <cfset rcd6 = "">
    <cfset rcd7 = "">
    <cfset rcd8 = getPaytran_qry.empno&hmmonth&hmyear>
    <cfset rcd9 = "Payroll-"&hmmonth&hmyear>
    <cfset rcd10 = "">
    <cfset rcd11 = "MYR">
    <cfset rcd12 = numberformat(getPaytran_qry.netpay,'.__')>
    <cfset rcd13 = "N">
    <cfset rcd14 = "MYR">
    <cfset rcd15 = acBank_qry.com_accno>
    <cfset rcd16 = getPaytran_qry.bankaccno>
    ...
    <cfset rcd17 = getPaytran_qry.bankaccno>
    <cfset rcd18 = "">
    <cfset rcd19 = "N">
    ...
    <cfset rcd21 = "">
    <cfset rcd22 = "">
    <cfif len(getPaytran_qry.name) gte 0 and len(getPaytran_qry.name) lte 40>
        <cfset rcd20 = getPaytran_qry.name>
    <cfelseif len(getPaytran_qry.name) gte 41 and len(getPaytran_qry.name) lte 80>
        <cfset rcd20 = left(getPaytran_qry.name,40)>
        <cfset rcd21 = mid(getPaytran_qry.name,41,80)>
    <cfelseif len(getPaytran_qry.name) gte 81 and len(getPaytran_qry.name) lte 120>
        <cfset rcd20 = left(getPaytran_qry.name,40)>
        <cfset rcd21 = mid(getPaytran_qry.name,41,80)>
        <cfset rcd22 = mid(getPaytran_qry.name,81,120)>
    </cfif>
    <cfset rcd23 = "">
    <cfset rcd24 = "">
    <cfset rcd25 = getPaytran_qry.nricn>
    <cfset rcd26 = getPaytran_qry.nric>
    <cfset rcd27 = "">
    <cfset rcd28 = "">
    <cfset rcd29 = getPaytran_qry.add1>
    <cfset rcd30 = getPaytran_qry.add2>
    <cfset rcd31 = "">
    <cfset rcd32 = "">
    <cfset rcd33 = "">
    <cfset rcd34 = "">
