...
<cfquery name="getempicno" datasource="kwangmingtest_i">
SELECT icno FROM paybillprofile WHERE profilename = <cfqueryparam cfsqltype="cf_sql_varchar" value="#url.profilename#">
</cfquery>

<cfquery name="getemplist" datasource="#dts#">
SELECT * FROM pmast
WHERE paystatus = "A" and nric in (<cfqueryparam cfsqltype="cf_sql_varchar" value="#valuelist(getempicno.icno)#" list="yes" separator=",">) order by empno
</cfquery>
...
SELECT * FROM #url.type# as c left join pmast as p on c.empno = p.empno 
<!---<cfif left(dts,4) eq "beps">
LEFT JOIN
(
...
<!---and p.empno in (<cfqueryparam cfsqltype="cf_sql_varchar" list="yes" separator="," value="#valuelist(getemplist.empno)#">)--->
