...
SELECT * FROM cfsempinprofile WHERE profileid = <cfqueryparam cfsqltype="cf_sql_varchar" value="#url.id#">
  ...
  <cfinclude template="/CFSpaybill/filter/filterCFSEmployee.cfm">
  <script type="text/javascript" src="/latest/js/select2/select2.min.js"></script>
  <link rel="stylesheet" href="/latest/css/select2/select2.css" />
  
  <div class="container">
    <div class="page-header">
      <h2> CFS Profile: #getcfsprofilelist.profilename# </h2>
    </div>
    <div class="container">
      <h2> CFS Employee Added </h2>
        ...
        <cfif getcfsempprofilelist.recordcount eq 0>
          ...
          <cfloop query="getcfsempprofilelist">
            ...
            <tr>
              ...
              <td><span class="glyphicon glyphicon-remove btn btn-link" onclick="if(confirm('Are you sure you wish to delete this profile?')){window.open('/CFSpaybill/CFSEmployee2profileprocess.cfm?type=Delete&id=#getcfsempprofilelist.id#&profileid=#getcfsempprofilelist.profileid#','_self');}"></span></td>
            </tr>
          </cfloop>
        </cfif>
      </table>
    ...
    <div>
      ...
      <cfform action="/CFSpaybill/CFSEmployee2profileprocess.cfm?type=add&profileid=#url.id#" name="form">
        <table>
          ...
          <tr>
            <td><input type="hidden" name="getCFSEmplist2" id="filterCFSEmployee" data-placeholder="Choose an employee" class="filterCFSEmployee" >
          ...
          <tr>
            <td><br>
              ...
              <a href="/CFSpaybill/listCFSprofile.cfm">
              <input type="button" id="donebtn" name="donebtn" value="Done">
              </a></td>
          </tr>
        </table>
      </cfform>
