...
<cfloop query="getempicno">
    ...
    AND icno =<cfqueryparam cfsqltype="cf_sql_varchar" value="#valuelist(getempicno.icno)#">
    </cfquery>
    <cfquery name="getemplist" datasource="#dts#">
    SELECT * FROM cfsemp
    WHERE icno =<cfqueryparam cfsqltype="cf_sql_varchar" value="#valuelist(getempicno.icno)#"> 
    </cfquery>
    <cfset count += 1>
    <cfset record = "">
    <cfset rcd1 = "01">
    ...
    <cfset rcd6 = "">
    <cfset rcd7 = "">
    <cfset rcd8 = getempicno.icno&hmmonth&hmyear>
    ...
    <cfset rcd21 = "">
    <cfset rcd22 = "">
    <cfif len(getemplist.name&' '&getemplist.name2) gte 0 and len(getemplist.name&' '&getemplist.name2) lte 40>
        <cfset rcd20 = getemplist.name&' '&getemplist.name2>
    <cfelseif len(getemplist.name&' '&getemplist.name2) gte 41 and len(getemplist.name&' '&getemplist.name2) lte 80>
        <cfset rcd20 = left(getemplist.name&' '&getemplist.name2,40)>
        <cfset rcd21 = mid(getemplist.name&' '&getemplist.name2,41,80)>
    <cfelseif len(getemplist.name&' '&getemplist.name2) gte 81 and len(getemplist.name&' '&getemplist.name2) lte 120>
        <cfset rcd20 = left(getemplist.name&' '&getemplist.name2,40)>
        <cfset rcd21 = mid(getemplist.name&' '&getemplist.name2,41,80)>
        <cfset rcd22 = mid(getemplist.name&' '&getemplist.name2,81,120)>
    </cfif>
    <cfset rcd23 = "">
    <cfset rcd24 = "">
    <cfset rcd25 = "">
