...
<div class="container">
    ...
    <div class="container">
    <cfif isdefined("url.profileno")>
		<div>  
			<h2 style="color: red">Profile No <strong>#url.profileno#</strong> has created.</h2>  	
		</div>
    </cfif>
        ...
        <cfelse>
        	<cfloop query="getcfsprofilelist">
                <tr>
                    ...
                    <span class="glyphicon glyphicon-remove btn btn-link" onclick="if(confirm('Are you sure you wish to delete this profile?')){window.open('/CFSpaybill/CFSpaybillprofileprocess.cfm?type=Delete&id=#getcfsprofilelist.id#','_self');}"></span>
                    </td>
                </tr>
            </cfloop>
        </cfif>
