...
<cfif isdefined('url.type')>
	<cfif url.type eq "create"> 
        ...
        <cfif isdefined('form.bankpersonname1')>
        <cfqueryparam cfsqltype="cf_sql_varchar" value="#form.bankpersonname1#">,
        <cfelse>
        <cfqueryparam cfsqltype="cf_sql_varchar" value="#form.bankpersonname2#">,
        </cfif>
    ...
    <cfif url.type eq 'edit'>
        ...
        <cfif isdefined('form.bankpersonname1')>
        bankpersonname = <cfqueryparam cfsqltype="cf_sql_varchar" value="#form.bankpersonname1#">,
        <cfelse>
        bankpersonname = <cfqueryparam cfsqltype="cf_sql_varchar" value="#form.bankpersonname2#">,
        </cfif>
    ...
    <cfif url.type eq 'delete'>
        ...
        WHERE
        icno = <cfqueryparam cfsqltype="cf_sql_varchar" value="#url.icno#">
        </cfquery>
        <cflocation url = "/CFSpaybill/listCFSEmployee.cfm">
    </cfif>
</cfif>
