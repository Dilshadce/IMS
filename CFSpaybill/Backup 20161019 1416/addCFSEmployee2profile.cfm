...
<div class="container">
            ...
            <cfelse>
                <cfloop query="getcfsempprofilelist">                    
                    ...
                    <tr>
                        ...
                        <td>
                        <span class="glyphicon glyphicon-remove btn btn-link" onclick="if(confirm('Are you sure you wish to delete this profile?')){window.open('/CFSpaybill/CFSEmployee2profileprocess.cfm?type=Delete&id=#getcfsempprofilelist.id#','_self');}"></span>
                        </td>
                    </tr>
                </cfloop>
            </cfif>
    ...
    <div>
    	...
    	<cfform action="/CFSpaybill/CFSEmployee2profileprocess.cfm?type=add&id=#url.id#" name="form">
    	<table>
        	<tr>
            	<td>
