        ...
        <table class="table table-bordered table-hover" id="resultTable" style="table-layout:fixed">
            ...
            <cfloop query="getCFSlist">
                <tr>
                	...
                	<span class="glyphicon glyphicon-remove btn btn-link" onclick="if(confirm('Are you sure you wish to delete this profile?')){window.open('/CFSpaybill/editCFS.cfm?type=Delete&id=#getCFSlist.id#','_self');}"></span>
                    </td>
                </tr>
            </cfloop>
