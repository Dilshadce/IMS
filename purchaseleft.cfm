...
<div id="masterdiv">
<li onClick="SwitchMenu('sub2')"><a class="oe_secondary_menu_item" style="cursor:pointer" title="Purchase"><cfoutput>Purchase</cfoutput></a></li>
<span class="submenu" id="sub2" style="display:block">
    <cfif getpin2.h2860 eq 'T'>
            ...
            <cfif getpin2.h28G0 eq "T">
            				<li>
				<a class="oe_secondary_submenu_item" href="/#HDir#/transaction/transaction.cfm?tran=RQ" target="mainFrame" title="#getGeneralInfo.lRQ#">
               				#getGeneralInfo.lRQ#
				</a>
			</li>
			</cfif>
