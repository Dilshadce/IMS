...
<cfsetting showdebugoutput="yes">
    ...
    <cfset headerlist = "Placement No,Leave Type,Days Taken,Submitted On,Leave Start Date,Leave Start Time,Leave End Date,Leave End Time,Leave Status,Employee Remarks,Manager Remarks,Updated On,Updated By,Employee No,Employee Name,Client No,Client Name">
