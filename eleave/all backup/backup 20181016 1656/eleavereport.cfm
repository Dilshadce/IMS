        ...
        <cfoutput>
                        ...
                        <tr class="active">
                            <td colspan="100%" align="center">
                                <input type="submit" name="Leave_Report" id="Leave_Report" value="Leave Report" 
                                       data-toggle="tooltip" data-placement="bottom" title="Report with leave taken and leave balance">&nbsp;&nbsp;
                                <input type="submit" name="Leave_Report" id="Leave_Report" value="Leave Taken Only" 
                                       data-toggle="tooltip" data-placement="bottom" title="Report with leave taken only">&nbsp;&nbsp;
                                <input type="submit" name="Leave_Report" id="Leave_Report" value="Leave Balance Only" 
                                       data-toggle="tooltip" data-placement="bottom" title="Report with leave balance only">&nbsp;&nbsp;
                                <input type="submit" name="Leave_Report" id="Leave_Report_att" value="Leave Report with attachment"
                                       data-toggle="tooltip" data-placement="bottom" title="Report with leave taken and leave balance along with attachment (MC)"><br />
                            </td>
                        </tr>
                    </table>
                </form>
            ...
            <div class="notice">
                <ul>
                    <li>2018-09-04</li>
                    <ul>
                        <li>Segregated report into leave report with leave taken and balance, leave taken only, leave balance only and leave with attachment.</li>
                        <li>
                            Fixed report to include placement No that did not have any leave record. 
                            Previously report will exclude placement no that did not have any leave record.
                        </li>
                    </ul>
