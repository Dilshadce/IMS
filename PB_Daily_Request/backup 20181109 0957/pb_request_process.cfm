...
<cfloop query="getPB">
    ...
    <cfset SpreadSheetAddRow(excel, "'#getPB.empno#','#getPB.name#','#holderstruct.custno#','#holderstruct.custname#','#getPB.desp#','#finalpbdata#','#getPB.mp4u#','#getPB.requested_on#','#holderstruct.hmname#','#holderstruct.hmemail#'")>     
</cfloop>
