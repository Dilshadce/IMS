<html>
<head>
<title>Add Special Print Bills</title>
...
<cfif isdefined("form.submit")>
	<cfquery name="truncate_customize_print_bills" datasource="main">
		truncate customize_print_bills;
	</cfquery>
	
	<cfif isdefined("form.customized_print_bills")>
		<cfset sql = "">
		
		<cfloop list="#form.customized_print_bills#" index="a" delimiters=",">
			<cfset sql = sql&"("&chr(34)&jsstringformat(preservesinglequotes(a))&chr(34)&"),">
		</cfloop>
		
		<cfset sql = removechars(sql,len(sql),1)>
		
		<cfquery name="insert_customize_print_bills" datasource="main">
			insert into customize_print_bills 
			(
				company_id
			)
...
<form name="defineddatabase" action="add_special_print_bills.cfm" method="post">
	<table align="center" class="data" width="50%" cellpadding="0" cellspacing="0">
    	<tr align="center">
      		<td colspan="2"><h2>Add Special Print Bills</h2></td>
    	</tr>
    	...
    	<cfoutput query="getdatabase">
			<cfif getdatabase.customized eq "Y">
				<tr bgcolor="FFFFFF" onMouseOut="JavaScript:this.style.backgroundColor='';" onMouseOver="JavaScript:this.style.backgroundColor='99FF00';">
					...
					<td align="left"><input name="customized_print_bills" type="checkbox" value="#getdatabase.userbranch#" checked></td>
				</tr>
				<tr>
					<td></td>
				</tr>
			<cfelse>
				<tr bgcolor=#iif((getdatabase.currentrow mod 2) eq 1,DE('"9999FF"'),DE('"99FF99"'))# onMouseOut="JavaScript:this.style.backgroundColor='';" onMouseOver="JavaScript:this.style.backgroundColor='99FF00';">
					<td align="center"><font face="Times New Roman,Times,serif" size="2">#getdatabase.userbranch#</font></td>
					<td align="left"><input name="customized_print_bills" type="checkbox" value="#getdatabase.userbranch#"></td>
				</tr>
				<tr>
					<td></td>
				</tr>
