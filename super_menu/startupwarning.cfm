...
<title>Startup Warning Profile</title>
...
<script type="text/javascript">
	function create(){
		...
		if(ComID==''){
			...
			window.location='startupwarning2.cfm?type=create'+'&ComID='+ComID;
		}
	}
</script>
</head>
...
<body>
	...
	<div id="container">
		<cfform name="form1" action="#currentFile#?list=" method="post" onsubmit="return checkValue();">
			...
			<br>
			<div>Company ID:<input type="text" name="ComID" value="">&nbsp;<input type="button" name="btncreate" value="Create New" onclick="create();"><!--- <a href="startupwarning2.cfm?type=create">Create New</a> ---></div>
			...
			<table width="90%" align="center" class="data">
				...
				<cfif getData.recordcount>
					...
					<tr onMouseOut="javascript:this.style.backgroundColor='';" onMouseOver="javascript:this.style.backgroundColor='99FF00';">
						...
						<td>#getData.File#</td>
						<td align="center">#dateformat(getData.duedate,"dd/mm/yyyy")#</td>
						<td align="left">
						<a href="startupwarning2.cfm?type=edit&id=#getData.ID#">Edit</a>  ||
						<a href="startupwarning2.cfm?type=delete&id=#getData.ID#">Delete</a></td> 
					</tr>
					</cfoutput>
				<cfelse>
