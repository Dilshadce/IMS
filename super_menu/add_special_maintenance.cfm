<html>
<head>
<title>Add Special Maintenance</title>
...
<cfif isdefined("form.submit")>
	<cfquery name="truncate_customize_maintenance" datasource="main">
		truncate customize_maintenance;
	</cfquery>
	
	<cfif isdefined("form.customized_maintenance")>
		<cfset sql = "">
		
		<cfloop list="#form.customized_maintenance#" index="a" delimiters=",">
			<cfset sql = sql&"("&chr(34)&jsstringformat(preservesinglequotes(a))&chr(34)&"),">
		</cfloop>
		
		<cfset sql = removechars(sql,len(sql),1)>
		
		<cfquery name="insert_customize_maintenance" datasource="main">
			insert into customize_maintenance 
			(
				company_id
			)
...
<form name="defineddatabase" action="add_special_maintenance.cfm" method="post">
	<table align="center" class="data" width="50%" cellpadding="0" cellspacing="0">
    	<tr align="center">
      		<td colspan="2"><h2>Add Special Maintenance</h2></td>
    	</tr>
    	...
    	<cfoutput query="getdatabase">
			<cfif getdatabase.customized eq "Y">
				<tr bgcolor="FFFFFF" onMouseOut="JavaScript:this.style.backgroundColor='';" onMouseOver="JavaScript:this.style.backgroundColor='99FF00';">
					...
					<td align="left"><input name="customized_maintenance" type="checkbox" value="#getdatabase.userbranch#" checked></td>
				</tr>
				<tr>
					<td></td>
				</tr>
			<cfelse>
				<tr bgcolor=#iif((getdatabase.currentrow mod 2) eq 1,DE('"9999FF"'),DE('"99FF99"'))# onMouseOut="JavaScript:this.style.backgroundColor='';" onMouseOver="JavaScript:this.style.backgroundColor='99FF00';">
					<td align="center"><font face="Times New Roman,Times,serif" size="2">#getdatabase.userbranch#</font></td>
					<td align="left"><input name="customized_maintenance" type="checkbox" value="#getdatabase.userbranch#"></td>
				</tr>
				<tr>
					<td></td>
				</tr>
