                                ...
                                <div class="col-sm-6">
                                    ...
                                    <cfif husergrpid EQ 'admin' OR husergrpid EQ 'super'>
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-8">
                                                <input type="password" id="userPassword" name="userPassword" class="form-control input-sm" required maxlength="32" value="#userPassword#" autocomplete="off"/>
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            <label for="password" class="col-sm-4 control-label">Password Repeat</label>
                                            <div class="col-sm-8">
                                                <input type="password" id="userPassword2" name="userPassword2" class="form-control input-sm" required onBlur="confirmPassword()" autocomplete="off"/>
                                            </div>
                                        </div>
                                    </cfif>
                                    <div class="form-group">
