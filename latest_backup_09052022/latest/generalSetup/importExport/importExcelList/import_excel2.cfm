                ...
                <!--- <cftry> --->
                    ...
                    <cfif submiticitem eq 'Submit' and trim(column1) neq "">
                        <cfquery name="inserticitem" datasource="#dts#">
                            ...
                            <cfqueryparam cfsqltype="cf_sql_varchar" value="#column2#">,
                            <cfqueryparam cfsqltype="cf_sql_varchar" value="#column3#">,
                            ...
                            '#val(column21)#',
                            '#val(column22)#',
                            <cfqueryparam cfsqltype="cf_sql_varchar" value="#column23#">,
                            <cfqueryparam cfsqltype="cf_sql_varchar" value="#column24#">,
                            '#val(column25)#',
                            '#val(column26)#',
                            '#val(column27)#',
                            '#val(column28)#',
