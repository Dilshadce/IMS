...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="/latest/js/bootstrap-toggle-master/bootstrap-toggle.min.css">
  	<link rel="stylesheet" type="text/css" href="/latest/js/jQuery-Plugin-For-Beautifying-Checkboxes-Radio-Buttons-iCheck/skins/square/blue.css">  
    <link rel="stylesheet" type="text/css" href="/latest/css/generalSetup/generalInfoSetup/TransactionNew.css">
...
<cfset rqapproval = getGeneralSetup.rqapproval>
...
<cfset locproject = getGeneralSetup.locproject>
...
<!--- Panel 7 --->
<cfset grpinitem = getGeneralSetup.grpinitem>
...
<cfoutput>
        ...
        <ul class="nav nav-tabs" id="interest_tabs">
            ...
            <li><a href="##maintenance" data-toggle="tab" id="maintenancelist">Maintenance</a></li>
        </ul>
        <!---END: 1st Layer Tabs --->
                            ...
                            <div class="form-group">
                                 ...
                                 <div class="col-sm-5 col-xs-offset-1 input-group">  
                                    <select class="form-control" name="dfpos" id="dfpos">
                                        <option value="0.10" <cfif dfpos eq "0.10">Selected</cfif>>No Rounding</option>
            ...
            <div id="mailSetup" class="tab-pane fade">
                ...
                <div class="row" align="center">
                    <div class="col-sm-12 checkbox">
                        <div class="col-sm-6">
                            <div class="form-group">
                                <div class="col-sm-4">RQ update to PO Require Approval of Admins</div>
                                <div class="col-sm-8">
                                    <input name="rqapproval" id="rqapproval" type="checkbox" value="Y" data-toggle="toggle"   data-on="Enable" data-off="Disable" data-width="60"   data-size="small"<cfif rqapproval eq 'Y'>checked</cfif>>                                     
                                </div>
                            </div>
                        </div>
                        <div class="col-sm-6">
                ...
                <div class="row" align="center">
                    ...
                    <div class="row" align="center">
                    	<div class="col-sm-12 checkbox">
                            ...
                            <div class="col-sm-6">
                            	<div class="form-group">
                                     <div class="col-sm-4">Post Update Location To Project</div>

                                     <div class="col-sm-8">
        									<input name="locproject" id="locproject" type="checkbox" value="Y" data-toggle="toggle" data-width="60"  data-on="Enable" data-off="Disable"  data-size="small"<cfif locproject eq 'Y'>checked</cfif>>
                                     </div>
     							</div>
                            </div>
            	...
            	<div id="maintenance" class="tab-pane fade">
                	<div class="row" align="center">
                    	<div class="col-sm-12 checkbox">
                        	<div class="col-sm-6">
                           		<div class="form-group">
                               		<div class="col-sm-4">Include Group In Item</div>
                               		<div class="col-sm-5 col-xs-offset-1 input-group">
                                 		<input name="grpinitem" id="grpinitem" type="checkbox" value="1" data-toggle="toggle" data-width="60"  data-on="Enable" data-off="Disable"  data-size="small"<cfif grpinitem eq 'Y'>checked</cfif>> 
                                    </div>
                            	</div>
                        	</div>
    ...
    <div class="modal-dialog">
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <p style="text-align:center">Changing this may result in incorrect tax amount. Please consult our support team.</p>
            </div>
