...
<!---<cfif HcomID NEQ 'supporttest_i'>
    <cfquery name="checkExistError" datasource="main">
        SELECT * 
        FROM autoErrorEmail
    ...
    <cfif checkExistError.recordcount EQ 0>
        ...
        <cfquery name="insertError" datasource="main">
        ...
        <cfset emailList = 'prinesh@mynetiquette.com'>
        <cfmail from="noreply@mynetiquette.com" to="#emailList#" subject="IMS.asia -- ERROR URGENT (AUTO EMAIL)" type="html">
            <table width="500px">
                <tr>
                    <td>Dear Master,</td>
                </tr>
