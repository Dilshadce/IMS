...
<cfswitch expression="#form.result#">
	<cfcase value="EXCEL">
		...
		<Styles>
	 	...
	 	<cfoutput>
		<Table ss:ExpandedColumnCount="16" x:FullColumns="1" x:FullRows="1">
	   ...
	   <cfif form.periodfrom neq "" and form.periodto neq "">
        ...
        <Cell ss:StyleID="s27"><Data ss:Type="String">Date</Data></Cell>
            ...
            <Cell ss:StyleID="s27"><Data ss:Type="String">Round Adjustment</Data></Cell>
		...
		<cfquery name="getusername" datasource="main">
			...
			<cfquery name="getdata" datasource="#dts#">
					select a.wos_date, a.refno, if(b.taxincl = "T",b.amt-a.tax,b.amt) as invgross, a.discount, a.tax, a.roundadj, a.m_charge1, a.grand, a.CS_PM_cash, a.CS_PM_dbcd, 
                           a.CS_PM_cashcd, a.CS_PM_crcd, a.CS_PM_cheq, a.CS_PM_vouc, a.deposit
                    from artran a
                    LEFT JOIN ictran b ON a.type = b.type AND a.refno = b.refno 
					where a.type='CS' and a.userid = '#getagent.userid#' and (a.void = '' or a.void is null)
                    ...
                    <cfif form.locationFrom neq "" and form.locationTo neq "">
					and a.refno in (<cfqueryparam cfsqltype="cf_sql_varchar" list="yes" separator="," value="#locationlist#">)
					</cfif>
                    <cfif form.userfrom neq "" and form.userto neq "">
