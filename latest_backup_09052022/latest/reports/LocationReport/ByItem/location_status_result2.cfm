...
<cfinvoke component="CFC.date" method="getDbDate" inputdate = "#form.datefrom#" returnvariable="date1">
<cfinvoke component="CFC.date" method="getDbDate" inputdate = "#form.dateto#" returnvariable="date2">
</cfif>
...
<cfswitch expression="#form.result#">
    ...
    <cfxml variable="data">
			...
			<Worksheet ss:Name="Item Status Value Report">
...
<Table x:FullColumns="1" x:FullRows="1" ss:DefaultColumnWidth="54" ss:DefaultRowHeight="11.25">
          ...
          <Cell ss:MergeAcross="#c#" ss:StyleID="s22"><Data ss:Type="String"><cfif lcase(hcomid) eq "mhca_i">Marketer<cfelse>Location</cfif> - Item Status and Value</Data></Cell>
          </Row>
          
          	<Row ss:AutoFitHeight="0" ss:Height="20.0625">
          
		  <Cell ss:MergeAcross="#c#" ss:StyleID="s22"><Data ss:Type="String">Calculated by <cfoutput>#costingmethod#</cfoutput></Data></Cell>
          </Row>

	<cfinvoke component = "locationstatus" method = "get_location" returnvariable = "getlocation">
		...
		<cfif form.periodfrom neq "" and form.periodto neq "">
			...
			<Row ss:AutoFitHeight="0" ss:Height="20.0625">
			<Cell ss:StyleID="s52"><Data ss:Type="String">ITEM NO.</Data></Cell>
			<Cell ss:StyleID="s52"><Data ss:Type="String">DESPCRIPTION</Data></Cell>
			<Cell ss:StyleID="s52"><Data ss:Type="String">QTYBF</Data></Cell>
			<Cell ss:StyleID="s52"><Data ss:Type="String">IN</Data></Cell>
			<Cell ss:StyleID="s52"><Data ss:Type="String">OUT</Data></Cell>
			<Cell ss:StyleID="s52"><Data ss:Type="String">ON HAND</Data></Cell>
			<Cell ss:StyleID="s52"><Data ss:Type="String">
			...
			<Cell ss:StyleID="s52"><Data ss:Type="String">STOCK VALUE</Data></Cell>
	    </Row>
		...
		<cfloop query="getlocation">
			...
			<Row ss:AutoFitHeight="0" ss:Height="20.0625">
            	 ...
            	 <cfwddx action = "cfml2wddx" input = "LOCATION: #target_location#" output = "wddxText">
				 <cfwddx action = "cfml2wddx" input = "#target_location_desp#" output = "wddxText4">
			...
			<cfinvoke component = "locationstatus" method = "get_group" returnvariable = "getgroup">
				...
				<cfinvokeargument name = "lastaccyear" 	value = "#getgeneral.lastaccyear#">
				<cfinvokeargument name = "form" 		value = "#form#">
				<cfinvokeargument name = "location" 	value = "#target_location#">
			</cfinvoke>
			...
			<Row ss:AutoFitHeight="0" ss:Height="20.0625">
				 <cfwddx action = "cfml2wddx" input = "GROUP: #target_group# #target_group_desp#" output = "wddxText4">
					<Cell ss:StyleID="s41"><Data ss:Type="String">#wddxText4#</Data></Cell>
				</Row>--->
				<cfif getgeneral.cost eq "FIXED">
					<cfquery name="getitem" datasource="#dts#">
						...
						right join
						(
							select itemno,desp,ucost,wos_group,category
							from icitem 
							where itemno<>'' 
                ...
                <cfelseif getgeneral.cost eq "MONTH">
                    <cfquery name="getitem" datasource="#dts#">
                        ...
                        right join
                        (
                            select itemno,desp,avcost,wos_group,category
                            from icitem 
                            where itemno<>'' 
                            <!---and wos_group ='#target_group#'--->
                            <cfif trim(form.categoryFrom) neq "" and trim(form.categoryTo) neq "">
                ...
                <cfelseif getgeneral.cost eq "MOVING">
                    <cfquery name="getitem" datasource="#dts#">
                        ...
                        right join
                        (
                            select itemno,desp,avcost2,wos_group,category
                            from icitem 
                            where itemno<>'' 
                            <!---and wos_group ='#target_group#'--->
                            <cfif trim(form.categoryFrom) neq "" and trim(form.categoryTo) neq "">
                        ...
                        (
                            ...
                            from ictran
                            where type in ('CN','INV') and wos_date=(select max(wos_date) from ictran where type='RC' and (void = '' or void is null) and location = '#target_location#') and (void = '' or void is null)
                            and location = '#target_location#'
							and (linecode <> 'SV' or linecode is null) 
                            <cfif form.periodfrom neq "" and form.periodto neq "">
                                and fperiod+0 <= '#form.periodto#'
			...
			select a.LastAccDate,a.ThisAccDate,a.avcost2,b.locqfield as qtybf FROM icitem_last_yearas a left join (select locqfield,itemno from locqdbf_last_year where itemno='#getitem.itemno#' and location='#target_location#' and LastAccDate = #thislastaccdate# )as b on a.itemno=b.itemno
            ...
            <cfelse>
            <cfquery name="getqtybf" datasource="#dts#">
			select a.avcost2,b.locqfield as qtybf FROM icitem as a left join (select locqfield,itemno from locqdbf where itemno='#getitem.itemno#' and location='#target_location#')as b on a.itemno=b.itemno
			...
			order by a.wos_date,a.trdatetime,a.trancode,a.itemcount
			</cfquery>
        ...
        <cfset getitem.stockbalance=locationbalanceqty*getmonthcostamt.cost>
        <cfset getitem.ucost=getmonthcostamt.cost>
                   ...
                   <cfwddx action = "cfml2wddx" input = "" output = "wddxText3">
                   <cfwddx action = "cfml2wddx" input = "" output = "wddxText4">
                   <cfwddx action = "cfml2wddx" input = "" output = "wddxText5">
                   ...
                   <Cell ss:StyleID="s26"><Data ss:Type="String">#numberformat(val(ucost),stDecl_UPrice)#</Data></Cell>
                   <Cell ss:StyleID="s26"><Data ss:Type="String">#numberformat(val(stockbalance),stDecl_TPrice)#</Data></Cell>
                    </Row>
					...
					<cfset locationstkval=locationstkval+val(stockbalance)>
		...
		<Row ss:AutoFitHeight="0" ss:Height="20.0625">
                   <Cell ss:StyleID="s26"><Data ss:Type="String"></Data></Cell>
	               <Cell ss:StyleID="s26"><Data ss:Type="String">GROUP TOTAL:</Data></Cell>
	               <Cell ss:StyleID="s26"><Data ss:Type="String">#numberformat(groupqtybf,"0")#</Data></Cell>
	               <Cell ss:StyleID="s26"><Data ss:Type="String">#numberformat(groupqtyin,"0")#</Data></Cell>
	               <Cell ss:StyleID="s26"><Data ss:Type="String">#numberformat(groupqtyout,"0")#</Data></Cell>
	               <Cell ss:StyleID="s26"><Data ss:Type="String">#numberformat(groupbalanceqty,"0")#</Data></Cell>
                   <Cell ss:StyleID="s26"><Data ss:Type="String"></Data></Cell>
	               <Cell ss:StyleID="s26"><Data ss:Type="String">#numberformat(groupstkval,stDecl_TPrice)#</Data></Cell>
	                </Row>    
				</cfif>
		<Row ss:AutoFitHeight="0" ss:Height="20.0625">
                   <Cell ss:StyleID="s26"><Data ss:Type="String"></Data></Cell>
		...
		<Row ss:AutoFitHeight="0" ss:Height="20.0625">
		          ...
		          <Cell ss:StyleID="s51"><Data ss:Type="String">LOCATION TOTAL:</Data></Cell>
		          <Cell ss:StyleID="s51"><Data ss:Type="String">#numberformat(locationqtybf,"0")#</Data></Cell>
		          <Cell ss:StyleID="s51"><Data ss:Type="String">#numberformat(locationqtyin,"0")#</Data></Cell>
		          <Cell ss:StyleID="s51"><Data ss:Type="String">#numberformat(locationqtyout,"0")#</Data></Cell>
		          <Cell ss:StyleID="s51"><Data ss:Type="String">#numberformat(locationbalanceqty,"0")#</Data></Cell>
                  <Cell ss:StyleID="s51"><Data ss:Type="String"></Data></Cell>
		          <Cell ss:StyleID="s51"><Data ss:Type="String">#numberformat(locationstkval,stDecl_TPrice)#</Data></Cell>
		    </Row>
		</cfloop>
		...
		<Row ss:AutoFitHeight="0" ss:Height="20.0625">
                    ...
                    <Cell ss:StyleID="s38"><Data ss:Type="String">#numberformat(grandqtybf,"0")#</Data></Cell>
                    <Cell ss:StyleID="s38"><Data ss:Type="String">#numberformat(grandqtyin,"0")#</Data></Cell>
                    <Cell ss:StyleID="s38"><Data ss:Type="String">#numberformat(grandqtyout,"0")#</Data></Cell>
                    <Cell ss:StyleID="s38"><Data ss:Type="String">#numberformat(grandbalanceqty,"0")#</Data></Cell>
                    <Cell ss:StyleID="s38"><Data ss:Type="String"></Data></Cell>
		            <Cell ss:StyleID="s38"><Data ss:Type="String">#numberformat(grandstkval,stDecl_TPrice)#</Data></Cell>
		</Row>
		</cfoutput>
		  </Table>
...
<h3 align="center"><font face="Times New Roman, Times, serif"><cfif lcase(hcomid) eq "mhca_i">Marketer<cfelse>Location</cfif> - Item Status and Value</font></h3>
<h4 align="center"><font face="Times New Roman, Times, serif"><cfif getgeneral.cost eq "MOVING">Moving Average<cfelse>Fixed Cost</cfif></font></h4>
	...
	<table align="center" border="0" width="100%">
		...
		<cfloop query="getlocation">
			...
			<cfset locationstkval=0>
			<tr>
				<td><div align="left"><font size="2" face="Times New Roman,Times,serif"><strong>LOCATION: #target_location#</strong></font></div></td>
				<td><div align="left"><font size="2" face="Times New Roman,Times,serif"><strong>#target_location_desp#</strong></font></div></td>
			</tr>
			<cfinvoke component = "locationstatus" method = "get_group" returnvariable = "getgroup">
				<cfinvokeargument name = "dts" 			value = "#dts#">
				<cfinvokeargument name = "lastaccyear" 	value = "#getgeneral.lastaccyear#">
			...
			<cfloop query="getgroup">
				...
				<tr>
					<td><div align="left"><font size="2" face="Times New Roman,Times,serif"><u>GROUP: #target_group#</u></font></div></td>
					<td><div align="left"><font size="2" face="Times New Roman,Times,serif"><u>#target_group_desp#</u></font></div></td>
				</tr>
				<cfif getgeneral.cost eq "FIXED">
					<cfquery name="getitem" datasource="#dts#">
						select a.location,a.itemno,b.desp,b.ucost,
            ...
            <cfif isdefined("form.thislastaccdate") and form.thislastaccdate neq "">
            <cfquery name="getqtybf" datasource="#dts#">
			select a.LastAccDate,a.ThisAccDate,a.avcost2,b.locqfield as qtybf FROM icitem_last_year as a left join (select locqfield,itemno from locqdbf_last_year where itemno='#getitem.itemno#' and location='#target_location#' and LastAccDate = #thislastaccdate# )as b on a.itemno=b.itemno
			where a.itemno='#getitem.itemno#' and LastAccDate = #thislastaccdate# 
			limit 1
            </cfquery>
        ...
        <cfset getitem.ucost=getmonthcostamt.cost>
                	...
                	<tr onMouseOut="javascript:this.style.backgroundColor='';" onMouseOver="javascript:this.style.backgroundColor='99FF00';">
                        ...
                        <td><div align="right"><font size="2" face="Times New Roman, Times, serif">#numberformat(val(stockbalance),stDecl_TPrice)#</font></div></td>
                    </tr>
                    <cfset groupqtybf=groupqtybf+val(getitem.qtybf)>
					<cfset groupqtyin=groupqtyin+val(getitem.qin)>
                    <cfset groupqtyout=groupqtyout+val(getitem.qout)>
