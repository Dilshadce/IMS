...
<cfset words_id_list = "123,495,496,146,497,498,1302,1417,1418,122,1373,1374,482,499,500,703,1361,1362,702,1300,1301,1406,1443,1407,1444,1459,501,1399,688,1600">
...
<cfoutput>
	<cfform class="formContainer form3Button" name="location_listing_report" id="billListingForm" action="locationstockcheck2.cfm" method="post" target="_blank">
		<div>#pageTitle#</div>
        <div>
            <table> 
            ...
            <th><label for="other">#words[688]#</label></th>
                <td>
                    <div><input type="checkbox" name="include0" id="include0" value="checkbox1"> #words[1406]#</div>
                    <div><input type="checkbox" name="groupitem" value="checkbox2"> #words[1443]#</div>
                    <div><input type="checkbox" name="dodate" value="checkbox3" checked="checked"> #words[1407]#</div>
                </td>
			</tr>
            <tr>
            <th></th>
                <td>
                    <div><input type="checkbox" name="reserve" value="checkbox4"> #words[1444]#</div>
                    <div><input type="checkbox" name="sortByGroup" value="checkbox5"> #words[1459]#</div>
                </td>
			</tr>
            </table>
		</div>
