...
<cfset words_id_list = "1487,123,495,496,146,497,498,1302,1417,1418,122,1373,1374,150,1448,1449,482,499,500,703,1183,702,639,1452,1456,1457,1380,501,1399,688">
...
<head>
	...
	<script type="text/javascript">
		function change_link() {
			if(document.locationPhysicalWorksheetDOForm.update_actual_qty.checked==true) {
				document.locationPhysicalWorksheetDOForm.action="location_physical_worksheetDOadjust.cfm";
			}
			else {
				document.locationPhysicalWorksheetDOForm.action="location_physical_worksheetDO2.cfm";
			}
		}
	</script>
...
<cfoutput>
	<cfform class="formContainer form3Button" name="locationPhysicalWorksheetDOForm" id="locationPhysicalWorksheetDOForm" action="location_physical_worksheetDO2.cfm" method="post" target="_blank">
		<div>#pageTitle#</div>
        <div>
        <table> 
            ...
            <th><label for="other">#words[688]#</label></th>
                <td>
                    ...
                    <div><input type="checkbox" name="generate_adjustment_transaction" id="generate_adjustment_transaction" value="yes"> #words[1456]#</div>
                    <div><input type="checkbox" name="exclude_actual" id="exclude_actual" value="yes"> #words[1457]#</div>
                </td>
			</tr>
            <tr>
            	<th></th>
                <td>
                	<div><input type="checkbox" name="itemdespsort" id="itemdespsort" value="yes"/> #words[1380]#</div>
                </td>
            </tr>
            </table>
		</div>
