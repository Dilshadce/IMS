        ...
        <div>
            <table> 
                ...
                <tr> 
                    ...
                    <td>
                        <input type="hidden" id="groupFrom" name="groupFrom" value="#Hitemgroup#" class="groupFilter" data-placeholder="#words[497]#" />
                        <input type="hidden" id="groupTo" name="groupTo" value="#Hitemgroup#" class="groupFilter" placeholder="#words[498]#" />
                    </td>
                </tr>
                <tr> 
