...
<cfinvoke component="reportpurchase" method="getPurchaseMonthContent" returnvariable="cfcContent">
	...
	<cfinvokeargument name="productFrom" value="#trim(form.productfrom)#">
	<cfinvokeargument name="productTo" value="#trim(form.productto)#">
...
<cfswitch expression="#form.result#">
	<cfcase value="EXCEL">
        ...
        <cfheader name="Content-Disposition" value="inline; filename=#dts#_PR_PPM_#huserid#.xls">
