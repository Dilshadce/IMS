...
<cfxml variable="data">
    ...
    <cfset comcom = 3>
	     ...
	     <Row ss:AutoFitHeight="0" ss:Height="20.0625">
			<Cell ss:StyleID="s38"><Data ss:Type="String">Customer Payment Status Report</Data></Cell>
		</Row>
        ...
        <cfset custtotal=0>
	     <Row ss:AutoFitHeight="0" ss:Height="20.0625">
			...
			<Cell ss:StyleID="s38"><Data ss:Type="String">Customer:#wddxText2#(#getcustomer.custno#)</Data></Cell>
       ...
       <Row ss:AutoFitHeight="0" ss:Height="20.0625">
	     ...
	     <Row ss:AutoFitHeight="0" ss:Height="20.0625">
            ...
            <cfset debittotal=debittotal+getbill.grandsum>
        	<cfset custtotal=custtotal+getbill.grand_bil>
			</cfloop>

	     <Row ss:AutoFitHeight="0" ss:Height="20.0625">
		   <Cell ss:StyleID="s60"><Data ss:Type="String"></Data></Cell>
           <Cell ss:StyleID="s60"><Data ss:Type="String"></Data></Cell>
		   <Cell ss:StyleID="s60"><Data ss:Type="String">Total</Data></Cell>
		   <Cell ss:StyleID="s60"><Data ss:Type="String">#debittotal#</Data></Cell>
		   <Cell ss:StyleID="s60"><Data ss:Type="String">#custtotal#</Data></Cell>
	...
	<html>
	<head>
	<title>Customer Payment Status Report</title>
...
<cfquery name="getcustomer" datasource="#dts#">
	...
	<table width="100%" border="0" cellspacing="0" cellpadding="2">
		<tr>
			<td colspan="100%"><div align="left"><font size="3" face="Times New Roman, Times, serif"><strong>Customer Payment Status Report</strong></font></div></td>
		</tr>
         <tr>
        ...
        <cfset custtotal=0>
		<tr>
			<td colspan="4"><div align="left"><font size="2" face="Times New Roman, Times, serif"><strong>Customer:&nbsp;&nbsp;#getcustomer.name#&nbsp;(#getcustomer.custno#)</strong></font></div></td>
		...
		<tr>
            ...
            <tr>
                    ...
                    <td><div align="right"><font size="2" face="Times New Roman, Times, serif">#numberformat(debittotal,',_.__')#</font></div></td>
                    <td><div align="right"><font size="2" face="Times New Roman, Times, serif">#numberformat(custtotal,',_.__')#</font></div></td>
