...
<cfquery datasource="manpower_p">
	drop table if exists manpower_p.pay12_m_statutory;
</cfquery>
<cfquery datasource="manpower_p">
...
<cfif form.period eq getComp_qry.mmonth>
	<cfset p_table = "manpower_p.pay_tm WHERE empno = a.empno ">
<cfelse>
	<cfset p_table = "manpower_p.pay12_m_statutory WHERE TMONTH = #form.period# and empno = a.empno ">
</cfif>
