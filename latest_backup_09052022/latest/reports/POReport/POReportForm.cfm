...
<cfoutput>
	<cfform class="formContainer form3Button" name="POReportForm" id="POReportForm" action="POReport.cfm?type=#trantype#&trancode=#trancode#&alown=#alown#&consignment=#consignment#" method="post" target="_blank">
        <div>#pageTitle#</div>
        <div>
        <table>
			...
			<cfelse>
            	...
            	<tr>
                    ...
                    <td>
                        <input type="text" id="customerFrom" name="customer" class="customerFilter" style="width:90%;" data-placeholder="Choose a Customer" />
