...
<cfset consignment=''>
	<cfset pageTitle = "Advance Billing Report">
...
<cfoutput>
	<cfform class="formContainer form3Button" name="AdvanceBillingForm" id="AdvanceBillingForm" action="LorealAdvanceBillingReport.cfm" method="post" target="_blank">
        <div>#pageTitle#</div>
        <div>
        <table>
        ...
        <div>
            <input type="Submit" name="result" id="result" value="Advance Cash"/> 
            <input type="Submit" name="result" id="result" value="Advance Invoice"/> 
            <input type="Submit" name="result" id="result" value="List of BA"  />
        </div>
    </cfform>
    <div>
    <h2>Instruction to Print This Report</h2>
    <br>Click <a href="Steps%20to%20setup%20for%20printing%20Loreal%20Advance%20Billing%20Report.pdf" target="_blank"><span style="color: black">Here</span></a> to open the instruction in PDF.
    </div>
</cfoutput>
</body>
</html>