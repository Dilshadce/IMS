...
<cfelse>
	...
	<cfif getBillToAdd.recordcount eq 0>
    	<cfquery datasource='#dts#' name="getBillToAdd">
   	  		select name,name2,add1,add2,add3,add4,attn,phone,fax from #target_arcust# limit 1
		</cfquery>
...
<cfelse>
	...
	<cfif getDeliveryAdd.recordcount eq 0>
    	<cfquery datasource='#dts#' name="getDeliveryAdd">
            select b.name,b.name2,a.add1,a.add2,a.add3,a.add4, a.attn, a.phone, a.fax from address a, #ptype# b limit 1
        </cfquery>
