...
<cfswitch expression="#form.result#">
	<cfcase value="HTML">
		...
		<table width="100%" border="0" cellspacing="0" cellpadding="2">
			...
			<cfif trim(form.customerfrom) neq "" and trim(form.customerto) neq "">
				<tr>
					<td colspan="6"><div align="center"><font size="2" face="Times New Roman, Times, serif">CUSTOMER: #form.customerfrom# - #form.customerto#</font></div></td>
				</tr>
			</cfif>
			<tr>
			...
			<cfloop query="getagent">
                ...
                <cfelse>
                    ...
                    <cfquery name="getsales" datasource="#dts#">
							select sum(qty) as sumqty, sum(if(taxincl="T",amt-taxamt,amt)) as sumamt, sum(if(taxincl="T",amt_bil-taxamt_bil,amt_bil)) as sumamt_bil, sum(it_cos) as sumcost from ictran
	...
	<cfcase value="EXCEL">
        ...
        <cfheader name="Content-Disposition" value="inline; filename=Agent_Profit_Margin_#huserid#.xls">
