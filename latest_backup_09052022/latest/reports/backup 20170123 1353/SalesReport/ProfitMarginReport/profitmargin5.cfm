       ...
       <!---Agent from Bill--->
			...
			<cfloop query="getartran">
				<cfquery name="getictran" datasource="#dts#">
					select type,itemno,linecode,desp,despa,if(taxincl="T",amt-taxamt,amt) as amt,if(taxincl="T",amt_bil-taxamt_bil,amt_bil) as amt_bil,it_cos,sercost 
					from ictran 
...
<cfelse>
       <!---Agent from Bill--->
			...
			<cfloop query="getartran">
				...
				<cfquery name="getictran" datasource="#dts#">
					select itemno,desp,despa,if(taxincl="T",amt-taxamt,amt) as amt,if(taxincl="T",amt_bil-taxamt_bil,amt_bil) as amt_bil,it_cos,sercost  from ictran where refno = '#getartran.refno#' and type = '#getartran.type#'
                     <cfif form.radio1 eq 'item'>
                and linecode !='SV'
                <cfelseif form.radio1 eq 'serv'>
                and linecode ='SV'
        ...
        <cfheader name="Content-Disposition" value="inline; filename=Bill_Item_Profit_Margin_#huserid#.xls">
