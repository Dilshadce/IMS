...
select area,custno from #target_arcust# 
</cfquery>

<cfloop query='getcust'>

<cfquery name="updateartran" datasource="#dts#">
update artran set area='#getcust.area#' where custno='#getcust.custno#'
</cfquery>

<cfquery name="updateictran" datasource="#dts#">
update ictran set area='#getcust.area#' where custno='#getcust.custno#'
</cfquery>
</cfloop>
	...
	<cfcase value="HTML">
		...
		<table width="100%" border="0" cellspacing="0" cellpadding="2">
			...
			<cfquery name="getgroup" datasource="#dts#">
				...
				left join
				(select wos_group,sum(amt) as suminvamt from ictran where type='INV' and linecode=''
				<cfif form.areafrom neq "" and form.areato neq "">
            ...
            <cfif form.agentfrom neq "" and form.agentto neq "">
				and custno in ( select custno from #target_arcust# where agent >='#form.agentfrom#' and agent <= '#form.agentto#')
			</cfif>
            <cfif form.teamfrom neq "" and form.teamto neq "">
            and custno in ( select custno from #target_arcust# where agent in (select agent from #target_icagent# where team >= '#form.teamfrom#' and team <= '#form.teamto#'))
				</cfif>
            <cfif url.alown eq 1>
       ...
       <!---Agent from Bill--->
			...
			and (userid in (select userid from main.users where userDept = '#dts#' and location='#Huserloc#'))
				...
				left join
				(select wos_group,sum(amt) as sumcsamt from ictran where type='CS' and linecode=''
				<cfif form.areafrom neq "" and form.areato neq "">
				and area >='#form.areafrom#' and area <= '#form.areato#'
				</cfif>
                <cfif form.enduserfrom neq "" and form.enduserto neq "">
       ...
       <!---Agent from Bill--->
			...
			and (userid in (select userid from main.users where userDept = '#dts#' and location='#Huserloc#'))
				...
				left join
				(select wos_group,sum(amt) as sumdnamt from ictran where type='DN' and linecode=''
				<cfif form.areafrom neq "" and form.areato neq "">
				and area >='#form.areafrom#' and area <= '#form.areato#'
				</cfif>
                <cfif form.enduserfrom neq "" and form.enduserto neq "">
       ...
       <!---Agent from Bill--->
			...
			and (userid in (select userid from main.users where userDept = '#dts#' and location='#Huserloc#'))
				...
				left join
				(select wos_group,sum(amt) as sumcnamt from ictran where type='CN' and linecode=''
				<cfif form.areafrom neq "" and form.areato neq "">
				and area >='#form.areafrom#' and area <= '#form.areato#'
				</cfif>
                <cfif form.enduserfrom neq "" and form.enduserto neq "">
