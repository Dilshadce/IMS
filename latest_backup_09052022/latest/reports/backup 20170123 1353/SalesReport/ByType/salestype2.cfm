...
<cfswitch expression="#form.result#">
	<cfcase value="HTML">
		...
		<table width="100%" border="0" cellspacing="0" cellpadding="2">
			...
			<cfif form.enduserfrom neq "" and form.enduserto neq "">
				<tr>
					<td colspan="11"><div align="center"><font size="2" face="Times New Roman, Times, serif">END USER: #form.enduserfrom# - #form.enduserto#</font></div></td>
				</tr>
			</cfif>
			<cfswitch expression="#form.qtysold#">
				<cfcase value="yes">
					...
					<cfquery name="getcustomername" datasource="#dts#">
						select a.custno,a.name,b.agenno,a.agent,(select desp from #target_icagent# where agent=a.agent) as agentdesp,b.sumqty
				...
				and agenno in(select agent from #target_icagent# where team >= '#form.teamfrom#' and team <= '#form.teamto#')
					...
					<cfloop query="getcustomername">
						...
						<tr onMouseOut="javascript:this.style.backgroundColor='';" onMouseOver="javascript:this.style.backgroundColor='99FF00';">
                            ...
                            <cfset agentlist=''>
                            <cfquery name="getallagent" datasource="#dts#">
                            select agenno from artran where custno='#getcustomername.custno#' group by agenno
                            </cfquery>
                            <cfloop query="getallagent">
                            <cfif agentlist eq ''>
                            <cfset agentlist=getallagent.agenno>
                            <cfelse>
                            <cfset agentlist=agentlist&','&getallagent.agenno>
                            </cfif>
                            </cfloop>
                            #agentlist#
                            </font></div></td>
				...
				<cfdefaultcase>
					...
					<cfquery name="getcustomername" datasource="#dts#">
						select a.custno,a.name,b.agenno,b.van,a.agent,(select desp from #target_icagent# where agent=a.agent) as agentdesp,b.sumqty,
				...
				and agenno in(select agent from #target_icagent# where team >= '#form.teamfrom#' and team <= '#form.teamto#')
						...
						left join
						(select custno,sum(invgross)-sum(discount) as suminvamt from artran where type='INV' and (void = '' or void is null)
						<cfif trim(form.customerfrom) neq "" and trim(form.customerto) neq "">
						and custno between '#form.customerfrom#' and '#form.customerto#'
						</cfif>
						<cfif form.periodfrom neq "" and form.periodto neq "">
				...
				and agenno in(select agent from #target_icagent# where team >= '#form.teamfrom#' and team <= '#form.teamto#')
						...
						left join
						(select custno,sum(invgross)-sum(discount) as sumcsamt from artran where type='CS' and (void = '' or void is null)
						<cfif trim(form.customerfrom) neq "" and trim(form.customerto) neq "">
						and custno between '#form.customerfrom#' and '#form.customerto#'
						</cfif>
						<cfif form.periodfrom neq "" and form.periodto neq "">
				...
				and agenno in(select agent from #target_icagent# where team >= '#form.teamfrom#' and team <= '#form.teamto#')
						...
						left join
						(select custno,sum(invgross)-sum(discount) as sumdnamt from artran where type='DN' and (void = '' or void is null)
						<cfif trim(form.customerfrom) neq "" and trim(form.customerto) neq "">
						and custno between '#form.customerfrom#' and '#form.customerto#'
						</cfif>
						<cfif form.periodfrom neq "" and form.periodto neq "">
				...
				and agenno in(select agent from #target_icagent# where team >= '#form.teamfrom#' and team <= '#form.teamto#')
						...
						left join
						(select custno,sum(invgross)-sum(discount) as sumcnamt from artran where type='CN' and (void = '' or void is null)
						<cfif trim(form.customerfrom) neq "" and trim(form.customerto) neq "">
						and custno between '#form.customerfrom#' and '#form.customerto#'
						</cfif>
						<cfif form.periodfrom neq "" and form.periodto neq "">
				...
				and agenno in(select agent from #target_icagent# where team >= '#form.teamfrom#' and team <= '#form.teamto#')
						...
						<cfelse>
						and (ifnull(b.sumqty,0)<>0 or (ifnull(c.suminvamt,0)+ifnull(d.sumcsamt,0)+ifnull(e.sumdnamt,0)-ifnull(f.sumcnamt,0))<>0)
						</cfif>
						<cfif form.areafrom neq "" and form.areato neq "">
						and a.area >='#form.areafrom#' and a.area <='#form.areato#'
						</cfif>
						...
						<cfelse>
            			and (a.custno in ( select custno from #target_arcust# where agent='#ucase(huserid)#'))  
						</cfif>
						<cfelse>
						</cfif>
           				<cfelse>
	...
	<cfcase value="EXCEL">
		...
		<cfif form.datefrom neq "" and form.dateto neq "">
			<Row ss:AutoFitHeight="0" ss:Height="20.0625">
				<Cell ss:MergeAcross="8" ss:StyleID="s32"><Data ss:Type="String">DATE: #form.datefrom# - #form.dateto#</Data></Cell>
			</Row>
		</cfif>
		<cfif trim(form.customerfrom) neq "" and trim(form.customerto) neq "">
			<Row ss:AutoFitHeight="0" ss:Height="20.0625">
