	...
	<cfcase value="EXCEL">
		...
		<cfif form.enduserfrom neq "" and form.enduserto neq "">
			<Row ss:AutoFitHeight="0" ss:Height="20.0625">
				<cfwddx action = "cfml2wddx" input = "END USER: #form.enduserfrom# - #form.enduserto#" output = "wddxText">
        ...
        <cfheader name="Content-Disposition" value="inline; filename=End_User_Sales_Report_By-Type_#huserid#.xls">
