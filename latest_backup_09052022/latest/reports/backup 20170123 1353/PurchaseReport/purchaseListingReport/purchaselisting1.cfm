...
<cfswitch expression="#form.result#">
	...
	<Row ss:AutoFitHeight="0" ss:Height="20.0625">
		<Cell ss:MergeAcross="3" ss:StyleID="s26"><Data ss:Type="String">#Replace(getgeneral.compro, "&", "&amp;", "all")#</Data></Cell>
        <Cell ss:StyleID="s26"/>
        <Cell ss:StyleID="s26"/>
 ...
 <cfif lcase(hcomid) eq "vsolutionspteltd_i">
    ...
    <cfheader name="Content-Disposition" value="inline; filename=#dts#_PLV_#huserid#.xls">
	...
	<table width="100%" border="0" cellspacing="0" cellpadding="2">
		...
		<cfif trim(form.supplierfrom) neq "" and trim(form.supplierto) neq "">
			<tr>
				<td colspan="5"><div align="center"><font size="2" face="Times New Roman, Times, serif">SUPP_NO: #form.supplierfrom# - #form.supplierto#</font></div></td>
			</tr>
		</cfif>
		<tr>
