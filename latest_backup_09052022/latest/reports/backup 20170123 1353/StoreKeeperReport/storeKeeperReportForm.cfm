...
<cfset words_id_list = "5, 1352, 1353, 104, 1354, 1355, 29, 1387, 1388, 1302, 1417, 1418, 123, 495, 496, 146, 497, 498, 703, 1361, 1362, 702, 1300, 1301, 688, 1406, 1569, 1570 ,1571 ,1572 ,1573">
<cfinclude template="/latest/words.cfm">

<cfif url.target EQ "type1">
	<cfset pageTitle="#words[1569]#">
	<cfset formAction="report1.cfm">
    
<cfelseif url.target EQ "type2">
	<cfset pageTitle="#words[1570]#">
	<cfset formAction="report2.cfm">
    
<cfelseif url.target EQ "type3">
	<cfset pageTitle="#words[1571]#">
	<cfset formAction="report3.cfm">     
    
<cfelseif url.target EQ "type4">
	<cfset pageTitle="#words[1572]#">
	<cfset formAction="report4.cfm">  
    
<cfelseif url.target EQ "type5">
	<cfset pageTitle="#words[1573]#">
...
<cfoutput>
	<cfform class="formContainer form3Button" name="storeKeeperReportForm" id="storeKeeperReportForm" action="#formAction#" method="post" target="_blank">
        <div>#pageTitle#</div>
        <div>
            <table> 
                ...
                <cfif url.target NEQ "type1" AND url.target NEQ "type4" AND url.target NEQ "type5">
                    <tr> 
                ...
                <cfif url.target EQ "type1">
                    <tr>
                        ...
                        <td>
                            <div><input type="checkbox" name="" value=""> #words[1406]#</div>
                        </td>
                    </tr>
                </cfif>
            </table>
        ...
        <div>
        	<cfif url.target EQ "type2" OR url.target EQ "type4" OR url.target EQ "type5">
