...
<cfset words_id_list = "123, 495, 496, 146, 497, 498, 1302, 1417, 1418, 703, 1361, 1362, 702, 1300, 1301, 1852, 688, 1406, 2020, 2021, 2022, 2023, 2024, 2025, 2036, 2037, 2027, 2028, 2029, 2034, 2035, 2030, 2033, 2026">
...
<cfif type EQ "itembatchopening">
	<cfif checkcustom.customcompany eq "Y">
        <cfset trantype = "PRODUCT - LOT NUMBER OPENING">
    <cfelse>
        <cfset trantype = "PRODUCT BATCH OPENING">
    </cfif>
	<cfset pageTitle = "#words[2020]#">
    <cfset actionForm = "itembatchopening.cfm">
<cfelseif type EQ "itembatchsales">
	<cfif checkcustom.customcompany eq "Y">
        <cfset trantype = "PRODUCT - LOT NUMBER SALES">
    <cfelse>
        <cfset trantype = "PRODUCT BATCH SALES">
    </cfif>
	<cfset pageTitle = "#words[2021]#">
    <cfset actionForm = "itembatchsales.cfm">
<cfelseif type EQ "itembatchstatus">
	<cfif checkcustom.customcompany eq "Y">
        <cfset trantype = "PRODUCT - LOT NUMBER STATUS">
    <cfelse>
        <cfset trantype = "PRODUCT BATCH STATUS">
    </cfif>
	<cfset pageTitle = "#words[2022]#">
    <cfset actionForm = "itembatchstatus.cfm">
<cfelse>
	<cfif checkcustom.customcompany eq "Y">
        <cfset trantype = "PRODUCT - LOT NUMBER STOCK CARD">
    <cfelse>
        <cfset trantype = "PRODUCT BATCH STOCK CARD">
    </cfif>
	<cfif type EQ "itembatchstockcard1">
		<cfset pageTitle = "#words[2023]#">
        <cfset actionForm = "itembatchstockcard1.cfm">
    <cfelseif type EQ "itembatchstockcard2">
		<cfset pageTitle = "#words[2024]#">
        <cfset actionForm = "itembatchstockcard2.cfm">
    <cfelseif type EQ "itembatchstockcard3">
		<cfset pageTitle = "#words[2025]#">
        <cfset actionForm = "itembatchstockcard3.cfm">
    </cfif>
</cfif>
	...
	<cfform class="formContainer form3Button" name="salesTypeForm" id="salesTypeForm" action="#actionForm#" method="post" target="_blank">
        ...
        <div>
            <table>
                ...
                <cfif type neq "itembatchopening">
                    <tr> 
                ...
                <tr> 
                    <th><label for="date"><cfif type eq "itembatchopening" or type eq "itembatchstatus">#words[2026]#<cfelse>#words[702]#</cfif></label></th>			
                    <td>
        ...
        <div>
			...
			<cfif type neq "itembatchstockcard1" and type neq "itembatchstockcard2" and type neq "itembatchstockcard3">
