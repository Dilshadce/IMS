<html>
<head>
<title>Product Batch Stock Card 2</title>
...
<body>
<p align="center"><font color="#000000" size="4" face="Times New Roman, Times, serif"><strong>PRODUCT <cfif checkcustom.customcompany eq "Y">- LOT NUMBER<cfelse>BATCH</cfif> STOCK CARD 2</strong></font></p>
	...
	<table width="100%" border="0" align="center" cellspacing="0">
		...
		<cfloop query="getitem">
			<tr onMouseOut="javascript:this.style.backgroundColor='';" onMouseOver="javascript:this.style.backgroundColor='99FF00';">
                ...
                <td><div align="right"><font size="2" face="Times New Roman, Times, serif"><a href="itembatchstockcard2A.cfm?itemno=#urlencodedformat(itemno)#&itembal=#getitem.balance#&pf=#urlencodedformat(productfrom)#&pt=#urlencodedformat(productto)#&cf=#categoryfrom#&ct=#categoryto#&pef=#periodfrom#&pet=#periodto#&gpf=#groupfrom#&gpt=#groupto#&df=#datefrom#&dt=#dateto#&batchcode=#batchcode#&batchcodefrom=#batchcodefrom#&batchcodeto=#batchcodeto#&expdate=#getitem.exp_date#&manudate=#getitem.manu_date#<cfif isdefined ('form.figure')>&figure=1</cfif>">View</a></font></div></td>
			</tr>
