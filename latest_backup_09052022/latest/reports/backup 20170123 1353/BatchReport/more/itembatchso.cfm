	...
	<cfoutput query="getinfo">
		<tr onMouseOut="javascript:this.style.backgroundColor='';" onMouseOver="javascript:this.style.backgroundColor='99FF00';">
			...
			<td><div align="center"><font size="2" face="Times New Roman, Times, serif">
				<a href="itembatchso2.cfm?itemno=#urlencodedformat(itemno)#&itemdesp=#urlencodedformat(getinfo.itemdesp)#&batchcode=#urlencodedformat(getinfo.batchcode)#&location=#getinfo.location#&itembal=#getinfo.balance#&cf=#urlencodedformat(customerfrom)#&ct=#urlencodedformat(customerto)#">View Details</a>
			</font></div></td>
		</tr>
	</cfoutput>
</table>
