...
<cfif form.locationFrom neq "" and form.locationTo neq "">        
    <cfquery name="location" datasource="#dts#">
    select refno 
    from ictran 
    where location >='#form.locationFrom#' 
    and location <= '#form.locationTo#' group by refno
    </cfquery>
</cfif>

<cfif form.productFrom neq "" and form.productTo neq "">
    <cfquery name="getRefNoList_Item" datasource="#dts#">
        select refno 
        from ictran 
...
<cfswitch expression="#form.result#">
	<cfcase value="EXCEL">
	   ...
	   <cfif form.periodfrom neq "" and form.periodto neq "">
        ...
        <Cell ss:StyleID="s27"><Data ss:Type="String">Date</Data></Cell>
            ...
            <Cell ss:StyleID="s27"><Data ss:Type="String">AMEX</Data></Cell>
            <Cell ss:StyleID="s27"><Data ss:Type="String">DINERS</Data></Cell>
		...
		<cfquery name="getagent" datasource="#dts#">
            ...
            <cfif form.locationFrom neq "" and form.locationTo neq "">
				and refno in (<cfqueryparam cfsqltype="cf_sql_varchar" value="#valuelist(location.refno)#" list="yes" separator=",">)
			</cfif>
            <cfif form.productFrom neq "" and form.productTo neq "">
            	and refno in (<cfqueryparam cfsqltype="cf_sql_varchar" value="#valuelist(getRefNoList_Item.refno)#" list="yes" separator=",">)
            </cfif>
		...
		<cfloop query="getagent">
			...
			<cfquery name="getdata" datasource="#dts#">
					select a.refno, a.type, if(b.taxincl = "T",sum(b.amt)-a.tax,sum(b.amt)) as invgross, a.discount, a.tax, a.roundadj, a.m_charge1, a.grand, a.CS_PM_cash, a.CS_PM_dbcd, 
                           a.CS_PM_cashcd, a.CS_PM_crcd, a.CS_PM_cheq, a.CS_PM_vouc, a.deposit
                    from artran a 
                    left join ictran b on a.type = b.type and a.refno = b.refno  
					where a.type='CS' and a.wos_date = #getagent.wos_date# and (a.void = '' or a.void is null)
                    
					<cfif form.agentfrom neq "" and form.agentto neq "">
                    and a.agenno >='#form.agentfrom#' and a.agenno <= '#form.agentto#'
                    </cfif>
                    <cfif form.locationFrom neq "" and form.locationTo neq "">
						and a.refno in (<cfqueryparam cfsqltype="cf_sql_varchar" value="#valuelist(location.refno)#" list="yes" separator=",">)
					</cfif>
					<cfif form.productFrom neq "" and form.productTo neq "">
                        and a.refno in (<cfqueryparam cfsqltype="cf_sql_varchar" value="#valuelist(getRefNoList_Item.refno)#" list="yes" separator=",">)
                    </cfif>
                    <cfif form.userfrom neq "" and form.userto neq "">
        ...
        <cfquery name="getdiners2" datasource="#dts#">
            ...
            <cfwddx action = "cfml2wddx" input = "#getdata.refno#" output = "wddxText">
				<Row ss:AutoFitHeight="0">
                    ...
                    <Cell ss:StyleID="s32"><Data ss:Type="Number">#val(getamex.CS_PM_crcd)+val(getamex2.CS_PM_crc2)#</Data></Cell>
                    <Cell ss:StyleID="s32"><Data ss:Type="Number">#val(getdiners.CS_PM_crcd)+val(getdiners2.CS_PM_crc2)#</Data></Cell>
                    ...
                    <Cell ss:StyleID="s32"><Data ss:Type="Number">#val(getdata.deposit)#</Data></Cell>
                                ...
                                <cfset subcrcd4 = subcrcd4 + val(getdiners.CS_PM_crcd)+val(getdiners2.CS_PM_crc2)>
								<cfset totalcrcd4 = totalcrcd4 + val(getdiners.CS_PM_crcd)+val(getdiners2.CS_PM_crc2)>
			...
			<Row ss:AutoFitHeight="0" ss:Height="12">
                ...
                <Cell ss:StyleID="s37"><Data ss:Type="Number">#subroundadj#</Data></Cell>
                <Cell ss:StyleID="s37"><Data ss:Type="Number">#submcharge#</Data></Cell>
                ...
                <Cell ss:StyleID="s37"><Data ss:Type="Number">#subcrcd3#</Data></Cell>
                <Cell ss:StyleID="s37"><Data ss:Type="Number">#subcrcd4#</Data></Cell>
		...
		<Row ss:AutoFitHeight="0" ss:Height="12"/>
	   	<Row ss:AutoFitHeight="0" ss:Height="12">
            ...
            <Cell ss:StyleID="s37"><Data ss:Type="Number">#totalcrcd3#</Data></Cell>
            <Cell ss:StyleID="s37"><Data ss:Type="Number">#totalcrcd4#</Data></Cell>
	...
	<cfcase value="HTML">
		...
		<table width="100%" border="0" cellspacing="0" cellpadding="2">
			<tr>
				<td colspan="100%"><div align="center"><font size="3" face="Times New Roman, Times, serif"><strong>Daily Cash Sales Detail Report</strong></font></div></td>
			</tr>
			<cfif form.periodfrom neq "" and form.periodto neq "">
			<tr>
			...
			<tr>
                ...
                <td><div align="right"><font size="2" face="Times New Roman, Times, serif">Net/Debit Card</font></div></td>
                ...
                <td><div align="right"><font size="2" face="Times New Roman, Times, serif">DINERS</font></div></td>
            ...
            and (creditcardtype2='DINERS')
                    ...
                    <td></td>
                        ...
                        <td><div align="right"><font size="2" face="Times New Roman, Times, serif">#getqty.qty#</font></div></td>
                                ...
                                <td><div align="right">#numberformat(val(getdiners.CS_PM_crcd)+val(getdiners2.CS_PM_crc2),',_.__')#</div></td>
