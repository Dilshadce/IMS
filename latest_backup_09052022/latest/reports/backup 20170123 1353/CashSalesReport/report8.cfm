...
<cfswitch expression="#form.result#">
	...
	<cfset i=1>
		...
		where (type = 'CS')  and b.itemno = a.itemno and (void = '' or void is null)
    ...
    <Cell ss:StyleID="s27"><Data ss:Type="String">Old Item No.</Data></Cell>
        ...
        <Cell ss:StyleID="s27"><Data ss:Type="String">Category</Data></Cell>
         <cfif lcase(hcomid) eq "gramas_i" or lcase(hcomid) eq "kjpe_i" or lcase(hcomid) eq "aipl_i" or lcase(hcomid) eq "belco_i">
