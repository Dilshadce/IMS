...
<table align="center" class="data" width="100%" border="0" cellspacing="0">
	...
	<cfif form.categoryfrom neq "" and form.categoryto neq "">
		<tr>
			<td colspan="7"><div align="center"><font size="2" face="Times New Roman, Times, serif">CATE: #form.categoryfrom# - #form.categoryto#</font></div></td>
		</tr>
	</cfif>
	...
	<cfif form.productfrom neq "" and form.productto neq "">
		<tr>
			<td colspan="7"><div align="center"><font size="2" face="Times New Roman, Times, serif">PRODUCT.NO. #form.productfrom# - #form.productto#</font></div></td>
		</tr>
	</cfif>
	<cfif form.periodfrom neq "">
		<tr>
			<td colspan="7"><div align="center"><font size="2" face="Times New Roman, Times, serif">PERIOD: #form.periodfrom#</font></div></td>
		</tr>
	</cfif>
	<cfif form.datefrom neq "">
		<tr>
			<td colspan="7"><div align="center"><font size="2" face="Times New Roman, Times, serif">DATE: #dateformat(form.datefrom,"dd-mm-yyyy")#</font></div></td>
		</tr>
	</cfif>
	<tr>
	...
	<cfform name="physical_worksheet_adjust" action="physical_worksheet_update_stock.cfm" method="post" target="_BLANK">
		...
		<input type="hidden" name="period" value="#form.periodfrom#">
		<input type="hidden" name="date" value="#dateformat(form.datefrom,'YYYY-MM-DD')#">
