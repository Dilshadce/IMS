...
<cfset words_id_list = "1447,495,496,146,123,497,498,1302,1417,1418,150,1448,1449,703,1183,702,639,1450,1451,1452,1454,501,1399,688">
...
<head>
	...
	function change_link() {
		if(document.physicalWorksheetForm.update_actual_qty.checked==true) {
			document.physicalWorksheetForm.action="physical_worksheet_adjust.cfm";
		}
		else {
			document.physicalWorksheetForm.action="physical_worksheet_result.cfm";
		}
	}
	</script>
...
<cfoutput>
	<cfform class="formContainer form3Button" name="physicalWorksheetForm" id="physicalWorksheetForm" action="physical_worksheet_result.cfm" method="post" target="_blank">
		<div>#pageTitle#</div>
        <div>
            <table> 
			...
			<input type="hidden" name="tf_fperiod" id="tf_fperiod" value="" />
                ...
                <tr> 
                    ...
                    <td>
                        <input type="Text" name="dateFrom" id="dateFrom" maxlength="10" size="10" value="#dateformat(now(),'dd/mm/yyyy')#" placeholder="#words[639]#" readonly="readonly" />
                        </td>
                </tr>
                <tr>
                ...
                <tr>
                    ...
                    <td>
                        ...
                        <div><input type="checkbox" name="generate_adjustment_transaction" id="generate_adjustment_transaction" value="yes"> #words[1454]#</div>
                    </td>
                </tr>
            </table>
		</div>
