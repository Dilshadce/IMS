...
<cfparam name="qtyprojtotal" default="0">
		...
		<cfquery name="getinfo" datasource="#dts#">
			...
			left join(
				...
				<cfif trim(form.itemFrom) neq "" and trim(form.itemTo) neq "">
					and itemno between <cfqueryparam cfsqltype="cf_sql_varchar" value="#form.itemFrom#">
			...
			order by p.source,b.wos_group,b.itemno
		</cfquery>
...
<table align="center" width="80%" border="0" cellspacing="0" cellpadding="1">
	...
	<cfoutput query="getinfo">
		...
		<cfif thisproj neq getinfo.source>
			...
			<cfif thisproj neq "ZZZZZZZZZZ">
				<tr><td colspan="100%"><hr></td></tr>
				<tr>
					<td colspan="2"><div align="right"><font size="2" face="Times New Roman, Times, serif">#ucase(getgeneral.lPROJECT)# TOTAL:</font></div></td>
					<td><div align="right"><font size="2" face="Times New Roman, Times, serif">#qtyprojtotal#</font></div></td>
					<td><div align="right"><font size="2" face="Times New Roman, Times, serif">#numberformat(projtotal,",.__")#</font></div></td>
				</tr>
			</cfif>
			...
			<cfset projtotal=0>
			<cfset grouptotal=0>
			<cfset qtyprojtotal=0>
			<cfset qtygrouptotal=0>
			<tr>
				<td><font size="2" face="Times New Roman, Times, serif"><b>#ucase(getgeneral.lPROJECT)# : #getinfo.source#</b></font></td>
				<td colspan="3"><font size="2" face="Times New Roman, Times, serif"><b>#getinfo.project#</b></font></td>
			</tr>
		</cfif>
		...
		<tr onMouseOut="javascript:this.style.backgroundColor='';" onMouseOver="javascript:this.style.backgroundColor='99FF00';">
			<td><div align="left"><font size="2" face="Times New Roman, Times, serif"><a href="projectreportresult3-2.cfm?itemno=#urlencodedformat(itemno)#&pf=#urlencodedformat(productfrom)#&pt=#urlencodedformat(productto)#&cf=#catefrom#&ct=#cateto#&pef=#periodfrom#&pet=#periodto#&gpf=#groupfrom#&gpt=#groupto#&df=#datefrom#&dt=#dateto#&project=#source#&jobfrom=#jobfrom#&jobto=#jobto#">#getinfo.itemno#</a></font></div></td>
			<td><div align="left"><font size="2" face="Times New Roman, Times, serif">#getinfo.desp#</font></div></td>
		...
		<cfset projtotal=projtotal+val(sumissamt)>
		<cfset grouptotal=grouptotal+val(sumissamt)>
		<cfset grandtotal=grandtotal+val(sumissamt)>
		<cfset qtyprojtotal=qtyprojtotal+val(sumissqty)>
	...
	<tr><td height="2" colspan="100%"><hr></td></tr>
	<tr>
		<td colspan="2"><div align="right"><font size="2" face="Times New Roman, Times, serif"><cfoutput>#ucase(getgeneral.lPROJECT)#</cfoutput> TOTAL:</font></div></td>
		<td><div align="right"><font size="2" face="Times New Roman, Times, serif"><cfoutput>#qtyprojtotal#</cfoutput></font></div></td>
		<td><div align="right"><font size="2" face="Times New Roman, Times, serif"><cfoutput>#numberformat(projtotal,",.__")#</cfoutput></font></div></td>
	</tr>
	<tr><td colspan="100%"><hr></td></tr>
	<tr>
...
<cfwddx action = "cfml2wddx" input = "#title#" output = "wddxText">
	...
	<cfif trim(form.itemFrom) neq "" and trim(form.itemTo) neq "">
		<Row ss:AutoFitHeight="0" ss:Height="23.0625">
        <cfwddx action = "cfml2wddx" input = "#form.itemFrom# To #form.itemTo#" output = "wddxText">
     ...
     <cfwddx action = "cfml2wddx" input = "#dateformat(now(),"dd-mm-yyyy")#" output = "wddxText2">
      <Cell ss:StyleID="s27"><Data ss:Type="String">#wddxText#</Data></Cell>
       ...
       <Cell ss:StyleID="s53"><Data ss:Type="String">#wddxText2#</Data></Cell>
                ...
                <Row ss:AutoFitHeight="0" ss:Height="23.0625"><Cell ss:StyleID="s50"><Data ss:Type="String"></Data></Cell></Row>
                <cfset thisproj="ZZZZZZZZZZ">
	<cfset thisgroup="ZZZZZZZZZZ">
               <cfoutput query="getinfo">
		<cfif thisgroup neq "ZZZZZZZZZZ" and thisgroup neq getinfo.wos_group and thisproj eq getinfo.source>
		...
		<cfif thisproj neq getinfo.source>
			...
			<cfif thisproj neq "ZZZZZZZZZZ">
                    ...
                    <cfwddx action = "cfml2wddx" input = "#ucase(getgeneral.lPROJECT)#" output = "wddxText">
                     <cfwddx action = "cfml2wddx" input = "#qtyprojtotal#" output = "wddxText2">
                     <cfwddx action = "cfml2wddx" input = "#numberformat(projtotal,",.__")#" output = "wddxText3">
					<Cell ss:StyleID="s52"><Data ss:Type="String"><cfoutput>#wddxText# TOTAL :</cfoutput></Data></Cell>	
					<Cell ss:StyleID="s52"><Data ss:Type="String">#wddxText2#</Data></Cell>	
			...
			<Row ss:AutoFitHeight="0" ss:Height="23.0625">
             <cfwddx action = "cfml2wddx" input = "#ucase(getgeneral.lPROJECT)# : #getinfo.source#" output = "wddxText">
              <cfwddx action = "cfml2wddx" input = "#getinfo.project#" output = "wddxText2">
				<Cell ss:StyleID="s52"><Data ss:Type="String"><b>#wddxText#</b></Data></Cell>
				<Cell ss:StyleID="s52"><Data ss:Type="String"><b>#wddxText2#</b></Data></Cell>
			</Row>
		</cfif>
		<cfif thisgroup neq getinfo.wos_group>
			<cfset thisgroup=getinfo.wos_group>
    ...
    <Cell ss:StyleID="s52"><Data ss:Type="String"> </Data></Cell>
		<Cell ss:StyleID="s52"><Data ss:Type="String"><cfoutput>#wddxText# TOTAL :</cfoutput></Data></Cell>
        <Cell ss:StyleID="s52"><Data ss:Type="String"><cfoutput>#wddxText2#</cfoutput></Data></Cell>
        <Cell ss:StyleID="s52"><Data ss:Type="String"><cfoutput>#wddxText3#</cfoutput></Data></Cell>
	</Row>
	<Row ss:AutoFitHeight="0" ss:Height="23.0625">
     <cfwddx action = "cfml2wddx" input = "#qtygrandtotal#" output = "wddxText">
      <cfwddx action = "cfml2wddx" input = "#numberformat(grandtotal,",.__")#" output = "wddxText2">
      <Cell ss:StyleID="s55"><Data ss:Type="String"> </Data></Cell>
    <Cell ss:StyleID="s55"><Data ss:Type="String">GRAND TOTAL :</Data></Cell>
    <Cell ss:StyleID="s55"><Data ss:Type="String"><cfoutput>#wddxText#</cfoutput></Data></Cell>
    <Cell ss:StyleID="s55"><Data ss:Type="String"><cfoutput>#wddxText2#</cfoutput></Data></Cell>
	</Row>
			</Table>
