...
<cfset consignment=''>
	<cfset pageTitle = "Tax Report">
	<cfset trantype = "Tax Report">
	<cfset trancode = "RC">
...
<cfoutput>
	<cfform class="formContainer form3Button" name="TaxReport" id="TaxReport" action="TaxReport.cfm" method="post" target="_blank">
        <div>#pageTitle#</div>
        <div>
        <table>
            ...
            <tr>
                ...
                <td>
                    <select name="periodfrom" id="periodfrom" Onchange="periodto.value = this.options[this.selectedIndex].value;">
