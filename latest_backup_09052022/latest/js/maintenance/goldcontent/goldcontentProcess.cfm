...
<cfset words_id_list = "431,100,154,65,101">
	...
	<cfif url.action EQ "create">
		...
		<cfif checkExist.recordcount>
			<script type="text/javascript">
				...
				window.open('goldcontent.cfm?action=create&menuID=#URLmenuID#','_self');
			</script>
		<cfelse>
			<cftry>
			...
			<script type="text/javascript">
				...
				window.open('goldcontentProfile.cfm?menuID=#URLmenuID#','_self');
			</script>
		</cfif>
	<cfelseif url.action EQ "update">
		...
		<cfcatch type="any">
			<script type="text/javascript">
				...
				window.open('goldcontent.cfm?action=update&menuID=#URLmenuID#&size=#form.size#','_self');
			</script>
		</cfcatch>
		</cftry>
		<script type="text/javascript">
