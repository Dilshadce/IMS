...
<cfset words_id_list = "1414,877,1375,120,11,3">
<cfinclude template="/latest/words.cfm">
<cfset pageTitle="#words[1414]#">
<cfset targetTitle="Item Deleted Before Bill Report">
<cfset targetTable="">
...
<head>
    ...
    <script type="text/javascript" src="/latest/js/enquiries/BillsNotAcceptedReport/report_3.js"></script>
	...
	<div class="page-header">
		<h2>
			...
			<div class="pull-right">
            	<button type="button" class="btn btn-default" onclick="window.open('/default/enquires/norecoverbill2.cfm','_blank');">
