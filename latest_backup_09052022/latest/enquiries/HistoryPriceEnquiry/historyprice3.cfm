...
<table width="100%" border="0" cellspacing="0" cellpadding="2" on>
	...
	<cfquery name="getitem" datasource="#dts#">
        ...
        FROM ictran
		WHERE (type='CN' or type='INV' or type='DN' or type='CS')
	...
	<cfloop query="getitem">
		...
		<cfquery name="getcust" datasource="#dts#">
			SELECT a.type,a.refno,a.custno,a.name,a.wos_date,a.price,b.rem1,a.price_bil,b.agenno,a.unit,a.qty,b.currcode,b.comm2,b.frem7,b.frem8,b.comm1,b.comm3,b.comm4,b.comm0,b.currrate,a.amt,b.rem11,a.dispec1,a.dispec2,a.dispec3
        ...
        <cfif getcust.rem1 neq ''>
        <cfif getcust.rem1 eq 'Profile'>
        <cfquery name="getaddress" datasource="#dts#">
            SELECT * 
            FROM #target_arcust# 
            WHERE custno='#getcust.custno#'
        </cfquery>
        <cfset getcust.frem7=getaddress.name>
        <cfset getcust.frem8=getaddress.name2>
        <cfset getcust.comm0=getaddress.daddr1>
        <cfset getcust.comm1=getaddress.daddr2>
        <cfset getcust.comm2=getaddress.daddr3>
        <cfset getcust.comm3=getaddress.daddr4>
        <cfelse>
        <cfquery name="getaddress" datasource="#dts#">
        select * 
        from address 
        where code='#getcust.rem1#'
        </cfquery>
        <cfset getcust.frem7=getaddress.name>
        <cfset getcust.frem8=''>
        <cfset getcust.comm0=getaddress.add1>
        <cfset getcust.comm1=getaddress.add2>
        <cfset getcust.comm2=getaddress.add3>
        <cfset getcust.comm3=getaddress.add4>
        </cfif>
        </cfif>
...
" output = "wddxText">
                    ...
                    <cfif trim(form.customerFrom) neq "" AND trim(form.customerTo) neq "">
        			<cfwddx action = "cfml2wddx" input = "CUST: #form.customerFrom# - #form.customerTo#" output = "wddxText">
                ...
                <cfif trim(form.customerFrom) neq "" AND trim(form.customerTo) neq "">
                AND b.custno between '#form.customerFrom#' AND '#form.customerTo#'
                </cfif>
                <cfif trim(form.itemfrom) neq "" AND trim(form.itemto) neq "">
    ...
    <cfquery name="getcust" datasource="#dts#">
			SELECT a.type,a.refno,a.custno,a.name,a.wos_date,a.price,a.price_bil,a.unit,a.qty,b.currcode,b.currrate,a.amt,b.rem11,b.frem7,b.comm2,b.frem8,b.agenno,b.rem1
			FROM ictran a,artran b 
			WHERE a.type=b.type
			AND a.refno=b.refno 
			AND (a.type='CN' or a.type='INV' or a.type='DN' or a.type='CS')
        ...
        <cfelse>
        <cfquery name="getaddress" datasource="#dts#">
        select * from address where code='#getcust.rem1#'
        </cfquery>
        <cfset getcust.frem7=getaddress.name>
        <cfset getcust.frem8=''>
        <cfset getcust.comm0=getaddress.add1>
