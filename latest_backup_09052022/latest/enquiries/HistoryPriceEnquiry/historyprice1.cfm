...
<table width="100%" border="0" cellspacing="0" cellpadding="2">
	...
	<cfloop query="getcust">
		...
		<cfquery name="getdata" datasource="#dts#">
			...
			FROM ictran 
            WHERE custno='#custno#' 
            AND (type='INV' or type='DN' or type='CS') 
			...
			group by itemno 
			<cfif IsDefined('form.sort')>order by #form.sort#</cfif>
		</cfquery>
		...
		<cfloop query="getdata">
			...
			<tr onMouseOut="javascript:this.style.backgroundColor='';" onMouseOver="javascript:this.style.backgroundColor='99FF00';"> 
                ...
                <cfquery name="getitem" datasource="#dts#">
					SELECT a.itemno,date_format(b.wos_date1,'%d-%m-%Y') as wos_date1,ifnull(b.price1,0) as price1,a.price as rprice,
				...
				<td><div align="left"><font size="2" face="Times New Roman, Times, serif">#numberformat(getitem.rprice,".__")#</font></div></td>
