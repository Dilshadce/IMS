...
<cfset words_id_list = "1413,702,1088,1375,703,1320,11,3">
<cfinclude template="/latest/words.cfm">
<cfset pageTitle="#words[1413]#">
<cfset targetTitle="Missing Posted IMS Bills">
<cfset targetTable="">
...
<head>
   ...
   <!--- <meta name="viewport" content="width=device-width, initial-scale=1.0" />--->
    ...
    <script type="text/javascript">
        ...
        var date='#words[702]#';
        var billtype='#words[1088]#';
        var referenceno='#words[1375]#';
        var period='#words[703]#';
        var grandtotal='#words[1320]#';
        var SEARCH='#words[11]#';
    </script>
    </cfoutput>
    <script type="text/javascript" src="/latest/js/enquiries/ExceptionReport/report_5.js"></script>
	...
	<div class="page-header">
		<h2>
			...
			<div class="pull-right">
            	<button type="button" class="btn btn-default" onclick="window.open('/default/report-exception/imspostedbillcheck.cfm','_blank');">
