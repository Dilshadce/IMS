...
<cfset words_id_list = "1416,1087,959,702,106,23,11, 1533, 1534, 65, 1535, 1536, 11">
<cfinclude template="/latest/words.cfm">
<cfset pageTitle="#words[1533]#">
...
<head>
   ...
   <!--- <meta name="viewport" content="width=device-width, initial-scale=1.0" />--->
    ...
    <script type="text/javascript">
        var dts='#dts#';
		var relateditemno = '#words[1534]#';
		var description = '#words[65]#';
		var stockbalance = '#words[1535]#';
		var unitprice = '#words[1536]#';
		var SEARCH = '#words[11]#';
    </script>
    </cfoutput>
    <script type="text/javascript" src="/latest/js/enquiries/InventoryBalanceCheck/relitembalance.js"></script>
