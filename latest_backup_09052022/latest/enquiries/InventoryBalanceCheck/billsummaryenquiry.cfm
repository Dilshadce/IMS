...
<cfelse>
	...
	<cfxml variable="data">
			...
			<Worksheet ss:Name="Print Bill Summary Report">
                ...
                <cfif trim(form.supplierfrom) neq "" and trim(form.supplierto) neq "">
                    <cfwddx action = "cfml2wddx" input = "SUPP: #form.supplierfrom# - #form.supplierto#" output = "wddxText">
                        <Row ss:AutoFitHeight="0" ss:Height="23.0625">
                            <Cell ss:MergeAcross="#c#" ss:StyleID="s22"><Data ss:Type="String">#wddxText#</Data></Cell>
                        </Row>
                </cfif>
                ...
                <cfif form.refnofrom neq "" and form.refnoto neq "">
                    <cfwddx action = "cfml2wddx" input = "REF NO: #form.refnofrom# - #form.refnoto#" output = "wddxText">
                        <Row ss:AutoFitHeight="0" ss:Height="23.0625">
                            <Cell ss:MergeAcross="#c#" ss:StyleID="s22"><Data ss:Type="String">#wddxText#</Data></Cell>
                        </Row>
                </cfif>
