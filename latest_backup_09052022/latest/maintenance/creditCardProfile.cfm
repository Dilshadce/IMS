...
<head>
    ...
    <script type="text/javascript" src="/latest/js/maintenance/creditCardProfile.js"></script>
	...
	<div class="page-header">
		<h2>
			...
			<div class="pull-right">
                <button type="button" class="btn btn-default" onclick="window.open('/latest/maintenance/creditCard.cfm?action=create&menuID=#menuID#','_self');">
                    <span class="glyphicon glyphicon-plus"></span> Add Credit Card
                </button>
                <button type="button" class="btn btn-default" onclick="window.open('/latest/maintenance/creditCardProcess.cfm?action=print&pageTitle=#pageTitle#','_blank');">
