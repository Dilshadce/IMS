...
<cffunction name="listAccount" access="remote" returntype="struct">
	...
	<cfquery name="getFilteredDataSet" datasource="#dts#">
		SELECT SQL_CALC_FOUND_ROWS groupID,desp,recurrtype,nextdate
		FROM recurrgroup
	...
	<cfquery name="getTotalDataSetLength" datasource="#dts#">
		SELECT COUNT(groupID) AS iTotal
		FROM #targetTable#
	</cfquery>
    ...
    <cfloop query="getFilteredDataSet">	
        ...
        <cfset data["groupID"]=groupID>
        <cfset data["desp"]=desp>
        <cfset data["recurrtype"]=recurrtype>
        <cfset data["nextdate"]=nextdate>        
