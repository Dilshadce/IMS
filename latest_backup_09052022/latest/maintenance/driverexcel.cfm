...
<cfset words_id_list = "100, 16, 536, 101,1499,23,1358">
...
<cfxml variable="data">
			...
			<Worksheet ss:Name="#words[1358] #Listing">
				...
				<Row ss:AutoFitHeight="0" ss:Height="23.0625">
					...
					<Cell ss:StyleID="s27"><Data ss:Type="String">IC No</Data></Cell>
                    <Cell ss:StyleID="s27"><Data ss:Type="String">DOB</Data></Cell>
                    <Cell ss:StyleID="s27"><Data ss:Type="String">ADDRESS</Data></Cell>
                    <Cell ss:StyleID="s27"><Data ss:Type="String">PHONE</Data></Cell>
                    <Cell ss:StyleID="s27"><Data ss:Type="String">HP</Data></Cell>
				</Row>
