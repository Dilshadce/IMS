...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="/latest/maintenance/weelungtest/dataTables_bootstrap.css" />
    ...
    <script type="text/javascript" src="/latest/maintenance/weelungtest/jquery.dataTables.min.js"></script>
     <script type="text/javascript" src="/latest/maintenance/weelungtest/FixedColumns.min.js"></script>
    ...
    <script type="text/javascript" src="/latest/maintenance/weelungtest/productProfile.js"></script>
