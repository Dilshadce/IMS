...
<script>
	...
	<script type="text/javascript" src="/latest/js/maintenance/target2.js"></script>
								...
								<div class="col-sm-6">								
									<div class="form-group">
										...
										<div class="col-sm-8">
											<div class="row">
												<div class="col-sm-12">
													<input type="text" class="form-control input-sm" id="custno" name="custno" autocomplete="off" placeholder="XXXX/XXX" maxlength="8" <cfif IsDefined("url.action") AND url.action NEQ "create"> value="#custno#" disabled="true"</cfif>>
												</div>
											</div>
