		...
		<cfelse>
			<cftry> 
				<cfquery name="createProduct" datasource="#dts#">
					INSERT INTO icitem (itemno,desp,despa,comment,aitemno,barcode,taxcode,pur_taxcode,itemtype,nonstkitem,photo,         								  							brand,category,wos_group,colorid,shelf,costcode,sizeid,costformula,supp,wqformula,wpformula,wserialno,packing,reorder,minimum,maximum,qtybf,<cfloop index="i" from="2" to="6">qty#i#,</cfloop>graded,
					...
					(
                        ...
                        <cfqueryparam cfsqltype="cf_sql_varchar" value="#trim(form.purchaseTax)#">,
                        ...
                        <cfif len(form.stock) neq 8>""<cfelse><cfqueryparam cfsqltype="cf_sql_varchar" value="#trim(form.stock)#"></cfif>,
				...
				<cfif IsDefined('form.grade')>
                	<cfquery name="insertgrade" datasource="#dts#">
                	INSERT INTO itemgrd (itemno)
                    VALUES (<cfqueryparam cfsqltype="cf_sql_varchar" value="#trim(form.itemNo)#">)
                    </cfquery>
				</cfif>
            ...
            <cfquery name="getlocationqtybf" datasource="#dts#">
               SELECT sum(locqfield) as qtybf FROM  locqdbf WHERE
               itemno = <cfqueryparam cfsqltype="cf_sql_varchar" value="#trim(form.itemno)#">
        	</cfquery>
        
       		<cfif getLocation.recordcount neq 0 and getlocationqtybf.qtybf neq val(form.qtyBF)>
            <script type="text/javascript">
				window.open('/latest/maintenance/addlocationqtybf.cfm?menuID=#URLmenuID#&itemno=#urlencodedformat(trim(form.itemNo))#','_self');
			</script>
            <cfelse>
			<script type="text/javascript">
		...
		<cftry>	
			<cfquery name="updateProduct" datasource="#dts#">
				...
				SET
                    ...
                    pur_taxcode = <cfqueryparam cfsqltype="cf_sql_varchar" value="#trim(form.purchaseTax)#">,
                    ...
                    stock = <cfif len(form.stock) neq 8>""<cfelse><cfqueryparam cfsqltype="cf_sql_varchar" value="#trim(form.stock)#"></cfif>,
            ...
            <cftry>
                    ...
                    <cfloop query="getLocation">
                        <cfquery name="insert_LOCQDBF" datasource="#dts#">
                            INSERT IGNORE INTO locqdbf (itemno,location) 
                            VALUES (
                            			'#trim(itemno)#',
                                        '#getlocation.location#'
                                   )
