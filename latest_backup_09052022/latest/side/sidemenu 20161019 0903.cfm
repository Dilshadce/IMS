...
<li id="cseuroprofitmargin" class="manpowerdoc">
			...
			<li id="manpowerpricematrix" class="manpowerpricematrix">
                ...
                <li id="manpowertimesheetval" class="manpowertimesheetval">
                                <a href="/latest/customization/manpower_i/mpapproval/TimesheetApprovalMain.cfm" target="mainFrame">Validate Time Sheet</a>
                        </li>     
                        ...
                        <li id="billableonlyitem" class="billableonlyitem">
                                <a href="/CFSpaybill/listCFSEmployee.cfm" target="mainFrame">List CFS Employee</a>
                        </li>
                        <li id="billableonlyitem" class="billableonlyitem">
                                <a href="/CFSpaybill/listCFSprofile.cfm" target="mainFrame">List CFS Profile</a>
                        </li>    
                        <li id="billableonlyitem" class="billableonlyitem">
                                <a href="/CFSpaybill/listCFSprofile.cfm" target="mainFrame">Add/Remove Employee CFS Profile</a>
                        </li>                  
                        <li id="billableonlyitem" class="billableonlyitem">
                                <a href="/CFSpaybill/generateInvoiceBankfile.cfm" target="mainFrame">Generate Invoice and Bankfile</a>
                        </li>
</ul>
</li>  
