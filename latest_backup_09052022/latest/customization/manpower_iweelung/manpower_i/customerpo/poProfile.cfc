...
<cffunction name="listAccount" access="remote" returntype="struct">
	...
	<cfquery name="getFilteredDataSet" datasource="#dts#">
		SELECT SQL_CALC_FOUND_ROWS refno,wos_date,custno,povalidate,poamount,pothresholdamount
	...
	<cfquery name="getTotalDataSetLength" datasource="#dts#">
		...
		WHERE placementno in (<cfqueryparam cfsqltype="cf_sql_varchar" list="yes" separator="," value="#jolist#">)
            ...
            <cfset data["povalidate"]=dateformat(povalidate,'dd/mm/yyyy')>
            <cfset data["poamount"]=poamount>
			<cfset data["pothresholdamount"]=pothresholdamount>
			<cfset data["joamount"]=getjoamount.custtotal>
