<cfset targetTitle="Document Linkage Profile">
<cfset targetTable="docupload">
<cfset pageTitle="Document Linkage Profile">

<cfif IsDefined("url.action")>
	<cfif url.action EQ "create">
		<cfset pageTitle="New Document Linkage">
	...
	<cfelseif url.action EQ "update">
		<cfset pageTitle="Update Document Linkage">
