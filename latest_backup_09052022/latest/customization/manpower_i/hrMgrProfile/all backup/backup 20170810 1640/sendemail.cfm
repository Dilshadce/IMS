...
<cfoutput>
   ...
   alert('with guide'); 
    ...
    <cfelse>
        ...
        <cfloop query="getlist">
            <script>
   alert('without guide,#getlist.recordcount#'); 
   </script>
            <cfmail from="donotreply@manpower.com.my" failto="myhrhelpdesk@manpower.com.my,alvin.hen@manpower.com.my" to="#getlist.useremail#" subject="MP4U Password Reset" replyto="myhrhelpdesk@manpower.com.my" bcc="alvinh.mpg@gmail.com"  type="html"><!---myhrhelpdesk@manpower.com.my--->
