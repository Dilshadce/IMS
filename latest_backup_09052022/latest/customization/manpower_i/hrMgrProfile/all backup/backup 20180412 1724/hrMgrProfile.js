...
$(document).ready(function(e) {
	...
	var resultTable=$('#resultTable')
		.dataTable({
			...
			'aoColumnDefs':[
				{'aTargets':[0],'sTitle':"user id".toUpperCase(),'mData':'userID','bSortable':true,'sWidth':'10%'},
				{'aTargets':[1],'sTitle':custno.toUpperCase(),'mData':'custno','bSortable':true,'sWidth':'26%'},
				{'aTargets':[2],'sTitle':"name".toUpperCase(),'mData':'userName','bSortable':true,'sWidth':'26%'},
				{'aTargets':[3],'sTitle':email.toUpperCase(),'mData':'userEmail','bSortable':true,'sWidth':'26%'},
				{
					'aTargets':[4],
			...
			'sAjaxSource':'/latest/customization/manpower_i/hrMgrProfile/hrMgrProfile.cfc',
			'sServerMethod':'POST',
        	'sScrollX':'100%'
		})
		.fadeIn();
