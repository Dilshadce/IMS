...
<head>
	...
	function additem(){
		...
		if(document.getElementById('itemname2').value != ''){
...
<cfoutput>
<cfform id="form" name="form" class="form-horizontal" role="form" action="pricematrixProcess.cfm?action=edit" method="post" onsubmit="return validatefield();" >
	<div class="page-header">
		<h3>#pageTitle#</h3>
        <h5>For Tips on Price Structure, please scroll all the way to the bottom.</h5>
	</div>
							...
							<div class="row">
                                ...
                                <td>
                                    ...
                                    <cfif ArrayContains(list,getauthuser())>
                                        <cfinput type="text" size="50" id="pricename" name="pricename"  placeholder="Pay & Bill Structure Name" value="#pricename#" required="true" message="Please Key In Pay & Bill Structure Name">	
                                    <cfelse>
    ...
    (only applicable for %)</th>
                                    ...
                                    <tr>
                                                ...
                                                <td>
                                             <select name="itemname" id="itemname" onchange="document.getElementById('itemname2').value=this.options[this.selectedIndex].id" style="width:150px" hidden="true">
                                             ...
                                             <input type="hidden" name="itemname2" id="itemname2" value="" class="itemnameFilter"/>
...
(only applicable for %)</label>
            ...
            <div>
                Tips:<br>
                Items with "A-" is items in Fix Allowance and Variable Allowance Section in Assignment Slip.<br>
                Items with "B-" is items in Monthly Billable Item Section in Assignment Slip.<br>
                To setup formula, the items of allowance and bill should not have the "-" symbol. E.g. A1 instead of A-1<br><br>
                <table>
                    <tr>
                        <td>BASIC = </td>
                        <td>Basic Rate</td> 
                        ...
                        <td>&nbsp;</td>
                        <td>RATEYEE = </td>
                        <td>Basic Employee Amount</td>  
                        <td>&nbsp;</td>
                        <td>|</td>
                        <td>&nbsp;</td>
                        <td>RATEYER = </td>
                        <td>Basic Employer Amount</td> 
                    </tr>
                    <tr>
                        <td>EPFYER = </td>
                        <td>EPF Employer/Billing</td> 
                        <td>&nbsp;</td>
                        <td>|</td>
                        <td>&nbsp;</td>
                        <td>SOCSOYER = </td>
                        <td>SOCSO Employer/Billing</td>  
                        <td>&nbsp;</td>
                        <td>|</td>
                        <td>&nbsp;</td>
                        <td>EISYER = </td>
                        <td>EIS Employer/Billing</td>                         
                    </tr>
                    <tr>
                        <td>TOTALFIXAW = </td>
                        <td>Total Fix Allowance Amount</td> 
                        <td>&nbsp;</td>
                        <td>|</td>
                        <td>&nbsp;</td>
                        <td>TOTALVARAW = </td>
                        <td>Total Variable Allowance Amount</td>  
                        <td>&nbsp;</td>
                        <td>|</td>
                        <td>&nbsp;</td>
                        <td>AW_TOTAL = </td>
                    ...
                    <tr>
                        <td>EPF_FIXAW = </td>
                        <td>Total EPF Amount for Fix Allowance</td> 
                        <td>&nbsp;</td>
                        <td>|</td>
                        <td>&nbsp;</td>
                        <td>EPF_VARAW = </td>
                        <td>Total EPF Amount for Variable Allowance</td>                      
                    </tr>
                    <tr>
                        <td>SOCSO_FIXAW = </td>
                        <td>Total SOCSO Amount for Fix Allowance</td> 
                        <td>&nbsp;</td>
                        <td>|</td>
                        <td>&nbsp;</td>
                        <td>SOCSO_VARAW = </td>
                        <td>Total SOCSO Amount for Variable Allowance</td>                      
                    </tr>
                    <tr>
                        <td>EIS_FIXAW = </td>
                        <td>Total EIS Amount for Fix Allowance</td> 
                        <td>&nbsp;</td>
                        <td>|</td>
                        <td>&nbsp;</td>
                        <td>EIS_VARAW = </td>
                        <td>Total EIS Amount for Variable Allowance</td>                      
                    </tr>
                    <tr> 
                        <td>&nbsp;</td>        
                    </tr>
