<!--- Get User Details--->
<cfquery name="getUserDetails" datasource="main">
	SELECT userID, userGrpID,userEmail
    FROM users
    WHERE userID = <cfqueryparam cfsqltype="cf_sql_varchar" value="#getAuthUser()#">;
</cfquery>
<cfset companyID = dts>
<cfset userID = getUserDetails.userID>
<cfset userGrpID = getUserDetails.userGrpID>
<cfset userEmail = getUserDetails.userEmail>
		...
		<div class="row">
			<form role="form" class="container" action="/latest/body/sendSupportEmail.cfm" method="post" enctype="multipart/form-data" onsubmit="return validate();">
            	<cfoutput>
                    ...
                    <input type="hidden" id="userGrpID" name="userGrpID" value="#userGrpID#" />
		...
		<div class="row">
			<div class="col-sm-4">
				...
				<div class="row">
					...
					<h4 class="text-muted col-sm-4 btmSubContent">1700 81 8010</h4>
					<div class="col-sm-2"></div>
				</div>
				<div class="row">
					<div class="col-sm-2"></div>
			...
			<div class="col-sm-4" id="remoteAssistanceDiv">
				...
				<a href="https://download.teamviewer.com/download/version_10x/TeamViewer_Setup.exe" target="_self"><h4 class="text-muted text-center btmSubContent">Team Viewer >></h4></a><br />
				<a href="https://download3.showmypc.com/ShowMyPC3160.exe" target="_self"><h4 class="text-muted text-center btmSubContent">ShowMyPc >></h4></a><br />
			</div>
			<div class="col-sm-4">
