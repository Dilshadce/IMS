	...
	var resultTable=$('#resultTable')
		.dataTable({
			...
			'aoColumnDefs':[				
				...
				{'aTargets':[0],'sTitle':'PO Number','mData':'refno','bSortable':true,'sWidth':'15%','bVisible':document.getElementById("0").selected},
				{'aTargets':[1],'sTitle':'Date','mData':'wos_date','bSortable':true,'sWidth':'15%','bVisible':document.getElementById("1").selected},
				{'aTargets':[2],'sTitle':'Customer','mData':'custno','bSortable':true,'sWidth':'15%','bVisible':document.getElementById("2").selected},				
				{'aTargets':[3],'sTitle':'Valid Date','mData':'povalidate','bSortable':true,'sWidth':'15%','bVisible':document.getElementById("3").selected},
				{'aTargets':[4],'sTitle':'Amount','mData':'poamount','bSortable':true,'sWidth':'10%','bVisible':document.getElementById("4").selected},
				{'aTargets':[5],'sTitle':'Threshold Amount','mData':'pothresholdamount','bSortable':true,'sWidth':'10%','bVisible':document.getElementById("5").selected},
				{'aTargets':[6],'sTitle':'JO Used Amount','mData':'joamount','bSortable':true,'sWidth':'10%','bVisible':document.getElementById("6").selected},
				{
					'aTargets':[7],
