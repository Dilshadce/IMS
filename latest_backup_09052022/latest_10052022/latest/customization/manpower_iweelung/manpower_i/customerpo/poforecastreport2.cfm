...
<body <cfif getpin2.h4G00 eq "T">onBeforePrint="document.body.style.display = 'none';" onAfterPrint="document.body.style.display = '';"</cfif>>
	...
	<table width="100%" border="2" cellspacing="0" cellpadding="5" >
		<tr>
			...
			<th><div align="right"><font size="2" face="Times New Roman, Times, serif">Forecast Months For PO to hit Threshold</font></div></td>
		</tr>
		...
		<cfset totalmonth=1>
				...
				<tr onMouseOut="javascript:this.style.backgroundColor='';" onMouseOver="javascript:this.style.backgroundColor='99FF00';">
					...
					<td nowrap><div align="left"><font size="2" face="Times New Roman,Times,serif">#getallcustpo.refno#</font></div></td>
