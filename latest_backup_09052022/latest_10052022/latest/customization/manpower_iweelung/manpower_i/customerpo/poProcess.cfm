		...
		<cfelse>
			<cftry> 
				<cfquery name="createProduct" datasource="#dts#">
					INSERT INTO manpowerpo (refno,custno,wos_date,povalidate,poamount,pothresholdamount,notificationemail,notificationuser,notificationsetting,virtualpo,created_by,created_on)                     
					VALUES
					(
