...
SELECT disamt_bil FROM ictrantempcn where uuid = <cfqueryparam cfsqltype="cf_sql_varchar" value="#form.uuid#"> and id = <cfqueryparam cfsqltype="cf_sql_varchar" value="#form.trancode#">
</cfquery>
...
WHERE 
uuid = <cfqueryparam cfsqltype="cf_sql_varchar" value="#form.uuid#"> and
id = <cfqueryparam cfsqltype="cf_sql_varchar" value="#form.trancode#">
</cfquery>

<cfquery name="getitemdetail" datasource="#dts#">
SELECT itemno,unit,currrate,disamt_bil,brem4,qty,qty_bil FROM ictrantempcn WHERE 
uuid = <cfqueryparam cfsqltype="cf_sql_varchar" value="#form.uuid#"> and
id = <cfqueryparam cfsqltype="cf_sql_varchar" value="#form.trancode#">
</cfquery>
