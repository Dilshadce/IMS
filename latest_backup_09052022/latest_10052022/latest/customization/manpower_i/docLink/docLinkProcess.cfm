...
<cfif IsDefined("url.action")>
	<cfif url.action EQ "create">	
        ...
        <cfcatch type="any">
            <script type="text/javascript">
                alert('Failed to create new document linkage!\nError Message: #cfcatch.message#');
                window.open('/latest/customization/manpower_i/docLink/docLinkDetail.cfm?action=create','_self');
            </script>
        </cfcatch>
        </cftry>
		<script type="text/javascript">
			alert('New document linkage has been created successfully!');
	...
	<cfelseif url.action EQ "update">	
		...
		<script type="text/javascript">
			alert('Updated document linkage successfully!');
			window.open('/latest/customization/manpower_i/docLink/docLink.cfm','_self');
		</script>	
	<cfelseif url.action EQ "delete">
        ...
        <cfcatch type="any">
            <script type="text/javascript">
                alert('Failed to delete document linkage!\nError Message: #cfcatch.message#');
                window.open('/latest/customization/manpower_i/docLink/docLink.cfm','_self');
            </script>
        </cfcatch>
		</cftry>
		<script type="text/javascript">
			alert('Deleted document linkage successfully!');
			window.open('/latest/customization/manpower_i/docLink/docLink.cfm','_self');
		</script>
	<cfelse>
		<script type="text/javascript">
