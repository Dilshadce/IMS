...
<cfloop query="getposlist">
    ...
    --->
            ...
            <td>
                <a href="##" onclick="confirmApprove#apptype#('app','#getposlist.id#')"><img height="30px" width="30px" src="/images/1.jpg" alt="Approve" border="0"><br/>Approve</a>
            </td>
            <td>
                <a href="##" onclick="confirmDecline('dec','#getposlist.id#')"><img height="30px" width="30px" src="/images/2.jpg" alt="Decline" border="0"><br />Decline</a>
            </td>
...
<div class="tabbertab">
    ...
    <cfquery name="getposlist" datasource="#dts2#">
        ...
        WHERE status in ('Updated To Payroll','update to payroll','Approved') ORDER BY empno
    </cfquery>
	<tr>
        <th width="2%"><center>No.</th>
        <th width="12%"><center>Employee</th>
