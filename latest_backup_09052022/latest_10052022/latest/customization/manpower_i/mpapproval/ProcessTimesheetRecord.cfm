<cfset targetTitle="Process Approved Timesheet">
<cfset targetTable="timesheet">

<cfset pageTitle="Process Approved Timesheet">
...
<head>
    ...
    <script type="text/javascript" src="/latest/customization/manpower_i/mpapproval/ProcessTimesheetRecord.js"></script>
</head>
