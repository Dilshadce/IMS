...
<cffunction name="listAccount" access="remote" returntype="struct">
	...
	<cfloop query="getFilteredDataSet">
        ...
        <!---<cfquery name="getflday" datasource="#dts#">
            ...
            WHERE status IN ('PROCESSED') and a.empno = '#getFilteredDataSet.empno#' and a.placementno = '#getFilteredDataSet.placementno#'
        ...
        <cfset data["tmonth"]=monthasstring(month(tmonth))>
