...
<cfif IsDefined("url.action")>
        ...
        <cftry>
			...
			<cfif IsDefined("form.fileUpload")>
                ...
                <cfquery name="uploadDoc" datasource="#dts#">
                    INSERT INTO docupload (uuid, name, path, uploaded_by, uploaded_on)
                    Values (
                        <cfqueryparam cfsqltype="cf_sql_varchar" value="#form.hidUuid#">,
                ...
                <cfquery name="uploadDoc" datasource="#dts#">
                    INSERT INTO docuploadat (docupload_id, uuid, name, path, uploaded_by, uploaded_on, remark)
                    Values (
	...
	<cfelseif url.action EQ "delete">
		<cftry>
            ...
            <cfquery name="uploadDoc" datasource="#dts#">
                INSERT INTO docuploadat (docupload_id, uuid, name, path, uploaded_by, uploaded_on, updated_by, updated_on, remark)
                Values (
