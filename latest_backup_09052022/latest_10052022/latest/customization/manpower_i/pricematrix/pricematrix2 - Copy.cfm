		...
		var limit=10;
			...
			$(document).ready(function(e) {
				$('.itemnameFilter').select2({
					...
					placeholder:"Choose a <Cell></Cell>",
          ...
          <div class="row">
            <table width="100%">
              <tr>
                ...
                <td><input type="hidden" name="priceid" id="priceid" value="#priceid#">
                  <cfinput type="text" size="50" id="pricename" name="pricename"  placeholder="Pay & Bill Structure Name" value="#pricename#" readonly required="true" message="Please Key In Pay & Bill Structure Name"></td>
              </tr>
              <tr>
                <td colspan="100%" style="padding-top :20px;"><table width="80%" style="margin-left:10%;">
                    <tr>
                      <th width='30%'><Cell></Cell>
                      </th>
                      ...
                      <td  width='70%' style='padding-left:10px'><select class='form-control' name="itemname" id="itemname" onchange="document.getElementById('itemname2').value=this.options[this.selectedIndex].id" style="width:150px">
                        ...
                        <input type="hidden" name="itemname2" id="itemname2" value="" /></td>
                    </tr>
                    <tr>
                      <th>Payable
                        <input type="checkbox" id="payable" name="payable" value="1" class='pull-right'/></th>
                      <td style='padding-left:10px'><input type='text' class='form-control input-sm' id="payableamt" name="payableamt" value="" placeholder="Payable Amount" style='width : 40%;text-align:right;'/></td><input type="hidden" class="pull-right form-control input-sm" style="text-align:right" id="payadminfee" name="payadminfee" value="" placeholder="Pay Admin Fee" />
                    </tr>
                    <tr>
                      <th>Billable
                        <input type='checkbox'  id="billable" name="billable" value="1"  class='pull-right'/></th>
                      <td style='padding-left:10px'><input type="text" class="form-control pull-left input-sm" style="text-align:right;width: 40%;" id="billableamt" name="billableamt" value="" placeholder="Billable Amount" />
                        <input type="text" class="pull-left form-control input-sm" style="text-align:right;width: 40%;" id="billadminfee" name="billadminfee" value="" placeholder=" Billable Admin Fee" /></td>
                    </tr>
                    <tr>
                      <td>&nbsp;</td>
                    </tr>
                    <tr>
                      <td colspan='3'><input type="checkbox" id="saf" name="saf" value="1" />
                        Same Statutory AF (only applicable for %) <br />
                        <input type="checkbox" id="statutoryBillingType" name="statutoryBillingType" value="1" />
                        Statutory Billing Inclusive</td>
                    </tr>
                    <!-- test -->
                    
                    <tr>
                      <td colspan="2" align="right"><input type="button" id="addlist" name="addlist" value="Add" class='btn btn-info' onclick="additem()" ></td>
                    </tr>
                  </table></td>
              </tr>
            </table>
        ...
        <div class="panel panel-default">
          ...
          <div id="panel1Collapse" class="panel-collapse collapse in">
            <div class="panel-body">
              ...
              <!-- <label for="itemname" class="col-sm-2 control-label">Statutory Billing Type</label> -->
              <label for="itemname" class="col-sm-1 control-label">Action</label>
            </div>
                  <cfloop query="getpriceiddetail">
                    <div class="form-group">
                <div class="col-sm-1" > #getpriceiddetail.itemname# </div>
                <div class="col-sm-1" align="center"> #getpriceiddetail.payable# </div>
                <div class="col-sm-2" align="right"> #getpriceiddetail.payableamt# </div>
                <!--- <div class="col-sm-2" align="right">
											#getpriceiddetail.payadminfee#
										</div> --->
                
                <div class="col-sm-1" align="center"> #getpriceiddetail.billable# </div>
                <div class="col-sm-2" align="right"> #getpriceiddetail.billableamt# </div>
                <div class="col-sm-2" align="right"> #getpriceiddetail.billadminfee# </div>
                <div class="col-sm-2" align="right"> #getpriceiddetail.saf# </div>
               
                 <!--<div class="col-sm-2" align="right"> #getpriceiddetail.statutoryBillingType# </div> -->
