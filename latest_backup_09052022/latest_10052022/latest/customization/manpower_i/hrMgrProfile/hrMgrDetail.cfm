<cfif IsDefined("url.action")>
	<cfif url.action EQ "create">
        ...
        <cfset isLogin = "">
        <cfset comID = "">  
        <cfset approveverify = "APPROVED">  
        <cfset approvalview = "SUBMITTED FOR APPROVAL,IN PROGRESS">  
	...
	<cfelseif url.action EQ "update">
        ...
        <cfset approveverify = getHM.approveverify>
        <cfset approvalview = getHM.approvalview>
    </cfif>      
</cfif>
...
<head>
    ...
    <script>
        function checkboxes(){
            if(document.getElementById('submitted').checked == false && document.getElementById('verified').checked == false){
                alert('Kindly check/select at least one approval view option!');
                return false;
            }
            else{
                return true;
...
<div class="container">
    ...
    <cfform class="form-horizontal" action="/latest/customization/manpower_i/hrMgrProfile/hrMgrProcess.cfm?action=#url.action#" method="post" enctype="multipart/form-data"
            onsubmit="javascript: return checkboxes()">
        <div class="row">
        	<div class="col-sm-9">
                ...
                <div class="form-group">
                    <label class="col-sm-2 control-label">Approve/Verify</label>
                            
                        <div class="col-sm-4">
                            <div class="input-group">
                                <span class="input-group-addon">
                                    <input type="radio" name="approveverify" value="APPROVED" <cfif "#approveverify#" EQ "APPROVED">checked</cfif>>
                                </span>
                        ...
                        <div class="col-sm-3">
                            <div class="input-group">
                                <span class="input-group-addon">
                                    <input type="radio" name="approveverify" value="VERIFIED" <cfif "#approveverify#" EQ "VERIFIED">checked</cfif>>
                                </span>
                                <input type="text" class="form-control" value="Verify" readonly>
                            </div>
                        </div>
                </div>
        
                <div class="form-group">
                    <label class="col-sm-2 control-label">Approval View</label>
                        
                    <div class="col-sm-4">
                        <div class="input-group">
                            <span class="input-group-addon">
                                <input type="checkbox" id="submitted" name="approvalview" value="SUBMITTED FOR APPROVAL,IN PROGRESS" 
                                       <cfif "#Find('SUBMITTED FOR APPROVAL,IN PROGRESS', approvalview)#" NEQ 0>checked</cfif>>
                            </span>
                            <input type="text" class="form-control" value="Submitted For Approval Only" readonly>
                        </div>
                    </div>
                    ...
                    <div class="col-sm-3">
                        <div class="input-group">
                            <span class="input-group-addon">
                                <input type="checkbox" id="verified" name="approvalview" value="VERIFIED" 
                                       <cfif "#Find('VERIFIED', approvalview)#" NEQ 0>checked</cfif>>
                            </span>
                            <input type="text" class="form-control" value="Verified Only" readonly>
                        </div>
                    </div>
                </div>
                
                <div class="form-group">
                    <label class="col-sm-2 control-label">Portal Access</label>
                    <div class="col-sm-7">
