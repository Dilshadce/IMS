<cfcomponent>
    <cffunction name="listAccount" access="remote" returntype="struct"> 
        ...
        <cfquery name="getFilteredDataSet" datasource="payroll_main">
            SELECT SQL_CALC_FOUND_ROWS entryID, userID, userName, userEmail, custno 
            FROM #targetTable#
        ...
        <cfquery name="getTotalDataSetLength" datasource="payroll_main">
            SELECT COUNT(entryID) AS iTotal
            FROM #targetTable#
        </cfquery>      
        ...
        <cfloop query="getFilteredDataSet">	
			...
			<cfset data["id"]=entryID>
			<cfset data["entryID"]=entryID>
            <cfset data["userID"]=userID>
            <cfset data["userName"]=userName>
