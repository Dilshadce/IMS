		...
		<cfelse>
        	...
        	<cfloop from="1" to="4" index="i">
				...
				<cfquery name="createHM" datasource="payroll_main">
					...
					(userID, userPWD, userGrpID, userName, userCmpID, userDsn, userCty, userEmail, custno,realpass,approveverify,approvalview)
					VALUES(	
                        ...
                        <cfqueryparam cfsqltype="cf_sql_varchar" value="#form.approveverify#">,
                        <cfqueryparam cfsqltype="cf_sql_varchar" value="#form.approvalview#">
					)
				</cfquery>
		...
		<!---<cftry>--->
			<cfquery name="updateHM" datasource="payroll_main">
				...
				SET userID=<cfqueryparam cfsqltype="cf_sql_varchar" value="#form.userEmail#">,
                    ...
                    ,approveverify = <cfqueryparam cfsqltype="cf_sql_varchar" value="#form.approveverify#">
                    ,approvalview = <cfqueryparam cfsqltype="cf_sql_varchar" value="#form.approvalview#">
