...
<li id="cseuroprofitmargin" class="manpowerdoc">
			...
			<li id="manpowerpricematrix" class="manpowerpricematrix">
                ...
                <li id="manpowertimesheetval" class="manpowertimesheetval">
                        ...
                        <li id="billableonlyitem" class="billableonlyitem">
                                <a href="/CFSpaybill/createCFS.cfm" target="mainFrame">Create CFS Employee</a>
                        </li>
                        <li id="billableonlyitem" class="billableonlyitem">
                                <a href="/CFSpaybill/createCFSpaybillprofile.cfm" target="mainFrame">Create CFS Profile</a>
                        </li>
                        <li id="billableonlyitem" class="billableonlyitem">
                                <a href="/CFSpaybill/generateInvoiceBankfile.cfm" target="mainFrame">Generate Invoice Bankfile</a>
                        </li>
