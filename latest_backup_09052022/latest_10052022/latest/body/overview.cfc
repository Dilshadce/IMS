...
<cffunction name="listLoggingHistory" access="remote" returntype="struct">
	...
	<cfquery name="getFilteredDataSet" datasource="main">
        ...
        <cftry>
        <cfif lcase(husergrpid) neq 'admin' and lcase(husergrpid) neq 'super'>
        AND b.userID=<cfqueryparam cfsqltype="cf_sql_varchar" value="#huserid#" />
        </cfif>
        <cfcatch></cfcatch></cftry>
		#sWhere#
		#sOrder#
	...
	<cfquery name="getTotalDataSetLength" datasource="main">
        ...
        <cftry>
        <cfif lcase(husergrpid) neq 'admin' and lcase(husergrpid) neq 'super'>
        AND a.userLogID=<cfqueryparam cfsqltype="cf_sql_varchar" value="#huserid#" />
