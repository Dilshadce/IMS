<cfquery name="getGSetup" datasource="#dts#">
  	SELECT compro,compro2,compro3,compro4,compro5,compro6,compro7,compro8,compro9,compro10,
    	   gstno,bcurr,wpitemtax 
    FROM gsetup; 
</cfquery>
...
<cfquery name="getgeneral" datasource="#dts#">
	select lastaccyear,filterall,bcurr 
    from gsetup
</cfquery>
...
SELECT * FROM (
SELECT  itemno,a.desp,a.despa,a.brem1,a.brem2,'' as lastpage,taxamt_bil,taxpec1,
		a.amt,price,grand,tax,discount,taxp1,a.wos_date,a.refno,qty,a.custno,
		c.name,c.name2,c.add1,c.add2,c.add3,c.add4,c.country,c.postalcode,c.phone,c.term,
        (qty*factor1/factor2) as qty2 
from ictran as a 
left join artran as b on a.refno = b.refno and a.type=b.type 
left join #target_arcust# as c on a.custno=c.custno 
where a.type = "INV" 
...
order by aa.custno,aa.wos_date,aa.refno
...
<cfreport template="#reportname#" format="PDF" query="MyQuery"><!--- or "FlashPaper" or "Excel" or "RTF" --->
    ...
    <cfreportparam name="compro8" value="#getGSetup.compro8#">
    <cfreportparam name="compro9" value="#getGSetup.compro9#">
    <cfreportparam name="compro10" value="#getGSetup.compro10#">
    ...
    <cfreportparam name="itemTax" value="#getGSetup.wpitemtax#">
		...
		<cfxml variable="data">
			...
			<Worksheet ss:Name="Bills Listing">
				...
				<Row ss:AutoFitHeight="0" ss:Height="23.0625">
					...
					<Cell ss:StyleID="s27"><Data ss:Type="String">GST @ <cfif getGSetup.bcurr eq "MYR">6<cfelse>7</cfif>%</Data></Cell>
					...
					<Row ss:AutoFitHeight="0">
						...
						<Cell ss:StyleID="s33"><Data ss:Type="Number">#taxamt#</Data></Cell>
                        <cfset amt1=amt+taxamt>
				...
				<cfoutput>
				<Row ss:AutoFitHeight="0" ss:Height="12">
					<Cell ss:StyleID="s38" ss:MergeAcross="7"><Data ss:Type="String">TOTAL AMOUNT DUE #getgeneral.bcurr# :</Data></Cell>
