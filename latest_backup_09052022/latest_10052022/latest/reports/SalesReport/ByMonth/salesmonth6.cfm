...
<cfif form.periodfrom neq "" and form.periodto neq "">
    ...
    <cfinvoke component="salesmonth6a" method="getmonthuser" returnvariable="getuser">
        ...
        <cfinvokeargument name="enduserfrom" value="#form.enduserfrom#">
        <cfinvokeargument name="enduserto" value="#form.enduserto#">
    </cfinvoke>
<cfelse>
    <cfloop index="a" from="1" to="18">
        <cfset monthtotal[a] = 0>
    </cfloop>
    <cfinvoke component="salesmonth6b" method="getmonthuser" returnvariable="getuser">
        <cfinvokeargument name="dts" value="#dts#">
        <cfinvokeargument name="lastaccyear" value="#getgeneral.lastaccyear#">
        <cfinvokeargument name="enduserfrom" value="#form.enduserfrom#">
        <cfinvokeargument name="enduserto" value="#form.enduserto#">
...
<cfswitch expression="#form.result#">
    ...
    <cfif form.enduserfrom neq "" and form.enduserto neq "">
     <Row ss:AutoFitHeight="0" ss:Height="20.0625">
        	<cfwddx action = "cfml2wddx" input = "#form.enduserfrom# - #form.enduserto#" output = "wddxText2">
