...
<cfoutput>
	<cfform class="formContainer form3Button" name="CostingReportForm" id="CostingReportForm" action="CostingReport.cfm?type=#trantype#&trancode=#trancode#&alown=#alown#&consignment=#consignment#" method="post" target="_blank">
        <div>#pageTitle#</div>
        <div>
        <table>
			...
			<cfelse>
            	...
            	<tr>
                    ...
                    <td>
                        <input type="text" id="customerFrom" name="customerfrom" class="customerFilter" style="width:90%;" data-placeholder="Choose a Customer" />
						<button type="button" id="searchCustomer">Search</button>
                    </td>
                </tr>
                <tr>
                    <td colspan='2'>
					   <div id="customerContainer" style="max-height:300px;overflow-y:scroll;width:100%;padding-left:10%;padding-right:10%;overflow-x:hidden;"></div>
				    </td>
                </tr>
                <tr>
                    <th><label for="PlacementOrder">#words[8001]#</label></th>
                    <td>
                        <input type="hidden" id="placmentNoFrom" name="placementNoFrom" class="placementOrderFilter" data-placeholder="#words[8001]#" />
                        <input type="hidden" id="placmentNoTo" name="placementNoTo" class="placementOrderFilter" data-placeholder="#words[8001]#" />
                    </td>
                </tr>

            <tr>
                <th><label for="period">Payroll #words[703]#</label></th>
                <td>
                    <select name="periodFrom" id="periodFrom" Onchange="tf_fperiodfromDesp.value = this.options[this.selectedIndex].title;">
                        <option value="">#words[1361]#</option>
                          <cfloop index="j" from="1" to="12">
                              ...
                              <option  value="#j#" <cfif j eq getpayrollgsetup.mmonth>selected</cfif>>#j#</option>
                          </cfloop>
                    </select>
            ...
            <tr>
                <th><label for="fieldglass">Fieldglass</label></th>
                <td>
                    <div style="text-align: left">
                        <input type="checkbox" name="fieldglass" id="fieldglass" />
                    </div>
