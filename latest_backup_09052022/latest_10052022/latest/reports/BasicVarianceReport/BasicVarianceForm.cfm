...
<cfset consignment=''>
	<cfset pageTitle = "Basic Salary Variance Report">
...
<cfoutput>
	<cfform class="formContainer form3Button" name="BasicVarianceReportForm" id="BasicVarianceReportForm" action="BasicVarianceReport.cfm" method="post" target="_blank">
        <div>#pageTitle#</div>
        <div>
        <table>
