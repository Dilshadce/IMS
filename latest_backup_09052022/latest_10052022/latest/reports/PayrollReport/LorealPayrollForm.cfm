...
<cfset consignment=''>
	<cfset pageTitle = "Payroll Report">
...
<cfoutput>
	<cfform class="formContainer form3Button" name="PayrollReportForm" id="PayrollReportForm" action="LorealPayrollReport2.cfm" method="post" target="_blank">
        <div>#pageTitle#</div>
        <div>
        <table>
