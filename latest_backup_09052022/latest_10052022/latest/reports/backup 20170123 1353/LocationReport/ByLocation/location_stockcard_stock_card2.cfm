...
<cfquery name="getictran" datasource="#dts#">
    ...
    if(b.taxincl = "T" and b.taxamt <> 0 and b.qty >0,b.price-(b.taxamt/b.qty),b.price) as price,
	<cfelse>
	b.price,
    </cfif>
    b.it_cos,
	b.qty,
	b.toinv,
	(<cfif getgeneral.wpitemtax eq "1">if(b.taxincl = "T" and b.taxamt <> 0 and b.qty >0,b.amt-b.taxamt,b.amt)<cfelse>b.amt</cfif>+b.m_charge1+b.m_charge2+b.m_charge3+b.m_charge4+b.m_charge5+b.m_charge6+b.m_charge7) as amt
	<cfif lcase(hcomid) eq "ovas_i">
		,c.drivername
	</cfif>
    ,c.cluster
    	...
    	<tr onMouseOut="javascript:this.style.backgroundColor='';" onMouseOver="javascript:this.style.backgroundColor='99FF00';">
            ...
            <td><div align="left"><font size="2" face="Times New Roman, Times, serif"><cfif type eq 'TRIN'>#gettrlocation.created_by#<cfelse>#gettrlocation.created_by#</cfif></font></div></td>
      		...
      		<td><cfif type eq "RC" or type eq "CN" or type eq "OAI" or type eq "TRIN">
          			<cfset itembal = LSParseNumber(itembal) + LSParseNumber(qty)>
            ...
            <cfif isdefined('url.dodate')>
                    ...
                    <cfif type eq "DO">
                        <cfset itembal = LSParseNumber(itembal) - LSParseNumber(qty)>
	            		<cfset totalout = totalout + LSParseNumber(qty)>
