...
<cfquery name="getGSetup" datasource="#dts#">
    ...
    <cfreportparam name="categoryfrom" value="#form.categoryfrom#">
    <cfreportparam name="categoryto" value="#form.categoryto#">
...
<Row ss:AutoFitHeight="0" ss:Height="20.0625">
		<Cell ss:MergeAcross="#c#" ss:StyleID="s22"><Data ss:Type="String"><cfif lcase(hcomid) eq "mhca_i">Marketer<cfelse>Location</cfif> Physical Worksheet</Data></Cell>
	</Row>
...
<Row ss:AutoFitHeight="0" ss:Height="20.0625">
    ...
    <cfif trim(form.categoryfrom) neq "" and trim(form.categoryto) neq "">
<Row ss:AutoFitHeight="0" ss:Height="20.0625">
  		   <cfwddx action = "cfml2wddx" input = "#form.categoryfrom# - #form.categoryto#" output = "wddxText1">
			<Cell ss:MergeAcross="#c#" ss:StyleID="s22"><Data ss:Type="String">CATEGORY : #wddxText1#</Data></Cell>
		</Row>
	</cfif>
    
    <cfif trim(form.groupfrom) neq "" and trim(form.groupto) neq "">
<Row ss:AutoFitHeight="0" ss:Height="20.0625">
  		   <cfwddx action = "cfml2wddx" input = "#form.groupfrom# - #form.groupto#" output = "wddxText2">
			<Cell ss:MergeAcross="#c#" ss:StyleID="s22"><Data ss:Type="String">GROUP : #wddxText2#</Data></Cell>
		</Row>
	</cfif>
    
	<cfif form.periodFrom neq "">
<Row ss:AutoFitHeight="0" ss:Height="20.0625">
  		   <cfwddx action = "cfml2wddx" input = "#form.periodFrom#" output = "wddxText3">
...
<Row ss:AutoFitHeight="0" ss:Height="20.0625">
  		   <cfwddx action = "cfml2wddx" input = "#getlocation.locationdesp#" output = "wddxText6">
		<Cell ss:StyleID="s41"><Data ss:Type="String"><cfif lcase(hcomid) eq "mhca_i">MARKETER<cfelse>LOCATION</cfif>: #getlocation.location#</Data></Cell>
			<Cell ss:StyleID="s41"><Data ss:Type="String">#wddxText6#</Data></Cell>
		</Row>
		...
		<cfloop query="getiteminfo">
	     <Row ss:AutoFitHeight="0" ss:Height="20.0625">
				<Cell ss:StyleID="s26"><Data ss:Type="String">#getiteminfo.currentrow#.</Data></Cell>
				<Cell ss:StyleID="s26"><Data ss:Type="String">#getiteminfo.itemno#</Data></Cell>
                <cfif (lcase(hcomid) eq "kjcpl_i" or lcase(hcomid) eq "mlpl_i" or lcase(hcomid) eq "kjctrial_i")>
                <cfelseif lcase(hcomid) eq "vsolutionspteltd_i">
               <Cell ss:StyleID="s26"><Data ss:Type="String">#getiteminfo.Aitemno#</Data></Cell>
                </cfif>
				<Cell ss:StyleID="s26"><Data ss:Type="String">#getiteminfo.desp#</Data></Cell>
				<Cell ss:StyleID="s24"><Data ss:Type="String">#getiteminfo.unit#</Data></Cell>
                <cfif lcase(hcomid) eq "ssuni_i">
                <Cell ss:StyleID="s26"><Data ss:Type="String">#numberformat(getiteminfo.price,",_.__")#</Data></Cell>
                </cfif>
				<Cell ss:StyleID="s26"><Data ss:Type="String">#getiteminfo.balance#</Data></Cell>
				<Cell ss:StyleID="s26"><Data ss:Type="String">#getiteminfo.locqactual#</Data></Cell>
				<Cell ss:StyleID="s26"><Data ss:Type="String">#val(getiteminfo.balance)-val(getiteminfo.locqactual)#</Data></Cell>
				<Cell ss:StyleID="s26"><Data ss:Type="String">#getiteminfo.shelf#</Data></Cell>
			</Row>
    ...
    <Cell ss:StyleID="s51"><Data ss:Type="String">#totalqty#</Data></Cell>
    <Cell ss:StyleID="s51"><Data ss:Type="String">#totalact#</Data></Cell>
    				<Cell ss:StyleID="s51"><Data ss:Type="String"></Data></Cell>
				<Cell ss:StyleID="s51"><Data ss:Type="String"></Data></Cell>
...
<table align="center" width="100%" border="0" cellspacing="0">
	<cfoutput>
	<tr>
		<td colspan="8"><div align="center"><font size="3" face="Times New Roman, Times, serif"><strong><cfif lcase(hcomid) eq "mhca_i">Marketer<cfelse>Location</cfif> Physical Worksheet</strong></font></div></td>
	</tr>
	<!--- <cfif trim(form.categoryfrom) neq "" and trim(form.categoryto) neq "">
		<tr>
			<td colspan="8"><div align="center"><font size="2" face="Times New Roman, Times, serif">CATE: #form.categoryfrom# - #form.categoryto#</font></div></td>
