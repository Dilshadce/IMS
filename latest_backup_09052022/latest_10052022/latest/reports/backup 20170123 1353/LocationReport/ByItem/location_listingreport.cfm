...
<cfset words_id_list = "1436,1437,123,495,496,146,497,498,1302,1417,1418,29,1387,1388,482,499,500,703,1361,1362,702,1300,1301,501,1399">
...
<cfif url.type eq "1">
	<cfset pageTitle = "#words[1436]#">
	<cfset typename = "SALES">
<cfelse>
	<cfset pageTitle = "#words[1437]#">
...
<cfoutput>
	<cfform class="formContainer form3Button" name="location_listing_report" id="billListingForm" action="location_listingreport_result_html.cfm;
        location_listingreport_result_excel_default.cfm;" method="post" target="_blank">
		<div>#pageTitle#</div>
        <div>
            <table> 
                ...
                <tr> 
                    ...
                    <td>
                        <input type="hidden" id="groupFrom" name="groupFrom" class="groupFilter" value="#Hitemgroup#" data-placeholder="#words[497]#" />
                        <input type="hidden" id="groupTo" name="groupTo" class="groupFilter" value="#Hitemgroup#" data-placeholder="#words[498]#" />
                    </td>
                </tr>
                <tr> 
        ...
        <div>
            <input type="Submit" name="result" id="result" value="#words[501]#" onclick='this.form.action="location_listingreport_result_html.cfm";' />
            <input type="Submit" name="result" id="result" value="#words[1399]#" onclick='this.form.action="location_listingreport_result_excel_default.cfm";' />
        </div>
    </cfform>
