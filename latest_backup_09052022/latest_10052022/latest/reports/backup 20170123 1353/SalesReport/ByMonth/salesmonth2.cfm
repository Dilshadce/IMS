...
<cfxml variable="data">
   ...
   <cfoutput>                     
    ...
    <cfif trim(form.categoryfrom) neq "" and trim(form.categoryto) neq "">
        <Row ss:AutoFitHeight="0" ss:Height="20.0625">
            	<cfwddx action = "cfml2wddx" input = "#form.categoryfrom# - #form.categoryto#" output = "wddxText5">
          			<Cell ss:StyleID="s26"><Data ss:Type="String">CATEGORY: #wddxText5#</Data></Cell>
        </Row>
    </cfif>
    <cfif trim(form.productfrom) neq "" and trim(form.productto) neq "">
        <Row ss:AutoFitHeight="0" ss:Height="20.0625">
                    	<cfwddx action = "cfml2wddx" input = "#form.productfrom# - #form.productto#" output = "wddxText6">
          				<Cell ss:StyleID="s26"><Data ss:Type="String">PRODUCT NO: #wddxText6#</Data></Cell>
        </Row>
    </cfif>
    <cfif form.agentfrom neq "" and form.agentto neq "">
        <Row ss:AutoFitHeight="0" ss:Height="20.0625">
    ...
    <cfif form.enduserfrom neq "" and form.enduserto neq "">
        <Row ss:AutoFitHeight="0" ss:Height="20.0625">
                       <cfwddx action = "cfml2wddx" input = "#form.enduserfrom# - #form.enduserto#" output = "wddxText10">
