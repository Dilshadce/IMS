  ...
  <cfif #getcust.recordCount# neq 0>
    ...
    <table width="100%" border="0" class="" align="center">
      ...
      <tr>
        ...
        <td align="center" ><strong><font size="2" face="Arial, Helvetica, sans-serif">#getgsetup.lbrand#</font></strong></td>
        </cfif>
        <cfif getdisplaydetail.report_category eq 'Y'>
        <td align="center" ><strong><font size="2" face="Arial, Helvetica, sans-serif">#getgsetup.lcategory#</font></strong></td>
        </cfif>
        <cfif getdisplaydetail.report_group eq 'Y'>
        <td align="center" ><strong><font size="2" face="Arial, Helvetica, sans-serif">#getgsetup.lgroup#</font></strong></td>
        </cfif>
        <cfif getdisplaydetail.report_sizeid eq 'Y'>
        <td align="center" ><strong><font size="2" face="Arial, Helvetica, sans-serif">#getgsetup.lsize#</font></strong></td>
        </cfif>
        <cfif getdisplaydetail.report_colorid eq 'Y'>
        <td align="center" ><strong><font size="2" face="Arial, Helvetica, sans-serif">#getgsetup.lmaterial#</font></strong></td>
        </cfif>
        <cfif getdisplaydetail.report_costcode eq 'Y'>
        <td align="center" ><strong><font size="2" face="Arial, Helvetica, sans-serif">#getgsetup.lrating#</font></strong></td>
        </cfif>
        <cfif getdisplaydetail.report_shelf eq 'Y'>
        <td align="center" ><strong><font size="2" face="Arial, Helvetica, sans-serif">#getgsetup.lmodel#</font></strong></td>
        </cfif>
	 ...
	 <td align="center"><strong><font size="2" face="Arial, Helvetica, sans-serif">Sales Price</font></strong></td>
      ...
      <cfquery name="gettaxincl" datasource="#dts#">
        ...
        <cfquery name="getproductcode" datasource="#dts#">
            select aitemno,brand,category,wos_group,costcode,sizeid,colorid,shelf from icitem where itemno='#getcust.itemno#'
          </cfquery>    
		...
		<tr>
          ...
          <cfif getdisplaydetail.report_aitemno eq 'Y'>
          <td align="left">#getproductcode.aitemno#</div></td>
          </cfif>
          <cfif getdisplaydetail.report_brand eq 'Y'>
        <td align="left">#getproductcode.brand#</div></td>
        </cfif>
        <cfif getdisplaydetail.report_category eq 'Y'>
        <td align="left">#getproductcode.category#</div></td>
        </cfif>
        <cfif getdisplaydetail.report_group eq 'Y'>
        <td align="left">#getproductcode.wos_group#</div></td>
        </cfif>
        <cfif getdisplaydetail.report_sizeid eq 'Y'>
        <td align="left">#getproductcode.sizeid#</div></td>
        </cfif>
        <cfif getdisplaydetail.report_colorid eq 'Y'>
        <td align="left">#getproductcode.colorid#</div></td>
        </cfif>
        <cfif getdisplaydetail.report_costcode eq 'Y'>
        <td align="left">#getproductcode.costcode#</div></td>
        </cfif>
        <cfif getdisplaydetail.report_shelf eq 'Y'>
        <td align="left">#getproductcode.shelf#</div></td>
        </cfif>
