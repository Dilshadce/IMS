<cfcomponent>
	<cffunction name="getPurchaseMonthContent" output="true" returntype="query">
		...
		<cfargument name="productFrom" required="yes" type="string">
		<cfargument name="productTo" required="yes" type="string">
		<cfargument name="periodFrom" required="yes" type="string">
		<cfargument name="periodTo" required="yes" type="string">
		...
		<cfquery name="getdata" datasource="#dts#">
			...
			and ic.itemno>='#productfrom#' and ic.itemno<='#productto#'
			</cfif>
	...
	<cffunction name="getVendorMonthContent" returntype="query">
		<cfargument name="dts" required="yes" type="string">
		<cfargument name="periodDate" required="yes" type="string">
		<cfargument name="supplierFrom" required="yes" type="string">
		<cfargument name="supplierTo" required="yes" type="string">
		<cfargument name="periodFrom" required="yes" type="string">
		<cfargument name="periodTo" required="yes" type="string">
		<cfargument name="indexFrom" required="yes" type="numeric">
		<cfargument name="indexTo" required="yes" type="numeric">
		...
		<cfquery name="getdata" datasource="#dts#">
			...
			where wos_date>#periodDate# and (ic.type='RC' or ic.type='PR') <!---and (linecode ='' or linecode is null) and ic.itemno not in (select servi from icservi)--->
			<cfif supplierfrom neq "" and form.supplierto neq "">
			and ic.custno>='#supplierfrom#' and ic.custno<='#supplierto#'
			</cfif>
