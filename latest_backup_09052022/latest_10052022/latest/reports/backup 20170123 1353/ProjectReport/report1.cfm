...
<table align="center" width="80%" border="0" cellspacing="0" cellpadding="1">
	...
	<tr>
		<td colspan="100%">
			<div align="center"><font size="3" face="Times New Roman, Times, serif"><strong>PROJECT TRANSACTION LISTING</strong></font></div>
		</td>
	</tr>
	...
	<cfif trim(form.itemFrom) neq "" and trim(form.itemTo) neq "">
		<tr>
			<td colspan="100%"><div align="center"><font size="2" face="Times New Roman, Times, serif">Product From #form.itemFrom# To #form.itemTo#</font></div></td>
		</tr>
	</cfif>
    ...
    select * from (
			...
			<cfif trim(form.itemFrom) neq "" and trim(form.itemTo) neq "">
				and ic.itemno between <cfqueryparam cfsqltype="cf_sql_varchar" value="#form.itemFrom#">
				and <cfqueryparam cfsqltype="cf_sql_varchar" value="#form.itemTo#">
			</cfif>
            <cfif trim(form.jobfrom) neq "" and trim(form.jobto) neq "">
			...
			<cfif trim(form.categoryFrom) neq "" and trim(form.categoryTo) neq "">
				and ic.category between <cfqueryparam cfsqltype="cf_sql_varchar" value="#form.categoryFrom#">
...
<cfif form.datefrom neq "" and form.dateto neq "">
		...
		<cfxml variable="data">
			...
			<Worksheet ss:Name="Print Profit Margin Report">
                ...
                <cfoutput>
					...
					<cfwddx action = "cfml2wddx" input = "PROJECT TRANSACTION LISTING" output = "wddxText">
    ...
    <cfif trim(form.itemFrom) neq "" and trim(form.itemTo) neq "">
    <Row ss:AutoFitHeight="0" ss:Height="23.0625">
		<cfwddx action = "cfml2wddx" input = "Product From #form.itemFrom# To #form.itemTo#" output = "wddxText">
						<Cell ss:MergeAcross="#d#" ss:StyleID="s22"><Data ss:Type="String">#wddxText#</Data></Cell>
					</Row>
	</cfif>
    
			<cfif trim(form.categoryFrom) neq "" and trim(form.categoryTo) neq ""><Row ss:AutoFitHeight="0" ss:Height="23.0625">
    ...
    <cfif url.type eq "listprojitem">
    	...
    	<cfelse>
            <cfquery name="getinfo" datasource="#dts#">
				...
				<Row ss:AutoFitHeight="0" ss:Height="23.0625">
					<Cell ss:StyleID="s29"><Data ss:Type="String">PD</Data></Cell>
                     <cfif lcase(hcomid) eq "mphcranes_i" or lcase(hcomid) eq "mphcs_i">
				    <Cell ss:StyleID="s29"><Data ss:Type="String">CUST NAME</Data></Cell>
                    <cfelse>
                    <Cell ss:StyleID="s29"><Data ss:Type="String">CUSTNO</Data></Cell>
                    </cfif>
					<Cell ss:StyleID="s29"><Data ss:Type="String">TYPE</Data></Cell>
					<Cell ss:StyleID="s29"><Data ss:Type="String">REFNO</Data></Cell>
					<Cell ss:StyleID="s29"><Data ss:Type="String">ITEM NO.</Data></Cell>
					<Cell ss:StyleID="s29"><Data ss:Type="String">ITEM DESPCRIPTION.</Data></Cell>
                    <Cell ss:StyleID="s29"><Data ss:Type="String">QTY</Data></Cell>
                    <Cell ss:StyleID="s29"><Data ss:Type="String">UNIT</Data></Cell>
                    <Cell ss:StyleID="s29"><Data ss:Type="String">U.PRICE</Data></Cell>
                    <Cell ss:StyleID="s29"><Data ss:Type="String">AMOUNT</Data></Cell>
				</Row>
            ...
            <cfset thisproj="ZZZZZZZZZZ">
				...
				<cfif thiscust neq "ZZZZZZZZZZ" and thiscust neq getinfo.custno and thisproj eq getinfo.source>
					<Row ss:AutoFitHeight="0" ss:Height="23.0625"><Cell ss:StyleID="s27"><Data ss:Type="String"></Data></Cell></Row>
					<Row ss:AutoFitHeight="0" ss:Height="23.0625">
				...
				<cfif thisproj neq getinfo.source>
					...
					<cfif thisproj neq "ZZZZZZZZZZ">
						...
						<Cell ss:StyleID="s27"><Data ss:Type="String">#wddxText# TOTAL:</Data></Cell>
				...
				<Row ss:AutoFitHeight="0" ss:Height="23.0625">
                <cfwddx action = "cfml2wddx" input = "#ucase(getgeneral.lPROJECT)# : #getinfo.fperiod#" output = "wddxText">
                    <cfif lcase(hcomid) eq "mphcranes_i" or lcase(hcomid) eq "mphcs_i">
                   ...
                   <cfwddx action = "cfml2wddx" input = "#getinfo.custno#" output = "wddxText2">
                    ...
                    <Cell ss:StyleID="s27"><Data ss:Type="String">#wddxText4#</Data></Cell>
                    <Cell ss:StyleID="s27"><Data ss:Type="String">#wddxText5#</Data></Cell>
                    <Cell ss:StyleID="s27"><Data ss:Type="String">#wddxText6#</Data></Cell>
                    <Cell ss:StyleID="s27"><Data ss:Type="String">#wddxText7#</Data></Cell>
                    <Cell ss:StyleID="s27"><Data ss:Type="String">#wddxText8#</Data></Cell>
                    <Cell ss:StyleID="s27"><Data ss:Type="String">#wddxText9#</Data></Cell>
					<cfif form.usecostiniss neq "" and getinfo.type eq "ISS">
						<cfset thisamt=val(getinfo.qty)*val(getinfo.it_cos)>
					<cfelse>
						<cfset thisamt=val(getinfo.amt)>
					...
					<Cell ss:StyleID="s27"><Data ss:Type="String">#wddxText10#</Data></Cell>
				</Row>
				<cfset projtotal=projtotal+thisamt>
				<cfset custtotal=custtotal+thisamt>
			</cfoutput>
		...
		<cfelse>
            ...
            <cfset thisproj="ZZZZZZZZZZ">
				...
				<cfif thisgroup neq "ZZZZZZZZZZ" and thisgroup neq getinfo.wos_group and thisproj eq getinfo.source>
					...
					<Row ss:AutoFitHeight="0" ss:Height="23.0625">
                     ...
                     <Cell ss:StyleID="s27"><Data ss:Type="String">GROUP TOTAL:</Data></Cell>
                     <Cell ss:StyleID="s27"><Data ss:Type="String">#wddxText#</Data></Cell>
					</Row>
					<cfset grouptotal=0>
				</cfif>
				...
				<cfif thisproj neq getinfo.source or thisjob neq getinfo.job>
                    ...
                    <Cell ss:StyleID="s29"><Data ss:Type="String"></Data></Cell>
                    <Cell ss:StyleID="s29"><Data ss:Type="String"></Data></Cell>
					<Cell ss:StyleID="s45"><Data ss:Type="String">GROUP TOTAL:</Data></Cell>
                    <Cell ss:StyleID="s45"><Data ss:Type="String">#wddxText#</Data></Cell>
                     <Cell ss:StyleID="s29"><Data ss:Type="String"></Data></Cell>
						</Row>
						<cfset grouptotal=0>
					</cfif>
                    ...
                    <Cell ss:StyleID="s27"><Data ss:Type="String"></Data></Cell>
                    <Cell ss:StyleID="s27"><Data ss:Type="String"></Data></Cell>    
                    <Cell ss:StyleID="s46"><Data ss:Type="String">#wddxText# TOTAL:</Data></Cell>
                    <Cell ss:StyleID="s80"><Data ss:Type="String">#wddxText2#</Data></Cell>
						</Row>
					</cfif>
                    ...
                    <cfwddx action = "cfml2wddx" input = "#ucase(getgeneral.lPROJECT)# : #getinfo.source#" output = "wddxText">
                     ...
                     <Cell ss:StyleID="s38"><Data ss:Type="String">#wddxText2#</Data></Cell>
					</Row>
					<cfif thisjob neq getinfo.job>
						<cfset thisjob=getinfo.job>
						<cfif getinfo.job neq "">
							<Row ss:AutoFitHeight="0" ss:Height="23.0625">
                             <cfwddx action = "cfml2wddx" input = "#ucase(getgeneral.lJOB)# : #getinfo.job#" output = "wddxText">
                             <cfwddx action = "cfml2wddx" input = "#getinfo.jobdesp#" output = "wddxText2"> 
                     <Cell ss:StyleID="s27"><Data ss:Type="String">#wddxText#</Data></Cell>
                     <Cell ss:StyleID="s27"><Data ss:Type="String">#wddxText2#</Data></Cell>
				...
				<cfif thisgroup neq getinfo.wos_group>
                   ...
                   <cfwddx action = "cfml2wddx" input = "#getinfo.wos_group#" output = "wddxText">
                    <Cell ss:StyleID="s43"><Data ss:Type="String">GROUP : #wddxText#</Data></Cell>
					</Row>
				</cfif>
				<Row ss:AutoFitHeight="0" ss:Height="23.0625">
                <cfwddx action = "cfml2wddx" input = "#getinfo.fperiod#" output = "wddxText">
				   ...
				   <cfwddx action = "cfml2wddx" input = "#getinfo.unit#" output = "wddxText8">
				   <cfwddx action = "cfml2wddx" input = "#numberformat(val(getinfo.price),stDecl_UPrice)#" output = "wddxText9">
					<Cell ss:StyleID="s47"><Data ss:Type="String">#wddxText#</Data></Cell>
                    <cfif lcase(hcomid) eq "mphcranes_i" or lcase(hcomid) eq "mphcs_i">
                    <Cell ss:StyleID="s47"><Data ss:Type="String">#wddxText2#</Data></Cell>
                    <cfelse>
                    <Cell ss:StyleID="s47"><Data ss:Type="String">#wddxText2#</Data></Cell>
                    </cfif>
                    <Cell ss:StyleID="s47"><Data ss:Type="String">#wddxText3#</Data></Cell>
                    <Cell ss:StyleID="s47"><Data ss:Type="String">#wddxText4#</Data></Cell>
                    <Cell ss:StyleID="s47"><Data ss:Type="String">#wddxText5#</Data></Cell>
                    <Cell ss:StyleID="s47"><Data ss:Type="String">#wddxText6#</Data></Cell>
                    <Cell ss:StyleID="s44"><Data ss:Type="String">#wddxText7#</Data></Cell>
                    <Cell ss:StyleID="s44"><Data ss:Type="String">#wddxText8#</Data></Cell>
                    <Cell ss:StyleID="s44"><Data ss:Type="String">#wddxText9#</Data></Cell>
					<cfif form.usecostiniss neq "" and getinfo.type eq "ISS">
						<cfset thisamt=val(getinfo.qty)*val(getinfo.it_cos)>
					<cfelse>
						<cfset thisamt=val(getinfo.amt)>
                    ...
                    <cfwddx action = "cfml2wddx" input = "#numberformat(val(thisamt),stDecl_UPrice)#" output = "wddxText10">
					<Cell ss:StyleID="s44"><Data ss:Type="String">#wddxText10#</Data></Cell>
				</Row>
				<cfset projtotal=projtotal+thisamt>
				<cfset grouptotal=grouptotal+thisamt>
			</cfoutput>
            ...
            <Cell ss:StyleID="s45"><Data ss:Type="String"></Data></Cell>
            <Cell ss:StyleID="s45"><Data ss:Type="String">GROUP TOTAL:</Data></Cell>
			<Cell ss:StyleID="s45"><Data ss:Type="String"><cfoutput>#wddxText#</cfoutput></Data></Cell>
            <Cell ss:StyleID="s45"><Data ss:Type="String"></Data></Cell>
			</Row>
			
			<Row ss:AutoFitHeight="0" ss:Height="23.0625">
             <cfwddx action = "cfml2wddx" input = "#ucase(getgeneral.lPROJECT)#" output = "wddxText3">
             <cfwddx action = "cfml2wddx" input = "#numberformat(projtotal,",.__")#" output = "wddxText4">
             <Cell ss:StyleID="s46"><Data ss:Type="String"></Data></Cell>
             <Cell ss:StyleID="s46"><Data ss:Type="String"></Data></Cell>
             <Cell ss:StyleID="s46"><Data ss:Type="String"></Data></Cell>
             <Cell ss:StyleID="s46"><Data ss:Type="String"></Data></Cell>
             <Cell ss:StyleID="s46"><Data ss:Type="String"></Data></Cell>
             <Cell ss:StyleID="s46"><Data ss:Type="String"></Data></Cell>
             <Cell ss:StyleID="s46"><Data ss:Type="String"></Data></Cell>
             <Cell ss:StyleID="s90"><Data ss:Type="String"><cfoutput>#wddxText3# </cfoutput><b>TOTAL:</b></Data></Cell>
			 <Cell ss:StyleID="s80"><Data ss:Type="String"><cfoutput>#wddxText4#</cfoutput></Data></Cell>	
			</Row>
		</cfif>
	</cfif>
</Table>
