...
<cfswitch expression="#form.result#">
	...
	<Row ss:AutoFitHeight="0" ss:Height="23.0625">
		<Cell ss:MergeAcross="7" ss:StyleID="s22"><Data ss:Type="String">Print Location Product <cfif checkcustom.customcompany eq "Y">- Lot Number<cfelse>Batch</cfif> Sales Report</Data></Cell>
	</Row>
	...
	<!--- <cfquery name="getlocation" datasource="#dts#">
			select a.location,b.desp from ictran a,icitem b,iclocation c
			where a.location=c.location and a.itemno=b.itemno and (a.type='INV' or a.type='CS' or a.type='DN' or a.type='CN') and (a.void = '' or a.void is null) and a.batchcode<>'' and a.location<>''
			<cfif trim(form.categoryfrom) neq "" and trim(form.categoryto) neq "">
		...
		<cfif getlocation.recordcount gt 0>
			<cfloop query="getlocation">
				<cfset xlocation = getlocation.location>	<!--- Add on 18-11-2008 --->
				...
				<!--- <cfquery name="getgroup" datasource="#dts#">
					select a.wos_group from ictran a,icitem b where a.itemno=b.itemno and (a.void = '' or a.void is null) and (a.type='INV' or a.type='CS' or a.type='DN' or a.type='CN') and a.location='#getlocation.location#' and a.batchcode<>''
					<cfif trim(form.categoryfrom) neq "" and trim(form.categoryto) neq "">
					and b.category between '#form.categoryfrom#' and '#form.categoryto#'
					</cfif>
					<cfif trim(form.productfrom) neq "" and trim(form.productto) neq "">
				...
				<cfloop query="getgroup">
					<cfset xgroup = getgroup.wos_group>	<!--- Add on 18-11-2008 --->
					...
					<!--- <cfquery name="getitem" datasource="#dts#">
						select a.itemno,a.desp,b.location,b.batchcode from icitem a,ictran b where b.wos_group='#getgroup.wos_group#' and b.itemno=a.itemno and (b.void = '' or b.void is null) and b.location='#getlocation.location#' and b.batchcode<>'' and (b.type='INV' or b.type='CS' or b.type='DN' or b.type='CN')
						<cfif trim(form.categoryfrom) neq "" and trim(form.categoryto) neq "">
					...
					<cfloop query="getitem">
						...
						<!--- <cfquery name="gettran" datasource="#dts#">
							select a.itemno,a.batchcode,a.location,b.sumqty,c.suminv,d.sumcs,e.sumdn,f.sumcn,(ifnull(c.suminv,0)+ifnull(d.sumcs,0)+ifnull(e.sumdn,0)) as total from ictran as a
							left join
							(select itemno,sum(qty) as sumqty,batchcode,location from ictran where (type='INV' or type='CS' or type='DN') and (void = '' or void is null)
							<cfif form.batchcodefrom neq "" and form.batchcodeto neq "">
							...
							group by itemno,batchcode,location order by itemno,batchcode,location) as b on a.itemno=b.itemno and a.location=b.location and a.batchcode=b.batchcode

							left join
							(select itemno,sum(amt) as suminv,batchcode,location from ictran where type='INV' and (void = '' or void is null)
							<cfif form.batchcodefrom neq "" and form.batchcodeto neq "">
							and batchcode between "#form.batchcodefrom#" and "#form.batchcodeto#"
							</cfif>
							<cfif form.periodfrom neq "" and form.periodto neq "">
							...
							group by itemno,batchcode,location order by itemno,batchcode,location) as c on a.itemno=c.itemno and a.location=c.location and a.batchcode=c.batchcode

							left join
							(select itemno,sum(amt) as sumcs,batchcode,location from ictran where type='CS' and (void = '' or void is null)
							<cfif form.batchcodefrom neq "" and form.batchcodeto neq "">
							and batchcode between "#form.batchcodefrom#" and "#form.batchcodeto#"
							</cfif>
							<cfif form.periodfrom neq "" and form.periodto neq "">
							...
							group by itemno,batchcode,location order by itemno,batchcode,location) as d on a.itemno=d.itemno and a.location=d.location and a.batchcode=d.batchcode

							left join
							(select itemno,sum(amt) as sumdn,batchcode,location from ictran where type='DN' and (void = '' or void is null)
							<cfif form.batchcodefrom neq "" and form.batchcodeto neq "">
							and batchcode between "#form.batchcodefrom#" and "#form.batchcodeto#"
							</cfif>
							<cfif form.periodfrom neq "" and form.periodto neq "">
							...
							group by itemno,batchcode,location order by itemno,batchcode,location) as e on a.itemno=e.itemno and a.location=e.location and a.batchcode=e.batchcode

							left join
							(select itemno,sum(amt) as sumcn,batchcode,location from ictran where type='CN' and (void = '' or void is null)
							<cfif form.batchcodefrom neq "" and form.batchcodeto neq "">
							and batchcode between "#form.batchcodefrom#" and "#form.batchcodeto#"
							</cfif>
							<cfif form.periodfrom neq "" and form.periodto neq "">
							...
							group by itemno,batchcode,location order by itemno,batchcode,location) as f on a.itemno=f.itemno  and a.location=f.location and a.batchcode=f.batchcode

							where a.itemno='#getitem.itemno#'  and (a.void = '' or a.void is null) and a.batchcode='#getitem.batchcode#'  and a.location='#getitem.location#'
							<cfif form.batchcodefrom neq "" and form.batchcodeto neq "">
							and a.batchcode between "#form.batchcodefrom#" and "#form.batchcodeto#"
							</cfif>
							<cfif form.periodfrom neq "" and form.periodto neq "">
							...
							group by a.itemno,a.batchcode,a.location order by a.itemno,a.batchcode,a.location
						</cfquery> --->
						
						<cfquery name="gettran" datasource="#dts#">
							select a.itemno,a.batchcodea,milcert,a.importpermit<cfif checkcustom.customcompany eq "Y">,a.brem5</cfif>,a.location,b.sumqty,c.suminv,d.sumcs,e.sumdn,f.sumcn,(ifnull(c.suminv,0)+ifnull(d.sumcs,0)+ifnull(e.sumdn,0)) as total 
							from ictran as a
    ...
    <cfheader name="Content-Disposition" value="inline; filename=BatchCodeR_LIBSales_#huserid#.xls">
	<cfcontent type="application/vnd.ms-excel" deletefile="yes" file="#HRootPath#\Excel_Report\#dts#\BatchCodeR_LIBSales_#huserid#.xls">
<!---
	<cffile action="write" nameconflict="overwrite" file="C:\Inetpub\wwwroot\WOS\Excel_Report\#dts#\BatchCodeR_LIBSales_#huserid#.xls" output="#tostring(data)#">
	<cfcontent type="application/vnd.ms-excel" deletefile="yes" file="C:\Inetpub\wwwroot\WOS\Excel_Report\#dts#\BatchCodeR_LIBSales_#huserid#.xls">
--->
	</cfcase>
	...
	<html>
	<head>
	<title>Location Product Batch Sales Report</title>
	...
	<table width="100%" border="0" cellspacing="1" cellpadding="2">
		<tr>
			<td colspan="100%"><div align="center"><font size="3" face="Times New Roman, Times, serif"><strong>Print Location Product <cfif checkcustom.customcompany eq "Y">- Lot Number<cfelse>Batch</cfif> Sales Report</strong></font></div></td>
		</tr>
		<cfif form.batchcodefrom neq "" and form.batchcodeto neq "">
			<tr>
            ...
            <cfif form.importpermit neq "">
				...
				<cfloop query="getgroup">
					...
					<cfloop query="getitem">
						...
						<cfquery name="gettran" datasource="#dts#">
							select a.itemno,a.batchcode,a.milcert,a.importpermit<cfif checkcustom.customcompany eq "Y">,a.brem8,a.brem9,a.brem10</cfif>,a.location,b.sumqty,c.suminv,d.sumcs,e.sumdn,f.sumcn,(ifnull(c.suminv,0)+ifnull(d.sumcs,0)+ifnull(e.sumdn,0)) as total 
							from ictran as a
							
							left join
							(	select itemno,sum(qty) as sumqty,batchcode,location<cfif checkcustom.customcompany eq "Y">,brem8,brem9,brem10</cfif>  
								from ictran 
								where (type='INV' or type='CS' or type='DN') 
								and (void = '' or void is null) and batchcode='#getitem.batchcode#'
								and itemno='#getitem.itemno#'
							...
							left join
							(	select itemno,sum(amt) as suminv,batchcode,location<cfif checkcustom.customcompany eq "Y">,brem8,brem9,brem10</cfif>  
								from ictran where type='INV' 
								and (void = '' or void is null) and batchcode='#getitem.batchcode#'
								and itemno='#getitem.itemno#'
								<cfif form.batchcodefrom neq "" and form.batchcodeto neq "">
							...
							left join
							(	select itemno,sum(amt) as sumcs,batchcode,location<cfif checkcustom.customcompany eq "Y">,brem8,brem9,brem10</cfif>  
								from ictran 
								where type='CS' 
								and (void = '' or void is null) and batchcode='#getitem.batchcode#'
								and itemno='#getitem.itemno#'
							...
							left join
							(	select itemno,sum(amt) as sumdn,batchcode,location<cfif checkcustom.customcompany eq "Y">,brem8,brem9,brem10</cfif>  
								from ictran where type='DN' 
								and (void = '' or void is null) and batchcode='#getitem.batchcode#'
								and itemno='#getitem.itemno#'
								<cfif form.batchcodefrom neq "" and form.batchcodeto neq "">
							...
							left join
							(	select itemno,sum(amt) as sumcn,batchcode,location<cfif checkcustom.customcompany eq "Y">,brem8,brem9,brem10</cfif>  
								from ictran 
								where type='CN' 
								and (void = '' or void is null) and batchcode='#getitem.batchcode#'
								and itemno='#getitem.itemno#'
