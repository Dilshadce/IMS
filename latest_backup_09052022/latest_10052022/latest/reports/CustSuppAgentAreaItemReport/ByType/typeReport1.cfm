...
<cfswitch expression="#form.result#">
	...
	<Worksheet ss:Name="PRODUCT SALES REPORT BY TYPE">
	<cfoutput>
    ...
    <cfheader name="Content-Disposition" value="inline; filename=ItemSaleRType_CP_Sales_#huserid#.xls">
...
--->
	...
	<table width="100%" border="0" cellspacing="0" cellpadding="2">
		...
		<cfif trim(form.customerfrom) neq "" and trim(form.customerto) neq "">
			<tr>
				<td colspan="#columncount#"><div align="center"><font size="2" face="Times New Roman, Times, serif">CUST_NO: #form.customerfrom# - #form.customerto#</font></div></td>
			</tr>
		</cfif>
		<cfif trim(form.categoryfrom) neq "" and trim(form.categoryto) neq "">
			<tr>
				<td colspan="#columncount#"><div align="center"><font size="2" face="Times New Roman, Times, serif">CATEGORY: #form.categoryfrom# - #form.categoryto#</font></div></td>
			</tr>
		</cfif>
		<cfif trim(form.groupfrom) neq "" and trim(form.groupto) neq "">
			<tr>
		...
		<cfif trim(form.productfrom) neq "" and trim(form.productto) neq "">
			<tr>
				<td colspan="#columncount#"><div align="center"><font size="2" face="Times New Roman, Times, serif">PRODUCT_NO: #form.productfrom# - #form.productto#</font></div></td>
			</tr>
		</cfif>
		<tr>
		...
		<cfloop query="getcustomer">
            ...
            <cfquery name="getadd" datasource="#dts#">
            select add1,add2,add3,add4 from #target_arcust# where custno='#getcustomer.custno#'
            </cfquery>
			<tr>
				<td><div align="left"><strong><u>#getcustomer.custno#</u></strong></div></td>
				<td><div align="left"><strong><u>#getcustomer.name#</u></strong></div></td>
                <td><div align="left"><strong><u>#getadd.add1##getadd.add2##getadd.add3##getadd.add4#</u></strong></div></td>
			</tr>
