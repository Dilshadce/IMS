...
<cfset consignment=''>
	<cfset pageTitle = "Variable Report">
...
<cfoutput>
	<cfform class="formContainer form3Button" name="VariableReportForm" id="VariableReportForm" action="LorealvariableReport2.cfm" method="post" target="_blank">
        <div>#pageTitle#</div>
        <div>
        <table>
