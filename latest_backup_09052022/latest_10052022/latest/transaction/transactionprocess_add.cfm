...
select autobom,recompriceup,recompriceup1,autolocbf from gsetup
</cfquery>
            ...
            <cfset qtyfree_bil = 0>
             ...
             <cfquery name="insertictran" datasource="#dts#" >
                ...
                (
                    ...
                    wos_group,category,brem1,brem2,brem3,brem4,requiredate,replydate,deliverydate,pono,
                ...
                (
                    ...
                    '#form.brem3#','<cfif ucase(form.brem4) eq "XCOST">XCOST<cfelse>#form.brem4#</cfif>','#requiredate#','#replydate#','#deliverydate#','#form.pono#',
...
(<cfqueryparam cfsqltype="cf_sql_varchar" value="#form.voucherno#">,'Value','#val(amt1_bil)#',<cfqueryparam cfsqltype="cf_sql_varchar" value="#form.desp#">,'#HUserID#',now(),<cfqueryparam cfsqltype="cf_sql_varchar" value="#form.custno#" >)
    ...
    <cfquery name="insertictran" datasource="#dts#" >
        ...
        (
            ...
            mc3_bil,mc4_bil,mc5_bil,mc6_bil,mc7_bil<cfif isdefined('form.taxinclude') and wpitemtax eq "Y">,taxincl</cfif><cfif isdefined('form.foc')>,foc</cfif><cfif isdefined('form.asvoucher')>,asvoucher,voucherno</cfif>,photo<cfif isdefined('form.ictranfilename')>,ictranfilename</cfif><cfif isdefined('form.invlinklist')>,invlinklist</cfif><cfif isdefined('form.invcnitem')>,invcnitem</cfif>,stkcost
        )
        values
        (
            '#tran#','#nexttranno#','#form.custno#','#numberformat(form.readperiod,"00")#',#getcust.wos_date#,
