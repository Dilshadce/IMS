...
<cfset words_id_list = "1416,1087,959,702,106,23,11">
<cfinclude template="/latest/words.cfm">
<cfset pageTitle="#words[1416]#">
<cfset targetTitle="Trace RefNo 2 Duplicate">
<cfset targetTable="">
...
<head>
    ...
    <script type="text/javascript">
        ...
        var refno='#words[1087]#';
        var refno2='#words[959]#';
        var date='#words[702]#';
        var supplierno='#words[106]#';
        var name='#words[23]#';
        var SEARCH='#words[11]#';
    </script>
    </cfoutput>
    <script type="text/javascript" src="/latest/enquiries/More/report_1.js"></script>
