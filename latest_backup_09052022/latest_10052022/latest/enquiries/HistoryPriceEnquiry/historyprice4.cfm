...
<table border="0" cellspacing="0" cellpadding="2">
	...
	<cfif trim(form.supplierFrom) neq "" and trim(form.supplierTo) neq "">
		<tr>
			<td colspan="13"><div align="center"><font size="2" face="Times New Roman, Times, serif">SUPPLIER: #form.supplierFrom# - #form.supplierTo#</font></div></td>
		</tr>
	</cfif>
	...
	<cfloop query="getitem">
        ...
        <cfif trim(form.supplierFrom) neq trim(form.supplierTo) or (trim(form.supplierFrom) eq "" and trim(form.supplierTo) eq "")>
        		<tr> 
        ...
        <cfquery name="getsuppdetail" datasource="#dts#">
			select custno,name from #target_apvend# where custno = '#form.supplierFrom#'
		</cfquery>
        	<tr> 
		...
		<cfloop query="getsupp">
			...
			<td><font size="2" face="Times New Roman, Times, serif"><div align="left"><b><u>#getitem.desp#</u></b></div></font></td>
				...
				<cfquery name="getprice" datasource="#dts#">
					...
					left join 
					(select custno,itemno,wos_date as wos_date1,qty as qty_1,(price_bil) as price1
					...
					left join 
					(select custno,itemno,wos_date as wos_date2,qty as qty_2,(price_bil) as price2
					from ictran where itemno='#itemno#' and custno='#customerno#' and type='RC' and (void='' or void is null)
					<cfif form.datefrom neq "" and form.dateto neq "">
						and wos_date between '#ndatefrom#' and '#ndateto#'
					<cfelse>
					...
					left join 
					(select custno,itemno,wos_date as wos_date3,qty as qty_3,(price_bil) as price3
					from ictran where itemno='#itemno#' and custno='#customerno#' and type='RC' and (void='' or void is null)
					<cfif form.datefrom neq "" and form.dateto neq "">
						and wos_date between '#ndatefrom#' and '#ndateto#'
					<cfelse>
