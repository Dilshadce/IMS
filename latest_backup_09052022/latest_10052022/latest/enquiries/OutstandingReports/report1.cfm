...
<cfquery name="getitem" datasource="#dts#">
 ...
 and (void = '' or void is null) <cfif lcase(HcomID) eq "kjcpl_i" or lcase(HcomID) eq "mlpl_i" or lcase(HcomID) eq "viva_i" or lcase(HcomID) eq "tlxil_i" or lcase(HcomID) eq "uniq_i"><cfelse>and wos_date > #getgeneral.lastaccyear#</cfif>  and (toinv='' or toinv is null)
	...
	<cfif trim(form.itemFrom) neq "" and trim(form.itemTo) neq "">
		and a.itemno >= <cfqueryparam cfsqltype="cf_sql_varchar" value="#form.itemFrom#"> and a.itemno <= <cfqueryparam cfsqltype="cf_sql_varchar" value="#form.itemTo#">
	</cfif>
...
<cfquery name="getgroup" datasource="#dts#">
	...
	itemno <> ''
	<cfif trim(form.itemFrom) neq "" and trim(form.itemTo) neq "">
		and itemno >= <cfqueryparam cfsqltype="cf_sql_varchar" value="#form.itemFrom#"> and itemno <= <cfqueryparam cfsqltype="cf_sql_varchar" value="#form.itemTo#">
	</cfif>
	<cfif trim(form.categoryFrom) neq "" and trim(form.categoryTo) neq "">
    ...
    <cfif trim(categoryFrom) neq "" and trim(categoryTo) neq "">
      <tr>
        <td colspan="100%"><div align="center"><font size="2" face="Times New Roman, Times, serif">#getgeneral.lCATEGORY#
            From #categoryFrom# To #categoryTo#</font></div></td>
      </tr>
    </cfif>
    ...
    <cfif trim(itemFrom) neq "" and trim(itemTo) neq "">
      <tr>
        <td colspan="100%"><div align="center"><font size="2" face="Times New Roman, Times, serif">Product
            From #itemFrom# To #itemTo#</font></div></td>
      </tr>
    </cfif>
    ...
    <cfoutput query="getdata">
      ...
      <tr>
		...
		<td nowrap><div align="center"><font size="2" face="Times New Roman, Times, serif">
			<a href="inforecastreport2.cfm?itemno=#urlencodedformat(itemno)#&itembal=#balonhand#&pf=#urlencodedformat(itemFrom)#&pt=#urlencodedformat(itemTo)#&cf=#categoryFrom#&ct=#categoryTo#&gpf=#groupfrom#&gpt=#groupto#&projfr=#projectfrom#&projto=#projectto#">View Details</a></font></div></td>
      </tr>
    </cfoutput> <cfoutput>
      <tr>
        <td colspan="100%"><hr></td>
