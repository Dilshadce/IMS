...
<cfset words_id_list = "1412,3,120,65,11">
<cfinclude template="/latest/words.cfm">
<cfset pageTitle="#words[1412]#">
<cfset targetTitle="Item With Restricted Symbol">
<cfset targetTable="">
...
<head>
   ...
   <!--- <meta name="viewport" content="width=device-width, initial-scale=1.0" />--->
    ...
    <script type="text/javascript" src="/latest/js/enquiries/ExceptionReport/report_4.js"></script>
