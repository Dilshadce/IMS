...
<cfset words_id_list = "1415,877,1375,11,3">
<cfinclude template="/latest/words.cfm">
<cfset pageTitle="#words[1415]#">
<cfset targetTitle="Error During Update Report">
<cfset targetTable="">
...
<head>
    ...
    <script type="text/javascript" src="/latest/js/enquiries/BillsNotAcceptedReport/report_4.js"></script>
	...
	<div class="page-header">
		<h2>
			...
			<div class="pull-right">
            	<button type="button" class="btn btn-default" onclick="window.open('/default/enquires/norecoverbill3.cfm','_blank');">
