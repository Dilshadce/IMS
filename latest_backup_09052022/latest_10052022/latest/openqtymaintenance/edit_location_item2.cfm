...
<cfform name="edit_location_item" action="location_opening_qty_maintenance-new.cfm?type=edit&modeaction=#url.modeaction#&location=#URLEncodedFormat(url.location)#&itemno=#URLEncodedFormat(url.itemno)#">	
	<table align="center">
		<tr align="justify">
			<th>Location</th>
	...
	<table align="center">
		<tr>
			...
			<td><input type="button" name="Back" value="Back" onClick="window.location='location_opening_qty_maintenance-new.cfm?modeaction=#url.modeaction#'"></td>
		</tr>
	</table>
</cfform>
</cfoutput>
