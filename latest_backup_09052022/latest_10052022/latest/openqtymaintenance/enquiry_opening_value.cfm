...
<cfif getrecordcount.recordcount neq 0>
	...
	<cfform action="enquiry_opening_value.cfm" method="post" target="_self">
		...
		<cfquery name="getitem" datasource="#dts#">
			select itemno,desp,despa, qtybf,ucost,avcost,avcost2 
			from icitem 
            where #searchType# LIKE binary('#searchStr#') <cfif searchType eq "desp"> or despa LIKE binary('#searchStr#') </cfif>
			order by itemno
			limit #start-1#,20;
		...
		<cfif start neq 1>
			|| <a target="_self" href="enquiry_opening_value.cfm?start=#prevTwenty#">Previous</a> ||
		</cfif>
		
		<cfif page neq noOfPage>
			<a target="_self" href="enquiry_opening_value.cfm?start=#nextTwenty#">Next</a> ||
		</cfif>
		...
		<table align="center" class="data" width="600px">
			...
			<cfloop query="getitem"> 
        		<tr onMouseOut="javascript:this.style.backgroundColor='';" onMouseOver="javascript:this.style.backgroundColor='99FF00';">
          			...
          			<cfif getpin2.h1311 eq 'T'>
						<td width="100" nowrap>
						<a href="openqtyvalue_item.cfm?itemno=#urlencodedformat(itemno)#">View</a>
						</td>
					</cfif>
        		</tr>
      		</cfloop> 
