...
$(document).ready(function(e){
	...
	$.pnotify.defaults.styling = displayInviteFriend;
	$.pnotify({
		addclass: 'notification',
    	text: '<a href="/latest/body/inviteFriend.cfm" target="mainFrame">Click here to invite a friend and earn 10% incentive for their first subscription.</a>',
    	type: 'info',
		hide: false,
		history: false,
    	icon: false,
