...
$(document).ready(function(e) {
	...
	var resultTable=$('#resultTable')
		.dataTable({
			...
			'aoColumnDefs':[
				{'aTargets':[0],'sTitle':menuid.toUpperCase(),'mData':'menu_id','bSortable':true,'bVisible':false,'sWidth':'10%'},
				{'aTargets':[1],'sTitle':menuname.toUpperCase(),'mData':'menu_name','bSortable':true,'sWidth':'20%'},
				{	'aTargets':[2],
					'sTitle':newmenuname.toUpperCase(),
					'mData':'new_menu_name',
					'bSortable':true,
					'sWidth':'20%',
