...
<cfif IsDefined("url.action")>
	<cfif url.action EQ "create">
		<cfset pageTitle="Create Gold Content">
	...
	<cfelseif url.action EQ "update">
		<cfset pageTitle="Update Gold Content">
    ...
    <cfelseif url.action EQ "delete">
    	<cfset pageTitle="Delete Gold Content">
...
<cfoutput>
<form class="form-horizontal" role="form" action="goldcontentProcess.cfm?action=#url.action#&menuID=#url.menuID#" method="post" onsubmit="document.getElementById('size').disabled=false";>
	<div class="page-header">
		...
		<div class="panel-group">
            ...
            <div class="pull-right">
				...
				<input type="button" value="#words[96]#" onclick="window.location='goldcontentProfile.cfm?menuID=#url.menuID#'" class="btn btn-default" />
			</div>
</form>
</cfoutput>
</body>
