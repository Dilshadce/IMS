	...
	var resultTable=$('#resultTable')
		.dataTable({
			...
			'aoColumnDefs':[
				...
				{'aTargets':[1],'sTitle':'MEMBER ID','mData':'wijayamemberid','bSortable':true,'sWidth':'15%'},
				{'aTargets':[2],'sTitle':name.toUpperCase(),'mData':'name','bSortable':true,'sWidth':'30%'},
				{'aTargets':[3],'sTitle':customerno.toUpperCase(),'mData':'customerno','bSortable':true,'sWidth':'10%'},
				{'aTargets':[4],'sTitle':'PHONE','mData':'phone','bSortable':true,'sWidth':'10%'},
				{'aTargets':[5],'sTitle':'HP','mData':'contact','bSortable':true,'sWidth':'10%'},
				
						{'aTargets':[6],'sTitle':"Joint Date",'mData':'expiredate','bSortable':true,'sWidth':'10%',
