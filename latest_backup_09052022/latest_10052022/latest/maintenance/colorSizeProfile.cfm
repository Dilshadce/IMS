...
<cfset words_id_list = "576,578,579,65,10,11,577,3">
<cfinclude template="/latest/words.cfm">
<cfset pageTitle="#words[576]#">
...
<head>
    ...
    <script type="text/javascript">
        ...
        var colorno='#words[578]#';
        var colorid='#words[579]#';
			...
			<div class="pull-right">
            	<cfif getUserPin2.H10413_3a EQ 'T'>
					<button type="button" class="btn btn-default" onclick="window.open('/latest/maintenance/colorSize.cfm?action=create','_self');">
						<span class="glyphicon glyphicon-plus"></span> #words[577]#
					</button>
                </cfif>
