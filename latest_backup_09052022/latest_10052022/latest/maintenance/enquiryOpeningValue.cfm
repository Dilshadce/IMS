...
<cfset words_id_list = "493, 11, 10, 120, 65">
<cfinclude template="/latest/words.cfm">

<cfset pageTitle="#words[493]#">
	...
	<div class="page-header">
		<h2>
			...
			<div class="pull-right">
				<button type="button" class="btn btn-default" onclick="window.open('/default/maintenance/openqtymaintenance/openqtysummary.cfm','_self');">
                	<span class="glyphicon glyphicon-print"></span> Print All
                </button>
                <button type="button" class="btn btn-default" onclick="window.open('/default/maintenance/openqtymaintenance/locationopenqtysummary.cfm','_self');">
                	<span class="glyphicon glyphicon-print"></span> Print All Location
                </button>
			</div>
		</h2>
	</div>
