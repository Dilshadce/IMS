...
<cfset words_id_list = "460,95,461,98,438,23,16,6,38,39,8,440,300,96">
...
<form class="formContainer form2Button" action="/latest/maintenance/collectAddressProcess.cfm?action=#url.action#" method="post" onsubmit="document.getElementById('code').disabled=false";>
	...
	<div>
		...
		<input type="button" value="#words[96]#" onclick="window.location='/latest/maintenance/collectAddressProfile.cfm'" />
	</div>
</form>
</cfoutput>
</body>
