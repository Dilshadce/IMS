...
<cfquery name="listpricematrix" datasource="#dts#">
	SELECT *
...
<cfif IsDefined("url.action")>
	<cfif url.action EQ "create">
		...
		<cfset trchkd = "">
		<cfset creditchecked = "">
		<cfset payrolltaxexempt = "">
		<cfset invoicegrouping = "">
		<cfset costcode = "">
		<cfset invoiceformat = "">
		<cfset invoicemessage = "">
		<cfset billingrequirements = "">
		<cfset servicetype = "">
		<cfset clientcondition = "">
		<cfset pricematrix = "">
	...
	<cfelseif url.action EQ "update">
		...
		<cfset officecode = getCustomer.officecode>
		<cfset clienttype = getCustomer.clienttype>
		<cfset clientlevel = getCustomer.clientlevel>
		<cfset source = getCustomer.source>
		<cfset competitor = getCustomer.competitor>
		<cfset vatno = getCustomer.vatno>
		<cfset tacs = getCustomer.tacs>
		<cfset orgdate = getCustomer.orgdate>
		<cfset noemp = getCustomer.noemp>
		<cfset tacr = getCustomer.tacr>
		<cfset ps10 = getCustomer.ps10>
		<cfset clientaltno = getCustomer.clientaltno>
		<cfset clientremark = getCustomer.clientremark>
		<cfset capital = getCustomer.capital>
		<cfset annualsales = getCustomer.annualsales>
		<cfset trchkd = getCustomer.trchkd>
		<cfset creditchecked = getCustomer.creditchecked>
		<cfset payrolltaxexempt = getCustomer.payrolltaxexempt>
		<cfset invoicegrouping = getCustomer.invoicegrouping>
		<cfset costcode = getCustomer.costcode>
		<cfset invoiceformat = getCustomer.invoiceformat>
		<cfset invoicemessage = getCustomer.invoicemessage>
		<cfset billingrequirements = getCustomer.billingrequirements>
		<cfset servicetype = getCustomer.servicetype>
		<cfset clientcondition = getCustomer.clientcondition>
		<cfset pricematrix = getCustomer.pricematrix>
        <cfloop from="2" to="10" index="a">
        <cfset "pricematrix#a#" = evaluate("getCustomer.pricematrix#a#")>
        </cfloop>
							...
							<div class="row">
								<div class="col-sm-6">								
									...
									<div class="form-group">
										...
										<div class="col-sm-8">
											<input type="text" class="form-control input-sm" id="name" name="name" value="#name#" placeholder="#targetNameLine1#" maxlength="40" readonly>
										</div>
									</div>
									<div class="form-group">
										<label for="name2" class="col-sm-4 control-label"></label>
										<div class="col-sm-8">
											<input type="text" class="form-control input-sm" id="name2" name="name2" value="#name2#" placeholder="#targetNameLine2#" maxlength="40" readonly>
											<span class="help-block" style="display:none;"></span>
										</div>
									</div>
									<div class="form-group">
									...
									<div class="form-group">
										...
										<div class="col-sm-8">
											<input type="text" class="form-control input-sm" id="groupTo" name="groupTo" value="#groupTo#" placeholder="#words[31]#" maxlength="8" readonly>
										</div>
									</div> 
                                    <div class="form-group">
									...
									<div class="form-group" style="display:none">
										<label for="officecode" class="col-sm-4 control-label">Office Code</label>
										<div class="col-sm-8">
											<input type="text" class="form-control input-sm" id="officecode" name="officecode" value="#officecode#" placeholder="Office Code" disabled>
										</div>
									</div> 
									
									<div class="form-group" style="display:none">
										<label for="clienttype" class="col-sm-4 control-label">Type</label>
										<div class="col-sm-8">
											<input type="text" class="form-control input-sm" id="clienttype" name="clienttype" value="#clienttype#" placeholder="Type" disabled>
										</div>
									</div> 
									
									<div class="form-group" style="display:none">
										<label for="clientlevel" class="col-sm-4 control-label">Level</label>
										<div class="col-sm-8">
											<input type="text" class="form-control input-sm" id="clientlevel" name="clientlevel" value="#clientlevel#" placeholder="Level" disabled>
										</div>
									</div> 
									<div class="form-group">
                                        						<label for="taxCode" class="col-sm-4 control-label">Default Pay & Bill Structure</label>
                                            						<div class="col-sm-6">
                                                					<select class="form-control input-sm" id="pricematrix" name="pricematrix">
                                                    					<option value="">Choose a Pay & Bill Structure</option>
                                                    					<cfloop query="listpricematrix">
                                                        				<option value="#listpricematrix.priceid#" data-symbol="#listpricematrix.priceid#" data-description="#listpricematrix.priceid#" <cfif listpricematrix.priceid EQ pricematrix>selected</cfif>>#listpricematrix.priceid# - #listpricematrix.pricename#</option>
                                                    					</cfloop>
                                                					</select>
                                            						</div>
                                        				</div>
<cfloop from="2" to="10" index="a">
                                                                  <div class="form-group">
                                        						<label for="taxCode" class="col-sm-4 control-label">Pay & Bill Structure #a#</label>
                                            						<div class="col-sm-6">
                                                					<select class="form-control input-sm" id="pricematrix#a#" name="pricematrix#a#">
                                                    					<option value="">Choose a Pay & Bill Structure</option>
                                                    					<cfloop query="listpricematrix">
                                                        				<option value="#listpricematrix.priceid#" data-symbol="#listpricematrix.priceid#" data-description="#listpricematrix.priceid#" <cfif listpricematrix.priceid EQ evaluate('pricematrix#a#')>selected</cfif>>#listpricematrix.priceid# - #listpricematrix.pricename#</option>
                                                    					</cfloop>
                                                					</select>
                                            						</div>
                                        				</div>
							...
							<div class="row">
                            	<div class="col-sm-6">
                                	<div class="form-group">
										...
										<div class="col-sm-8">
                                        	<input type="text" class="form-control input-sm" id="attn" name="attn" value="#attn#" readonly>
										</div>
									</div>
									<div class="form-group">
										<label for="add1" class="col-sm-4 control-label">#words[6]#</label>
										<div class="col-sm-8">
											<input type="text" class="form-control input-sm" id="add1" name="add1" value="#add1#" placeholder="#words[34]#" maxlength="35" readonly>
										</div>
									</div>
									<div class="form-group">
										<label for="add2" class="col-sm-4 control-label"></label>
										<div class="col-sm-8">
											<input type="text" class="form-control input-sm" id="add2" name="add2" value="#add2#" placeholder="#words[35]#" maxlength="35" readonly>
										</div>
									</div>
									<div class="form-group">
										<label for="add3" class="col-sm-4 control-label"></label>
										<div class="col-sm-8">
											<input type="text" class="form-control input-sm" id="add3" name="add3" value="#add3#" placeholder="#words[36]#" maxlength="35" readonly>
										</div>
									</div>
									<div class="form-group">
										<label for="add4" class="col-sm-4 control-label"></label>
										<div class="col-sm-8">
											<input type="text" class="form-control input-sm" id="add4" name="add4" value="#add4#" placeholder="#words[37]#" maxlength="35" readonly>
										</div>
									</div>
									<div class="form-group">
										<label class="col-sm-4 control-label"></label>
										<div class="col-sm-4">
											<input type="text" class="form-control input-sm" id="country" name="country" value="#country#" placeholder="#words[38]#" maxlength="25" readonly>											
										</div>
										<div class="col-sm-4">
											<input type="text" class="form-control input-sm" id="postalcode" name="postalcode" value="#postalcode#" placeholder="#words[39]#" maxlength="25" readonly>
										</div>
									</div>	
                                    <div class="form-group">
										<label for="phone" class="col-sm-4 control-label">#words[40]#</label>
										<div class="col-sm-8">
											<input type="text" class="form-control input-sm" id="phone" name="phone" value="#phone#" placeholder="#words[41]#" maxlength="25" readonly>
										</div>
									</div>
                                    <div class="form-group">
										<label for="hp" class="col-sm-4 control-label">#words[42]#</label>
										<div class="col-sm-8">
											<input type="text" class="form-control input-sm" id="hp" name="hp" value="#hp#" placeholder="#words[43]#" maxlength="25" readonly>
										</div>
									</div>
									<div class="form-group">
										<label for="fax" class="col-sm-4 control-label">#words[300]#</label>
										<div class="col-sm-8">
											<input type="text" class="form-control input-sm" id="fax" name="fax" value="#fax#" placeholder="#words[44]#" maxlength="25" readonly>
										</div>
									</div>								
									<div class="form-group">
										<label for="email" class="col-sm-4 control-label">#words[45]#</label>
										<div class="col-sm-8">
											<input type="text" class="form-control input-sm" id="email" name="email" value="#email#" placeholder="#words[46]#" maxlength="100" readonly>
										</div>
									</div>
                                </div>
                                <div class="col-sm-6">
                                	<div class="form-group">
										...
										<div class="col-sm-8">
                                        <input type="text" class="form-control input-sm" id="d_attn" name="d_attn" value="#d_attn#" readonly>
										</div>
									</div>
									<div class="form-group">
										<label for="d_add1" class="col-sm-4 control-label">#words[48]#</label>
										<div class="col-sm-8">
											<input type="text" class="form-control input-sm" id="d_add1" name="d_add1" value="#d_add1#" placeholder="#words[34]#" maxlength="35" readonly>
										</div>
									</div>
									<div class="form-group">
										<label for="d_add2" class="col-sm-4 control-label"></label>
										<div class="col-sm-8">
											<input type="text" class="form-control input-sm" id="d_add2" name="d_add2" value="#d_add2#" placeholder="#words[35]#" maxlength="35" readonly>
										</div>
									</div>
									<div class="form-group">
										<label for="d_add3" class="col-sm-4 control-label"></label>
										<div class="col-sm-8">
											<input type="text" class="form-control input-sm" id="d_add3" name="d_add3" value="#d_add3#" placeholder="#words[36]#" maxlength="35" readonly>
										</div>
									</div>
									<div class="form-group">
										<label for="d_add4" class="col-sm-4 control-label"></label>
										<div class="col-sm-8">
											<input type="text" class="form-control input-sm" id="d_add4" name="d_add4" value="#d_add4#" placeholder="#words[37]#" maxlength="35" readonly>
										</div>
									</div>
									<div class="form-group">
										<label class="col-sm-4 control-label"></label>
										<div class="col-sm-4">
											<input type="text" class="form-control input-sm" id="d_country" name="d_country" value="#d_country#" placeholder="#words[38]#" maxlength="25" readonly>											
										</div>
										<div class="col-sm-4">
											<input type="text" class="form-control input-sm" id="d_postalcode" name="d_postalcode" value="#d_postalcode#" placeholder="#words[39]#" maxlength="25" readonly>
										</div>
									</div>	
                                    <div class="form-group">
										<label for="d_phone" class="col-sm-4 control-label">#words[49]#</label>
										<div class="col-sm-8">
											<input type="text" class="form-control input-sm" id="d_phone" name="d_phone" value="#d_phone#" placeholder="#words[41]#" maxlength="25" readonly>
										</div>
									</div>
                                    <div class="form-group">
										<label for="d_hp" class="col-sm-4 control-label">#words[50]#</label>
										<div class="col-sm-8">
											<input type="text" class="form-control input-sm" id="d_hp" name="d_hp" value="#d_hp#" placeholder="#words[43]#" maxlength="25" readonly>
										</div>
									</div>
									<div class="form-group">
										<label for="d_fax" class="col-sm-4 control-label">#words[51]#</label>
										<div class="col-sm-8">
											<input type="text" class="form-control input-sm" id="d_fax" name="d_fax" value="#d_fax#" placeholder="#words[44]#" maxlength="25" readonly>
										</div>
									</div>								
									<div class="form-group">
										<label for="web_site" class="col-sm-4 control-label">#words[52]#</label>
										<div class="col-sm-8">
											<input type="text" class="form-control input-sm" id="web_site" name="web_site" value="#web_site#" placeholder="#words[46]#" maxlength="100" readonly>
										</div>
									</div>         
						...
						<div class="panel-body">
							<div class="row">                            
								<div class="col-sm-6">
									...
									<div class="form-group">
										<label for="costcode" class="col-sm-4 control-label">Cost Code</label>
										<div class="col-sm-8">
											<input type="text" class="form-control input-sm" id="costcode" name="costcode" value="#costcode#" placeholder="Cost Code" disabled>
										</div>
									</div>		
									
									<div class="form-group">
										<label for="trchkd" class="col-sm-4 control-label">Trade Ref Chkd</label>
										<div class="col-sm-8">
											<input type="checkbox" class="form-control input-sm" id="trchkd" name="trchkd" <cfif trchkd eq 1>checked</cfif> disabled>
										</div>
									</div>		
									
									<div class="form-group">
										<label for="creditchecked" class="col-sm-4 control-label">Credit Checked</label>
										<div class="col-sm-8">
											<input type="checkbox" class="form-control input-sm" id="creditchecked" name="creditchecked" <cfif creditchecked eq 1>checked</cfif> disabled>
										</div>
									</div>	
									
									<div class="form-group">
										<label for="payrolltaxexempt" class="col-sm-4 control-label">Payroll Tax Exempt</label>
										<div class="col-sm-8">
											<input type="checkbox" class="form-control input-sm" id="payrolltaxexempt" name="payrolltaxexempt" <cfif payrolltaxexempt eq 1>checked</cfif> disabled>
										</div>
									</div>	
									
									<div class="form-group">
										<label for="invoicegrouping" class="col-sm-4 control-label">Invoice Grouping</label>
										<div class="col-sm-8">
											<input type="text" class="form-control input-sm" id="invoicegrouping" name="invoicegrouping" value="#invoicegrouping#" placeholder="Invoice Grouping" disabled>
										</div>
									</div>		
								...
								<div class="col-sm-6">
                                    ...
                                    <div class="form-group">
										...
										<div class="col-sm-8">
											<input type="text" class="form-control input-sm" id="creditLimit" name="creditLimit" value="#creditLimit#" placeholder="#words[69]#" value="0.00" readonly/>
										</div>
									</div>
									<div class="form-group">
									...
									<div class="form-group">
										...
										<div class="col-sm-8">
											<input type="text" class="form-control input-sm" id="capital" name="capital" value="#capital#" placeholder="Capital" disabled />
										</div>
									</div>
									
									<div class="form-group">
										<label for="annualsales" class="col-sm-4 control-label">Annual Sales</label>
										<div class="col-sm-8">
											<input type="text" class="form-control input-sm" id="annualsales" name="annualsales" value="#annualsales#" placeholder="Annual Sales" disabled />
										</div>
									</div>
							...
							<div class="row">
                            	<div class="col-sm-12">
									<div class="form-group">
										<label for="invoiceformat" class="col-sm-4 control-label">Invoice Format</label>
										<div class="col-sm-8">
											<input type="text" class="form-control input-sm" id="invoiceformat" name="invoiceformat" value="#invoiceformat#" placeholder="Invoice Grouping" disabled>
										</div>
									</div>		
									
									<div class="form-group">
										<label for="invoicemessage" class="col-sm-4 control-label">Invoice Message</label>
										<div class="col-sm-8">
											<input type="text" class="form-control input-sm" id="invoicemessage" name="invoicemessage" value="#invoicemessage#" placeholder="Invoice Message" disabled>
										</div>
									</div>
									
									<div class="form-group">
										<label for="billingrequirements" class="col-sm-4 control-label">Special Billing Requirements</label>
										<div class="col-sm-8">
											<input type="text" class="form-control input-sm" id="billingrequirements" name="billingrequirements" value="#billingrequirements#" placeholder="" disabled>
										</div>
									</div>
									
									<div class="form-group">
										<label for="servicetype" class="col-sm-4 control-label">Service</label>
										<div class="col-sm-8">
											<input type="text" class="form-control input-sm" id="servicetype" name="servicetype" value="#servicetype#" placeholder="Service Type" disabled>
										</div>
									</div>
					...
					<div id="remarkCollapse" class="panel-collapse collapse">
						<div class="panel-body">
							<div class="row">
								<div class="col-sm-6">
                                    <div class="form-group">
                                        <label for="remark1" class="col-sm-4 control-label">Office Code</label>
                                        <div class="col-sm-8">
                                            <input type="text" class="form-control input-sm" id="remark1" name="remark1" value="#remark1#" placeholder="#words[91]#" readonly>
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <label for="remark2" class="col-sm-4 control-label">Profile</label>
                                        <div class="col-sm-8">
                                            <input type="text" class="form-control input-sm" id="remark2" name="remark2" value="#remark2#" placeholder="#words[92]#" readonly>
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <label for="remark3" class="col-sm-4 control-label">Title</label>
                                        <div class="col-sm-8">
                                            <input type="text" class="form-control input-sm" id="remark3" name="remark3" value="#remark3#" placeholder="#words[93]#" readonly>
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <label for="remark4" class="col-sm-4 control-label">Department</label>
                                        <div class="col-sm-8">
                                            <input type="text" class="form-control input-sm" id="remark4" name="remark4" value="#remark4#" placeholder="#words[94]#" readonly>
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <label for="remark5Label" class="col-sm-4 control-label">Tax Type</label>
                                        <div class="col-sm-8">
                                            <input type="text" class="form-control input-sm" id="remark5" name="remark5" value="#remark5#" placeholder="Remark 5" readonly>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-sm-6">
                                    <div class="form-group">
                                        <label for="remark6Label" class="col-sm-4 control-label">Factor</label>
                                        <div class="col-sm-8">
                                            <input type="text" class="form-control input-sm" id="remark6" name="remark6" value="#remark6#" placeholder="Remark 6" readonly>
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <label for="remark7Label" class="col-sm-4 control-label">Pay Date</label>
                                        <div class="col-sm-8">
                                            <input type="text" class="form-control input-sm" id="remark7" name="remark7" value="#remark7#" placeholder="Remark 7">
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <label for="remark8Label" class="col-sm-4 control-label">Bill Date</label>
                                        <div class="col-sm-8">
                                            <input type="text" class="form-control input-sm" id="remark8" name="remark8" value="#remark8#" placeholder="Remark 8">
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <label for="remark9Label" class="col-sm-4 control-label">Bill Next Month</label>
                                        <div class="col-sm-8">
                                             <select class="form-control input-sm" id="remark9" name="remark9">
                                                <option value="N" <cfif remark9 eq "N">Selected</cfif>>NO</option>
                                                <option value="Y" <cfif remark9 eq "Y">Selected</cfif>>YES</option>
                                            </select>
                                        </div>
                                    </div>
                                    <div class="form-group">
				...
				<div class="panel panel-default">
					<div class="panel-heading" data-toggle="collapse" href="##profilesCollapse">
						<h4 class="panel-title accordion-toggle">Detail Profile Information</h4>
					</div>
					<div id="profilesCollapse" class="panel-collapse collapse">
						<div class="panel-body">
							<div class="row">
								<div class="col-sm-6">
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-8">
                                            <input type="text" class="form-control input-sm" id="source" name="source" value="#source#" placeholder="Source" disabled>
                                        </div>
                                    </div>
                                    
                                    <div class="form-group">
                                        <label for="vatno" class="col-sm-4 control-label">Vat No</label>
                                        <div class="col-sm-8">
                                            <input type="text" class="form-control input-sm" id="vatno" name="vatno" value="#vatno#" placeholder="Vat No" disabled>
                                        </div>
                                    </div>
                                   
                                    <div class="form-group">
                                        <label for="orgdate" class="col-sm-4 control-label">Org Date</label>
                                        <div class="col-sm-8">
                                            <input type="text" class="form-control input-sm" id="orgdate" name="orgdate" value="#orgdate#" placeholder="Org Date" disabled>
                                        </div>
                                    </div>
									<div class="form-group">
                                        <label for="noemp" class="col-sm-4 control-label">No. Emps</label>
                                        <div class="col-sm-8">
                                            <input type="text" class="form-control input-sm" id="noemp" name="noemp" value="#noemp#" placeholder="" disabled>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-sm-6">
									<div class="form-group">
                                        <label for="competitor" class="col-sm-4 control-label">Competitor</label>
                                        <div class="col-sm-8">
                                            <input type="text" class="form-control input-sm" id="competitor" name="competitor" value="#competitor#" placeholder="Competitor" disabled>
                                        </div>
                                    </div>
									<div class="form-group">
                                        <label for="tacs" class="col-sm-4 control-label">Terms and Conditions Sent</label>
                                        <div class="col-sm-8">
                                            <input type="text" class="form-control input-sm" id="tacs" name="tacs" value="#tacs#" placeholder="" disabled>
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <label for="tacr" class="col-sm-4 control-label">Terms and Conditions Recd</label>
                                        <div class="col-sm-8">
                                            <input type="text" class="form-control input-sm" id="tacr" name="tacr" value="#tacr#" placeholder="" disabled>
                                        </div>
                                    </div>
                                    
                                    <div class="form-group">
                                        <label for="ps10" class="col-sm-4 control-label">PS 10 Completed</label>
                                        <div class="col-sm-8">
                                            <input type="text" class="form-control input-sm" id="ps10" name="ps10" value="#ps10#" placeholder="" disabled>
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <label for="clientaltno" class="col-sm-4 control-label">Client Alternate ##</label>
                                        <div class="col-sm-8">
                                            <input type="text" class="form-control input-sm" id="clientaltno" name="clientaltno" value="#clientaltno#" placeholder="" disabled>
                                        </div>
                                    </div>
							...
							<div class="row">
								<div class="col-sm-12">
                                    <div class="form-group">
                                        <label for="clientremark" class="col-sm-12 control-label">Client Profile / Work Enviroment</label>
                                        <div class="col-sm-12">
                                            <input type="text" class="form-control input-sm" id="clientremark" name="clientremark" value="#clientremark#" placeholder="">
                                        </div>
                                    </div>
                                </div>
							</div>
