...
$(document).ready(function(e){
	...
	$.pnotify({
		...
		<!---modified by Lee Kher Xin 20160920--->
    	text: '<a href="/menulist/body/inviteFriend.cfm" target="mainFrame">Click here to invite a friend and get reward.</a>',
    	type: 'info',
		 
		/*function stack_topleft() { 
		find('.stack_topleft').fadeOut(500).fadeIn(500);
		}*/
