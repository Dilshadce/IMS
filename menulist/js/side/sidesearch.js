...
$(document).ready(function(e) {
	...
	*/
	if(top.frames['mainFrame'].document.title!='Search Result'){
		var resultFrame=window.open('/menulist/body/searchresult.cfm','mainFrame');
	};
	$('#backNavigation').on('click',function(e){
		window.open('/menulist/body/overview.cfm','mainFrame');
		window.open('/menulist/side/sidemenu.cfm','_self');
	});
