...
SELECT * FROM eumasbalance WHERE actiontype = "SERVICES" 
AND wos_date between "#form.datefrom#" and "#form.dateto#" and delstatus <> "Y" order by wos_date
</cfquery>
...
<cfelse>
<cfset itemno = "SERVICES">
<cfset custnoa = "3010/000">
</cfif>
