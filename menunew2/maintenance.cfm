...
<span id="sub30" style="display:none;" class="submenu">
        ...
        <cfif getpin2.h1Q20 eq "T">
        <li>
			<a class="oe_secondary_submenu_item" href="/#HDir#/maintenance/colour/colourtable.cfm" target="mainFrame" title="<cfoutput>Model Profile</cfoutput>">
                <cfoutput>Colour Profile</cfoutput>
			</a>
		</li>
        </cfif>
        <cfif getpin2.h1Q10 eq "T">
        <li>
			<a class="oe_secondary_submenu_item" href="/#HDir#/maintenance/capacity/capacitytable.cfm" target="mainFrame" title="<cfoutput>Model Profile</cfoutput>">
                <cfoutput>Capacity Profile</cfoutput>
			</a>
		</li>
        </cfif>
</span>
...
<cfif getpin2.h1F00 eq "T">
	...
	<cfif getpin2.h1J00 eq "T">
		<li>
			<a class="oe_secondary_submenu_item" href="/#HDir#/maintenance/bom_Search.cfm" target="mainFrame" title="<cfoutput>#menutitle[18]#</cfoutput>">
	...
	<cfif getpin2.h1K00 eq "T" or getpin2.h1K10 eq "T" or getpin2.h1K20 eq "T" or getpin2.h1K30 eq "T" or getpin2.h1K40 eq "T" or getpin2.h1K50 eq "T" or getpin2.h1K60 eq "T" or getpin2.h1K70 eq "T">
                ...
                <li>
                    <a class="oe_secondary_submenu_item" href="/#HDir#/maintenance/openqtymaintenance/batch.cfm?modeaction=no" target="mainFrame" title="<cfoutput>#menutitle[134]#</cfoutput>">
                        <cfif getGeneral.dflanguage eq 'english'>
               				<cfoutput>Edit #getGeneral.lbatch# Opening Qty</cfoutput>
                    <cfelse>
                ...
                <li>
                    <a class="oe_secondary_submenu_item" href="/#HDir#/maintenance/openqtymaintenance/locationbatch.cfm?modeaction=no" target="mainFrame" title="<cfoutput>#menutitle[137]#</cfoutput>">
                        <cfif getGeneral.dflanguage eq 'english'>
               				<cfoutput>Edit Location - #getGeneral.lbatch# Opening Qty</cfoutput>
                    <cfelse>
                ...
                <li>
                    <a class="oe_secondary_submenu_item" href="/#HDir#/maintenance/openqtymaintenance/serialno_opening_qty_maintenance.cfm" target="mainFrame" title="<cfoutput>#menutitle[138]#</cfoutput>">
                        <cfoutput>
                        <cfif getgeneral.dflanguage eq 'english'>
                        Edit #getgeneral.lserial#. Opening Quantity
                        <cfelse>
                        #menutitle[138]#
						</cfif>
						</cfoutput>
                ...
                <cfif getpin2.h1K70 eq "T">
                <li>
                    <a class="oe_secondary_submenu_item" href="/#HDir#/maintenance/openqtymaintenance/checkopeningqty.cfm" target="mainFrame" title="<cfoutput>Check Opening Value with Fifo</cfoutput>">
                        <cfoutput>Check Opening Value with Fifo</cfoutput>
                    </a>
                </li>
	  	</cfif>
...
<cfif getpin2.h1L00 eq "T">
    ...
    <cfif lcase(HcomID) eq "mcjim_i">
     ...
     <li>
        ...
        <cfif lcase(HcomID) eq "net_i" or lcase(HcomID) eq "netm_i" or lcase(HcomID) eq "netsm_i" or lcase(HcomID) eq "nett_i" or lcase(HcomID) eq "imperial1_i">
     	<li>
			<a class="oe_secondary_submenu_item" href="/customized/#lcase(hcomid)#/maintenance/s_cso.cfm" target="_blank" title="<cfoutput>CSO Profile</cfoutput>">
				<cfoutput>CSO Profile</cfoutput>
			</a>
		</li>
        
        <li>
			<a class="oe_secondary_submenu_item" href="/customized/#lcase(hcomid)#/maintenance/s_servicetype.cfm" target="_blank" title="<cfoutput>Service Type Profile</cfoutput>">
				<cfoutput>Service Type Profile</cfoutput>
			</a>
		</li>
        </cfif>
        
        
        <cfif lcase(HcomID) eq "mylustre_i">
     <li>
			<a class="oe_secondary_submenu_item" href="/default/maintenance/DeliveryTiming/setDeliveryTiming.cfm" target="mainFrame" title="<cfoutput>Service Type Profile</cfoutput>">
				<cfoutput>Delivery Timing</cfoutput>
			</a>
		</li>    
        </cfif>
