...
<cfif form.customer neq ''>
	<cfquery name="getEmp" datasource="manpower_i">
		SELECT empno FROM manpower_i.assignmentslip WHERE payrollperiod = '#form.month#' and batches != ""
...
<cfloop query="getAssignment">
	<cfquery name="getPayYTD" datasource="#dts#">
