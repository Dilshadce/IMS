	...
	var resultTable=$('#resultTable')
		.dataTable({
			...
			'aoColumnDefs':[
				...
				{'aTargets':[1],'sTitle':emailsent.toUpperCase(),'mData':'emailsent','bSortable':true,'sWidth':'8%'},
				{'aTargets':[2],'sTitle':eformupdated.toUpperCase(),'mData':'requested_on','bSortable':true,'sWidth':'8%'},
				{'aTargets':[3],'sTitle':pbupdated.toUpperCase(),'mData':'dbcandupdate','bSortable':true,'sWidth':'8%'},
				{'aTargets':[4],'sTitle':address1.toUpperCase(),'mData':'add1','bSortable':true,'sWidth':'13%'},
				{'aTargets':[5],'sTitle':address2.toUpperCase(),'mData':'add2','bSortable':true,'sWidth':'13%'},
				{'aTargets':[6],'sTitle':dob.toUpperCase(),'mData':'dbirth','bSortable':true,'sWidth':'8%'},
				{'aTargets':[7],'sTitle':gender.toUpperCase(),'mData':'sex','bSortable':true,'sWidth':'5%'},
				{'aTargets':[8],'sTitle':race.toUpperCase(),'mData':'race','bSortable':true,'sWidth':'5%'},
				{'aTargets':[9],'sTitle':origincountry.toUpperCase(),'mData':'Country_code_address','bSortable':true,'sWidth':'5%'},
				{'aTargets':[10],'sTitle':contactno.toUpperCase(),'mData':'phone','bSortable':true,'sWidth':'5%'},
				{'aTargets':[11],'sTitle':personalemail.toUpperCase(),'mData':'email','bSortable':true,'sWidth':'5%'},
				{'aTargets':[12],'sTitle':workemail.toUpperCase(),'mData':'workemail','bSortable':true,'sWidth':'5%'},
				{'aTargets':[13],'sTitle':maritalstatus.toUpperCase(),'mData':'mstatus','bSortable':true,'sWidth':'5%'},
				{'aTargets':[14],'sTitle':nricpassport.toUpperCase(),'mData':'nricn','bSortable':true,'sWidth':'5%'},
				{'aTargets':[15],'sTitle':passportexpiry.toUpperCase(),'mData':'passprt_to','bSortable':true,'sWidth':'5%'},
				{'aTargets':[16],'sTitle':secondpassport.toUpperCase(),'mData':'passport','bSortable':true,'sWidth':'5%'},
				{'aTargets':[17],'sTitle':highesteducation.toUpperCase(),'mData':'edu','bSortable':true,'sWidth':'5%'},
				{'aTargets':[18],'sTitle':nationality.toUpperCase(),'mData':'national','bSortable':true,'sWidth':'5%'},				
				{'aTargets':[19],'sTitle':emergencycontactperson.toUpperCase(),'mData':'econtact','bSortable':true,'sWidth':'5%'},
				{'aTargets':[20],'sTitle':emergencycontactno.toUpperCase(),'mData':'etelno','bSortable':true,'sWidth':'5%'},
				{'aTargets':[21],'sTitle':originalcountryadd1.toUpperCase(),'mData':'eadd1','bSortable':true,'sWidth':'5%'},
				{'aTargets':[22],'sTitle':originalcountryadd2.toUpperCase(),'mData':'eadd2','bSortable':true,'sWidth':'5%'}	
        	],
			'bAutoWidth':true,
			'bFilter':true,
			'bDestroy':true,
