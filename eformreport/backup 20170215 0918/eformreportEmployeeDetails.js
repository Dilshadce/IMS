...
$(document).ready(function(e) {
	...
	var resultTable=$('#resultTable2')
		.dataTable({
			...
			'aLengthMenu':[[10, 25, 50, 100, -1], [10, 25, 50, 100, 'All']],
			'aoColumnDefs':[
				{'aTargets':[0],'sTitle':taxno.toUpperCase(),'mData':'itaxno','bSortable':true,'sWidth':'8%'},
				{'aTargets':[1],'sTitle':taxbranch.toUpperCase(),'mData':'itaxbran','bSortable':true,'sWidth':'8%'},
				{'aTargets':[2],'sTitle':spouseworking.toUpperCase(),'mData':'itaxno','bSortable':true,'sWidth':'8%',
					'mRender':function(data,type,object){
					return ''+object.spousework+'';
					}
				},
				{'aTargets':[3],'sTitle':spousename.toUpperCase(),'mData':'sname','bSortable':true,'sWidth':'8%'},
				{'aTargets':[4],'sTitle':numberofchild.toUpperCase(),'mData':'numchild','bSortable':true,'sWidth':'8%'},
				{'aTargets':[5],'sTitle':childbelow18.toUpperCase(),'mData':'num_child','bSortable':true,'sWidth':'8%'},
				{'aTargets':[6],'sTitle':childstudy.toUpperCase(),'mData':'child_edu_m','bSortable':true,'sWidth':'8%'},
				{'aTargets':[7],'sTitle':childstudydiploma.toUpperCase(),'mData':'child_edu_f','bSortable':true,'sWidth':'8%'},
				{'aTargets':[8],'sTitle':disabledchild.toUpperCase(),'mData':'child_disable','bSortable':true,'sWidth':'8%'},
				{'aTargets':[9],'sTitle':disabledchildstudy.toUpperCase(),'mData':'child_edu_disable','bSortable':true,'sWidth':'8%'}
        	],
			'bAutoWidth':true,
			'bFilter':true,
			'bDestroy':true,
...
$(document).ready(function(e) {
	...
	var resultTable=$('#resultTable3')
		.dataTable({
			...
			'aLengthMenu':[[10, 25, 50, 100, -1], [10, 25, 50, 100, 'All']],
			'aoColumnDefs':[
				{'aTargets':[0],'sTitle':epfno.toUpperCase(),'mData':'epfno','bSortable':true,'sWidth':'8%'},
				{'aTargets':[1],'sTitle':countrypub.toUpperCase(),'mData':'pbholiday','bSortable':true,'sWidth':'8%'},
				{'aTargets':[2],'sTitle':countryserve.toUpperCase(),'mData':'countryserve','bSortable':true,'sWidth':'8%'},
				{'aTargets':[3],'sTitle':hiringmanagername.toUpperCase(),'mData':'epfno','bSortable':true,'sWidth':'8%',
					'mRender':function(data,type,object){
					return ''+object.username+'';
					}
				},
				{'aTargets':[4],'sTitle':hiringmanageremail.toUpperCase(),'mData':'epfno','bSortable':true,'sWidth':'8%',
					'mRender':function(data,type,object){
					return ''+object.userid+'';
					}
				},
				{'aTargets':[5],'sTitle':employmentpassnno.toUpperCase(),'mData':'wpermit','bSortable':true,'sWidth':'8%'},
				{'aTargets':[6],'sTitle':employmentvalidfrom.toUpperCase(),'mData':'wp_from','bSortable':true,'sWidth':'8%'},
				{'aTargets':[7],'sTitle':employmentvalidto.toUpperCase(),'mData':'wp_to','bSortable':true,'sWidth':'8%'},
				{'aTargets':[8],'sTitle':bankname.toUpperCase(),'mData':'bankcode','bSortable':true,'sWidth':'8%'},
				{'aTargets':[9],'sTitle':bankaccountno.toUpperCase(),'mData':'bankaccno','bSortable':true,'sWidth':'8%'},
				{'aTargets':[10],'sTitle':bankbeneficialname.toUpperCase(),'mData':'bankbefname','bSortable':true,'sWidth':'8%'},
				{'aTargets':[11],'sTitle':workplacedepartment.toUpperCase(),'mData':'epfno','bSortable':true,'sWidth':'8%',
					'mRender':function(data,type,object){
					return ''+object.department+'';
					}
				},
				{'aTargets':[12],'sTitle':designation.toUpperCase(),'mData':'epfno','bSortable':true,'sWidth':'8%',
					'mRender':function(data,type,object){
