	...
	var resultTable=$('#resultTable')
		.dataTable({
			...
			'aoColumnDefs':[
				...
				'aoColumnDefs':[
					{'mData': 'custno', 'aTargets':[0]},
					{'mData': 'custname', 'aTargets':[1]}],
					'mRender':function(data,type,full){
						return '<a href="eformreportEmployeeDetails.cfm?custno='+full.custno+'&custname='+full.custname+'">'+ full.custname +'</a>';
					}
				}
			...
			'fnServerParams':function(aoData){
				aoData.push(
					{"name":"method","value":"listClient"},
					{"name":"returnformat","value":"json"},
					{"name":"dts","value":dts},
					{"name":"targetTable","value":targetTable},
					{"name":"customerFrom","value":customerFrom},
					{"name":"customerTo","value":customerTo}
					/*{"name":"custnoform","value":custnoform},
