	...
	var resultTable=$('#resultTable')
		.dataTable({
			...
			'aoColumnDefs':[
				...
				{'aTargets':[2],'sTitle':eformupdated.toUpperCase(),'mData':'dbcandupdate','bSortable':true,'sWidth':'8%'},
				{'aTargets':[3],'sTitle':pbupdated.toUpperCase(),'mData':'requested_on','bSortable':true,'sWidth':'8%'},
