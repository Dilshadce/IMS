        ...
        <cfqueryparam cfsqltype="cf_sql_varchar" value="SGD">
          ...
          <cfquery name="insertictran" datasource="#dts#">
            ...
            <cfquery name="updatecombine" datasource="#dts#">
            	UPDATE assignmentslip SET combine = "Y" WHERE refno in (<cfqueryparam cfsqltype="cf_sql_varchar"  value="#form.checklist#" list="yes" separator=",">) and combine <> "Y"
            </cfquery>
...
<cfquery name="insertictran" datasource="#dts#">
            ...
            <cfquery name="updatecombine" datasource="#dts#">
            	UPDATE assignmentslip SET combine = "Y" WHERE refno in (<cfqueryparam cfsqltype="cf_sql_varchar"  value="#valuelist(getinvlist.refno)#" list="yes" separator=",">) and combine <> "Y"
            </cfquery>
...
<cfelseif form.combinationtype eq "gnsi">
    ...
    SELECT * FROM tempcreatebiitem WHERE uuid = "#form.uuid#" GROUP BY orderno ORDER BY orderno,id
    </cfquery>
...
alert('Big Invoice Generation Completed. The invoice number is #refno#');
