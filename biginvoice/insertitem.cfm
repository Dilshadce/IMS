...
<tr>
<td colspan="100%"><div align="center"><cfif getitemlist.recordcount neq 0><input type="button" name="groupitem" id="groupitem" value="Group Item" onclick="groupitemfunc();"><cfelse>&nbsp;<input type="submit" name="sub_btn" id="sub_btn" value="Generate Invoice"></cfif></div> </td>
</tr>
</table>
</cfoutput>
</cfif>