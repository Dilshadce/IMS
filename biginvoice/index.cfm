...
<option value="mg">Multiple Group</option>
<option value="gnsi">Group & Split Invoice</option>
...
<th>Invoice Date</th>
<td>
<input type="text" name="invoicedate" id="invoicedate" value="#dateformat(now(),'dd/mm/yyyy')#">&nbsp;<img src="/images/cal.gif" width=17 height=15 border=0 onClick="showCalendarControl(document.getElementById('invoicedate'));">
</td>
</tr>
<tr>
<th>Invoice Type</th>
