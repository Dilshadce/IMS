...
select refno,assignmentslipdate,custno,custname,custtotal,created_by,empno,empname from assignmentslip where assignmenttype = "sinvoice" and combine <> "Y" and custno = "#form.custno#"
...
<td colspan="6"><cfinput type="text" name="desp" id="desp" value="" size="100" required="yes" message="Description is Required"></td>
</tr>
</cfif>
<tr>
...
<input type="button" name="groupitem" id="groupitem" value="Group Invoice" onclick="groupitemfunc();" />
</cfif>
<input type="submit" name="sub_btn" id="sub_btn" value="Generate" style="display:none">
</div>
</th>
</tr>
</table>
...
<th colspan="100%">
<div align="center">
<input type="submit" name="sub_btn" id="sub_btn" value="Pick Item">
</div>
</th>
</tr>
</table>
