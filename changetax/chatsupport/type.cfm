<--- --------------------------------------------------------------------------------------- ----
	...
	Link:
	http://www.bennadel.com/index.cfm?event=blog.view&id=1956
	
	Date Posted:
	Jun 30, 2010 at 10:39 AM
...
<!---
	...
	channel creation).
--->
<cfset pusherAppID = "15839" />
<cfset pusherKey = "f72a11e1d2e6f1918df9" />
<cfset pusherSecret = "aabd80f54cd2e5e6d112" />
