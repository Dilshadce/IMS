	...
	var resultTable=$('#resultTable')
		.dataTable({
			...
			'aoColumnDefs':[
                ...
                {'aTargets':[8],'sTitle':notfound.toUpperCase(),'mData':'custno','bSortable':true,'sWidth':'25%',
				'mRender':function(data,type,object){
					return ''+object.notfound+'';
					},
				},
                {'aTargets':[9],'sTitle':summary.toUpperCase(),'mData':'custno','bSortable':true,'sWidth':'25%',
				'mRender':function(data,type,full){
