...
<!---dts is _i but dts will be used as _p thus exchanging dts below--->

<cfset datestart = "">
<cfset dateend = "">
<cfset tmonth = '#form.monthselected#'>
<cfset tyear = '#form.yearselected#'>
<cfset dts2 = #dts#>
...
<cfquery name="gettimelist" datasource="#dts2#">
    SELECT b.placementno, max(b.tsrowcount) as end, min(b.tsrowcount) as start, b.updated_on, b.updated_by, b.created_on, 
    CASE WHEN b.status = "" THEN "SAVED" ELSE b.status END AS status
    FROM placement a
...
<cfquery name="company_details" datasource="payroll_main">
   SELECT * FROM gsetup WHERE comp_id = <cfqueryparam cfsqltype="cf_sql_varchar" value="#HcomID#">
        ...
        SELECT * FROM pmast as pm WHERE empno = '100129876'
        </cfquery>
        ...
        <cfquery name="gettimesheet" datasource="#dts#">
            SELECT * FROM 
                (
                    ...
                    AND tmonth = "#tmonth#" AND tyear = "#tyear#"
                    ORDER BY pdate
                ) AS sort
                GROUP by pdate	
        </cfquery>
      <!---edited--->
        ...
        SELECT * FROM placement a 
        LEFT JOIN payroll_main.hmusers b on a.hrmgr = b.entryid
        WHERE a.placementno = '#pno#'
        </cfquery>
...
<table border=0 cellpadding=0 cellspacing=0 width=800 style='border-collapse:
 ...
 <tr height=26 style='height:19.5pt'>
  <td colspan=20 class=xl1138828 width=669 style='width:502pt'>#counter#: MONTHLY TIMESHEET (#gettimelist.status#)</td>
 </tr>
 ...
 <tr height=21 style='mso-height-source:userset;height:15.75pt'>
  ...
  border-left:none;width:96pt'>Candidate no</td>
...
<!---  <cfquery name="gettimesheet" datasource="#dsname#">
 ...
 <tr height=20 style='height:15.0pt'>
  ...
  <td colspan=9 class=xl1288828 width=128 style='border-left:none;width:96pt'>#getplacementlist.empno#</td>
 </tr>

 
 <tr height=21 style='mso-height-source:userset;height:15.75pt'>
  <td colspan=2 rowspan=2 height=41 class=xl1188828 style='border-right:1pt solid black;
  border-bottom:1pt solid black;height:30.75pt'>Manager</td>
  <td colspan=7 class=xl1248828 width=320 style='border-right:1pt solid black;
  border-left:none;width:240pt'>Name</td>
  <td colspan=7 class=xl1248828 width=128 style='border-right:1pt solid black;
  border-left:none;width:96pt'>Email</td>
  <td colspan="2" class=xl898828 style='border-top:none;border-left:none'>Signature:</td>
 </tr>
 
 <!---Changed rowspan to 5, [20170920, Alvin]--->
 <tr height=20 style='height:15.0pt'>
  <td colspan=7 height=20 class=xl1258828 style='border-right:1pt solid black;
  height:15.0pt;border-left:none'>#getplacementlist.username#</td>
  <td colspan=7 class=xl1288828 width=128 style='border-left:none;width:96pt'>#getplacementlist.useremail#</td> 
  <td rowspan="5" height=22 class=xl748828 style='height:15.0pt;border-top:none' colspan="2"><input type="hidden" name="enddate" id="enddate" value="<cfif gettimesheet.recordcount neq 0>#dateformat(gettimesheet.assigndate,'dd/mm/yyyy')#</cfif> " size="12" readonly><!--- <img src="/images/cal.gif" width=17 height=15 border=0 onClick="showCalendarControl(document.getElementById('enddate'));"> ---></td>
 </tr>
 <!---Changed rowspan to 5--->
 
 <tr height=21 style='mso-height-source:userset;height:15.75pt'>
  <td colspan=2 rowspan=2 height=41 class=xl1188828 style='border-right:1pt solid black;
  border-bottom:1pt solid black;height:30.75pt'>Timesheet<br/> Details</td>
  <td colspan=7 class=xl1248828 width=320 style='border-right:1pt solid black;
  border-left:none;width:240pt'>Submitted On</td>
  <td colspan=7 class=xl1248828 width=128 style='border-right:1pt solid black;
  border-left:none;width:96pt'>Updated On</td>
 </tr>
 
 <tr height=20 style='height:15.0pt'>
  <td colspan=7 height=20 class=xl1258828 style='border-right:1pt solid black;
  height:15.0pt;border-left:none'>#DateTimeFormat(gettimelist.created_on, 'yyyy-mm-dd hh:nn:ss')#</td>
  <td colspan=7 class=xl1288828 width=128 style='border-left:none;width:96pt'>#DateTimeFormat(gettimelist.updated_on, 'yyyy-mm-dd hh:nn:ss')# <br/>By #gettimelist.updated_by#</td> 
 </tr>
