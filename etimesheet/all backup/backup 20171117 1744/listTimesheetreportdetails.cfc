<cfcomponent>
    <cffunction name="listDetails" access="remote" returntype="struct"> 
        ...
        <cfquery name="getFilteredDataSet" datasource="#dts#">
            ...
            FROM
            (
                SELECT pl.empno, pl.empname, pm.phone, 
        ...
        <cfloop query="getFilteredDataSet">	
            ...
            <cfset data["submitdate"]="#DateTimeFormat(submitdate, 'yyyy-mm-dd hh:nn:ss')#">
            <cfset data["updateddate"]="#DateTimeFormat(updateddate, 'yyyy-mm-dd hh:nn:ss')#">
