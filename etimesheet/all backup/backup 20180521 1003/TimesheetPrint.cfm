...
<cfquery name="gettimelist" datasource="#dts#">
    ...
    FROM 
    (
        SELECT placementno, custno, empno, empname, hrmgr, timesheet, custname, contactperson
        FROM placement 
    )a
    LEFT JOIN 
    (
        SELECT placementno, empno, tmonth, tyear, pdate, ot1, ot2, ot3, ot4, ot5, ot6, ot7, ot8, remarks, mgmtremarks, workhours, ot_type, stcol, ampm, 
        starttime, endtime, breaktime, status, created_on, updated_on, updated_by
        FROM #dsname#.timesheet 
    )b ON a.placementno = b.placementno
    LEFT JOIN 
    (
        SELECT custno, add1, add2, add3, add4, phone FROM arcust
    ...
    <cfif (#IsDefined('form.fromclient')# AND "#form.fromclient#" NEQ "") AND (#IsDefined('form.toclient')# AND "#form.toclient#" NEQ "")>
        AND a.custno BETWEEN <cfqueryparam cfsqltype="cf_sql_varchar" value="#form.fromclient#"> 
        AND <cfqueryparam cfsqltype="cf_sql_varchar" value="#form.toclient#">
    <cfelse>
        <cfif "#form.fromclient#" NEQ "">
            AND a.custno = <cfqueryparam cfsqltype="cf_sql_varchar" value="#form.fromclient#">
        <cfelseif "#form.toclient#" NEQ "">
            AND a.custno = <cfqueryparam cfsqltype="cf_sql_varchar" value="#form.toclient#">
        </cfif>
    </cfif>
                ...
                <div id="Book1_8828" align=center x:publishsource="Excel">
                    ...
                    <cfloop query="placementcount">
                        ...
                        <table border=0 cellpadding=0 cellspacing=0 width=800 id="titlec" style='border-collapse:collapse;table-layout:fixed;width:800pt'>
                            ...
                            <tr height=26 style='height:19.5pt'>
                                <td colspan=25 class=xl1138828 width=669 style='width:502pt'>#counter#: MONTHLY TIMESHEET (#gettimesheet.status#)</td>
                            </tr>
                            ...
                            <cfloop query="gettimesheet">
                                ...
                                <tr onMouseOut="javascript:this.style.backgroundColor='';" onMouseOver="javascript:this.style.backgroundColor='##dce3e5';" height=20 style='height:12.0pt'>
                                    ...
                                    <td class=xl768828 style='border-top:none;border-left:none'>#gettimesheet.stcol#</td>  
