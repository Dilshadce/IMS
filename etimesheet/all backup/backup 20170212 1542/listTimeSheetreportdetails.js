		...
		.dataTable({
			...
			'aoColumnDefs':[
				...
				'mRender':function(data,type,object){
					return ''+object.empname+'';
				}},
				{'aTargets':[2],'sTitle':phone.toUpperCase(),'mData':'phone','bSortable':true,'sWidth':'10%',
				'mRender':function(data,type,object){
					return ''+object.phone+'';		//because most of the value get is not from the same table therefore need to get it from function/object
				}},
				...
				'mRender':function(data,type,object){
					return ''+object.timesheetstatus+'';
				}},
				{'aTargets':[5],'sTitle':hmname.toUpperCase(),'mData':'username','bSortable':true,'sWidth':'10%',
				'mRender':function(data,type,object){
					return ''+object.hmname+'';
				}},
				{'aTargets':[6],'sTitle':hmemail.toUpperCase(),'mData':'useremail','bSortable':true,'sWidth':'10%',
				'mRender':function(data,type,object){
					return ''+object.hmemail+'';
				}},
				{'aTargets':[7],'sTitle':submitdate.toUpperCase(),'mData':'empno','bSortable':true,'sWidth':'10%',
				'mRender':function(data,type,object){
					return ''+object.submitdate+'';
				}},
				{'aTargets':[8],'sTitle':approvaldate.toUpperCase(),'mData':'empno','bSortable':true,'sWidth':'26%',
				'mRender':function(data,type,object){
					return ''+object.approvaldate+'';
				}}
        	],
			'bAutoWidth':true,
			'bFilter':true,
