...
<cfloop query="excel">
    ...
    <cfif "#placementno#" EQ "">
        <cffile action="#writeAppend#" file="#outputfile#"
            output="#placementno#,#excel.col_1#,#excel.col_2#,#excel.col_3#,#LsDateFormat(excel.col_4, 'yyyy-mm-dd', 'English (Australian)')#,#excel.col_5#,#excel.col_6#,#excel.col_7#,#excel.col_8#,#excel.col_9#,#excel.col_10#,#excel.col_11#,#excel.col_12#,#excel.col_13#,#excel.col_14#,#excel.col_15#,#excel.col_16#,""#remarks#"",#ampm#,#tmonth#,#tyear#"
            addnewline="yes">
    <cfelse>
        ...
        <cfif "#getplacement.timesheet#" EQ "01-31">
            ...
            <cfset tyear = "#LsDateFormat(excel.col_4, 'yyyy', 'English (Australian)')#">
        <cfelse>
            <cfif "#LsDateFormat(excel.col_4, 'd', 'English (Australian)')#" GTE "#Left(timesheet, 2)#"> <!--- >= left(timesheet cycle) means next payroll month reached--->
                ...
                <cfset tyear = #LsDateFormat(DateAdd('m', 1, "#LsDateFormat(excel.col_4, 'yyyy-mm-dd', 'English (Australian)')#"), 'yyyy', 'English (Australian)')#>
            <cfelse>
                <cfset tmonth = "#LsDateFormat(excel.col_4, 'm', 'English (Australian)')#">
                <cfset tyear = "#LsDateFormat(excel.col_4, 'yyyy', 'English (Australian)')#">
            </cfif>
        ...
        <cfif "#phflag#" EQ TRUE>
            <cffile action="#writeAppend#" file="#outputfile#"
                    output="#placementno#,#excel.col_1#,PH,#excel.col_3#,#LsDateFormat(excel.col_4, 'yyyy-mm-dd', 'English (Australian)')#,#excel.col_5#,#excel.col_6#,#excel.col_7#,#excel.col_8#,#excel.col_9#,#excel.col_10#,#excel.col_11#,#excel.col_12#,#excel.col_13#,#excel.col_14#,#excel.col_15#,#excel.col_16#,""#remarks#"",#ampm#,#tmonth#,#tyear#"
                    addnewline="yes">
        <cfelse>
            ...
            <cfif #checkLeave.recordcount# NEQ 0>
                ...
                <cffile action="#writeAppend#" file="#outputfile#"
                    output="#placementno#,#excel.col_1#,#checkLeave.leavetype#,#excel.col_3#,#LsDateFormat(excel.col_4, 'yyyy-mm-dd', 'English (Australian)')#,#excel.col_5#,#excel.col_6#,#workhours#,#breaktime#,#excel.col_9#,#excel.col_10#,#excel.col_11#,#excel.col_12#,#excel.col_13#,#excel.col_14#,#excel.col_15#,#excel.col_16#,""#checkLeave.remarks#"",#ampm#,#tmonth#,#tyear#"
                    addnewline="yes">
