<cffunction name="createTimesheet" access="remote">
    <cfargument name="dts" type="string" required="yes" />
    <cfargument name="a" type="string" required="yes" />
    <cfargument name="dateNow" type="string" required="yes" />
    <cfargument name="fileName" type="string" required="yes" />
    <cfargument name="firstTime" type="string" required="yes" />
    <cfargument name="writeAppend" type="string" required="yes" />
    <cfargument name="lastRow" type="string" required="yes" />
    <cfargument name="lastRowMonth" type="string" required="yes" />
    <cfargument name="srcFile" type="string" required="yes" />
    <cfargument name="stcol" type="string" required="yes" />
    <cfargument name="outputfile" type="string" required="yes" />
    <cfargument name="workhours" type="string" required="yes" />
    <cfargument name="breaktime" type="string" required="yes" />
