...
<cfloop list="#SpreadSheetInfo(SpreadsheetRead(srcFile)).SHEETNAMES#" index="a">
	...
	<cfloop query="queryData" startrow="11" endrow="#val(lastrow)#">
		...
		<cffile action="#writeAppend#" file="#outputfile#"
				output="#placementno#,#empno#,#stcol#,#tsrowcount#,#LsDateFormat(queryData.col_1, 'yyyy-mm-dd', 'English (Australian)')#,#starttime#,#endtime#,#workhours#,#breaktime#,0,0,0,0,0,0,0,0,#queryData.col_17#"
				addnewline="yes">
