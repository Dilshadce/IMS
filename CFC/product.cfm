							...
							<div class="row">
								<div class="col-sm-6">      
                                 	<div class="form-group">
										...
										<div class="col-sm-8">
											<input type="text" class="form-control input-sm" id="itemNo" name="itemNo"  placeholder="#words[120]#" required="yes" <cfif IsDefined("url.action") AND url.action NEQ "create"> value="#convertquote(itemNo)#" disabled="true"</cfif>>									
										</div>
									</div>
                                    <div class="form-group">
										<label for="desp" class="col-sm-4 control-label">#words[65]#</label>
										<div class="col-sm-8">
											<input type="text" class="form-control input-sm" id="desp" name="desp" value="#convertquote(desp)#" placeholder="#words[65]#">								
                                            <input type="text" class="form-control input-sm" id="desp" name="despa" value="#convertquote(despa)#" placeholder="#words[126]#">						
										</div>
									</div>
                                    <div class="form-group">
