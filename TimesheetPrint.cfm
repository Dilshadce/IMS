...
<cfquery name="gettimelist" datasource="#dts2#">
    SELECT b.placementno, max(b.tsrowcount) as end, min(b.tsrowcount) as start, b.updated_on, b.updated_by
    FROM placement a
    LEFT JOIN #dts#.timesheet b
    ON a.placementno = b.placementno
    WHERE b.tmonth = '#tmonth#'
    <!---AND a.custname like '%samsung%'--->
    AND b.placementno = '200136721'
    <!---AND status = 'Approved'--->
...
<!---Changed rowspan to 5, [20170920, Alvin]--->
 <tr height=20 style='height:15.0pt'>
  ...
  <td colspan=7 class=xl1288828 width=128 style='border-left:none;width:96pt'>#getplacementlist.empno#</td>
...
<!---Changed rowspan to 5--->
 ...
 <tr height=21 style='mso-height-source:userset;height:15.75pt'>
  ...
  border-left:none;width:240pt'>Name</td>
  <td colspan=7 class=xl1248828 width=128 style='border-right:1pt solid black;
  border-left:none;width:96pt'>Updated On & By</td>
  
 </tr>
 
 <tr height=20 style='height:15.0pt'>
  <td colspan=7 height=20 class=xl1258828 style='border-right:1pt solid black;
  height:15.0pt;border-left:none'>#getplacementlist.username# (#getplacementlist.useremail#)</td>
  <td colspan=7 class=xl1288828 width=128 style='border-left:none;width:96pt'>#gettimelist.updated_on# <br/>By #gettimelist.updated_by#</td>
